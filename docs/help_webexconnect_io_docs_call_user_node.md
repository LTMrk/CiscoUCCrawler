[Jump to Content](https://help.webexconnect.io/docs/call-user-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Call User Node
Search
`CTRL-K`
All
Platform Documentation
...
# Call User Node
Understand what a Call User node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/call-user-node)
...
![Screenshot of Call User Node](https://files.readme.io/4c52ea8-call-user.png)
Call User Node
## 
Node Configuration
[](https://help.webexconnect.io/docs/call-user-node#node-configuration)
...
![Screenshot of Call User Node Configuration.](https://files.readme.io/5c83403-Call_User_Node_Call_User_Node_Configuration.png)
Call User Node Configuration
  1. Select the **From Number** from the drop-down list of available numbers. This is the number from which the outbound call gets initiated to the user. The platform supports dynamic 'FROM NUMBER' configuration as well. Simply select the ‘Dynamic’ option dropdown and configure the variable name that contains the ‘FROM NUMBER’.
  2. In the **Destination** field, enter the variable that contains the selected destination type or provide an absolute value.
  3. Configure Correlation ID, Callback Data, and Notify URL options are added to be able to pass data back to the client’s system to notify every call status. If an invalid URL is passed in API request or via a variable, then such request will not be considered eligible for retries. This field accepts only a valid URL or a variable.  
...
## 
Input Variables
[](https://help.webexconnect.io/docs/call-user-node#input-variables)
...
## 
Output Variables
[](https://help.webexconnect.io/docs/call-user-node#output-variables)
You can see the data that this node generates as output variables. These [variables](https://help.webexconnect.io/docs/variable-management) are available for use in subsequent nodes. The following are the standard output variables for the _Call User_ node:
...
![Screenshot of Output Variables](https://files.readme.io/8d7c8bb-Call_User_Node_Output_Variables.png)
Output Variables
## 
Node Outcomes
[](https://help.webexconnect.io/docs/call-user-node#node-outcomes)
...
| --- | --- |  
| Success (green)  |  **onAnswer** - the flow exits through this node outcome when the configured audio prompts are played successfully.  
  
This node outcome is automatically connected to the voice node group.  |  
| Error (red)  |  **onError** - the node exits with an error when there is an invalid user ID or missing digits in the customer's phone number. However, we noticed that the success rate of retried calls is significantly low. So, we suggest not to retry calling in such scenarios.  
...
## 
Transition Actions
[](https://help.webexconnect.io/docs/call-user-node#transition-actions)
...
* * *
[Decryption Node](https://help.webexconnect.io/docs/decryption-node)[Collect Input Node](https://help.webexconnect.io/docs/collect-input-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/call-user-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/call-user-node#node-configuration)
    * [Input Variables](https://help.webexconnect.io/docs/call-user-node#input-variables)
    * [Output Variables](https://help.webexconnect.io/docs/call-user-node#output-variables)
    * [Node Outcomes](https://help.webexconnect.io/docs/call-user-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/call-user-node#transition-actions)
