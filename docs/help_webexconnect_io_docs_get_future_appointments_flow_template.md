[Jump to Content](https://help.webexconnect.io/docs/get-future-appointments-flow-template#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Get Future Appointments Flow Template
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/get-future-appointments-flow-template)
## 
Overview
[](https://help.webexconnect.io/docs/get-future-appointments-flow-template#overview)
This flow acts as a prerequisite for downstream workflows such as appointment confirmation, cancellation, or rescheduling.
## 
Pre-requisites
[](https://help.webexconnect.io/docs/get-future-appointments-flow-template#pre-requisites)
...
## 
User Roles
[](https://help.webexconnect.io/docs/get-future-appointments-flow-template#user-roles)
...
## 
Node Breakdown
[](https://help.webexconnect.io/docs/get-future-appointments-flow-template#node-breakdown)  
...
| Get Future Appointments  | Executes a subscription-based API call to EPIC to fetch future records.  | Raw JSON list of appointments.  
...
[](https://help.webexconnect.io/docs/get-future-appointments-flow-template#input--output-variables)
### 
Input Variables (Configure AI Agent Event)
[](https://help.webexconnect.io/docs/get-future-appointments-flow-template#input-variables-configure-ai-agent-event)
`patientId:` The unique identifier for the patient whose appointments are being retrieved.
### 
Output Variables
[](https://help.webexconnect.io/docs/get-future-appointments-flow-template#output-variables)
...
## 
Error Handling
[](https://help.webexconnect.io/docs/get-future-appointments-flow-template#error-handling)
...
## 
Script Analysis
[](https://help.webexconnect.io/docs/get-future-appointments-flow-template#script-analysis)
### 
Trim Result Set Script
[](https://help.webexconnect.io/docs/get-future-appointments-flow-template#trim-result-set-script)
...
### 
Evaluate Script
[](https://help.webexconnect.io/docs/get-future-appointments-flow-template#evaluate-script)
...
Updated 20 days ago
* * *
[Confirm Appointment Flow Template](https://help.webexconnect.io/docs/confirm-appointment-flow-template)[Cancel Appointment Flow Template](https://help.webexconnect.io/docs/cancel-appointment-flow-template)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/get-future-appointments-flow-template)
  *     * [Overview](https://help.webexconnect.io/docs/get-future-appointments-flow-template#overview)
    * [Pre-requisites](https://help.webexconnect.io/docs/get-future-appointments-flow-template#pre-requisites)
    * [User Roles](https://help.webexconnect.io/docs/get-future-appointments-flow-template#user-roles)
    * [Node Breakdown](https://help.webexconnect.io/docs/get-future-appointments-flow-template#node-breakdown)
    * [Input & Output Variables](https://help.webexconnect.io/docs/get-future-appointments-flow-template#input--output-variables)
      * [Input Variables (Configure AI Agent Event)](https://help.webexconnect.io/docs/get-future-appointments-flow-template#input-variables-configure-ai-agent-event)
      * [Output Variables](https://help.webexconnect.io/docs/get-future-appointments-flow-template#output-variables)
    * [Error Handling](https://help.webexconnect.io/docs/get-future-appointments-flow-template#error-handling)
    * [Script Analysis](https://help.webexconnect.io/docs/get-future-appointments-flow-template#script-analysis)
      * [Trim Result Set Script](https://help.webexconnect.io/docs/get-future-appointments-flow-template#trim-result-set-script)
      * [Evaluate Script](https://help.webexconnect.io/docs/get-future-appointments-flow-template#evaluate-script)
