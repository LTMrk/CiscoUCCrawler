[Jump to Content](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Service Key & JWT Authentication Tokens
Search
`CTRL-K`
All
Platform Documentation
...
View, copy and regenerate your service key and/or JWT Authentication Tokens
[Suggest Edits](https://help.webexconnect.io/edit/service-key-and-jwt-authentication-tokens)
## 
Understanding the role of Service Key and JWT Auth Credentials
[](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#understanding-the-role-of-service-key-and-jwt-auth-credentials)
...
![Screenshot of Webex Connect Service Key and JWT Auth Credentials](https://files.readme.io/9dd3ccf-Serivce_Key_n_JWT.jpg)
Accessing Service Keys, JWT Authentication Credentials, and Configuring Outbound Webhooks
> ## 📘
...
[](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#generating-jwt-tokens)
> ## 👍
...
![Screenshot displaying How to pass the JWT token when invoking Webex Connect APIs and Webhooks](https://files.readme.io/8075f16-jwt-token-in-api-header.png)
Header Parameters in API
## 
Rotating authentication credentials periodically
[](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#rotating-authentication-credentials-periodically)
...
> ## ❗️
> Service Key and JWT Tokens Security
...
[](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#creating-an-extra-service-key)
...
![Screenshot of Create Authentication Credentials.](https://files.readme.io/0fc2c31-Serivce_Key_n_JWT2.jpg)
Create Authentication Credentials
  1. Click **Create Authentication Credential(s)**. The Webex Connect platform generates a service key.

![Screenshot of Creating a Service Key.](https://files.readme.io/12b2404-Serivce_Key_n_JWT1.jpg)
Creating a Service Key
### 
Discarding an existing Service Key
[](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#discarding-an-existing-service-key)
...
![Screenshot of Discarding Webex Connect Service Key](https://files.readme.io/2311759-Serivce_Key_n_JWT3.jpg)
Discarding Service Key Credentials
> ## 📘
> Note
...
![Screenshot of Discarding existing JWT Auth Credentials](https://files.readme.io/ac89ec7-Serivce_Key_n_JWT4.jpg)
Discarding a JWT Auth credentials
### 
Reactivating a Service Key
[](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#reactivating-a-service-key)
...
[](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#deleting-a-service-key)
...
![Screenshot of Deleting a Service Key](https://files.readme.io/4947c26-Serivce_Key_n_JWT5.jpg)
Deleting a Service Key
  1. Enter the password and click **Yes, Delete** in the confirmation dialog. The service key gets deleted.

![Screenshot of the Deleting Service Key Credentials window](https://files.readme.io/43d6341-Serivce_Key_n_JWT6.jpg)
Deleting Service Key Credentials
### 
Creating an Extra Pair of JWT Tokens
[](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#creating-an-extra-pair-of-jwt-tokens)
...
[](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#discarding-a-jwt-token)
...
[](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#reactivating-a-jwt-token)
...
[](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#deleting-a-jwt-token)
...
* * *
[Inside a Service](https://help.webexconnect.io/docs/service-dashboard)[Locking, Deleting, and Other Settings](https://help.webexconnect.io/docs/service-settings)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens)
  *     * [Understanding the role of Service Key and JWT Auth Credentials](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#understanding-the-role-of-service-key-and-jwt-auth-credentials)
    * [Generating JWT Tokens](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#generating-jwt-tokens)
    * [Rotating authentication credentials periodically](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#rotating-authentication-credentials-periodically)
      * [Creating an Extra Service Key](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#creating-an-extra-service-key)
      * [Discarding an existing Service Key](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#discarding-an-existing-service-key)
      * [Reactivating a Service Key](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#reactivating-a-service-key)
      * [Deleting a Service Key](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#deleting-a-service-key)
      * [Creating an Extra Pair of JWT Tokens](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#creating-an-extra-pair-of-jwt-tokens)
      * [Discarding a JWT Token](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#discarding-a-jwt-token)
      * [Reactivating a JWT Token](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#reactivating-a-jwt-token)
      * [Deleting a JWT Token](https://help.webexconnect.io/docs/service-key-and-jwt-authentication-tokens#deleting-a-jwt-token)
