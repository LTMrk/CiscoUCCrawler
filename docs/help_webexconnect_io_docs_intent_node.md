[Jump to Content](https://help.webexconnect.io/docs/intent-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Intent Node
Search
`CTRL-K`
All
Platform Documentation
...
# Intent Node
Understand what an Intent node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/intent-node)
> ## 📘
...
_User Intent_ , also known as search intent or query intent, is the way of recognizing and classifying what a user wants to find or means when they entered their query. 
...
![Screenshot of Intent Node.](https://files.readme.io/661c326-intent.PNG)
Intent Node
## 
Node Configuration
[](https://help.webexconnect.io/docs/intent-node#node-configuration)
Use this tab to configure the Intent node. You can define the Intent in two steps: _Configuring Intent Settings_ and _Transition Actions_. 
![Screenshot of Intent Node Configuration.](https://files.readme.io/c1fd7a4-intent_config.PNG)
...
![Screenshot of Untrained Intent Error](https://files.readme.io/3151def-untrained_intent.png)
...
## 
Input Variables
[](https://help.webexconnect.io/docs/intent-node#input-variables)
...
## 
Output Variables
[](https://help.webexconnect.io/docs/intent-node#output-variables)
...
![Screenshot of Output Variables](https://files.readme.io/ec6dcd0-intent_output_variable.PNG)
Output Variables
## 
Node Outcomes
[](https://help.webexconnect.io/docs/intent-node#node-outcomes)
...
_ **onInvalidData** - the flow exits through this node when there is invalid data.  |  
## 
Transition Actions
[](https://help.webexconnect.io/docs/intent-node#transition-actions)
...
![Screenshot of Tansition Actions.](https://files.readme.io/48a8b2c-delay_transition_actions.png)
Transition Actions
## 
Testing the Data
[](https://help.webexconnect.io/docs/intent-node#testing-the-data)
...
![Screenshot of Test Intent](https://files.readme.io/d3bc1e5-test_intent.PNG)
Test Intent
...
![Screenshot of Test Intent.](https://files.readme.io/a8fb72c-Intent.png)
Screenshot of Test Intent 
> ## ❗️
> Note
> Copy and Paste functionality is not supported for this node
Updated over 1 year ago
* * *
[Entity Node](https://help.webexconnect.io/docs/entity-node)[Send Voice Node [Deprecated]](https://help.webexconnect.io/docs/send-voice-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/intent-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/intent-node#node-configuration)
    * [Input Variables](https://help.webexconnect.io/docs/intent-node#input-variables)
    * [Output Variables](https://help.webexconnect.io/docs/intent-node#output-variables)
    * [Node Outcomes](https://help.webexconnect.io/docs/intent-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/intent-node#transition-actions)
    * [Testing the Data](https://help.webexconnect.io/docs/intent-node#testing-the-data)
