[Jump to Content](https://help.webexconnect.io/docs/social-hour-check-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Social Hour Check Node
Search
`CTRL-K`
All
Platform Documentation
...
![Screenshot of Social Hour Check Node.](https://files.readme.io/eb52008-Social.jpg)
Social Hour Check Node
Social hours play an important role in ensuring that you do not disturb the users at the wrong time of the day. You can configure working hours for your business, holidays, and special days using the Social Hour Check node. You can also set exceptions to the social hours. For example, if your normal working hours are from 9 AM to 6 PM, you can configure an exception of 1 PM to 2 PM as the lunch hour.  

## 
Node Configuration
[](https://help.webexconnect.io/docs/social-hour-check-node#node-configuration)
...
![Screenshot of Node Outcomes](https://files.readme.io/36c6db3-Social_Hour_Check1.jpg)
Node Outcomes
## 
Input Variables
[](https://help.webexconnect.io/docs/social-hour-check-node#input-variables)
...
![Screenshot of Input and Custom Variables.](https://files.readme.io/3ce7c82-Social_Hour_Check3.jpg)
Input and Custom Variables
## 
Output Variables
[](https://help.webexconnect.io/docs/social-hour-check-node#output-variables)
You can see the data that this node generates as output variables. These [variables](https://help.webexconnect.io/docs/variable-management) are available for use in subsequent nodes. The following are the standard output variables for the Social Hour Check node:
  * **socialHour.timeToNext** - . 

![Screenshot of Output Variables.](https://files.readme.io/48e738f-Social_Hour_Check2.jpg)
Output Variables
## 
Node Outcomes
[](https://help.webexconnect.io/docs/social-hour-check-node#node-outcomes)
...
**Note** : You can see this node edge only when you complete the node configuration.  | * **onSuccess** - the flow exits through this node when it is a success.  |  
...
See the [example](https://help.webexconnect.io/docs/social-hour-check-node#section-example) for configuration details.
![Screenshot of Node Outcomes](https://files.readme.io/4ef57e2-Social_Hour_Check1.jpg)
Node Outcomes
## 
Transition Actions
[](https://help.webexconnect.io/docs/social-hour-check-node#transition-actions)
...
### 
Example
[](https://help.webexconnect.io/docs/social-hour-check-node#example)
...
![Screenshot of Sample Configuration of Social Hours.](https://files.readme.io/7d1df22-Social_Hour_Check4.jpg)
Sample Configuration of Social Hours
Updated 4 months ago
* * *
[Receive Node](https://help.webexconnect.io/docs/receive-node)[HTTP Request Node](https://help.webexconnect.io/docs/http-request-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/social-hour-check-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/social-hour-check-node#node-configuration)
    * [Input Variables](https://help.webexconnect.io/docs/social-hour-check-node#input-variables)
    * [Output Variables](https://help.webexconnect.io/docs/social-hour-check-node#output-variables)
    * [Node Outcomes](https://help.webexconnect.io/docs/social-hour-check-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/social-hour-check-node#transition-actions)
      * [Example](https://help.webexconnect.io/docs/social-hour-check-node#example)
