[Jump to Content](https://help.webexconnect.io/docs/third-party-bot#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Third-Party Bot
Search
`CTRL-K`
All
Platform Documentation
...
# Third-Party Bot
Understand how to integrate BOT platform and Webex Connect using Webhooks
[Suggest Edits](https://help.webexconnect.io/edit/third-party-bot)
The integration between the BOT platform and Webex Connect is setup using webhooks. The platform will provide incoming and outgoing webhooks.  
...
[](https://help.webexconnect.io/docs/third-party-bot#adding-a-bot-integration)
A BOT integration allows Webex Connect to route messages to and from your BOT.  
...
Screenshot of Adding Integrations
  1. Select **BOT PLATFORM** and click **Next**.  
Choose **IMI BOT** to allow Webex Connect to route messages to and from a BOT. Otherwise, choose **OTHERS**.

![Screenshot of Selecting BOT Platform](https://files.readme.io/8a80ef4-img1.jpg)
Select BOT Platform
  1. _For IMI BOT platform_ , enter a name for the integration and click **Next**.

![Screenshot of Enter Integration Name](https://files.readme.io/dadb879-img3.jpg)
Enter Integration Name
  1. **(For IMI BOT Only)** A BOT endpoint is used to notify your BOT of Webex Connect events via HTTPS POST request using the BOTs access token for verification in every interaction with the BOT.  
In the BOT Endpoint window. Enter a value in BOT's endpoint URL and BOT's access token.
  2. Click **Save**.

![Screenshot of Configuring Bot Endpoint](https://files.readme.io/f9e5074-Third_Party1.jpeg)
IMI Bot: Bot Endpoint
  1. _For Other_ platform, enter a name for the integration and click **Next**.
  2. **(For Generic BOT only)** In the **Outbound Webhook** window, enter values for the following: 
...
Screenshot of Configuring Outbound Webhook.
  1. Click **Verify** and then **Save**.


## 
Using Bot in a Service
[](https://help.webexconnect.io/docs/third-party-bot#using-bot-in-a-service)
To use a BOT in a service,
  1. On the integration list, map the added BOT integration to a service and click **Save**.

![Screenshot of Adding Integration to Service.](https://files.readme.io/85d02d4-img5.jpg)
Add Integration to Service
  1. Create a rule with incoming message on the added channel asset as the trigger, to perform one of the following actions:
  ...
  * Forward the message to be handled by BOT + CCSP
  ...
  1. Select an event from the available list and enter trigger conditions:

![Screenshot of Selecting Event](https://files.readme.io/4e1c8d7-img7.jpg)
Select Event
The **Handover** event is raised when the BOT decides to handover the chat to a CCSP integration.
![Screenshot of Select Trigger Channel](https://files.readme.io/8034548-img8.jpg)
...
[](https://help.webexconnect.io/docs/third-party-bot#communicating-with-bot)
...
Incoming message on a channelSample POSTBACK eventSample message delivery
...
BOTs ReplyConversation Handover to Agent
...
[](https://help.webexconnect.io/docs/third-party-bot#conversation-between-bot-and-ccsp)
...
* * *
[Custom Node Integration](https://help.webexconnect.io/docs/custom-nodes-integration)[Introduction](https://help.webexconnect.io/docs/pre-built-integrations-introduction)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/third-party-bot)
  *     * [Adding a BOT Integration](https://help.webexconnect.io/docs/third-party-bot#adding-a-bot-integration)
    * [Using Bot in a Service](https://help.webexconnect.io/docs/third-party-bot#using-bot-in-a-service)
      * [Communicating with BOT](https://help.webexconnect.io/docs/third-party-bot#communicating-with-bot)
    * [Conversation Between BOT and CCSP](https://help.webexconnect.io/docs/third-party-bot#conversation-between-bot-and-ccsp)
