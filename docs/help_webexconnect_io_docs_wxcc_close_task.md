[Jump to Content](https://help.webexconnect.io/docs/wxcc-close-task#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Close Task - WXCC
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/wxcc-close-task)
...
## 
Authorization
[](https://help.webexconnect.io/docs/wxcc-close-task#authorization)
...
[](https://help.webexconnect.io/docs/wxcc-close-task#methods-and-outcomes)
...
* The output variables of the closed event is the Media Type  | None  | v1.1 and v1.0  |  
> ## 📘
> Note
...
_ The output variables of the closed event is the Media Type  | None  | v1.1 and v1.0  |  
> ## 📘
> Note
...
_ The output variables of the closed event is the Media Type  | NA  | v1.1 and v1.0  |  
Updated 4 months ago
* * *
[Screen Pop - WXCC](https://help.webexconnect.io/docs/wxcc-screen-pop)[Resolve Conversation](https://help.webexconnect.io/docs/wxcc-resolve-conversation)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/wxcc-close-task)
  *     * [Authorization](https://help.webexconnect.io/docs/wxcc-close-task#authorization)
    * [Methods and Outcomes](https://help.webexconnect.io/docs/wxcc-close-task#methods-and-outcomes)
