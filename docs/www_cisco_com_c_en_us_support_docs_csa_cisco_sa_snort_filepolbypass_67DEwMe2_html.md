  * [Skip to content](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort-filepolbypass-67DEwMe2.html#eot-doc-wrapper)
  * [Skip to search](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort-filepolbypass-67DEwMe2.html)
  * [Skip to footer](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort-filepolbypass-67DEwMe2.html)
  ...
  * [](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort-filepolbypass-67DEwMe2.html)
  * [Support](https://www.cisco.com/c/en/us/support/index.html)
...
Save
[Log in](https://www.cisco.com/c/login/index.html?referer=/c/en/us/support/docs/csa/cisco-sa-snort-filepolbypass-67DEwMe2.html) to Save Content 
Print
### Available Languages
Updated:April 30, 2021
Document ID:1610556843351528
Bias-Free Language
### Bias-Free Language
...
Last Updated: 
2021 April 30 16:09 GMT
Version 1.1: 
[Final](https://sec.cloudapps.cisco.com/security/center/resources/security_vulnerability_policy.html#final)
Workarounds: 
No workarounds available
Cisco Bug IDs:
[CSCvs71969](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvs71969)
[CSCvu18635](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCvu18635)
[](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort-filepolbypass-67DEwMe2.html)
CVE-2021-1223
[](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort-filepolbypass-67DEwMe2.html)
CWE-693
...
CWE-693
[](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort-filepolbypass-67DEwMe2.html)
[ Download CSAF ](https://sec.cloudapps.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-snort-filepolbypass-67DEwMe2/csaf/cisco-sa-snort-filepolbypass-67DEwMe2.json)
Email 
## 
Summary 
...
Affected Products 
  * ##  Vulnerable Products 
At the time of publication, this vulnerability affected all open source Snort project releases earlier than Release 2.9.17. For more information, see the [Snort website](https://www.snort.org/).
...
At the time of publication, this vulnerability affected the following Cisco products if they were running a release earlier than the first fixed release of Cisco Unified Threat Defense (UTD) Snort Intrusion Protection System (IPS) Engine for Cisco IOS XE Software or Cisco UTD Engine for Cisco IOS XE SD-WAN Software: 
    * 1000 Series Integrated Services Routers (ISRs) 
    * 4000 Series Integrated Services Routers (ISRs) 
    * Cloud Services Router 1000V
    * Integrated Services Virtual Router (ISRv)
For information about which Cisco software releases were vulnerable at the time of publication, see the [Fixed Software](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort-filepolbypass-67DEwMe2.html#fs) section of this advisory. See the Details section in the bug ID(s) at the top of this advisory for the most complete and current information.
##  Products Confirmed Not Vulnerable 
Only products listed in the [Vulnerable Products](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort-filepolbypass-67DEwMe2.html#vp) section of this advisory are known to be affected by this vulnerability.
...
At the time of publication, open source Snort project releases 2.9.17 and later contained the fix for this vulnerability. For more information, see the [Snort website](https://www.snort.org/).
...
| --- | --- | --- | --- | --- |  
| 1.1  | Added Unified Threat Defense release information.  | Vulnerable Products  | Final  | 2021-APR-30  |  
...
## 
Related to This Advisory 
[![Back to Top](https://www.cisco.com/etc/designs/cdc/fw/i/responsive/Default-bTop-36.svg)Back to Top](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort-filepolbypass-67DEwMe2.html "Back to Top")
