[Jump to Content](https://help.webexconnect.io/docs/wxcc-surveys-node-#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Surveys
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/wxcc-surveys-node-)
...
[](https://help.webexconnect.io/docs/wxcc-surveys-node-#accessing-the-product)
...
## 
Prerequisites
[](https://help.webexconnect.io/docs/wxcc-surveys-node-#prerequisites)
...
[](https://help.webexconnect.io/docs/wxcc-surveys-node-#methods-and-outcomes)
...
## 
Authorization
[](https://help.webexconnect.io/docs/wxcc-surveys-node-#authorization)
...
## 
Webex Connect Setup
[](https://help.webexconnect.io/docs/wxcc-surveys-node-#webex-connect-setup)
...
[](https://help.webexconnect.io/docs/wxcc-surveys-node-#chat-setup-in-the-webex-connect-portal)
  1. Login to the Webex Connect platform.
...
[](https://help.webexconnect.io/docs/wxcc-surveys-node-#method-name---create-a-new-survey-token-for-a-questionnaire)
...
[](https://help.webexconnect.io/docs/wxcc-surveys-node-#how-to-fetch-all-questionnaires)
...
Preferred Language: Select the required language. This can be configured from the Surveys platform.  | id - contains the questionnaire token  
...
responsePayload - contains the entire response payload  | onInvalidData  
...
APIRequestLimitExceeded  | v1.0,v1.1,v1.2,v1.3, v1.4 and v1.5  
...
## 
FAQ's
[](https://help.webexconnect.io/docs/wxcc-surveys-node-#faqs)
### 
Where can I call the survey node in the Webex Connect flow?
[](https://help.webexconnect.io/docs/wxcc-surveys-node-#where-can-i-call-the-survey-node-in-the-webex-connect-flow)
...
[](https://help.webexconnect.io/docs/wxcc-surveys-node-#how-can-i-access-authentication-for-the-survey-node-configuration)
You can use the admin account credentials you use to log in to the Contact Center and Control Hub.
Updated 6 months ago
* * *
[Webex Surveys](https://help.webexconnect.io/docs/wxcc-surveys-node)[Flow Configuration using Sample Templates - WXCC](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/wxcc-surveys-node-)
  *     * [Accessing the Product](https://help.webexconnect.io/docs/wxcc-surveys-node-#accessing-the-product)
    * [Prerequisites](https://help.webexconnect.io/docs/wxcc-surveys-node-#prerequisites)
    * [Methods and Outcomes](https://help.webexconnect.io/docs/wxcc-surveys-node-#methods-and-outcomes)
    * [Authorization](https://help.webexconnect.io/docs/wxcc-surveys-node-#authorization)
    * [Webex Connect Setup](https://help.webexconnect.io/docs/wxcc-surveys-node-#webex-connect-setup)
    * [Chat Setup in the Webex Connect Portal](https://help.webexconnect.io/docs/wxcc-surveys-node-#chat-setup-in-the-webex-connect-portal)
    * [Method Name - Create a New Survey Token for a Questionnaire](https://help.webexconnect.io/docs/wxcc-surveys-node-#method-name---create-a-new-survey-token-for-a-questionnaire)
      * [How to Fetch All Questionnaires](https://help.webexconnect.io/docs/wxcc-surveys-node-#how-to-fetch-all-questionnaires)
    * [FAQ's](https://help.webexconnect.io/docs/wxcc-surveys-node-#faqs)
      * [Where can I call the survey node in the Webex Connect flow?](https://help.webexconnect.io/docs/wxcc-surveys-node-#where-can-i-call-the-survey-node-in-the-webex-connect-flow)
      * [How can I access authentication for the Survey Node configuration?](https://help.webexconnect.io/docs/wxcc-surveys-node-#how-can-i-access-authentication-for-the-survey-node-configuration)
