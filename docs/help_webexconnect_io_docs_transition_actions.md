[Jump to Content](https://help.webexconnect.io/docs/transition-actions#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Transition Actions
Search
`CTRL-K`
All
Platform Documentation
...
# Transition Actions
Configure actions to be performed by the flow while moving into/out of a Node
[Suggest Edits](https://help.webexconnect.io/edit/transition-actions)
...
![Screenshot of Node transition actions.](https://files.readme.io/a935960-Transition_Actions.jpg)
Node transition actions
Webex Connect supports four transition actions for each of the nodes:
## 
Set Variable
[](https://help.webexconnect.io/docs/transition-actions#set-variable)
You can use a variable to set a value. This option supports two types of actions:
  * Capture a [node output variable](https://help.webexconnect.io/docs/variable-management) value into a custom variable. This allows data to be passed between flows when a flow is invoked from another flow.
...
| Value  | Set the value that you want to store in the custom variable.  
This is a mandatory field.  |  
| +Add  | Use to add and set multiple custom variable - values.  |  
### 
[DEBUG] Log all Flow Variables to Transaction Log
[](https://help.webexconnect.io/docs/transition-actions#debug-log-all-flow-variables-to-transaction-log)
This action captures a snapshot of all [custom variable](https://help.webexconnect.io/docs/variable-management) values into flow transaction logs for quick view in [debug view](https://help.webexconnect.io/docs/debugging). This action is functional only when you enable the [**Descriptive logging**](https://help.webexconnect.io/docs/flow-settings#section-general) option in Flow settings.
### 
[DEBUG] Log a Value to Transaction Log
[](https://help.webexconnect.io/docs/transition-actions#debug-log-a-value-to-transaction-log)
This action allows you to capture a given variable value into the transaction log for quick validation of the variable value during flow runtime. Flow transaction logs are available in the [debug view](https://help.webexconnect.io/docs/debugging).  
...
| Parameter  | Description  |  
| --- | --- |  
| Log ID  | Provide a Log id for reference within the flow transaction logs against which data is to be logged.  
...
[](https://help.webexconnect.io/docs/transition-actions#log-a-value-to-logbook)
...
![Screenshot of Logging data into a Logbook Attribute.](https://files.readme.io/dae3641-logging_data_logbook_attribute.png)
Logging data into a Logbook Attribute  
| Parameter  | Description  |  
| --- | --- |  
| Logbook  | Select an existing logbook that is mapped to this flow.  |  
| Attribute  | Select the attributes within the logbook into which data must be logged.  
Logbook attributes can be manged from [Tools - Logbooks](https://help.webexconnect.io/docs/logbook#section-custom-attributes)  |  
...
* * *
[Variable Management in Flows](https://help.webexconnect.io/docs/variable-management-in-flows)[Node Transitions](https://help.webexconnect.io/docs/node-transitions)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/transition-actions)
  *     * [Set Variable](https://help.webexconnect.io/docs/transition-actions#set-variable)
      * [DEBUG Log all Flow Variables to Transaction Log](https://help.webexconnect.io/docs/transition-actions#debug-log-all-flow-variables-to-transaction-log)
      * [DEBUG Log a Value to Transaction Log](https://help.webexconnect.io/docs/transition-actions#debug-log-a-value-to-transaction-log)
    * [Log a Value to Logbook](https://help.webexconnect.io/docs/transition-actions#log-a-value-to-logbook)
