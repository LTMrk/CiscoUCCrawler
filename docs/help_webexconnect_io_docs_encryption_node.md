[Jump to Content](https://help.webexconnect.io/docs/encryption-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Encryption Node
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/encryption-node)
...
![Screenshot of Encryption Node.](https://files.readme.io/c255e62-Encryption.png)
Encryption Node
## 
Interface Elements
[](https://help.webexconnect.io/docs/encryption-node#interface-elements)
...
| --- | --- | --- |  
| 1  | Configuration tab  | Use this tab to configure the encryption settings using AMW Key Management Service or Webex Connect encryption.  
...
**Webex Connect encryption method**  
...
[](https://help.webexconnect.io/docs/encryption-node#encrypting-a-text-or-string)
...
[](https://help.webexconnect.io/docs/encryption-node#configuring-encryption-settings)
...
[](https://help.webexconnect.io/docs/encryption-node#configuring-transitions)
...
* * *
[Validate OTP Node](https://help.webexconnect.io/docs/validate-otp-node)[Decryption Node](https://help.webexconnect.io/docs/decryption-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/encryption-node)
  *     * [Interface Elements](https://help.webexconnect.io/docs/encryption-node#interface-elements)
    * [Encrypting a Text or String](https://help.webexconnect.io/docs/encryption-node#encrypting-a-text-or-string)
    * [**Configuring Encryption Settings**](https://help.webexconnect.io/docs/encryption-node#configuring-encryption-settings)
    * [Configuring Transitions](https://help.webexconnect.io/docs/encryption-node#configuring-transitions)
