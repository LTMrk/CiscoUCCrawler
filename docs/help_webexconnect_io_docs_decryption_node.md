[Jump to Content](https://help.webexconnect.io/docs/decryption-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Decryption Node
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/decryption-node)
...
![Screenshot of Decryption Node.](https://files.readme.io/fc94b07-Decryption.png)
Decryption Node
## 
Node Configuration
[](https://help.webexconnect.io/docs/decryption-node#node-configuration)
...
### 
Using AWS-KMS
[](https://help.webexconnect.io/docs/decryption-node#using-aws-kms)
...
[](https://help.webexconnect.io/docs/decryption-node#using--decryption)
...
* * *
[Encryption Node](https://help.webexconnect.io/docs/encryption-node)[Call User Node](https://help.webexconnect.io/docs/call-user-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/decryption-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/decryption-node#node-configuration)
      * [Using AWS-KMS](https://help.webexconnect.io/docs/decryption-node#using-aws-kms)
      * [Using Webex Connect Decryption](https://help.webexconnect.io/docs/decryption-node#using--decryption)
