[Jump to Content](https://help.webexconnect.io/docs/validate-chat-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Validate Chat Node
Search
`CTRL-K`
All
Platform Documentation
...
# Validate Chat Node
Understand what a Validate Chat node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/validate-chat-node)
> ## 📘
> Deprecation Alert
...
![Screenshot of Validate Chat Node](https://files.readme.io/286211c-Validate_Chat.jpg)
Validate Chat Node
## 
Interface Elements
[](https://help.webexconnect.io/docs/validate-chat-node#interface-elements)
...
| --- | --- | --- |  
| 1  | Configuration tab  | Use this tab to configure the validate chat settings.  
...
[](https://help.webexconnect.io/docs/validate-chat-node#passing-values-to-a-live-chat)
You can pass the desired variables to a live chat by configuring them on the Validate chat interface. 
Here are the steps:
## 
**Configuring Variables**
[](https://help.webexconnect.io/docs/validate-chat-node#configuring-variables)
...
[](https://help.webexconnect.io/docs/validate-chat-node#configuring-transitions)
...
* * *
[Create Chat Node](https://help.webexconnect.io/docs/create-chat-node)[Webex Campaign Profile Node](https://help.webexconnect.io/docs/campaign-profile-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/validate-chat-node)
  *     * [Interface Elements](https://help.webexconnect.io/docs/validate-chat-node#interface-elements)
    * [Passing Values to a Live Chat](https://help.webexconnect.io/docs/validate-chat-node#passing-values-to-a-live-chat)
    * [**Configuring Variables**](https://help.webexconnect.io/docs/validate-chat-node#configuring-variables)
    * [Configuring Transitions](https://help.webexconnect.io/docs/validate-chat-node#configuring-transitions)
