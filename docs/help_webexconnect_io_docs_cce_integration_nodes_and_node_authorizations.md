[Jump to Content](https://help.webexconnect.io/docs/cce-integration-nodes-and-node-authorizations#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)CCE Integration Nodes and Node Authorizations
Search
`CTRL-K`
All
Platform Documentation
...
Understand the various integration nodes and node authorizations on Webex Connect.
[Suggest Edits](https://help.webexconnect.io/edit/cce-integration-nodes-and-node-authorizations)
...
## 
Node and Methods
[](https://help.webexconnect.io/docs/cce-integration-nodes-and-node-authorizations#node-and-methods)  
...
|   | Calls Contact Center Enterprise  
Task API to notify Contact Center Enterprise on close task accept  | Close Task Accept  | v1.0  |  
|   | Calls Contact Center Enterprise Task API to notify Contact Center Enterprise on close task reject  | Close Task Reject  | v1.0  |  
## 
Node Authorization
[](https://help.webexconnect.io/docs/cce-integration-nodes-and-node-authorizations#node-authorization)
...
[](https://help.webexconnect.io/docs/cce-integration-nodes-and-node-authorizations#node-authorization-for-cisco-contact-center-enterprise-task-nodes)
...
![Screenshot of Integrations page showing pre-built integrations with pending authorization status.](https://files.readme.io/cf44793-WebexCCE_Authorized.PNG)
Viewing pre-built integrations pending authorization.
![Screenshot of Integrations page showing pre-built integrations with pending authorization status.](https://files.readme.io/46839cf-WebexCCE_Auth_Pending_2.PNG)
Viewing pre-built integrations pending authorization.
...
![Screenshot of Manage Integrations page with Node Authorizations section displaying mapped authorizations for the integration.](https://files.readme.io/ceb78ab-Prebuild_Integration_Manage_Integration.PNG)
...
* * *
[Event Authorization - CCE](https://help.webexconnect.io/docs/cce-event-authorization)[Create Task - CCE](https://help.webexconnect.io/docs/cce-create-task)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/cce-integration-nodes-and-node-authorizations)
  *     * [Node and Methods](https://help.webexconnect.io/docs/cce-integration-nodes-and-node-authorizations#node-and-methods)
    * [Node Authorization](https://help.webexconnect.io/docs/cce-integration-nodes-and-node-authorizations#node-authorization)
    * [Node Authorization for Cisco Contact Center Enterprise Task nodes](https://help.webexconnect.io/docs/cce-integration-nodes-and-node-authorizations#node-authorization-for-cisco-contact-center-enterprise-task-nodes)
