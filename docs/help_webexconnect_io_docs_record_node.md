[Jump to Content](https://help.webexconnect.io/docs/record-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Record Node
Search
`CTRL-K`
All
Platform Documentation
...
# Record Node
Understand what a Record node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/record-node)
The _Record_ node is used to record a message from the caller. You can choose to play an audio message before recording the user's message. For example, record the caller's name when the call comes in.  

The _Record_ node can exist only within the [Voice Node Group](https://help.webexconnect.io/docs/voice-node-group).
![Screenshot of Record Node.](https://files.readme.io/b3706b4-record.png)
Record Node
> ## 📘
...
## 
Node Configuration
[](https://help.webexconnect.io/docs/record-node#node-configuration)
...
![Screenshot of Configuring a Record node.](https://files.readme.io/f4d207a-Record.jpg)
Configuring a Record node
  1. Select the **Play short beep before starting the recording** checkbox if you want to indicate to the user that the recording is about to start after the beep sound. This is optional.
  2. Enter or select details for the following **Recording Settings** : 
...
## 
Input Variables
[](https://help.webexconnect.io/docs/record-node#input-variables)
...
## 
Output Variables
[](https://help.webexconnect.io/docs/record-node#output-variables)
You can see the data that this node generates as output variables. These [variables](https://help.webexconnect.io/docs/variable-management) are available for use in subsequent nodes. The following are the standard output variables for the _Record_ node:
  * **record.recordingFilePath** - stores the path of the file that contains the call recording.

![Screenshot of Record Node Output Variables](https://files.readme.io/161b4e7-Record1.jpg)
Output Variables
## 
Node Outcomes
[](https://help.webexconnect.io/docs/record-node#node-outcomes)
...
## 
Transition Actions
[](https://help.webexconnect.io/docs/record-node#transition-actions)
...
* * *
[Play Node](https://help.webexconnect.io/docs/play-node)[Call Patch Node](https://help.webexconnect.io/docs/call-patch-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/record-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/record-node#node-configuration)
    * [Input Variables](https://help.webexconnect.io/docs/record-node#input-variables)
    * [Output Variables](https://help.webexconnect.io/docs/record-node#output-variables)
    * [Node Outcomes](https://help.webexconnect.io/docs/record-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/record-node#transition-actions)
