[Jump to Content](https://help.webexconnect.io/docs/pre-built-integrations-introduction#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Introduction
Search
`CTRL-K`
All
Platform Documentation
...
# Introduction
Know the pre-built integrations type and how to access them in Webex Connect
[Suggest Edits](https://help.webexconnect.io/edit/pre-built-integrations-introduction)
...
[](https://help.webexconnect.io/docs/pre-built-integrations-introduction#types-of-integration)
...
## 
Getting Started
[](https://help.webexconnect.io/docs/pre-built-integrations-introduction#getting-started)
...
## 
Authorization
[](https://help.webexconnect.io/docs/pre-built-integrations-introduction#authorization)
...
Screenshot of Adding New Authorization
  1. Enter all the required fields. The authorization configuration and the parameters/variables depend on the type of authorization.
  2. Click Authorize.  
...
## 
Manage Integration
[](https://help.webexconnect.io/docs/pre-built-integrations-introduction#manage-integration)
### 
Integration Details
[](https://help.webexconnect.io/docs/pre-built-integrations-introduction#integration-details)
...
### 
Nodes
[](https://help.webexconnect.io/docs/pre-built-integrations-introduction#nodes)
#### 
Node Authorization
[](https://help.webexconnect.io/docs/pre-built-integrations-introduction#node-authorization)
...
#### 
View Node List
[](https://help.webexconnect.io/docs/pre-built-integrations-introduction#view-node-list)
...
### 
Inbound Events
[](https://help.webexconnect.io/docs/pre-built-integrations-introduction#inbound-events)
#### 
Event Authorisation
[](https://help.webexconnect.io/docs/pre-built-integrations-introduction#event-authorisation)
...
#### 
View Event List
[](https://help.webexconnect.io/docs/pre-built-integrations-introduction#view-event-list)
...
[](https://help.webexconnect.io/docs/pre-built-integrations-introduction#validating-signature-while-regenerating-a-secret-key-for-prebuilt-integration)
...
![Screenshot of Manage Integrations](https://files.readme.io/fe5405e-image.png)
Screen shot of Manage Integrations
...
## 
Live Integrations
[](https://help.webexconnect.io/docs/pre-built-integrations-introduction#live-integrations)
...
## 
FAQ
[](https://help.webexconnect.io/docs/pre-built-integrations-introduction#faq)
## 
...
[](https://help.webexconnect.io/docs/pre-built-integrations-introduction#i-want-to-use-an-integration-prebuiltcustomhttp-node-immediately-after-a-social-hour-node-however-im-experiencing-failures-such-as-http-429-status-code-too-many-requests-and-my-flow-execution-stops-what-should-i-do)
...
* * *
[Third-Party Bot](https://help.webexconnect.io/docs/third-party-bot)[Agile CRM](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/pre-built-integrations-introduction)
  *     * [Types of Integration](https://help.webexconnect.io/docs/pre-built-integrations-introduction#types-of-integration)
    * [Getting Started](https://help.webexconnect.io/docs/pre-built-integrations-introduction#getting-started)
    * [Authorization](https://help.webexconnect.io/docs/pre-built-integrations-introduction#authorization)
    * [Manage Integration](https://help.webexconnect.io/docs/pre-built-integrations-introduction#manage-integration)
      * [Integration Details](https://help.webexconnect.io/docs/pre-built-integrations-introduction#integration-details)
      * [Nodes](https://help.webexconnect.io/docs/pre-built-integrations-introduction#nodes)
      * [Inbound Events](https://help.webexconnect.io/docs/pre-built-integrations-introduction#inbound-events)
      * [Validating Signature while regenerating a Secret key for Prebuilt Integration](https://help.webexconnect.io/docs/pre-built-integrations-introduction#validating-signature-while-regenerating-a-secret-key-for-prebuilt-integration)
    * [Live Integrations](https://help.webexconnect.io/docs/pre-built-integrations-introduction#live-integrations)
    * [FAQ](https://help.webexconnect.io/docs/pre-built-integrations-introduction#faq)
    * [I want to use an Integration (Prebuilt/Custom/HTTP) node immediately after a Social Hour node. However, I'm experiencing failures such as HTTP 429 Status Code ("Too Many Requests") and my flow execution stops. What should I do?](https://help.webexconnect.io/docs/pre-built-integrations-introduction#i-want-to-use-an-integration-prebuiltcustomhttp-node-immediately-after-a-social-hour-node-however-im-experiencing-failures-such-as-http-429-status-code-too-many-requests-and-my-flow-execution-stops-what-should-i-do)
