[Jump to Content](https://help.webexconnect.io/docs/create-brand#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Creating a Brand
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/create-brand)
Learn how to create a Brand on the Webex Connect platform. This process is essential for registering your organization with The Campaign Registry (TCR) to enable 10DLC messaging campaigns.
> ## 🚧
...
![Screenshot displaying a List of Brands.](https://files.readme.io/79f574d-4.jpg)
Displaying a List of Brands
  1. Enter details or select an option from the drop-down menu. The **Create New Brand** form asks you to provide comprehensive details about your company. The fields displayed may vary based on your selected 'Type of Organization.'

![Screenshot of Create the New Brand Page.](https://files.readme.io/03a33862a6955ee277ae5c311d97b538bd38dbd2770fe2dbc2b5beead492d0e8-Picture_1.png)
...
>       * **Mandatory Fields** : For detailed information on the mandatory fields for each organization type, refer to [Details for Creating Brands](https://help.webexconnect.io/docs/details-for-creating-brands).
  ...
  1. Click **Create**.The **Create** button is enabled only when correct details are filled in for all the mandatory fields.
  2. After the Brand form is successfully submitted, the status of the brand can be seen on the **Brand Listing** page and the **Brand Management** page. In addition, the tenant owner, the tenant user, and the Support contact provided in the Brand  
Creation Form will receive Brand status email notifications.


Updated 10 months ago
* * *
[Limitations and FAQs](https://help.webexconnect.io/docs/limitations-and-faqs)[Details for Creating Brands](https://help.webexconnect.io/docs/details-for-creating-brands)
