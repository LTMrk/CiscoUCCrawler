[Jump to Content](https://help.webexconnect.io/docs/call-patch-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Call Patch Node
Search
`CTRL-K`
All
Platform Documentation
...
# Call Patch Node
Understand what a Call Patch node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/call-patch-node)
...
![Screenshot of Call Patch Node](https://files.readme.io/5370070-call-patch-node.png)
Call Patch Node
> ## 📘
...
## 
Node Configuration
[](https://help.webexconnect.io/docs/call-patch-node#node-configuration)
...
> The Destination number should be in E.164 format. In case of any errors in format the node will exit through ErrorEdge.
  1. Select the **Display Number** from the drop-down list box. This is the phone number that is displayed to the customer. Only voice numbers provisioned to your account under **Assets** > **Numbers** are listed in this drop-down list box.
  2. Enter **Display Name**. It will be enabled when the display number or display name is enabled at the call user node. Enter a specific business name to be displayed during a call on the handset of the customer. The field limit is 10 digits.
...
![Screenshot of Configuring a Call Patch Node](https://files.readme.io/14a35a8-Call_Patch.jpg)
Call Patch Node Configuration
  1. Check **Transfer DTMFs pressed after call patch by A-party to B-party and/or vice versa. If announcement loop is enabled these DTMFs will be transferred only after the loop has been exited** if you want to mandate customer's every DTMF key input to be transferred to the agent. If the option is not selected, no DTMF inputs from the customers will be considered for transfer to the agent. This option is useful for cases where the agent is required to transfer the call to the payment IVR and DTMF key inputs are required from the customers.
  2. Check **Record the call upon successfully patching both calls** to record the call once it gets connected to the B party. The recording is saved to **Voice recordings** in the **Tools** section with the configured prefix and a unique node transaction id (NodeTID). You can download or ship them to FTP/SFTP/S3 location.
  3. Click **Save** to complete the configuration.


## 
Input Variables
[](https://help.webexconnect.io/docs/call-patch-node#input-variables)
...
You can see the list of variables that you explicitly create and configure for this node under the **Custom Variables** pane. You can also add a custom variable to the flow using the **Add New Custom Variable** button. For more information, see [Custom Variables](https://help.webexconnect.io/docs/variable-management#section-custom-variables).
## 
Output Variables
[](https://help.webexconnect.io/docs/call-patch-node#output-variables)
You can see the data that this node generates as output variables. These [variables](https://help.webexconnect.io/docs/variable-management) are available for use in subsequent nodes. The following are the standard output variables for the _Call Patch_ node:
...
![Screenshot of Call Patch Output Variables](https://files.readme.io/f6be5a7-Call_Patch1.jpg)
Output Variables
## 
Node Outcomes
[](https://help.webexconnect.io/docs/call-patch-node#node-outcomes)
...
## 
Transition Actions
[](https://help.webexconnect.io/docs/call-patch-node#transition-actions)
...
* * *
[Record Node](https://help.webexconnect.io/docs/record-node)[IVR Menu Node](https://help.webexconnect.io/docs/ivr-menu-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/call-patch-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/call-patch-node#node-configuration)
    * [Input Variables](https://help.webexconnect.io/docs/call-patch-node#input-variables)
    * [Output Variables](https://help.webexconnect.io/docs/call-patch-node#output-variables)
    * [Node Outcomes](https://help.webexconnect.io/docs/call-patch-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/call-patch-node#transition-actions)
