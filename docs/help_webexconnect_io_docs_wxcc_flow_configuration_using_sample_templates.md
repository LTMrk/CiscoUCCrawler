[Jump to Content](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Flow Configuration using Sample Templates - WXCC
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/wxcc-flow-configuration-using-sample-templates)
...
![](https://files.readme.io/208e992-1.jpg)
  ...
  2. Click **Create Flow**.
  3. Provide a name for the flow.
  4. Select **Upload a flow** in the Method drop-down.
  5. Click **Choose File** to upload the required file.
...
![Screenshot displaying the Create Flow button on the interface.](https://files.readme.io/32d424e-CISCO_WEBEX_CONTACT_CENTER__IMICONNECT_INTEGRATION_Flow_Configuration_using_Sample_Templates_Create.png)
Screenshot showing Create Floe
> ## 📘
> Note
...
## 
Configure Flows
[](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates#configure-flows)
...
[](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates#understanding-representative-flows)
Here's a high level overview of the logic configured in each of the representative flows:
### 
FBM Inbound Message Flow
[](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates#fbm-inbound-message-flow)
...
![Screenshot of FBM Inbound Message Flow](https://files.readme.io/0808ded-MicrosoftTeams-image_6.png)
FBM Inbound Message Flow
...
## 
Routed Flow
[](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates#routed-flow)
...
![Screenshot of Task routed flow](https://files.readme.io/0f9682fc6a5a3429647d46fa866acaf0cc08f7e03e652d6682d2499d88788a31-image.png)
Task routed flow
## 
Task Modified
[](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates#task-modified)
...
This flow is channel-agnostic but the flow designer can choose to make it channel-specific by applying conditions in the Start node. 
![Screenshot of Task modified](https://files.readme.io/9719a73feac4d4d4d6b7e7ce7f4bc172ba3f8a08ef3af9a360ef2166c08c031f-image.png)
Task modified flow
## 
Close Task
[](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates#close-task)
...
This flow is channel-agnostic but the flow designer can choose to make it channel-specific by applying conditions in the Start node. 
![Screenshot of Close task node](https://files.readme.io/8f7a0d16f1ee7728a40bda257b40348e6ab2e69c8de5ccac921f28703fa9172f-image.png)
Close task flow
## 
Livechat Inbound Message Flow
[](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates#livechat-inbound-message-flow)
...
* * *
[Surveys](https://help.webexconnect.io/docs/wxcc-surveys-node-)[Proactive chat - Flows - WXCC](https://help.webexconnect.io/docs/wxcc-proactive-chat-flows)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates)
  *     * [Configure Flows](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates#configure-flows)
    * [Understanding Representative Flows](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates#understanding-representative-flows)
      * [FBM Inbound Message Flow](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates#fbm-inbound-message-flow)
    * [Routed Flow](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates#routed-flow)
    * [Task Modified](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates#task-modified)
    * [Close Task](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates#close-task)
    * [Livechat Inbound Message Flow](https://help.webexconnect.io/docs/wxcc-flow-configuration-using-sample-templates#livechat-inbound-message-flow)
