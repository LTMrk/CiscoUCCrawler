[Jump to Content](https://help.webexconnect.io/docs/cce-whatsapp#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)WhatsApp - CCE
Search
`CTRL-K`
All
Platform Documentation
...
# WhatsApp - CCE
Learn about the procedure for app asset configuration for the WhatsApp channel.
[Suggest Edits](https://help.webexconnect.io/edit/cce-whatsapp)
...
You may view the following sections:
  ...
  * [Configure WhatsApp App Asset on <](https://help.webexconnect.io/docs/whatsapp-cce#configure-whatsapp-app-asset-on-webex-connect)
...
[](https://help.webexconnect.io/docs/cce-whatsapp#register-for-an-official-account-on-whatsapp)
> ## 📘
...
[](https://help.webexconnect.io/docs/cce-whatsapp#configure-whatsapp-app-asset-on-webex-connect)
...
## 
Embedded Sign-up
[](https://help.webexconnect.io/docs/cce-whatsapp#embedded-sign-up)
...
### 
Prerequisites
[](https://help.webexconnect.io/docs/cce-whatsapp#prerequisites)
...
[](https://help.webexconnect.io/docs/cce-whatsapp#embedded-sign-up-onboarding)
  1. If you select **Sign-in with Facebook**.  
A pop-up appears.

![Sign-in with Facebook](https://files.readme.io/1c2225e-WxccWhatsApp1.jpg)
...
[](https://help.webexconnect.io/docs/cce-whatsapp#what-is-phone-number-display-name)
...
[](https://help.webexconnect.io/docs/cce-whatsapp#business-verification-and-display-name-review)
...
## 
Manual Sign-up
[](https://help.webexconnect.io/docs/cce-whatsapp#manual-sign-up)
...
## 
Local Storage
[](https://help.webexconnect.io/docs/cce-whatsapp#local-storage)
...
[](https://help.webexconnect.io/docs/cce-whatsapp#whatsapp-official-business-account-oba-eligibility-and-application-process)
...
[](https://help.webexconnect.io/docs/cce-whatsapp#registering-your-whatsapp-app-asset-with-webex-engage)
...
[](https://help.webexconnect.io/docs/cce-whatsapp#start-messaging-immediately)
...
[](https://help.webexconnect.io/docs/cce-whatsapp#editmanagedelete-the-whatsapp-app-asset)
  1. Go to **Assets** > **Apps**.
...
### 
Delete WhatsApp App
[](https://help.webexconnect.io/docs/cce-whatsapp#delete-whatsapp-app)
  1. Go to Assets > Apps.
...
[](https://help.webexconnect.io/docs/cce-whatsapp#disable-the-two-factor-authentication-pin-from-whatsapp-manager)
...
![Navigating to WhatsApp Manager >Phone numbers](https://files.readme.io/27a16e1-d2464bcc-e8f2-4cab-95ba-e424fa7887b2.png)
...
[](https://help.webexconnect.io/docs/cce-whatsapp#waba-accountnumber-updates)
...
### 
Learn more
[](https://help.webexconnect.io/docs/cce-whatsapp#learn-more)
...
[](https://help.webexconnect.io/docs/cce-whatsapp#business-account-settings)
...
## 
Using the Channel
[](https://help.webexconnect.io/docs/cce-whatsapp#using-the-channel)
### 
User Preference
[](https://help.webexconnect.io/docs/cce-whatsapp#user-preference)
...
[](https://help.webexconnect.io/docs/cce-whatsapp#managing-user-preferences-for-marketing-messages-on-whatsapp)
...
[](https://help.webexconnect.io/docs/cce-whatsapp#configuring-outbound-webhook-for-whatsapp)
...
* * *
[Facebook Messenger - CCE](https://help.webexconnect.io/docs/cce-facebook-messenger)[WhatsApp Usernames and Business-Scoped User IDs (BSUID) - CCE](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/cce-whatsapp)
  *     * [Register for an Official Account on WhatsApp](https://help.webexconnect.io/docs/cce-whatsapp#register-for-an-official-account-on-whatsapp)
    * [Configure WhatsApp App Asset on Webex Connect](https://help.webexconnect.io/docs/cce-whatsapp#configure-whatsapp-app-asset-on-webex-connect)
    * [Embedded Sign-up](https://help.webexconnect.io/docs/cce-whatsapp#embedded-sign-up)
      * [Prerequisites](https://help.webexconnect.io/docs/cce-whatsapp#prerequisites)
      * [Embedded Sign-up Onboarding](https://help.webexconnect.io/docs/cce-whatsapp#embedded-sign-up-onboarding)
      * [What is Phone Number Display Name?](https://help.webexconnect.io/docs/cce-whatsapp#what-is-phone-number-display-name)
      * [Business verification and Display Name review](https://help.webexconnect.io/docs/cce-whatsapp#business-verification-and-display-name-review)
    * [Manual Sign-up](https://help.webexconnect.io/docs/cce-whatsapp#manual-sign-up)
    * [Local Storage](https://help.webexconnect.io/docs/cce-whatsapp#local-storage)
    * [WhatsApp Official Business Account (OBA) Eligibility and Application Process](https://help.webexconnect.io/docs/cce-whatsapp#whatsapp-official-business-account-oba-eligibility-and-application-process)
    * [Registering your WhatsApp App Asset with Webex Engage](https://help.webexconnect.io/docs/cce-whatsapp#registering-your-whatsapp-app-asset-with-webex-engage)
    * [Start messaging immediately](https://help.webexconnect.io/docs/cce-whatsapp#start-messaging-immediately)
    * [Edit/Manage/Delete the WhatsApp App Asset](https://help.webexconnect.io/docs/cce-whatsapp#editmanagedelete-the-whatsapp-app-asset)
      * [Delete WhatsApp App](https://help.webexconnect.io/docs/cce-whatsapp#delete-whatsapp-app)
      * [WABA Account/number updates](https://help.webexconnect.io/docs/cce-whatsapp#waba-accountnumber-updates)
      * [Learn more](https://help.webexconnect.io/docs/cce-whatsapp#learn-more)
    * [Business Account Settings](https://help.webexconnect.io/docs/cce-whatsapp#business-account-settings)
    * [Using the Channel](https://help.webexconnect.io/docs/cce-whatsapp#using-the-channel)
      * [User Preference](https://help.webexconnect.io/docs/cce-whatsapp#user-preference)
      * [Managing User Preferences for Marketing Messages on WhatsApp](https://help.webexconnect.io/docs/cce-whatsapp#managing-user-preferences-for-marketing-messages-on-whatsapp)
      * [Configuring Outbound Webhook for WhatsApp](https://help.webexconnect.io/docs/cce-whatsapp#configuring-outbound-webhook-for-whatsapp)
