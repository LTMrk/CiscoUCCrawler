[Jump to Content](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)WhatsApp Usernames and Business-Scoped User IDs (BSUID) - CCE
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce)
## 
Introduction:
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#introduction)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#understanding-bsuid-elements)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#identifier-priority--data-sharing)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#summary-checklist-for-developers)  
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#bsuid-support-in-the-platform-components)  
| Component  | Update  |  
| --- | --- |  
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#future-implementation-roadmap-whatsapp-bsuid--username-integration)
...
### 
Strategic Objective
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#strategic-objective)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#inbound-normalization--visibility)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#outbound-compatibility)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#sessioning--data-hierarchy)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#client-impact--action-plan)  
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#what-is-contact-book)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#scenario-1-existing-customers-customers-who-have-interacted-with-you-prior-to-april)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#scenario-2-new-customers-customers-who-have-not-interacted-with-you)
...
### 
Limitations
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#limitations)
...
* * *
[WhatsApp - CCE](https://help.webexconnect.io/docs/cce-whatsapp)[Local Storage - CCE](https://help.webexconnect.io/docs/cce-local-storage)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce)
  *     * [Introduction:](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#introduction)
    * [Understanding BSUID elements:](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#understanding-bsuid-elements)
    * [Identifier Priority & Data Sharing](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#identifier-priority--data-sharing)
      * [Summary Checklist for Developers](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#summary-checklist-for-developers)
    * [BSUID Support in the platform components:](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#bsuid-support-in-the-platform-components)
    * [Future Implementation Roadmap: WhatsApp BSUID & Username Integration](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#future-implementation-roadmap-whatsapp-bsuid--username-integration)
      * [Strategic Objective](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#strategic-objective)
      * [Inbound Normalization & Visibility](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#inbound-normalization--visibility)
      * [Outbound Compatibility](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#outbound-compatibility)
      * [Sessioning & Data Hierarchy](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#sessioning--data-hierarchy)
      * [Client Impact & Action Plan](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#client-impact--action-plan)
    * [What is Contact Book?](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#what-is-contact-book)
      * [Scenario 1: Existing Customers (Customers who have interacted with you prior to April)](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#scenario-1-existing-customers-customers-who-have-interacted-with-you-prior-to-april)
      * [Scenario 2: New Customers (Customers who have not interacted with you)](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#scenario-2-new-customers-customers-who-have-not-interacted-with-you)
      * [Limitations](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce#limitations)
