[Jump to Content](https://help.webexconnect.io/docs/migration-from-on-prem-to-cloud-api#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Migration from On-premise API to Cloud API (Deprecated)
Search
`CTRL-K`
All
Platform Documentation
...
Know how you can easily migrate from On-premise API to Cloud API
[Suggest Edits](https://help.webexconnect.io/edit/migration-from-on-prem-to-cloud-api)
## 
Migration from On-Premise API to Cloud API
[](https://help.webexconnect.io/docs/migration-from-on-prem-to-cloud-api#migration-from-on-premise-api-to-cloud-api)
...
Screenshot of WhatsApp Manage Page.
  1. Select the Verification Method by which you want to confirm.
  2. Click Migrate to Cloud API.

![Popup of Migrate to Cloud API](https://files.readme.io/0d8511e-WhatsApp_onprem1.png)
Popup of Migrate to Cloud API.
  1. Click Confirm. A confirmation message is displayed.


### 
Advantages of Cloud API
[](https://help.webexconnect.io/docs/migration-from-on-prem-to-cloud-api#advantages-of-cloud-api)
...
[](https://help.webexconnect.io/docs/migration-from-on-prem-to-cloud-api#disabling-2fa-authentication-pin)
...
* * *
[WhatsApp Usernames and Business-Scoped User IDs (BSUID)](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid)[Local Storage](https://help.webexconnect.io/docs/whatsapp-local-storage)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/migration-from-on-prem-to-cloud-api)
  *     * [Migration from On-Premise API to Cloud API](https://help.webexconnect.io/docs/migration-from-on-prem-to-cloud-api#migration-from-on-premise-api-to-cloud-api)
      * [Advantages of Cloud API](https://help.webexconnect.io/docs/migration-from-on-prem-to-cloud-api#advantages-of-cloud-api)
    * [Disabling 2FA Authentication Pin](https://help.webexconnect.io/docs/migration-from-on-prem-to-cloud-api#disabling-2fa-authentication-pin)
