[Jump to Content](https://help.webexconnect.io/docs/wxcc-routed-notification#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Routed Notification - WXCC
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/wxcc-routed-notification)
...
## 
Authorization
[](https://help.webexconnect.io/docs/wxcc-routed-notification#authorization)
...
[](https://help.webexconnect.io/docs/wxcc-routed-notification#methods-and-outcomes)
...
| --- | --- | --- |  
| Routed Accepted  | None  |  _onInvalidData  
_ onError  
 _onInvalidChoice  
_ onauthorizationfail  
 _onTaskRoutedFailure  
_ onTaskRouted  
* onTimeout  |  
| Channel  | Field Value  |  
| --- | --- |  
| All channels  | TASK ID - $(n2.webex.ID)  
ID - $(n2.webex.ID)  
...
>  
> _ MediaType from the output variables of the routed event is the Media Type  | None  | v1.1 and v1.0  |  
> ## 📘
> Note:
...
## 
Routed Rejected
[](https://help.webexconnect.io/docs/wxcc-routed-notification#routed-rejected)
...
| Method Name  | Output Variables  | Node Outcomes  |  
| --- | --- | --- |  
| Routing Reject  | None  |  _onInvalidData  
_ onError  
 _onInvalidChoice  
_ onauthorizationfail  
 _onTaskRoutedFailure  
...
* * *
[PIQ and EWT - WXCC](https://help.webexconnect.io/docs/wxcc-piq-and-ewt)[Modify Notification - WXCC](https://help.webexconnect.io/docs/wxcc-modify-notification)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/wxcc-routed-notification)
  *     * [Authorization](https://help.webexconnect.io/docs/wxcc-routed-notification#authorization)
    * [Methods and Outcomes](https://help.webexconnect.io/docs/wxcc-routed-notification#methods-and-outcomes)
    * [Routed Rejected](https://help.webexconnect.io/docs/wxcc-routed-notification#routed-rejected)
