[Jump to Content](https://help.webexconnect.io/docs/send-voice-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Send Voice Node [Deprecated]
Search
`CTRL-K`
All
Platform Documentation
...
Understand what a Send Voice node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/send-voice-node)
> ## ❗️
> Deprecation Alert
...
![Screenshot of Send Voice Node](https://files.readme.io/f215893-Voice.png)
Send Voice Node
## 
Node Configuration
[](https://help.webexconnect.io/docs/send-voice-node#node-configuration)
...
| --- | --- | --- |  
| 1  | Configuration tab  | Use this tab to configure the message settings.  
...
[](https://help.webexconnect.io/docs/send-voice-node#configuring-voice-calls)
...
[](https://help.webexconnect.io/docs/send-voice-node#triggering-voice-flow)
...
### 
Playing Media File
[](https://help.webexconnect.io/docs/send-voice-node#playing-media-file)
  1. Double click the **Voice** node.  
The Voice screen appears. 
  2. On the **Voice** screen: 
...
[](https://help.webexconnect.io/docs/send-voice-node#configuring-transitions-actions)
...
* * *
[Intent Node](https://help.webexconnect.io/docs/intent-node)[Registry Node [Deprecated]](https://help.webexconnect.io/docs/registry-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/send-voice-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/send-voice-node#node-configuration)
    * [Configuring Voice Calls](https://help.webexconnect.io/docs/send-voice-node#configuring-voice-calls)
      * [Triggering Voice Flow](https://help.webexconnect.io/docs/send-voice-node#triggering-voice-flow)
      * [Playing Media File](https://help.webexconnect.io/docs/send-voice-node#playing-media-file)
      * [Configuring Transitions Actions](https://help.webexconnect.io/docs/send-voice-node#configuring-transitions-actions)
