[Jump to Content](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Best Practices to Improve Email Deliverability
Search
`CTRL-K`
All
Platform Documentation
...
Best practices for improving email deliverability with AWS SES, including domain verification, DKIM, SPF, DMARC, custom MAIL FROM, and unsubscribe guidelines.
[Suggest Edits](https://help.webexconnect.io/edit/best-practices-to-improve-email-deliverability)
...
[](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#follow-email-authentication-best-practices)
### 
Finish Domain Verification
[](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#finish-domain-verification)
...
[](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#set-up-dkim-to-protect-your-domain-against-spoofing)
...
[](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#sender-policy-framework-spf-authentication)
...
[](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#set-up-a-dmarc-policy)
...
[](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#complying-with-dmarc-through-dkim)
...
[](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#complying-with-dmarc-through-spf)
...
[](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#add-custom-mail-from-domain)
...
![An email received with a Custom MAIL FROM configured \(see "mailed-by" field\)](https://files.readme.io/dc1a53756a572c0b054e52f5fa7b61630994c6e6dc82b0fc99999280dc9446ef-email_domain_2.png)
...
[](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#reverse-dns-and-pointer-records-ptr)
...
[](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#provide-easy-unsubscribe-options)
...
[](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#ensure-youre-sending-solicited-emails)
This apart, Gmail recommends the following best practices that we highly encourage clients to follow:
  ...
  * Messages of the same category should have the same From: email address. For example, messages from a domain called solarmora.com might have From: addresses like: 
    * Account notification messages: alert@domain.tld
    * Sales receipt messages: sales@domain.tld
...
[](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#errors-in-case-of-not-meeting-the-minimum-authentication-requirements)
...
* * *
[Email](https://help.webexconnect.io/docs/email)[Configuring Branded Mail in Apple Business Connect](https://help.webexconnect.io/docs/configuring-branded-mail-in-apple-business-connect)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability)
  *     * [Follow-Email Authentication best practices](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#follow-email-authentication-best-practices)
      * [Finish Domain Verification](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#finish-domain-verification)
      * [Set-up DKIM to protect your domain against spoofing](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#set-up-dkim-to-protect-your-domain-against-spoofing)
      * [Sender Policy Framework (SPF) authentication](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#sender-policy-framework-spf-authentication)
      * [Set-Up a DMARC Policy](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#set-up-a-dmarc-policy)
      * [Complying with DMARC through DKIM](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#complying-with-dmarc-through-dkim)
      * [Complying with DMARC through SPF](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#complying-with-dmarc-through-spf)
      * [Add Custom MAIL FROM domain](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#add-custom-mail-from-domain)
      * [Reverse DNS and Pointer Records (PTR)](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#reverse-dns-and-pointer-records-ptr)
    * [Provide easy unsubscribe options](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#provide-easy-unsubscribe-options)
    * [Ensure you’re sending solicited emails.](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#ensure-youre-sending-solicited-emails)
    * [Errors in case of not meeting the minimum authentication requirements](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability#errors-in-case-of-not-meeting-the-minimum-authentication-requirements)
