[Jump to Content](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)WhatsApp Usernames and Business-Scoped User IDs (BSUID)
Search
`CTRL-K`
All
Platform Documentation
...
Understanding WhatsApp Usernames and Business-Scoped User IDs (BSUID) functionalities
[Suggest Edits](https://help.webexconnect.io/edit/whatsapp-usernames-and-business-scoped-user-ids-bsuid)
## 
Introduction:
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#introduction)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#understanding-bsuid-elements)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#identifier-priority--data-sharing)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#summary-checklist-for-developers)  
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#bsuid-support-in-the-platform-components)  
| Component  | Update  |  
| --- | --- |  
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#bsuid-support-in-contact-policy-and-event-scheduler)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#future-implementation-roadmap-whatsapp-bsuid--username-integration)
...
### 
Strategic Objective
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#strategic-objective)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#inbound-normalization--visibility)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#outbound-compatibility)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#sessioning--data-hierarchy)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#client-impact--action-plan)  
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#what-is-contact-book)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#scenario-1-existing-customers-customers-who-have-interacted-with-you-prior-to-april)
...
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#scenario-2-new-customers-customers-who-have-not-interacted-with-you)
...
### 
Limitations
[](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#limitations)
...
* * *
[WhatsApp](https://help.webexconnect.io/docs/whatsapp)[Migration from On-premise API to Cloud API (Deprecated)](https://help.webexconnect.io/docs/migration-from-on-prem-to-cloud-api)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid)
  *     * [Introduction:](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#introduction)
    * [Understanding BSUID elements:](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#understanding-bsuid-elements)
    * [Identifier Priority & Data Sharing](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#identifier-priority--data-sharing)
      * [Summary Checklist for Developers](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#summary-checklist-for-developers)
    * [BSUID Support in the platform components:](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#bsuid-support-in-the-platform-components)
    * [BSUID Support in Contact Policy and Event Scheduler](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#bsuid-support-in-contact-policy-and-event-scheduler)
    * [Future Implementation Roadmap: WhatsApp BSUID & Username Integration](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#future-implementation-roadmap-whatsapp-bsuid--username-integration)
      * [Strategic Objective](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#strategic-objective)
      * [Inbound Normalization & Visibility](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#inbound-normalization--visibility)
      * [Outbound Compatibility](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#outbound-compatibility)
      * [Sessioning & Data Hierarchy](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#sessioning--data-hierarchy)
      * [Client Impact & Action Plan](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#client-impact--action-plan)
    * [What is Contact Book?](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#what-is-contact-book)
      * [Scenario 1: Existing Customers (Customers who have interacted with you prior to April)](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#scenario-1-existing-customers-customers-who-have-interacted-with-you-prior-to-april)
      * [Scenario 2: New Customers (Customers who have not interacted with you)](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#scenario-2-new-customers-customers-who-have-not-interacted-with-you)
      * [Limitations](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid#limitations)
