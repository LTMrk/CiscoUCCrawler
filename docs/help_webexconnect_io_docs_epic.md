[Jump to Content](https://help.webexconnect.io/docs/epic#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)EPIC
Search
`CTRL-K`
All
Platform Documentation
...
# EPIC
Use this node to manage patient appointments and related tasks in EPIC Systems.
[Suggest Edits](https://help.webexconnect.io/edit/epic)
## 
Introduction
[](https://help.webexconnect.io/docs/epic#introduction)
...
## 
Pre-requisites
[](https://help.webexconnect.io/docs/epic#pre-requisites)
...
## 
Use Cases
[](https://help.webexconnect.io/docs/epic#use-cases)
### 
Appointment Management
[](https://help.webexconnect.io/docs/epic#appointment-management)
...
### 
Patient Management
[](https://help.webexconnect.io/docs/epic#patient-management)
...
Updated 20 days ago
* * *
[Link Shortener](https://help.webexconnect.io/docs/link-shortener)[Patient Match (EPIC EHR) Flow Template](https://help.webexconnect.io/docs/patient-match-epic-ehr-flow-template)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/epic)
  *     * [Introduction](https://help.webexconnect.io/docs/epic#introduction)
    * [Pre-requisites](https://help.webexconnect.io/docs/epic#pre-requisites)
    * [Use Cases](https://help.webexconnect.io/docs/epic#use-cases)
      * [Appointment Management](https://help.webexconnect.io/docs/epic#appointment-management)
      * [Patient Management](https://help.webexconnect.io/docs/epic#patient-management)
