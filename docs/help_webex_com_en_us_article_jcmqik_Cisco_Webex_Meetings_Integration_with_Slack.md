...
[+1-888-469-3239](tel:+1-888-469-3239)[Contact Sales →](https://www.webex.com/contact-sales.html)
  ...
  * ![Cisco AI Assistant for Webex](https://help.webex.com/images/cisco-ai-assistance.svg)
  * English
    * [ Dansk ](https://help.webex.com/da-dk/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Deutsch ](https://help.webex.com/de-de/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ English ](https://help.webex.com/en-us/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)![language tick](https://help.webex.com/images/checkbox-check.svg)
    * [ Español ](https://help.webex.com/es-co/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Français ](https://help.webex.com/fr-fr/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Italiano ](https://help.webex.com/it-it/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Nederlands ](https://help.webex.com/nl-nl/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Português ](https://help.webex.com/pt-br/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Pyccĸий ](https://help.webex.com/ru-ru/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Svenska ](https://help.webex.com/sv-se/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Tϋrkçe ](https://help.webex.com/tr-tr/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ 한국어 ](https://help.webex.com/ko-kr/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ 日本語 ](https://help.webex.com/ja-jp/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ 简体中文 ](https://help.webex.com/zh-cn/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ 繁體中文 ](https://help.webex.com/zh-tw/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Română ](https://help.webex.com/ro-ro/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Magyar ](https://help.webex.com/hu-hu/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Polski ](https://help.webex.com/pl-pl/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Čeština ](https://help.webex.com/cs-cz/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Български ](https://help.webex.com/bg-bg/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Norsk ](https://help.webex.com/no-no/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Hrvatski ](https://help.webex.com/hr-hr/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Srpski ](https://help.webex.com/sr-rs/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Українська ](https://help.webex.com/uk-ua/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ العربية ](https://help.webex.com/ar-ae/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ עברית ](https://help.webex.com/he-il/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Suomi ](https://help.webex.com/fi-fi/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Slovenščina ](https://help.webex.com/sl-si/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
    * [ Slovenský ](https://help.webex.com/sk-sk/article/jcmqik/Cisco-Webex-Meetings-Integration-with-Slack)
  * Sign In
...
April 11, 2026 | 77903 view(s) | 304 people thought this was helpful
...
The Meetings integration lets you start and join a Personal Room or scheduled meeting directly from the Slack app. Easily share your Personal Room link, or link to a scheduled meeting in a channel. You can also click the call button to instantly start a meeting and share your Personal Room link to the channel. 
  * [](https://help.webex.com/en-us/article/n9e61edb/Webex-Meetings-integration-with-Slack#Cisco_Concept.dita_a02eb6ba-6b74-421b-b1bb-2563f00c79a0)
  * [](https://help.webex.com/en-us/article/n9e61edb/Webex-Meetings-integration-with-Slack#Cisco_Reference.dita_67799809-1b84-4950-b142-895bd5312a8f)


![Images shows a collage of ways that you can schedule, start, join, and cancel Webex Meetings in Slack.](https://cisco-api.ingeniuxondemand.com/DITA/content/en/us/td/i/400001-500000/460001-470000/466001-467000/466141.jpg)
## What's new
Webex Meetings for Slack feature announcements are included in [What's new for the latest channel of Webex Meetings](https://help.webex.com/en-us/xcwws1/), which updates each month for every new release. Make sure to subscribe to it so you can stay up-to-date.
View archive (41.5 and older) [here](https://help.webex.com/en-us/7dxdzp/).
## Install and setup 
Before Slack users can use Meetings, Webex site administrators must enable the integration before your Slack administrator can install the app. Users also need to have a host account on a valid Webex site. Slack administrators, workspace owners, and Webex site administrators can follow the steps below to get Meetings up and running.
  * [Install and set up Webex Meetings for Slack](https://help.webex.com/en-us/5l2yjp/)
...
Now that you're all set up, get acquainted with the Meetings app commands and scheduling meetings in Slack. View a list of upcoming meetings and easily join when you're ready. You can also start or cancel meetings you scheduled.
  * [Schedule, start, and join Webex Meetings](https://help.webex.com/en-us/nsuguis/)
...
## Contact support
Contacting support varies depending on your Webex site and service provider. If you purchased Meetings through a partner or reseller, contact their support desk for assistance. Refer to [this article](https://help.webex.com/en-us/WBX162/) for reaching support.
Was this article helpful?
Yes, thank you!
Not really
Was this article helpful?
...
![](https://help.webex.com/images/arrow-down_20.svg)
  ...
  * [Koristite serije Board, Desk i Room sa aplikacijom Webex](https://help.webex.com/en-us/article/nj0al88)
