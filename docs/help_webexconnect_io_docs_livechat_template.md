[Jump to Content](https://help.webexconnect.io/docs/livechat-template#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Live Chat/In-App Messaging
Search
`CTRL-K`
All
Platform Documentation
...
Learn how you can create and manage Live Chat/In-App message templates.
[Suggest Edits](https://help.webexconnect.io/edit/livechat-template)
![Live Chat/In-App Message Configuration](https://files.readme.io/5ce9b0d-Live_Chat.png)
Screenshot of Live Chat/In-App Message Configuration
> ## 📘
> Sending Messages
...
[](https://help.webexconnect.io/docs/livechat-template#configure-richtext-message)
...
[](https://help.webexconnect.io/docs/livechat-template#configure-form-message)
  1. Log in to the Webex Connect platform.
  2. Go to Tools → Templates.
  3. Click Add New Template.
...
>   * For **Email** - The recommended email format is Name@Domain.TopLevelDomain - **TopLevelDomain** should have a minimum of 2 characters and a maximum of 9 characters.
...
* * *
[Push](https://help.webexconnect.io/docs/push-template)[Messenger](https://help.webexconnect.io/docs/templates-messenger)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/livechat-template)
  *     * [Configure RichText Message](https://help.webexconnect.io/docs/livechat-template#configure-richtext-message)
    * [Configure Form Message](https://help.webexconnect.io/docs/livechat-template#configure-form-message)
