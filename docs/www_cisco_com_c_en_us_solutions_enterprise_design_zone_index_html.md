  * [Skip to main content](https://www.cisco.com/site/us/en/solutions/cisco-validated/index.html#fw-c-content)
  * [Skip to search](https://www.cisco.com/site/us/en/solutions/cisco-validated/index.html#fw-c-header__button--search)
  * [Skip to footer](https://www.cisco.com/site/us/en/solutions/cisco-validated/index.html#fw-c-footer)
...
Clear
[Downloads](https://www.cisco.com/site/us/en/solutions/cisco-validated/index.html#tabs-a107e9a621-item-b27a5c1e52-tab) [Product Support](https://www.cisco.com/site/us/en/solutions/cisco-validated/index.html#tabs-a107e9a621-item-b27a5c1e52-tab) [Technology Support](https://www.cisco.com/site/us/en/solutions/cisco-validated/index.html#tabs-a107e9a621-item-b27a5c1e52-tab) | End of Sale End of Support
...
Partners
EN US
[ Log in](https://www.cisco.com/content/cdc/login.html?referer=/site/us/en/solutions/cisco-validated/index.html)
[ Trials and demos](https://www.cisco.com/site/us/en/products/trials-demos.html?linkclickid=hdr-mainnav-trialsdemos)
MENU
CLOSE
[ How to buy](https://www.cisco.com/site/us/en/buy/index.html?linkclickid=hdr-utilnav-howtobuy)
...
![](https://www.cisco.com/content/dam/cisco-cdc/site/images/heroes/solutions/cisco-validated-hero-desktop-2400x1028.jpg)
# Cisco validated
##  Design and deploy for impact 
Cisco Validated provides documentation and best practices to help IT architects and practitioners design, deploy, and operate platforms to deliver trusted, unified experiences.
Hello, how can I help?
## Why Cisco validated
![](https://www.cisco.com/content/dam/cisco-cdc/site/images/icons-and-shapes/icon_optimization.svg)
###  Faster deployments 
From system designs to configuration instructions, Cisco Validated guides make it easy for you to quickly implement your solutions.
![](https://www.cisco.com/content/dam/cisco-cdc/site/images/icons-and-shapes/marketing-icons/icon_arrow_down_right.svg)
###  Reduced risk 
Cisco Validated guides help ensure products work together by design, based on common use cases and engineering system priorities.
![](https://www.cisco.com/content/dam/cisco-cdc/site/images/icons-and-shapes/icon_predictable.svg)
###  Predictability 
Backed by extensive testing, Cisco Validated guides help you set performance expectations and help ensure faster, more reliable deployments.
* * *
Show more (1)
* * *
## Browse validated designs
Cisco's expert-designed solutions, proven architectures, and best practices simplify your IT and security operations.
FeaturedCampus and branchCollaborationData centerService providerBy industry
###  Featured
Secure Network Reference Architecture
###  Introduction to the Cisco Secure Networking Architecture 
An introduction to the Cisco Secure Network Reference Architecture (SNRA), presenting the architectural framework, core principles, major domains, and intended business outcomes that define the architecture.
[Explore guide](https://www.cisco.com/content/en/us/td/docs/solutions/CVD/Campus/Intro-Cisco-Secure-Network-Architecture.html)
Wired and wireless LAN
###  Campus LAN and WLAN design guide 
Design a reliable, secure, and high-performance wired and wireless campus network using best practices.
[Explore guide](https://www.cisco.com/c/en/us/td/docs/solutions/CVD/Campus/cisco-campus-lan-wlan-design-guide.html)
SD-WAN – Cisco secure routers
###  Cisco Catalyst SD-WAN design guide 
Design flexible, secure, and high-performing WAN solutions with Cisco Secure Routers.
[Explore guide](https://www.cisco.com/c/en/us/td/docs/solutions/CVD/SDWAN/cisco-sdwan-design-guide.html)
Cloud
###  Zero trust access from Cisco – at a glance 
Deliver seamless, secure access to applications and data across a hybrid, multi-device world with Cisco’s zero trust approach to secure access.
[Explore guide](https://www.cisco.com/c/en/us/products/collateral/security/secure-access/zero-trust-access-aag.html)
Data center networking
###  Application-Centric Infrastructure design guide 
Simplify data center operations through automated tasks and application security with our expert ACI design guide.
[Explore guide](https://www.cisco.com/c/en/us/td/docs/dcn/whitepapers/cisco-application-centric-infrastructure-design-guide.html)
AI-ready infrastructure
###  Cisco data center Networking blueprint for AI/ML applications 
Fuel AI and ML apps. Build a high-speed network that handles the heaviest workloads.
[Explore guide](https://www.cisco.com/c/en/us/td/docs/dcn/whitepapers/cisco-data-center-networking-blueprint-for-ai-ml-applications.html)
###  Campus and branch
New
Secure Network Reference Architecture
###  Introduction to the Cisco Secure Networking Architecture 
...
[Explore guide](https://www.cisco.com/content/en/us/td/docs/solutions/CVD/Campus/Intro-Cisco-Secure-Network-Architecture.html)
###  SD-WAN solutions 
Simplify branch connectivity with Cisco Secure Router SD-WAN architectures that strengthen policy control and enable secure scalability.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/campus-branch.html?flt1_general-table0=SD-WAN#guides)
###  Cloud Networking 
Outline validated cloud networking architectures that enable scalable fabric, segmentation, and secure connectivity across modern environments.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/campus-branch.html?flt2_general-table0=Cloud#~guides)
###  SASE/SSE architectures 
Provide validated SASE and SSE blueprints that protect users, applications, and access with secure connectivity everywhere.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/campus-branch.html?flt1_general-table0=SASE%2FSSE#guides)
###  On-premises deployments 
Deliver tested architectures and best practices to modernize campus and branch environments with resilient operations.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/campus-branch.html?flt2_general-table0=On-Prem#~guides)
###  Wired and Wireless LAN 
Build high-performance wired and wireless LAN environments with trusted designs for mobility, scale, and consistent user experiences.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/campus-branch.html?flt1_general-table0=LAN%2FWLAN#guides)
###  Hybrid solutions 
Connect cloud and on-premises environments with validated hybrid architectures that improve agility, visibility, and operational control.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/campus-branch.html?flt2_general-table0=Hybrid#guides)
[View all guides](https://www.cisco.com/c/en/us/solutions/design-zone/campus-branch.html)
###  Collaboration
Popular in collaboration
Collaboration preferred architectures
###  On-premises collaboration design 
Build a secure, local foundation to keep people connected, with confidence.
[Explore guide](https://www.cisco.com/c/dam/en/us/td/docs/solutions/PA/overview/15x/clbpa15x.pdf)
###  Collaboration preferred architectures 
Streamline deployment with our tested, scalable models for on-premises, hybrid, and cloud environments. Expert guidance for enterprise success.
[View more](https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/uc_system/design/guides/PAdocs.html)
###  Collaboration solutions design guidance 
Master system-level design with our comprehensive SRND guides and sizing tools. Get the technical blueprints necessary to implement robust, scalable solutions.
[View more](https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/uc_system/design/guides/UCgoList.html)
###  Hybrid work 
Optimize office environments through expert layouts and technology configurations designed for modern hybrid teams. Create top-tier collaboration spaces today.
[View more](https://www.cisco.com/site/us/en/solutions/hybrid-work/design-guides.html)
[View all guides](https://www.cisco.com/c/en/us/solutions/enterprise/design-zone-collaboration/index.html)
###  Data center
Popular in data center
Data center networking
###  VXLAN BGP EVPN design and implementation 
Implement advanced overlay networks for data centers with VXLAN BGP EVPN.
[Explore guide](https://www.cisco.com/c/en/us/td/docs/dcn/whitepapers/cisco-vxlan-bgp-evpn-design-and-implementation-guide.html)
###  AI-ready infrastructure 
Deliver high-performance, lossless infrastructure for AI/ML workloads. From edge to cloud, our blueprints optimize performance and latency for any AI environment.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/ai-ready-infrastructure.html)
###  FlexPod platforms 
Leverage converged infrastructure for virtualized platforms, SAP, and AI. Get tested, scalable deployment models for the most demanding data center applications.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/data-center-design-guides/flexpod-design-guides.html)
###  Data center networking 
Simplify operations with automated, secure, and AI-ready network fabrics. Achieve consistent policy enforcement and high-performance connectivity across the data center.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/data-center-networking.html)
###  Data center design navigator 
Easily find the solution that best aligns with infrastructure needs. Browse our comprehensive navigator to map specific application requirements with validated designs.
[View more](https://ucsnav.cisco.com/design-navigator/#/?_k=o4vbqh)
###  Big data 
Boost productivity and scale analytics with high-performance UCS solutions. Access blueprints for Cloudera, Hortonworks, and data-intensive workloads.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/data-center-design-guides/data-center-big-data.html)
[View all guides](https://www.cisco.com/c/en/us/solutions/design-zone/data-center-design-guides.html)
###  Service provider
Popular in service provider
Routed optical networking
###  Routed optical networking white paper 
Gain insights into cutting-edge optical networking strategies and best practices for infrastructure design and deployment.
[Explore guide](https://www.cisco.com/c/en/us/products/collateral/routed-optical-networking/routed-optical-networking-wp.html)
###  Routed optical networking 
Simplify infrastructure by converging IP and optical layers. Our guides offer expert strategies to reduce complexity, lower costs, and enhance network scalability.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/service-provider.html?flt1_general-table0=Routed%20Optical%20Networking#~guides)
###  5G network architecture 
Accelerate 5G transformation with our automation and converged transport blueprints. Enable seamless orchestration and efficient, scalable network slicing today.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/service-provider.html?flt1_general-table0=5G%20Network%20Architecture)
###  Intelligent peering 
Optimize network interconnections for peak performance. Our design guides provide best practices for peering fabric, telemetry, and reliable edge connectivity.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/service-provider.html?flt1_general-table0=Intelligent%20Peering#~guides)
###  Agile services networking 
Build resilient, automated metro networks. Leverage SRv6 and SDN transport to address bandwidth demands and enable programmable, distributed service architectures.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/service-provider.html?flt1_general-table0=Agile%20Services%20Networking#~guides)
[View all guides](https://www.cisco.com/c/en/us/solutions/design-zone/service-provider.html)
###  By industry
Popular industry design guide
Manufacturing
###  Converged Plantwide Ethernet (CPwE) validated design 
Explore how CPwE can help you design and securely deploy an industrial network infrastructure.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/industries/manufacturing/cpwe.html)
###  Manufacturing 
Accelerate smart factory transition. Implement secure, agile industrial automation and Industry 4.0 technologies with our proven network design guides for digital manufacturing.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/industries/manufacturing.html)
###  Utilities and renewables 
Modernize power grid infrastructure through validated designs for renewable energy integration, substation and distribution automation, AMI, and grid cybersecurity.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/industries/power-utilities.html)
###  Oil and gas 
Boost productivity and security for upstream, midstream, and downstream operations. Leverage our design guides to automate extraction, pipelines, and refinery control systems.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/industries/oil-gas.html)
###  Rugged enterprise networks 
Extend enterprise-grade security to uncarpeted, rugged environments. Our validated designs ensure reliable connectivity and management for challenging, non-climate-controlled spaces.
[View more](https://www.cisco.com/c/en/us/solutions/design-zone/industries/rugged-enterprise-networking.html)
[View all guides](https://www.cisco.com/c/en/us/solutions/design-zone/industries.html)
## Cisco validated profiles
Cisco Validated Profiles (CVP) detail topologies, hardware and software features, and use cases—all validated as complete systems for reliable deployment.
![](https://www.cisco.com/content/dam/cisco-cdc/site/images/photography/solutions/cisco-validated/large-enteprises-and-government-validated-profile.jpg)
###  Large enterprises and government 
Trusted solutions for validated profiles in large enterprises and government sectors help to ensure security and compliance.
[Browse large enterprises validated profile](https://www.cisco.com/c/en/us/td/docs/cloud-systems-management/network-automation-and-management/dna-center/Cisco-Validated-Solution-Profiles/b_validated_profile_enterprise_govt_237x.html)
![](https://www.cisco.com/content/dam/cisco-cdc/site/images/photography/solutions/cisco-validated/manufacturing-validated-profile.jpg)
###  Manufacturing 
Improve business operations by digitizing production environments.
[Browse manufacturing validated profile](https://www.cisco.com/c/en/us/td/docs/cloud-systems-management/network-automation-and-management/catalyst-center/cisco-validated-solution-profiles/validated-profile-manufacturing-sd-access.html)
![](https://www.cisco.com/content/dam/cisco-cdc/site/images/photography/solutions/cisco-validated/healthcare-validated-profile.jpg)
###  Healthcare 
Robust network solutions for validated profiles in healthcare help to ensure secure and seamless connectivity.
[Browse healthcare validated profile](https://www.cisco.com/c/en/us/td/docs/cloud-systems-management/network-automation-and-management/dna-center/Cisco-Validated-Solution-Profiles/b_cisco_validated_solution_profile_healthcare_vertical.html)
![](https://www.cisco.com/content/dam/cisco-cdc/site/images/photography/solutions/cisco-validated/university-validated-profile.jpg)
###  University 
Efficient network solutions for validated profiles in universities support secure and collaborative learning environments.
[Browse university validated profile](https://www.cisco.com/c/en/us/td/docs/cloud-systems-management/network-automation-and-management/catalyst-center/cisco-validated-solution-profiles/validated-profile-university.html)
[Explore all validated profiles](https://www.cisco.com/c/en/us/solutions/design-zone/cisco-validated-profiles.html)
## Cisco validated case studies
![Swetha Velamuri, Cisco Data Center Networking](https://www.cisco.com/content/dam/cisco-cdc/site/images/photography/solutions/cisco-validated/swetha-velamuri-150x150.jpg)
##  Cisco validated design for Panasonic: A blueprint for IP media success 
> Cisco and Panasonic partnered on a validated design for media broadcasters, creating a reliable and scalable IP infrastructure for high-resolution video and future-proof live production workflows.
**Swetha Velamuri (pictured) and Devanshi Kotak**
Cisco Data Center Networking
[Read about the Cisco and Panasonic blueprint](https://blogs.cisco.com/partner/cisco-validated-design-for-panasonic-a-blueprint-for-ip-media-success)
![Andrew Blair, ScottishPower Renewals Lead Telecoms Engineer](https://www.cisco.com/content/dam/cisco-cdc/site/images/photography/solutions/cisco-validated/scottish-quote-800x450-cut.jpg)
##  ScottishPower Renewables grows clean energy 
...
[Read the Scottish Power case study](https://www.cisco.com/site/us/en/about/case-studies-customer-stories/scottishpower-renewables.html)
Previous
Next
## Engineering alliances
Innovate with a simplified, validated ecosystem.
![](https://www.cisco.com/content/dam/cisco-cdc/site/images/icons-and-shapes/about/why-cisco/why-cisco-ai-data-center.svg)
###  AI-ready data centers 
Revolutionize your AI and High-Performance Computing (HPC) data centers with liquid and immersion cooling, slashing energy costs while boosting hardware reliability for high-density computing excellence.
![](https://www.cisco.com/content/dam/cisco-cdc/site/images/icons-and-shapes/about/why-cisco/why-cisco-future-proofed-workplace.svg)
###  Future-proofed workplaces 
Enable next-gen workplaces with DC microgrids and PoE-based smart infrastructure, unifying power and data for IoT, lighting, shading, and HVAC.
[Explore engineering alliances](https://www.cisco.com/c/en/us/solutions/design-zone/engineering-alliances.html)
Cisco validated communities
##  Join your peers 
Check out the Cisco validated communities aligned to Cisco validated outputs. They can help you design, deploy, and operate platforms that deliver unified experiences at every touchpoint.
[Explore Cisco validated communities](https://learningnetwork.cisco.com/s/cisco-validated)
###  Quick Links
