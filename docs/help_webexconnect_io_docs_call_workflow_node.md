[Jump to Content](https://help.webexconnect.io/docs/call-workflow-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Call Workflow Node
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/call-workflow-node)
...
![Screenshot of Call workflow Node.](https://files.readme.io/0630546-Call_Workflow.png)
Call workflow Node
## 
Call Workflow Node Configuration
[](https://help.webexconnect.io/docs/call-workflow-node#call-workflow-node-configuration)
  1. Double click the **Call Workflow** node.  
The Call workflow screen appears. 

![Screenshot of Call Workflow Node Configuration Page.](https://files.readme.io/798ef79-Call_Workflow_Click_the_image_to_view_it_larger.png)
Call Workflow Node Configuration Page.
...
[](https://help.webexconnect.io/docs/call-workflow-node#optionally-configure-transition-actions)
...
| --- | --- | --- |  
| 1  | Configuration tab  | Use this tab to configure the workflow that you wish to call.  
...
### 
Notify URL
[](https://help.webexconnect.io/docs/call-workflow-node#notify-url)
...
* * *
[Page Connector Node](https://help.webexconnect.io/docs/page-connector-node)[Generate OTP Node](https://help.webexconnect.io/docs/generate-otp-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/call-workflow-node)
  *     * [Call Workflow Node Configuration](https://help.webexconnect.io/docs/call-workflow-node#call-workflow-node-configuration)
    * [**Optionally configure Transition Actions**](https://help.webexconnect.io/docs/call-workflow-node#optionally-configure-transition-actions)
      * [Notify URL](https://help.webexconnect.io/docs/call-workflow-node#notify-url)
