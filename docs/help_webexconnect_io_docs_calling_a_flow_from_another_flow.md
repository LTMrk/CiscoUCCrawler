[Jump to Content](https://help.webexconnect.io/docs/calling-a-flow-from-another-flow#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Calling a Flow from another Flow
Search
`CTRL-K`
All
Platform Documentation
...
Learn how to divide a large flow into different sub-flows using various nodes in Webex Connect
[Suggest Edits](https://help.webexconnect.io/edit/calling-a-flow-from-another-flow)
Webex Connect users who want to modularise/divide a large flow into sub-flows can use the _Call Workflow_ node on the flow palette.   

The _[Call Flow](https://help.webexconnect.io/docs/call-workflow)_ node allows flows within a service to invoke other flows within the same service. It’s the suggested approach when calling a flow from another flow when both the flows are within the same service.
## 
Using Call Flow Node
[](https://help.webexconnect.io/docs/calling-a-flow-from-another-flow#using-call-flow-node)
...
![Screenshot of Call Flow Node Configuration.](https://files.readme.io/136d363-Calling_a_Flow_from_another_Flow.jpg)
Call Flow Node Configuration
> ## 🚧
...
* * *
[Node Transitions](https://help.webexconnect.io/docs/node-transitions)[Flow Version History](https://help.webexconnect.io/docs/flow-version-history)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/calling-a-flow-from-another-flow)
  *     * [Using Call Flow Node](https://help.webexconnect.io/docs/calling-a-flow-from-another-flow#using-call-flow-node)
