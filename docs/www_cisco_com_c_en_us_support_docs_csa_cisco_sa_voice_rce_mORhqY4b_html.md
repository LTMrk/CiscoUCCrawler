  * [Skip to content](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-voice-rce-mORhqY4b.html#eot-doc-wrapper)
  * [Skip to search](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-voice-rce-mORhqY4b.html)
  * [Skip to footer](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-voice-rce-mORhqY4b.html)
  ...
  * [](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-voice-rce-mORhqY4b.html)
  * [Support](https://www.cisco.com/c/en/us/support/index.html)
...
Save
[Log in](https://www.cisco.com/c/login/index.html?referer=/c/en/us/support/docs/csa/cisco-sa-voice-rce-mORhqY4b.html) to Save Content 
Print
### Available Languages
Updated:February 13, 2026
Document ID:1769013437646113
Bias-Free Language
### Bias-Free Language
...
Last Updated: 
2026 February 13 15:21 GMT
Version 1.1: 
[Final](https://sec.cloudapps.cisco.com/security/center/resources/security_vulnerability_policy.html#final)
Workarounds: 
No workarounds available
Cisco Bug IDs:
[CSCwr21851](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwr21851)
[CSCwr29208](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwr29208)
[CSCwr29216](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwr29216)
[](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-voice-rce-mORhqY4b.html)
CVE-2026-20045
[](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-voice-rce-mORhqY4b.html)
CWE-94
[](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-voice-rce-mORhqY4b.html)
CVSS Score:
[ Base 8.2](https://sec.cloudapps.cisco.com/security/center/cvssCalculator.x?version=3.1&vector=CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:L/A:N)[![](https://sec.cloudapps.cisco.com/security/center/images/blue-square.png)](https://sec.cloudapps.cisco.com/security/center/images/blue-square.png "Related image, diagram or screenshot.")**Click Icon to Copy Verbose Score**   
CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:L/A:N/E:X/RL:X/RC:X
CVE-2026-20045
[](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-voice-rce-mORhqY4b.html)
CWE-94
[](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-voice-rce-mORhqY4b.html)
[ Download CSAF ](https://sec.cloudapps.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-voice-rce-mORhqY4b/csaf/cisco-sa-voice-rce-mORhqY4b.json)
Email 
## 
Summary 
...
This vulnerability is due to improper validation of user-supplied input in HTTP requests. An attacker could exploit this vulnerability by sending a sequence of crafted HTTP requests to the web-based management interface of an affected device. A successful exploit could allow the attacker to obtain user-level access to the underlying operating system and then elevate privileges to _root_. 
...
This vulnerability affects the following Cisco products, regardless of device configuration:
    * Unified CM ([CSCwr21851](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwr21851))
    * Unified CM SME ([CSCwr21851](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwr21851))
    * Unified CM IM&P ([CSCwr29216](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwr29216))
    * Unity Connection ([CSCwr29208](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwr29208))
    * Webex Calling Dedicated Instance ([CSCwr21851](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwr21851))
For information about which Cisco software releases are vulnerable, see the [Fixed Software](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-voice-rce-mORhqY4b.html#fs) section of this advisory.
##  Products Confirmed Not Vulnerable 
Only products listed in the [Vulnerable Products](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-voice-rce-mORhqY4b.html#vp) section of this advisory are known to be affected by this vulnerability.
...
| 14  | 14SU5 or apply patch file:1  
[ciscocm.CSCwr21851_Remote_Code_Execution_v1.zip](https://software.cisco.com/download/home/286328117/type/286319236/release/14SU4a)  |  
| 15  | 15SU4 or apply patch file:1  
[ciscocm.CSCwr21851_Remote_Code_Execution_v1.zip](https://software.cisco.com/download/home/286331940/type/286319236/release/15SU3a)  |  
...
| 12.5  | Migrate to a fixed release.  |  
| 14  | 14SU5 or apply patch file:1  
[ciscocm.cuc.CSCwr29208_C0266-v2.zip](https://software.cisco.com/download/home/286328409/type/286319533/release/14SU4)  |  
| 15  | 15SU4 (Mar 2026) or apply patch file:1  
[ciscocm.cuc.CSCwr29208_C0266-v2.zip](https://software.cisco.com/download/home/286331949/type/286319533/release/15SU3)  |  
1. Patches are version-specific. Consult the README attached to the patch for details.
...
Exploitation and Public Announcements 
  * The Cisco PSIRT is aware of attempted exploitation of this vulnerability in the wild. Cisco strongly recommends that customers upgrade to a fixed software release to remediate this vulnerability.
...
Action Links for This Advisory 
  * [Snort Rule 65750-65752](https://www.snort.org/advisories/talos-rules-2026-01-22)
...
| --- | --- | --- | --- | --- |  
| 1.1  | Updated COP versions in Fixed Releases table.  | Fixed Releases  | Final  | 2026-FEB-13  |  
...
## 
Related to This Advisory 
[![Back to Top](https://www.cisco.com/etc/designs/cdc/fw/i/responsive/Default-bTop-36.svg)Back to Top](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-voice-rce-mORhqY4b.html "Back to Top")
