[Jump to Content](https://help.webexconnect.io/docs/variable-management-in-flows#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Variable Management in Flows
Search
`CTRL-K`
All
Platform Documentation
...
Learn about different Variables types that can be used at flow-level or node-level
[Suggest Edits](https://help.webexconnect.io/edit/variable-management-in-flows)
...
[](https://help.webexconnect.io/docs/variable-management-in-flows#categories-of-variables)
Webex Connect categorizes variables into the following categories: 
  * _[Input Variables](https://help.webexconnect.io/docs/variable-management-in-flows#section-input-variables)_ - the node-level variables that you can use from the preceding nodes.
  * _[Custom Variables](https://help.webexconnect.io/docs/variable-management-in-flows#section-custom-variables)_ - variables explicitly defined by you 
  * _[Output Variables](https://help.webexconnect.io/docs/variable-management-in-flows#section-output-variables)_ - the auto-generated node-level variables of the current node that can be used in the subsequent nodes in the flow.
...
### 
Input Variables
[](https://help.webexconnect.io/docs/variable-management-in-flows#input-variables)
...
### 
Custom Variables
[](https://help.webexconnect.io/docs/variable-management-in-flows#custom-variables)
...
[](https://help.webexconnect.io/docs/variable-management-in-flows#creating-custom-variables-at-node-level)
...
![Screenshot of Add Custom Variable Dialog.](https://files.readme.io/145a0cb-variable_management_in_flows.jpg)
...
[](https://help.webexconnect.io/docs/variable-management-in-flows#creating-custom-variables-at-flow-level)
...
![Screenshot of Custom Variables in Flow Settings.](https://files.readme.io/2061619-variable_management_in_flows1.jpg)
...
### 
External Variables
[](https://help.webexconnect.io/docs/variable-management-in-flows#external-variables)
...
The variables can be externalized both at the node-level and the flow-level. For instructions about externalizing the variables, see the [Custom Variables](https://help.webexconnect.io/docs/variable-management-in-flows#section-custom-variables) section.
...
![Screenshot of Using Variables](https://files.readme.io/2fa8648-variable_management_in_flows2.png)
Using Variables
...
### 
Output Variables
[](https://help.webexconnect.io/docs/variable-management-in-flows#output-variables)
...
### 
Session Variables
[](https://help.webexconnect.io/docs/variable-management-in-flows#session-variables)
...
* * *
[Nodes](https://help.webexconnect.io/docs/nodes)[Transition Actions](https://help.webexconnect.io/docs/transition-actions)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/variable-management-in-flows)
  *     * [Categories of Variables](https://help.webexconnect.io/docs/variable-management-in-flows#categories-of-variables)
      * [Input Variables](https://help.webexconnect.io/docs/variable-management-in-flows#input-variables)
      * [Custom Variables](https://help.webexconnect.io/docs/variable-management-in-flows#custom-variables)
      * [External Variables](https://help.webexconnect.io/docs/variable-management-in-flows#external-variables)
      * [Output Variables](https://help.webexconnect.io/docs/variable-management-in-flows#output-variables)
      * [Session Variables](https://help.webexconnect.io/docs/variable-management-in-flows#session-variables)
