[Jump to Content](https://help.webexconnect.io/docs/voice-media#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Voice Media
Search
`CTRL-K`
All
Platform Documentation
...
# Voice Media
Uploaded voice media can be used in voice flow or a Messaging API request
[Suggest Edits](https://help.webexconnect.io/edit/voice-media)
...
Screenshot of Voice Media Page
  1. Click the folder to which you want to add the media files.
  2. Click **Add Language Folder** , select the required language and click **Save**. A folder gets created with the selected language.
...
Screenshot of Main Folder Navigation
  1. Click the language folder to which you want to add the media.
  2. Click **Add New** and select:  
...
* * *
[Smart Links](https://help.webexconnect.io/docs/smart-links)[Voice Recordings](https://help.webexconnect.io/docs/voice-recordings)
