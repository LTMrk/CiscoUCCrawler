[Jump to Content](https://help.webexconnect.io/docs/wxcc-screen-pop#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Screen Pop - WXCC
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/wxcc-screen-pop)
...
## 
Authorization
[](https://help.webexconnect.io/docs/wxcc-screen-pop#authorization)
...
[](https://help.webexconnect.io/docs/wxcc-screen-pop#methods-and-outcomes)
...
Screenshot of Screen Pop configuration page.  
| Method Name  | Output Variables  | Node Outcomes  |  
| --- | --- | --- |  
| Screenpop  | None  |  _onInvalidData  
_ onError  
 _onInvalidChoice  
...
* Select the required screen pop loading behavior from the list: Inside Desktop, New Browser Tab, and Existing Browser Tab  | None  | v1.1 and v1.0  |  
> ## 📘
> Note
...
* * *
[Modify Notification - WXCC](https://help.webexconnect.io/docs/wxcc-modify-notification)[Close Task - WXCC](https://help.webexconnect.io/docs/wxcc-close-task)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/wxcc-screen-pop)
  *     * [Authorization](https://help.webexconnect.io/docs/wxcc-screen-pop#authorization)
    * [Methods and Outcomes](https://help.webexconnect.io/docs/wxcc-screen-pop#methods-and-outcomes)
