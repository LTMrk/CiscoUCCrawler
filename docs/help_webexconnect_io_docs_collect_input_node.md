[Jump to Content](https://help.webexconnect.io/docs/collect-input-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Collect Input Node
Search
`CTRL-K`
All
Platform Documentation
...
# Collect Input Node
Understand what a Collect Input node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/collect-input-node)
The _Collect Input_ node is used to receive and capture input from a user on an ongoing-call. You can choose to play an audio prompt before asking the user to enter an input. For example, you can use this node to capture the account number or date of birth of the user.  
...
## 
Node Configuration
[](https://help.webexconnect.io/docs/collect-input-node#node-configuration)
...
[](https://help.webexconnect.io/docs/collect-input-node#configuring-dtmf-input)
![Screenshot of Keypress Collect Input Node Configuration](https://files.readme.io/f5e405a-Collect_Input.jpg)
Collect Input Node Configuration - Keypress
...
## 
Input Variables
[](https://help.webexconnect.io/docs/collect-input-node#input-variables)
...
[](https://help.webexconnect.io/docs/collect-input-node#configuring-speech-recognition)
![Screenshot of Speech Collect Input Node Configuration](https://files.readme.io/c699f0b-Collect_Input1.jpg)
Collect Input Node Configuration - Speech
...
## 
Output Variables
[](https://help.webexconnect.io/docs/collect-input-node#output-variables)
You can see the data that this node generates as output variables. These [variables](https://help.webexconnect.io/docs/variable-management) are available for use in subsequent nodes. The following are the standard output variables for the _Collect Input_ node:
  * **collect.input** - stores the user input the DTMFs pressed for onSuccess, onFailure, and onError outcomes.

![Screenshot of Collect Input Output Variables](https://files.readme.io/3c3b1d4-Collect_Input2.jpg)
Output Variables
## 
Node Outcomes
[](https://help.webexconnect.io/docs/collect-input-node#node-outcomes)
...
## 
Transition Actions
[](https://help.webexconnect.io/docs/collect-input-node#transition-actions)
...
* * *
[Call User Node](https://help.webexconnect.io/docs/call-user-node)[Play Node](https://help.webexconnect.io/docs/play-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/collect-input-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/collect-input-node#node-configuration)
      * [Configuring DTMF Input](https://help.webexconnect.io/docs/collect-input-node#configuring-dtmf-input)
    * [Input Variables](https://help.webexconnect.io/docs/collect-input-node#input-variables)
      * [Configuring Speech Recognition:](https://help.webexconnect.io/docs/collect-input-node#configuring-speech-recognition)
    * [Output Variables](https://help.webexconnect.io/docs/collect-input-node#output-variables)
    * [Node Outcomes](https://help.webexconnect.io/docs/collect-input-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/collect-input-node#transition-actions)
