[Jump to Content](https://help.webexconnect.io/docs/legacy-export-logs#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Legacy Export Logs
Search
`CTRL-K`
All
Platform Documentation
...
# Legacy Export Logs
Export logs using the legacy Export Logs interface.
[Suggest Edits](https://help.webexconnect.io/edit/legacy-export-logs)
> ## 📘
...
[](https://help.webexconnect.io/docs/legacy-export-logs#fields-in-the-export-logs)
...
[](https://help.webexconnect.io/docs/legacy-export-logs#channel-specific-fields-in-the-export-logs)
...
* * *
[New Export Logs](https://help.webexconnect.io/docs/new-export-logs)[Logbooks](https://help.webexconnect.io/docs/logbook)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/legacy-export-logs)
  *     * [Fields in the Export Logs](https://help.webexconnect.io/docs/legacy-export-logs#fields-in-the-export-logs)
    * [Channel-specific Fields in the Export Logs](https://help.webexconnect.io/docs/legacy-export-logs#channel-specific-fields-in-the-export-logs)
