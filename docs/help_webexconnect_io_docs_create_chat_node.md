[Jump to Content](https://help.webexconnect.io/docs/create-chat-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Create Chat Node
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/create-chat-node)
> ## 📘
> Deprecation Alert
...
![Screenshot of Create Chat Node](https://files.readme.io/75a3c08-Create_Chat_Icon.png)
Create Chat Node
## 
Interface Elements
[](https://help.webexconnect.io/docs/create-chat-node#interface-elements)
...
| --- | --- | --- |  
| 1  | Configuration tab  | Use this tab to configure the chat settings.  
...
## 
Configuring a Chat
[](https://help.webexconnect.io/docs/create-chat-node#configuring-a-chat)
You can configure either a static message or a conversation piece.
Here are the steps:
## 
**Configuring a Static Message** ##
[](https://help.webexconnect.io/docs/create-chat-node#configuring-a-static-message)
...
[](https://help.webexconnect.io/docs/create-chat-node#configuring-a-conversation)
  1. Double click the **Create Chat** node.  
The Create Chat screen appears. 
  2. On the **Create Chat** screen: 
...
### 
**Testing a Sample**
[](https://help.webexconnect.io/docs/create-chat-node#testing-a-sample)
...
[](https://help.webexconnect.io/docs/create-chat-node#configuring-transitions)
...
* * *
[Database Node [Deprecated]](https://help.webexconnect.io/docs/database-node)[Validate Chat Node](https://help.webexconnect.io/docs/validate-chat-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/create-chat-node)
  *     * [Interface Elements](https://help.webexconnect.io/docs/create-chat-node#interface-elements)
    * [Configuring a Chat](https://help.webexconnect.io/docs/create-chat-node#configuring-a-chat)
    * [**Configuring a Static Message** ##](https://help.webexconnect.io/docs/create-chat-node#configuring-a-static-message)
    * [**Configuring a Conversation** ##](https://help.webexconnect.io/docs/create-chat-node#configuring-a-conversation)
      * [**Testing a Sample**](https://help.webexconnect.io/docs/create-chat-node#testing-a-sample)
    * [Configuring Transitions](https://help.webexconnect.io/docs/create-chat-node#configuring-transitions)
