[Jump to Content](https://help.webexconnect.io/docs/cce-live-chat#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Live Chat - CCE
Search
`CTRL-K`
All
Platform Documentation
...
# Live Chat - CCE
Learn about the procedure for app asset configuration for the Live Chat channel.
[Suggest Edits](https://help.webexconnect.io/edit/cce-live-chat)
...
[](https://help.webexconnect.io/docs/cce-live-chat#configuring-live-chat-channel-asset-on-webex-connect)
> ## 📘
...
Screenshot of Configuring a New Mobile & Web App Page
...
Screenshot displaying to enable Use Secured Port
  1. Click 'Save'. The 'Register To Webex Engage' action button becomes available once you've completed this step.


## 
Registering your Live Chat App Asset with Webex Engage
[](https://help.webexconnect.io/docs/cce-live-chat#registering-your-live-chat-app-asset-with-webex-engage)
...
Screenshot of Register to Webex Engage
  1. Select the required service and click Register (Note: this should be the Webex Connect service that would be used for configuring Live Chat flows for Cisco Contact Center Enterprise integration and click Register).
...
* * *
[Email - CCE](https://help.webexconnect.io/docs/cce-email)[Apple Messages for Business - CCE](https://help.webexconnect.io/docs/cce-apple-messages-for-business)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/cce-live-chat)
  *     * [Configuring Live Chat channel asset on Webex Connect](https://help.webexconnect.io/docs/cce-live-chat#configuring-live-chat-channel-asset-on-webex-connect)
    * [Registering your Live Chat App Asset with Webex Engage](https://help.webexconnect.io/docs/cce-live-chat#registering-your-live-chat-app-asset-with-webex-engage)
