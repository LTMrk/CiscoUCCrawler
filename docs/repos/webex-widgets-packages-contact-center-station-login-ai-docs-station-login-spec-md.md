---
doc_id: webex-widgets-packages-contact-center-station-login-ai-docs-station-login-spec-md
source_url: https://github.com/webex/widgets/blob/next/packages/contact-center/station-login/ai-docs/station-login-spec.md
repo: webex/widgets
ruta: packages/contact-center/station-login/ai-docs/station-login-spec.md
licencia: sin declarar
retrieved_at: 2026-08-24T09:09:19.180851+00:00
---

# widgets — packages/contact-center/station-login/ai-docs/station-login-spec.md
...
---
> Fuente: https://github.com/webex/widgets/blob/next/packages/contact-center/station-login/ai-docs/station-login-spec.md (licencia sin declarar)
