---
doc_id: webex-widgets-packages-contact-center-ai-docs-migration-component-layer-migration-md
source_url: https://github.com/webex/widgets/blob/next/packages/contact-center/ai-docs/migration/component-layer-migration.md
repo: webex/widgets
ruta: packages/contact-center/ai-docs/migration/component-layer-migration.md
licencia: sin declarar
retrieved_at: 2026-08-24T09:09:15.141705+00:00
---

# widgets — packages/contact-center/ai-docs/migration/component-layer-migration.md
...
---
> Fuente: https://github.com/webex/widgets/blob/next/packages/contact-center/ai-docs/migration/component-layer-migration.md (licencia sin declarar)
