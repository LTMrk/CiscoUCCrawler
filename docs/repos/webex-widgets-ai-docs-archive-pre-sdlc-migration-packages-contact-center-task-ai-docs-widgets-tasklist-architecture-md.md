---
doc_id: webex-widgets-ai-docs-archive-pre-sdlc-migration-packages-contact-center-task-ai-docs-widgets-tasklist-architecture-md
source_url: https://github.com/webex/widgets/blob/next/ai-docs/_archive/pre-sdlc-migration/packages/contact-center/task/ai-docs/widgets/TaskList/ARCHITECTURE.md
repo: webex/widgets
ruta: ai-docs/_archive/pre-sdlc-migration/packages/contact-center/task/ai-docs/widgets/TaskList/ARCHITECTURE.md
licencia: sin declarar
retrieved_at: 2026-08-24T09:08:52.182558+00:00
---

# widgets — ai-docs/_archive/pre-sdlc-migration/packages/contact-center/task/ai-docs/widgets/TaskList/ARCHITECTURE.md
...
---
> Fuente: https://github.com/webex/widgets/blob/next/ai-docs/_archive/pre-sdlc-migration/packages/contact-center/task/ai-docs/widgets/TaskList/ARCHITECTURE.md (licencia sin declarar)
