---
doc_id: webex-widgets-packages-contact-center-test-fixtures-ai-docs-test-fixtures-spec-md
source_url: https://github.com/webex/widgets/blob/next/packages/contact-center/test-fixtures/ai-docs/test-fixtures-spec.md
repo: webex/widgets
ruta: packages/contact-center/test-fixtures/ai-docs/test-fixtures-spec.md
licencia: sin declarar
retrieved_at: 2026-08-24T09:09:21.335746+00:00
---

# widgets — packages/contact-center/test-fixtures/ai-docs/test-fixtures-spec.md
...
---
> Fuente: https://github.com/webex/widgets/blob/next/packages/contact-center/test-fixtures/ai-docs/test-fixtures-spec.md (licencia sin declarar)
