---
doc_id: ciscodevnet-cvp-sample-code-vxmlportusage-nginx-configurations-samples-nginx-ha-cc-march-2026-docs-resilience-md
source_url: https://github.com/CiscoDevNet/cvp-sample-code/blob/master/VXMLPortUsage-Nginx-Configurations-Samples/nginx-ha-cc-March-2026/docs/resilience.md
repo: CiscoDevNet/cvp-sample-code
ruta: VXMLPortUsage-Nginx-Configurations-Samples/nginx-ha-cc-March-2026/docs/resilience.md
licencia: MIT
retrieved_at: 2026-08-24T09:11:18.100288+00:00
---

# cvp-sample-code — VXMLPortUsage-Nginx-Configurations-Samples/nginx-ha-cc-March-2026/docs/resilience.md
...
---
> Fuente: https://github.com/CiscoDevNet/cvp-sample-code/blob/master/VXMLPortUsage-Nginx-Configurations-Samples/nginx-ha-cc-March-2026/docs/resilience.md (licencia MIT)
