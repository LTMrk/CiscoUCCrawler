---
doc_id: webex-widgets-packages-contact-center-user-state-ai-docs-user-state-spec-md
source_url: https://github.com/webex/widgets/blob/next/packages/contact-center/user-state/ai-docs/user-state-spec.md
repo: webex/widgets
ruta: packages/contact-center/user-state/ai-docs/user-state-spec.md
licencia: sin declarar
retrieved_at: 2026-08-24T09:09:22.062893+00:00
---

# widgets — packages/contact-center/user-state/ai-docs/user-state-spec.md
...
---
> Fuente: https://github.com/webex/widgets/blob/next/packages/contact-center/user-state/ai-docs/user-state-spec.md (licencia sin declarar)
