---
doc_id: webex-widgets-packages-contact-center-ai-docs-migration-migration-overview-md
source_url: https://github.com/webex/widgets/blob/next/packages/contact-center/ai-docs/migration/migration-overview.md
repo: webex/widgets
ruta: packages/contact-center/ai-docs/migration/migration-overview.md
licencia: sin declarar
retrieved_at: 2026-08-24T09:09:15.843390+00:00
---

# widgets — packages/contact-center/ai-docs/migration/migration-overview.md
...
---
> Fuente: https://github.com/webex/widgets/blob/next/packages/contact-center/ai-docs/migration/migration-overview.md (licencia sin declarar)
