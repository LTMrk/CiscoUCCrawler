---
doc_id: webex-widgets-ai-docs-archive-pre-sdlc-migration-packages-contact-center-cc-components-ai-docs-agents-md
source_url: https://github.com/webex/widgets/blob/next/ai-docs/_archive/pre-sdlc-migration/packages/contact-center/cc-components/ai-docs/AGENTS.md
repo: webex/widgets
ruta: ai-docs/_archive/pre-sdlc-migration/packages/contact-center/cc-components/ai-docs/AGENTS.md
licencia: sin declarar
retrieved_at: 2026-08-24T09:08:45.587371+00:00
---

# widgets — ai-docs/_archive/pre-sdlc-migration/packages/contact-center/cc-components/ai-docs/AGENTS.md
...
---
> Fuente: https://github.com/webex/widgets/blob/next/ai-docs/_archive/pre-sdlc-migration/packages/contact-center/cc-components/ai-docs/AGENTS.md (licencia sin declarar)
