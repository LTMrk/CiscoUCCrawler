---
doc_id: webex-widgets-ai-docs-archive-pre-sdlc-migration-packages-playwright-ai-docs-agents-md
source_url: https://github.com/webex/widgets/blob/next/ai-docs/_archive/pre-sdlc-migration/packages/playwright/ai-docs/AGENTS.md
repo: webex/widgets
ruta: ai-docs/_archive/pre-sdlc-migration/packages/playwright/ai-docs/AGENTS.md
licencia: sin declarar
retrieved_at: 2026-08-24T09:08:55.265479+00:00
---

# widgets — ai-docs/_archive/pre-sdlc-migration/packages/playwright/ai-docs/AGENTS.md
...
---
> Fuente: https://github.com/webex/widgets/blob/next/ai-docs/_archive/pre-sdlc-migration/packages/playwright/ai-docs/AGENTS.md (licencia sin declarar)
