---
doc_id: webex-widgets-ai-docs-archive-pre-sdlc-migration-packages-contact-center-task-ai-docs-widgets-incomingtask-agents-md
source_url: https://github.com/webex/widgets/blob/next/ai-docs/_archive/pre-sdlc-migration/packages/contact-center/task/ai-docs/widgets/IncomingTask/AGENTS.md
repo: webex/widgets
ruta: ai-docs/_archive/pre-sdlc-migration/packages/contact-center/task/ai-docs/widgets/IncomingTask/AGENTS.md
licencia: sin declarar
retrieved_at: 2026-08-24T09:08:49.179495+00:00
---

# widgets — ai-docs/_archive/pre-sdlc-migration/packages/contact-center/task/ai-docs/widgets/IncomingTask/AGENTS.md
...
---
> Fuente: https://github.com/webex/widgets/blob/next/ai-docs/_archive/pre-sdlc-migration/packages/contact-center/task/ai-docs/widgets/IncomingTask/AGENTS.md (licencia sin declarar)
