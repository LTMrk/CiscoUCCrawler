---
doc_id: webex-webexplaybooks-playbooks-wxcc-ai-agent-autonomous-docs-upstream-overview-md
source_url: https://github.com/webex/WebexPlaybooks/blob/main/playbooks/wxcc-ai-agent-autonomous/docs/upstream-overview.md
repo: webex/WebexPlaybooks
ruta: playbooks/wxcc-ai-agent-autonomous/docs/upstream-overview.md
licencia: NOASSERTION
retrieved_at: 2026-08-24T09:10:21.122003+00:00
---

# WebexPlaybooks — playbooks/wxcc-ai-agent-autonomous/docs/upstream-overview.md
...
---
> Fuente: https://github.com/webex/WebexPlaybooks/blob/main/playbooks/wxcc-ai-agent-autonomous/docs/upstream-overview.md (licencia NOASSERTION)
