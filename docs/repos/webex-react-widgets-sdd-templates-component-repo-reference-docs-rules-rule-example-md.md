---
doc_id: webex-react-widgets-sdd-templates-component-repo-reference-docs-rules-rule-example-md
source_url: https://github.com/webex/react-widgets/blob/master/.sdd/templates/component-repo/reference-docs/rules/_rule-example.md
repo: webex/react-widgets
ruta: .sdd/templates/component-repo/reference-docs/rules/_rule-example.md
licencia: MIT
retrieved_at: 2026-09-16T09:35:22.071478+00:00
---

# react-widgets — .sdd/templates/component-repo/reference-docs/rules/_rule-example.md
...
---
> Fuente: https://github.com/webex/react-widgets/blob/master/.sdd/templates/component-repo/reference-docs/rules/_rule-example.md (licencia MIT)
