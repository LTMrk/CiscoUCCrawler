---
doc_id: webex-webex-js-sdk-packages-webex-contact-center-ai-docs-templates-documentation-create-architecture-md-md
source_url: https://github.com/webex/webex-js-sdk/blob/next/packages/%40webex/contact-center/ai-docs/templates/documentation/create-architecture-md.md
repo: webex/webex-js-sdk
ruta: packages/@webex/contact-center/ai-docs/templates/documentation/create-architecture-md.md
licencia: NOASSERTION
retrieved_at: 2026-08-24T09:06:53.296197+00:00
---

# webex-js-sdk — packages/@webex/contact-center/ai-docs/templates/documentation/create-architecture-md.md
...
---
> Fuente: https://github.com/webex/webex-js-sdk/blob/next/packages/%40webex/contact-center/ai-docs/templates/documentation/create-architecture-md.md (licencia NOASSERTION)
