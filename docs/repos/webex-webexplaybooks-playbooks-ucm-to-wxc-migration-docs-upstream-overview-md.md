---
doc_id: webex-webexplaybooks-playbooks-ucm-to-wxc-migration-docs-upstream-overview-md
source_url: https://github.com/webex/WebexPlaybooks/blob/main/playbooks/ucm-to-wxc-migration/docs/upstream-overview.md
repo: webex/WebexPlaybooks
ruta: playbooks/ucm-to-wxc-migration/docs/upstream-overview.md
licencia: NOASSERTION
retrieved_at: 2026-08-24T09:10:15.571637+00:00
---

# WebexPlaybooks — playbooks/ucm-to-wxc-migration/docs/upstream-overview.md
...
---
> Fuente: https://github.com/webex/WebexPlaybooks/blob/main/playbooks/ucm-to-wxc-migration/docs/upstream-overview.md (licencia NOASSERTION)
