---
doc_id: ciscodevnet-axl-ansible-examples-vault-setup-commands-md
source_url: https://github.com/CiscoDevNet/axl-ansible-examples/blob/main/vault/setup_commands.md
repo: CiscoDevNet/axl-ansible-examples
ruta: vault/setup_commands.md
licencia: MIT
retrieved_at: 2026-08-24T09:12:11.014333+00:00
---

# axl-ansible-examples — vault/setup_commands.md

Repositorio: CiscoDevNet/axl-ansible-examples
Descripcion del repositorio: Examples showing how to use Cisco Communications Manager AXL SOAP to make configuration changes using Ansible playbooks
...
---
> Fuente: https://github.com/CiscoDevNet/axl-ansible-examples/blob/main/vault/setup_commands.md (licencia MIT)
