---
doc_id: webex-widgets-packages-contact-center-ai-docs-migration-task-list-migration-md
source_url: https://github.com/webex/widgets/blob/next/packages/contact-center/ai-docs/migration/task-list-migration.md
repo: webex/widgets
ruta: packages/contact-center/ai-docs/migration/task-list-migration.md
licencia: sin declarar
retrieved_at: 2026-08-24T09:09:17.452564+00:00
---

# widgets — packages/contact-center/ai-docs/migration/task-list-migration.md
...
---
> Fuente: https://github.com/webex/widgets/blob/next/packages/contact-center/ai-docs/migration/task-list-migration.md (licencia sin declarar)
