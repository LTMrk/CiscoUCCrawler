---
doc_id: ciscodevnet-jabber-web-sample-readme-md
source_url: https://github.com/CiscoDevNet/jabber-web-sample/blob/master/README.md
repo: CiscoDevNet/jabber-web-sample
ruta: README.md
licencia: MIT
retrieved_at: 2026-08-24T10:08:00.133066+00:00
---

# jabber-web-sample — README.md

Repositorio: CiscoDevNet/jabber-web-sample
Descripcion del repositorio: Basic and advanced sample pages demonstrating the use of the Cisco Jabber Web SDK for voice and video
...
---
> Fuente: https://github.com/CiscoDevNet/jabber-web-sample/blob/master/README.md (licencia MIT)
