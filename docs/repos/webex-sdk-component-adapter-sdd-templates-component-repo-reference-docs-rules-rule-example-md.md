---
doc_id: webex-sdk-component-adapter-sdd-templates-component-repo-reference-docs-rules-rule-example-md
source_url: https://github.com/webex/sdk-component-adapter/blob/master/.sdd/templates/component-repo/reference-docs/rules/_rule-example.md
repo: webex/sdk-component-adapter
ruta: .sdd/templates/component-repo/reference-docs/rules/_rule-example.md
licencia: MIT
retrieved_at: 2026-09-07T10:28:49.042431+00:00
---

# sdk-component-adapter — .sdd/templates/component-repo/reference-docs/rules/_rule-example.md
...
---
> Fuente: https://github.com/webex/sdk-component-adapter/blob/master/.sdd/templates/component-repo/reference-docs/rules/_rule-example.md (licencia MIT)
