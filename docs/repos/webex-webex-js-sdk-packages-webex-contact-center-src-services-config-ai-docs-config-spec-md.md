---
doc_id: webex-webex-js-sdk-packages-webex-contact-center-src-services-config-ai-docs-config-spec-md
source_url: https://github.com/webex/webex-js-sdk/blob/next/packages/%40webex/contact-center/src/services/config/ai-docs/config-spec.md
repo: webex/webex-js-sdk
ruta: packages/@webex/contact-center/src/services/config/ai-docs/config-spec.md
licencia: NOASSERTION
retrieved_at: 2026-08-24T09:07:02.880316+00:00
---

# webex-js-sdk — packages/@webex/contact-center/src/services/config/ai-docs/config-spec.md
...
---
> Fuente: https://github.com/webex/webex-js-sdk/blob/next/packages/%40webex/contact-center/src/services/config/ai-docs/config-spec.md (licencia NOASSERTION)
