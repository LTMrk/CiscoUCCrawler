---
doc_id: webex-widgets-packages-contact-center-task-ai-docs-task-spec-md
source_url: https://github.com/webex/widgets/blob/next/packages/contact-center/task/ai-docs/task-spec.md
repo: webex/widgets
ruta: packages/contact-center/task/ai-docs/task-spec.md
licencia: sin declarar
retrieved_at: 2026-08-31T10:47:31.230560+00:00
---

# widgets — packages/contact-center/task/ai-docs/task-spec.md
...
---
> Fuente: https://github.com/webex/widgets/blob/next/packages/contact-center/task/ai-docs/task-spec.md (licencia sin declarar)
