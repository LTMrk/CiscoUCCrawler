---
doc_id: ciscodevnet-serviceability-python-zeep-samples-readme-md
source_url: https://github.com/CiscoDevNet/serviceability-python-zeep-samples/blob/master/README.md
repo: CiscoDevNet/serviceability-python-zeep-samples
ruta: README.md
licencia: MIT
retrieved_at: 2026-08-24T09:12:08.207067+00:00
---

# serviceability-python-zeep-samples — README.md

Repositorio: CiscoDevNet/serviceability-python-zeep-samples
Descripcion del repositorio: Sample scripts demonstrating usage of various Cisco CUCM Serviceability APIs using Python and the Zeep SOAP library
...
---
> Fuente: https://github.com/CiscoDevNet/serviceability-python-zeep-samples/blob/master/README.md (licencia MIT)
