---
doc_id: webex-webexplaybooks-playbooks-cucm-dialplan-migration-docs-upstream-overview-md
source_url: https://github.com/webex/WebexPlaybooks/blob/main/playbooks/cucm-dialplan-migration/docs/upstream-overview.md
repo: webex/WebexPlaybooks
ruta: playbooks/cucm-dialplan-migration/docs/upstream-overview.md
licencia: NOASSERTION
retrieved_at: 2026-08-24T09:10:04.921150+00:00
---

# WebexPlaybooks — playbooks/cucm-dialplan-migration/docs/upstream-overview.md
...
---
> Fuente: https://github.com/webex/WebexPlaybooks/blob/main/playbooks/cucm-dialplan-migration/docs/upstream-overview.md (licencia NOASSERTION)
