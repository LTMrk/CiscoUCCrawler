---
doc_id: ciscodevnet-xapi-samples-docs-quickstart-md
source_url: https://github.com/CiscoDevNet/xapi-samples/blob/master/docs/QuickStart.md
repo: CiscoDevNet/xapi-samples
ruta: docs/QuickStart.md
licencia: MIT
retrieved_at: 2026-08-24T09:12:04.230403+00:00
---

# xapi-samples — docs/QuickStart.md
...
---
> Fuente: https://github.com/CiscoDevNet/xapi-samples/blob/master/docs/QuickStart.md (licencia MIT)
