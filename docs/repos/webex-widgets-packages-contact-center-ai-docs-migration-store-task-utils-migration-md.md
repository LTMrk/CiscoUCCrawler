---
doc_id: webex-widgets-packages-contact-center-ai-docs-migration-store-task-utils-migration-md
source_url: https://github.com/webex/widgets/blob/next/packages/contact-center/ai-docs/migration/store-task-utils-migration.md
repo: webex/widgets
ruta: packages/contact-center/ai-docs/migration/store-task-utils-migration.md
licencia: sin declarar
retrieved_at: 2026-08-24T09:09:17.117673+00:00
---

# widgets — packages/contact-center/ai-docs/migration/store-task-utils-migration.md
...
---
> Fuente: https://github.com/webex/widgets/blob/next/packages/contact-center/ai-docs/migration/store-task-utils-migration.md (licencia sin declarar)
