---
doc_id: webex-widgets-packages-contact-center-ai-docs-migration-call-control-hook-migration-md
source_url: https://github.com/webex/widgets/blob/next/packages/contact-center/ai-docs/migration/call-control-hook-migration.md
repo: webex/widgets
ruta: packages/contact-center/ai-docs/migration/call-control-hook-migration.md
licencia: sin declarar
retrieved_at: 2026-08-24T09:09:14.553213+00:00
---

# widgets — packages/contact-center/ai-docs/migration/call-control-hook-migration.md
...
---
> Fuente: https://github.com/webex/widgets/blob/next/packages/contact-center/ai-docs/migration/call-control-hook-migration.md (licencia sin declarar)
