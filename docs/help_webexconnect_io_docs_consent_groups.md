[Jump to Content](https://help.webexconnect.io/docs/consent-groups#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Consent Groups
Search
`CTRL-K`
All
Platform Documentation
...
# Consent Groups
Learn about Consent Group types and adding new groups.
[Suggest Edits](https://help.webexconnect.io/edit/consent-groups)
...
## 
Consent Group Types
[](https://help.webexconnect.io/docs/consent-groups#consent-group-types)
...
## 
Add a New Group
[](https://help.webexconnect.io/docs/consent-groups#add-a-new-group)
...
Screenshot of the Add New Consent Group page
  1. **Consent Group Type** – select Allow List or Deny List.
  ...
  2. Provide the information listed below.
  ...
  3. Under Frequency Type, select None, All Channels or Per Channel.
...
Screenshot of the interface with frequency type selected as None
...
Screenshot of the interface with frequency type selected as All Channels
...
Screenshot of the interface with frequency type selected as Per Channel.
  1. Click **+ Add Channel** to individually set the frequencies for the selected channels.
...
> The Frequency can only be set for channels selected in the displayed list.
  1. Click **Save**. The new group is listed on the Consent Group page.

![Screenshot of Image showing the Consent Group page with the newly added group appearing in the list of groups.](https://files.readme.io/ae883645a4afb083ad796b5728dd7729cb3de93e049ca5cd7d3ecd6f6e3d9c3f-image-20250812-132350.png)
Image showing the list of groups in the Consent Groups page
...
* * *
[Getting Started with Contact Policy](https://help.webexconnect.io/docs/getting-started-with-contact-policy-app)[Manage Consent Groups](https://help.webexconnect.io/docs/manage-consent-groups)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/consent-groups)
  *     * [Consent Group Types](https://help.webexconnect.io/docs/consent-groups#consent-group-types)
    * [Add a New Group](https://help.webexconnect.io/docs/consent-groups#add-a-new-group)
