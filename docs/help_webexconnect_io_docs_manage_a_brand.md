[Jump to Content](https://help.webexconnect.io/docs/manage-a-brand#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Managing a Brand
Search
`CTRL-K`
All
Platform Documentation
...
# Managing a Brand
Understand how to manage a brand on Webex Connect
[Suggest Edits](https://help.webexconnect.io/edit/manage-a-brand)
To manage a brand on the Webex Connect platform:
  1. In the Brands & Campaigns (10DLC) page, click the indicator towards the end of a brand record and click **Manage**.


> ## 📘
> Reusing Brand IDs
> If you have an existing brand listing in your account added by our Admin team, you can create a new campaign using the same brand ID.
  1. In the Manage Brand page, click **Edit Details**.

![Screenshot Displaying Manage Button Under Action.](https://files.readme.io/21aa599-4.jpg)
Screenshot Displaying Manage Button Under Action.
  1. Make required edits to fields in the sections.
  2. Click **Save**.
  3. Click **Resubmit**.

![Screenshot of Manage Brand Page.](https://files.readme.io/2b06039-5.jpg)
Screenshot of Manage Brand Page.
> ## 📘
> Note
> In case of errors during Brand registration or change in Brand information over time, you can reach out to the Operations or Support Team for help.
Updated 7 months ago
* * *
[Unverified Scenarios and Resubmission of Brands](https://help.webexconnect.io/docs/unverified-scenarios-and-resubmission-of-brands)[Registering a Campaign](https://help.webexconnect.io/docs/register-a-campaign)
