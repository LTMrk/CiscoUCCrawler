[Jump to Content](https://help.webexconnect.io/docs/sms-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)SMS Node
Search
`CTRL-K`
All
Platform Documentation
...
# SMS Node
Understand what an SMS node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/sms-node)
...
![Screenshot of SMS Node](https://files.readme.io/57185d4-SMS.jpg)
SMS Node
## 
Node Configuration
[](https://help.webexconnect.io/docs/sms-node#node-configuration)
### 
**Destination Type**
[](https://help.webexconnect.io/docs/sms-node#destination-type)
...
### 
**Destination**
[](https://help.webexconnect.io/docs/sms-node#destination)
...
### 
**From Number**
[](https://help.webexconnect.io/docs/sms-node#from-number)
The number or sender ID that is used to send the SMS needs to be selected here.
### 
**Message Type**
[](https://help.webexconnect.io/docs/sms-node#message-type)
...
### 
**Message**
[](https://help.webexconnect.io/docs/sms-node#message)
...
### 
**Add SmartLink**
[](https://help.webexconnect.io/docs/sms-node#add-smartlink)
...
### 
**Shortened Links**
[](https://help.webexconnect.io/docs/sms-node#shortened-links)
...
### 
**Correlation ID**
[](https://help.webexconnect.io/docs/sms-node#correlation-id)
...
### 
**Notify URL**
[](https://help.webexconnect.io/docs/sms-node#notify-url)
...
### 
**Advanced options**
[](https://help.webexconnect.io/docs/sms-node#advanced-options)
### 
**Wait For**
[](https://help.webexconnect.io/docs/sms-node#wait-for)
...
### 
**Expiry**
[](https://help.webexconnect.io/docs/sms-node#expiry)
...
* * *
[Start Node](https://help.webexconnect.io/docs/start-node)[Email Node](https://help.webexconnect.io/docs/email-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/sms-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/sms-node#node-configuration)
      * [**Destination Type**](https://help.webexconnect.io/docs/sms-node#destination-type)
      * [**Destination**](https://help.webexconnect.io/docs/sms-node#destination)
      * [**From Number**](https://help.webexconnect.io/docs/sms-node#from-number)
      * [**Message Type**](https://help.webexconnect.io/docs/sms-node#message-type)
      * [**Message**](https://help.webexconnect.io/docs/sms-node#message)
      * [**Add SmartLink**](https://help.webexconnect.io/docs/sms-node#add-smartlink)
      * [**Shortened Links**](https://help.webexconnect.io/docs/sms-node#shortened-links)
      * [**Correlation ID**](https://help.webexconnect.io/docs/sms-node#correlation-id)
      * [**Notify URL**](https://help.webexconnect.io/docs/sms-node#notify-url)
      * [**Callback Data**](https://help.webexconnect.io/docs/sms-node#callback-data)
      * [**Extra Parameters**](https://help.webexconnect.io/docs/sms-node#extra-parameters)
      * [**Advanced options**](https://help.webexconnect.io/docs/sms-node#advanced-options)
      * [**Wait For**](https://help.webexconnect.io/docs/sms-node#wait-for)
      * [**Expiry**](https://help.webexconnect.io/docs/sms-node#expiry)
