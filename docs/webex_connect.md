...
---
# ORIGEN: https://help.webexconnect.io/docs/welcome

[Jump to Content](https://help.webexconnect.io/docs/welcome#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Webex Connect Platform Overview
Search
`CTRL-K`
All
Platform Documentation
...
Enterprise Communications Platform as a Service (CPaaS)
[Suggest Edits](https://help.webexconnect.io/edit/welcome)
Webex Connect (formerly imiconnect) is an Enterprise Communications Platform as a Service (CPaaS) that enables enterprises to rapidly automate end-to-end customer interactions and journeys across 12+ channels.
Webex Connect offers various APIs and a rich low-code toolset to make it easy for enterprises to orchestrate, automate, and manage customer interactions across SMS, Voice, MMS, RCS, Email, Push Notifications, Live Chat, In-App Messaging, Apple Messages for Business, WhatsApp, Facebook Messenger, Instagram, and more.
At the heart of Webex Connect is a powerful visual flow builder that allows developers, product managers, configuration specialists, and other functional business users, to build, test, launch, analyze and optimize customer interaction flows across various communication channels and systems. 
Webex Connect offers pre-built integrations with various CRM, marketing, contact center, and other systems such as Salesforce, Freshdesk, Zendesk, Dialogflow, EPIC, and more. This reduces integration effort and allows you to accelerate end-to-end customer interactions and customer journey automation.
## 
Key Capabilities
[](https://help.webexconnect.io/docs/welcome#key-capabilities)
...
## 
Channel Support
[](https://help.webexconnect.io/docs/welcome#channel-support)
Webex Connect currently supports the following communication channels:
### 
SMS
[](https://help.webexconnect.io/docs/welcome#sms)
>   * [Requesting a Short Code](https://help.webexconnect.io/docs/shortcodes)
>   * [Setting up Sender IDs](https://help.webexconnect.io/docs/sender-id)
>   * [Requesting a Keyword](https://help.webexconnect.io/docs/keyword)
>   * [Buying Phone Numbers](https://help.webexconnect.io/docs/phone-numbers)
>   * [Sending SMS using our Multichannel Messaging API](https://developers.imiconnect.io/reference#section-smsmessage)
>   * [Sending SMS using our Visual Flow Builder](https://help.webexconnect.io/docs/send-sms)
> 

### 
RCS
[](https://help.webexconnect.io/docs/welcome#rcs)
>   * [Configuring your RCS App](https://help.webexconnect.io/docs/rcs)
>   * [Sending RCS Messages using our Multichannel Messaging API](https://developers.imiconnect.io/reference#messagesv2)
>   * [Sending RCS Messages using our Visual Flow Builder](https://help.webexconnect.io/docs/rcs-message-node)
>   * [Checking customer presence on RCS using RCS Capability Node](https://help.webexconnect.io/docs/rcs-capability-node)
> 

### 
Branded Text
[](https://help.webexconnect.io/docs/welcome#branded-text)
  * [Branded Text](https://help.webexconnect.io/docs/branded-text)


### 
Voice
[](https://help.webexconnect.io/docs/welcome#voice)
>   * [Buying Phone Numbers](https://help.webexconnect.io/docs/phone-numbers)
...
## 
Push Notifications
[](https://help.webexconnect.io/docs/welcome#push-notifications)
>   * [Configuring a Mobile/Web App](https://help.webexconnect.io/docs/mobile-web#section-push-notifications)
...
>   * [Using the Push Flow Node](https://help.webexconnect.io/docs/push)
> 

## 
Live Chat and In-App Messaging
[](https://help.webexconnect.io/docs/welcome#live-chat-and-in-app-messaging)
>   * [Configuring a Mobile/Web App](https://help.webexconnect.io/docs/mobile-web#section-add-a-mobile-application)
...
>   * [Using the Live Chat / In-App Messaging Flow Node](https://help.webexconnect.io/docs/in-app-messaging)
> 

## 
Apple Messages for Business
[](https://help.webexconnect.io/docs/welcome#apple-messages-for-business)
>   * [Configuring your Apple Messages for Business Profile](https://help.webexconnect.io/docs/apple-messages-for-business-setup)
>   * [Using our Multichannel Messaging API to send messages over Apple Messages for Business ](https://developers.webexconnect.io/reference/apple-messages-for-business-apis)
>   * [Using the Apple Messages for Business Flow Node](https://help.webexconnect.io/docs/apple-messages-for-business-node)
> 

## 
Messenger
[](https://help.webexconnect.io/docs/welcome#messenger)
>   * [Linking your Facebook Page to Webex Connect](https://help.webexconnect.io/docs/facebook-messenger)
...
>   * [Using the Messenger Flow Node ](https://help.webexconnect.io/docs/messenger)
> 

## 
WhatsApp
[](https://help.webexconnect.io/docs/welcome#whatsapp)
>   * [Setting up your WhatsApp Business Account](https://help.webexconnect.io/docs/whatsapp)
...
### 
Integrations
[](https://help.webexconnect.io/docs/welcome#integrations)
The following integrations are currently available on Webex Connect:
  * [Inbound Webhook](https://help.webexconnect.io/docs/inbound-webhooks)
  * [Outbound Webhook](https://help.webexconnect.io/docs/outbound-webhooks)
  * [Custom Event](https://help.webexconnect.io/docs/custom-events)
  ...
  * [Third-party Bot](https://help.webexconnect.io/docs/third-party-bot)
  * [Webex Contact Center](https://help.webexconnect.io/docs/wxcc-overview)
  * [Pre-built Integrations Nodes](https://help.webexconnect.io/docs/introduction-1)
    * [Agile CRM](https://help.webexconnect.io/docs/agile-crm)
    * [Salesforce CRM](https://help.webexconnect.io/docs/salesforce-node)
    * [AI Agent ](https://help.webexconnect.io/docs/ai-agent-node)
    ...
    * [ServiceNow ](https://help.webexconnect.io/docs/servicenow-node)
    * [Customer Journey Data](https://help.webexconnect.io/docs/customer-journey-data)
    * [Zendesk CRM](https://help.webexconnect.io/docs/zendesk-node)
    * [Freshdesk](https://help.webexconnect.io/docs/freshdesk-node)
    * [Zoho CRM](https://help.webexconnect.io/docs/zoho-crm)
...
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/welcome)
  *     * [Key Capabilities](https://help.webexconnect.io/docs/welcome#key-capabilities)
    * [Channel Support](https://help.webexconnect.io/docs/welcome#channel-support)
      * [SMS](https://help.webexconnect.io/docs/welcome#sms)
      * [RCS](https://help.webexconnect.io/docs/welcome#rcs)
      * [Branded Text](https://help.webexconnect.io/docs/welcome#branded-text)
      * [Voice](https://help.webexconnect.io/docs/welcome#voice)
      * [MMS](https://help.webexconnect.io/docs/welcome#mms)
      * [Email](https://help.webexconnect.io/docs/welcome#email)
    * [Push Notifications](https://help.webexconnect.io/docs/welcome#push-notifications)
    * [Live Chat and In-App Messaging](https://help.webexconnect.io/docs/welcome#live-chat-and-in-app-messaging)
    * [Apple Messages for Business](https://help.webexconnect.io/docs/welcome#apple-messages-for-business)
    * [Messenger](https://help.webexconnect.io/docs/welcome#messenger)
    * [WhatsApp](https://help.webexconnect.io/docs/welcome#whatsapp)
      * [Integrations](https://help.webexconnect.io/docs/welcome#integrations)
...
---
# ORIGEN: https://help.webexconnect.io/changelog

[Jump to Content](https://help.webexconnect.io/changelog#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)
Search
`CTRL-K`
All
Platform Documentation
Platform Changelog
###### Start typing to search…
# [Product Update - v6.21.0, August 2026](https://help.webexconnect.io/changelog/product-update-v6210-august-2026)
6 days ago
...
# [Product Update - v6.20.0, July 2026](https://help.webexconnect.io/changelog/product-update-v6200-july-2026)
29 days ago
...
# [Product Update - v6.19.0, June 2026](https://help.webexconnect.io/changelog/product-update-v6190-june-2026)
about 2 months ago
...
# [Product Update - v6.18.0, May 2026](https://help.webexconnect.io/changelog/product-update-v6180-may-2026)
3 months ago
...
# [Product Update - v6.17.0, April 2026](https://help.webexconnect.io/changelog/product-update-v6170-april-2026)
4 months ago
...
# [Product Update - v6.16.0, March 2026](https://help.webexconnect.io/changelog/product-update-v6160-march-2026)
5 months ago
...
# [Integration of Legacy Tenants with Webex Organization ID](https://help.webexconnect.io/changelog/integration-of-legacy-tenants-with-webex-organization-id)
6 months ago
The legacy Webex Connect tenants or tenants that were manually onboarded (or not via Cisco Partners) much earlier were integrated with Webex Organisation ID to enhance functionality and user experience, starting with Canada, Sydney, and Singapore regions on January 29th.
# [Product Update - v6.15.0, January 2026](https://help.webexconnect.io/changelog/product-update-v6150-january-2026)
7 months ago
...
# [WhatsApp Supports Business Portfolio Pacing, Relaxing Messaging Limit Tiers, and Text Truncation on Marketing Messages](https://help.webexconnect.io/changelog/whatsapp-supports-business-portfolio-pacing-relaxing-messaging-limit-tiers-and-text-truncation-on-marketing-messages)
8 months ago
WhatsApp has announced three major updates designed for faster growth and improvement of efficiency.
# [Product Update - v6.14.0, December 2025](https://help.webexconnect.io/changelog/product-update-v6140-december-2025)
8 months ago
...
1 of 10[](https://help.webexconnect.io/changelog?page=2)
Platform
[Channel Assets](https://help.imiconnect.io/docs/phone-numbers)
[Integrations](https://help.imiconnect.io/docs/pre-built-integrations)
[Flow Builder](https://help.imiconnect.io/docs/flows)
...
---
# ORIGEN: https://help.webexconnect.io/docs/accessing-the-product

[Jump to Content](https://help.webexconnect.io/docs/accessing-the-product#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Accessing Webex Connect
Search
`CTRL-K`
All
Platform Documentation
...
Accessing the Webex Connect by various login methods and navigating through various features.
[Suggest Edits](https://help.webexconnect.io/edit/accessing-the-product)
## 
Accessing the Product
[](https://help.webexconnect.io/docs/accessing-the-product#accessing-the-product)
To access Webex Connect, use the directions below.
  * Enter your tenant URL in the browser address bar (e.g., [https://..webexconnect.io]). Refer to [Know Your API Endpoints](https://developers.webexconnect.io/reference/endpoints) for guidance on selecting the relevant API endpoint.
...
Logging to Webex Connect using Username and Password
    * Only Webex SSO.
![Logging into Webex Connect using Webex Single Sign On \(SSO\)](https://files.readme.io/ba0408d-SSO.png)
Logging into Webex Connect using Webex Single Sign On (SSO)
...
### 
Session Timeout
[](https://help.webexconnect.io/docs/accessing-the-product#session-timeout)
...
## 
Navigation
[](https://help.webexconnect.io/docs/accessing-the-product#navigation)
...
### 
Services
[](https://help.webexconnect.io/docs/accessing-the-product#services)
...
### 
Reports
[](https://help.webexconnect.io/docs/accessing-the-product#reports)
...
### 
Assets
[](https://help.webexconnect.io/docs/accessing-the-product#assets)
...
### 
Tools
[](https://help.webexconnect.io/docs/accessing-the-product#tools)
...
### 
Debug
[](https://help.webexconnect.io/docs/accessing-the-product#debug)
...
[](https://help.webexconnect.io/docs/accessing-the-product#reports-and-analytics)
...
### 
Help
[](https://help.webexconnect.io/docs/accessing-the-product#help)
...
### 
App Tray
[](https://help.webexconnect.io/docs/accessing-the-product#app-tray)
...
### 
Profile Settings
[](https://help.webexconnect.io/docs/accessing-the-product#profile-settings)
...
* * *
[Webex Connect Platform Overview](https://help.webexconnect.io/docs/welcome)[The beginner's guide to Webex Connect](https://help.webexconnect.io/docs/getting-started-with-the-product)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/accessing-the-product)
  *     * [Accessing the Product](https://help.webexconnect.io/docs/accessing-the-product#accessing-the-product)
      * [Session Timeout](https://help.webexconnect.io/docs/accessing-the-product#session-timeout)
    * [Navigation](https://help.webexconnect.io/docs/accessing-the-product#navigation)
      * [Services](https://help.webexconnect.io/docs/accessing-the-product#services)
      * [Reports](https://help.webexconnect.io/docs/accessing-the-product#reports)
      * [Assets](https://help.webexconnect.io/docs/accessing-the-product#assets)
      * [Tools](https://help.webexconnect.io/docs/accessing-the-product#tools)
      * [Debug](https://help.webexconnect.io/docs/accessing-the-product#debug)
      * [Reports and Analytics](https://help.webexconnect.io/docs/accessing-the-product#reports-and-analytics)
      * [Help](https://help.webexconnect.io/docs/accessing-the-product#help)
      * [App Tray](https://help.webexconnect.io/docs/accessing-the-product#app-tray)
      * [Profile Settings](https://help.webexconnect.io/docs/accessing-the-product#profile-settings)
...
---
# ORIGEN: https://help.webexconnect.io/docs/getting-started-with-the-product

[Jump to Content](https://help.webexconnect.io/docs/getting-started-with-the-product#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)The beginner's guide to Webex Connect
Search
`CTRL-K`
All
Platform Documentation
...
If you're a first time user and are wondering how to rapidly create your first communication flow, here's a quick step-by-step guide to help you build a first-level understanding of the Webex Connect Enterprise CPaaS platform including the key steps for creating your first flow.
[Suggest Edits](https://help.webexconnect.io/edit/getting-started-with-the-product)
...
[](https://help.webexconnect.io/docs/getting-started-with-the-product#done-making-your-first-flow-and-ready-to-explore-more)
...
[](https://help.webexconnect.io/docs/getting-started-with-the-product#know-more-about-supported-channels)
...
* * *
[Accessing Webex Connect](https://help.webexconnect.io/docs/accessing-the-product)[Groups and Teams](https://help.webexconnect.io/docs/getting-started-groups-and-teams)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/getting-started-with-the-product)
  *     * [Done making your first flow and ready to explore more?](https://help.webexconnect.io/docs/getting-started-with-the-product#done-making-your-first-flow-and-ready-to-explore-more)
    * [Know more about supported channels](https://help.webexconnect.io/docs/getting-started-with-the-product#know-more-about-supported-channels)
...
---
# ORIGEN: https://help.webexconnect.io/docs/getting-started-groups-and-teams

[Jump to Content](https://help.webexconnect.io/docs/getting-started-groups-and-teams#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Groups and Teams
Search
`CTRL-K`
All
Platform Documentation
...
# Groups and Teams
Create groups and teams as sub-accounts under your Webex Connect tenant.
[Suggest Edits](https://help.webexconnect.io/edit/getting-started-groups-and-teams)
...
* * *
[The beginner's guide to Webex Connect](https://help.webexconnect.io/docs/getting-started-with-the-product)[Buying a Phone Number](https://help.webexconnect.io/docs/buying-phone-numbers)
Did this page help you?
Yes
No
Platform
...
---
# ORIGEN: https://help.webexconnect.io/docs/buying-phone-numbers

[Jump to Content](https://help.webexconnect.io/docs/buying-phone-numbers#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Buying a Phone Number
Search
`CTRL-K`
All
Platform Documentation
...
Webex Connect allows you to buy phone numbers, keywords, and/or sender IDs to send and receive SMS and/or voice calls to your customers. This tutorial covers how you can buy phone numbers (long codes) using Webex Connect.
[Suggest Edits](https://help.webexconnect.io/edit/buying-phone-numbers)
You can buy numbers either from within a Service or by visiting the **Assets** -> **Numbers** section. Here're the steps for buying a phone number in Webex Connect:
## 
Step 1: Go to 'Buy - Phone Number' section
[](https://help.webexconnect.io/docs/buying-phone-numbers#step-1-go-to-buy---phone-number-section)
**Option 1.** Click **Buy Numbers** under the Flows section of the service dashboard. 
![Buying a Phone Number from Service Dashboard](https://files.readme.io/1e5136d-Buying_Phone_NUmbers.jpg)
The above section can be accessed on the service dashboard of any created service
**Option 2:** Hover over the **Assets** icon from the menu bar on the left and click **Numbers**.
![Accessing Numbers through Assets](https://files.readme.io/462b1c0-19.jpg)
The Assets menu option can be accessed from the vertical menu bar across Webex Connect
## 
Step 2: Buy a Phone Number
[](https://help.webexconnect.io/docs/buying-phone-numbers#step-2-buy-a-phone-number)
  1. Click **Get Numbers** > **Phone Number**.
  2. Select the desired **Country** from the drop-down list and then select the **Number Type**. 
  3. Click **Find Numbers** to get a list of the available numbers.

![Buying a Number from Assets](https://files.readme.io/d06447b-Get_Numbers1.png)
Buy Phone Numbers screen
  1. Pick a number that suits your requirement from the available options and click **BUY**.  
You will then see a purchase confirmation dialog box. 
  2. Click **BUY NUMBER** to proceed further.


All the numbers purchased by you are available for use across flows. Also, you can use them through the messaging API by configuring the **Sender ID** parameter.
> ## 📘
> Note
...
Updated 7 months ago
* * *
[Groups and Teams](https://help.webexconnect.io/docs/getting-started-groups-and-teams)[Creating a Flow on Webex Connect](https://help.webexconnect.io/docs/create-a-new-flow)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/buying-phone-numbers)
  *     * [Step 1: Go to 'Buy - Phone Number' section](https://help.webexconnect.io/docs/buying-phone-numbers#step-1-go-to-buy---phone-number-section)
    * [Step 2: Buy a Phone Number](https://help.webexconnect.io/docs/buying-phone-numbers#step-2-buy-a-phone-number)
...
---
# ORIGEN: https://help.webexconnect.io/docs/create-a-new-flow

[Jump to Content](https://help.webexconnect.io/docs/create-a-new-flow#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Creating a Flow on Webex Connect
Search
`CTRL-K`
All
Platform Documentation
...
Webex Connect allows you to rapidly configure two-way communication flows using a drag-and-drop flow builder. Below are the steps to configure a flow.
[Suggest Edits](https://help.webexconnect.io/edit/create-a-new-flow)
## 
Step 1 - Add a New Flow
[](https://help.webexconnect.io/docs/create-a-new-flow#step-1---add-a-new-flow)
  1. Click **Create Blank Flow** button under the Flows section on the service dashboard. 

![Creating a Blank Flow using Services Dashboard](https://files.readme.io/75a2d14-4.jpg)
Creating a Blank Flow using Services Dashboard
Alternatively, click **Flows** tab (shown below), and then click either of the two **Create Flow** buttons.
![Creating a Blank Flow using Flows](https://files.readme.io/6be742d-5.jpeg)
Creating a Blank Flow using Flows
  1. Enter the Flow Name and choose the **Type** as WorkFlow. You can select 'Voice Flow' in case you want to build a voice flow.
  2. In the **Method** dropdown, select the **New Flow** option.
  3. Select **Start from Scratch** option to create a flow from the beginning and click on **Create** to proceed further. 


In case you would like to build an SMS survey, appointment reminder flow, or an autoresponder flow you can select one of the pre-built templates and get a head start.
![Creating a Flow popup](https://files.readme.io/f0cf650-9.jpg)
Creating a Flow popup
  1. Once done, you will arrive at the **Select Trigger Category** page where you can configure how this flow will be triggered. You can pick from the displayed trigger categories e.g. channel triggers, system triggers, or custom triggers.

![Select Trigger Category window](https://files.readme.io/3e716c7-1.jpeg)
Select Trigger Category window
From here on, you can follow one of the below end-to-end tutorials. 
  * [Sending automated SMS using Webex Connect Visual Flow Builder](https://help.imiconnect.io/docs/sending-automated-sms-using-imiconnect-visual-flow-builder)
  * [Setting up an Appointment Reminder in Webex Connect](https://help.imiconnect.io/docs/setting-up-an-appointment-reminder-in-imiconnect)


Updated over 1 year ago
* * *
[Buying a Phone Number](https://help.webexconnect.io/docs/buying-phone-numbers)[Sending automated SMS using Webex Connect Visual Flow Builder](https://help.webexconnect.io/docs/sending-automated-sms)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/create-a-new-flow)
  *     * [Step 1 - Add a New Flow](https://help.webexconnect.io/docs/create-a-new-flow#step-1---add-a-new-flow)
...
---
# ORIGEN: https://help.webexconnect.io/docs/sending-automated-sms

[Jump to Content](https://help.webexconnect.io/docs/sending-automated-sms#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Sending automated SMS using Webex Connect Visual Flow Builder
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/sending-automated-sms)
> ## 📘
> Prerequisites
...
[](https://help.webexconnect.io/docs/sending-automated-sms#step-1-create-a-service)
...
[](https://help.webexconnect.io/docs/sending-automated-sms#step-2-get-a-phone-number)
...
[](https://help.webexconnect.io/docs/sending-automated-sms#step-3-create-a-flow-to-send-sms)
### 
1. Create a New Flow
[](https://help.webexconnect.io/docs/sending-automated-sms#1-create-a-new-flow)
...
[](https://help.webexconnect.io/docs/sending-automated-sms#2-select-the-custom-event-as-the-event-trigger-on-the-trigger-category-selection-page)
...
### 
3. Build the Flow
[](https://help.webexconnect.io/docs/sending-automated-sms#3-build-the-flow)
...
[](https://help.webexconnect.io/docs/sending-automated-sms#step-4--configure-the-onsuccess-event)
[**Click here**](http://help.imiconnect.io/docs/configure-the-onsuccess-event) for detailed steps on configuring **onsuccess** event for SMS node. 
## 
Step 5 : Configure the 'onerror' event
[](https://help.webexconnect.io/docs/sending-automated-sms#step-5--configure-the-onerror-event)
[**Click here**](https://help.imiconnect.io/docs/configuring-error-events-for-a-node) for detailed steps on configuring **onerror** event for SMS node.
## 
Publish the Flow
[](https://help.webexconnect.io/docs/sending-automated-sms#publish-the-flow)
[**Click here**](https://help.imiconnect.io/docs/flows#configuring-and-publishing-a-flow) to know more about publishing a flow.
## 
Step 7: Invoke the flow using Postman
[](https://help.webexconnect.io/docs/sending-automated-sms#step-7-invoke-the-flow-using-postman)
[**Click here**](http://help.imiconnect.io/docs/invoke-the-flow-using-postman-or-any-alternative-tools) for steps on testing using postman
...
Updated 4 months ago
* * *
[Creating a Flow on Webex Connect](https://help.webexconnect.io/docs/create-a-new-flow)[Flow Debug](https://help.webexconnect.io/docs/transaction-logs-and-debugging)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/sending-automated-sms)
  *     * [Step 1: Create a Service](https://help.webexconnect.io/docs/sending-automated-sms#step-1-create-a-service)
    * [Step 2: Get a phone number](https://help.webexconnect.io/docs/sending-automated-sms#step-2-get-a-phone-number)
    * [Step 3: Create a Flow to Send SMS](https://help.webexconnect.io/docs/sending-automated-sms#step-3-create-a-flow-to-send-sms)
      * [1. Create a New Flow](https://help.webexconnect.io/docs/sending-automated-sms#1-create-a-new-flow)
      * [2. Select the custom event as the event trigger on the trigger category selection page](https://help.webexconnect.io/docs/sending-automated-sms#2-select-the-custom-event-as-the-event-trigger-on-the-trigger-category-selection-page)
      * [3. Build the Flow](https://help.webexconnect.io/docs/sending-automated-sms#3-build-the-flow)
    * [Step 4 : Configure the 'onsuccess' event](https://help.webexconnect.io/docs/sending-automated-sms#step-4--configure-the-onsuccess-event)
    * [Step 5 : Configure the 'onerror' event](https://help.webexconnect.io/docs/sending-automated-sms#step-5--configure-the-onerror-event)
    * [Publish the Flow](https://help.webexconnect.io/docs/sending-automated-sms#publish-the-flow)
    * [Step 7: Invoke the flow using Postman](https://help.webexconnect.io/docs/sending-automated-sms#step-7-invoke-the-flow-using-postman)
...
---
# ORIGEN: https://help.webexconnect.io/docs/transaction-logs-and-debugging

[Jump to Content](https://help.webexconnect.io/docs/transaction-logs-and-debugging#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Flow Debug
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/transaction-logs-and-debugging)
...
[](https://help.webexconnect.io/docs/transaction-logs-and-debugging#transaction-sequence-summary)
...
[](https://help.webexconnect.io/docs/transaction-logs-and-debugging#node-execution-details)
...
![800](https://files.readme.io/56dd4d9-3.jpg)
...
## 
Transaction Logs
[](https://help.webexconnect.io/docs/transaction-logs-and-debugging#transaction-logs)
...
[](https://help.webexconnect.io/docs/transaction-logs-and-debugging#transaction-channels)
...
| --- | --- | --- |  
| SMS  | Mobile originated -MO  | Timestamp  
Sender Number  
Service Number  
Message  |  
| SMS  | On Link click  | Timestamp  
Sender Number   |  
| Voice  | Inbound call  | Service Number  
Timestamp  
MSISDN   |  
| Voice  | Missed call  | Service Number  
Timestamp  
MSISDN   |  
| MMS  | Mobile originated -MO  | Sender Number   |  
| Messenger  | Incoming Message  | AppId  
PSID  
Message  
Attachment URL  
Timestamp  
Location URL   |  
| Messenger  | On link click  | AppId  
PSID  
Tim_estamp   |  
| Messenger  | Postback  | AppId  
PSID  
Timestamp  
Post_back Payload   |  
| WhatsApp  | Incoming Message  | AppId  
WaId  
Timestamp  
Message  
Image URL  
...
Video URL  
Sticker URL   |  
| WhatsApp  | Postback  | AppId  
WaId  
Timestamp  
Button Payload   |  
| WhatsApp  | List Message  | AppId  
WaId  
Timestamp  
List Description  
Row Title  
...
Reply button Message  |   | AppId  
WaId  
Timestamp  
Reply Button Title  
Reply Button Identifier   |  
| In-App / Live Chat  | Custom event  | UserId  
PushId  
Timestamp  
AppId  |  
| In-App / Live Chat  | Incoming Message  | Timestamp  
UserId  
PushId  
Message  
Attachments  
...
Version  
Threadid  |  
| In-App / Live Chat  | On thread close  | Threadid  
AppId  
UserId  |  
| In-App / Live Chat  | On postback  | Timestamp  
UserId  
PushId  
Message  
Attachments  
...
ThreadId  
Button Payload  |  
| Email  | Incoming Message  | Message  
Emailid  
AppId  
To Address  
Attachments  
Receipts  
Timestamp  |  
| Email  | Subscribe  | Emailid  
AppId  
Attachments  
Timestamp  |  
| Email  | unsubscribe  | EmailId  
AppId  
Attachments  
Timestamp  |  
| RCS  | Incoming Message  | Text  
Timestamp  
AppId  
Number  |  
| RCS  | Message  
Incoming attachment  | Text  
Timestamp  
AppId  
Number  
File URL  |  
| RCS  | Location response  | Text  
Timestamp  
AppId  
Number  |  
| RCS  | Postback  | Text  
...
Number  
Postback Data  |  
| Apple Messages for Business  | Conversation closed  | ABCUserId  
AppId  |  
| Apple Messages for Business  | Interactive Message authentication  | AppId  
AuthToken  
AuthStatus  |  
| Apple Messages for Business  | Interactive Message list picker  | ABCUserId  
AppId  
Timestamp  
...
| Apple Messages for Business  | Interactive Message payment  | ABCUserId  
AppId  
Timestamp  
Payment Status  |  
| Apple Messages for Business  | Incoming Message  | ABCUserId  
AppId  
Timestamp  
Message  
Attachment URL  |  
| Apple Messages for Business  | Interactive Message quick reply  | ABCUserId  
AppId  
Timestamp  
Selected Identifier  
Selected Index  |  
| Apple Messages for Business  | Interactive Message form response  | ABCUserId  
AppId  
Timestamp  
Selections  
Selections Count  |  
| Apple Messages for Business  | Typing indicator  | ABCUserId  
AppIdAppId  
Type  |  
| Apple Messages for Business  | Interactive Message new authentication  | AppId  
AuthToken  
AuthStatus  |  
| Apple Messages for Business  | Interactive Message iMessage extension  | AppId  
URL  |  
| Custom event  |   | Payload  
Timestamp  |  
| Google Business Messages  | Incoming Message  | AppId  
ConversationId  
AgentId  
Send Time  
MessageId  
Text  |  
| Google Business Messages  | User Status  | AppId  
ConversationId  
AgentId  
Send Time  
IsTyping  
Requested Live Agent  |  
| Google Business Messages  | Survey Response  | AppId  
ConversationId  
AgentId  
Send Time  
SurveyId  
...
QuestionIndex  |  
| Google Business Messages  | Suggestion Response  | AppId  
ConversationId  
AgentId  
Send Time  
MessageId  
...
Text  
Suggestion Type   |  
| Instagram  | Incoming Message  | MessageId  
Igsid  
Igid  
Timestamp  
UserId  
...
Story Reply Url  
Replied MessageId  |  
| Instagram  | Message Deleted  | MessageId  
Igsid  
Igid  
Timestamp  
UserId  
...
Message  
Timestamp  |  
| Messenger  | Incoming Message  | PSID  
AppId  
Message  
Attachments  
Timestamp  |  
| Messenger  | Postback  | PSID  
AppId  
Payload  
Timestamp  |  
| WhatsApp  | Incoming Message  | AppId  
...
| WhatsApp  | Reply button Message  | AppId  
WaId  
Timestamp  
Reply Button Title  
Reply Button Identifier  |  
...
Version  
ThreadId  |  
| In-App / Live Chat  | Form response  | Timestamp  
UserId  
PushId  
Form Response  
Attachments  
DeviceIdVersion  
ThreadId  |  
| In-App / Live Chat  | Postback  | Timestamp  
UserId  
PushId  
Message  
Attachments  
...
ThreadId  
Button Payload  |  
| Apple Messages for Business  | Interactive Message Time picker  | ABCUserId  
AppId  
Timestamp  
Message  
Attachment URL  
...
Time Slot Identifier  
Time Slot Start Time  |  
| Apple Messages for Business  | Interactive Message authentication  | AuthToken  
AuthStatus  |  
| Apple Messages for Business  | Interactive Message list picker  | ABCUserId  
AppId  
Timestamp  
...
[](https://help.webexconnect.io/docs/transaction-logs-and-debugging#variables-created-or-updated-during-the-node-execution)
...
## 
FAQs
[](https://help.webexconnect.io/docs/transaction-logs-and-debugging#faqs)
### 
...
[](https://help.webexconnect.io/docs/transaction-logs-and-debugging#question-why-are-there-escape-characters-like-forward-slash--in-the-json-parameters-shown-in-the-logs-of--flow-builder-especially-in-the-start-node-or-when-using-httpcustomprebuilt-integration-nodes-do-these-characters-alter-the-variable-values-at-runtime)
No, the values of your variables are not altered during runtime. The escape characters you see (such as forward slash - ) are only added for representation purposes in the logs. They help display the raw JSON structure and ensure special characters are visible and preserved in the log output. For example, if your incoming JSON parameter is: {"email": "Connect@Connect.com"}, in the flow Debug Logs the value of email parameter may appear as: "Connect@Connect.com" . Here, the forward slash are just to "escape" the quotation marks inside the JSON string for clear display. At runtime, the actual value used in your flow (e.g., in Transition Actions) is the real, unescaped value - ‘Connect@Connect.com’. This means the flow logic operates on the correct variable value without the extra escape characters.
### 
Question: Why are escape characters used in the logs?
[](https://help.webexconnect.io/docs/transaction-logs-and-debugging#question-why-are-escape-characters-used-in-the-logs)
...
* * *
[Sending automated SMS using Webex Connect Visual Flow Builder](https://help.webexconnect.io/docs/sending-automated-sms)[Tenant Configuration Best Practices](https://help.webexconnect.io/docs/getting-started-best-practices)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/transaction-logs-and-debugging)
  *     * [Transaction Sequence Summary](https://help.webexconnect.io/docs/transaction-logs-and-debugging#transaction-sequence-summary)
    * [Node Execution Details](https://help.webexconnect.io/docs/transaction-logs-and-debugging#node-execution-details)
    * [Transaction Logs](https://help.webexconnect.io/docs/transaction-logs-and-debugging#transaction-logs)
    * [Transaction Channels](https://help.webexconnect.io/docs/transaction-logs-and-debugging#transaction-channels)
    * [Variables Created or Updated during the Node Execution](https://help.webexconnect.io/docs/transaction-logs-and-debugging#variables-created-or-updated-during-the-node-execution)
    * [FAQs](https://help.webexconnect.io/docs/transaction-logs-and-debugging#faqs)
      * [Question: Why are there escape characters (like forward slash '') in the JSON parameters shown in the logs of Webex Connect Flow Builder, especially in the Start Node or when using HTTP/Custom/Prebuilt Integration nodes? Do these characters alter the variable values at runtime?](https://help.webexconnect.io/docs/transaction-logs-and-debugging#question-why-are-there-escape-characters-like-forward-slash--in-the-json-parameters-shown-in-the-logs-of--flow-builder-especially-in-the-start-node-or-when-using-httpcustomprebuilt-integration-nodes-do-these-characters-alter-the-variable-values-at-runtime)
      * [Question: Why are escape characters used in the logs?](https://help.webexconnect.io/docs/transaction-logs-and-debugging#question-why-are-escape-characters-used-in-the-logs)
...
---
# ORIGEN: https://help.webexconnect.io/docs/getting-started-best-practices

[Jump to Content](https://help.webexconnect.io/docs/getting-started-best-practices#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Tenant Configuration Best Practices
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/getting-started-best-practices)
Here are some of the best practices you can follow when starting your journey with Webex Connect platform:
  ...
  * Configure [IP Address Allowlist](https://help.webexconnect.io/docs/tenant-settings#ip-address-allowlist) to restrict API traffic for your tenant to trusted IPv4 addresses or CIDR ranges.
...
Updated 16 days ago
* * *
[Flow Debug](https://help.webexconnect.io/docs/transaction-logs-and-debugging)[Getting Started with Sandbox](https://help.webexconnect.io/docs/getting-started-with-sandbox)
Did this page help you?
Yes
No
Platform
...
---
# ORIGEN: https://help.webexconnect.io/docs/getting-started-with-sandbox

[Jump to Content](https://help.webexconnect.io/docs/getting-started-with-sandbox#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Getting Started with Sandbox
Search
`CTRL-K`
All
Platform Documentation
...
Understand what is Sandbox and how to sign-up for Sandbox
[Suggest Edits](https://help.webexconnect.io/edit/getting-started-with-sandbox)
Enterprise developers and business owners who want to explore Webex Connect capabilities before subscribing to the enterprise platform license can sign-up for a sandbox account [here](https://sandbox.us.webexconnect.io/self-sign-up). 
> ## ❗️
> New Sandbox Site
> Webex Connect Sandbox is now available at [sandbox.us.webexconnect.io](https://sandbox.us.webexconnect.io/login). The previous Sandbox site - [sandbox.imiconnect.io](https://sandbox.imiconnect.io/), was decommissioned on 17th October 2024.
...
[](https://help.webexconnect.io/docs/getting-started-with-sandbox#what-does-the-sandbox-contain)
...
To make it easy for you to get started with your Webex Connect journey, we pre-provision phone numbers/sender IDs for sending or receiving communications across SMS, voice, and WhatsApp. 
...
[](https://help.webexconnect.io/docs/getting-started-with-sandbox#signing-up-for-and-accessing-webex-connect-sandbox)
To register for an Webex Connect sandbox account, type <https://sandbox.us.webexconnect.io/self-sign-up> in your browser to access the Webex Connect landing page.
![Webex Connect Sandbox Registration Page](https://files.readme.io/6346591-Sandbox.jpg)
Webex Connect Developer Sandbox Registration 
...
* * *
[Tenant Configuration Best Practices](https://help.webexconnect.io/docs/getting-started-best-practices)[Accessing Webex Connect Sandbox](https://help.webexconnect.io/docs/accessing-sandbox)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/getting-started-with-sandbox)
  *     * [What does the Sandbox contain](https://help.webexconnect.io/docs/getting-started-with-sandbox#what-does-the-sandbox-contain)
    * [Signing-up for and accessing Webex Connect Sandbox](https://help.webexconnect.io/docs/getting-started-with-sandbox#signing-up-for-and-accessing-webex-connect-sandbox)
...
---
# ORIGEN: https://help.webexconnect.io/docs/accessing-sandbox

[Jump to Content](https://help.webexconnect.io/docs/accessing-sandbox#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Accessing Webex Connect Sandbox
Search
`CTRL-K`
All
Platform Documentation
...
Understand how to access the Webex Connect Sandbox and to navigate through various features
[Suggest Edits](https://help.webexconnect.io/edit/accessing-sandbox)
## 
Accessing Sandbox
[](https://help.webexconnect.io/docs/accessing-sandbox#accessing-sandbox)
To access the sandbox, use the directions below.
  * In the browser address field, type <https://sandbox.us.webexconnect.io/>. 
  * Type your username and password to log in.
  * After you successfully log in, the sandbox dashboard appears with the SMS tab in view.


## 
Sandbox Navigation
[](https://help.webexconnect.io/docs/accessing-sandbox#sandbox-navigation)
When you log into Webex Connect sandbox, you reach the 'Sandbox Home' page by default. This page provides you with the ability to quickly and easily send and receive test messages or calls across SMS, Voice and WhatApp. There are three tabs on the page, one dedicated to each channel. Each contains a widget to allow you to initiate or receive test messages, sample code in various languages, and links to deeper functionality.
![Screenshot of Webex Connect Sandbox Home page with tabs for SMS, Voice, and WhatsApp, featuring test message widgets and sample code.](https://files.readme.io/a6e87f6-1.jpg)
Screenshot of Webex Connect Sandbox Home page with tabs for SMS, Voice, and WhatsApp.
  * SMS - By using the Webex Connect Sandbox you can send and receive SMS from the interface, APIs, SDKs and advanced flows. For more information, refer to the [Sending and Receiving SMS using Sandbox](https://help.imiconnect.io/docs/sending-and-receiving-sms-using-sandbox) section. 
  * Voice - You can make a voice call to your registered phone number(s) using pre-provisioned phone numbers. For more information, refer to the [Making and Receiving Voice Calls using Sandbox](https://help.imiconnect.io/docs/making-and-receiving-calls-using-sandbox) section.
  * WhatsApp - By using the Webex Connect Sandbox you can send and receive WhatsApp messages from the interface, APIs, SDKs and advanced flows. For more information, refer to the [Sending and Receiving WhatsApp Messages using Sandbox](https://help.imiconnect.io/docs/sending-and-receiving-whatsapp-messages-using-sandbox) section.


The navigation bar for the sandbox can be found on the left-side of the page.
![Screenshot of the left-side navigation bar for sandbox page](https://files.readme.io/396cf84-3.jpg)
Sandbox Navigation Bar
### 
Services
[](https://help.webexconnect.io/docs/accessing-sandbox#services)
A service is a named workspace to manage a given customer interaction use case. Each service provides you with a unique service key that's needed for using Webex Connect communication APIs, event APIs, and inbound webhooks. Refer to the [Services Documentation](https://help.imiconnect.io/docs/introduction) for more information.
### 
Reports
[](https://help.webexconnect.io/docs/accessing-sandbox#reports)
The Reports section helps you view and analyze your messaging and flow traffic across various services. Webex Connect provides reporting at three levels - platform level summary, channel asset level summary, and service level summary. Refer to the [Reports Documentation](https://help.imiconnect.io/docs/service-reports) for more information.
### 
Assets
[](https://help.webexconnect.io/docs/accessing-sandbox#assets)
Assets is where you manage the numbers, apps (3rd party messaging platform connections), and integrations associated with your account. In the developer sandbox, you are not able to add new numbers or apps as these are preconfigured for you. Refer to the [Assets Documentation](https://help.imiconnect.io/docs/inbound-webhooks) for more information.
### 
Tools
[](https://help.webexconnect.io/docs/accessing-sandbox#tools)
As part of tools, you can access [Voice Media](https://help.imiconnect.io/docs/voice-media), [Voice Recordings](https://help.imiconnect.io/docs/voice-recordings), [Smart Links](https://help.imiconnect.io/docs/smart-links), [Templates](https://help.imiconnect.io/docs/templates), [Export Logs](https://help.webexconnect.io/docs/export-logs-overview), and [Media Manager](https://help.imiconnect.io/docs/media-manager).
### 
Debug
[](https://help.webexconnect.io/docs/accessing-sandbox#debug)
View transaction details and troubleshoot issues using a Transaction ID or a Destination ID or a date range. Refer to the [Debug Console Documentation](https://help.imiconnect.io/docs/console) for more information.
Updated 4 months ago
* * *
[Getting Started with Sandbox](https://help.webexconnect.io/docs/getting-started-with-sandbox)[Sending and Receiving SMS using Sandbox](https://help.webexconnect.io/docs/sending-and-receiving-sms-using-sandbox)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/accessing-sandbox)
  *     * [Accessing Sandbox](https://help.webexconnect.io/docs/accessing-sandbox#accessing-sandbox)
    * [Sandbox Navigation](https://help.webexconnect.io/docs/accessing-sandbox#sandbox-navigation)
      * [Services](https://help.webexconnect.io/docs/accessing-sandbox#services)
      * [Reports](https://help.webexconnect.io/docs/accessing-sandbox#reports)
      * [Assets](https://help.webexconnect.io/docs/accessing-sandbox#assets)
      * [Tools](https://help.webexconnect.io/docs/accessing-sandbox#tools)
      * [Debug](https://help.webexconnect.io/docs/accessing-sandbox#debug)
...
---
# ORIGEN: https://help.webexconnect.io/docs/sending-and-receiving-sms-using-sandbox

[Jump to Content](https://help.webexconnect.io/docs/sending-and-receiving-sms-using-sandbox#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Sending and Receiving SMS using Sandbox
Search
`CTRL-K`
All
Platform Documentation
...
Understand how to send and receive SMS using Sandbox
[Suggest Edits](https://help.webexconnect.io/edit/sending-and-receiving-sms-using-sandbox)
...
## 
Sandbox Home UI
[](https://help.webexconnect.io/docs/sending-and-receiving-sms-using-sandbox#sandbox-home-ui)
Webex Connect sandbox allows you to send and/or receive SMS messages using following three options:
  * Home Screen
  * SMS API
  * Flow Builder 

![Screenshot of the Sandbox Home screen displaying SMS sending feature](https://files.readme.io/0952a13-2.jpg)
Sending SMS from Sandbox Home Screen
### 
Sending SMS from Sandbox Home screen
[](https://help.webexconnect.io/docs/sending-and-receiving-sms-using-sandbox#sending-sms-from-sandbox-home-screen)
...
| From Number  | The Phone Number or the Sender ID used for sending the message from Webex Connect. This value is automatically populated in Sandbox mode and cannot be changed.  
  
Depending on the country you are sending messaging to, this will either be a local phone number, or an Alpha Sender ID.  |  
| To Number  | Phone number of the message recipient.  
...
[](https://help.webexconnect.io/docs/sending-and-receiving-sms-using-sandbox#receiving-sms-from-sandbox-home-screen)
...
![Screenshot of the Sandbox Home screen displaying SMS receiving feature](https://files.readme.io/f973ad5-Receive_SMS.jpeg)
Receiving SMS from Sandbox Home Screen
> ## 📘
> Note
...
## 
SMS API
[](https://help.webexconnect.io/docs/sending-and-receiving-sms-using-sandbox#sms-api)
...
## 
Visual Flow Builder
[](https://help.webexconnect.io/docs/sending-and-receiving-sms-using-sandbox#visual-flow-builder)
...
Updated 4 months ago
* * *
[Accessing Webex Connect Sandbox](https://help.webexconnect.io/docs/accessing-sandbox)[Making and Receiving Voice Calls using Sandbox](https://help.webexconnect.io/docs/making-and-receiving-voice-calls-using-sandbox)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/sending-and-receiving-sms-using-sandbox)
  *     * [Sandbox Home UI](https://help.webexconnect.io/docs/sending-and-receiving-sms-using-sandbox#sandbox-home-ui)
      * [Sending SMS from Sandbox Home screen](https://help.webexconnect.io/docs/sending-and-receiving-sms-using-sandbox#sending-sms-from-sandbox-home-screen)
      * [Receiving SMS from Sandbox Home screen](https://help.webexconnect.io/docs/sending-and-receiving-sms-using-sandbox#receiving-sms-from-sandbox-home-screen)
    * [SMS API](https://help.webexconnect.io/docs/sending-and-receiving-sms-using-sandbox#sms-api)
    * [Visual Flow Builder](https://help.webexconnect.io/docs/sending-and-receiving-sms-using-sandbox#visual-flow-builder)
...
---
# ORIGEN: https://help.webexconnect.io/docs/making-and-receiving-voice-calls-using-sandbox

[Jump to Content](https://help.webexconnect.io/docs/making-and-receiving-voice-calls-using-sandbox#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Making and Receiving Voice Calls using Sandbox
Search
`CTRL-K`
All
Platform Documentation
...
Understand how to make and receive Voice using Sandbox
[Suggest Edits](https://help.webexconnect.io/edit/making-and-receiving-voice-calls-using-sandbox)
...
## 
Sandbox Home UI
[](https://help.webexconnect.io/docs/making-and-receiving-voice-calls-using-sandbox#sandbox-home-ui)
You can make calls and view sample code for your voice requests on the Sandbox Home page by using the Voice tab. 
![Screenshot of the Sandbox Home screen displaying call-making feature](https://files.readme.io/7c69a7c-3.jpg)
Making a Call from Sandbox Home Screen
### 
Making a Call from Sandbox Home screen
[](https://help.webexconnect.io/docs/making-and-receiving-voice-calls-using-sandbox#making-a-call-from-sandbox-home-screen)
...
| From Number  | The Phone Number is used for making a call from Webex Connect. This value is automatically populated in Sandbox mode and cannot be changed.  
  
Depending on the country you are making a call to, this will be a local phone number.  |  
| To Number  | Phone number of the voice recipient.  
...
### 
Receiving a Call
[](https://help.webexconnect.io/docs/making-and-receiving-voice-calls-using-sandbox#receiving-a-call)
...
![](https://files.readme.io/953cc0c-4.jpg)
  1. Select the voice channel number you want to configure a webhook for and under the Actions menu, click Manage. The Manage Phone Number page appears.

![](https://files.readme.io/2e85717-5.jpg)
  1. Select the **Handling Incoming Calls via Callback URL** check box. The Manage Phone Number page expands allowing you to enter your configuration information.
...
Provide the information listed below.
  ...
  * Select Service – From the drop-down list select the service for this URL.
  ...
  1. If you want to validate webhooks with a signature generated using SHA256 or SHA512 sent in the header x-hub-signature, select the Enable Hub Signature check box. The value will be in the form method=signature where method is the algorithm selected.
  2. Click **Save**.
...
Updated 4 months ago
* * *
[Sending and Receiving SMS using Sandbox](https://help.webexconnect.io/docs/sending-and-receiving-sms-using-sandbox)[Sending and Receiving WhatsApp Messages using Sandbox](https://help.webexconnect.io/docs/sending-and-receiving-whatsapp-messages-using-sandbox)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/making-and-receiving-voice-calls-using-sandbox)
  *     * [Sandbox Home UI](https://help.webexconnect.io/docs/making-and-receiving-voice-calls-using-sandbox#sandbox-home-ui)
      * [Making a Call from Sandbox Home screen](https://help.webexconnect.io/docs/making-and-receiving-voice-calls-using-sandbox#making-a-call-from-sandbox-home-screen)
      * [Receiving a Call](https://help.webexconnect.io/docs/making-and-receiving-voice-calls-using-sandbox#receiving-a-call)
...
---
# ORIGEN: https://help.webexconnect.io/docs/sending-and-receiving-whatsapp-messages-using-sandbox

[Jump to Content](https://help.webexconnect.io/docs/sending-and-receiving-whatsapp-messages-using-sandbox#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Sending and Receiving WhatsApp Messages using Sandbox
Search
`CTRL-K`
All
Platform Documentation
...
Understand how to send and receive WhatsApp messages using Sandbox
[Suggest Edits](https://help.webexconnect.io/edit/sending-and-receiving-whatsapp-messages-using-sandbox)
...
## 
Sandbox Home UI
[](https://help.webexconnect.io/docs/sending-and-receiving-whatsapp-messages-using-sandbox#sandbox-home-ui)
Webex Connect sandbox allows you to send and/or receive WhatsApp messages using following three options:
  * Home Screen
  * WhatsApp API
  * Flow Builder 

![Screenshot of the Sandbox Home screen displaying WhatsApp sending feature](https://files.readme.io/e6cbb339991cfdda7f0e41f79cc9a188f3d5bafc33900554607eed2473ed0ad4-Screenshot_2024-10-17_at_4.24.14_PM.png)
Sending WhatsApp from Sandbox Home Screen
## 
Sending WhatsApp from Sandbox Home screen
[](https://help.webexconnect.io/docs/sending-and-receiving-whatsapp-messages-using-sandbox#sending-whatsapp-from-sandbox-home-screen)
...
* * *
[Making and Receiving Voice Calls using Sandbox](https://help.webexconnect.io/docs/making-and-receiving-voice-calls-using-sandbox)[Sandbox FAQs](https://help.webexconnect.io/docs/sandbox-faqs)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/sending-and-receiving-whatsapp-messages-using-sandbox)
  *     * [Sandbox Home UI](https://help.webexconnect.io/docs/sending-and-receiving-whatsapp-messages-using-sandbox#sandbox-home-ui)
    * [Sending WhatsApp from Sandbox Home screen](https://help.webexconnect.io/docs/sending-and-receiving-whatsapp-messages-using-sandbox#sending-whatsapp-from-sandbox-home-screen)
...
---
# ORIGEN: https://help.webexconnect.io/docs/sandbox-faqs

[Jump to Content](https://help.webexconnect.io/docs/sandbox-faqs#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Sandbox FAQs
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/sandbox-faqs)
## 
Which channels are supported in Webex Connect Sandbox?
[](https://help.webexconnect.io/docs/sandbox-faqs#which-channels-are-supported-in-webex-connect-sandbox)
...
[](https://help.webexconnect.io/docs/sandbox-faqs#whom-all-can-i-send-messages-to-and-receive-messages-from-in-sandbox-mode)
...
[](https://help.webexconnect.io/docs/sandbox-faqs#what-features-are-not-available-in-sandbox-mode)
...
[](https://help.webexconnect.io/docs/sandbox-faqs#i-dont-see-all-the-nodes-in-my-sandbox-flow-palette-are-there-some-limitations)
...
[](https://help.webexconnect.io/docs/sandbox-faqs#does--sandbox-provide-an-api-for-bulk-sms-sending)
...
[](https://help.webexconnect.io/docs/sandbox-faqs#how-many-sms-can-we-send-in-the-sandbox-environment)
...
[](https://help.webexconnect.io/docs/sandbox-faqs#which-all-countries-can-i-send-andor-receive-sms-and-voice-calls-from-using--sandbox)
Please refer to [a list of countries](https://developers.imiconnect.io/reference/sms-and-voice-support-in-sandbox) you can use Webex Connect Sandbox for sending or receiving test SMS messages and voice calls.
## 
What happens if I send a SMS via API to non-allowed list number?
[](https://help.webexconnect.io/docs/sandbox-faqs#what-happens-if-i-send-a-sms-via-api-to-non-allowed-list-number)
...
[](https://help.webexconnect.io/docs/sandbox-faqs#what-happens-if-i-reply-to-sms-from-a-non-allowed-list-number)
...
[](https://help.webexconnect.io/docs/sandbox-faqs#can-i-change-the-numbers-registered-with-my-sandbox-account)
...
[](https://help.webexconnect.io/docs/sandbox-faqs#how-do-i-change-the-voice-and-language-when-making-outbound-calls-using-text-to-speech)
...
[](https://help.webexconnect.io/docs/sandbox-faqs#why-am-i-not-able-to-create-the-new-whatsapp-asset-in-the-sandbox-account)
...
[](https://help.webexconnect.io/docs/sandbox-faqs#how-do-i-add-new-messaging-templates-for-whatsapp)
...
[](https://help.webexconnect.io/docs/sandbox-faqs#where-can-i-see-the-status-of-a-message-as-submitted-delivered-read-or-failed)
...
[](https://help.webexconnect.io/docs/sandbox-faqs#can-i-setup-chatbots-using--sandbox-account)
...
[](https://help.webexconnect.io/docs/sandbox-faqs#why-do-i-see-an-error-saying-we-are-unable-to-process-your-request-on-the-create-account-screen-after-submitting-otp)
...
Updated 11 months ago
* * *
[Sending and Receiving WhatsApp Messages using Sandbox](https://help.webexconnect.io/docs/sending-and-receiving-whatsapp-messages-using-sandbox)[Support for Sandbox Users](https://help.webexconnect.io/docs/support-for-sandbox-users)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/sandbox-faqs)
  *     * [Which channels are supported in Webex Connect Sandbox?](https://help.webexconnect.io/docs/sandbox-faqs#which-channels-are-supported-in-webex-connect-sandbox)
    * [Whom all can I send messages to and receive messages from in Sandbox mode?](https://help.webexconnect.io/docs/sandbox-faqs#whom-all-can-i-send-messages-to-and-receive-messages-from-in-sandbox-mode)
    * [What features are not available in Sandbox mode?](https://help.webexconnect.io/docs/sandbox-faqs#what-features-are-not-available-in-sandbox-mode)
    * [I don't see all the nodes in my Sandbox flow palette. Are there some limitations?](https://help.webexconnect.io/docs/sandbox-faqs#i-dont-see-all-the-nodes-in-my-sandbox-flow-palette-are-there-some-limitations)
    * [Does Webex Connect sandbox provide an API for bulk SMS sending?](https://help.webexconnect.io/docs/sandbox-faqs#does--sandbox-provide-an-api-for-bulk-sms-sending)
    * [How many SMS can we send in the sandbox environment?](https://help.webexconnect.io/docs/sandbox-faqs#how-many-sms-can-we-send-in-the-sandbox-environment)
    * [Which all countries can I send and/or receive SMS and Voice calls from using Webex Connect sandbox?](https://help.webexconnect.io/docs/sandbox-faqs#which-all-countries-can-i-send-andor-receive-sms-and-voice-calls-from-using--sandbox)
    * [What happens if I send a SMS via API to non-allowed list number?](https://help.webexconnect.io/docs/sandbox-faqs#what-happens-if-i-send-a-sms-via-api-to-non-allowed-list-number)
    * [What happens if I reply to SMS from a non-allowed list number?](https://help.webexconnect.io/docs/sandbox-faqs#what-happens-if-i-reply-to-sms-from-a-non-allowed-list-number)
    * [Can I change the numbers registered with my sandbox account?](https://help.webexconnect.io/docs/sandbox-faqs#can-i-change-the-numbers-registered-with-my-sandbox-account)
    * [How do I change the voice and language when making outbound calls using text to speech?](https://help.webexconnect.io/docs/sandbox-faqs#how-do-i-change-the-voice-and-language-when-making-outbound-calls-using-text-to-speech)
    * [Why am I not able to create the new WhatsApp asset in the sandbox account?](https://help.webexconnect.io/docs/sandbox-faqs#why-am-i-not-able-to-create-the-new-whatsapp-asset-in-the-sandbox-account)
    * [How do I add new messaging templates for WhatsApp?](https://help.webexconnect.io/docs/sandbox-faqs#how-do-i-add-new-messaging-templates-for-whatsapp)
    * [Where can I see the status of a message as submitted, delivered, read or failed?](https://help.webexconnect.io/docs/sandbox-faqs#where-can-i-see-the-status-of-a-message-as-submitted-delivered-read-or-failed)
    * [Can I setup chatbots using Webex Connect sandbox account?](https://help.webexconnect.io/docs/sandbox-faqs#can-i-setup-chatbots-using--sandbox-account)
    * [Why do I see an error saying "We are unable to process your request" on the create account screen after submitting OTP?](https://help.webexconnect.io/docs/sandbox-faqs#why-do-i-see-an-error-saying-we-are-unable-to-process-your-request-on-the-create-account-screen-after-submitting-otp)
...
---
# ORIGEN: https://help.webexconnect.io/docs/support-for-sandbox-users

[Jump to Content](https://help.webexconnect.io/docs/support-for-sandbox-users#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Support for Sandbox Users
Search
`CTRL-K`
All
Platform Documentation
...
The document provides information about the Webex Connect developer community, including resources for integrating with APIs, participating in forums, and accessing real-time status updates for the Webex Connect Developer Sandbox platform.
[Suggest Edits](https://help.webexconnect.io/edit/support-for-sandbox-users)
## 
Developer Community
[](https://help.webexconnect.io/docs/support-for-sandbox-users#developer-community)
Whether you're a developer who is integrating with Webex Connect APIs and webhooks, or a business user who is using Webex Connect Templates, Visual Flow Builder or Reporting features, engage and network with Webex Connect developer community by visiting Webex Connect [Developer forum](https://community.cisco.com/t5/imiconnect/bd-p/connect).
![Screenshot of the Developer Community portal homepage](https://files.readme.io/6799d48-Screenshot_2021-10-21_at_11.49.13_AM.png)
Screenshot of the Developer Community portal homepage
As an Webex Connect developer community member, you can raise questions, share your knowledge of Webex Connect with others users, sign-up for our upcoming events and webinars and do more.
## 
Webex Connect Sandbox Status
[](https://help.webexconnect.io/docs/support-for-sandbox-users#webex-connect-sandbox-status)
Visit [Webex Connect status page](https://status.webexcpaas.com/) for real-time status information on Webex Connect Developer Sandbox platform and messaging services.
## 
Key Resources
[](https://help.webexconnect.io/docs/support-for-sandbox-users#key-resources)
  * If you're a developer looking to integrate with Webex Connect messaging or voice APIs for embedding communication capabilities with your app, you can refer to **[Webex Connect Developer Sandbox Specific API Reference](https://developers.imiconnect.io/reference#sandbox-apis-overview)**.
  * Additionally, you can [download ](https://elements.getpostman.com/redirect?entityId=17978514-bfdbe72f-d536-47bb-b935-651033166c0c&entityType=collection)**Postman Collection** for Developer Sandbox Specific APIs.
  * If you're looking for information on Webex Connect visual flow builder, refer to the [Flows](https://help.imiconnect.io/docs/flows) section.


Updated 11 months ago
* * *
[Sandbox FAQs](https://help.webexconnect.io/docs/sandbox-faqs)[Accessing Webex AI Agent Studio in Sandbox](https://help.webexconnect.io/docs/webex-ai-agent-in-sandbox)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/support-for-sandbox-users)
  *     * [Developer Community](https://help.webexconnect.io/docs/support-for-sandbox-users#developer-community)
    * [Webex Connect Sandbox Status](https://help.webexconnect.io/docs/support-for-sandbox-users#webex-connect-sandbox-status)
    * [Key Resources](https://help.webexconnect.io/docs/support-for-sandbox-users#key-resources)
...
---
# ORIGEN: https://help.webexconnect.io/docs/webex-ai-agent-in-sandbox

[Jump to Content](https://help.webexconnect.io/docs/webex-ai-agent-in-sandbox#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Accessing Webex AI Agent Studio in Sandbox
Search
`CTRL-K`
All
Platform Documentation
...
Understand how to access Webex AI Agent in Sandbox
[Suggest Edits](https://help.webexconnect.io/edit/webex-ai-agent-in-sandbox)
Webex AI Agent Studio is an enterprise-grade AI Agent-building platform that allows enterprises to create, test, analyze and improve conversational user interfaces. The platform is powered by best-in-class NLP and NLU capabilities to power conversations and enhance customer interactions. The state-of-the-art AI Agents integrate seamlessly with the Webex Connect platform supporting a wide range of natural language interactions with varying conversational complexity.
To access the environment, you should have access to Webex Connect Sandbox.
Follow the steps to access Webex AI Agent Studio:
  1. Log in to Webex Connect sandbox with your username and password.

![Screenshot of the Sandbox home page](https://files.readme.io/9756f85-8.jpg)
Sandbox home page
  1. From the **App Tray** menu, click **Webex AI Agent** . 

![Screenshot showing navigation to Bot Builder via App Tray menu](https://files.readme.io/70750f4-9.jpg)
AccessingWebex AI Agent Studio from App Tray Menu
The Webex AI Agent Studio application appears in a new tab. For more information on the Webex AI Agent Studio , refer to [Webex Help - AI Agent Studio Documentation](https://help.webex.com/article/ncs9r37/Webex-AI-Agent-Studio-Administration-guide)
> ## 📘
> Note
> You can only create 5 AI Agents of each type in Sandbox. To increase this limit, contact Webex Connect Support.
Updated 7 months ago
* * *
[Support for Sandbox Users](https://help.webexconnect.io/docs/support-for-sandbox-users)[Creating a Service in Webex Connect](https://help.webexconnect.io/docs/create-a-new-service-on-webexconnect)
Did this page help you?
Yes
No
Platform
...
---
# ORIGEN: https://help.webexconnect.io/docs/create-a-new-service-on-webexconnect

[Jump to Content](https://help.webexconnect.io/docs/create-a-new-service-on-webexconnect#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Creating a Service in Webex Connect
Search
`CTRL-K`
All
Platform Documentation
...
A service is a named workspace that allows you to create and manage communication flows, APIs, integrations and configuration settings for a specific communication use case. Below are the steps to create a service.
[Suggest Edits](https://help.webexconnect.io/edit/create-a-new-service-on-webexconnect)
## 
Add New Service
[](https://help.webexconnect.io/docs/create-a-new-service-on-webexconnect#add-new-service)
  1. Once you login into Webex Connect, you will land on the Services Dashboard. Click on the **CREATE NEW SERVICE** button on the top right corner of the page to create a new service. 

![Screenshot of the Services Dashboard in Webex Connect with a highlighted 'CREATE NEW SERVICE' button located at the top right corner.](https://files.readme.io/6c2aea5-Create_a_Service.jpg)
Services Dashboard in Webex Connect showing where to click to create a new service.
  1. Assign a name to the service. Click on **CREATE** to finish creating the service.

![Screenshot showing the interface for assigning a name to the new service with the 'CREATE' button highlighted.](https://files.readme.io/1f13df5-Create_a_Service1.jpg)
Interface for naming and finalizing the creation of a new service by clicking 'CREATE'.
  1. This takes you to the **Service Dashboard** of the newly created service where you buy numbers, configure apps (i.e. OTT channels), send messages using the Messaging API or create customer interaction flows.


Here are a few tutorials that you can explore next:  
| Sno  | Tutorial  |  
| --- | --- |  
| 1  | [Buying a phone number](https://help.imiconnect.io/docs/buy-a-phone-number)  |  
| 2  | [Creating a flow on Webex Connect](https://help.imiconnect.io/docs/create-a-new-flow)  |  
| 3  | [How to use the Messaging API?](https://help.imiconnect.io/docs/using-the-multi-channel-messaging-api)  |  
Updated 7 months ago
* * *
[Accessing Webex AI Agent Studio in Sandbox](https://help.webexconnect.io/docs/webex-ai-agent-in-sandbox)[Exception handling at the node level](https://help.webexconnect.io/docs/exception-handling-at-the-node-level)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/create-a-new-service-on-webexconnect)
  *     * [Add New Service](https://help.webexconnect.io/docs/create-a-new-service-on-webexconnect#add-new-service)
...
---
# ORIGEN: https://help.webexconnect.io/docs/exception-handling-at-the-node-level

[Jump to Content](https://help.webexconnect.io/docs/exception-handling-at-the-node-level#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Exception handling at the node level
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/exception-handling-at-the-node-level)
...
[](https://help.webexconnect.io/docs/exception-handling-at-the-node-level#1-configure-onerror-event-for-a-node)
...
![Screenshot of the node configuration interface showing the 'onError' event setup.](https://files.readme.io/cf142a4-Error_Configs.png)
Configuration of the 'onError' event for a node
...
![Screenshot of the END FLOW - SETTINGS tab showing the Node event drop-down menu with 'onError' selected.](https://files.readme.io/72f92e3-Exception_Handling.jpg)
Selecting the 'onError' event from the Node event drop-down on the END FLOW - SETTINGS tab.
## 
2. Configure "onPolicyFail" event for a node
[](https://help.webexconnect.io/docs/exception-handling-at-the-node-level#2-configure-onpolicyfail-event-for-a-node)
...
![Screenshot of the END FLOW - SETTINGS tab showing the Node event drop-down menu with 'onPoilicyFail' selected.](https://files.readme.io/302870b-Exception_Handling1.jpg)
Selecting the 'onPolicyFail' event from the Node event drop-down on the END FLOW - SETTINGS tab.
## 
3. Configure "onTimeOut" event for a node
[](https://help.webexconnect.io/docs/exception-handling-at-the-node-level#3-configure-ontimeout-event-for-a-node)
...
![Screenshot of the node configuration interface showing the 'ontimeout' event setup.](https://files.readme.io/76a9529-onTimeOutConfigs.png)
Configuration of the 'onTimeout' event for a node.
...
![Screenshot of the END FLOW - SETTINGS tab showing the Node event drop-down menu with 'onTimeout' selected.](https://files.readme.io/df28c6d-Exception_Handling2.jpg)
Selecting the 'onTimeout' event from the Node event drop-down on the END FLOW - SETTINGS tab.
Updated 7 months ago
* * *
[Creating a Service in Webex Connect](https://help.webexconnect.io/docs/create-a-new-service-on-webexconnect)[Using Branch Node to build a flow with conditional branching](https://help.webexconnect.io/docs/branch-node-to-build-flow-with-conditional-branch)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/exception-handling-at-the-node-level)
  *     * [1. Configure "onError" event for a node](https://help.webexconnect.io/docs/exception-handling-at-the-node-level#1-configure-onerror-event-for-a-node)
    * [2. Configure "onPolicyFail" event for a node](https://help.webexconnect.io/docs/exception-handling-at-the-node-level#2-configure-onpolicyfail-event-for-a-node)
    * [3. Configure "onTimeOut" event for a node](https://help.webexconnect.io/docs/exception-handling-at-the-node-level#3-configure-ontimeout-event-for-a-node)
...
---
# ORIGEN: https://help.webexconnect.io/docs/branch-node-to-build-flow-with-conditional-branch

[Jump to Content](https://help.webexconnect.io/docs/branch-node-to-build-flow-with-conditional-branch#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Using Branch Node to build a flow with conditional branching
Search
`CTRL-K`
All
Platform Documentation
...
Branch node allows you to add alternative paths within a flow based on real-time conditional checks (e.g. if-then-else scenarios). Here's is how you can use the Brand Node.
[Suggest Edits](https://help.webexconnect.io/edit/branch-node-to-build-flow-with-conditional-branch)
...
[](https://help.webexconnect.io/docs/branch-node-to-build-flow-with-conditional-branch#step-1--add-the-branch-node)
Drag and drop the Branch node from the Nodes palette to the left on to the flow canvas.
## 
Step 2 – Configure the branch flow
[](https://help.webexconnect.io/docs/branch-node-to-build-flow-with-conditional-branch#step-2--configure-the-branch-flow)
...
![Screenshot of the branch node configuration in flow builder.](https://files.readme.io/ef075e9-Branch.jpg)
Setting up a branch node with conditions in a flow builder.
  1. Click **ADD BRANCH** to add a new branch and repeat the steps from 1-4 with a different match condition for the new branch.  
...
Updated 7 months ago
* * *
[Exception handling at the node level](https://help.webexconnect.io/docs/exception-handling-at-the-node-level)[Creating a Custom Variable on Webex Connect](https://help.webexconnect.io/docs/create-custom-variable-webexconnect)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/branch-node-to-build-flow-with-conditional-branch)
  *     * [Step 1 – Add the Branch Node](https://help.webexconnect.io/docs/branch-node-to-build-flow-with-conditional-branch#step-1--add-the-branch-node)
    * [Step 2 – Configure the branch flow](https://help.webexconnect.io/docs/branch-node-to-build-flow-with-conditional-branch#step-2--configure-the-branch-flow)
...
---
# ORIGEN: https://help.webexconnect.io/docs/create-custom-variable-webexconnect

[Jump to Content](https://help.webexconnect.io/docs/create-custom-variable-webexconnect#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Creating a Custom Variable on Webex Connect
Search
`CTRL-K`
All
Platform Documentation
...
Custom variables are user-defined variables that can be used to store required data during the flow execution.
[Suggest Edits](https://help.webexconnect.io/edit/create-custom-variable-webexconnect)
...
![Screenshot of the custom variable creation process.](https://files.readme.io/a7ee6f0-1.jpg)
Steps to create a custom variable.
## 
Creating a custom variable
[](https://help.webexconnect.io/docs/create-custom-variable-webexconnect#creating-a-custom-variable)
...
![Screenshot of the custom variable creation process.](https://files.readme.io/b6dc84d-Add_Custom_Variables.jpg)
Steps to create a custom variable.
  1. Enter the **Variable Name** and **Default Value (Optional)**.
  2. Optionally **externalize** the variable.
...
[](https://help.webexconnect.io/docs/create-custom-variable-webexconnect#externalizing-a-variable)
...
Updated 7 months ago
* * *
[Using Branch Node to build a flow with conditional branching](https://help.webexconnect.io/docs/branch-node-to-build-flow-with-conditional-branch)[Using Custom Node to configure your own integrations](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/create-custom-variable-webexconnect)
  *     * [Creating a custom variable](https://help.webexconnect.io/docs/create-custom-variable-webexconnect#creating-a-custom-variable)
    * [Externalizing a variable](https://help.webexconnect.io/docs/create-custom-variable-webexconnect#externalizing-a-variable)
...
---
# ORIGEN: https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations

[Jump to Content](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Using Custom Node to configure your own integrations
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/using-custom-node-to-configure-your-own-integrations)
## 
Step 1: Go to Integrations
[](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-1-go-to-integrations)
  1. Hover over **Assets** and click **Integrations** from the menu bar on the left to navigate to the Integrations screen.

![Screenshot showing navigation to the Integrations screen via Assets menu.](https://files.readme.io/5e030ed-20.jpg)
Navigate to the Integrations screen by selecting Integrations from the Assets menu.
## 
Step 2: Add a custom node
[](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-2-add-a-custom-node)
  1. Click **ADD INTEGRATION** button and select **CUSTOM NODE** from the drop-down.

![Screenshot of clicking the ADD INTEGRATION button and selecting CUSTOM NODE.](https://files.readme.io/cdf7c8e-21.jpg)
...
![Screenshot of the 'Create new custom node' pop-up window.](https://files.readme.io/f0027fc-Custom_Node1.jpg)
...
[](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-1-configure-the-watson-rest-api-under-the-settings-tab)
...
![Screenshot of the custom node request details screen.](https://files.readme.io/986f86e-1.jpg)
Configuration screen for setting up Request Details in custom node.
## 
Step 1.1: Configure the Authorization
[](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-11-configure-the-authorization)
...
![Screenshot of the Custom Node Authorization screen.](https://files.readme.io/c306014-2.jpg)
Configuration screen for setting up Authorization in custom node.
## 
Step 1.2: Configure the Headers
[](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-12-configure-the-headers)
...
![Screenshot of configuring headers in the custom node.](https://files.readme.io/b31da9b-3.jpg)
Configuration screen for setting up Headers in custom node.
## 
Step 1.3: Configure the Body
[](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-13-configure-the-body)
  1. Choose **JSON(application/json)** from the drop-down.
  2. Enter the code as shown below:

![Screenshot of configuring request body.](https://files.readme.io/3861bcc-4.jpg)
...
[](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-14--configure-the-response)
...
![Screenshot of configuring node events under the Response section.](https://files.readme.io/d761040-5.jpg)
...
![Screenshot of configuring the Response Path](https://files.readme.io/0d95c83-6.jpg)
Configure Response Path
## 
Step 2: Configure the NODE UI Tab
[](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-2-configure-the-node-ui-tab)
...
![Screenshot of Node UI ](https://files.readme.io/8a7fc34-7.jpg)
Node UI
...
Updated 7 months ago
* * *
[Creating a Custom Variable on Webex Connect](https://help.webexconnect.io/docs/create-custom-variable-webexconnect)[Setting up a Two-way Appointment Reminder in Webex Connect](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations)
  *     * [Step 1: Go to Integrations](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-1-go-to-integrations)
    * [Step 2: Add a custom node](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-2-add-a-custom-node)
    * [Step 1: Configure the Watson REST API under the SETTINGS tab](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-1-configure-the-watson-rest-api-under-the-settings-tab)
    * [Step 1.1: Configure the Authorization](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-11-configure-the-authorization)
    * [Step 1.2: Configure the Headers](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-12-configure-the-headers)
    * [Step 1.3: Configure the Body](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-13-configure-the-body)
    * [Step 1.4 : Configure the Response](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-14--configure-the-response)
    * [Step 2: Configure the NODE UI Tab](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations#step-2-configure-the-node-ui-tab)
...
---
# ORIGEN: https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect

[Jump to Content](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#content)
[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)v6.19.0 v6.20.0
* * *
[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)[API Reference](https://developers.imiconnect.io/reference/apioverview)[Push & In-App SDKs](https://developers.imiconnect.io/docs/overview-of-sdks)[SDK Release Notes](https://developers.imiconnect.io/docs/sdk-release-notes)[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)[![Platform Documentation](https://files.readme.io/7bdecfe-small-Webex_Connect.png)](https://help.webexconnect.io/)
...
[FAQs](https://developers.imiconnect.io/reference/apple-business-chat-faqs)[Website](https://imimobile.com/products/imiconnect)
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Setting up a Two-way Appointment Reminder in Webex Connect
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/setup-appointment-reminder-webexconnect)
## 
Step 1: Create a Service
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-1-create-a-service)
Create a new service to manage this use case.
[**Click here**](http://help.imiconnect.io/docs/create-a-service-on-imiconnect) for detailed steps on service creation
## 
Step 2: Get a Phone Number & assign it to the service
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-2-get-a-phone-number--assign-it-to-the-service)
For detailed steps on buying and assigning a number [**click here.**](http://help.imiconnect.io/docs/buy-a-phone-number)
## 
Step 3: Create a Flow to Send Appointment Reminder
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-3-create-a-flow-to-send-appointment-reminder)
### 
1. Create a New Flow
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#1-create-a-new-flow)
For detailed steps on creating a new flow [**click here**](http://help.imiconnect.io/docs/create-a-new-flow)
### 
2. Configure a Custom Event
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#2-configure-a-custom-event)
...
![Screenshot of the configuration screen for setting up a custom event.](https://files.readme.io/a9053d8-2.jpg)
Configuration screen for creating and setting up a custom event.
### 
3. Configure Send Node
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#3-configure-send-node)
...
> **MSISDN** stands for Mobile Station ISDN number, which refers to the mapping of the telephone number to the SIM card. In simple words, it's the mobile number
  1. Select the sender id from the drop-down under **FROM NUMBER**
  2. Type the message that you wish to send to your customers in the **MESSAGE** section and click on **SAVE** to save these settings.

![Screenshot of configuring the SMS Send Node.](https://files.readme.io/49c040d-Setting_Up_an_Appointment.jpg)
Configuration screen for setting up a SMS Send Node.
### 
4.Configure Exception handling details for the node
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#4configure-exception-handling-details-for-the-node)
  1. Set up 'onPolicyFail' exception.
  2. Set up 'onError' exception.


For detailed steps on configuring exception handling [**click here.**](https://help.imiconnect.io/docs/configuring-error-events-for-a-node)
## 
Step 4 : Configure Receive Node
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-4--configure-receive-node)
### 
1. Add the Receive Node
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#1-add-the-receive-node)
...
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#2-configure-the-receive-node-parameters)
...
![Screenshot of configuring parameters for the SMS Receive Node.](https://files.readme.io/4e6bfa8-Setting_Up_an_Appointment1.jpg)
Configuration screen for setting SMS Receive Node parameters.
### 
3. Configure Exception handling for the node
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#3-configure-exception-handling-for-the-node)
...
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-5-evaluate-customer-response)
...
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#1-add-the-branch-node)
Drag and drop the Branch node onto the flow canvas node palette to the left under **UTILITIES**.
### 
2. Configure the Branch Node
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#2-configure-the-branch-node)
...
![Screenshot of configuring the Branch Node.](https://files.readme.io/c426e77-Setting_Up_an_Appointment2.jpg)
Configuration screen for setting up a Branch Node.
...
### 
3. Configure Exception handling for the node
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#3-configure-exception-handling-for-the-node-1)
...
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-5-send-appointment-confirmation-message)
### 
1. Add the Send Node
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#1-add-the-send-node)
Drag and drop the Send SMS node onto the flow canvas node palette to the left under **UTILITIES**.
### 
2. Configure the Send Node
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#2-configure-the-send-node)
Double-click on the Send node to configure its parameters. You will arrive at the configuration window.
...
### 
3. Configure Exception handling for the node
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#3-configure-exception-handling-for-the-node-2)
  1. Set up 'onError' exception 
...
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-6-cancelling-the-appointment)
### 
1. Add the Send Node
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#1-add-the-send-node-1)
  1. Drag and drop the Send SMS node onto the flow canvas node palette.


### 
2. Configure the Send Node
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#2-configure-the-send-node-1)
...
### 
3. Configure Exception handling for the node
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#3-configure-exception-handling-for-the-node-3)
  1. Set up 'onError' exception 
...
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-7-handling-invalid-customer-responses)
### 
1. Add the Send Node for Invalid Response
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#1-add-the-send-node-for-invalid-response)
Drag and drop the Send node onto the flow canvas.
### 
2. Configure the Node
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#2-configure-the-node)
Follow the process mentioned in Step 2 of Confirming the Appointment.
### 
3. Configure Exception handling for the node
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#3-configure-exception-handling-for-the-node-4)
  1. Set up 'onError' exception 
...
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-8-publish-the-flow)
[**Click here**](http://help.imiconnect.io/v5.4/docs/publishing-the-flow) to know more about publishing a flow.
## 
Step 9: Configure the Event Scheduler
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-9--configure-the-event-scheduler)
...
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#1-create-an-event-in-the-event-scheduler)
...
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#2-configure-event-scheduler)
...
Screenshot of Creating a Schedule.
  1. Select the Send Trigger notification to the Email ID checkbox.
  2. Enter the Email ID to which the notifications have to be delivered. However, this is optional.
  3. Click **Next**.


### 
3. Configure Action
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#3-configure-action)
...
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#4-configure-target-data)
...
[](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#5-configure-schedule)
...
Updated 4 months ago
* * *
[Using Custom Node to configure your own integrations](https://help.webexconnect.io/docs/using-custom-node-to-configure-your-own-integrations)[Analyze customer sentiment using Webex Connect with IBM Watson](https://help.webexconnect.io/docs/analyze-customer-sentiment-with-imiconnect-ibm-watson)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect)
  *     * [Step 1: Create a Service](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-1-create-a-service)
    * [Step 2: Get a Phone Number & assign it to the service](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-2-get-a-phone-number--assign-it-to-the-service)
    * [Step 3: Create a Flow to Send Appointment Reminder](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-3-create-a-flow-to-send-appointment-reminder)
      * [1. Create a New Flow](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#1-create-a-new-flow)
      * [2. Configure a Custom Event](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#2-configure-a-custom-event)
      * [3. Configure Send Node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#3-configure-send-node)
      * [4.Configure Exception handling details for the node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#4configure-exception-handling-details-for-the-node)
    * [Step 4 : Configure Receive Node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-4--configure-receive-node)
      * [1. Add the Receive Node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#1-add-the-receive-node)
      * [2. Configure the Receive Node Parameters.](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#2-configure-the-receive-node-parameters)
      * [3. Configure Exception handling for the node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#3-configure-exception-handling-for-the-node)
    * [Step 5: Evaluate Customer Response](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-5-evaluate-customer-response)
      * [1. Add the Branch Node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#1-add-the-branch-node)
      * [2. Configure the Branch Node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#2-configure-the-branch-node)
      * [3. Configure Exception handling for the node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#3-configure-exception-handling-for-the-node-1)
    * [Step 5: Send Appointment Confirmation Message](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-5-send-appointment-confirmation-message)
      * [1. Add the Send Node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#1-add-the-send-node)
      * [2. Configure the Send Node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#2-configure-the-send-node)
      * [3. Configure Exception handling for the node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#3-configure-exception-handling-for-the-node-2)
    * [Step 6: Cancelling the Appointment](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-6-cancelling-the-appointment)
      * [1. Add the Send Node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#1-add-the-send-node-1)
      * [2. Configure the Send Node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#2-configure-the-send-node-1)
      * [3. Configure Exception handling for the node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#3-configure-exception-handling-for-the-node-3)
    * [Step 7: Handling Invalid Customer Responses](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-7-handling-invalid-customer-responses)
      * [1. Add the Send Node for Invalid Response](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#1-add-the-send-node-for-invalid-response)
      * [2. Configure the Node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#2-configure-the-node)
      * [3. Configure Exception handling for the node](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#3-configure-exception-handling-for-the-node-4)
    * [Step 8: Publish the Flow](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-8-publish-the-flow)
    * [Step 9: Configure the Event Scheduler](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#step-9--configure-the-event-scheduler)
      * [1. Create an Event in the Event Scheduler](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#1-create-an-event-in-the-event-scheduler)
      * [2. Configure Event Scheduler](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#2-configure-event-scheduler)
      * [3. Configure Action](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#3-configure-action)
      * [4. Configure Target Data](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#4-configure-target-data)
      * [5. Configure Schedule](https://help.webexconnect.io/docs/setup-appointment-reminder-webexconnect#5-configure-schedule)
