[Jump to Content](https://help.webexconnect.io/docs/node-palette#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Node Palette - WxEngage standalone
Search
`CTRL-K`
All
Platform Documentation
...
The document outlines various nodes available in WxEngage's Live Agent Integration, including functionalities for managing conversations, routing conversations, and utility nodes.
[Suggest Edits](https://help.webexconnect.io/edit/node-palette)
...
* * *
[Authorize Integration - WxEngage standalone](https://help.webexconnect.io/docs/authorize-integration)[Search conversation - WxEngage standalone](https://help.webexconnect.io/docs/search-conversation-1)
