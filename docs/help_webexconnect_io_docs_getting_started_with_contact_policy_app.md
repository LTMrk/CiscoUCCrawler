[Jump to Content](https://help.webexconnect.io/docs/getting-started-with-contact-policy-app#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Getting Started with Contact Policy
Search
`CTRL-K`
All
Platform Documentation
...
Understand the application's purpose and gain access.
[Suggest Edits](https://help.webexconnect.io/edit/getting-started-with-contact-policy-app)
## 
Overview
[](https://help.webexconnect.io/docs/getting-started-with-contact-policy-app#overview)
Contact Policy Management is a Webex Connect app available in the App Tray. When the app is enabled, using contact policy management provides customers a method for their users to opt in or out of receiving messages from them, as well as capping the number of messages received within a specified time.
This manual provides the information you need to set up and manage your consent groups.
## 
Access Contact Policy App
[](https://help.webexconnect.io/docs/getting-started-with-contact-policy-app#access-contact-policy-app)
To access the Contact Policy app, open Webex Connect and from the **App Tray** select **Contact Policy**.
![Image illustrating the steps to access Contact Policy App from the Webex Connect App Tray, highlighting the selection process within the interface.](https://files.readme.io/4069f83-ContactPolicyOption.png)
Screenshot showing how to access Contact Policy App from the Webex Connect App Tray.
The Consent Group page with the lists of all the consent groups appears.
![Image showing the list of groups in the Consent Group page.](https://files.readme.io/8c70bb3-Consent_Groups_Home_page.png)
...
## 
Permissions
[](https://help.webexconnect.io/docs/getting-started-with-contact-policy-app#permissions)
Your Webex Connect permissions determine what you can do in the Contact Policy app.
...
* * *
[Contact Policy](https://help.webexconnect.io/docs/contact-policy)[Consent Groups](https://help.webexconnect.io/docs/consent-groups)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/getting-started-with-contact-policy-app)
  *     * [Overview](https://help.webexconnect.io/docs/getting-started-with-contact-policy-app#overview)
    * [Access Contact Policy App](https://help.webexconnect.io/docs/getting-started-with-contact-policy-app#access-contact-policy-app)
    * [Permissions](https://help.webexconnect.io/docs/getting-started-with-contact-policy-app#permissions)
