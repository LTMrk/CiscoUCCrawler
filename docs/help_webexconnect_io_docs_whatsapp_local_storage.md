[Jump to Content](https://help.webexconnect.io/docs/whatsapp-local-storage#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Local Storage
Search
`CTRL-K`
All
Platform Documentation
...
# Local Storage
WhatsApp Cloud API’s Local Storage lets businesses store message data in specific countries for compliance, with controls for TTL and data location.
[Suggest Edits](https://help.webexconnect.io/edit/whatsapp-local-storage)
## 
WhatsApp Data Localization
[](https://help.webexconnect.io/docs/whatsapp-local-storage#whatsapp-data-localization)
...
### 
Localized Data
[](https://help.webexconnect.io/docs/whatsapp-local-storage#localized-data)
...
[](https://help.webexconnect.io/docs/whatsapp-local-storage#updating-local-storage)
...
[](https://help.webexconnect.io/docs/whatsapp-local-storage#updating-local-storage-for-new-asset)
...
[](https://help.webexconnect.io/docs/whatsapp-local-storage#updating-local-storage-of-an-existing-asset)
...
![Screenshot of the number is not verified.](https://files.readme.io/69e56d4eec115169566c170d012397464e7717393cf17a135aff8320c2307672-image.png)
...
* * *
[Migration from On-premise API to Cloud API (Deprecated)](https://help.webexconnect.io/docs/migration-from-on-prem-to-cloud-api)[Additional Information on WhatsApp Onboarding](https://help.webexconnect.io/docs/additional-information-regarding-embedded-signup)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/whatsapp-local-storage)
  *     * [WhatsApp Data Localization](https://help.webexconnect.io/docs/whatsapp-local-storage#whatsapp-data-localization)
      * [Localized Data](https://help.webexconnect.io/docs/whatsapp-local-storage#localized-data)
      * [Updating Local Storage](https://help.webexconnect.io/docs/whatsapp-local-storage#updating-local-storage)
