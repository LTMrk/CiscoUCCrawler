[Jump to Content](https://help.webexconnect.io/docs/setup-channel-assets#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Setup channel assets - WxEngage standalone
Search
`CTRL-K`
All
Platform Documentation
...
# Setup channel assets - WxEngage standalone
Understand how you can configure various channel assets on Webex Connect for enabling customer support over various digital messaging channels with Webex Engage.
[Suggest Edits](https://help.webexconnect.io/edit/setup-channel-assets)
...
| --- | --- | --- |  
| SMS  | Longcode  | [https://help.webexconnect.io/docs/phone-numbers](https://help.webexconnect.io/docs/phone-numbers)  |  
...
* * *
[Setup Org Hierarchy - WxEngage standalone](https://help.webexconnect.io/docs/setup-org-hierarchy)[SMS - WxEngage standalone](https://help.webexconnect.io/docs/sms)
