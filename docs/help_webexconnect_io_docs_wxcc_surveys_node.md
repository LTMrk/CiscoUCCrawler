...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Webex Surveys
Search
`CTRL-K`
All
Platform Documentation
...
# Webex Surveys
Understand your customers' needs by leveraging the Surveys node
[Suggest Edits](https://help.webexconnect.io/edit/wxcc-surveys-node)
Webex Connect offers the following node for Contact Center Surveys integration. The node authorization configuration details are available in the next section.
## 
Node and Methods
[](https://help.webexconnect.io/docs/wxcc-surveys-node#node-and-methods)  
| Node Name  | Description  | Recommended Node Version  |  
| --- | --- | --- |  
| [Surveys](https://help.imiconnect.io/docs/surveys-node)  | The Surveys node is a Webex CC-offered cloud application that helps you understand your customers' needs and improve your products or services to meet their expectations.  | v1.2 and v1.3 and v1.4 and v1.5  |  
Updated 6 months ago
* * *
[Business Hours - WXCC](https://help.webexconnect.io/docs/wxcc-engage-business-hours)[Surveys](https://help.webexconnect.io/docs/wxcc-surveys-node-)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/wxcc-surveys-node)
  *     * [Node and Methods](https://help.webexconnect.io/docs/wxcc-surveys-node#node-and-methods)
