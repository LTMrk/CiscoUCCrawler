[Jump to Content](https://help.webexconnect.io/docs/cce-event-authorization#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Event Authorization - CCE
Search
`CTRL-K`
All
Platform Documentation
...
Understand how Authorization works and how to activate it
[Suggest Edits](https://help.webexconnect.io/edit/cce-event-authorization)
## 
Prerequisites
[](https://help.webexconnect.io/docs/cce-event-authorization#prerequisites)
...
[](https://help.webexconnect.io/docs/cce-event-authorization#activating-authorizations-at-the-webex-connect-tenant)
  1. Login to Webex Connect tenant using your login credentials.
  2. Click **Assets** > **Integrations**.

![Screenshot showing the user interface with the highlighted path: Assets menu expanded to reveal the Integrations option.](https://files.readme.io/740b258-CCE_Services_Integration.PNG)
Navigating to the Integrations section under Assets.
The Integrations listing page is displayed.
![Screenshot of the Integrations listing page, displaying a list of available integrations.](https://files.readme.io/7c72071-CCE_Integrations_Page.PNG)
View of the Integrations listing page.
  1. Search for the pre-built integration that you have configured. The integration is displayed.
  2. In the **Actions** drop-down menu, click **Manage**.

![Screenshot showing the Actions drop-down menu opened with the Manage option highlighted, allowing users to manage selected integrations.](https://files.readme.io/0400eab-CCE_Integrations_Manage.PNG)
Accessing the Manage option from the Actions drop-down menu.
  1. In the **Manage Integration - Prebuilt Integration** page, click the **Activate** button.

![Screenshot of the Manage Integration - Prebuilt Integration page with the Activate button highlighted, enabling the activation of the selected integration.](https://files.readme.io/7e0de41-CC_Activate.PNG)
Activating a prebuilt integration from the Manage Integration page.
The activation success message is displayed, and the status is changed to **Activated**.
![Screenshot showing the activation success message displayed on the Manage Integration page, with the integration status updated to Activated.](https://files.readme.io/8e7805f-CCE_Authorization_successful.PNG)
...
Screenshot highlighting the section displaying the Client ID and Client Secret.
  1. Copy your **Client ID** and **Client Secret** and save it on your system for reference.
...
* * *
[Migrate an Existing WhatsApp Number to a Business Account - CCE](https://help.webexconnect.io/docs/cce-migrate-an-existing-whatsapp-number-to-a-business-account)[CCE Integration Nodes and Node Authorizations](https://help.webexconnect.io/docs/cce-integration-nodes-and-node-authorizations)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/cce-event-authorization)
  *     * [Prerequisites](https://help.webexconnect.io/docs/cce-event-authorization#prerequisites)
    * [Activating Authorizations at the Webex Connect Tenant](https://help.webexconnect.io/docs/cce-event-authorization#activating-authorizations-at-the-webex-connect-tenant)
