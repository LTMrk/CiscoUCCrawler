[Jump to Content](https://help.webexconnect.io/docs/cryptographic-hash-node-configuration#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Cryptographic Hash
Search
`CTRL-K`
All
Platform Documentation
...
# Cryptographic Hash
Understand what a Cryptographic Hash is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/cryptographic-hash-node-configuration)
...
![Screenshot of Cryptographic Hash Node.](https://files.readme.io/80e8484-Screenshot_2019-04-18_at_7.09.43_PM.png)
Cryptographic Hash Node
## 
Node Configuration
[](https://help.webexconnect.io/docs/cryptographic-hash-node-configuration#node-configuration)
...
| --- | --- | --- |  
| ### Hashing algorithmSelect a Hashing algorithm to generate hash. We support four hashing algorithms.  
...
Salt value: Data that must be added to string to be hashed is provided here.  | hash.output: Generated hash is stored in this variable  
  
hash.salt  | onSuccess: Hash generated successfully.  
  
onError: Hash generation failed because of invalid input.  |  
Updated 7 months ago
* * *
[Evaluate Node](https://help.webexconnect.io/docs/evaluate-node)[Delay Node](https://help.webexconnect.io/docs/delay-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/cryptographic-hash-node-configuration)
  *     * [Node Configuration](https://help.webexconnect.io/docs/cryptographic-hash-node-configuration#node-configuration)
