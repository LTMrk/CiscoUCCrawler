[Jump to Content](https://help.webexconnect.io/docs/delay-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Delay Node
Search
`CTRL-K`
All
Platform Documentation
...
# Delay Node
Understand what a Delay node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/delay-node)
...
![Screenshot of Delay Node](https://files.readme.io/3caf79f-delay_icon.png)
Delay Node
## 
Node Configuration
[](https://help.webexconnect.io/docs/delay-node#node-configuration)
Double-click the node to configure it. You can configure the delay node using either **Delay time** or **Wait for date** options.
![Screenshot of Delay Node Configuration Page](https://files.readme.io/1b18e18-Delay_Node_Configuration.png)
...
## 
Input Variables
[](https://help.webexconnect.io/docs/delay-node#input-variables)
...
![Screenshot of Input and Custom Variables](https://files.readme.io/4d444f6-delay_input_variables.png)
Input and Custom Variables
## 
Output Variables
[](https://help.webexconnect.io/docs/delay-node#output-variables)
You can see the data that this node generates as output variables. These [variables](https://help.webexconnect.io/docs/variable-management) are available for use in subsequent nodes. The following are the standard output variables for the delay node:
  * **delay.waitTime** - contains the time duration for which the flow waits.

![Screenshot of Output Variables](https://files.readme.io/60f889c-Delay_Node_Output_Variables.png)
Output Variables
## 
Node Outcomes
[](https://help.webexconnect.io/docs/delay-node#node-outcomes)
...
## 
Transition Actions
[](https://help.webexconnect.io/docs/delay-node#transition-actions)
...
![Screensht of Transition Actions.](https://files.readme.io/ec023ef-Delay_Nose_Transition_Actions.png)
Transition Actions
### 
Example
[](https://help.webexconnect.io/docs/delay-node#example)
...
* * *
[Cryptographic Hash](https://help.webexconnect.io/docs/cryptographic-hash-node-configuration)[Data Parser Node](https://help.webexconnect.io/docs/data-parser-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/delay-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/delay-node#node-configuration)
    * [Input Variables](https://help.webexconnect.io/docs/delay-node#input-variables)
    * [Output Variables](https://help.webexconnect.io/docs/delay-node#output-variables)
    * [Node Outcomes](https://help.webexconnect.io/docs/delay-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/delay-node#transition-actions)
      * [Example](https://help.webexconnect.io/docs/delay-node#example)
