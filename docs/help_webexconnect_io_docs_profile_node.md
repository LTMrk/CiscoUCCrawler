[Jump to Content](https://help.webexconnect.io/docs/profile-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Profile Node
Search
`CTRL-K`
All
Platform Documentation
...
# Profile Node
Understand what a Profile node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/profile-node)
...
![Screenshot of Profile Node.](https://files.readme.io/ee0f4a9-profile_node_icon.png)
Profile Node
## 
Node Configuration
[](https://help.webexconnect.io/docs/profile-node#node-configuration)
...
![Screenshot of Configuring a Profile Node ](https://files.readme.io/c2be3b3-Profile_Node.jpg)
Node Configuration
## 
Fetch a Profile
[](https://help.webexconnect.io/docs/profile-node#fetch-a-profile)
To fetch a profile:
...
msisdn  
name  |  
| Application Profile  | Messenger  | All  
FB_PSID  
birthday  
email  
first_name  
...
![Screenshot of Fetch a Profile.](https://files.readme.io/25d540f-Profile_Node_Fetch_Profile.png)
Fetch Profile
The specified customer profile is fetched. 
## 
Update a Profile
[](https://help.webexconnect.io/docs/profile-node#update-a-profile)
To update a profile:
...
![Screenshot of Update a Profile.](https://files.readme.io/7dcfd13-Profile_Node_Update_Profile.png)
Update Profile
...
## 
Create a Profile
[](https://help.webexconnect.io/docs/profile-node#create-a-profile)
To create a profile:
...
![Screenshot of Create Profile.](https://files.readme.io/8b01ca5-Profile_Node_Create_Profile.png)
Create Profile
  1. Enter the **Identifier Value** that uniquely identifies the customer.
  2. Under the **Profile Details** section, select the **Profile Attribute** and the **Variable** that contains the value of the selected attribute. The available profile attributes are: 
...
## 
Delete a Profile
[](https://help.webexconnect.io/docs/profile-node#delete-a-profile)
To delete a profile:
...
![Screenshot of Delete Profile.](https://files.readme.io/dbd444e-Profile_Node_Delete_Profile.png)
Delete Profile
  1. Click **Save**.
...
## 
Input Variables
[](https://help.webexconnect.io/docs/profile-node#input-variables)
You can see a list of all the flow variables available for this node under this pane. You can also search for a variable using the Search field. For more information, see the [Variable Management](https://help.webexconnect.io/docs/variable-management) section.
## 
Custom Variables
[](https://help.webexconnect.io/docs/profile-node#custom-variables)
You can see the list of variables that you explicitly create and configure for this node under the Custom Variables pane. For more information, see the [Variable Management](https://help.webexconnect.io/docs/variable-management) section.
## 
Output Variables
[](https://help.webexconnect.io/docs/profile-node#output-variables)
This node has no output variables.
## 
Node Outcomes
[](https://help.webexconnect.io/docs/profile-node#node-outcomes)
...
## 
Transition Actions
[](https://help.webexconnect.io/docs/profile-node#transition-actions)
...
* * *
[IVR Menu Node](https://help.webexconnect.io/docs/ivr-menu-node)[RCS Capability Node](https://help.webexconnect.io/docs/rcs-capability-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/profile-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/profile-node#node-configuration)
    * [Fetch a Profile](https://help.webexconnect.io/docs/profile-node#fetch-a-profile)
    * [Update a Profile](https://help.webexconnect.io/docs/profile-node#update-a-profile)
    * [Create a Profile](https://help.webexconnect.io/docs/profile-node#create-a-profile)
    * [Delete a Profile](https://help.webexconnect.io/docs/profile-node#delete-a-profile)
    * [Input Variables](https://help.webexconnect.io/docs/profile-node#input-variables)
    * [Custom Variables](https://help.webexconnect.io/docs/profile-node#custom-variables)
    * [Output Variables](https://help.webexconnect.io/docs/profile-node#output-variables)
    * [Node Outcomes](https://help.webexconnect.io/docs/profile-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/profile-node#transition-actions)
