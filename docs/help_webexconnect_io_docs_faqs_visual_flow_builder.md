[Jump to Content](https://help.webexconnect.io/docs/faqs-visual-flow-builder#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)FAQs
Search
`CTRL-K`
All
Platform Documentation
...
# FAQs
Common asked questions about Visual Flow Builder
[Suggest Edits](https://help.webexconnect.io/edit/faqs-visual-flow-builder)
## 
Is there an upper limit on the number of nodes within a flow?
[](https://help.webexconnect.io/docs/faqs-visual-flow-builder#is-there-an-upper-limit-on-the-number-of-nodes-within-a-flow)
...
[](https://help.webexconnect.io/docs/faqs-visual-flow-builder#can-i-export-and-import-flows-with-custom-integration-nodes-across-tenants)
...
* * *
[Flow Analytics](https://help.webexconnect.io/docs/flow-analytics)[Node Palette](https://help.webexconnect.io/docs/flow-nodes)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/faqs-visual-flow-builder)
  *     * [Is there an upper limit on the number of nodes within a flow?](https://help.webexconnect.io/docs/faqs-visual-flow-builder#is-there-an-upper-limit-on-the-number-of-nodes-within-a-flow)
    * [Can I export and import flows with Custom Integration Nodes across tenants?](https://help.webexconnect.io/docs/faqs-visual-flow-builder#can-i-export-and-import-flows-with-custom-integration-nodes-across-tenants)
