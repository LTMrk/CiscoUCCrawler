[Jump to Content](https://help.webexconnect.io/docs/api#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)API - WxEngage standalone
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/api)
## 
➡️ Inbound Messages
[](https://help.webexconnect.io/docs/api#%EF%B8%8F-inbound-messages)
texttext-with-attachmentsattachments
...
## 
⬅️ Outbound Messages
[](https://help.webexconnect.io/docs/api#%EF%B8%8F-outbound-messages)
texttext-with-attachmentsattachments
...
## 
↩️ Announcement
[](https://help.webexconnect.io/docs/api#%EF%B8%8F-announcement)
...
[](https://help.webexconnect.io/docs/api#markdown-cheat-sheet)  
| Formatting  | Synax  |  
| --- | --- |  
...
* * *
[Message Schema - Apple Messages for Business - WxEngage standalone](https://help.webexconnect.io/docs/apple-messages-for-business-3)[Authorize Integration - WxEngage standalone](https://help.webexconnect.io/docs/authorize-integration)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/api)
  *     * [➡️ Inbound Messages](https://help.webexconnect.io/docs/api#%EF%B8%8F-inbound-messages)
    * [⬅️ Outbound Messages](https://help.webexconnect.io/docs/api#%EF%B8%8F-outbound-messages)
    * [↩️ Announcement](https://help.webexconnect.io/docs/api#%EF%B8%8F-announcement)
    * [Markdown Cheat Sheet](https://help.webexconnect.io/docs/api#markdown-cheat-sheet)
