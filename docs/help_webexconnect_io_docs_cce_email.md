[Jump to Content](https://help.webexconnect.io/docs/cce-email#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Email - CCE
Search
`CTRL-K`
All
Platform Documentation
...
# Email - CCE
Learn about the procedure for asset configuration for the Email channel.
[Suggest Edits](https://help.webexconnect.io/edit/cce-email)
...
[](https://help.webexconnect.io/docs/cce-email#configuring-email-channel-asset-on-webex-connect)
...
Screenshot of Creating the New Email App Page
  ...
  3. Copy the forwarding email address and configure an email forwarding rule in your email client to forward emails sent to your support email id (i.e., same as the email id mentioned in step 6) to this email address.
...
[](https://help.webexconnect.io/docs/cce-email#authentication-using-username-and-password)
...
[](https://help.webexconnect.io/docs/cce-email#authentication-using-oauth-20)
...
[](https://help.webexconnect.io/docs/cce-email#registering--on-google-cloud)
...
## 
Adding Test Users
[](https://help.webexconnect.io/docs/cce-email#adding-test-users)
...
![Screenshot for Highlighting Publish App](https://files.readme.io/25efa9dcb1ce5062b3f4b9e16680d35943febb4072f83fb05cff7136795e6d93-0948c81-image001.png)
Highlighting Publish App
## 
Configure a rule in Gmail to forward incoming emails to Webex Connect
[](https://help.webexconnect.io/docs/cce-email#configure-a-rule-in-gmail-to-forward-incoming-emails-to-webex-connect)
...
[](https://help.webexconnect.io/docs/cce-email#registering-on-microsoft-365)
...
![Screenshot of API Permissions](https://files.readme.io/243323e-Wxcc8.png)
API Permissions
![Screenshot of Request API Permissions - Office 365](https://files.readme.io/727727d021d2d36760cb2797ae76c64cfe8acea3a76133f98d14732a78eea006-API_Permissions_1.png)
...
e. When you're finished, click **Save changes**.
  1. Once app is created ,you can find Tenant ID, Client ID and other details. Capture tenant id
...
Screenshot of Overview Page.
  1. Create Email asset in Webex Connect with above details.
...
[](https://help.webexconnect.io/docs/cce-email#to-enable-smtp-authentication-for-an-active-user)
...
[](https://help.webexconnect.io/docs/cce-email#configure-anti-spam-policies)
...
[](https://help.webexconnect.io/docs/cce-email#registering-your-webex-connect-email-app-asset-with-webex-engage)
...
Screenshot of Register To Webex Engage Page.
  1. Select the required service (Note: this should be the Webex Connect service that would be used for configuring Email flows for Webex Contact Center integration and click Register. 
...
* * *
[SMS - CCE](https://help.webexconnect.io/docs/cce-sms)[Live Chat - CCE](https://help.webexconnect.io/docs/cce-live-chat)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/cce-email)
  *     * [Configuring Email channel asset on Webex Connect](https://help.webexconnect.io/docs/cce-email#configuring-email-channel-asset-on-webex-connect)
    * [Authentication using Username and Password](https://help.webexconnect.io/docs/cce-email#authentication-using-username-and-password)
    * [Authentication using OAuth 2.0](https://help.webexconnect.io/docs/cce-email#authentication-using-oauth-20)
    * [Registering on Google Cloud](https://help.webexconnect.io/docs/cce-email#registering--on-google-cloud)
    * [Adding Test Users](https://help.webexconnect.io/docs/cce-email#adding-test-users)
    * [Configure a rule in Gmail to forward incoming emails to Webex Connect](https://help.webexconnect.io/docs/cce-email#configure-a-rule-in-gmail-to-forward-incoming-emails-to-webex-connect)
    * [Registering on Microsoft 365](https://help.webexconnect.io/docs/cce-email#registering-on-microsoft-365)
    * [To enable SMTP authentication for an Active User](https://help.webexconnect.io/docs/cce-email#to-enable-smtp-authentication-for-an-active-user)
    * [Configure Anti-spam policies](https://help.webexconnect.io/docs/cce-email#configure-anti-spam-policies)
    * [Registering your Webex Connect Email App Asset with Webex Engage](https://help.webexconnect.io/docs/cce-email#registering-your-webex-connect-email-app-asset-with-webex-engage)
