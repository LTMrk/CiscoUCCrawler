[Jump to Content](https://help.webexconnect.io/docs/azure-sso#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Azure SSO
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/azure-sso)
## 
Configure an Azure AD Identity Provider
[](https://help.webexconnect.io/docs/azure-sso#configure-an-azure-ad-identity-provider)
...
[](https://help.webexconnect.io/docs/azure-sso#configure-sso-on-azure)
...
![Image showing the interface to click the + New application button, highlighting its location for adding a new application.](https://files.readme.io/a16d912-3.jpg)
Screenshot instructing to click + New application
  1. Click **+ Create your own application**.

![Image displaying the interface with guidance on how to create your own application](https://files.readme.io/3969f48-4.jpg)
...
![Image showing the interface to enter the name for your app](https://files.readme.io/cac2555-5.jpg)
...
![Image showing the interface with instructions to select the Single Sign-on option](https://files.readme.io/2f89e20-6.jpg)
Screenshot displaying the option to select Single Sign-on
  1. On the left pane, click **Single sign-on** and then click **SAML**.

![Image showing the interface to select the SAML option](https://files.readme.io/87e7d3a-7.jpg)
Screenshot instructing to select the SAML option
  1. Click **Edit** in Basic SAML Configuration and enter/update the details.

![Image showing the interface with Basic SAML Configuration details](https://files.readme.io/1f27477-8.jpg)
...
[](https://help.webexconnect.io/docs/azure-sso#setting-up--saml-configuration)
  1. Log in to your Webex tenant and click **Single Sign-On Settings**.

![Image showing the interface for Single Sign-On Settings in Webex Connect.](https://files.readme.io/174e0e3-9.png)
...
[](https://help.webexconnect.io/docs/azure-sso#configuring-sso-on-webex-connect)
...
![Screenshot of Configuring the SSO in Webex Connect](https://files.readme.io/8215034-18.jpg)
...
[](https://help.webexconnect.io/docs/azure-sso#testing-the-sso-connection)
...
* * *
[Single Sign-On (SSO) Using SAML](https://help.webexconnect.io/docs/single-sign-on-settings)[Usage](https://help.webexconnect.io/docs/usage)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/azure-sso)
  *     * [Configure an Azure AD Identity Provider](https://help.webexconnect.io/docs/azure-sso#configure-an-azure-ad-identity-provider)
    * [Configure SSO on Azure](https://help.webexconnect.io/docs/azure-sso#configure-sso-on-azure)
    * [Setting up SAML Configuration](https://help.webexconnect.io/docs/azure-sso#setting-up--saml-configuration)
    * [Configuring SSO on Webex Connect](https://help.webexconnect.io/docs/azure-sso#configuring-sso-on-webex-connect)
    * [Testing the SSO Connection](https://help.webexconnect.io/docs/azure-sso#testing-the-sso-connection)
