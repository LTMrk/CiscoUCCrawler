[Jump to Content](https://help.webexconnect.io/docs/archive-search#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Archive Search
Search
`CTRL-K`
All
Platform Documentation
...
# Archive Search
Extend the search period in the Debug Console through your account manager.
[Suggest Edits](https://help.webexconnect.io/edit/archive-search)
Archive Search is an add-on that allows you to extend the search period in the Debug Console from 30 days (i.e. the default period) to either 60 days or 90 days. This add-on feature can be availed on request. Reach out to your account manager for more details.
This feature provides the ability for the users to debug in a single interface with multiple filters available to query the transaction logs.
![Image showing the interface for Archive Search](https://files.readme.io/1b844fd-Archive_Search.png)
Screenshot displaying the Archive Search feature
Updated over 1 year ago
* * *
[Debug Console](https://help.webexconnect.io/docs/console)[Profile Settings](https://help.webexconnect.io/docs/profile-settings)
