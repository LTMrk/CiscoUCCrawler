[Jump to Content](https://help.webexconnect.io/docs/nodes#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Nodes
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/nodes)
...
## 
List of Nodes
[](https://help.webexconnect.io/docs/nodes#list-of-nodes)
...
**Utilities**  
[Evaluate](https://help.webexconnect.io/docs/evaluate)  
[Branch](https://help.webexconnect.io/docs/branch)  
[HTTP request](https://help.webexconnect.io/docs/http-request)  
[Delay](https://help.webexconnect.io/docs/delay)  
[DataParser](https://help.webexconnect.io/docs/data-parser)  
[Data Transform](https://help.webexconnect.io/docs/data-transform)  
[Call Workflow](https://help.webexconnect.io/docs/call-workflow)  
[Page connector](https://help.webexconnect.io/docs/page-connector)  
[Profile](https://help.webexconnect.io/docs/profile-node)  
[Generate OTP](https://help.webexconnect.io/docs/generate-otp)  
[Validate OTP](https://help.webexconnect.io/docs/validate-otp)  
[SocialHour](https://help.webexconnect.io/docs/social-hour)  
[Cryptographic Hash](https://help.webexconnect.io/docs/cryptographic-hash-1)  
[Decryption](https://help.webexconnect.io/docs/decryption)  
[Encryption](https://help.webexconnect.io/docs/encryption)  
  
**Channels**  
[Send SMS](https://help.webexconnect.io/docs/send-sms)  
[Push](https://help.webexconnect.io/docs/push)  
[RCS Capability](https://help.webexconnect.io/docs/rcs-capability-node)  
[RCS Message](https://help.webexconnect.io/docs/rcs-message-node)  
[In-app messaging](https://help.webexconnect.io/docs/in-app-messaging)  
[Email](https://help.imiconnect.io/docs/email-node)  
[Messenger](https://help.webexconnect.io/docs/messenger)  
[Send Voice](https://help.webexconnect.io/docs/voice-1)  
...
[Receive](https://help.webexconnect.io/docs/receive)  
...
[Record Node](https://help.webexconnect.io/docs/record-node)  
[Collect Input Node](https://help.webexconnect.io/docs/collect-input-node)  
[IVR Menu Node](https://help.webexconnect.io/docs/voice-ivr-menu)  
[Call Patch Node](https://help.webexconnect.io/docs/call-patch-node)  
  
**Integrations**  
[Create Chat](https://help.webexconnect.io/docs/create-chat)  
[Validate Chat](https://help.webexconnect.io/docs/validate-chat)  
[Inbound Webhooks](https://help.webexconnect.io/docs/inbound-webhooks)  
[Outbound Webhooks](https://help.webexconnect.io/docs/outbound-webhooks)  
[Custom Events](https://help.webexconnect.io/docs/custom-events)  
[Generic Bot](https://help.webexconnect.io/docs/generic-bot)  
[Custom Node](https://help.webexconnect.io/docs/custom-nodes)  | The voice flow nodes will be deprecated in one of the upcoming releases. Use the Embedded Voice Nodes instead of these nodes.  
  
[Start](https://help.webexconnect.io/docs/voice-start) (To be depreceated soon)  
[Disconnect](https://help.webexconnect.io/docs/voice-disconnect) (To be depreceated soon)  
  
**Voice nodes**  
[Play](https://help.webexconnect.io/docs/voice-play) (To be depreceated soon)  
[Collect Input](https://help.webexconnect.io/docs/voice-collect-input) (To be depreceated soon)  
[Call URL](https://help.webexconnect.io/docs/voice-call-url) (To be depreceated soon)  
[Evaluate](https://help.webexconnect.io/docs/voice-evaluate) (To be depreceated soon)  
[Call Transfer](https://help.webexconnect.io/docs/voice-transfer) (To be depreceated soon)  
[Dial DTMF](https://help.webexconnect.io/docs/voice-dial-dtmf) (To be depreceated soon)  
[Send](https://help.webexconnect.io/docs/voice-send) (To be depreceated soon)  
[Record](https://help.webexconnect.io/docs/voice-record) (To be depreceated soon)  
[Call Project](https://help.webexconnect.io/docs/voice-call-project) (To be depreceated soon)  |  
### 
Adding a Node to Flow Canvas
[](https://help.webexconnect.io/docs/nodes#adding-a-node-to-flow-canvas)
Nodes are available in the [Node Palette](https://help.webexconnect.io/docs/flows#section-2-node-palette). Nodes are classified into different categories for easy identification based on their configurable properties. A few key points about nodes are that:
...
## 
Node Configuration
[](https://help.webexconnect.io/docs/nodes#node-configuration)
...
## 
Configuration Area
[](https://help.webexconnect.io/docs/nodes#configuration-area)
...
[](https://help.webexconnect.io/docs/nodes#contextual-information-sidebar)
...
## 
Connectors
[](https://help.webexconnect.io/docs/nodes#connectors)
...
### 
Drawing a Connector
[](https://help.webexconnect.io/docs/nodes#drawing-a-connector)
  ...
  2. Drop the connector onto an empty space in the canvas to terminate the flow when that particular outcome is encountered. This brings up the configuration for the End Node. While trying to connect an event to the target node, the target node is highlighted.  
...
![Screenshot of Connecting Nodes in a Flow.](https://files.readme.io/750702b-Connectors.jpg)
Connecting Nodes in a Flow
#### 
Restrictions
[](https://help.webexconnect.io/docs/nodes#restrictions)
...
[](https://help.webexconnect.io/docs/nodes#deleting-a-connector)
...
### 
Connector Colour
[](https://help.webexconnect.io/docs/nodes#connector-colour)
...
| --- | --- |  
| Green  | Indicates the flow continuation outcome of the node  
For example: OnMessageSent  |  
| Orange  | Indicates time-bound events of the node  
For example: OnTimeOut  |  
| Red  | Indicates the error events of the node  
For example: OnDeliveryFailure  |  
Updated 4 months ago
* * *
[Triggering a Flow](https://help.webexconnect.io/docs/trigger-flow)[Variable Management in Flows](https://help.webexconnect.io/docs/variable-management-in-flows)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/nodes)
  *     * [List of Nodes](https://help.webexconnect.io/docs/nodes#list-of-nodes)
      * [Adding a Node to Flow Canvas](https://help.webexconnect.io/docs/nodes#adding-a-node-to-flow-canvas)
    * [Node Configuration](https://help.webexconnect.io/docs/nodes#node-configuration)
    * [Configuration Area](https://help.webexconnect.io/docs/nodes#configuration-area)
    * [Contextual Information Sidebar](https://help.webexconnect.io/docs/nodes#contextual-information-sidebar)
    * [Connectors](https://help.webexconnect.io/docs/nodes#connectors)
      * [Drawing a Connector](https://help.webexconnect.io/docs/nodes#drawing-a-connector)
      * [Deleting a Connector](https://help.webexconnect.io/docs/nodes#deleting-a-connector)
      * [Connector Colour](https://help.webexconnect.io/docs/nodes#connector-colour)
