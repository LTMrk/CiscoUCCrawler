[Jump to Content](https://help.webexconnect.io/docs/fetch-teams-working-hours#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Fetch Team's working hours - WxEngage standalone
Search
`CTRL-K`
All
Platform Documentation
...
Understand how to configure a Fetch team working hours node.
[Suggest Edits](https://help.webexconnect.io/edit/fetch-teams-working-hours)
...
## 
Configuration
[](https://help.webexconnect.io/docs/fetch-teams-working-hours#configuration)
...
## 
Output variables
[](https://help.webexconnect.io/docs/fetch-teams-working-hours#output-variables)  
...
## 
Node outcomes
[](https://help.webexconnect.io/docs/fetch-teams-working-hours#node-outcomes)  
...
* * *
[Append message - WxEngage standalone](https://help.webexconnect.io/docs/append-message)[Update conversation - WxEngage standalone](https://help.webexconnect.io/docs/update-conversation-1)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/fetch-teams-working-hours)
  *     * [Configuration](https://help.webexconnect.io/docs/fetch-teams-working-hours#configuration)
    * [Output variables](https://help.webexconnect.io/docs/fetch-teams-working-hours#output-variables)
    * [Node outcomes](https://help.webexconnect.io/docs/fetch-teams-working-hours#node-outcomes)
