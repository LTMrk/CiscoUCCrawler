[Jump to Content](https://help.webexconnect.io/docs/media-manager#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Media Manager
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/media-manager)
...
[](https://help.webexconnect.io/docs/media-manager#supported-file-formats)  
...
## 
Using Media Manager
[](https://help.webexconnect.io/docs/media-manager#using-media-manager)
...
![Interface showing a list of image assets within the Media Manager](https://files.readme.io/e5d1c7e71326b26e1820bd8036f478dbb4cadb96ad49a7e4470ea88cd4b4013c-2024-12-11_21-25-04.png)
Screenshot displaying a list of image assets in Media Manager.
### 
Import URL
[](https://help.webexconnect.io/docs/media-manager#import-url)
Use the **Import URL** to add an image from a URL. Only files up to 10MB are allowed.
![Interface highlighting the Import URL option to upload an image directly from a specified URL](https://files.readme.io/4b21de5435085229145135dd2e7bba7f43478728a727b5764a2ebb7beb18ee45-2024-12-11_21-27-04.png)
Screenshot showing the use of Import URL to add an image from a URL
### 
Upload
[](https://help.webexconnect.io/docs/media-manager#upload)
...
![Interface displaying the option to upload an file. ](https://files.readme.io/df0acd34d3974ae40969a1a148dad7732fcd1db6349201c3d66bdfd4c4f43162-2024-12-11_21-25-05.png)
Screenshot showing the option to upload the file
**Steps to upload the file:**
  1. Upon uploading a file, the application identifies and displays the mime-type of the file uploaded. This enables you to edit the mime-type, if needed. 
  2. In the Upload File pop-up window, click **Edit** in the bottom-left to change the mime-type. or 
  3. Click **Replace File** to replace the previously uploaded file, if needed.
![Edit Mime Type](https://files.readme.io/c0f3b01b77f4cd6b7b19d77ace535a5370a562d52b18d96948932cc8251d5ba0-image.png)
Edit Mime Type


You will view the following screen if the system cannot recognize the mime-type.
![Mime-Type Not Recognised](https://files.readme.io/29d1adeb2907193816ea01746a937efe331290f460f4432c5a216d8996fc95fd-image.png)
Mime-type Not Recognised
  1. Click **Update**.


> ## 📘
> Note
> The mime-type will not be displayed for files that have already been uploaded.
### 
Copying the URL
[](https://help.webexconnect.io/docs/media-manager#copying-the-url)
...
![Interface highlighting the feature to copy the direct URL of media files uploaded in the Media Manager](https://files.readme.io/c40e813ea76219d858ea8315ed84b1fee773a3f3b3d5288bdd6a6b323d4ddbf3-2024-12-11_21-52-06.png)
Screenshot showing the option to copy the direct URL of media uploaded in the Media Manager
Updated 14 days ago
* * *
[Enable Logbooks for BI Reporting](https://help.webexconnect.io/docs/enable-logbooks-for-bi-reporting)[Debug Console](https://help.webexconnect.io/docs/console)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/media-manager)
  *     * [Supported File Formats](https://help.webexconnect.io/docs/media-manager#supported-file-formats)
    * [Using Media Manager](https://help.webexconnect.io/docs/media-manager#using-media-manager)
      * [Import URL](https://help.webexconnect.io/docs/media-manager#import-url)
      * [Upload](https://help.webexconnect.io/docs/media-manager#upload)
      * [Copying the URL](https://help.webexconnect.io/docs/media-manager#copying-the-url)
