[Jump to Content](https://help.webexconnect.io/docs/webex-campaign-integration-with-webex-connect#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Webex Campaign Integration with Webex Connect
Search
`CTRL-K`
All
Platform Documentation
...
Learn how to integrate Webex Campaign with Webex Connect.
[Suggest Edits](https://help.webexconnect.io/edit/webex-campaign-integration-with-webex-connect)
...
## 
Prerequisites
[](https://help.webexconnect.io/docs/webex-campaign-integration-with-webex-connect#prerequisites)
...
[](https://help.webexconnect.io/docs/webex-campaign-integration-with-webex-connect#viewing--tenant-information-in)
...
[](https://help.webexconnect.io/docs/webex-campaign-integration-with-webex-connect#integrating--in--flows)
  1. Login to the Webex Connect platform.
...
> This tab is displayed only when the Webex Campaign Data Stream is enabled for your tenant.
  1. In the **Choose Integration** drop-down menu, select **Webex Campaign**.
  2. In the **Parameter Name** as**campCorrelationId** , and its input for**Value as $(unique_id)**.  
...
### 
Making a Flow Live
[](https://help.webexconnect.io/docs/webex-campaign-integration-with-webex-connect#making-a-flow-live)
...
* * *
[Limitations - WxEngage standalone](https://help.webexconnect.io/docs/limitations)[Smart Links](https://help.webexconnect.io/docs/smart-links)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/webex-campaign-integration-with-webex-connect)
  *     * [Prerequisites](https://help.webexconnect.io/docs/webex-campaign-integration-with-webex-connect#prerequisites)
      * [Viewing Webex Campaign tenant information in Webex Connect](https://help.webexconnect.io/docs/webex-campaign-integration-with-webex-connect#viewing--tenant-information-in)
      * [Integrating Webex Campaign in Webex Connect Flows](https://help.webexconnect.io/docs/webex-campaign-integration-with-webex-connect#integrating--in--flows)
      * [Making a Flow Live](https://help.webexconnect.io/docs/webex-campaign-integration-with-webex-connect#making-a-flow-live)
