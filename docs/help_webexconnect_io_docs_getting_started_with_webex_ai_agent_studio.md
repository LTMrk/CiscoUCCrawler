[Jump to Content](https://help.webexconnect.io/docs/getting-started-with-webex-ai-agent-studio#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Getting Started with Webex AI Agent Studio
Search
`CTRL-K`
All
Platform Documentation
...
Understand the capabilities of Webex AI Agent Studio, its key business benefits, and how to get started.
[Suggest Edits](https://help.webexconnect.io/edit/getting-started-with-webex-ai-agent-studio)
...
[](https://help.webexconnect.io/docs/getting-started-with-webex-ai-agent-studio#capabilities-of)
...
[](https://help.webexconnect.io/docs/getting-started-with-webex-ai-agent-studio#key-benefits-for-businesses)
...
[](https://help.webexconnect.io/docs/getting-started-with-webex-ai-agent-studio#sign-in-from-control-hub)
...
[](https://help.webexconnect.io/docs/getting-started-with-webex-ai-agent-studio#sign-in-from-webex-connect)
...
* * *
[Mobile Wallet API](https://help.webexconnect.io/docs/mobile-wallet-api)[Configure Fulfillment Flows for AI Agent Actions](https://help.webexconnect.io/docs/configure-fulfilment-flows-for-ai-agent-actions)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/getting-started-with-webex-ai-agent-studio)
  *     * [Capabilities of Webex AI Agent Studio](https://help.webexconnect.io/docs/getting-started-with-webex-ai-agent-studio#capabilities-of)
    * [Key benefits for businesses](https://help.webexconnect.io/docs/getting-started-with-webex-ai-agent-studio#key-benefits-for-businesses)
    * [Sign-in from Control Hub](https://help.webexconnect.io/docs/getting-started-with-webex-ai-agent-studio#sign-in-from-control-hub)
    * [Sign-in from Webex Connect](https://help.webexconnect.io/docs/getting-started-with-webex-ai-agent-studio#sign-in-from-webex-connect)
