[Jump to Content](https://help.webexconnect.io/docs/single-sign-on-settings#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Single Sign-On (SSO) Using SAML
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/single-sign-on-settings)
...
## 
Prerequisites
[](https://help.webexconnect.io/docs/single-sign-on-settings#prerequisites)
...
## 
SSO Settings
[](https://help.webexconnect.io/docs/single-sign-on-settings#sso-settings)
...
> If you select both the options, you can choose how each user logs in individually.
  1. Select the **Default Authentication For New Users**. The available options are **SSO** and **Password**. The option you select here will be the default login mechanism for all the new users created from now on.
...
SSO Settings - Part 2
  1. Select the **SAML Version** that the identity provider uses.
  2. Provide the **Identity Provider Login URL**. This is the URL to which Webex Connect sends a SAML request to start the login sequence.
  3. Provide the Entity ID. This is the unique URL that identifies your SAML Identity Provider (IDP). This entity ID must be the same as the `<saml:issuer>` attribute in the SAML assertion. You will get this URL at both the IDP end as well as at the service provider end but you would need to use only one of these URLs and use the same URL at both places.
  4. Select a file for the **Identity Provider Certificate**.
  5. Select the **Request Signature Method**. This is the hashing algorithm for encrypted requests. The supported methods are _RSA-SHA1_ and _RSA-SHA256_.
  6. Assertion Decryption Certificate (Optional): If the identity provider encrypts SAML assertions, upload the decryption certificate here.
  7. Authentication Context Requirements: Provide the list of Allowed Authentication Context values (`SAML AuthnContextClassRef`) that Webex Connect will include in the authentication request to the Identity Provider (IdP). This setting is mandatory and is pre-populated by default for both existing and new tenants with:  
...
`urn:oasis:names:tc:SAML:2.0:ac:classes:Password`.
  8. Provide **Webex Connect Service Provider Details**. These details are required to configure the federated authentication, a single sign-on method that uses SAML assertions sent to an Webex Connect endpoint.
...
## 
Inviting New Users
[](https://help.webexconnect.io/docs/single-sign-on-settings#inviting-new-users)
...
## 
Password vs SSO
[](https://help.webexconnect.io/docs/single-sign-on-settings#password-vs-sso)
...
[](https://help.webexconnect.io/docs/single-sign-on-settings#testing-your-sso-configuration)
...
![Screenshot of Test Single Sign-On page](https://files.readme.io/49dcc8d6c964a568412f3e5b38b46fe2f1a03787308fc9b999b98e59d1062a6d-Single-Sign-On_2.png)
Test SSO
  1. Enter your **Test Email ID** (see below).  
...
![Screenshot of Test Single Sign-On page](https://files.readme.io/c5c12743ce07bd704b8638ed93dafbeed244b58103a8bd344648de7399f7eb2e-2025-03-28_11-27-20.jpg)
Test Single Sign-On
...
![Image showing an error message indicating that entered data does not match expected values due to an incorrect ID, with the message provided by the Identity Provider \(IDP\).](https://files.readme.io/c48d17c-errormsg.png)
Screenshot displaying error message for mismatched data due to wrong ID, as received from IDP.
## 
Remote Log-off for SSO
[](https://help.webexconnect.io/docs/single-sign-on-settings#remote-log-off-for-sso)
...
* * *
[Tenant Settings](https://help.webexconnect.io/docs/tenant-settings)[Azure SSO](https://help.webexconnect.io/docs/azure-sso)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/single-sign-on-settings)
  *     * [Prerequisites](https://help.webexconnect.io/docs/single-sign-on-settings#prerequisites)
    * [SSO Settings](https://help.webexconnect.io/docs/single-sign-on-settings#sso-settings)
    * [Inviting New Users](https://help.webexconnect.io/docs/single-sign-on-settings#inviting-new-users)
    * [Password vs SSO](https://help.webexconnect.io/docs/single-sign-on-settings#password-vs-sso)
    * [Testing your SSO configuration](https://help.webexconnect.io/docs/single-sign-on-settings#testing-your-sso-configuration)
    * [Remote Log-off for SSO](https://help.webexconnect.io/docs/single-sign-on-settings#remote-log-off-for-sso)
