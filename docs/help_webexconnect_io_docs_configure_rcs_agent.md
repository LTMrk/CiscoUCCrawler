[Jump to Content](https://help.webexconnect.io/docs/configure-rcs-agent#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Configure RCS Agent
Search
`CTRL-K`
All
Platform Documentation
...
# Configure RCS Agent
This guide outlines the steps to create and configure a new Rich Communication Services (RCS) agent to facilitate interactive messaging with your customers.
[Suggest Edits](https://help.webexconnect.io/edit/configure-rcs-agent)
# 
Prerequisites
[](https://help.webexconnect.io/docs/configure-rcs-agent#prerequisites)
...
# 
Configuration steps
[](https://help.webexconnect.io/docs/configure-rcs-agent#configuration-steps)
...
* * *
[RCS Onboarding Guidelines](https://help.webexconnect.io/docs/rcs-onboarding-guidelines)[WhatsApp](https://help.webexconnect.io/docs/whatsapp)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/configure-rcs-agent)
  *     * [Prerequisites](https://help.webexconnect.io/docs/configure-rcs-agent#prerequisites)
    * [Configuration steps](https://help.webexconnect.io/docs/configure-rcs-agent#configuration-steps)
