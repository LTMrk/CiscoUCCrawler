[Jump to Content](https://help.webexconnect.io/docs/phone-numbers#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Phone Number
Search
`CTRL-K`
All
Platform Documentation
...
# Phone Number
A phone number is a 10-digit number that is used to send/receive SMS and/or incoming/outgoing calls.
[Suggest Edits](https://help.webexconnect.io/edit/phone-numbers)
...
## 
Numbers List
[](https://help.webexconnect.io/docs/phone-numbers#numbers-list)
...
## 
Get a Number
[](https://help.webexconnect.io/docs/phone-numbers#get-a-number)
  1. Select **Numbers** from the **Assets** menu and choose the **Phone Number** option from the **Get Numbers** drop-down list box.

![Screenshot of Accessing a Phone Number from Numbers](https://files.readme.io/8362149-328e62e-Phone_Number_Get_Number.png)
Screenshot Displaying to Select the Phone Number.
  1. Select the **Country** , **Number Type** , and click **Find Numbers**.
...
## 
Search Numbers
[](https://help.webexconnect.io/docs/phone-numbers#search-numbers)
  1. Select Numbers from the Assets menu and choose the Phone Number option from the Get Numbers drop-down list box.

![Screenshot of Searching for a Phone Number](https://files.readme.io/c3bdd44-Get_Numbers2.png)
Screenshot of Search Numbers Page.
  1. Select the Country, Type, and Features, and click Find Numbers.  
If you selected United States or Canada as the Country, you can also search by Area Code or Location.
  2. Click Find Numbers.


## 
Number Availability
[](https://help.webexconnect.io/docs/phone-numbers#number-availability)
...
## 
Unavailability
[](https://help.webexconnect.io/docs/phone-numbers#unavailability)
In case you cannot find the country you are looking for, please reach out to the Support Team using the details mentioned in the ‘Contact Support’ section within your Webex Connect account.
## 
Order Numbers
[](https://help.webexconnect.io/docs/phone-numbers#order-numbers)
...
## 
Release Number
[](https://help.webexconnect.io/docs/phone-numbers#release-number)
...
[](https://help.webexconnect.io/docs/phone-numbers#modify-voice-capacity)
...
Screenshot of Numbers Page.
  1. On the Modify Voice Capacity pop-up, enter/update the values for the following for inbound and outbound calls: 
     * Concurrency Limit
     * CPS/TPS
     * Usage Cap
  2. Click Update.
...
[](https://help.webexconnect.io/docs/phone-numbers#10-digit-longcode-10dlc-numbers)
...
[](https://help.webexconnect.io/docs/phone-numbers#buy-numbers-for-the-united-states)
...
[](https://help.webexconnect.io/docs/phone-numbers#provisioning-the-numbers-for-mms-custom-bulk-porting-or-vanity-tfn-tollfree)
...
![Screenshot of Provisioning the Numbers for MMS, Custom, Bulk, Porting or Vanity TFN.](https://files.readme.io/0b50f39-10dlc_provisioning_form.png)
Provisioning the Numbers for MMS, Custom, Bulk, Porting or Vanity TFN
## 
Process for supporting number procurement requests
[](https://help.webexconnect.io/docs/phone-numbers#process-for-supporting-number-procurement-requests)
...
[](https://help.webexconnect.io/docs/phone-numbers#enabling-an-existing-number-for-sending-text-messages)
...
![Screenshot of Enabling an Existing Number for sending Text Messages.](https://files.readme.io/ae79388-10dlc_attach_loa.png)
Enabling an Existing Number for sending Text Messages.
## 
Send SMS from 10DLC and TFN numbers
[](https://help.webexconnect.io/docs/phone-numbers#send-sms-from-10dlc-and-tfn-numbers)
...
[](https://help.webexconnect.io/docs/phone-numbers#dlt-registered-numbers)
...
## 
Reserved Keywords
[](https://help.webexconnect.io/docs/phone-numbers#reserved-keywords)
...
## 
Delete Number
[](https://help.webexconnect.io/docs/phone-numbers#delete-number)
...
[](https://help.webexconnect.io/docs/phone-numbers#handle-incoming-calls-via-callback-url)
...
Updated 12 days ago
* * *
[Throughput Utilization](https://help.webexconnect.io/docs/throughput-utilization)[Short Code](https://help.webexconnect.io/docs/shortcodes)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/phone-numbers)
  *     * [Numbers List](https://help.webexconnect.io/docs/phone-numbers#numbers-list)
    * [Get a Number](https://help.webexconnect.io/docs/phone-numbers#get-a-number)
    * [Search Numbers](https://help.webexconnect.io/docs/phone-numbers#search-numbers)
    * [Number Availability](https://help.webexconnect.io/docs/phone-numbers#number-availability)
    * [Unavailability](https://help.webexconnect.io/docs/phone-numbers#unavailability)
    * [Order Numbers](https://help.webexconnect.io/docs/phone-numbers#order-numbers)
    * [Release Number](https://help.webexconnect.io/docs/phone-numbers#release-number)
    * [Modify Voice Capacity](https://help.webexconnect.io/docs/phone-numbers#modify-voice-capacity)
    * [10 Digit LongCode (10DLC) Numbers](https://help.webexconnect.io/docs/phone-numbers#10-digit-longcode-10dlc-numbers)
      * [Buy Numbers for the United States](https://help.webexconnect.io/docs/phone-numbers#buy-numbers-for-the-united-states)
    * [Provisioning the Numbers for MMS, Custom, Bulk, Porting or Vanity TFN (Tollfree)](https://help.webexconnect.io/docs/phone-numbers#provisioning-the-numbers-for-mms-custom-bulk-porting-or-vanity-tfn-tollfree)
    * [Process for supporting number procurement requests](https://help.webexconnect.io/docs/phone-numbers#process-for-supporting-number-procurement-requests)
    * [Enabling an Existing Number for sending Text Messages](https://help.webexconnect.io/docs/phone-numbers#enabling-an-existing-number-for-sending-text-messages)
    * [Send SMS from 10DLC and TFN numbers](https://help.webexconnect.io/docs/phone-numbers#send-sms-from-10dlc-and-tfn-numbers)
    * [DLT Registered Numbers](https://help.webexconnect.io/docs/phone-numbers#dlt-registered-numbers)
    * [Reserved Keywords](https://help.webexconnect.io/docs/phone-numbers#reserved-keywords)
    * [Delete Number](https://help.webexconnect.io/docs/phone-numbers#delete-number)
    * [Handle incoming calls via callback URL](https://help.webexconnect.io/docs/phone-numbers#handle-incoming-calls-via-callback-url)
