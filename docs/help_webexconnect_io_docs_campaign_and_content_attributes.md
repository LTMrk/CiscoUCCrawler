[Jump to Content](https://help.webexconnect.io/docs/campaign-and-content-attributes#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Campaign and Content Attributes
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/campaign-and-content-attributes)
...
[](https://help.webexconnect.io/docs/campaign-and-content-attributes#campaign-description)
...
## 
**Call-to-Action (CTA)**
[](https://help.webexconnect.io/docs/campaign-and-content-attributes#call-to-action-cta)
...
> Brand name & message types [brand name and the campaign category], how to opt in , Message frequency disclosure <recurring messages or one-time/transactional messages>, Message and data rates may apply. View Terms & Privacy here: (Customer URL link for Terms & Conditions link and Privacy Policy)
### 
Examples:
[](https://help.webexconnect.io/docs/campaign-and-content-attributes#examples)
...
[](https://help.webexconnect.io/docs/campaign-and-content-attributes#other-important-fields-specific-to-campaign-registration)
...
[](https://help.webexconnect.io/docs/campaign-and-content-attributes#other-important-message-categories-specific-to-customer-supportengagement)
### 
**HELP message**
[](https://help.webexconnect.io/docs/campaign-and-content-attributes#help-message)
...
#### 
Example:
[](https://help.webexconnect.io/docs/campaign-and-content-attributes#example)
[X Brand Program Name] Need help? Call us at (XXX) XXX-XXXX or email us at: support@brandname.com. Reply STOP to end.
### 
**STOP message**
[](https://help.webexconnect.io/docs/campaign-and-content-attributes#stop-message)
...
#### 
Example:
[](https://help.webexconnect.io/docs/campaign-and-content-attributes#example-1)
...
[](https://help.webexconnect.io/docs/campaign-and-content-attributes#sms-terms--conditions-url)
...
#### 
Example:
[](https://help.webexconnect.io/docs/campaign-and-content-attributes#example-2)
SMS Terms & Conditions:  
[X Brand] text notifications on [code], Message and Data Rates May Apply. Reply STOP to stop. Reply HELP for info or email us at support@xxxxx.com. View our Privacy Policy here [URL]
### 
**Privacy Policy**
[](https://help.webexconnect.io/docs/campaign-and-content-attributes#privacy-policy)
...
* * *
[Managing a Campaign](https://help.webexconnect.io/docs/manage-a-campaign)[Assigning a number to a Campaign ID](https://help.webexconnect.io/docs/assigning-a-number-to-a-campaign-id)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/campaign-and-content-attributes)
  *     * [**Campaign Description**](https://help.webexconnect.io/docs/campaign-and-content-attributes#campaign-description)
    * [**Call-to-Action (CTA)**](https://help.webexconnect.io/docs/campaign-and-content-attributes#call-to-action-cta)
      * [Examples:](https://help.webexconnect.io/docs/campaign-and-content-attributes#examples)
    * [Other important fields specific to Campaign Registration](https://help.webexconnect.io/docs/campaign-and-content-attributes#other-important-fields-specific-to-campaign-registration)
    * [Other important message categories specific to Customer support/engagement](https://help.webexconnect.io/docs/campaign-and-content-attributes#other-important-message-categories-specific-to-customer-supportengagement)
      * [**HELP message**](https://help.webexconnect.io/docs/campaign-and-content-attributes#help-message)
      * [**STOP message**](https://help.webexconnect.io/docs/campaign-and-content-attributes#stop-message)
      * [**SMS Terms & Conditions URL**](https://help.webexconnect.io/docs/campaign-and-content-attributes#sms-terms--conditions-url)
      * [**Privacy Policy**](https://help.webexconnect.io/docs/campaign-and-content-attributes#privacy-policy)
