[Jump to Content](https://help.webexconnect.io/docs/link-shortener#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Link Shortener
Search
`CTRL-K`
All
Platform Documentation
...
# Link Shortener
Overview of the Link Shortener Prebuilt Node in Flow Builder, including usage, setup steps, Early Access limitations, and reporting capabilities.
[Suggest Edits](https://help.webexconnect.io/edit/link-shortener)
## 
Introduction
[](https://help.webexconnect.io/docs/link-shortener#introduction)
...
![Screenshot for Link Shortener](https://files.readme.io/c29f29800f3f01b15f3d77b4f37cccef0a10ad426d55572776313b47bd4a7e88-image-20250515-121830.png)
Link Shortener
## 
Version Supported
[](https://help.webexconnect.io/docs/link-shortener#version-supported)
> ## 📘
> This integration is based on Link Shortener Node API is v1.0.0.
## 
Pre-requisites
[](https://help.webexconnect.io/docs/link-shortener#pre-requisites)
...
| AWS Sydney  | au.wbxc.io  |  
  3. [Generate client credentials](https://help.webexconnect.io/docs/link-shortener#generate-client-credentials) for your tenant. Enter up to 50 branded subdomains owned by the customer that they wish to use for Link Shortening via Webex Connect Messaging APIs and/or Flow Builder. 
...
[](https://help.webexconnect.io/docs/link-shortener#generate-client-credentials)
...
![Screenshot for Tenant Settings—Custom Domain Setup for Link Shortening](https://files.readme.io/c524c56a5f6dff1fcd70dd292945c8dd340728370c010b68bc39311e9464cb59-image-20250515-124112.png)
Tenant Settings—Custom Domain Setup for Link Shortening


## 
Add a Valid Authorization
[](https://help.webexconnect.io/docs/link-shortener#add-a-valid-authorization)
...
## 
Node Configuration
[](https://help.webexconnect.io/docs/link-shortener#node-configuration)
...
![Screenshot for Link Shortener](https://files.readme.io/f6b1f28b1d3c4bf02b282a0c2b3446fc3cf555aa95f204fa16fee8e9874551a6-image-20250526-181806.png)
Link Shortener


## 
Methods and Outcomes
[](https://help.webexconnect.io/docs/link-shortener#methods-and-outcomes)
Here’s a brief description of various methods and corresponding output variables and node outcomes associated with each of the methods.
### 
Method Name - Create Shortlink
[](https://help.webexconnect.io/docs/link-shortener#method-name---create-shortlink)
The following are the UI parameters that are required to call this method.
![Screenshot for Link Shortener](https://files.readme.io/fd031a30b8d492ddcb63c3b86bb0e43199c90f677c6060bb5aca534de0ee4149-image-20250526-181549.png)
Link Shortener  
...
Correlation ID  
•Enter your unique reference ID that will be passed back to you in click notification via notify URL.  | Shortlink  
...
Response Message  | onInvalidData  
•Invalid data  
...
## 
Limitation
[](https://help.webexconnect.io/docs/link-shortener#limitation)
...
* * *
[Zoho CRM](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm)[EPIC](https://help.webexconnect.io/docs/epic)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/link-shortener)
  *     * [Introduction](https://help.webexconnect.io/docs/link-shortener#introduction)
    * [Version Supported](https://help.webexconnect.io/docs/link-shortener#version-supported)
    * [Pre-requisites](https://help.webexconnect.io/docs/link-shortener#pre-requisites)
    * [Generate Client Credentials](https://help.webexconnect.io/docs/link-shortener#generate-client-credentials)
    * [Add a Valid Authorization](https://help.webexconnect.io/docs/link-shortener#add-a-valid-authorization)
    * [Node Configuration](https://help.webexconnect.io/docs/link-shortener#node-configuration)
    * [Methods and Outcomes](https://help.webexconnect.io/docs/link-shortener#methods-and-outcomes)
      * [Method Name - Create Shortlink](https://help.webexconnect.io/docs/link-shortener#method-name---create-shortlink)
    * [Limitation](https://help.webexconnect.io/docs/link-shortener#limitation)
