[Jump to Content](https://help.webexconnect.io/docs/play-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Play Node
Search
`CTRL-K`
All
Platform Documentation
...
# Play Node
Understand what a Play node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/play-node)
...
![Screenshot of Play Node](https://files.readme.io/3e1348d-play.png)
Play Node
> ## 📘
...
## 
Node Configuration
[](https://help.webexconnect.io/docs/play-node#node-configuration)
...
![Screenshot of Configuring a Play node - Pre-recorded](https://files.readme.io/2a98718-Play1.jpg)
Screenshot of Play Node Configuration Page.
...
![Screenshot of Uploading a file](https://files.readme.io/5405c6b-Play2.jpg)
Uploading a file
...
![Screenshot of Fetching a URL](https://files.readme.io/4eb38a5-Play3.jpg)
Fetching a URL
(iv) **Text To Speech**
...
>   * **Language** - the list of available languages. Select **Dynamic** if you want to pass the language at run-time. Ensure that the language code you pass at run-time is of the ISO 639 format. See the [supported languages](https://help.webexconnect.io/docs/supported-languages-for-voice) section for a complete list.
...
![Screenshot of Text To Speech](https://files.readme.io/127e49d-Play4.jpg)
Text To Speech
...
## 
Input Variables
[](https://help.webexconnect.io/docs/play-node#input-variables)
...
## 
Output Variables
[](https://help.webexconnect.io/docs/play-node#output-variables)
This node has no output variables.
## 
Node Outcomes
[](https://help.webexconnect.io/docs/play-node#node-outcomes)
...
## 
Transition Actions
[](https://help.webexconnect.io/docs/play-node#transition-actions)
...
* * *
[Collect Input Node](https://help.webexconnect.io/docs/collect-input-node)[Record Node](https://help.webexconnect.io/docs/record-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/play-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/play-node#node-configuration)
    * [Input Variables](https://help.webexconnect.io/docs/play-node#input-variables)
    * [Output Variables](https://help.webexconnect.io/docs/play-node#output-variables)
    * [Node Outcomes](https://help.webexconnect.io/docs/play-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/play-node#transition-actions)
