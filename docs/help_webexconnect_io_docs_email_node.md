[Jump to Content](https://help.webexconnect.io/docs/email-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Email Node
Search
`CTRL-K`
All
Platform Documentation
...
# Email Node
Understand what an Email node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/email-node)
...
![Screenshot of Email Node](https://files.readme.io/625b440-Email.jpg)
Email Node
## 
Node Configuration
[](https://help.webexconnect.io/docs/email-node#node-configuration)
![Screenshot of Configuring an Email](https://files.readme.io/a8bc12a-Email_Node.jpg)
Configuring an Email 
### 
Destination type
[](https://help.webexconnect.io/docs/email-node#destination-type)
...
### 
Destination ID
[](https://help.webexconnect.io/docs/email-node#destination-id)
...
### 
From Email
[](https://help.webexconnect.io/docs/email-node#from-email)
...
[](https://help.webexconnect.io/docs/email-node#unsubscribe-mail-to-address-optional)
...
[](https://help.webexconnect.io/docs/email-node#unsubscribe-email-subject-optional)
...
### 
Message Source
[](https://help.webexconnect.io/docs/email-node#message-source)
#### 
Email type
[](https://help.webexconnect.io/docs/email-node#email-type)
  1. Text
  2. Template 
  3. HTML
...
![Screenshot of Fallback Text for Email](https://files.readme.io/45631a6-Email_Node.jpg)
Fallback Text for Email
#### 
Subject
[](https://help.webexconnect.io/docs/email-node#subject)
Email subject line.
#### 
Template Type
[](https://help.webexconnect.io/docs/email-node#template-type)
...
#### 
HTML Content
[](https://help.webexconnect.io/docs/email-node#html-content)
If you select HTML as Email Type, the Message field changes to HTML Content. Enter the HTML email body.
#### 
Enable link tracking
[](https://help.webexconnect.io/docs/email-node#enable-link-tracking)
...
![Screenshot of Link Tracking](https://files.readme.io/d4208dc-email_html_1.png)
Link Tracking
#### 
Track Opens
[](https://help.webexconnect.io/docs/email-node#track-opens)
...
#### 
Correlation ID
[](https://help.webexconnect.io/docs/email-node#correlation-id)
...
#### 
Callback Data
[](https://help.webexconnect.io/docs/email-node#callback-data)
...
#### 
Notify Status
[](https://help.webexconnect.io/docs/email-node#notify-status)
> ## 🚧
...
#### 
Notify URL
[](https://help.webexconnect.io/docs/email-node#notify-url)
...
[](https://help.webexconnect.io/docs/email-node#smtp-headers-applicable-only-when-smtp-based-email-sending-option-is-enabled-for-your-tenant)
  ...
  * In-Reply-To when you want to send a reply to a previous message
  ...
  1. Enter the Value for the selected header parameter.
...
## 
Advance Options
[](https://help.webexconnect.io/docs/email-node#advance-options)
### 
Wait For
[](https://help.webexconnect.io/docs/email-node#wait-for)
...
### 
Expiry
[](https://help.webexconnect.io/docs/email-node#expiry)
...
[](https://help.webexconnect.io/docs/email-node#mime-types-for-sending-email-attachments)  
...
## 
Output Variables
[](https://help.webexconnect.io/docs/email-node#output-variables)
...
| send.response_interactive  
  
The interactive response data.  | Captures if the interactive button in the message is tapped.  |   |  
Updated 7 months ago
* * *
[SMS Node](https://help.webexconnect.io/docs/sms-node)[Push Node](https://help.webexconnect.io/docs/push)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/email-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/email-node#node-configuration)
      * [Destination type](https://help.webexconnect.io/docs/email-node#destination-type)
      * [Destination ID](https://help.webexconnect.io/docs/email-node#destination-id)
      * [From Email](https://help.webexconnect.io/docs/email-node#from-email)
      * [From Name](https://help.webexconnect.io/docs/email-node#from-name)
      * [ReplyTo Email](https://help.webexconnect.io/docs/email-node#replyto-email)
      * [CC Recipients (Optional)](https://help.webexconnect.io/docs/email-node#cc-recipients-optional)
      * [BCC Recipients (Optional)](https://help.webexconnect.io/docs/email-node#bcc-recipients-optional)
      * [List Unsubscribe URL (Optional)](https://help.webexconnect.io/docs/email-node#list-unsubscribe-url-optional)
      * [Unsubscribe Mail To Address (Optional)](https://help.webexconnect.io/docs/email-node#unsubscribe-mail-to-address-optional)
      * [Unsubscribe Email Subject (Optional)](https://help.webexconnect.io/docs/email-node#unsubscribe-email-subject-optional)
      * [Message Source](https://help.webexconnect.io/docs/email-node#message-source)
    * [SMTP Headers (Applicable only when SMTP based Email Sending option is enabled for your tenant)](https://help.webexconnect.io/docs/email-node#smtp-headers-applicable-only-when-smtp-based-email-sending-option-is-enabled-for-your-tenant)
    * [Advance Options](https://help.webexconnect.io/docs/email-node#advance-options)
      * [Wait For](https://help.webexconnect.io/docs/email-node#wait-for)
      * [Expiry](https://help.webexconnect.io/docs/email-node#expiry)
    * [MIME Types for Sending Email Attachments](https://help.webexconnect.io/docs/email-node#mime-types-for-sending-email-attachments)
    * [Output Variables](https://help.webexconnect.io/docs/email-node#output-variables)
