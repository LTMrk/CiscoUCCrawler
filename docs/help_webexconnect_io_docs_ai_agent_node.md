[Jump to Content](https://help.webexconnect.io/docs/ai-agent-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)AI Agent
Search
`CTRL-K`
All
Platform Documentation
...
# AI Agent
Understand how you can use AI Agent pre-built integration node.
[Suggest Edits](https://help.webexconnect.io/edit/ai-agent-node)
## 
Prerequisites
[](https://help.webexconnect.io/docs/ai-agent-node#prerequisites)
...
[](https://help.webexconnect.io/docs/ai-agent-node#methods-and-outcomes-in-the-ai-agent-node)
...
[](https://help.webexconnect.io/docs/ai-agent-node#configure-ai-agent-node-with-process-message-method)
### 
Process Message
[](https://help.webexconnect.io/docs/ai-agent-node#process-message)
...
### 
Output variables 
[](https://help.webexconnect.io/docs/ai-agent-node#output-variables)
...
[](https://help.webexconnect.io/docs/ai-agent-node#configure-ai-agent-node-with-close-session-method)
### 
Close Session
[](https://help.webexconnect.io/docs/ai-agent-node#close-session)
...
## 
Node Outcomes
[](https://help.webexconnect.io/docs/ai-agent-node#node-outcomes)
...
* * *
[Salesforce CRM](https://help.webexconnect.io/docs/salesforce-crm-get-insert-update-delete-contacts)[Google Dialogflow CX](https://help.webexconnect.io/docs/google-dialogflow-cx)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/ai-agent-node)
  *     * [Prerequisites](https://help.webexconnect.io/docs/ai-agent-node#prerequisites)
    * [Methods and Outcomes in the AI Agent node ](https://help.webexconnect.io/docs/ai-agent-node#methods-and-outcomes-in-the-ai-agent-node)
    * [Configure AI Agent node with Process Message method ](https://help.webexconnect.io/docs/ai-agent-node#configure-ai-agent-node-with-process-message-method)
      * [Process Message](https://help.webexconnect.io/docs/ai-agent-node#process-message)
      * [Output variables ](https://help.webexconnect.io/docs/ai-agent-node#output-variables)
    * [Configure AI Agent node with Close Session method ](https://help.webexconnect.io/docs/ai-agent-node#configure-ai-agent-node-with-close-session-method)
      * [Close Session](https://help.webexconnect.io/docs/ai-agent-node#close-session)
    * [Node Outcomes](https://help.webexconnect.io/docs/ai-agent-node#node-outcomes)
