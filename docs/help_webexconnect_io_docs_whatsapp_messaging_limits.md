[Jump to Content](https://help.webexconnect.io/docs/whatsapp-messaging-limits#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Messaging Limits
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/whatsapp-messaging-limits)
> ## ❗️
...
[](https://help.webexconnect.io/docs/whatsapp-messaging-limits#how-to-increase-the-messaging-limit)
...
You can increase your messaging limit to 2,000 by completing one of the [scaling paths](https://help.webexconnect.io/docs/whatsapp-messaging-limits#scaling-paths) below. After that, WhatsApp will automatically increase your limit to the next higher limit if you meet our [automatic scaling criteria](https://help.webexconnect.io/docs/whatsapp-messaging-limits#automatic-scaling).
### 
Scaling paths
[](https://help.webexconnect.io/docs/whatsapp-messaging-limits#scaling-paths)
...
### 
Approvals
[](https://help.webexconnect.io/docs/whatsapp-messaging-limits#approvals)
...
Additional messaging limit increases for your number can now happen automatically via [automatic scaling](https://help.webexconnect.io/docs/whatsapp-messaging-limits#automatic-scaling).
### 
Denials
[](https://help.webexconnect.io/docs/whatsapp-messaging-limits#denials)
...
### 
Automatic Scaling
[](https://help.webexconnect.io/docs/whatsapp-messaging-limits#automatic-scaling)
...
* * *
[WhatsApp Business Phone Number Quality Rating](https://help.webexconnect.io/docs/whatsapp-business-phone-numbers-quality-rating)[Migrate an Existing WhatsApp Number to a Business Account](https://help.webexconnect.io/docs/migrate-an-existing-whatsapp-number-to-a-whatsapp-business-account)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/whatsapp-messaging-limits)
  *     * [How to increase the Messaging limit](https://help.webexconnect.io/docs/whatsapp-messaging-limits#how-to-increase-the-messaging-limit)
      * [Scaling paths](https://help.webexconnect.io/docs/whatsapp-messaging-limits#scaling-paths)
      * [Approvals](https://help.webexconnect.io/docs/whatsapp-messaging-limits#approvals)
      * [Denials](https://help.webexconnect.io/docs/whatsapp-messaging-limits#denials)
      * [Automatic Scaling](https://help.webexconnect.io/docs/whatsapp-messaging-limits#automatic-scaling)
