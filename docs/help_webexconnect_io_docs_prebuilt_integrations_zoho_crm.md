[Jump to Content](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Zoho CRM
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/prebuilt-integrations-zoho-crm)
## 
Introduction
[](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#introduction)
...
## 
Version Supported
[](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#version-supported)
> ## 📘
> Webex Connect's integration is based on Zoho's API version 2.0.
## 
Pre-requisites
[](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#pre-requisites)
...
## 
Node Configuration
[](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#node-configuration)
...
![Screenshot of Insert Record method configuration page.](https://files.readme.io/759a5e2-Insert_Record.jpg)
Screenshot of Insert Record method configuration page.
  1. You can see the data that this node generates under the Output Variables section. These [variables](https://help.webexconnect.io/docs/variable-management) are available for use in subsequent nodes. 

![Screenshot of Insert Record method configuration page.](https://files.readme.io/5b4c3c7-a95fe9f-IMIconnect_Zoho_Integration_Node_Outcomes.png)
Screenshot of Insert Record method configuration page.
...
[](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#methods-and-outcomes)
Here’s a brief description of various methods, and corresponding output variables and node outcomes associated with each of the methods.
### 
Method Name - Insert Record
[](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---insert-record)  
...
**State**
  * This field specifies the state of the record whether _Active _or _Inactive_
...
**status**
  * Contains the status of the record whether _Success_or _Error_
...
[](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---get-a-specific-record)
![Screenshot of Get a Specific Record method configuration page.](https://files.readme.io/d300339-Get_A_Specific_Record.jpg)
...
[](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---update-a-specific-record)
![Screenshot of Update a Specific Record method configuration page](https://files.readme.io/4eac9c0-Update_Record.jpg)
...
*** Contains the time on which the record is created **details_modified_time**
  * Contains the time on which the record is modified
...
[](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---delete-a-specific-record)
![Screenshot of Delete a Specific Record method configuration page.](https://files.readme.io/ac085aa-Delete_record.jpg)
...
**Record ID** **Workflow Trigger**  
This field specifies if the workflow rules are to be triggered upon record deletion. The default value is **True**.  
Possible values - true: triggers associated workflows; false: does not trigger associated workflows.  |  **Code**
  * Contains only text whether "Success", "Invalid_Data", "Mandatory_Not_Found"
...
[](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---add-user)
![Screenshot of Add User method configuration page.](https://files.readme.io/017b4eb-image.png)
...
**Profile ID**  
Specify the unique ID of the profile you want to assign the user with, to decide the user's level of access to CRM data. **Last Name**
...
[](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---get-details-of-a-specific-user)
![Screenshot of Get Details of a Specific User method configuration page.](https://files.readme.io/f41a0f7-Get_Date_of_a_Specific_User.jpg)
...
|  **User ID**
 ...
 |  **role_name**  
Represents the name of the role of the user. **role_id**
...
[](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---update-user)
![Screenshot of Update User method configuration page.](https://files.readme.io/06b19aa-Update_User.jpg)
...
**State**
  * This field specifies the state of the user whether _Active _or _Inactive_
...
[](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---delete-user)
![Screenshot of Delete User method configuration page.](https://files.readme.io/6a07b3a-Delete_User.jpg)
...
* * *
[Freshdesk](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk)[Link Shortener](https://help.webexconnect.io/docs/link-shortener)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm)
  *     * [Introduction](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#introduction)
    * [Version Supported](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#version-supported)
    * [Pre-requisites](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#pre-requisites)
    * [Node Configuration](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#node-configuration)
    * [Methods and Outcomes](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#methods-and-outcomes)
      * [Method Name - Insert Record](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---insert-record)
      * [Method Name - Get a Specific Record](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---get-a-specific-record)
      * [Method Name - Update a Specific Record](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---update-a-specific-record)
      * [Method Name - Delete a Specific Record](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---delete-a-specific-record)
      * [Method Name - Add User](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---add-user)
      * [Method Name - Get Details of a Specific User](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---get-details-of-a-specific-user)
      * [Method Name - Update User](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---update-user)
      * [Method Name - Delete User](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm#method-name---delete-user)
