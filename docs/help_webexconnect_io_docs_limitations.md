[Jump to Content](https://help.webexconnect.io/docs/limitations#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Limitations - WxEngage standalone
Search
`CTRL-K`
All
Platform Documentation
...
# Limitations - WxEngage standalone
[Suggest Edits](https://help.webexconnect.io/edit/limitations)
...
* * *
[Data streams for Webex Engage](https://help.webexconnect.io/docs/data-streams-webex-engage)[Webex Campaign Integration with Webex Connect](https://help.webexconnect.io/docs/webex-campaign-integration-with-webex-connect)
