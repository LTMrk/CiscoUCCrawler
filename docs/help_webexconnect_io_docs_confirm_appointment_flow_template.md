[Jump to Content](https://help.webexconnect.io/docs/confirm-appointment-flow-template#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Confirm Appointment Flow Template
Search
`CTRL-K`
All
Platform Documentation
...
The Confirm Appointment flow automates the process the confirming attendance from patient on their existing appointment.
[Suggest Edits](https://help.webexconnect.io/edit/confirm-appointment-flow-template)
## 
Overview
[](https://help.webexconnect.io/docs/confirm-appointment-flow-template#overview)
...
## 
Pre-requisites
[](https://help.webexconnect.io/docs/confirm-appointment-flow-template#pre-requisites)
...
## 
User Roles
[](https://help.webexconnect.io/docs/confirm-appointment-flow-template#user-roles)
...
## 
Node Breakdown
[](https://help.webexconnect.io/docs/confirm-appointment-flow-template#node-breakdown)  
| Node Type  | Purpose  | Outcome  |  
| --- | --- | --- |  
| Configure AI Agent Event  | Initializes the flow with the specific identifiers needed to confirm the booking.  
...
• **EPICClientId:** Represents the unique identifier for your application, as registered in the Epic App. The variable value can be configured in the flow settings under custom variables.  | • On success, the flow proceeds to **Confirm Appointment**  
• On failure, the flow terminates.  |  
| Confirm Appointment  | Sends the patient final confirmation to the EPIC.  
...
| Evaluate (Retry Logic)  | Manages transient errors (like timeouts or invalid choices).  
...
[](https://help.webexconnect.io/docs/confirm-appointment-flow-template#input--output-variables)
### 
Input Variables (Configure AI Agent Event)
[](https://help.webexconnect.io/docs/confirm-appointment-flow-template#input-variables-configure-ai-agent-event)
...
### 
Output Variables
[](https://help.webexconnect.io/docs/confirm-appointment-flow-template#output-variables)
...
## 
Error Handling
[](https://help.webexconnect.io/docs/confirm-appointment-flow-template#error-handling)
...
## 
Script Analysis
[](https://help.webexconnect.io/docs/confirm-appointment-flow-template#script-analysis)
### 
Evaluate Script
[](https://help.webexconnect.io/docs/confirm-appointment-flow-template#evaluate-script)
...
Updated 20 days ago
* * *
[EPIC Reschedule Appointment Flow Template](https://help.webexconnect.io/docs/epic-reschedule-appointment-flow-template)[Get Future Appointments Flow Template](https://help.webexconnect.io/docs/get-future-appointments-flow-template)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/confirm-appointment-flow-template)
  *     * [Overview](https://help.webexconnect.io/docs/confirm-appointment-flow-template#overview)
    * [Pre-requisites](https://help.webexconnect.io/docs/confirm-appointment-flow-template#pre-requisites)
    * [User Roles](https://help.webexconnect.io/docs/confirm-appointment-flow-template#user-roles)
    * [Node Breakdown](https://help.webexconnect.io/docs/confirm-appointment-flow-template#node-breakdown)
    * [Input & Output Variables](https://help.webexconnect.io/docs/confirm-appointment-flow-template#input--output-variables)
      * [Input Variables (Configure AI Agent Event)](https://help.webexconnect.io/docs/confirm-appointment-flow-template#input-variables-configure-ai-agent-event)
      * [Output Variables](https://help.webexconnect.io/docs/confirm-appointment-flow-template#output-variables)
    * [Error Handling](https://help.webexconnect.io/docs/confirm-appointment-flow-template#error-handling)
    * [Script Analysis](https://help.webexconnect.io/docs/confirm-appointment-flow-template#script-analysis)
      * [Evaluate Script](https://help.webexconnect.io/docs/confirm-appointment-flow-template#evaluate-script)
