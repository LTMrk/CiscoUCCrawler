[Jump to Content](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Setting up Brand Indicators for Message Identification (BIMI)
Search
`CTRL-K`
All
Platform Documentation
...
Learn to set up the BIMI email specification for authenticated emails
[Suggest Edits](https://help.webexconnect.io/edit/setting-up-brand-indicators-for-message-identification-bimi)
...
## 
Prerequisites
[](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi#prerequisites)
...
[](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi#svg-file-of-your-logo)
...
[](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi#bimi-standard-requirements-for-svg-files)
...
The SVG file should not include: 
  ...
  * The x= or y= attributes in the  root element
...
[](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi#vmc-or-cmc-for-your-domain)
...
## 
DMARC Setup
[](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi#dmarc-setup)
...
[](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi#add-a-bimi-txt-record)
...
* * *
[Configuring Branded Mail in Apple Business Connect](https://help.webexconnect.io/docs/configuring-branded-mail-in-apple-business-connect)[Instagram (Deprecated)](https://help.webexconnect.io/docs/instagram)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi)
  *     * [Prerequisites](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi#prerequisites)
    * [SVG file of your logo](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi#svg-file-of-your-logo)
      * [BIMI standard requirements for SVG files](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi#bimi-standard-requirements-for-svg-files)
    * [VMC or CMC for your domain](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi#vmc-or-cmc-for-your-domain)
    * [DMARC Setup](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi#dmarc-setup)
    * [Add a BIMI TXT record](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi#add-a-bimi-txt-record)
