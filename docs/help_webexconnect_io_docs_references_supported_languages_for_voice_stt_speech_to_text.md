[Jump to Content](https://help.webexconnect.io/docs/references-supported-languages-for-voice-stt-speech-to-text#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Supported Languages for Voice STT (Speech-to-Text)
Search
`CTRL-K`
All
Platform Documentation
...
Supported languages for Voice STT (Speech-to-Text) channel on the Webex Connect platform.
[Suggest Edits](https://help.webexconnect.io/edit/references-supported-languages-for-voice-stt-speech-to-text)
...
* * *
[Supported Languages for Voice TTS (Text-to-Speech)](https://help.webexconnect.io/docs/references-supported-languages-for-voice)[Supported File Types for Channels](https://help.webexconnect.io/docs/references-supported-file-types-for-channels)
