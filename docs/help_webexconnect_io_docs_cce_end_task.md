[Jump to Content](https://help.webexconnect.io/docs/cce-end-task#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)End Task - CCE
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/cce-end-task)
...
## 
Authorization
[](https://help.webexconnect.io/docs/cce-end-task#authorization)
...
[](https://help.webexconnect.io/docs/cce-end-task#methods-and-outcomes)
...
Extension variables consist of Key, Type, and Value.  | CCE End Task -  
_location  
...
| --- | --- | --- |  
| Close Task  | None  |  _onInvalidData  
_ onError  
 _onInvalidChoice  
...
* * *
[Get Task Details - CCE](https://help.webexconnect.io/docs/cce-get-task-details)[Webex Engage Nodes and Node Authorizations - CCE](https://help.webexconnect.io/docs/cce-webex-engage-nodes-and-node-authorizations)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/cce-end-task)
  *     * [Authorization](https://help.webexconnect.io/docs/cce-end-task#authorization)
    * [Methods and Outcomes](https://help.webexconnect.io/docs/cce-end-task#methods-and-outcomes)
