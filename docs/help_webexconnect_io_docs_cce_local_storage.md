[Jump to Content](https://help.webexconnect.io/docs/cce-local-storage#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Local Storage - CCE
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/cce-local-storage)
## 
WhatsApp Data Localization
[](https://help.webexconnect.io/docs/cce-local-storage#whatsapp-data-localization)
...
### 
Localized Data
[](https://help.webexconnect.io/docs/cce-local-storage#localized-data)
...
[](https://help.webexconnect.io/docs/cce-local-storage#updating-local-storage)
...
[](https://help.webexconnect.io/docs/cce-local-storage#updating-local-storage-for-new-asset)
...
[](https://help.webexconnect.io/docs/cce-local-storage#updating-local-storage-of-an-existing-asset)
...
## [](https://help.webexconnect.io/docs/cce-local-storage#section-)
Updated 4 months ago
* * *
[WhatsApp Usernames and Business-Scoped User IDs (BSUID) - CCE](https://help.webexconnect.io/docs/whatsapp-usernames-and-business-scoped-user-ids-bsuid-cce)[Additional Information on WhatsApp Onboarding - CCE](https://help.webexconnect.io/docs/cce-additional-information-on-whatsapp-onboarding)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/cce-local-storage)
  *     * [WhatsApp Data Localization](https://help.webexconnect.io/docs/cce-local-storage#whatsapp-data-localization)
      * [Localized Data](https://help.webexconnect.io/docs/cce-local-storage#localized-data)
      * [Updating Local Storage](https://help.webexconnect.io/docs/cce-local-storage#updating-local-storage)
