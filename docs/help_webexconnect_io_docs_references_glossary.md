[Jump to Content](https://help.webexconnect.io/docs/references-glossary#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Glossary
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/references-glossary)  
| Term  | Definition  |  
| --- | --- |  
| Asset  | Assets in Webex Connect refer to one or more of:  
...
| Fallback mechanism  | A set of rules that attempt to carry out a request in sequence.  
...
* * *
[Data Storage](https://help.webexconnect.io/docs/data-hosting)[Character Sets Supported for Messaging](https://help.webexconnect.io/docs/references-character-sets-supported-for-messaging)
