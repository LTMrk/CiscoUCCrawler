[Jump to Content](https://help.webexconnect.io/docs/wxcc-engage-add-participant#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Add Participant - WXCC
Search
`CTRL-K`
All
Platform Documentation
...
Understand how to add an agent while configuring an Add Participant node in Cisco Webex Contact Center
[Suggest Edits](https://help.webexconnect.io/edit/wxcc-engage-add-participant)
...
## 
Authorization
[](https://help.webexconnect.io/docs/wxcc-engage-add-participant#authorization)
...
[](https://help.webexconnect.io/docs/wxcc-engage-add-participant#methods-and-outcomes)
...
| --- | --- | --- |  
| Add Participant  | TransId  |  _onInvalidData  
_ onError  
 _onInvalidChoice  
...
_ AgentId from the output variables of the start node is the participant  | TransId  | v1.0  |  
> ## 📘
> Note
...
* * *
[Update Conversation - WXCC](https://help.webexconnect.io/docs/wxcc-engage-update-conversation)[Remove Participant - WXCC](https://help.webexconnect.io/docs/wxcc-engage-remove-participant)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/wxcc-engage-add-participant)
  *     * [Authorization](https://help.webexconnect.io/docs/wxcc-engage-add-participant#authorization)
    * [Methods and Outcomes](https://help.webexconnect.io/docs/wxcc-engage-add-participant#methods-and-outcomes)
