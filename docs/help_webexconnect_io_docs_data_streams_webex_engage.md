[Jump to Content](https://help.webexconnect.io/docs/data-streams-webex-engage#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Data streams for Webex Engage
Search
`CTRL-K`
All
Platform Documentation
...
Learn how to enable Data Streams for Webex Engage.
[Suggest Edits](https://help.webexconnect.io/edit/data-streams-webex-engage)
> ## 📘
> Note:
...
[](https://help.webexconnect.io/docs/data-streams-webex-engage#enabling-data-streams-for-apple-business-for-messages-amb-assets)
...
![Interface showing options to enable Data Streams for Apple Business for Messages \(AMB\) assets](https://files.readme.io/9218240bddaa01dfe7ec214c43952a5f2807b0b02cce84f8eb0cfc0a05b8a5bc-image.png)
Screenshot displaying the enabling of Data Streams for Apple Business for Messages (AMB) assets.
  1. Uncheck all channels except the AMB channel from the Channels drop-down list, as we only support that one.
  2. Click **Save**.
...
[](https://help.webexconnect.io/docs/data-streams-webex-engage#enabling-data-streams-for-select-assets)
...
This integration is enabled by default for all channels on the Webex Engage Streaming screen.
  1. Change the setting to **Choose to enable at an asset level**.
  2. Click **Save**.
  3. Navigate to **Assets** > **Apps**.
...
Screenshot displaying the enabling of Data Streams for Apple Business for Messages (AMB) assets
  1. Find your Apple Messages Asset that you would like to turn ON the data streams and Choose **Manage** from the Actions drop-down list.
  2. Tun ON the Data Stream toggle.
  3. Choose **Webex Engage Streaming** from the Integration drop-down list.
  4. Click **Save**.


Updated 12 months ago
* * *
[Reopen conversation - WxEngage standalone](https://help.webexconnect.io/docs/reopen-conversation)[Limitations - WxEngage standalone](https://help.webexconnect.io/docs/limitations)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/data-streams-webex-engage)
  *     * [Enabling Data Streams for Apple Business for Messages (AMB) assets](https://help.webexconnect.io/docs/data-streams-webex-engage#enabling-data-streams-for-apple-business-for-messages-amb-assets)
    * [Enabling Data Streams for select assets](https://help.webexconnect.io/docs/data-streams-webex-engage#enabling-data-streams-for-select-assets)
