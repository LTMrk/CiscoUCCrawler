[Skip to content](https://apphub.webex.com/applications/baeareigf6pkks7jb43qzucxmbvmja4uimwbf4qyzqzrtt6elqzqd2lk52y#main-content) [Skip to footer](https://apphub.webex.com/applications/baeareigf6pkks7jb43qzucxmbvmja4uimwbf4qyzqzrtt6elqzqd2lk52y#main-footer)
...
Back
* * *
![Postman logo](https://developer-applications.webexcontent.com/agenticServers/icons/dee5eda2ab7347e19b8698d0d7466bc1.png)
#### Postman
Federated through Agntcy Developed by postman; Imported from External Registry
Turn your Postman collections into AI-powered tools—execute API requests, search documentation, and test endpoints directly from your AI assistant.
[ Learn more ](https://developer.webex.com/mcp/docs/federated-through-external-registry-mcp-servers#postman)
![Postman logo](https://developer-applications.webexcontent.com/agenticServers/icons/dee5eda2ab7347e19b8698d0d7466bc1.png)
#### Postman
Federated through Agntcy Developed by postman; Imported from External Registry
Agentic App by [postman](https://www.postman.com/)
* * *
Turn your Postman collections into AI-powered tools—execute API requests, search documentation, and test endpoints directly from your AI assistant.
[ Learn more ](https://developer.webex.com/mcp/docs/federated-through-external-registry-mcp-servers#postman)
Agentic App by [postman](https://www.postman.com/)
The Postman MCP Server is a comprehensive API platform designed for developers, network engineers, and IT teams to efficiently build, test, and manage APIs within Cisco environments. It offers a powerful REST client for sending requests, inspecting responses, and debugging APIs throughout the API lifecycle, while supporting team collaboration through shared API collections and documentation to standardize workflows and accelerate development. Available as both a web client and desktop application, it provides flexibility for various development and testing needs. To get started, you can simply[sign up for free](https://identity.getpostman.com/signup?continue=https%3A%2F%2Fgo.postman.co%2Fbuild&authFlowId=7cc0bad2-7c4f-407c-a3c2-f71ba267f79d) or contact our [sales](https://www.postman.com/company/contact-sales/). Usage requires a Webex license and a Postman account. Postman offers free trials and multiple pricing plans detailed at <https://www.postman.com/pricing/>.
##### Support
* * *
  * ![Developer Support](https://apphub.webex.com/images/developer-support.png)[Developer Support](https://support.postman.com/hc/en-us)
  * ![Privacy Policy](https://apphub.webex.com/images/privacy.png)[Privacy Policy](https://privacy.postman.com/policies/)
