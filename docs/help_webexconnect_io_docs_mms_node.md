[Jump to Content](https://help.webexconnect.io/docs/mms-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)MMS Node
Search
`CTRL-K`
All
Platform Documentation
...
# MMS Node
Understand what a MMS node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/mms-node)
...
![Screenshot of MMS Node](https://files.readme.io/85b6204-image.png)
MMS Node
## 
Node Configuration
[](https://help.webexconnect.io/docs/mms-node#node-configuration)
Drag and drop the MMS node on the flow canvas. Double-click the node to configure it.
![Screenshot of MMS Node Configuration Page](https://files.readme.io/70ab795-1.png)
MMS Node
## 
Node Configuration - Common fields for all message types
[](https://help.webexconnect.io/docs/mms-node#node-configuration---common-fields-for-all-message-types)
...
## 
Notify URL
[](https://help.webexconnect.io/docs/mms-node#notify-url)
...
* * *
[Messenger Node](https://help.webexconnect.io/docs/messenger)[WhatsApp Node](https://help.webexconnect.io/docs/whatsapp-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/mms-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/mms-node#node-configuration)
    * [Node Configuration - Common fields for all message types](https://help.webexconnect.io/docs/mms-node#node-configuration---common-fields-for-all-message-types)
    * [Notify URL](https://help.webexconnect.io/docs/mms-node#notify-url)
