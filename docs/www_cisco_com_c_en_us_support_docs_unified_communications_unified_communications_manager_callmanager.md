  * [Skip to content](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html#eot-doc-wrapper)
  * [Skip to search](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)
  * [Skip to footer](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)
  ...
  * [](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)
  * [...](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)Show All Breadcrumbs
  * [Support](https://www.cisco.com/c/en/us/support/index.html)
...
Save
[Log in](https://www.cisco.com/c/login/index.html?referer=/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html) to Save Content 
[ Translations ](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)
Download
Print
### Available Languages
  * [Arabic - عربي](https://www.cisco.com/c/ar_ae/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)
  * [Brazil - Português](https://www.cisco.com/c/pt_br/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)
  * [Canada - Français](https://www.cisco.com/c/fr_ca/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)
  * [China - 简体中文](https://www.cisco.com/c/zh_cn/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)
  * [China - 繁體中文 (臺灣)](https://www.cisco.com/c/zh_tw/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)
  * [Germany - Deutsch](https://www.cisco.com/c/de_de/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)
  * [Italy - Italiano](https://www.cisco.com/c/it_it/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)
  * [Japan - 日本語](https://www.cisco.com/c/ja_jp/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)
  * [Korea - 한국어](https://www.cisco.com/c/ko_kr/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)
  * [Latin America - Español](https://www.cisco.com/c/es_mx/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)
  * [Netherlands - Nederlands](https://www.cisco.com/c/nl_nl/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)


### Download Options
  * [PDF](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.pdf) (65.3 KB)   
View with Adobe Reader on a variety of devices
  * [ePub](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.epub) (94.5 KB)   
View in various apps on iPhone, iPad, Android, Sony Reader, or Windows Phone
  * [Mobi (Kindle)](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.mobi) (90.6 KB)   
...
## Contents
[Introduction](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html#toc-hId-1789610536)
[Background Information](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html#toc-hId--762546425)
[Important Information](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html#toc-hId-980263910)
[Working Scenario](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html#toc-hId--1571893051)
[Phone Service URL is Set to Application:Cisco/CorporateDirectory and the Phone Uses HTTP](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html#toc-hId-170917284)
[Troubleshoot](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html#toc-hId-1913727619)
[Other Scenarios When the "Host Not Found" Issue Occurs](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html#toc-hId--638429342)
## Introduction
...
Important information relevant to this document is:
  ...
  * On the phone, when you select the option Corporate Directory, the phone sends either an HTTP or HTTPS request to one of the CUCM servers and is returned as an XML object as an HTTP(S) response. If HTTPS, then this also depends on the phone connecting to TVS service to verify the certificate for HTTPS. On phones that support midlets, this can be implemented in the phone midlet, and affected by [Services Provisioning](https://www.cisco.com/c/en/us/support/unified-communications/unified-communications-manager-callmanager/series.html "Services Provisioning") setting.
...
The certificate authentication process is similar to what is discussed in [Phone Contacts Trust Verification Service for Unknown Certificate](https://community.cisco.com:443/t5/collaboration-knowledge-base/communications-manager-security-by-default-and-itl-operation-and/ta-p/3129362).
...
[![PCAP from CUCM](https://www.cisco.com/c/dam/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00-00.jpeg)](https://www.cisco.com/c/dam/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00-00.jpeg "PCAP from CUCM")
## Troubleshoot
...
When you set the TVS logs to detailed, the service needs to be restarted for the trace level changes to take place. See Cisco bug ID [CSCuq22327](https://tools.cisco.com/bugsearch/bug/CSCuq22327) for the enhancement to notify that a service restart is required when log levels are changed.
...
Now, subscribe this service to one of the affected phones:
  1. Navigate to the device configuration page.
  2. Choose **Subscribe/Unsubscribe Services** under Related Links.
  3. **Subscribe** the test service you created.
  4. **Save** , apply the **configuration** , and reset the **phone**. 
    1. What you have done, irrespective of the phone's FW version, which determines whether to use the HTTP or HTTPS URL, is force it to use the HTTP URL.
    2. Access the Corporate Directory service on the phone.
    3. If it does not work, then collect the logs mentioned previously, and compare them with the working scenario mentioned under the Working Scenario section, and identify where the deviation is.
    4. If it works, then you have at least confirmed that from CUCM IP Phone service perspective there are no issues.
    5. At this stage, the issue is most likely with the phones that use the HTTPS URL.
    6. Now, pick a phone that does not work, and proceed to next step.
...
It could be one of these issues:
  1. The phone is unable to contact the TVS server. 
    1. In the PCAPS, verify the communication on port 2445.
    2. Ensure that none of the network devices in the path block this port.
  2. The phone contacts the TVS server, but the TLS handshake fails. 
...
See Cisco bug ID [CSCua65618](https://tools.cisco.com/bugsearch/bug/CSCua65618) for more information.  
  
  

  3. The Phone contacts the TVS servers, and the TLS handshake is successful, but the TVS is unable to verify the signer of the certificate that the phone requested to authenticate. 
...
```
  ...
  4. HTTPS traffic is blocked/dropped somewhere in the network. 
...
## Other Scenarios When the "Host Not Found" Issue Occurs
  ...
  2. The TVS server list is empty on the phone when it downloads the xmldefault.cnf.xml file. (In Version 8.6.2 the default configuration file does not have the TVS entry in it due to Cisco bug ID [CSCti64589](https://tools.cisco.com/bugsearch/bug/CSCti64589).)
  3. The phone is unable to use the TVS entry in the configuration file because it downloaded the xmldefault.cnf.xml file. See Cisco bug ID [CSCuq33297](https://tools.cisco.com/bugsearch/bug/CSCuq33297) - Phone to parse TVS information from the default configuration file.
...
| 2.0  |  08-Jun-2023   | Removed PII. Added TOC and Background Information. Updated Title, Introduction, SEO, Alt Text, Machine Translation, Style Requirements and Formatting.  |  
| 1.0  |  26-Jan-2015   | Initial Release  |  
[![Back to Top](https://www.cisco.com/etc/designs/cdc/fw/i/responsive/Default-bTop-36.svg)Back to Top](https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html "Back to Top")
...
### Contact Cisco
  * [Open a Support Case](https://mycase.cloudapps.cisco.com/start?prodDocUrl=https://www.cisco.com/c/en/us/support/docs/unified-communications/unified-communications-manager-callmanager/118699-technote-directory-00.html)![login required](https://www.cisco.com/etc/designs/cdc/fw/i/icon_lock_small.png)
