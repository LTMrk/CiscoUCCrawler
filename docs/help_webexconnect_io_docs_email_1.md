[Jump to Content](https://help.webexconnect.io/docs/email-1#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Email - WxEngage standalone
Search
`CTRL-K`
All
Platform Documentation
...
The email channel on the Live agent add-on currently only supports SMTP-based email assets on Webex Connect.
[Suggest Edits](https://help.webexconnect.io/edit/email-1)
...
* * *
[Livechat - WxEngage standalone](https://help.webexconnect.io/docs/livechat)[Apple Messages for Business - WxEngage standalone](https://help.webexconnect.io/docs/apple-messages-for-business-2)
