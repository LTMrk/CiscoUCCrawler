[Jump to Content](https://help.webexconnect.io/docs/cce-create-task#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Create Task - CCE
Search
`CTRL-K`
All
Platform Documentation
...
# Create Task - CCE
Understand how this node calls the Contact Center Enterprise Task API to create a new Task.
[Suggest Edits](https://help.webexconnect.io/edit/cce-create-task)
...
## 
Authorization
[](https://help.webexconnect.io/docs/cce-create-task#authorization)
...
[](https://help.webexconnect.io/docs/cce-create-task#methods-and-outcomes)
...
Extension variables consist of Key, Type, and Value.  | CCE Create Task -  
_location  
_ responsePayload  |  _ok - 200 - Success  
_ Successfully Created - 201 - Success  
 _Forbidden - 403 - Erro  
_ Not Found - 404 - Error  
 _Internal Server Error - 500 - Error  
_ Bad Request - 400 - Error  
 _Unreachable - HTTP Status - 502 Error  
...
[](https://help.webexconnect.io/docs/cce-create-task#sample-configurations-for-various-channels)
> ## 📘
> Note:
...
- Call Variables -  
- User Variables -  |  
| Facebook Messenger  | Task ID - $(flid)  
Conversation ID - $(conversationId)  
...
LiveChatAppID - $(aphid)  
Type - String  |  
| Apple Messages for Business  | Task ID - $(flid)  
Conversation ID - $(conversationId)  
...
* * *
[CCE Integration Nodes and Node Authorizations](https://help.webexconnect.io/docs/cce-integration-nodes-and-node-authorizations)[Get Task Details - CCE](https://help.webexconnect.io/docs/cce-get-task-details)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/cce-create-task)
  *     * [Authorization](https://help.webexconnect.io/docs/cce-create-task#authorization)
    * [Methods and Outcomes](https://help.webexconnect.io/docs/cce-create-task#methods-and-outcomes)
    * [Sample configurations for various channels](https://help.webexconnect.io/docs/cce-create-task#sample-configurations-for-various-channels)
