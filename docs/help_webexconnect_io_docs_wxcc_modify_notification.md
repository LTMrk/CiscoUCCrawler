[Jump to Content](https://help.webexconnect.io/docs/wxcc-modify-notification#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Modify Notification - WXCC
Search
`CTRL-K`
All
Platform Documentation
...
Understand the various modify notifications types present and how they can be configured
[Suggest Edits](https://help.webexconnect.io/edit/wxcc-modify-notification)
...
## 
Authorization
[](https://help.webexconnect.io/docs/wxcc-modify-notification#authorization)
...
[](https://help.webexconnect.io/docs/wxcc-modify-notification#methods-and-outcomes)
...
| --- | --- | --- |  
| Modified Accept  | None  |  _onInvalidData  
_ onError  
 _onInvalidChoice  
...
* ID from the output variables of the modified event is the task ID  | None  | V1.1 and v1.0  |  
| ID - $(n2.webex.ID)  
...
| Method Name  | Output Variables  | Node Outcomes  |  
| --- | --- | --- |  
| Modified Reject  | None  |  _onInvalidData  
_ onError  
 _onInvalidChoice  
_ onauthorizationfail  
 _onModifiedRejectFailure  
...
* * *
[Routed Notification - WXCC](https://help.webexconnect.io/docs/wxcc-routed-notification)[Screen Pop - WXCC](https://help.webexconnect.io/docs/wxcc-screen-pop)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/wxcc-modify-notification)
  *     * [Authorization](https://help.webexconnect.io/docs/wxcc-modify-notification#authorization)
    * [Methods and Outcomes](https://help.webexconnect.io/docs/wxcc-modify-notification#methods-and-outcomes)
