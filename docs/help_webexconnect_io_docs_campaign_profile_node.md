[Jump to Content](https://help.webexconnect.io/docs/campaign-profile-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Webex Campaign Profile Node
Search
`CTRL-K`
All
Platform Documentation
...
Understand what a Webex Campaign Profile node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/campaign-profile-node)
The _WEBEX CAMPAIGN Profile_ node enables you to manage any profile of selected IMICAMPAIGN accounts, which includes creating, updating, fetching, and deleting them.
> ## 📘
> Note:
> This node is available in Node Palette only if it has been provisioned for you.
![Screenshot of Webex Campaign Profile Node.](https://files.readme.io/39490e9-campaign_profile_node.png)
WEBEX CAMPAIGN Profile Node
## 
Manage Customer Profiles
[](https://help.webexconnect.io/docs/campaign-profile-node#manage-customer-profiles)
...
![Screenshot of Profile Node Configuration Page.](https://files.readme.io/7bf3384-node_configuration.png)
Node Configuration
## 
Fetch a Profile##
[](https://help.webexconnect.io/docs/campaign-profile-node#fetch-a-profile)
To fetch a profile:
...
![Screenshot of Fetch a Profile.](https://files.readme.io/eb9fe0a-fetch_profile.png)
Fetch Profile
The specified customer profile is fetched. 
## 
Update a Profile##
[](https://help.webexconnect.io/docs/campaign-profile-node#update-a-profile)
To update a profile:
  1. Select **Update Profile** in the **Actions** drop-down list box.
  2. Select the required **Profile**. The **Profile** corresponds to an account on IMICAMPAIGN .

![Screenshot of Update a Profile](https://files.readme.io/0cbc316-update_profile.png)
Update Profile
  1. Select the **Group** to which the selected profile belongs.
  2. Enter a **Primary Key** that uniquely identifies the selected profile.
  3. Select the **Attribute** that you want to update. The available attributes are: 
  ...
  5. Click **Add Attribute** if you want to add other attributes and repeat steps 5 and 6.
  6. Click **Save**.
...
## 
Create a Profile##
[](https://help.webexconnect.io/docs/campaign-profile-node#create-a-profile)
To update a profile:
  1. Select **Create Profile** in the **Actions** drop-down list box.
  2. Select the required **Profile**. The **Profile** corresponds to an account on IMICAMPAIGN.

![Screenshot of Create Profile](https://files.readme.io/293f8d4-create_profile.png)
Create Profile
  1. Select the **Group** to which the selected profile belongs.
  2. Enter a **Primary Key** that uniquely identifies the selected profile.
  3. Select the **Attribute** that you want to update. The available attributes are: 
...
## 
Delete a Profile##
[](https://help.webexconnect.io/docs/campaign-profile-node#delete-a-profile)
To delete a profile:
  1. Select **Fetch Profile** in the **Actions** drop-down list box.
  2. Select the required **Profile**. The **Profile** corresponds to an account on IMICAMPAIGN.
  3. Enter a **Primary Key** that uniquely identifies the selected profile.

![Screenshot of Delete Profile](https://files.readme.io/1d90f4e-delete_profile.png)
Delete Profile
  1. Click **Save**.
...
## 
Node Outcomes
[](https://help.webexconnect.io/docs/campaign-profile-node#node-outcomes)
...
## 
Transition Actions
[](https://help.webexconnect.io/docs/campaign-profile-node#transition-actions)
...
* * *
[Validate Chat Node](https://help.webexconnect.io/docs/validate-chat-node)[QnA Bot Node](https://help.webexconnect.io/docs/qa-bot-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/campaign-profile-node)
  *     * [Manage Customer Profiles](https://help.webexconnect.io/docs/campaign-profile-node#manage-customer-profiles)
    * [Fetch a Profile##](https://help.webexconnect.io/docs/campaign-profile-node#fetch-a-profile)
    * [Update a Profile##](https://help.webexconnect.io/docs/campaign-profile-node#update-a-profile)
    * [Create a Profile##](https://help.webexconnect.io/docs/campaign-profile-node#create-a-profile)
    * [Delete a Profile##](https://help.webexconnect.io/docs/campaign-profile-node#delete-a-profile)
    * [Node Outcomes](https://help.webexconnect.io/docs/campaign-profile-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/campaign-profile-node#transition-actions)
