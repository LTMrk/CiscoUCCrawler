[Jump to Content](https://help.webexconnect.io/docs/livechat#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Livechat - WxEngage standalone
Search
`CTRL-K`
All
Platform Documentation
...
Learn how to set up your Live Chat channel asset in Webex Connect and link it with Webex Engage.
[Suggest Edits](https://help.webexconnect.io/edit/livechat)
...
[](https://help.webexconnect.io/docs/livechat#register-livechat-asset)
...
Screenshot of Register to Webex Engage
  1. Choose a Service that you created in the pre-requisite step from the **Select Service** drop-down and click **Register**.
...
[](https://help.webexconnect.io/docs/livechat#configure-livechat-widget)
...
[](https://help.webexconnect.io/docs/livechat#deploy-the-widget-on-your-website)
...
* * *
[Facebook Messenger - WxEngage standalone](https://help.webexconnect.io/docs/facebook-messenger-2)[Email - WxEngage standalone](https://help.webexconnect.io/docs/email-1)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/livechat)
  *     * [Register Livechat asset](https://help.webexconnect.io/docs/livechat#register-livechat-asset)
    * [**Configure Livechat widget**](https://help.webexconnect.io/docs/livechat#configure-livechat-widget)
    * [**Deploy the widget on your website**](https://help.webexconnect.io/docs/livechat#deploy-the-widget-on-your-website)
