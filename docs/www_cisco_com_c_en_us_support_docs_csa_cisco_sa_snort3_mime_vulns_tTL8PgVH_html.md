  * [Skip to content](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html#eot-doc-wrapper)
  * [Skip to search](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html)
  * [Skip to footer](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html)
  ...
  * [](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html)
  * [Support](https://www.cisco.com/c/en/us/support/index.html)
...
Save
[Log in](https://www.cisco.com/c/login/index.html?referer=/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html) to Save Content 
Print
### Available Languages
Updated:February 12, 2026
Document ID:1760545027961358
Bias-Free Language
### Bias-Free Language
...
First Published:
2025 October 15 16:00 GMT
Last Updated: 
2026 February 12 18:38 GMT
Version 1.1: 
[Final](https://sec.cloudapps.cisco.com/security/center/resources/security_vulnerability_policy.html#final)
Workarounds: 
No workarounds available
Cisco Bug IDs:
[CSCwo71401](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwo71401)
[CSCwq03467](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwq03467)
[CSCwq15864](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwq15864)
[ More... ](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html)
[](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html) ,[CSCwo71401](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwo71401),[CSCwq03467](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwq03467),[CSCwq15864](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwq15864),[CSCwq42141](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwq42141),[CSCwq42153](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwq42153),[CSCwq42161](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwq42161)
CVE-2025-20359
CVE-2025-20360
[](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html)
CWE-127
...
[](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html)
CVSS Score:
[ Base 6.5](https://sec.cloudapps.cisco.com/security/center/cvssCalculator.x?version=3.1&vector=CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:L)[![](https://sec.cloudapps.cisco.com/security/center/images/blue-square.png)](https://sec.cloudapps.cisco.com/security/center/images/blue-square.png "Related image, diagram or screenshot.")**Click Icon to Copy Verbose Score**   
...
CWE-805
[](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html)
[ Download CSAF ](https://sec.cloudapps.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-snort3-mime-vulns-tTL8PgVH/csaf/cisco-sa-snort3-mime-vulns-tTL8PgVH.json)
Email 
## 
Summary 
...
For more information about these vulnerabilities, see the [Details](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html#details) section of this advisory. 
...
For information about which Snort releases were vulnerable at the time of publication, see the [Fixed Software](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html#fs) section of this advisory. For more information on Snort, see the [Snort website](https://www.snort.org/).
...
For information about which Cisco software releases are vulnerable, see the [Fixed Software](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html#fs) section of this advisory. 
...
| 
 ...
 |  
| --- | --- | --- |  
For information about which Cisco software releases were vulnerable at the time of publication, see the [Fixed Software](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html#fs) section of this advisory.
...
Only products listed in the [Vulnerable Products](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html#vp) section of this advisory are known to be affected by these vulnerabilities.
...
| Snort 3 Release  | First Fixed Release for CVE-2025-20360  | First Fixed Release for CVE-2025-20359  |  
| --- | --- | --- |  
| 3.x  | 3.9.1.0  | 3.9.3.0  |  
...
| Cisco Cyber Vision Release  | First Fixed Release for CVE-2025-20360  | First Fixed Release for CVE-2025-20359  |  
| --- | --- | --- |  
| Earlier than 5.2  | Migrate to a fixed release.  | Migrate to a fixed release.  |  
| 5.2  | Migrate to a fixed release.  | Migrate to a fixed release.  |  
...
## 
Source 
  * CVE-2025-20360: This vulnerability was found by Arunesh Shukla and Sanmith Prakash of Cisco during internal security testing.
...
| --- | --- | --- | --- | --- |  
| 1.1  | Updated fixed release information for Cisco Meraki.  | Fixed Releases  | Final  | 2026-FEB-12  |  
| 1.0  | Initial public release.  | —  | Final  | 2025-OCT-15  |  
Show Less
...
## 
Related to This Advisory 
[![Back to Top](https://www.cisco.com/etc/designs/cdc/fw/i/responsive/Default-bTop-36.svg)Back to Top](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-snort3-mime-vulns-tTL8PgVH.html "Back to Top")
