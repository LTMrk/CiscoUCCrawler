[Jump to Content](https://help.webexconnect.io/docs/flow-settings#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Flow Settings
Search
`CTRL-K`
All
Platform Documentation
...
# Flow Settings
Manage the flow configuration settings and set default values
[Suggest Edits](https://help.webexconnect.io/edit/flow-settings)
...
## 
General Settings
[](https://help.webexconnect.io/docs/flow-settings#general-settings)
Lists the common flow settings required for running the flow.
![Screenshot of Flow Settings.](https://files.readme.io/5ebb8ba-Flow_settings.jpg)
Flow Settings  
| Setting  | Description  |  
| --- | --- |  
| _Flow Name_  | The flow name used while creating the flow.  |  
| _Description_  | A meaningful description of the flow.  
  
This is an optional field.  |  
| _Correlation ID_  | A unique value that is attached to each running flow. This value allows you to trace a given flow run to your original request. For example, you can attach the OrderID created on your system as a CorrelationID to trace the flow run against the request. The field length limit is 250 characters.  
  
This is an optional field.  |  
| _Descriptive logs_  | A toggle button that is disabled by default.  
  
- Disabled - captures flow execution summary in the transaction logs.  
- Enabled - captures full node execution details in the transaction logs for [debugging](https://help.webexconnect.io/docs/debugging).**Note** : It may take up to 2 mins for the descriptive logs to start logging.This is an optional setting.Descriptive logs can be enabled or disabled irrespective of the status of the flow. However, they will log only the version of the flow that is in live state.  |  
| _Prevent duplicate flow runs_  | A toggle button that is disabled by default.  
...
### 
Custom Logs
[](https://help.webexconnect.io/docs/flow-settings#custom-logs)
...
[](https://help.webexconnect.io/docs/flow-settings#setting-up-a-custom-log)
...
![Screenshot of Mapping a Logbook to a Flow.](https://files.readme.io/704e092-Flow_settings1.jpg)
Mapping a Logbook to a Flow
> ## 📘
> Note
...
### 
Flow Outcomes
[](https://help.webexconnect.io/docs/flow-settings#flow-outcomes)
...
![Screenshot of Configuring Flow Outcomes.](https://files.readme.io/f86e005-Flow_settings2.jpg)
Configuring Flow Outcomes
Once configured, the custom Flow Outcomes are available for use when configuring the node end error configs.
![Screenshot of Custom Outcome in End Edge Configuration.](https://files.readme.io/b6a53ea-Flow_Settings_Custom_Outcome_in_End_Edge_Configuration.png)
Custom Outcome in End Edge Configuration
> ## 📘
> Note
...
[](https://help.webexconnect.io/docs/flow-settings#outcome-based-notifications)
...
![Screenshot of Setting up outcome-based notifications.](https://files.readme.io/b8ffbac-Flow_Settings_Setting_up_outcome-based_notifications.png)
Setting up outcome-based notifications
> ## 📘
...
> ## ❗️
> Enable [descriptive logging](https://help.webexconnect.io/docs/flow-settings#section-general) and check the transaction logs in [debug mode](https://help.webexconnect.io/docs/debugging) to verify if the notification URL is accessible. Please note that this feature is suggested to be used only during initial flow set-up and troubleshooting. Enabling this feature in production mode can impact your tenant performance.
### 
Custom Variables
[](https://help.webexconnect.io/docs/flow-settings#custom-variables)
...
![Screenshot of Managing custom variables.](https://files.readme.io/f17142f-Flow_Settings_Managing_custom_variables.png)
Managing custom variables
Updated 4 months ago
* * *
[Navigating Flow Builder Canvas](https://help.webexconnect.io/docs/navigate-flow-builder-canvas)[Triggering a Flow](https://help.webexconnect.io/docs/trigger-flow)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/flow-settings)
  *     * [General Settings](https://help.webexconnect.io/docs/flow-settings#general-settings)
      * [Custom Logs](https://help.webexconnect.io/docs/flow-settings#custom-logs)
      * [Flow Outcomes](https://help.webexconnect.io/docs/flow-settings#flow-outcomes)
      * [Outcome-based Notifications](https://help.webexconnect.io/docs/flow-settings#outcome-based-notifications)
      * [Custom Variables](https://help.webexconnect.io/docs/flow-settings#custom-variables)
