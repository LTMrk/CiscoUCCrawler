[Jump to Content](https://help.webexconnect.io/docs/rcs-capability-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)RCS Capability Node
Search
`CTRL-K`
All
Platform Documentation
...
# RCS Capability Node
Understand what a RCS Capability node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/rcs-capability-node)
The RCS capability node checks if the mobile number of customers has the capability to receive RCS messages. This node helps you in checking the RCS version, RCS platform, and if RCS has been enabled on the user's mobile device, along with many other RCS attributes.  

![Screenshot of RCS Capability Node.](https://files.readme.io/78f4539-RCS.jpg)
RCS Capability Node
## 
Node Configuration
[](https://help.webexconnect.io/docs/rcs-capability-node#node-configuration)
...
![Screenshot of RCS Capability Node Configuartion Window.](https://files.readme.io/22033f2-RCS1.jpg)
...
It is useful when sending messages to users on a single mobile operator and increases the message throughput significantly when provided. See the list of [carrier IDs](https://help.webexconnect.io/docs/carrier-ids-for-rcs-capability-and-rcs-message-nodes).


## 
Input Variables
[](https://help.webexconnect.io/docs/rcs-capability-node#input-variables)
...
## 
Output Variables
[](https://help.webexconnect.io/docs/rcs-capability-node#output-variables)
> ## 📘
> Using the node
...
You can see the data that this node generates as output variables. These [variables](https://help.webexconnect.io/docs/variable-management) are available for use in subsequent nodes. The following are the standard output variables for the RCS capability node:
...
## 
Node Outcomes
[](https://help.webexconnect.io/docs/rcs-capability-node#node-outcomes)
...
| --- | --- |  
| Success (green)  
 | - **onSuccess** - the flow exits through this node when the RCS capability verification is a success  |  
| Error (red)  | - **onError** - the flow exits through this node outcome when there is an error in verifying RCS capability  |  
## 
Transition Actions
[](https://help.webexconnect.io/docs/rcs-capability-node#transition-actions)
...
* * *
[Profile Node](https://help.webexconnect.io/docs/profile-node)[RCS Message Node](https://help.webexconnect.io/docs/rcs-message-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/rcs-capability-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/rcs-capability-node#node-configuration)
    * [Input Variables](https://help.webexconnect.io/docs/rcs-capability-node#input-variables)
    * [Output Variables](https://help.webexconnect.io/docs/rcs-capability-node#output-variables)
    * [Node Outcomes](https://help.webexconnect.io/docs/rcs-capability-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/rcs-capability-node#transition-actions)
