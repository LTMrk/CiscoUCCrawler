[Jump to Content](https://help.webexconnect.io/docs/validate-otp-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Validate OTP Node
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/validate-otp-node)
...
![Screenshot of Validate OTP Node.](https://files.readme.io/6ff51cc-validate_otp_icon.png)
Validate OTP Node
## 
Node Configuration
[](https://help.webexconnect.io/docs/validate-otp-node#node-configuration)
...
![Screenshot of Validate OTP Configuration Page.](https://files.readme.io/de8bab8-validate_otp_configuration.png)
Validate OTP Configuration
## 
Input Variables
[](https://help.webexconnect.io/docs/validate-otp-node#input-variables)
...
![Screenshot of Input and Custom Variables.](https://files.readme.io/32d8290-validate_otp_input_variables.png)
Input and Custom Variables
## 
Output Variables
[](https://help.webexconnect.io/docs/validate-otp-node#output-variables)
This node does not have any standard output variables.
## 
Node Outcomes
[](https://help.webexconnect.io/docs/validate-otp-node#node-outcomes)
...
## 
Transition Actions
[](https://help.webexconnect.io/docs/validate-otp-node#transition-actions)
...
* * *
[Generate OTP Node](https://help.webexconnect.io/docs/generate-otp-node)[Encryption Node](https://help.webexconnect.io/docs/encryption-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/validate-otp-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/validate-otp-node#node-configuration)
    * [Input Variables](https://help.webexconnect.io/docs/validate-otp-node#input-variables)
    * [Output Variables](https://help.webexconnect.io/docs/validate-otp-node#output-variables)
    * [Node Outcomes](https://help.webexconnect.io/docs/validate-otp-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/validate-otp-node#transition-actions)
