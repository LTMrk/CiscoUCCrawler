[Jump to Content](https://help.webexconnect.io/docs/cce-remove-participant-engage-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Remove Participant - CCE
Search
`CTRL-K`
All
Platform Documentation
...
Understand how to remove an agent while configuring an Remove Participant node in Contact Center Enterprise
[Suggest Edits](https://help.webexconnect.io/edit/cce-remove-participant-engage-node)
...
## 
Authorization
[](https://help.webexconnect.io/docs/cce-remove-participant-engage-node#authorization)
...
[](https://help.webexconnect.io/docs/cce-remove-participant-engage-node#methods-and-outcomes)
...
| --- | --- | --- |  
| Remove Participant  | TransId  |  _onInvalidData  
_ onError  
 _onInvalidChoice  
...
_ AgentId from the output variables of the start node is the participant  | TransId  |  
> ## 📘
> Note
...
* * *
[Add Participant - CCE](https://help.webexconnect.io/docs/cce-add-participant-engage-node)[Close Conversation - CCE](https://help.webexconnect.io/docs/cce-close-conversation-engage-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/cce-remove-participant-engage-node)
  *     * [Authorization](https://help.webexconnect.io/docs/cce-remove-participant-engage-node#authorization)
    * [Methods and Outcomes](https://help.webexconnect.io/docs/cce-remove-participant-engage-node#methods-and-outcomes)
