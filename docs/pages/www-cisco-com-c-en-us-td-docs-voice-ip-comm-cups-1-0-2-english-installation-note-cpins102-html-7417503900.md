---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cups-1-0-2-english-installation-note-cpins102-html-7417503900
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cups/1_0_2/english/installation/note/cpins102.html
retrieved_at: 2026-08-16T23:36:54.586794+00:00
---

Installing Cisco Unified Presence Server Release 1.0(2)
...
See Table 2 , which lists URLs for software and additional documentation.
...
After the software installation starts, you will be asked to select one of the options that Table 7 lists.
...
Step 31 Enter your certificate information from Table 5 and choose OK .
...
Step 38 Enter your certificate information from Table 6 and choose OK .
...
| Cisco Unified CallManager Security Guide | http://www.cisco.com/univercd/cc/td/doc/product/voice/c_callmg/sec_vir/a e/index.htm |
...
| RAID not applicable Note For the HP 7825H1 and the IBM 7825I1, SATA RAID is enabled, and the RAID type is 1(1+0), with one logical drive. | RAID type: 1(1+0) | RAID type: 1(1+0) |
...
| Step 3 | Before installing Cisco Unified Presence Server, ensure that the server has network access to the Cisco Unified CallManager first node. |  |
| Step 4 | Before installing the Cisco Unified Presence Server second node, ensure that you have added the Cisco Unified Presence Server second node as an application server on the Cisco Unified CallManager first node and that you have also added the second node as a server on the Cisco Unified Presence Server first node. | From the Cisco Unified CallManager Administration window, navigate to System > Application Server . From the Cisco Unified Presence Server Administration window, navigate to System > Server . For more information, see the Cisco Unified CallManager Administration Guide and the Cisco Unified Presence Server Administration Guide . |
| Step 5 | If you use DNS, ensure that you have configured the host name of the new server on the DNS server and that the DNS server can resolve the host name of the Cisco Unified CallManager first node and of the other Cisco Unified Presence Server node (if any). |  |
...
| Cisco Unified CallManager Publisher Security Password Note You must enter the security password configured on the Cisco Unified CallManager first node. |  | No |
...
| Apply Additional Release | This option allows you to upgrade the preinstall software with the latest service release prior to configuring your system. Note You must have the software image available on DVD or on a remote server prior to choosing this option. |
