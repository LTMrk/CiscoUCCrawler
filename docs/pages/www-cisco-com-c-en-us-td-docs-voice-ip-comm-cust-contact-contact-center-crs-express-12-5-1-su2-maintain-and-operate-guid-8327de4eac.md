---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-crs-express-12-5-1-su2-maintain-and-operate-guid-8327de4eac
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/crs/express_12_5_1_su2/maintain_and_operate/guide/uccx_b_1251su2_admin-and-operations-guide/uccx_b_12_5_2admin-and-operations-guide_chapter_011010.html
retrieved_at: 2026-08-16T21:37:32.423198+00:00
---
...
EmailOAuthConnectionFailed

EMAIL_OAUTH_CONNECTION_FAILED

This alert occurs when CCP is unable to connect to the email OAuth server or get the access token.

EmailAuthenticationFailed

EMAIL_AUTHENTICATION_FAILED

This alert occurs when the email credentials are wrong.
...
To view or edit values for any alert, right-click the alert and select Set Alert/Properties .
