---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-be6000-releasenotes-be6000-softwareloadsummary-12x14x-xu-14-cucm-m-busi-f234b2b521
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/BE6000/releasenotes/BE6000_SoftwareLoadSummary_12X14X_XU_14/cucm_m_business-edition-6000-software-load_XU.html
retrieved_at: 2026-08-21T21:39:51.773374+00:00
---
...
Business Edition 6000 appliance hardware is loaded with the latest supported BIOS, firmware, and drivers from Cisco’s UCS Hardware and Software Compatibility Tool at the time of factory build. At time of installation, consult this tool to see if any items must be refreshed.

Business Edition 6000 appliances are loaded with a variety of files for virtualization software and application software to
...
If the factory-loaded software is erased (example due to hardware replacement/migration, disks reformat, RAID rebuild, virtualization
                                    software reinstall, or upgrade, so on), see the Business Edition 6000 12.5  Installation Guide for appliance rebuild instructions.
...
Partial (skip) installed OVA: Open Virtual Archive file containing an application that is installed up to the “skip” configuration point, where the application
                                    ...
                                    install with a platformConfig.xml configuration file. Refer to the Business Edition 6000 12.5 Installation Guide for further information.
...
## Preloaded Virtualization and Application Software - Business Edition 6000
...
If ordered with option BE6K-VIRTBAS-7X

License for Cisco Business Edition Embedded Virt. Basic 7x is factory-loaded. See Cisco Business Edition 6000 Installation
                                          Guide for details.
...
License for Cisco Business Edition Embedded Virt. Basic Plus 7x is factory-loaded. See Cisco Business Edition 6000 Installation
                                          Guide for details.
...
License for Cisco Business Edition Embedded Virt. Enhanced 7x is factory-loaded. See Cisco Business Edition 6000 Installation
                                          Guide for details.
...
Partial (skip) installed application OVA (1000 user VM configuration)

UCSInstall_UCOS_UNRST_12.5.1.10000-22_80_vmv13_v1.0.ova

UCSInstall_UCOS_UNRST_14.0.1.10000-20_80_vmv13_v1.0.ova

Factory preload only

Preloaded bootable application installer image for base release

Bootable_UCSInstall_UCOS_UNRST_12.5.1.10000-22.sgn.iso
...
UCSInstall_CUP_UNRST_12.5.1.10000-22_80_vmv13_v1.0.ova

Factory preloaded only

Preloaded bootable application installer image for base release

Bootable_UCSInstall_CUP_UNRST_12.5.1.10000-22.sgn.iso
...
UCSInstall_CUC_UNRST_12.5.1.10000-23_160_v1.0.ova

UCSInstall_CUC_UNRST_14.0.1.10000-19_160_v1.0.ova

Factory preload only

Preloaded bootable application installer image for base release

Bootable_UCSInstall_CUC_UNRST_12.5.1.10000-23.sgn.iso
...
Partial (skip) installed application OVA (100 agent VM configuration)
...
cpc-provisioning-12.6.0.3039-small.ova_v6.5_signed.ova
...
| Application or File | Filename for appliances with Cisco Product ID's: BE6M-M5-XU BE6H-M5-KXU | Access |
|---|---|---|
| Virtualization Software |
| VMware vSphere ESXi 7.0 GA |
| CISCO Custom Image for ESXi 7.0 GA Install CD | VMware_ESXi_7.0.0_15843807_Custom_Cisco_4.1.1a.iso | VMware |
| Cisco Business Edition Embedded Virtualization License |
| If ordered with option BE6K-VIRTBAS-7X | License for Cisco Business Edition Embedded Virt. Basic 7x is factory-loaded. See Cisco Business Edition 6000 Installation
                                          Guide for details. | Cisco License Central |
| If ordered with option BE6/7K-VIRTBASP-7X | License for Cisco Business Edition Embedded Virt. Basic Plus 7x is factory-loaded. See Cisco Business Edition 6000 Installation
                                          Guide for details. | Cisco License Central |
| If ordered with option BE6/7K-VIRTENH-7X | License for Cisco Business Edition Embedded Virt. Enhanced 7x is factory-loaded. See Cisco Business Edition 6000 Installation
                                          Guide for details. | Cisco License Central |
| Calling, Messaging & Edge Applications |
| Cisco Unified Communications Manager 12.5(1) SU2 |
| Partial (skip) installed application OVA (1000 user VM configuration) | UCSInstall_UCOS_UNRST_12.5.1.10000-22_80_vmv13_v1.0.ova UCSInstall_UCOS_UNRST_14.0.1.10000-20_80_vmv13_v1.0.ova | Factory preload only |
| Preloaded bootable application installer image for base release | Bootable_UCSInstall_UCOS_UNRST_12.5.1.10000-22.sgn.iso | Cisco License Central |
...
| Cisco Unified Communications Manager - IM &Presence Service 12.5(1) SU2 |
| Partial (skip) installed application OVA (1000 user VM configuration) | UCSInstall_CUP_UNRST_12.5.1.10000-22_80_vmv13_v1.0.ova | Factory preloaded only |
| Preloaded bootable application installer image for base release | Bootable_UCSInstall_CUP_UNRST_12.5.1.10000-22.sgn.iso | Cisco License Central |
...
| Cisco Unity Connection 12.5(1) SU2 |
| Partial (skip) installed application OVA (1000 user VM configuration) | UCSInstall_CUC_UNRST_12.5.1.10000-23_160_v1.0.ova UCSInstall_CUC_UNRST_14.0.1.10000-19_160_v1.0.ova | Factory preload only |
| Preloaded bootable application installer image for base release | Bootable_UCSInstall_CUC_UNRST_12.5.1.10000-23.sgn.iso | Cisco License Central |
...
| Cisco Expressway X12.6.2 |
| Deployed OVA containing preinstalled application (Small VM configuration) | s42700x12_6_2.ova | Software Download |
| Cisco Paging Server 12.5.1 |
...
| Contact Center Applications |
| Cisco Unified Contact Center Express 12.5 |
| Partial (skip) installed application OVA (100 agent VM configuration) | Not preloaded at this time | Cisco License Central |
