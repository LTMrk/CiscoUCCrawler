...
Cisco IP Phone 7800 Series Release Notes for Firmware Release 14.2(1)SR1 . 3
...
Cisco IP Phone 7800 Series Release Notes for Firmware Release 14.2(1)SR1

These release notes support the Cisco IP Phone 7811, 7821, 7841, and 7861 running SIP Firmware Release 14.2(1)SR1.
...
Starting from this release, the phone supports Cisco UCM with Multi-server (SAN) Tomcat Certificates configured. The TFTP server address can still be found in the phone ITL file.
...
Localization Improvement on Enhanced Survivability

The feature Enhanced Survivability only applies to Webex Calling Dedicated Instance . Since from this release, the phone improves the localization support on this feature. The supported languages can be referred to Cisco IP Phone 7800 Series Data Sheet .
...
· CSCuv46831 Improve NTP accuracy
...
https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=14.2(1)SR1&sb=anfr&svr=3nH&bt=custV

· Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=14.2(1)SR1&sb=afr&sts=open&svr=3nH&bt=custV

· Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=14.2(1)SR1&sb=fr&svr=3nH&bt=custV
