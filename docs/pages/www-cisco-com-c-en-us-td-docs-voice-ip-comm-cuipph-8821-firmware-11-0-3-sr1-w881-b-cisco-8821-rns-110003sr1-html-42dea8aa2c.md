---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-8821-firmware-11-0-3-sr1-w881-b-cisco-8821-rns-110003sr1-html-42dea8aa2c
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/8821/firmware/11-0-3-SR1/w881_b_cisco-8821-rns-110003sr1.html
retrieved_at: 2026-08-21T13:35:59.941383+00:00
---

Cisco Wireless IP Phone 8821 Release Notes for Firmware Release 11.0(3)SR1
...
These release notes support the Cisco Wireless IP Phone 8821 Firmware Release 11.0(3)SR1.
...
### Install Firmware Release 11.0(3)SR1 on Cisco Unified Communications Manager
...
Firmware file: cmterm-8821-sip.11-0-3SR1-1.k3.cop.sgn

If you added
				  the firmware file to the cart, click the Download Cart link when you are ready to download
				  the file.

### Install Firmware Release 11.0(3)SR1 on Cisco Unified Communications Manager Express
...
The file to download is cmterm-8821.11-0-3SR1-1.zip
...
| Cisco Wireless LAN Controller | 8.0.121.0 | 8.0.140.0, 8.2.141.0, and later |
...
| Step 5 | In the Latest
			 Releases folder, choose 11.0(3)SR1 . |
| Step 6 | Select the
			 firmware file, click the Download or Add to
				cart button, and follow the prompts. Firmware file: cmterm-8821-sip.11-0-3SR1-1.k3.cop.sgn Note If you added
				  the firmware file to the cart, click the Download Cart link when you are ready to download
...
| Step 4 | Choose 11.0(3)SR1 in the Latest Releases folder. |
| Step 5 | Click Download or Add to cart and follow the prompts. The file to download is cmterm-8821.11-0-3SR1-1.zip |
