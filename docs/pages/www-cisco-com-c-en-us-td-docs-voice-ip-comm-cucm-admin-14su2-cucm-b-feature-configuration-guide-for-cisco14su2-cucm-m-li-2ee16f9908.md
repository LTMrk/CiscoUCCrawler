---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-admin-14su2-cucm-b-feature-configuration-guide-for-cisco14su2-cucm-m-li-2ee16f9908
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/admin/14SU2/cucm_b_feature-configuration-guide-for-cisco14su2/cucm_m_licensing.html
retrieved_at: 2026-08-16T16:22:33.399192+00:00
---
...
Cisco Unified Workspace Licensing (UWL) allows organizations to access a wide range of Cisco Collaboration applications and
                              services in a cost-effective, simple package. It includes soft clients, application server software, and licensing on a per-user
                              basis.
...
Basic User Connect License - supports one device, including all Essential devices, plus basic (voice and video) call control
                                          features. (For example: Cisco 6911, Cisco 6921, Cisco 9811)
...
Enhanced User Connect License - supports one device, including all Basic devices, plus advanced (voice and video) call control
                                          ...
                                          79xx, Cisco 89xx, Cisco 9841, 9851, 9861, and 9871, Cisco 99xx, Cisco E20, Cisco TelePresence EX60, Cisco TelePresence EX90,
                                          third party SIP)
...
TelePresence Room license - supports room based immersive and multipurpose Cisco TelePresence System endpoints and Spark Room.
                                          ...
                                          Cisco TelePresence System Profile Series, Cisco Expressway)

### Commercial Licensing

Cisco Unified Communications Manager software and user licenses are available through Cisco Collaboration Flex Plan 3.0. Ordering
                              options include:

A-Flex-3

A-FLEX-3-EDU ( EOL , reaches LDOS June 30, 2026)

A-Flex-3-FEDRAMP

E3-COLLABORATION

Flex Plan 3.0 offers both Enterprise Agreement (EA) and Named User (NU) buying models.
...
Cisco has announced the End-of-Sale (EoS) for perpetual licensing models for Unified Communications Manager. You can continue
                              to use on-premises calling while migrating to Flex Plan 3.0. The following are the Flex Plan 3.0 license types for Unified
...
Device (low-end phones)

User and Device (low-end phones)

Cisco IP Phones 7811, 7821, 6901, Cisco Analog Telephony Adapters, Cisco Unified SIP Phone 3905, and Fax.
...
Cisco IP Phones 7841 and 7861, Cisco IP Phones 7945 and 7965, Cisco IP Phones 8811, 8841, 8851, 8861, 8875, Cisco Unified
                                          IP Phones 9900 Series, Jabber clients, and Cisco Desktop Collaboration Experience DX Series

NU Professional

CUWL

User and Multiple Devices

Cisco Unified IP Phone 7800 Series, Cisco Unified IP Phone 7900 Series, Cisco IP Phones 8811, 8841, 8851, 8861, 8875, Cisco
                                          Unified IP Phone 9900 Series, Jabber clients, and Cisco Desktop Collaboration Experience DX Series
...
Analog phones, Cisco IP Phones 3905, 6901, 7811, 7821, Cisco IP Phone 9811.
...
Cisco IP Phones 7841 and 7861, Cisco IP Phones 7945 and 7965, Cisco IP Phones 8811, 8841, 8851, 8861, 8875, Cisco IP Phones
                                          9841, 9851, 9861, and 9871, Cisco Unified IP Phones 9900 Series, Jabber clients, and Cisco Desktop Collaboration Experience
                                          DX Series
...
Supports room based immersive and multipurpose Cisco TelePresence System endpoints and Spark Room. (For example: Cisco Desk
                                          Pro G2, Cisco Codec Pro G2, Cisco Board Pro 55 G2, and Cisco Board Pro 75 G2, Cisco TelePresence System Series 3200, 3000,
                                          1300, Cisco TelePresence MX Series, Cisco TelePresence TX Series, Cisco TelePresence System Profile Series, Cisco Expressway)
...
| Note | Legacy license types, such as Enhanced and Enhanced Plus, are no longer valid under Flex Plan 3.0. |
|---|---|

| Flex 3.0 | License Type | Consumed by |
|---|---|---|
| NU Access | Basic | Device (low-end phones) User and Device (low-end phones) Cisco IP Phones 7811, 7821, 6901, Cisco Analog Telephony Adapters, Cisco Unified SIP Phone 3905, and Fax. |
| NU Enhanced | Enhanced | Device User and Device Cisco IP Phones 7841 and 7861, Cisco IP Phones 7945 and 7965, Cisco IP Phones 8811, 8841, 8851, 8861, 8875, Cisco Unified
                                          IP Phones 9900 Series, Jabber clients, and Cisco Desktop Collaboration Experience DX Series |
| NU Professional | CUWL | User and Multiple Devices Cisco Unified IP Phone 7800 Series, Cisco Unified IP Phone 7900 Series, Cisco IP Phones 8811, 8841, 8851, 8861, 8875, Cisco
                                          Unified IP Phone 9900 Series, Jabber clients, and Cisco Desktop Collaboration Experience DX Series |
| EA Access | Basic | Device (low end phones) User and Device (low end phones) Analog phones, Cisco IP Phones 3905, 6901, 7811, 7821, Cisco IP Phone 9811. |
| EA Common Area | Enhanced | Device User and Device Cisco IP Phones 7841 and 7861, Cisco IP Phones 7945 and 7965, Cisco IP Phones 8811, 8841, 8851, 8861, 8875, Cisco IP Phones
                                          9841, 9851, 9861, and 9871, Cisco Unified IP Phones 9900 Series, Jabber clients, and Cisco Desktop Collaboration Experience
                                          DX Series |
| EA Knowledge Worker | CUWL | User and Multiple Devices Cisco Unified IP Phone 7800 Series, Cisco Unified IP Phone 7900 Series, Cisco IP Phones 8811, 8841, 8851, 8861, 8875, Cisco
                                          Unified IP Phone 9900 Series, Jabber clients, and Cisco Desktop Collaboration Experience DX Series |
| UC Manager TelePresence Room | TelePresence Room license | Supports room based immersive and multipurpose Cisco TelePresence System endpoints and Spark Room. (For example: Cisco Desk
                                          Pro G2, Cisco Codec Pro G2, Cisco Board Pro 55 G2, and Cisco Board Pro 75 G2, Cisco TelePresence System Series 3200, 3000,
                                          1300, Cisco TelePresence MX Series, Cisco TelePresence TX Series, Cisco TelePresence System Profile Series, Cisco Expressway) |
