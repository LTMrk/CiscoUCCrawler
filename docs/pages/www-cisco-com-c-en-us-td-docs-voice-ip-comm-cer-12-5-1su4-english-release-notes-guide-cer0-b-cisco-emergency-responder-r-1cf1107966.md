...
Cisco Emergency Responder Release 12.5(1)SU4 supports the following new features:

## E911 Support for Remote Teleworker and Off-Premises User

Cisco Emergency Responder provides E911 support to remote teleworker and off-premises users. These users when registering
                  over Virtual Private Network (VPN) or Mobile and Remote Access, can update their location through Device display or Off-premises
                  User Page. The Enterprises require an arrangement with a National E911 Service Provider for location Update to PSAP, call
                  completion, and MSAG validation service.

## Switch Support

Support switch port based tracking for new Voice LAN Switches: Cisco Catalyst C9300L Series. For more information, see the Supported Voice Ready Lan Switches section.

## Requirements

### Supported Hardware and Software

The information in the following sections discuss Hardware and Software requirements for Cisco Emergency Responder 12.5(1)SU4.
...
Off-premise device mapping does not correctly map extensions longer than 10 digits

CSCvv22092

CER does not retain Intrado cert on upgrade and the connectivity to intrado will not be successful

CSCvv79617

CER doesn't display ERROR's info when SNMPv3's user has password with '<' or '>' characters

CSCvv84530

Issue when uploading branding file to CER
...
CiscoJ should be top security method but CPU spikes
...
| Identifier | Headline |
|---|---|
| CSCvu69590 | Off-premise device mapping does not correctly map extensions longer than 10 digits |
| CSCvv22092 | CER does not retain Intrado cert on upgrade and the connectivity to intrado will not be successful |
| CSCvv79617 | CER doesn't display ERROR's info when SNMPv3's user has password with '<' or '>' characters |
