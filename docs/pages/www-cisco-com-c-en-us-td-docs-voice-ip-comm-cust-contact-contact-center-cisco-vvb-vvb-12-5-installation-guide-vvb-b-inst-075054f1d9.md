---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-cisco-vvb-vvb-12-5-installation-guide-vvb-b-inst-075054f1d9
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/cisco_vvb/VVB_12_5/installation/guide/vvb_b_install-and-upgrade-guide-12-5/vvb_b_install-and-upgrade-guide-12-5_chapter_010.html
retrieved_at: 2026-08-21T16:27:43.759219+00:00
---
...
Check the 12.0 VVB OVA HDD profile using the CLI command: show hardware
...
From Release 11.6, VVB is available in two release ISOs: the VVB export restricted software image and the VVB export unrestricted
                                       software image. The export unrestricted image does not support SRTP voice media. An upgrade from one release ISO to the other
                                       is not possible.
...
The following table lists the tasks to be performed in order to upgrade from Cisco VVB, Release 12.0(1) to Cisco VVB, Release
                              12.5(1).
...
After the successful upgrade, the Certificate Authoritiess (CAs) that are unapproved by Cisco are removed from the platform
...
| Important | From Release 11.6, VVB is available in two release ISOs: the VVB export restricted software image and the VVB export unrestricted
                                       software image. The export unrestricted image does not support SRTP voice media. An upgrade from one release ISO to the other
                                       is not possible. |
|---|---|

| Note | Local DVD option is not available for upgrading Cisco VVB on KVM. To apply ES, follow the same procedure as Cisco VVB upgrade. |
|---|---|

| Upgrade Type | Upgrade Path | Description |
|---|---|---|
| Release to Release | 12.0(1) to 12.5(1) | There is service interruption during the upgrade and subsequent server restart. |
...
| Note | After the successful upgrade, the Certificate Authoritiess (CAs) that are unapproved by Cisco are removed from the platform
