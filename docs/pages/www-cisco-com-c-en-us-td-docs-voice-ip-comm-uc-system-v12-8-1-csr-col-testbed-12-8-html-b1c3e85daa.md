---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-uc-system-v12-8-1-csr-col-testbed-12-8-html-b1c3e85daa
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/uc_system/V12_8_1/CSR_COL_TestBed_12_8.html
retrieved_at: 2026-08-16T18:27:25.415338+00:00
---

Collaboration Test Bed for Collaboration Systems Release 12.8
...
This document covers the test bed topology that was completed for Cisco Collaborations System Release 12.8 testing.
...
For more details about system-wide features tested for Cisco Collaboration Systems Release 12.8, see System Release Notes for Cisco Collaboration Systems, Release 12.8 . For details about the new and changed product features, see individual product releases notes: Product Documentation .

## Collaboration Test Bed and Deployment Architecture

This figure provides an overview of the test bed topology that was used for Cisco Collaboration Systems Release 12.8. This high-level topology centers on the Cisco Unified Communications Manager (Unified Communications Manager). To address global customer needs, the test bed contains collaboration elements spread across different Unified Communications Manager clusters in multiple time zones and geographical boundaries.

Figure 1: Collaboration Systems Release 12.8 Test Bed Architecture
...
For a more detailed topology of the Cisco Unified Contact Center Express topology, refer to Unified CCX Test Bed Description for CSR 11.5 - Revised (update link once new doc is published)
...
### Jabber for iOS13 Push Notifications

Release 13 of iOS deprecates legacy VoiP sockets that allow Cisco Unified Communications Manager or the IM and Presence Service to maintain connections for calling and messaging while Jabber on iOS is operating in background mode. Apple’s cloud-based Push Notification service is needed to push instant message and voice notifications to Cisco Jabber iOS clients that are running in the background.
