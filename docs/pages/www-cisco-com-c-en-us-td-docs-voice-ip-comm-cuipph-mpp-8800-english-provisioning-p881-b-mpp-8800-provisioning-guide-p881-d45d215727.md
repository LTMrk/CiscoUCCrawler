...
## New and Changed Information for Cisco IP Phone 8800 Series Multiplatform Phones

The document Cisco IP Phone 7800 Series and 8800 Series Multiplatform Phones Provisioning Guide for Firmware Release 11.0(1) has been split to cover only the Cisco IP Phone 8800 Series Multiplatform Phones.

## New and Changed Information for Firmware Release 11.2(3)SR1

The following sections are new or updated to support the Cisco IP Phone 7832 Multiplatform Phones .

Revisions

New and Changed Sections

## New and Changed Information for Firmware Release 11.2(3)

Revisions

New and Changed Sections

Added XML open format examples for Cisco IP Conference Phone 8832 Multiplatform Phone
...
## New and Changed Information for Cisco IP Phone 8800 Series Multiplatform Phones with Firmware 11.2(1)
...
|---|---|
| Added a new topic to introduce Activation Code Onboarding. | Onboard Activation Code |

| Revisions | New and Changed Sections |
|---|---|
| Added a concept topic for Open Profile Encryption. | Open Profile Encryption |
| Added XML open format examples for Cisco IP Conference Phone 8832 Multiplatform Phone | XML Open Format Sample for the Cisco IP Conference Phone 8832 Multiplatform Phones |
...
| Updated the XML open format samples with new parameters and available options | XML Open Format Sample for Cisco IP Phone 8800 Series Multiplatform Phone |
...
| Added new elements to XML Open Format Sample | XML Open Format Sample for Cisco IP Phone 8800 Series Multiplatform Phone |
...
| Updated the topic to support Executive and assistant | XML Open Format Sample for Cisco IP Phone 8800 Series Multiplatform Phone |
