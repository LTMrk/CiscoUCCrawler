---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-bat-12-5-1-su2-cucm-b-bulk-administration-guide-1251su2-cucm-b-bulk-adm-ab447fd230
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/bat/12_5_1_SU2/cucm_b_bulk-administration-guide-1251su2/cucm_b_bulk-administration-guide-1251su2_chapter_01001000.html
retrieved_at: 2026-08-21T08:50:40.450643+00:00
---
...
You can add Fallback Profile Configuration to the Cisco Unified Communications Manager database using a custom CSV data file.

### Before you begin

- You must have a CSV data
                                 			 file that contains the Name, Description, Advertised Fallback Directory E.164
                                 			 Number, Fallback QOS Sensitivity Level, Fallback Call Answer Timer, Fallback
                                 			 Directory Number Partition, Fallback Directory Number, Number of Digits for
                                 			 Caller ID Partial Match and Fallback Call CSS.
...
You can delete Fallback Profile from the Cisco Unified Communications Manager database using a custom CSV data file.
...
- Create a text file that
                                 			 lists the name of the Fallback Profile that you want to delete.
...
From the Delete Fallback Profile where Name in custom
...
| Step 1 | Choose Bulk Administration > Intercompany
                                             				  Media Services > Fallback
                                             				  Profie > Insert Fallback Profile . The Insert Fallback Profile Configuration window
                                       			 displays. |
|---|---|
...
| Step 1 | Choose Bulk
                                             				  Administration > Intercompany Media
                                             				  Services > Fallback Profile > Delete
                                             				  Fallback Profile . The Delete Fallback Profile Configuration window
                                       			 displays. |
|---|---|
| Step 2 | From the Delete Fallback Profile where Name in custom
                                          				file drop-down list box, choose the filename of the custom file for
                                       			 this delete, and click Find . The Fallback Profile matching your search criteria
                                       			 displays. |
