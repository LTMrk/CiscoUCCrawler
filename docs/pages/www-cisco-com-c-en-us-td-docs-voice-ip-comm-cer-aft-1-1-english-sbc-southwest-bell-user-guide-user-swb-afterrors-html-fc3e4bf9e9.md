---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cer-aft-1-1-english-sbc-southwest-bell-user-guide-user-swb-afterrors-html-fc3e4bf9e9
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cer/aft/1_1/english/sbc_southwest_bell/user/guide/user_swb/AFTerrors.html
retrieved_at: 2026-08-21T15:50:04.389073+00:00
---
...
Q. In my Cisco Emergency Responder (Cisco ER) setup, I have a set of ELINs that I bought from SBC Southwestern Bell and another set of ELINs that I bought from Sprint. I have configured these ELINs in Cisco ER. I did an ALI export and exported the ELINs to a single file. How will I send this ELIN file separately to SBC Southwestern Bell and Sprint?

A. You can use AFT to accomplish this task. Perform the following steps:

Step 1 Download the AFT for SBC Southwestern Bell and download the AFT for Sprint from CCO and install them on your Cisco ER server.

Step 2 Give the ALI file exported from Cisco ER as input to the SBC Southwestern Bell AFT.

Step 3 Perform the necessary formatting selectively for the SBC Southwestern Bell ELINs:

Step 4 Use the SBC Southwestern Bell Area Code which is different from the Sprint area code. Send this file of the SBC Southwestern Bell ELINs to SBC Southwestern Bell.
