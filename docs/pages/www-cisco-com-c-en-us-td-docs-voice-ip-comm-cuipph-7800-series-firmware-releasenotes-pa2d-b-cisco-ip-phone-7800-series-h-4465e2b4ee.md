---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-7800-series-firmware-releasenotes-pa2d-b-cisco-ip-phone-7800-series-h-4465e2b4ee
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/7800-series/firmware/releasenotes/pa2d_b_cisco-ip-phone-7800-series.html
retrieved_at: 2026-08-21T13:24:37.116672+00:00
---

Cisco IP Phone 7800 Series Release Notes for Firmware Release 11.5(1)
...
#### Disable Recents Softkey

Recents is enabled by default.
...
The phones now support the Opus audio codec, which offers an improved, higher-quality audio for voice calls. Opus is supported
                           on Cisco Unified Communications Manager version 11.0(1) and later.
...
The phones support Federal Information processing standard (FIPS) 140-2 level 1, which requires server certificates to be
                           2048 bits or greater. The certificates ensure secure communications between the Cisco Unified Communications Manager (Unified
                           CM) and the phone.

Phones with certificates less than 2048 bits cannot register with Unified CM.

FIPS mode is enabled from the Product Specific Configuration Layout portion of the Device
...
Before using the
                        		  Cisco Unified IP Phone Firmware Release 11.5(1) with Cisco Unified
...
- cmterm-78xx.11-5-1-18.k3.cop.sgn
...
Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=11.5%281%29&sb=anfr&bt=custV

Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=11.5%281%29&sb=afr&bt=custV

Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=11.5%281%29&sb=fr&bt=custV
...
| Step 6 | Select the following firmware file, click the Download or Add to
                                    				cart button, and follow the prompts: cmterm-78xx.11-5-1-18.k3.cop.sgn Note If you added
                                                				  the firmware file to the cart, click the Download Cart link when you are ready to download
...
| Step 1 | Perform one of
                              			 the following actions: Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=11.5%281%29&sb=anfr&bt=custV Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=11.5%281%29&sb=afr&bt=custV Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=11.5%281%29&sb=fr&bt=custV |
|---|---|
