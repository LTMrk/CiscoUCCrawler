---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cusrst-release-notes-srst-releasenotes-12-8-html-ee07e57fff
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cusrst/release/notes/SRST_ReleaseNotes_12_8.html
retrieved_at: 2026-08-21T21:28:48.176101+00:00
---

Release Notes for Cisco Unified Survivable Remote Site Telephony, 12.8

# Release Notes for Cisco Unified Survivable Remote Site Telephony, 12.8

## Table of Contents

Release Notes for Cisco Unified Survivable Remote Site Telephony, Release 12.8
...
New Features in Unified SRST, Release 12.8

Support for Voice VRF for Unified SRST

Support for YANG Models in Unified SRST

Caveats

Open Caveats—Unified SRST, Release 12.8
...
This Release Notes document describes the features of Cisco Unified Survivable Remote Site Telephony, Release 12.8 (Cisco IOS XE Amsterdam 17.2.1r).
...
The Cisco 4000 Series Integrated Services Router platforms require 4 GB of DRAM, except Cisco ISR 4461 that requires 8 GB of DRAM.
...
Cisco IOS XE Software, Version Cisco IOS XE 17.2.1r

Cisco IOS Software, ISR Software (X86_64_LINUX_IOSD-UNIVERSALK9-M),

Copyright (c) 1986-2020 by Cisco Systems, Inc.

Compiled Fri 06-Dec-19 01:12.
...
Support for Virtual Routing and Forwarding (VRF) for Unified SRST with Cisco IOS XE is being introduced from Unified SRST, Release 12.8. For more information, see Cisco Unified SCCP and SIP SRST System Administrator Guide (All Versions) .

### Support for YANG Models in Unified SRST

Support for YANG Models in Unified SRST is being introduced from Unified SRST, Release 12.8. For more details, see the UC YANG Data Models for IOS XE on Cisco DevNet .
...
There are no open or unresolved caveats in Unified SRST, 12.8 Release.
