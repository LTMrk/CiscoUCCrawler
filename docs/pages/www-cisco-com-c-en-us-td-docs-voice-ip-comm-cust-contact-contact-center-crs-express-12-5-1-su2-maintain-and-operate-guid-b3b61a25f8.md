---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-crs-express-12-5-1-su2-maintain-and-operate-guid-b3b61a25f8
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/crs/express_12_5_1_su2/maintain_and_operate/guide/uccx_b_1251su2_admin-and-operations-guide/uccx_b_12_5_2admin-and-operations-guide_chapter_011101.html
retrieved_at: 2026-08-16T21:35:42.912096+00:00
---
...
To use any version of Unified Communications Manager , you must first ensure that you define Unified Communications Manager users as Unified CCX agents in Unified Communications Manager . After you perform this task, these Unified CCX agents can be combined into Resource Groups, assigned Skills, and placed
                                 in CSQs.
...
To assign devices to an application user, you must access the Application User Configuration window for that user. The Application
                                 User Configuration window in Unified Communications Manager Administration allows the administrator to add, search, display, and maintain information about Unified Communications Manager application users.
...
If you change or update an end user ID in Unified Communications Manager, Unified CCX resets the end user's resource name,
                                             skills, and team to default values.
...
| Note | In Unified CCX, this operation is called "associating a device." Be sure to assign Unified CCX devices to both end users and application users in the Unified Communications Manager web interface. |
|---|---|
...
| Note | If you change or update an end user ID in Unified Communications Manager, Unified CCX resets the end user's resource name,
                                             skills, and team to default values. |
|---|---|
