---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-7800-series-3pcc-11-0-0-english-release-notes-pa2d-b-7800-mpp-1101-ht-14cd56591a
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/7800-series/3pcc/11-0-0/english/release-notes/pa2d_b_7800-mpp-1101.html
retrieved_at: 2026-08-21T13:25:15.017799+00:00
---

Cisco IP Phone 7800 Series Multiplatform Phones Release Notes for Firmware Release 11.0(0)
...
The buttons on the left and right of the phone screen can be set up as line buttons, giving up to eight more line keys. You can also configure up to ten calls per line.
...
http://10.74.10.225/firmware/sip78xx.11-0-0MPP-7dev.loads
...
phone's switch not change Cos value after extended Cos changes

CSCvc97003

Changes in NTP time during a call could cause abnormal values in rtcp reports.
...
| Step 6 | Download the file cmterm-78xx.11-0-0MPP-7.zip . |
...
| Identifier | Headline |
|---|---|
| CSCvb83904 | phone's switch not change Cos value after extended Cos changes |
| CSCvc97003 | Changes in NTP time during a call could cause abnormal values in rtcp reports. |
