---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-connection-12x-integration-guide-pimg-b-12xcucintpimg-b-12xcucintpimg-chapte-9c0f89ef40
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/integration/guide/pimg/b_12xcucintpimg/b_12xcucintpimg_chapter_01000.html
retrieved_at: 2026-08-16T18:44:19.418787+00:00
---
...
Chapter: Setting Up an NEC
	 NEAX 2400 Digital PIMG Integration with Cisco Unity Connection
...
Setting Up an NEC NEAX 2400 Digital PIMG Integration

## Task List for NEC
                        	 NEAX 2400 PIMG Phone System Integration

Before doing the following tasks to integrate Unity Connection
                           		with the NEC NEAX 2400 phone system using PIMG units (media gateways), confirm
...
Program the NEC NEAX 2400 phone system and extensions. See the “Programming
                                    				NEC NEAX 2400 PIMG Phone System Integration” section.

Set up the PIMG units. See the “Setting
                                    				Up Digital PIMG Units” section.

Create the integration. See the Configuring Unity Connection for Integration with NEC NEAX 2400 Phone System section.
...
## Programming NEC NEAX 2400 PIMG Phone System Integration
...
Do the following steps to program the NEC NEAX
                              		  2400 phone system using Command Line Interface

Sign in to the NEC NEAX 2400 administration
                                       			 terminal and go to the Maintenance Command Menu page.

On the Maintenance Command Menu page, enter 14 (Installation).

On the Installation Menu page, enter 3 (ASYD) to assign
                                       			 system data.
...
On the Maintenance Command Menu page, enter 6 (Station Data).

On the Station Data Commands page, enter 3 (ASTN) to assign the
                                       			 station numbers for the voice messaging ports.

On the Station Number Assignment page, enter
                                       			 the extension for the first port that connects to the PIMG unit.

Confirm that the station number (extension)
                                          				is not already assigned. Otherwise, the integration cannot function correctly.

On the Station Data Commands page, enter 2 (ASCL).

On the Station Class Data page, assign the
                                       			 applicable station class information to the voice messaging port.

On the Station Data Commands page, enter 1 (ASDT).

On the Station Data page, in the LENS field,
                                       			 enter the applicable line equipment number for the voice messaging port.

On the Station Data Commands page, enter 5 (AKYD).

On the Key Data page, select Assignment/Change and
                                       			 press Enter .

On the Assignment of Key Data page, enter
                                       			 the following settings to enable the PRIMARY APPEARANCE function on Key 1.
...
Press Esc to move to the next
                                       			 operation.

Enter the following settings to enable the
                                       			 MWL SET function on Key 5.
...
On the Maintenance Command Menu page, enter 13 (Restriction Data).

On the Restriction Data Commands page, enter 2 (ASFC).

On the Service Feature Assignment page,
                                       			 enter the following settings.
...
Program each phone to forward calls to the
                                       			 ...
                                       			 Connection call transfer types shown in Table 9-6 .
...
Enter the numbers of the PIMG ports
                                                         						  that MWIs. For example, enter “*” for all PIMG ports, or enter “7,8” for the
                                                         						  last two PIMG ports.
...
On the Digital Telephony page, in the
                                          			 Telephony Switch Type field, select NEC_NEAX.
...
## Configuring Unity
                        	 Connection for Integration with NEC NEAX 2400 Phone System

After ensuring that the NEC NEAX 2400 phone system, the PIMG units, and
...
| Step 1 | Sign in to the NEC NEAX 2400 administration
                                       			 terminal and go to the Maintenance Command Menu page. |
|---|---|
| Step 2 | On the Maintenance Command Menu page, enter 14 (Installation). |
| Step 3 | On the Installation Menu page, enter 3 (ASYD) to assign
                                       			 system data. |
| Step 4 | Enter the following settings. Table 1. Assignment of System Data
                                                				Settings Field Setting Sys Enter 1 . Index Enter 78 . Data Enter 0B . | Field | Setting | Sys | Enter 1 . | Index | Enter 78 . | Data | Enter 0B . |
| Field | Setting |
| Sys | Enter 1 . |
| Index | Enter 78 . |
| Data | Enter 0B . |
| Step 5 | On the Maintenance Command Menu page, enter 6 (Station Data). |
| Step 6 | On the Station Data Commands page, enter 3 (ASTN) to assign the
                                       			 station numbers for the voice messaging ports. |
| Step 7 | On the Station Number Assignment page, enter
                                       			 the extension for the first port that connects to the PIMG unit. Confirm that the station number (extension)
                                          				is not already assigned. Otherwise, the integration cannot function correctly. |
| Step 8 | On the Station Data Commands page, enter 2 (ASCL). |
| Step 9 | On the Station Class Data page, assign the
                                       			 applicable station class information to the voice messaging port. |
| Step 10 | On the Station Data Commands page, enter 1 (ASDT). |
| Step 11 | On the Station Data page, in the LENS field,
                                       			 enter the applicable line equipment number for the voice messaging port. |
| Step 12 | On the Station Data Commands page, enter 5 (AKYD). |
| Step 13 | On the Key Data page, select Assignment/Change and
                                       			 press Enter . |
| Step 14 | On the Assignment of Key Data page, enter
                                       			 the following settings to enable the PRIMARY APPEARANCE function on Key 1. Table 2. Assignment of Key Data Settings for Key
                                                				1 Field Setting KYN Enter 1 . KYI Enter 2 . | Field | Setting | KYN | Enter 1 . | KYI | Enter 2 . |
| Field | Setting |
| KYN | Enter 1 . |
| KYI | Enter 2 . |
| Step 15 | Press Esc to move to the next
                                       			 operation. |
| Step 16 | Enter the following settings to enable the
                                       			 MWL SET function on Key 5. Table 3. Assignment of Key Data Settings for Key
                                                				5 Field Setting KYN Enter 5 . FKI Enter 9 . | Field | Setting | KYN | Enter 5 . | FKI | Enter 9 . |
| Field | Setting |
| KYN | Enter 5 . |
| FKI | Enter 9 . |
| Step 17 | Press Esc to move to the next
                                       			 operation. |
| Step 18 | Enter the following settings to enable the
                                       			 MWL CNCL function on Key 6. Table 4. Assignment of Key Data Settings for Key
                                                				6 Field Setting KYN Enter 6 . FKY Enter 11 . | Field | Setting | KYN | Enter 6 . | FKY | Enter 11 . |
| Field | Setting |
| KYN | Enter 6 . |
| FKY | Enter 11 . |
...
| Step 21 | On the Service Feature Assignment page,
                                       			 enter the following settings. Table 5. Service Feature Assignment
                                                				Settings Field Setting TN:1 Enter SFI:74 . TN:1 Enter SFI:82 . | Field | Setting | TN:1 | Enter SFI:74 . | TN:1 | Enter SFI:82 . |
| Field | Setting |
| TN:1 | Enter SFI:74 . |
| TN:1 | Enter SFI:82 . |
| Step 22 | Program each phone to forward calls to the
                                       			 pilot number assigned to the voice messaging ports, based on one of the Unity
                                       			 Connection call transfer types shown in Table 9-6 . Table 6. Call Transfer Types Transfer Type Usage Release transfer (blind transfer) Program the phone to forward calls
...
| Step 4 | To sign in, enter the following
                                          			 case-sensitive settings. Table 7. Sign-in Settings Field Setting Username Enter admin . Password Enter IpodAdmin . | Field | Setting | Username | Enter admin . | Password | Enter IpodAdmin . |
| Field | Setting |
...
| Step 24 | On the Change Password page, enter the
                                          			 following settings. Table 10. Change Password Page Settings Field Setting Old Password Enter IpodAdmin . (This setting is
...
| Step 28 | Under VoIP Host Groups, enter the following
                                          			 settings for the first VoIP Host Group. Table 11. First VoIP Host Group Settings Field Settings Name Accept the default or enter another
...
| Step 35 | Under TDM Trunk Groups, enter the following
                                          			 settings for the first TDM trunk group. Table 12. First TDM Trunk Group Settings (Inbound
...
| Step 37 | Enter the following settings for the second
                                          			 TDM trunk group. Table 13. Second TDM Trunk Group Settings
                                                   				(MWIs) Field Settings Name Enter MWIs or another unique name. This TDM trunk group handles
                                                         						  ...
                                                         						  that MWIs. For example, enter “*” for all PIMG ports, or enter “7,8” for the
                                                         						  last two PIMG ports. | Field | Settings | Name | Enter MWIs or another unique name. This TDM trunk group handles
                                                         						  outbound MWI calls (where applicable). | Selection Direction | Select Ascending . | Selection Mode | Select Cyclic . | Port/Channel Content | Enter the numbers of the PIMG ports
                                                         						  that MWIs. For example, enter “*” for all PIMG ports, or enter “7,8” for the
                                                         						  last two PIMG ports. |
| Field | Settings |
...
| Step 39 | Enter the following settings for the third
                                          			 TDM trunk group. Table 14. Third TDM Trunk Group Settings (Outbound
...
| Step 44 | Under Inbound VoIP Rules, enter the
                                          			 following settings for the first new inbound VoIP rule. Table 15. First New Inbound VoIP Rule Settings
...
| Step 45 | Under Inbound VoIP Request Matching, enter
                                          			 the following settings. The rule that you created in Step 44 must be selected.
                                             				Otherwise, any changes you make apply to another inbound VoIP rule. Table 16. Inbound VoIP Request Matching
...
| Step 46 | Under Outbound Routes, enter the following
                                          			 settings. The rule that you created in Step 44 must be selected.
                                             				Otherwise, any changes you make apply to another rule. Table 17. Outbound Routes Settings Field Settings Device
...
| Step 48 | Under Inbound VoIP Rules, enter the
                                          			 following settings for the second new inbound VoIP rule. Table 18. Second New Inbound VoIP Rule Settings
...
| Step 49 | Under Inbound VoIP Request Matching, enter
                                          			 the following settings. The rule that you created in Step 48 must be selected.
                                             				Otherwise, any changes you make apply to another rule. Table 19. Inbound VoIP Request Matching
                                                   				Settings Field Settings Calling Number Enter * . Calling Name Enter * . Called Number Enter * . Called Name Enter * . Redirect Number Enter * . Redirect Name Enter * . | Field | Settings | Calling Number | Enter * . | Calling Name | Enter * . | Called Number | Enter * . | Called Name | Enter * . | Redirect Number | Enter * . | Redirect Name | Enter * . |
| Field | Settings |
| Calling Number | Enter * . |
| Calling Name | Enter * . |
...
| Step 50 | Under Outbound Routes, enter the following
                                          			 settings. The rule that you created in Step 48 must be selected.
                                             				Otherwise, any changes you make apply to another rule. Table 20. Outbound Routes Settings Field Settings Device
                                                            							 Selection Outbound Destination Select TDM . Trunk Group Select the name of the TDM trunk
                                                         						  group that you created for outbound calls in Step 39 . For example, select
...
| Step 53 | Under Inbound TDM Rules, enter the following
                                          			 settings for the first inbound TDM rule. Table 21. First Inbound TDM Rule Settings Field Settings Enable Check this check box. Rule Label Enter Inbound_Rule_1 or another
...
| Step 54 | Under Inbound TDM Request Matching, enter
                                          			 the following settings. The rule that you created in Step 53 must be selected.
                                             				Otherwise, any changes you make apply to another rule. Table 22. Inbound TDM Request Matching
...
| Step 63 | On the TDM General Settings page, enter the
                                          			 following settings. Table 24. TDM General Settings Page
...
| Step 70 | On the VoIP General Settings page, enter the
                                          			 following settings. Table 25. VoIP General Settings Page
...
| Step 73 | On the VoIP Media Settings page, enter the
                                          			 following settings. Table 26. VoIP Media Settings Page
...
| Step 76 | On the VoIP QOS Configuration page, enter
                                          			 the following settings. Table 27. VoIP QOS Configurative Page
...
| Step 79 | On the IP Settings page, enter the following
                                          			 settings. Table 28. IP Settings Page Settings Field Settings Client IP Address Enter the new IP address you want to
