---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-jvdi-12-5-jvdi-b-release-notes-jvdi-hp-ubuntu-12-5-html-4755f62c85
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/jvdi/12_5/jvdi_b_release-notes-jvdi-hp-ubuntu-12-5.html
retrieved_at: 2026-09-01T18:02:19.879939+00:00
---

Release Notes for Cisco Jabber Softphone for VDI—HP Thin Pro and Ubuntu Release 12.5
...
These release notes describe new features, requirements, restrictions, and caveats for Cisco Jabber Softphone for VDI for HP Thin Pro and Ubuntu Release 12.5. These release notes are updated for every maintenance release but not for patches
                  or hot fixes.
...
Updated System Requirements to include the HP t520.
...
Cisco Jabber Softphone for VDI for HP Thin Pro and Ubuntu Release 12.5 adds support for the following programs and features:
...
From Cisco Jabber Softphone for VDI —HP Thin Pro and Ubuntu Release 12.0 to Cisco Jabber Softphone for VDI —Thin Pro and Ubuntu Release 12.5

From Cisco Jabber Softphone for VDI —HP Thin Pro and Ubuntu Release 12.1 to Cisco Jabber Softphone for VDI —Thin Pro and Ubuntu Release 12.5
...
There are no closed caveats (bugs) for Cisco Jabber Softphone for VDI—HP Thin Pro and Ubuntu  Release 12.5.
...
when jabber video is moved around in windows,video gets out of sync only when self-view is enabled
...
| Date | Description |
|---|---|
| December 6, 2018 | Updated System Requirements to include the HP t520. |
...
|---|---|---|
| CSCvn03165 | 3 | when jabber video is moved around in windows,video gets out of sync only when self-view is enabled |
