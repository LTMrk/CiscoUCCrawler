...
## Surviveable Remote Site Telephony
...
For information on SRST, see http://www.cisco.com/c/en/us/support/unified-communications/unified-survivable-remote-site-telephony/tsd-products-support-series-home.html
...
| PickUp | No | The softkey does not display. |
| Group PickUp | No | The softkey does not display. |
| Other PickUp | No | The softkey does not display. |
| Malicious Call ID | No | The softkey does not display. |
| QRT | No | The softkey does not display. |
