---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-pcce-pcce-12-5-1-maintenance-guide-pcce-b-report-a1e349a5b6
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/pcce/pcce_12_5_1/maintenance/guide/pcce_b_Reporting-User-Guide-12-5/pcce_b_cisco-packaged-contact-center-enterprise_chapter_010111.html
retrieved_at: 2026-08-21T16:58:55.531985+00:00
---
...
The Call icon: To call directly click Call.

Edit and Call icon: When you click on Edit and Call icon the dial pad is populated with the contact number of the customer from the number field. Click Call, the call is initiated.
                                             You can also edit the number before making a call.

Note : The call is connected to the customer only if your system has the required outbound call settings.
...
| Duration | The
                                             						duration of the call in seconds. |
| Actions | The Call icon: To call directly click Call. Edit and Call icon: When you click on Edit and Call icon the dial pad is populated with the contact number of the customer from the number field. Click Call, the call is initiated.
                                             You can also edit the number before making a call. Note : The call is connected to the customer only if your system has the required outbound call settings. |
