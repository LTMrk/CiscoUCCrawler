...
Sets up the maximum number of contacts that display in a directory.
...
The phone only displays distinct contacts. If there're duplicated contacts in the directories, the number of displayed contacts
                                             might be less than the configured value.

Value range: 50 to 999

Default: 50

When phone is onboarded to Webex cloud successfully and Webex directory service is enabled on the it, and if you configure Max Display Records parameter value more than 100, the query result displays only hundred contacts for a search in Webex directory and All directory.
                                                         When search result has count more than the allowed display record value, user see a message: Too many matches found.Refine your search .

Max Display Records parameter is not available in Cisco IP Multiplatform Phone 7811.
...
| Max Display Records | Sets up the maximum number of contacts that display in a directory. Perform one of the following: In the phone configuration file with XML(cfg.xml), enter a string in this format: <Max_Display_Records ua="na">50</Max_Display_Records> In the phone web page, enter an appropriate value. The phone only displays distinct contacts. If there're duplicated contacts in the directories, the number of displayed contacts
                                             might be less than the configured value. Note The Cisco IP Phone 7811 Multiplatform Phones doesn't support the parameter. Value range: 50 to 999 Default: 50 Note When phone is onboarded to Webex cloud successfully and Webex directory service is enabled on the it, and if you configure Max Display Records parameter value more than 100, the query result displays only hundred contacts for a search in Webex directory and All directory.
                                                         When search result has count more than the allowed display record value, user see a message: Too many matches found.Refine your search . Note Max Display Records parameter is not available in Cisco IP Multiplatform Phone 7811. | Note | The Cisco IP Phone 7811 Multiplatform Phones doesn't support the parameter. | Note | When phone is onboarded to Webex cloud successfully and Webex directory service is enabled on the it, and if you configure Max Display Records parameter value more than 100, the query result displays only hundred contacts for a search in Webex directory and All directory.
                                                         When search result has count more than the allowed display record value, user see a message: Too many matches found.Refine your search . | Note | Max Display Records parameter is not available in Cisco IP Multiplatform Phone 7811. |
| Note | The Cisco IP Phone 7811 Multiplatform Phones doesn't support the parameter. |
| Note | When phone is onboarded to Webex cloud successfully and Webex directory service is enabled on the it, and if you configure Max Display Records parameter value more than 100, the query result displays only hundred contacts for a search in Webex directory and All directory.
                                                         When search result has count more than the allowed display record value, user see a message: Too many matches found.Refine your search . |
| Note | Max Display Records parameter is not available in Cisco IP Multiplatform Phone 7811. |
