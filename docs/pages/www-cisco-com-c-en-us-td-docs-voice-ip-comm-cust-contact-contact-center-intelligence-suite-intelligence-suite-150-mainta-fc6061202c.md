---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-intelligence-suite-intelligence-suite-150-mainta-fc6061202c
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/intelligence_suite/intelligence_suite_150/maintain_and_operate/guide/cuic_b_150_admin-console-user-guide/cluster_config_drawer.html
retrieved_at: 2026-08-21T04:32:24.452770+00:00
---
...
Configure Active Directory for the CCE supervisors so that they can sign in as Unified Intelligence Center Reporting users.
...
The Unified CCE User Integration feature imports supervisors and their teams from CCE via the CCE Configuration Manager and database into Unified Intelligence Center.
...
After upgrading to Cisco Unified Intelligence Center 15.0(1) , perform the User Integration operation (Cluster Configuration > UCCE User Integration) manually to import the Supervisors
...
The User Integration feature facilitates the automatic import of reporting supervisors who are added or modified in CCE Configuration Manager and stored in the CCE/CCH database.
...
| Note | After upgrading to Cisco Unified Intelligence Center 15.0(1) , perform the User Integration operation (Cluster Configuration > UCCE User Integration) manually to import the Supervisors
