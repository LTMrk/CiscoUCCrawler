---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-8821-firmware-11-0-6-sr5-w881-b-wireless-8821-rln-1106sr5-html-aca46eb335
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/8821/firmware/11-0-6-SR5/w881-b-wireless-8821-rln-1106sr5.html
retrieved_at: 2026-08-21T13:34:31.616569+00:00
---

Cisco Wireless IP Phone 8821 and 8821-EX Release Notes for Firmware Release 11.0(6)SR5
...
These release notes support the 11.0(6)SR5 firmware release for the Cisco Wireless IP Phone 8821 and 8821-EX .
...
### Install Firmware Release 11.0(6)SR5 on Cisco Unified
                     				Communications Manager
...
From the Latest Releases folder, click 11.0(6)SR5 .

Step 5

Click either Download or Add to Cart next to the firmware file, and follow the prompts.

Firmware file: cmterm-8821-sip.11-0-6SR5-5.k4.cop.sha512
...
Zip file: cmterm-8821.11-0-6SR5-5.zip
...
Click the following links to view bugs for the 11.0(6)SR5 release of the Cisco Wireless IP Phone 8821 and 8821-EX :
...
The following list contains a snapshot of the severity 1, 2, and 3 bugs that were open at the time of the Cisco Wireless IP Phone 8821 and 8821-EX Firmware Release 11.0(6)SR5.
...
The following list contains a snapshot of the severity 1, 2, and 3 bugs that were resolved at the time of the Cisco Wireless IP Phone 8821 and 8821-EX Firmware Release 11.0(6)SR5.
...
8821:XML parse error caused by UnsupportedEncodingException.

CSCwe09200

8821:roaming: after re-association phone does not ignore deauth code 8 sent by 91xx AX APs.

CSCwf62223

Paging audio cannot be heard from the loudspeaker due to random audio path switching.
...
| Step 3 | Click Session Initiation Protocol (SIP) Software . |
| Step 4 | From the Latest Releases folder, click 11.0(6)SR5 . |
| Step 5 | Click Download or Add to Cart next to the following zip file and follow the prompts. Zip file: cmterm-8821.11-0-6SR5-5.zip |
| Step 6 | Extract the files from the zip file, manually copy them to the Cisco Unified
                                    				Communications Manager Express TFTP server (router flash), and enable them for TFTP. |

| Step 1 | Click the following links to view bugs for the 11.0(6)SR5 release of the Cisco Wireless IP Phone 8821 and 8821-EX : View all bugs . View open bugs . View resolved bugs . |
|---|---|
...
| Bug number | Description |
|---|---|
| CSCwe95522 | 8821:XML parse error caused by UnsupportedEncodingException. |
| CSCwe09200 | 8821:roaming: after re-association phone does not ignore deauth code 8 sent by 91xx AX APs. |
| CSCwf62223 | Paging audio cannot be heard from the loudspeaker due to random audio path switching. |
