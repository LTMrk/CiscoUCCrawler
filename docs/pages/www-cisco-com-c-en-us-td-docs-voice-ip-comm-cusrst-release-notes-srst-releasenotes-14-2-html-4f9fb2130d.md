...
Release Notes for Cisco Unified Survivable Remote Site Telephony, Release 14.2
...
New Features in Unified SRST, Release 14.2

Caveats

Open Caveats—Unified SRST, Release 14.2
...
This Release Notes document describes the features of Cisco Unified Survivable Remote Site Telephony, Release 14.2. The Cisco Unified Survivable Remote Site Telephony, Release 14.2 is included in Cisco IOS XE Cupertino 17.8.1a and later releases.
...
Cisco IOS XE Software, Version Cisco IOS XE Cupertino 17.8.1a

Cisco IOS Software, ISR Software (X86_64_LINUX_IOSD-UNIVERSALK9-M),

Copyright (c) 1986-2022 by Cisco Systems, Inc.

Compiled Fri 7-Jan-22 01:12.
...
- From Unified SRST Release 14.2, Unified SRST for SIP and SCCP may be configured to only allow SHA2 TLS1.2 ciphers. For more information, see Cisco Unified SCCP and SIP SRST System Administrator Guide (All Versions) .

- From Unified SRST Release 14.2, SIP clients that use token-based authentication can register to Unified SRST during a WAN outage. For more information, see Cisco Unified SCCP and SIP SRST System Administrator Guide (All Versions) .
...
There are no open or unresolved caveats for Unified SRST, 14.2 Release.
