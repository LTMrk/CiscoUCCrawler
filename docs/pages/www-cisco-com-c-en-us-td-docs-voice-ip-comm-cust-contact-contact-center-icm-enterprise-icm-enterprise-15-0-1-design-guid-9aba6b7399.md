---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-15-0-1-design-guid-9aba6b7399
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_15_0_1/design/guide/ucce_b_ucce_soldg-for-unified-cce-1501/rcct_m_configuration-limits-and-feature-availability-15-0.html
retrieved_at: 2026-08-16T19:50:01.728147+00:00
---
...
For information about configuration limits with 36000 agents, see Scale up to 36000 Agents .
...
Maximum reserved and active tasks per agent 17
...
Maximum incoming tasks/sec across all MRDs 18
...
Maximum reserved and active tasks per agent 19
...
The DR API service enhances the limit of tasks that can be queued in the Digital Routing service memory to be 100,000. However,
                                 ...
                                 the channel on which the request was received. For more information on Queue Settings, see the Configure queue settings section in the Cisco Unified Contact Center Enterprise Features Guide .
...
Dialed Numbers on each CVP peripheral (External Voice and Post Call Survey ) 20
...
VRU Ports in a Reference Layout 21 22
...
Maximum VRU Ports with Added PGs 23
...
Maximum Inbound CPS per VRU PG 25
...
ECE Email or Chat requests per hour for 1500 agent deployment 27
...
Configured Schedule Objects per Business Hours Object 29
...
Persistent Enabled Expanded Call Variables (Default) 30
...
Maximum System-wide ECC Variable Contents (bytes) 31
...
Maximum Agent PGs with Live Data, Precision Queueing, or Single Sign-On enabled 32
...
24 (when using the Extra Large Live Data OVA)
...
Maximum Cisco Finesse server pairs per PG pair 35
...
Call Type Skill Group per Interval 36
...
These other call flows are only allowed in Non-Reference Design solutions.
...
VRU only—VRU, switching for PSTN endpoints
...
"Multicast with Unified CM subscriber source only" is only supported in non-Reference Designs.
...
Instead of using CCCSP , some deployments can achieve High Availability (HA) and load balancing using these solution components:
...
You can use SIP over Media Gateway Control Protocol (MGCP) only in Non-Reference Designs. You can use SIP over UDP only for the Outbound Dialer.
...
The following are supported only in Non-Reference Designs:
...
| Maximum reserved and active tasks per agent 17 | 15 | 15 | 15 | 15 | NA |
| Maximum incoming tasks/sec across all MRDs 18 | 5 | 5 | 5 | 5 | NA |
...
| Maximum reserved and active tasks per agent 19 | 15 | 15 | 15 | 15 | 15 |
...
| Resource | 2000 Agent Reference Design Model | 4000 Agent Reference Design Model | 12000 Agent Reference Design Model | 24000 Agent Reference Design Model | Contact Director Reference Design Model |
|---|---|---|---|---|---|
| Dialed Numbers on each CVP peripheral (External Voice and Post Call Survey ) 20 | 4000 | 4000 | 12,000 | 12,000 | 12,000 |
...
| Resource | 2000 Agent Reference Design Model | 4000 Agent Reference Design Model | 12000 Agent Reference Design Model | 24000 Agent Reference Design Model | Contact Director Reference Design Model |
|---|---|---|---|---|---|
| VRU Ports in a Reference Layout 21 22 | 3000 | 6000 | 18,000 | 36,000 | 36,000 |
| Maximum VRU Ports with Added PGs 23 | 6000 | 12,000 | 36,000 | 48,000 | 72,000 |
| Maximum Inbound Calls per Second (CPS) | 15 | 30 | 90 | 90 | 300 |
| Congestion Control CPS 24 | 18 | 35 | 105 | 105 | 300 |
| Maximum Inbound CPS per VRU PG 25 | 15 | 15 | 15 | 15 | NA |
| Maximum VRU PIM per VRU PG | 2 | 2 | 2 | 2 | NA |
| Dynamic Reskilling (operations/hr.) | 7200 | 7200 | 7200 | 7200 | NA |
| Maximum Queued Calls and Tasks | 15,000 | 15,000 | 15,000 | 15,000 26 | 15,000 |
...
| ECE Email or Chat requests per hour for 1500 agent deployment 27 | 6 per agent | 6 per agent | 6 per agent | 6 per agent | NA |
...
| Maximum rows per report 28 | 3000 for real-time 8000 for historical | 3000 for real-time 8000 for historical | 3000 for real-time 8000 for historical | 3000 for real-time 8000 for historical | NA |
| Configured Business Hour Objects | 1000 | 1000 | 1000 | 1000 | 1000 |
| Configured Schedule Objects per Business Hours Object 29 | 50 | 50 | 50 | 50 | 50 |

| Resource | 2000 Agent Reference Design Model | 4000 Agent Reference Design Model | 12000 Agent Reference Design Model | 24000 Agent Reference Design Model | Contact Director Reference Design Model |
|---|---|---|---|---|---|
| Persistent Enabled Expanded Call Variables (Default) 30 | 5 | 5 | 5 | 5 | 5 |
...
| Maximum System-wide ECC Variable Contents (bytes) 31 | 90,000,000 | 90,000,000 | 90,000,000 | 90,000,000 | NA |
| Number of Peripheral Variables | 10 | 10 | 10 | 10 | 10 |
| Call Context for Peripheral Variables 1-10 (bytes) | 40 | 40 | 40 | 40 | 40 |

| Resource | 2000 Agent Reference Design Model | 4000 Agent Reference Design Model | 12000 Agent Reference Design Model | 24000 Agent Reference Design Model | Contact Director Reference Design Model |
|---|---|---|---|---|---|
| Maximum Agent PGs with Live Data, Precision Queueing, or Single Sign-On enabled 32 | 4 33 | 4 | 12 24 (when using the Extra Large Live Data OVA) | 24 | 50 |
| Maximum PGs 34 | 30 | 100 | 150 | 150 | NA |
| Maximum Agent PGs on each VM | 1 | 1 | 1 | 1 | NA |
| Maximum Cisco Finesse server pairs per PG pair 35 | 2 | 2 | 2 | 2 | NA |
...
| Call Type Skill Group per Interval 36 | 70,000 | 70,000 | 70,000 | 70,000 | NA |
...
| Not-ready Reason Codes | 100 global codes 100 associated reason codes for each team | 100 global codes 100 associated reason codes for each team | 100 global codes 100 associated reason codes for each team | 100 global codes 100 associated reason codes for each team | NA |
| Sign-out Reason Codes | 100 global codes 100 associated reason codes for each team | 100 global codes 100 associated reason codes for each team | 100 global codes 100 associated reason codes for each team | 100 global codes 100 associated reason codes for each team | NA |
| Wrap-up Reason labels 37 | 100 global labels 1500 team labels | 100 global labels 1500 team labels | 100 global labels 1500 team labels | 100 global labels 1500 team labels | NA |
| Administration Bulk Jobs 38 | 200 | 200 | 200 | 200 | NA |
| CTI AllEventClients 39 | 7/Medium PG 20/Large PG 40 | 7/Medium PG 20/Large PG 41 | 7/Medium PG 20/Large PG 42 | 7/Medium PG 20/Large PG | NA |
...
| Call Flows | Post-route by CVP Comprehensive call flow: Inbound and outbound calls Supplementary services Hold and resume Blind, consult, and refer transfers
                                                      												and conferences Router requery | These other call flows are only allowed in Non-Reference Design solutions. Pre-route call flows Translation Routes Unified CVP VXML Server (standalone) Call Director—IP switching VRU only—VRU, switching for PSTN endpoints |
| Outbound
                                          					 campaigns | Cisco
...
| Music on
                                          					 ...
                                          					 using voice gateway | "Multicast with Unified CM subscriber source only" is only supported in non-Reference Designs. |
| Proxy / CCCSP | SIP Proxy
                                          					 is an optional component. | Instead of using CCCSP , some deployments can achieve High Availability (HA) and load balancing using these solution components: Time
                                                						  Division Multiplexing (TDM) gateway and Unified CM, which use the SIP Options
...
| Protocol | Session
                                          					 ...
                                          					 to SIP signaling | Contact center enterprise solutions do
                                          								not support H.323. You can use SIP over Media Gateway Control Protocol (MGCP) only in Non-Reference Designs. You can use SIP over UDP only for the Outbound Dialer. From the Outbound Option SIP Dialer to
                                          								the egress gateway has to use UDP. |
...
| Capability | Supported | Notes |
|---|---|---|
| Core Component Provisioning | Gateways - CLI Unified CVP - Web-based operation console Unified CCE - Web-based administration and thick client configuration tools Unified CCMP for Unified CCE solutions Cisco VVB - Web-based operation console Unified CM - Web-based administration Cisco Finesse - Web-based administration Unified Intelligence Center - Web-based administration | For provisioning, Packaged CCE does not support CCMP or CCDM. |
| Service
...
| Voice
                                          					 ...
                                          					 CVP Comprehensive Model Type 10 | The following are supported only in Non-Reference Designs: All other Unified CVP VRU types Cisco Unified IP IVR Third-party VRUs |
| Caller
                                          					 Input | DTMF -
                                          					 RFC2833 Automatic
                                          					 Speech Recognition and Text-to-speech (ASR/TTS) |  |
...
| Reporting
                                          					 ...
                                          					 Unified Intelligence Center Third-party
                                          								reporting applications Custom reporting |  |
| Database
                                          					 sources | Unified
