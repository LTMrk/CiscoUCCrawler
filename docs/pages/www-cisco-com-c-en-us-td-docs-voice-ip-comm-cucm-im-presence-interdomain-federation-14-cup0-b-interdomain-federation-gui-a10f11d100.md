---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-im-presence-interdomain-federation-14-cup0-b-interdomain-federation-gui-a10f11d100
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/im_presence/interdomain_federation/14/cup0_b_interdomain-federation-guide-14/cup0_b_interdomain-federation-1251su3_chapter_00.html
retrieved_at: 2026-08-16T16:27:12.612831+00:00
---
...
Third-party XMPP clients do not update the policy list of the user, they just accept the subscription. The user can manually
                                          update their privacy list in the IM and Presence Service User Options interface.
...
In the table, Microsoft Office Communicator "Busy" and "Do
                                 		  ...
                                 		  example, certain XMPP clients show the "Away" icon with no text. Other
                                 		  XMPP clients render the "Away" icon with "Busy" text annotation alongside.
...
| Note | Third-party XMPP clients do not update the policy list of the user, they just accept the subscription. The user can manually
                                          update their privacy list in the IM and Presence Service User Options interface. |
|---|---|
