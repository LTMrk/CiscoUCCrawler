---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-im-presence-database-setup-14-cup0-b-database-setup-guide-1401-cup0-b-d-52b078310d
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/im_presence/database_setup/14/cup0_b_database-setup-guide-1401/cup0_b_database-setup-guide-1401_chapter_00.html
retrieved_at: 2026-08-16T16:19:19.361357+00:00
---

Database Setup Guide for the IM and Presence Service, Release 14 and SUs
...
The supported active Oracle database versions are the following: 19c and 21c. None of the currently active Oracle database
                                          versions have been validated against Release 14 and SUs. The latest validated version was 18c.
...
|---|---|
| PostgreSQL | All currently active PostgreSQL versions from 12.x through 17.x are supported. Now, validation was performed against versions
                                          12.x, 13.x, 16.x, and 17.x. |
| Oracle | The supported active Oracle database versions are the following: 19c and 21c. None of the currently active Oracle database
                                          versions have been validated against Release 14 and SUs. The latest validated version was 18c. |
