---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-bat-12-5-1-su2-cucm-b-bulk-administration-guide-1251su2-cucm-b-bulk-adm-e57e7552c3
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/bat/12_5_1_SU2/cucm_b_bulk-administration-guide-1251su2/cucm_b_bulk-administration-guide-1251su2_chapter_0111001.html
retrieved_at: 2026-08-21T08:49:38.213333+00:00
---
...
- You must have a data file
                                 			 that contains the access list names.
...
Do not use the insert or export transaction files that are
                                                				  ...
                                                				  custom file with details of the access list records that need to be deleted.
                                                				  Use only this file for the delete transaction. In this custom delete file, you
                                                				  do not need a header, and you can enter values for access list names.
