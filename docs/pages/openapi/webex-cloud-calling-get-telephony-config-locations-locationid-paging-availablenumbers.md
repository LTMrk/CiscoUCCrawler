---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-paging-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/paging/availableNumbers
operation_id: Get Paging Group Primary Available Phone Numbers
tags: Features:  Paging Group
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.056444+00:00
---

# GET /telephony/config/locations/{locationId}/paging/availableNumbers
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/paging/availableNumbers' \
