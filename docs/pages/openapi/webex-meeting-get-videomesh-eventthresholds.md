...
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:33.407562+00:00
---
...
## Parámetros
- `eventName` [query] (string): Event name to fetch threshold details.
- `clusterId` [query] (string): Unique ID of the Video Mesh Cluster.
- `orgId` [query] (string): Unique ID of the Organization.
- `eventScope` [query] (string): Scope name to filter events.
