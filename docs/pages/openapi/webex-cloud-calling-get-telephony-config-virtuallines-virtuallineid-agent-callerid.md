---
doc_id: webex-cloud-calling-get-telephony-config-virtuallines-virtuallineid-agent-callerid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/virtualLines/{virtualLineId}/agent/callerId
operation_id: Retrieve Agent's Caller ID Information
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.396006+00:00
---

# GET /telephony/config/virtualLines/{virtualLineId}/agent/callerId
...
```bash
curl -X GET '/telephony/config/virtualLines/<virtualLineId>/agent/callerId' \
