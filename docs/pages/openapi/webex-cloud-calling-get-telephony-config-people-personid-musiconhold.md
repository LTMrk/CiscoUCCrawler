---
doc_id: webex-cloud-calling-get-telephony-config-people-personid-musiconhold
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/{personId}/musicOnHold
operation_id: retrieveMusicOnHoldSettingsForPerson
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.761249+00:00
---

# GET /telephony/config/people/{personId}/musicOnHold
...
```bash
curl -X GET '/telephony/config/people/<personId>/musicOnHold' \
...
**Documentación adicional:** https://developer.webex.com/docs/api/v1/webex-calling-person-settings-music-on-hold
