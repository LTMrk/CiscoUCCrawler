---
doc_id: webex-cloud-calling-post-telephony-calls-stoprecording
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:07.940508+00:00
---
...
- `callId` (string): The call identifier of the call to stop recording.
...
```bash
curl -X POST '/telephony/calls/stopRecording' \
