---
doc_id: webex-cloud-calling-delete-telephony-config-people-personid-simultaneousring-criteria-id
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/people/{personId}/simultaneousRing/criteria/{id}
operation_id: deletePersonSimultaneousRingCriteria
tags: User Call Settings (3/3)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.353033+00:00
---

# DELETE /telephony/config/people/{personId}/simultaneousRing/criteria/{id}

**API:** Webex Cloud Calling
**Área:** User Call Settings (3/3)
**operationId:** `deletePersonSimultaneousRingCriteria`
...
```bash
curl -X DELETE '/telephony/config/people/<personId>/simultaneousRing/criteria/<id>' \
