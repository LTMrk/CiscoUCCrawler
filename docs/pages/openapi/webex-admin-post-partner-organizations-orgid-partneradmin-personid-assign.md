---
doc_id: webex-admin-post-partner-organizations-orgid-partneradmin-personid-assign
source: webex-openapi-specs/public-spec/webex-admin.json
api: Webex Admin
api_version: 1.0.0
method: POST
path: /partner/organizations/{orgId}/partnerAdmin/{personId}/assign
operation_id: Assign partner admin to a customer
tags: Partner Administrators
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:42.570597+00:00
---

# POST /partner/organizations/{orgId}/partnerAdmin/{personId}/assign
...
## Descripción
Assign a specific Partner Admin to a customer organization. The partner admin is a user that has the Partner Administrator role.
...
```bash
curl -X POST '/partner/organizations/<orgId>/partnerAdmin/<personId>/assign' \
