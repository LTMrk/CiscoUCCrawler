...
operation_id: Configure Caller ID Settings for a Virtual Line
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.357408+00:00
---
...
```bash
curl -X PUT '/telephony/config/virtualLines/<virtualLineId>/callerId' \
