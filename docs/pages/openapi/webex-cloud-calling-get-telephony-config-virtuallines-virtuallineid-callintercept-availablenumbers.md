---
doc_id: webex-cloud-calling-get-telephony-config-virtuallines-virtuallineid-callintercept-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/virtualLines/{virtualLineId}/callIntercept/availableNumbers
operation_id: Get Virtual Line Call Intercept Available Phone Numbers
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.185898+00:00
---

# GET /telephony/config/virtualLines/{virtualLineId}/callIntercept/availableNumbers

**API:** Webex Cloud Calling
**Área:** Virtual Line Call Settings
**operationId:** `Get Virtual Line Call Intercept Available Phone Numbers`
...
```bash
curl -X GET '/telephony/config/virtualLines/<virtualLineId>/callIntercept/availableNumbers' \
