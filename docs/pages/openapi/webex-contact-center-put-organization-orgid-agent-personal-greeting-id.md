---
doc_id: webex-contact-center-put-organization-orgid-agent-personal-greeting-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: PUT
path: /organization/{orgid}/agent-personal-greeting/{id}
operation_id: updateConfigAgentPersonalGreeting
tags: Agent Personal Greeting Files
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.643369+00:00
---
...
**operationId:** `updateConfigAgentPersonalGreeting`
...
```bash
curl -X PUT '/organization/<orgid>/agent-personal-greeting/<id>' \
