---
doc_id: webex-cloud-calling-put-people-personid-features-callwaiting
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /people/{personId}/features/callWaiting
operation_id: Configure Call Waiting Settings for a Person
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.361893+00:00
---

# PUT /people/{personId}/features/callWaiting

**API:** Webex Cloud Calling
**Área:** User Call Settings (1/2)
**operationId:** `Configure Call Waiting Settings for a Person`
...
```bash
curl -X PUT '/people/<personId>/features/callWaiting' \
