...
operation_id: Update Call Park settings
tags: Features:  Call Park
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.468113+00:00
---
...
```bash
curl -X PUT '/telephony/config/locations/<locationId>/callParks/settings' \
