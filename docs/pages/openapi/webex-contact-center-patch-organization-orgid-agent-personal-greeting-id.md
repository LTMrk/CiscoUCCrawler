---
doc_id: webex-contact-center-patch-organization-orgid-agent-personal-greeting-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: PATCH
path: /organization/{orgid}/agent-personal-greeting/{id}
operation_id: patchConfigAgentPersonalGreeting
tags: Agent Personal Greeting Files
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T18:15:55.065935+00:00
---
...
**operationId:** `patchConfigAgentPersonalGreeting`
...
```bash
curl -X PATCH '/organization/<orgid>/agent-personal-greeting/<id>' \
