---
doc_id: webex-cloud-calling-get-telephony-config-people-personid-outgoingpermission-autotransfernumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/{personId}/outgoingPermission/autoTransferNumbers
operation_id: retrieveTransferNumbersForPerson
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.762319+00:00
---

# GET /telephony/config/people/{personId}/outgoingPermission/autoTransferNumbers

**API:** Webex Cloud Calling
**Área:** User Call Settings (2/2)
**operationId:** `retrieveTransferNumbersForPerson`
...
```bash
curl -X GET '/telephony/config/people/<personId>/outgoingPermission/autoTransferNumbers' \
