---
doc_id: webex-cloud-calling-put-telephony-config-emergencycallnotification
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/emergencyCallNotification
operation_id: Update an Organization Emergency Call Notification
tags: Emergency Services Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.453767+00:00
---
...
**operationId:** `Update an Organization Emergency Call Notification`
...
## Parámetros
- `orgId` [query] (string): Update Emergency Call Notification attributes for the organization.
...
```bash
curl -X PUT '/telephony/config/emergencyCallNotification' \
