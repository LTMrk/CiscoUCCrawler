---
doc_id: webex-cloud-calling-delete-telephony-config-people-personid-selectiveforward-criteria-id
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/people/{personId}/selectiveForward/criteria/{id}
operation_id: deleteCriteriaFromUserSelectiveCallForwardingService
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.773368+00:00
---

# DELETE /telephony/config/people/{personId}/selectiveForward/criteria/{id}

**API:** Webex Cloud Calling
**Área:** User Call Settings (2/2)
**operationId:** `deleteCriteriaFromUserSelectiveCallForwardingService`
...
```bash
curl -X DELETE '/telephony/config/people/<personId>/selectiveForward/criteria/<id>' \
