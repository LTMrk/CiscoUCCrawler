...
operation_id: createMyCallNotifyCriteria
tags: Call Settings For Me With UserHub Phase2
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.161040+00:00
---
...
```bash
curl -X POST '/telephony/config/people/me/settings/callNotify/criteria' \
