...
operation_id: patchV2ConfigAgentPersonalGreeting
tags: Agent Personal Greeting Files
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.645610+00:00
---
...
```bash
curl -X PATCH '/organization/<orgid>/v2/agent-personal-greeting/<id>' \
