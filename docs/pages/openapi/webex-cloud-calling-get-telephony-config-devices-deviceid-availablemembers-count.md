---
doc_id: webex-cloud-calling-get-telephony-config-devices-deviceid-availablemembers-count
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/devices/{deviceId}/availableMembers/count
operation_id: getCountOfMembers
tags: Device Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.395021+00:00
---
...
- `orgId` [query] (string): Retrieves the count of available members on the device in this organization.
...
```bash
curl -X GET '/telephony/config/devices/<deviceId>/availableMembers/count' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `totalCount` (integer) (**requerido**): The total count of members that can be assigned to the device.
