---
doc_id: webex-cloud-calling-get-people-personid-features-schedules-scheduletype-scheduleid-events-eventid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /people/{personId}/features/schedules/{scheduleType}/{scheduleId}/events/{eventId}
operation_id: Fetch Event for Person Schedule
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.149249+00:00
---

# GET /people/{personId}/features/schedules/{scheduleType}/{scheduleId}/events/{eventId}

**API:** Webex Cloud Calling
**Área:** User Call Settings (1/2)
**operationId:** `Fetch Event for Person Schedule`
...
```bash
curl -X GET '/people/<personId>/features/schedules/<scheduleType>/<scheduleId>/events/<eventId>' \
...
- `recurrence` (object): Recurrance scheme for an event.
  ...
  - `recurWeekly` (object): Specifies the event recur weekly on the designated days of the week and is not allowed with `recurDaily`.
