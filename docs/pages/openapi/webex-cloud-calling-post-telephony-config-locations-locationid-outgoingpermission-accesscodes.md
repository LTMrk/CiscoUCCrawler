---
doc_id: webex-cloud-calling-post-telephony-config-locations-locationid-outgoingpermission-accesscodes
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/locations/{locationId}/outgoingPermission/accessCodes
operation_id: Create Outgoing Permission a new access code for a customer location
tags: Location Call Settings: Call Handling
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.731149+00:00
---

# POST /telephony/config/locations/{locationId}/outgoingPermission/accessCodes
...
## Parámetros
- `locationId` [path] (string) (**requerido**): Add new access code for this location.
- `orgId` [query] (string): Add new access code for this organization.

## Cuerpo de la petición (application/json)
- `accessCodes` (object): Access code details
  - `code` (string) (**requerido**): Create new access code number.
  - `description` (string) (**requerido**): Set access code description.
...
```bash
curl -X POST '/telephony/config/locations/<locationId>/outgoingPermission/accessCodes' \
