---
doc_id: webex-cloud-calling-get-telephony-config-people-me-settings-callwaiting
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/me/settings/callWaiting
operation_id: getMyCallWaitingSettings
tags: Call Settings For Me With UserHub Phase3
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.596760+00:00
---
...
```bash
curl -X GET '/telephony/config/people/me/settings/callWaiting' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: Call Waiting Settings retrieved for the authenticated user.
