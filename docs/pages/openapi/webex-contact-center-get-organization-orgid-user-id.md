---
doc_id: webex-contact-center-get-organization-orgid-user-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/user/{id}
operation_id: getConfigUser
tags: Users
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.837086+00:00
---
...
- `includeCount` [query] (boolean): If set to true, the API response will include the count of each type of Contact Service Queue to which the user is assigned. Por defecto: False.
- `includeUserProfileType` [query] (boolean): If set to true, the API response includes the User Profile. Por defecto: False.
- `includeSkillProfileAudit` [query] (boolean): If set to true gives skill profile modification info. Por defecto: False.
- `includeReskillAuditInfo` [query] (boolean): If set to true gives skill profile and dynamic skill modification info. Por defecto: False.
...
- `checkIfUserHasDynamicSkill` [query] (boolean): If set to true, checks if user has the specified dynamic skill Por defecto: False.
- `dynamicSkillId` [query] (string): Dynamic skill ID to check if user has it assigned (required when checkIfUserHasDynamicSkill is true)

## Ejemplo de invocación
```bash
curl -X GET '/organization/<orgid>/user/<id>' \
