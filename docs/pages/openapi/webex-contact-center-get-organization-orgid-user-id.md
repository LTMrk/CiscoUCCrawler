...
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:32.956295+00:00
---
...
- `includeCount` [query] (boolean): If set to true, the API response will include the count of each type of Contact Service Queue to which the user is assigned.
- `includeUserProfileType` [query] (boolean): If set to true, the API response includes the User Profile.
- `includeSkillProfileAudit` [query] (boolean): If set to true gives skill profile modification info.
- `includeReskillAuditInfo` [query] (boolean): If set to true gives skill profile and dynamic skill modification info.
...
- `checkIfUserHasDynamicSkill` [query] (boolean): If set to true, checks if user has the specified dynamic skill
