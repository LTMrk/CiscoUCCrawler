---
doc_id: webex-contact-center-get-organization-orgid-contact-number-bulk-export
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/contact-number/bulk-export
operation_id: bulkExport_17
tags: Contact Number
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T18:15:55.071791+00:00
---
...
```bash
curl -X GET '/organization/<orgid>/contact-number/bulk-export' \
