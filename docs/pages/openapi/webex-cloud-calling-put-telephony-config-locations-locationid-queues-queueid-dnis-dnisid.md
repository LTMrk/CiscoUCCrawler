...
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:32.607905+00:00
---
...
- `name` (string): Name of the DNIS. Must be unique across the call queue.
- `phoneNumber` (string): Phone number of the DNIS. Set to `null` to remove the phone number.
- `extension` (string): Extension of the DNIS. Set to `null` to remove the extension.
