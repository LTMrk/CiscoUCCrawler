...
operation_id: Delete Delegate Emails
tags: Preferences
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.470993+00:00
---
...
```bash
curl -X POST '/meetingPreferences/schedulingOptions/delegateEmails/delete' \
