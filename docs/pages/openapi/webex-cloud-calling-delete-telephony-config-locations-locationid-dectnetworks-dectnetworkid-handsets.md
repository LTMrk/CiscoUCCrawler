...
operation_id: Delete Multiple Handsets
tags: DECT Devices Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:07.932112+00:00
---
...
```bash
curl -X DELETE '/telephony/config/locations/<locationId>/dectNetworks/<dectNetworkId>/handsets/' \
