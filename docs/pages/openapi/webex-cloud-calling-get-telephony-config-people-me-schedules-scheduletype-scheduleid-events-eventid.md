---
doc_id: webex-cloud-calling-get-telephony-config-people-me-schedules-scheduletype-scheduleid-events-eventid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/me/schedules/{scheduleType}/{scheduleId}/events/{eventId}
operation_id: getMyScheduleEvent
tags: Call Settings For Me With UserHub Phase2
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.159810+00:00
---

# GET /telephony/config/people/me/schedules/{scheduleType}/{scheduleId}/events/{eventId}
...
- `eventId` [path] (string) (**requerido**): Retrieve the event with the matching ID.

## Ejemplo de invocación
```bash
curl -X GET '/telephony/config/people/me/schedules/<scheduleType>/<scheduleId>/events/<eventId>' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: Schedule Event retrieved successfully for the authenticated user's specified schedule.
