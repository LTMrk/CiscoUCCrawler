---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-voicemailgroups-faxmessage-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/voicemailGroups/faxMessage/availableNumbers
operation_id: Get Voicemail Group Fax Message Available Phone Numbers
tags: Location Call Settings:  Voicemail
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.309542+00:00
---

# GET /telephony/config/locations/{locationId}/voicemailGroups/faxMessage/availableNumbers

**API:** Webex Cloud Calling
**Área:** Location Call Settings:  Voicemail
**operationId:** `Get Voicemail Group Fax Message Available Phone Numbers`

## Resumen
Get Voicemail Group Fax Message Available Phone Numbers

## Descripción
List the standard and service PSTN numbers that are available to be assigned as a voicemail group's FAX message phone number.
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/voicemailGroups/faxMessage/availableNumbers' \
