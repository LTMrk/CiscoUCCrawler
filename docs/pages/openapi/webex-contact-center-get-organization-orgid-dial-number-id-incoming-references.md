---
doc_id: webex-contact-center-get-organization-orgid-dial-number-id-incoming-references
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T18:15:55.090131+00:00
---
...
```bash
curl -X GET '/organization/<orgid>/dial-number/<id>/incoming-references' \
