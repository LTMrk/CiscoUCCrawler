---
doc_id: webex-cloud-calling-post-telephony-conference-mute
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.177525+00:00
---
...
- `callId` (string): The call identifier of the participant to mute. The conference host is muted when this attribute is not provided.
...
```bash
curl -X POST '/telephony/conference/mute' \
