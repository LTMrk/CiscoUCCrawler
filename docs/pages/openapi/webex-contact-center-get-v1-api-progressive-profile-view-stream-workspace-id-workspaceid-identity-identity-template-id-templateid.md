...
operation_id: streamProgressiveProfileViews
tags: Journey - Profile Creation & Insights API
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-20T13:57:48.746134+00:00
---
...
```bash
curl -X GET '/v1/api/progressive-profile-view/stream/workspace-id/<workspaceId>/identity/<identity>/template-id/<templateId>' \
