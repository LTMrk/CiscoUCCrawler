---
doc_id: webex-cloud-calling-put-telephony-pstn-locations-locationid-emergencyaddresses-addressid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/pstn/locations/{locationId}/emergencyAddresses/{addressId}
operation_id: updateEmergencyAddressOfLocation
tags: PSTN
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.746289+00:00
---

# PUT /telephony/pstn/locations/{locationId}/emergencyAddresses/{addressId}
...
## Parámetros
- `locationId` [path] (string) (**requerido**): Location for which the emergency address will be updated.
- `addressId` [path] (string) (**requerido**): Unique identifier for the emergency address that will be updated.
- `orgId` [query] (string): Updating the emergency address of a location in this organization.
...
```bash
curl -X PUT '/telephony/pstn/locations/<locationId>/emergencyAddresses/<addressId>' \
