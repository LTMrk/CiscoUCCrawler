---
doc_id: webex-cloud-calling-post-telephony-calls-unmute
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.558015+00:00
---
...
- `callId` (string) (**requerido**): The call identifier of the call to unmute.
...
```bash
curl -X POST '/telephony/calls/unmute' \
