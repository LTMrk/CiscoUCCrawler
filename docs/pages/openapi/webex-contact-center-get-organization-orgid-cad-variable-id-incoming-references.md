---
doc_id: webex-contact-center-get-organization-orgid-cad-variable-id-incoming-references
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/cad-variable/{id}/incoming-references
operation_id: getIncomingReferences_16
tags: Global Variables
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T18:15:55.097216+00:00
---
...
**operationId:** `getIncomingReferences_16`
...
```bash
curl -X GET '/organization/<orgid>/cad-variable/<id>/incoming-references' \
