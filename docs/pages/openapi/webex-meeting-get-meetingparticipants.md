...
operation_id: List Meeting Participants
tags: Participants
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.465653+00:00
---
...
## Parámetros
- `max` [query] (number): Limit the maximum number of participants in the response, up to 100. Por defecto: 10.
...
```bash
curl -X GET '/meetingParticipants?meetingId=<meetingId>' \
