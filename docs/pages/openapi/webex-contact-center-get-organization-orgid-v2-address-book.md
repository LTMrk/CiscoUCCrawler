---
doc_id: webex-contact-center-get-organization-orgid-v2-address-book
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/v2/address-book
operation_id: getAllConfigWithMetaDataWithEntries
tags: Address Book
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-20T13:57:48.668702+00:00
---
...
**API:** Webex Contact Center
**Área:** Address Book
**operationId:** `getAllConfigWithMetaDataWithEntries`
...
```bash
curl -X GET '/organization/<orgid>/v2/address-book' \
