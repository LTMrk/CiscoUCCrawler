---
doc_id: webex-cloud-calling-put-telephony-config-virtuallines-virtuallineid-callwaiting
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/virtualLines/{virtualLineId}/callWaiting
operation_id: Configure Call Waiting Settings for a Virtual Line
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.784143+00:00
---

# PUT /telephony/config/virtualLines/{virtualLineId}/callWaiting

**API:** Webex Cloud Calling
**Área:** Virtual Line Call Settings
**operationId:** `Configure Call Waiting Settings for a Virtual Line`
...
Updating the call waiting settings for a virtual line requires a full, user, or location administrator auth token with a scope of `spark-admin:telephony_config_write`.
...
```bash
curl -X PUT '/telephony/config/virtualLines/<virtualLineId>/callWaiting' \
