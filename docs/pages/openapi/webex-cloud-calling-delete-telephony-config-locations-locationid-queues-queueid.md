---
doc_id: webex-cloud-calling-delete-telephony-config-locations-locationid-queues-queueid
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.690111+00:00
---

# DELETE /telephony/config/locations/{locationId}/queues/{queueId}
...
## Parámetros
- `locationId` [path] (string) (**requerido**): Location from which to delete a call queue.
- `queueId` [path] (string) (**requerido**): Delete the call queue with the matching ID.
- `orgId` [query] (string): Delete the call queue from this organization.

## Ejemplo de invocación
```bash
curl -X DELETE '/telephony/config/locations/<locationId>/queues/<queueId>' \
