---
doc_id: webex-meeting-delete-meeting-messages-meetingmessageid
source: webex-openapi-specs/public-spec/webex-meeting.json
api: Webex Meetings
api_version: 1.0.0
method: DELETE
path: /meeting/messages/{meetingMessageId}
operation_id: Delete a Meeting Message
tags: Messages
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.465347+00:00
---

# DELETE /meeting/messages/{meetingMessageId}

**API:** Webex Meetings
**Área:** Messages
**operationId:** `Delete a Meeting Message`
...
## Parámetros
- `meetingMessageId` [path] (string) (**requerido**): The unique identifier for the message.

## Ejemplo de invocación
```bash
curl -X DELETE '/meeting/messages/<meetingMessageId>' \
