---
doc_id: webex-contact-center-post-organization-orgid-site-bulk
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: POST
path: /organization/{orgid}/site/bulk
operation_id: saveAllConfig_6
tags: Site
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T18:15:55.107855+00:00
---

# POST /organization/{orgid}/site/bulk
...
## Descripción
Create, Update or delete Site(s) in bulk in a given organization.
...
```bash
curl -X POST '/organization/<orgid>/site/bulk' \
