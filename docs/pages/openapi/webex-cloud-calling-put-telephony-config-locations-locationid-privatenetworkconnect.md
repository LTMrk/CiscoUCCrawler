...
operation_id: Update Private Network Connect
tags: Location Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.509998+00:00
---
...
```bash
curl -X PUT '/telephony/config/locations/<locationId>/privateNetworkConnect' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"networkConnectionType": "<networkConnectionType>"}'
```
