---
doc_id: webex-cloud-calling-post-telephony-config-people-personid-executive-callfiltering-criteria
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/people/{personId}/executive/callFiltering/criteria
operation_id: createPersonExecutiveCallFilteringCriteria
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.167610+00:00
---

# POST /telephony/config/people/{personId}/executive/callFiltering/criteria
...
```bash
curl -X POST '/telephony/config/people/<personId>/executive/callFiltering/criteria' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"filterName": "<filterName>", "callsFrom": "<callsFrom>", "filterEnabled": true}'
```

## Respuestas correctas
**200**: The executive call filtering criteria were created successfully. The response contains the new criteria identifier.
