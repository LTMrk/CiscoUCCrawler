---
doc_id: webex-cloud-calling-post-telephony-conference-addparticipant
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/conference/addParticipant
operation_id: Add Participant
tags: Conference Controls
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.390286+00:00
---
...
- `callId` (string) (**requerido**): The call identifier of the participant to add.
...
```bash
curl -X POST '/telephony/conference/addParticipant' \
