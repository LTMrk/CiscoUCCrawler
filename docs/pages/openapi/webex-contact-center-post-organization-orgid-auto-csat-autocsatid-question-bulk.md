---
doc_id: webex-contact-center-post-organization-orgid-auto-csat-autocsatid-question-bulk
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: POST
path: /organization/{orgid}/auto-csat/{autoCsatId}/question/bulk
operation_id: saveAllConfigAutoCSATQuestion1
tags: Auto CSAT
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.706320+00:00
---

# POST /organization/{orgid}/auto-csat/{autoCsatId}/question/bulk

> **ENDPOINT DEPRECADO.** No usar en integraciones nuevas.

**API:** Webex Contact Center
**Área:** Auto CSAT
**operationId:** `saveAllConfigAutoCSATQuestion1`

## Resumen
Bulk save Auto CSAT mapped Question(s)

## Descripción
Create, Update or delete Auto CSAT mapped Question(s) in bulk for Auto CSAT resource in a given organization. Deprecated. Use POST /ai-feature/auto-csat/question/bulk instead.
...
```bash
curl -X POST '/organization/<orgid>/auto-csat/<autoCsatId>/question/bulk' \
