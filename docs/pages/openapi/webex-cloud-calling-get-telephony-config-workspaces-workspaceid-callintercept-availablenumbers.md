---
doc_id: webex-cloud-calling-get-telephony-config-workspaces-workspaceid-callintercept-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/workspaces/{workspaceId}/callIntercept/availableNumbers
operation_id: Get Workspace Call Intercept Available Phone Numbers
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.409253+00:00
---

# GET /telephony/config/workspaces/{workspaceId}/callIntercept/availableNumbers

**API:** Webex Cloud Calling
**Área:** Workspace Call Settings (2/2)
**operationId:** `Get Workspace Call Intercept Available Phone Numbers`
...
```bash
curl -X GET '/telephony/config/workspaces/<workspaceId>/callIntercept/availableNumbers' \
...
- `phoneNumbers` (array) (**requerido**): Array of phone numbers.
  ...
  - `extension` (string): Extension for the PSTN phone number.
...
```json
{
  "phoneNumbers": [
    ...
    },
    {
      ...
      "isServiceNumber": false,
      "owner": {
        "id": "Y2lzY29zcGFyazovL3VzL0FVVE9fQVRURU5EQU5UL2RtbHRNWFV6WjJkaWRFQTJORGswTVRJNU55NXBiblF4TUM1aVkyeGtMbmRsWW1WNExtTnZiUT09",
        "type": "AUTO_ATTENDANT",
        "displayName": "Test Autoattendant"
      }
    }
  ]
}
