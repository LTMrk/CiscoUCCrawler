...
operation_id: updateConfig_3
tags: Skill
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.770907+00:00
---
...
- `payloadDTO` [query] (object) (**requerido**): Skill configuration data for update

## Ejemplo de invocación
```bash
curl -X PUT '/organization/<orgid>/skill/<id>?payloadDTO=<payloadDTO>' \
