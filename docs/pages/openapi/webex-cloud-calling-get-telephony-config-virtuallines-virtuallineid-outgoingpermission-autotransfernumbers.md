---
doc_id: webex-cloud-calling-get-telephony-config-virtuallines-virtuallineid-outgoingpermission-autotransfernumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/virtualLines/{virtualLineId}/outgoingPermission/autoTransferNumbers
operation_id: Retrieve Transfer Numbers for a Virtual Line
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.786326+00:00
---

# GET /telephony/config/virtualLines/{virtualLineId}/outgoingPermission/autoTransferNumbers

**API:** Webex Cloud Calling
**Área:** Virtual Line Call Settings
**operationId:** `Retrieve Transfer Numbers for a Virtual Line`
...
```bash
curl -X GET '/telephony/config/virtualLines/<virtualLineId>/outgoingPermission/autoTransferNumbers' \
