---
doc_id: webex-cloud-calling-put-telephony-config-virtuallines-virtuallineid-incomingpermission
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/virtualLines/{virtualLineId}/incomingPermission
operation_id: Configure Incoming Permission Settings for a Virtual Line
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.573847+00:00
---

# PUT /telephony/config/virtualLines/{virtualLineId}/incomingPermission

**API:** Webex Cloud Calling
**Área:** Virtual Line Call Settings
**operationId:** `Configure Incoming Permission Settings for a Virtual Line`
...
Updating the incoming permission settings for a virtual line requires a full, user, or location administrator auth token with a scope of `spark-admin:telephony_config_write`.
...
```bash
curl -X PUT '/telephony/config/virtualLines/<virtualLineId>/incomingPermission' \
