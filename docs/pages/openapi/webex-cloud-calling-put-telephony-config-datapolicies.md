---
doc_id: webex-cloud-calling-put-telephony-config-datapolicies
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/dataPolicies
operation_id: ModifyDataPolicySettings
tags: Call Settings Configurable Storage Region
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.707958+00:00
---
...
## Parámetros
- `orgId` [query] (string): Modify data policy settings for this organization.

## Cuerpo de la petición (application/json)
- `orgDataRegion` (string): (ISO 3166-1 alpha-2) Country Code to be configured as the storage region for the data policy of the Organization.
...
```bash
curl -X PUT '/telephony/config/dataPolicies' \
