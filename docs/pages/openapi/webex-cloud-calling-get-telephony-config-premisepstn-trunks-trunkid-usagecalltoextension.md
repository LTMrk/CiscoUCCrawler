---
doc_id: webex-cloud-calling-get-telephony-config-premisepstn-trunks-trunkid-usagecalltoextension
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/premisePstn/trunks/{trunkId}/usageCallToExtension
operation_id: Get Local Gateway Call to On-Premises Extension Usage for a Trunk
tags: Call Routing
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:07.951873+00:00
---

# GET /telephony/config/premisePstn/trunks/{trunkId}/usageCallToExtension

**API:** Webex Cloud Calling
**Área:** Call Routing
**operationId:** `Get Local Gateway Call to On-Premises Extension Usage for a Trunk`
...
```bash
curl -X GET '/telephony/config/premisePstn/trunks/<trunkId>/usageCallToExtension' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `locations` (array) (**requerido**): Array of locations associated with the trunk.
