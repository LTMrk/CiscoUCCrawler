---
doc_id: webex-cloud-calling-get-telephony-config-datapolicies
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/dataPolicies
operation_id: ReadDataPolicySettings
tags: Call Settings Configurable Storage Region
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.279130+00:00
---
...
## Parámetros
- `orgId` [query] (string): Retrieve data policy settings from this organization.

## Ejemplo de invocación
```bash
curl -X GET '/telephony/config/dataPolicies' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `orgDataRegion` (string) (**requerido**): (ISO 3166-1 alpha-2) Country Code configured as the storage region for the data policy of the Organization.
- `allowEditEnabled` (boolean) (**requerido**): If `true`, the storage region for the data policy of the Organization can be modified.
