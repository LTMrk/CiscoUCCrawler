---
doc_id: webex-cloud-calling-put-telephony-config-virtuallines-virtuallineid-outgoingpermission
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/virtualLines/{virtualLineId}/outgoingPermission
operation_id: Modify a Virtual Line's Outgoing Calling Permissions Settings
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.359202+00:00
---

# PUT /telephony/config/virtualLines/{virtualLineId}/outgoingPermission

**API:** Webex Cloud Calling
**Área:** Virtual Line Call Settings
**operationId:** `Modify a Virtual Line's Outgoing Calling Permissions Settings`
...
Updating the outgoing permission settings for a virtual line requires a full, user, or location administrator auth token with a scope of `spark-admin:telephony_config_write`.
...
```bash
curl -X PUT '/telephony/config/virtualLines/<virtualLineId>/outgoingPermission' \
