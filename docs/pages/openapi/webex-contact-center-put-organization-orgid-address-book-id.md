---
doc_id: webex-contact-center-put-organization-orgid-address-book-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: PUT
path: /organization/{orgid}/address-book/{id}
operation_id: updateConfigWithEntries
tags: Address Book
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-20T13:57:48.668299+00:00
---

# PUT /organization/{orgid}/address-book/{id}

> **ENDPOINT DEPRECADO.** No usar en integraciones nuevas.

**API:** Webex Contact Center
**Área:** Address Book
**operationId:** `updateConfigWithEntries`

## Resumen
Update specific Address Book by ID

## Descripción
Update an existing Address Book by ID in a given organization. To update address book having large entries use latest apis.
...
```bash
curl -X PUT '/organization/<orgid>/address-book/<id>' \
