---
doc_id: webex-contact-center-post-organization-orgid-overrides-bulk
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: POST
path: /organization/{orgid}/overrides/bulk
operation_id: saveAllConfig_5
tags: Overrides
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-20T13:57:48.665312+00:00
---

# POST /organization/{orgid}/overrides/bulk

**API:** Webex Contact Center
**Área:** Overrides
**operationId:** `saveAllConfig_5`

## Resumen
Bulk save Overrides resource(s)

## Descripción
Create, Update or delete Overrides resource(s) in bulk in a given organization.
...
```bash
curl -X POST '/organization/<orgid>/overrides/bulk' \
