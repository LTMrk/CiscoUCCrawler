...
operation_id: skipPreviewCampaignTaskRoute
tags: Tasks
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.802927+00:00
---
...
```bash
curl -X POST '/v1/dialer/campaign/<campaignId>/preview-task/<taskId>/skip' \
