---
doc_id: webex-cloud-calling-delete-telephony-config-workspaces-workspaceid-simultaneousring-criteria-id
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/workspaces/{workspaceId}/simultaneousRing/criteria/{id}
operation_id: Delete Simultaneous Ring Criteria for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.602212+00:00
---

# DELETE /telephony/config/workspaces/{workspaceId}/simultaneousRing/criteria/{id}

**API:** Webex Cloud Calling
**Área:** Workspace Call Settings (2/2)
**operationId:** `Delete Simultaneous Ring Criteria for a Workspace`
...
```bash
curl -X DELETE '/telephony/config/workspaces/<workspaceId>/simultaneousRing/criteria/<id>' \
