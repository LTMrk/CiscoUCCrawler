...
operation_id: Get an Organization Emergency Call Notification
tags: Emergency Services Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.453448+00:00
---
...
```bash
curl -X GET '/telephony/config/emergencyCallNotification' \
