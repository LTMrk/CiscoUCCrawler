---
doc_id: webex-messaging-delete-room-tabs-id
source: webex-openapi-specs/public-spec/webex-messaging.json
api: Webex Messaging
api_version: 1.0.0
method: DELETE
path: /room/tabs/{id}
operation_id: Delete a Room Tab
tags: Room Tabs
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-15T08:04:08.508000+00:00
---
...
## Parámetros
- `id` [path] (string) (**requerido**): The unique identifier for the Room Tab to delete.

## Ejemplo de invocación
```bash
curl -X DELETE '/room/tabs/<id>' \
