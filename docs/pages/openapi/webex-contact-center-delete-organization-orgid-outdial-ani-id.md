---
doc_id: webex-contact-center-delete-organization-orgid-outdial-ani-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: DELETE
path: /organization/{orgid}/outdial-ani/{id}
operation_id: deleteConfigOutdialANI
tags: Outdial ANI
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.708462+00:00
---
...
**API:** Webex Contact Center
**Área:** Outdial ANI
**operationId:** `deleteConfigOutdialANI`
...
```bash
curl -X DELETE '/organization/<orgid>/outdial-ani/<id>' \
