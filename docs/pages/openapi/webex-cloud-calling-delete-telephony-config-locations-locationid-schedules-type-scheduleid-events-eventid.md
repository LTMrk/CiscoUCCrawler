---
doc_id: webex-cloud-calling-delete-telephony-config-locations-locationid-schedules-type-scheduleid-events-eventid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/locations/{locationId}/schedules/{type}/{scheduleId}/events/{eventId}
operation_id: Delete a Schedule Event
tags: Location Call Settings:  Schedules
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.344487+00:00
---

# DELETE /telephony/config/locations/{locationId}/schedules/{type}/{scheduleId}/events/{eventId}
...
## Parámetros
- `locationId` [path] (string) (**requerido**): Location from which to delete a schedule.
...
- `eventId` [path] (string) (**requerido**): Delete the schedule event with the matching schedule event ID.
- `orgId` [query] (string): Delete the schedule from this organization.

## Ejemplo de invocación
```bash
curl -X DELETE '/telephony/config/locations/<locationId>/schedules/<type>/<scheduleId>/events/<eventId>' \
