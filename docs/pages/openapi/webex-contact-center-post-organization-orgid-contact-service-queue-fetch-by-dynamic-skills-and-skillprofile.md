...
operation_id: getSkillBasedCSQsByDynamicSkillsAndSkillProfileContactServiceQueue
tags: Contact Service Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.734416+00:00
---
...
```bash
curl -X POST '/organization/<orgid>/contact-service-queue/fetch-by-dynamic-skills-and-skillProfile' \
