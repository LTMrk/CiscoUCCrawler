...
operation_id: Voice Portal Hot desking sign in details for a user
tags: Features: Hot Desking Sign-in via Voice Portal
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.708965+00:00
---
...
```bash
curl -X GET '/telephony/config/people/<personId>/features/hotDesking/guest' \
