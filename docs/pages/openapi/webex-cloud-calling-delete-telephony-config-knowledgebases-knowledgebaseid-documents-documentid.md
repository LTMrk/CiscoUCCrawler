---
doc_id: webex-cloud-calling-delete-telephony-config-knowledgebases-knowledgebaseid-documents-documentid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/knowledgeBases/{knowledgeBaseId}/documents/{documentId}
operation_id: deleteKnowledgeBaseDocument
tags: AI Receptionist for Webex Calling, AI Receptionist
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.125392+00:00
---

# DELETE /telephony/config/knowledgeBases/{knowledgeBaseId}/documents/{documentId}
...
```bash
curl -X DELETE '/telephony/config/knowledgeBases/<knowledgeBaseId>/documents/<documentId>' \
