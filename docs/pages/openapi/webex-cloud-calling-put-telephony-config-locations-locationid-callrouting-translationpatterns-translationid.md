---
doc_id: webex-cloud-calling-put-telephony-config-locations-locationid-callrouting-translationpatterns-translationid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/locations/{locationId}/callRouting/translationPatterns/{translationId}
operation_id: Modify a specific Translation Pattern for a Location
tags: Call Routing
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.572516+00:00
---

# PUT /telephony/config/locations/{locationId}/callRouting/translationPatterns/{translationId}

**API:** Webex Cloud Calling
**Área:** Call Routing
**operationId:** `Modify a specific Translation Pattern for a Location`
...
```bash
curl -X PUT '/telephony/config/locations/<locationId>/callRouting/translationPatterns/<translationId>' \
