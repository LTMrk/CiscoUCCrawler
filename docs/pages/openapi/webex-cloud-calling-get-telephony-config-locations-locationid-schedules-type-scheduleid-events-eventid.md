---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-schedules-type-scheduleid-events-eventid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/schedules/{type}/{scheduleId}/events/{eventId}
operation_id: Get Details for a Schedule Event
tags: Location Call Settings:  Schedules
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.734182+00:00
---

# GET /telephony/config/locations/{locationId}/schedules/{type}/{scheduleId}/events/{eventId}
...
## Parámetros
- `locationId` [path] (string) (**requerido**): Retrieve schedule event details in this location.
- `type` [path] (string) (**requerido**): Type of schedule. Valores: businessHours, holidays.
- `scheduleId` [path] (string) (**requerido**): Retrieve the schedule event with the matching schedule ID.
- `eventId` [path] (string) (**requerido**): Retrieve the schedule event with the matching schedule event ID.
- `orgId` [query] (string): Retrieve schedule event details from this organization.

## Ejemplo de invocación
```bash
curl -X GET '/telephony/config/locations/<locationId>/schedules/<type>/<scheduleId>/events/<eventId>' \
