---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-queues-queueid-announcements
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/queues/{queueId}/announcements
operation_id: listCallQueueAnnouncementFiles
tags: Features:  Call Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.472618+00:00
---

# GET /telephony/config/locations/{locationId}/queues/{queueId}/announcements
...
- `queueId` [path] (string) (**requerido**): Retrieve anouncement files for the call queue with this identifier.
- `orgId` [query] (string): Retrieve announcement files for a call queue from this organization.

## Ejemplo de invocación
```bash
curl -X GET '/telephony/config/locations/<locationId>/queues/<queueId>/announcements' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `announcements` (array) (**requerido**): Array of announcements for this call queue.
