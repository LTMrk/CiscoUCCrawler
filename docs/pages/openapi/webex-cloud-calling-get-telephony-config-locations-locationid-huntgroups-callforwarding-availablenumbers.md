---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-huntgroups-callforwarding-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/huntGroups/callForwarding/availableNumbers
operation_id: getHuntGroupCallForwardAvailablePhoneNumbers
tags: Features:  Hunt Group
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.712563+00:00
---

# GET /telephony/config/locations/{locationId}/huntGroups/callForwarding/availableNumbers
...
## Descripción
List the service and standard PSTN numbers that are available to be assigned as the hunt group's call forward number.
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/huntGroups/callForwarding/availableNumbers' \
