---
doc_id: webex-cloud-calling-delete-telephony-config-people-personid-outgoingpermission-digitpatterns
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/people/{personId}/outgoingPermission/digitPatterns
operation_id: deleteAllDigitPatternsPerson
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.336055+00:00
---

# DELETE /telephony/config/people/{personId}/outgoingPermission/digitPatterns

**API:** Webex Cloud Calling
**Área:** User Call Settings (2/2)
**operationId:** `deleteAllDigitPatternsPerson`
...
```bash
curl -X DELETE '/telephony/config/people/<personId>/outgoingPermission/digitPatterns' \
