...
operation_id: Update a Call Park Extension
tags: Features:  Call Park
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.687368+00:00
---
...
```bash
curl -X PUT '/telephony/config/locations/<locationId>/callParkExtensions/<callParkExtensionId>' \
