---
doc_id: webex-contact-center-delete-organization-orgid-channel-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: DELETE
path: /organization/{orgid}/channel/{id}
operation_id: deleteConfigChannel
tags: Channel
deprecated: false
scopes: 
license: CC-BY-4.0
...
**API:** Webex Contact Center
**Área:** Channel
**operationId:** `deleteConfigChannel`

## Resumen
Delete specific Channel by ID

## Descripción
Delete an existing Channel by ID in a given organization.
...
```bash
curl -X DELETE '/organization/<orgid>/channel/<id>' \
