---
doc_id: webex-contact-center-put-organization-orgid-holiday-list-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: PUT
path: /organization/{orgid}/holiday-list/{id}
operation_id: updateConfigHolidayList
tags: Holiday List
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.657656+00:00
---

# PUT /organization/{orgid}/holiday-list/{id}

**API:** Webex Contact Center
**Área:** Holiday List
**operationId:** `updateConfigHolidayList`

## Resumen
Update specific Holiday List by ID

## Descripción
Update an existing Holiday List by ID in a given organization.

## Parámetros
- `orgid` [path] (string) (**requerido**): Organization ID to be used for this operation. The specified security token must have permission to interact with the organization.
- `id` [path] (string) (**requerido**): Resource ID of the Holiday List.
...
```bash
curl -X PUT '/organization/<orgid>/holiday-list/<id>' \
