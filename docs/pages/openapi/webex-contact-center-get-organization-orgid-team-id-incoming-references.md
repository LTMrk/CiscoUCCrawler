---
doc_id: webex-contact-center-get-organization-orgid-team-id-incoming-references
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/team/{id}/incoming-references
operation_id: getIncomingReferencesTeam
tags: Team
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.724239+00:00
---
...
**API:** Webex Contact Center
**Área:** Team
**operationId:** `getIncomingReferencesTeam`
...
```bash
curl -X GET '/organization/<orgid>/team/<id>/incoming-references' \
