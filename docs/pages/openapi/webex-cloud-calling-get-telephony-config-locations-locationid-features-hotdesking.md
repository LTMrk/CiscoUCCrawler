---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-features-hotdesking
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/features/hotDesking
operation_id: Voice Portal Hot desking sign in details for a location
tags: Features: Hot Desking Sign-in via Voice Portal
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.048084+00:00
---

# GET /telephony/config/locations/{locationId}/features/hotDesking

**API:** Webex Cloud Calling
**Área:** Features: Hot Desking Sign-in via Voice Portal
**operationId:** `Voice Portal Hot desking sign in details for a location`
...
## Parámetros
- `locationId` [path] (string) (**requerido**): Location in which the hot desking sign in resides.
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/features/hotDesking' \
