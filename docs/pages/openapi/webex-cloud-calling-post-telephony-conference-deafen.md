---
doc_id: webex-cloud-calling-post-telephony-conference-deafen
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/conference/deafen
operation_id: Deafen Participant
tags: Conference Controls
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.608758+00:00
---
...
- `callId` (string) (**requerido**): The call identifier of the participant to deafen.
...
```bash
curl -X POST '/telephony/conference/deafen' \
