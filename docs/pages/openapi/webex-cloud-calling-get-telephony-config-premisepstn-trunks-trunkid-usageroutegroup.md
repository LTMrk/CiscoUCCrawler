---
doc_id: webex-cloud-calling-get-telephony-config-premisepstn-trunks-trunkid-usageroutegroup
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/premisePstn/trunks/{trunkId}/usageRouteGroup
operation_id: Get Route Groups Using the Local Gateway
tags: Call Routing
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.165594+00:00
---

# GET /telephony/config/premisePstn/trunks/{trunkId}/usageRouteGroup
...
```bash
curl -X GET '/telephony/config/premisePstn/trunks/<trunkId>/usageRouteGroup' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `routeGroup` (array) (**requerido**): Array of route Groups.
  - `id` (string) (**requerido**): UUID of the route group associated with the Trunk.
  - `name` (string) (**requerido**): Name of the Route Group associated with the Trunk.
  - `inUse` (boolean) (**requerido**): In use flag.
