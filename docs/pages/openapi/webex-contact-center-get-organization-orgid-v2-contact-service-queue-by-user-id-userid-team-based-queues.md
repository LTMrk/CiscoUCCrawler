---
doc_id: webex-contact-center-get-organization-orgid-v2-contact-service-queue-by-user-id-userid-team-based-queues
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/v2/contact-service-queue/by-user-id/{userid}/team-based-queues
operation_id: getCSQByUserIDForTeamBasedQueueContactServiceQueue
tags: Contact Service Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.684241+00:00
---
...
**operationId:** `getCSQByUserIDForTeamBasedQueueContactServiceQueue`

## Resumen
List team-based Contact Service Queues by user ID

## Descripción
Retrieve a list of team-based Contact Service Queues by user ID in a given organization.
...
```bash
curl -X GET '/organization/<orgid>/v2/contact-service-queue/by-user-id/<userid>/team-based-queues' \
