---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-queues-callforwarding-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/queues/callForwarding/availableNumbers
operation_id: getCallQueueCallForwardAvailablePhoneNumbers
tags: Features:  Call Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.476941+00:00
---

# GET /telephony/config/locations/{locationId}/queues/callForwarding/availableNumbers

**API:** Webex Cloud Calling
**Área:** Features:  Call Queue
**operationId:** `getCallQueueCallForwardAvailablePhoneNumbers`
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/queues/callForwarding/availableNumbers' \
