---
doc_id: webex-cloud-calling-get-telephony-config-workspaces-workspaceid-faxmessage-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/workspaces/{workspaceId}/faxMessage/availableNumbers
operation_id: Get Workspace Fax Message Available Phone Numbers
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.814870+00:00
---

# GET /telephony/config/workspaces/{workspaceId}/faxMessage/availableNumbers

**API:** Webex Cloud Calling
**Área:** Workspace Call Settings (2/2)
**operationId:** `Get Workspace Fax Message Available Phone Numbers`
...
```bash
curl -X GET '/telephony/config/workspaces/<workspaceId>/faxMessage/availableNumbers' \
