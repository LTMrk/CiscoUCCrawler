---
doc_id: webex-cloud-calling-put-telephony-config-announcements-playlists-playlistid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/announcements/playlists/{playlistId}
operation_id: updateAnnouncementPlaylist
tags: Features: Announcement Playlist
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.282727+00:00
---

# PUT /telephony/config/announcements/playlists/{playlistId}
...
- `orgId` [query] (string): Modify an announcement playlist in this organization.
...
```bash
curl -X PUT '/telephony/config/announcements/playlists/<playlistId>' \
