---
doc_id: webex-cloud-calling-post-telephony-config-cxessentials-wrapup-reasons
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/cxEssentials/wrapup/reasons
operation_id: Create Wrap Up Reason
tags: Features: Customer Assist
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.313918+00:00
---
...
- `queues` (array): List of queue IDs assigned to the wrap-up reason.
...
```bash
curl -X POST '/telephony/config/cxEssentials/wrapup/reasons' \
