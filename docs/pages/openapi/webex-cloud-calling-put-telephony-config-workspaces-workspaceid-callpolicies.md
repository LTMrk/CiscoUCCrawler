---
doc_id: webex-cloud-calling-put-telephony-config-workspaces-workspaceid-callpolicies
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/workspaces/{workspaceId}/callPolicies
operation_id: Configure Call Policy Settings for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.412919+00:00
---

# PUT /telephony/config/workspaces/{workspaceId}/callPolicies

**API:** Webex Cloud Calling
**Área:** Workspace Call Settings (2/2)
**operationId:** `Configure Call Policy Settings for a Workspace`
...
```json
{
  "connectedLineIdPrivacyOnRedirectedCalls": "<NO_PRIVACY | PRIVACY_FOR_EXTERNAL_CALLS | PRIVACY_FOR_ALL_CALLS>"
}
```

## Ejemplo de invocación
```bash
curl -X PUT '/telephony/config/workspaces/<workspaceId>/callPolicies' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"connectedLineIdPrivacyOnRedirectedCalls": "<connectedLineIdPrivacyOnRedirectedCalls>"}'
```
