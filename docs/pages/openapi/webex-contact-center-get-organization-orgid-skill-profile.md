...
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:32.950211+00:00
---
...
- **200**: OK
  - (array de:)
    ...
    - `name` (string): Indicates the name of the skill Profile. It is required only during a create or an update operation.
