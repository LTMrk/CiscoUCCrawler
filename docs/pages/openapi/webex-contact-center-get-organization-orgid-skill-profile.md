---
doc_id: webex-contact-center-get-organization-orgid-skill-profile
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/skill-profile
operation_id: getAllConfig_3
tags: Skill Profile
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.684020+00:00
---

# GET /organization/{orgid}/skill-profile

**API:** Webex Contact Center
**Área:** Skill Profile
**operationId:** `getAllConfig_3`
...
```bash
curl -X GET '/organization/<orgid>/skill-profile' \
...
- (array de:)
  ...
  - `name` (string): Indicates the name of the skill Profile. It is required only during a create or an update operation. Long. max: 80.
