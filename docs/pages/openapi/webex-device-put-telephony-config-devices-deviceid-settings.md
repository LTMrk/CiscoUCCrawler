---
doc_id: webex-device-put-telephony-config-devices-deviceid-settings
source: webex-openapi-specs/public-spec/webex-device.json
api: Webex Device
api_version: 1.0.0
method: PUT
path: /telephony/config/devices/{deviceId}/settings
operation_id: updateDeviceSettings
tags: Device Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.191659+00:00
---
...
```bash
curl -X PUT '/telephony/config/devices/<deviceId>/settings' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"customizations": {}, "customEnabled": true}'
```
