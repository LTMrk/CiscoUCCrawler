---
doc_id: webex-cloud-calling-post-telephony-config-premisepstn-dialplans
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/premisePstn/dialPlans
operation_id: Create a Dial Plan
tags: Call Routing
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.166758+00:00
---
...
**API:** Webex Cloud Calling
**Área:** Call Routing
**operationId:** `Create a Dial Plan`
...
```bash
curl -X POST '/telephony/config/premisePstn/dialPlans' \
...
**201**: Created
- `id` (string) (**requerido**): ID of the newly created dial plan.
