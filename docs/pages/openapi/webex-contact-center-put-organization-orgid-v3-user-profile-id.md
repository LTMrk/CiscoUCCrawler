---
doc_id: webex-contact-center-put-organization-orgid-v3-user-profile-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: PUT
path: /organization/{orgid}/v3/user-profile/{id}
operation_id: updateConfigUserProfileGranularAccess
tags: User Profiles
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T18:15:55.120561+00:00
---

# PUT /organization/{orgid}/v3/user-profile/{id}
...
## Descripción
Update an existing user profile by ID in a given organization.
...
```bash
curl -X PUT '/organization/<orgid>/v3/user-profile/<id>' \
