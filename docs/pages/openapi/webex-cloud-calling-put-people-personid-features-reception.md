---
doc_id: webex-cloud-calling-put-people-personid-features-reception
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /people/{personId}/features/reception
operation_id: Configure Receptionist Client Settings for a Person
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.366527+00:00
---

# PUT /people/{personId}/features/reception
...
- `receptionEnabled` (boolean) (**requerido**): `true` if the Receptionist Client feature is enabled.
...
```bash
curl -X PUT '/people/<personId>/features/reception' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"receptionEnabled": true}'
```
