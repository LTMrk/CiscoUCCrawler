---
doc_id: webex-cloud-calling-get-telephony-config-people-me-settings-selectiveaccept
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/me/settings/selectiveAccept
operation_id: getMySelectiveAcceptSettings
tags: Call Settings For Me With UserHub Phase2
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.592857+00:00
---
...
**operationId:** `getMySelectiveAcceptSettings`
...
```bash
curl -X GET '/telephony/config/people/me/settings/selectiveAccept' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: Selective Call Accept Settings retrieved for the authenticated user.
