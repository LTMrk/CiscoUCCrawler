...
operation_id: Create Digit Pattern for a Virtual Profile
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.360683+00:00
---
...
```bash
curl -X POST '/telephony/config/virtualLines/<virtualLineId>/outgoingPermission/digitPatterns' \
