---
doc_id: webex-cloud-calling-delete-telephony-config-locations-locationid-aireceptionists-aireceptionistid-intents-intentid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/locations/{locationId}/aiReceptionists/{aiReceptionistId}/intents/{intentId}
operation_id: deleteAiReceptionistIntent
tags: AI Receptionist for Webex Calling, AI Receptionist
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.554487+00:00
---

# DELETE /telephony/config/locations/{locationId}/aiReceptionists/{aiReceptionistId}/intents/{intentId}

**API:** Webex Cloud Calling
**Área:** AI Receptionist for Webex Calling, AI Receptionist
**operationId:** `deleteAiReceptionistIntent`
...
```bash
curl -X DELETE '/telephony/config/locations/<locationId>/aiReceptionists/<aiReceptionistId>/intents/<intentId>' \
