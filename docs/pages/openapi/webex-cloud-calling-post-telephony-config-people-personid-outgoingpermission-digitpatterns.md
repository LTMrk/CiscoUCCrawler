---
doc_id: webex-cloud-calling-post-telephony-config-people-personid-outgoingpermission-digitpatterns
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/people/{personId}/outgoingPermission/digitPatterns
operation_id: createDigitPatternsForPerson
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.550302+00:00
---
...
```bash
curl -X POST '/telephony/config/people/<personId>/outgoingPermission/digitPatterns' \
