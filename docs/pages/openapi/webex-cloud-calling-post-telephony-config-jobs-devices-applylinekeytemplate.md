---
doc_id: webex-cloud-calling-post-telephony-config-jobs-devices-applylinekeytemplate
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/jobs/devices/applyLineKeyTemplate
operation_id: applyLineKeyTemplate
tags: Device Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.618784+00:00
---
...
```bash
curl -X POST '/telephony/config/jobs/devices/applyLineKeyTemplate' \
