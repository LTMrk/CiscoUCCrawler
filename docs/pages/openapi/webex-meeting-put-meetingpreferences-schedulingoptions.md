...
operation_id: Update Scheduling Options
tags: Preferences
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.470627+00:00
---
...
```bash
curl -X PUT '/meetingPreferences/schedulingOptions' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"enabledJoinBeforeHost": true, "joinBeforeHostMinutes": 0, "enabledAutoShareRecording": true}'
```
