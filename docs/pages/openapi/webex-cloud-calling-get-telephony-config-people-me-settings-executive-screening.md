---
doc_id: webex-cloud-calling-get-telephony-config-people-me-settings-executive-screening
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/me/settings/executive/screening
operation_id: getMyExecutiveScreeningSettings
tags: Beta Call Settings For Me With Userhub Phase1
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.154289+00:00
---
...
```bash
curl -X GET '/telephony/config/people/me/settings/executive/screening' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: User executive screening settings retrieved successfully.
