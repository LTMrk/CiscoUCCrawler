---
doc_id: webex-contact-center-get-organization-orgid-contact-service-queue-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/contact-service-queue/{id}
operation_id: getConfigContactServiceQueue
tags: Contact Service Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.784994+00:00
---

# GET /organization/{orgid}/contact-service-queue/{id}

**API:** Webex Contact Center
**Área:** Contact Service Queue
**operationId:** `getConfigContactServiceQueue`
...
```bash
curl -X GET '/organization/<orgid>/contact-service-queue/<id>' \
