---
doc_id: webex-contact-center-get-organization-orgid-business-hours-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/business-hours/{id}
operation_id: getConfigBusinessHours
tags: Business Hour
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.710732+00:00
---
...
**API:** Webex Contact Center
**Área:** Business Hour
**operationId:** `getConfigBusinessHours`
...
```bash
curl -X GET '/organization/<orgid>/business-hours/<id>' \
