---
doc_id: webex-cloud-calling-put-telephony-config-people-personid-features-callbridge
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/people/{personId}/features/callBridge
operation_id: configureCallBridgeSettingsPerson
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.554426+00:00
---

# PUT /telephony/config/people/{personId}/features/callBridge

**API:** Webex Cloud Calling
**Área:** User Call Settings (2/2)
**operationId:** `configureCallBridgeSettingsPerson`
...
```bash
curl -X PUT '/telephony/config/people/<personId>/features/callBridge' \
