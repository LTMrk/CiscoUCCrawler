---
doc_id: webex-cloud-calling-delete-telephony-config-locations-locationid-autoattendants-autoattendantid-callforwarding-selectiverules-ruleid
...
operation_id: deleteAutoAttendantSelectiveCallForwardingRule
tags: Features:  Auto Attendant
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.021862+00:00
---

# DELETE /telephony/config/locations/{locationId}/autoAttendants/{autoAttendantId}/callForwarding/selectiveRules/{ruleId}

**API:** Webex Cloud Calling
**Área:** Features:  Auto Attendant
**operationId:** `deleteAutoAttendantSelectiveCallForwardingRule`
...
- `autoAttendantId` [path] (string) (**requerido**): Delete the rule for this auto attendant.
- `ruleId` [path] (string) (**requerido**): Auto attendant rule you are deleting.
- `orgId` [query] (string): Delete auto attendant rule from this organization.

## Ejemplo de invocación
```bash
curl -X DELETE '/telephony/config/locations/<locationId>/autoAttendants/<autoAttendantId>/callForwarding/selectiveRules/<ruleId>' \
