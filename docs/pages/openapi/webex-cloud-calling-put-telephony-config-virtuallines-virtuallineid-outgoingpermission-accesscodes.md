---
doc_id: webex-cloud-calling-put-telephony-config-virtuallines-virtuallineid-outgoingpermission-accesscodes
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/virtualLines/{virtualLineId}/outgoingPermission/accessCodes
operation_id: Modify Access Codes for a Virtual Line
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.177863+00:00
---

# PUT /telephony/config/virtualLines/{virtualLineId}/outgoingPermission/accessCodes

**API:** Webex Cloud Calling
**Área:** Virtual Line Call Settings
**operationId:** `Modify Access Codes for a Virtual Line`
...
- `deleteCodes` (array): Access Codes to delete.
...
```bash
curl -X PUT '/telephony/config/virtualLines/<virtualLineId>/outgoingPermission/accessCodes' \
