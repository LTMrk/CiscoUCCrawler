---
doc_id: webex-admin-get-schemas-scim2-schemaid
source: webex-openapi-specs/public-spec/webex-admin.json
api: Webex Admin
api_version: 1.0.0
method: GET
path: /Schemas/SCIM2/{schemaId}
operation_id: Get Schema using Group Schema ID
tags: SCIM 2 Schemas
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:42.585744+00:00
---

# GET /Schemas/SCIM2/{schemaId}
...
## Parámetros
- `schemaId` [path] (string) (**requerido**): The Schema Id of Group/User Schema

## Ejemplo de invocación
```bash
curl -X GET '/Schemas/SCIM2/<schemaId>' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `urn:ietf:params:scim:schemas:core:2.0:Group` (object): The Cisco extension of SCIM 2.
