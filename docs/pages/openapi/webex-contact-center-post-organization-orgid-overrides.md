---
doc_id: webex-contact-center-post-organization-orgid-overrides
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: POST
path: /organization/{orgid}/overrides
operation_id: createConfig_6
tags: Overrides
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.637521+00:00
---
...
**API:** Webex Contact Center
**Área:** Overrides
**operationId:** `createConfig_6`

## Resumen
Create a new Overrides resource

## Descripción
Create a new Overrides resource in a given organization.
...
```bash
curl -X POST '/organization/<orgid>/overrides' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"name": "<name>", "overrides": [], "timezone": "<timezone>"}'
```
