---
doc_id: webex-contact-center-get-organization-orgid-v2-auto-csat-autocsatid-question
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/v2/auto-csat/{autoCsatId}/question
operation_id: getAllConfigWithMetaDataAutoCSATQuestion1
tags: Auto CSAT
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.758546+00:00
---

# GET /organization/{orgid}/v2/auto-csat/{autoCsatId}/question

> **ENDPOINT DEPRECADO.** No usar en integraciones nuevas.

**API:** Webex Contact Center
**Área:** Auto CSAT
**operationId:** `getAllConfigWithMetaDataAutoCSATQuestion1`

## Resumen
List Auto CSAT mapped Question(s)

## Descripción
Retrieve a list of Auto CSAT mapped Question(s) in a given organization. Deprecated. Use GET /v2/ai-feature/auto-csat/question instead.
...
- `attributes` [query] (string/string): Specify the attributes to be returned. By default, all attributes are returned along with the specified columns. All attributes are supported.(id, questionId, questionnaireId)
...
```bash
curl -X GET '/organization/<orgid>/v2/auto-csat/<autoCsatId>/question' \
