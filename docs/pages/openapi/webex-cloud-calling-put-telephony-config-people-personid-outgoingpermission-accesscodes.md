---
doc_id: webex-cloud-calling-put-telephony-config-people-personid-outgoingpermission-accesscodes
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/people/{personId}/outgoingPermission/accessCodes
operation_id: modifyAccessCodesForPerson
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.153394+00:00
---

# PUT /telephony/config/people/{personId}/outgoingPermission/accessCodes

**API:** Webex Cloud Calling
**Área:** User Call Settings (2/2)
**operationId:** `modifyAccessCodesForPerson`
...
```bash
curl -X PUT '/telephony/config/people/<personId>/outgoingPermission/accessCodes' \
