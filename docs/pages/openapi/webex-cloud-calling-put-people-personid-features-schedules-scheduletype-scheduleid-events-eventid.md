---
doc_id: webex-cloud-calling-put-people-personid-features-schedules-scheduletype-scheduleid-events-eventid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /people/{personId}/features/schedules/{scheduleType}/{scheduleId}/events/{eventId}
operation_id: Update an Event for Person Schedule
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.149533+00:00
---

# PUT /people/{personId}/features/schedules/{scheduleType}/{scheduleId}/events/{eventId}

**API:** Webex Cloud Calling
**Área:** User Call Settings (1/2)
**operationId:** `Update an Event for Person Schedule`
...
- `recurrence` (object): Recurrance scheme for an event.
  ...
  - `recurWeekly` (object): Specifies the event recurs weekly on the designated days of the week and is not allowed with `recurDaily`.
...
```json
{
  "newName": "Central_Zone_Day_Shift",
  "name": "Day_Shift",
...
```bash
curl -X PUT '/people/<personId>/features/schedules/<scheduleType>/<scheduleId>/events/<eventId>' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"newName": "<newName>", "name": "<name>", "startDate": "<startDate>", "endDate": "<endDate>", "startTime": "<startTime>", "endTime": "<endTime>"}'
```
...
```json
{
  "id": "Y2lzY29zcGFyazovL3VzL1VTRVJfU0NIRURVTEVfRVZFTlQvUTJWdWRISmhiRjlhYjI1bFgwUmhlVjlUYUdsbWRBPT0"
}
```
