---
doc_id: webex-device-get-telephony-config-devices-dectnetworks-supporteddevices
source: webex-openapi-specs/public-spec/webex-device.json
api: Webex Device
api_version: 1.0.0
method: GET
path: /telephony/config/devices/dectNetworks/supportedDevices
operation_id: readTheDectDeviceTypeList
tags: Device Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.198074+00:00
---
...
```bash
curl -X GET '/telephony/config/devices/dectNetworks/supportedDevices' \
