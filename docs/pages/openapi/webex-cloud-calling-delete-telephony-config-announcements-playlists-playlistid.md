---
doc_id: webex-cloud-calling-delete-telephony-config-announcements-playlists-playlistid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/announcements/playlists/{playlistId}
operation_id: deleteAnnouncementPlaylist
tags: Features: Announcement Playlist
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.457292+00:00
---
...
- `orgId` [query] (string): Delete an announcement playlist in this organization.

## Ejemplo de invocación
```bash
curl -X DELETE '/telephony/config/announcements/playlists/<playlistId>' \
