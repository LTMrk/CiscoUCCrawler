---
doc_id: webex-contact-center-post-organization-orgid-v2-agent-personal-greeting
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: POST
path: /organization/{orgid}/v2/agent-personal-greeting
operation_id: createV2ConfigAgentPersonalGreeting
tags: Agent Personal Greeting Files
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.725228+00:00
---

# POST /organization/{orgid}/v2/agent-personal-greeting

**API:** Webex Contact Center
**Área:** Agent Personal Greeting Files
**operationId:** `createV2ConfigAgentPersonalGreeting`
...
```bash
curl -X POST '/organization/<orgid>/v2/agent-personal-greeting' \
