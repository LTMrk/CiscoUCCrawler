...
operation_id: createMyScheduleEvent
tags: Call Settings For Me With UserHub Phase2
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.159590+00:00
---
...
```bash
curl -X POST '/telephony/config/people/me/schedules/<scheduleType>/<scheduleId>/events' \
