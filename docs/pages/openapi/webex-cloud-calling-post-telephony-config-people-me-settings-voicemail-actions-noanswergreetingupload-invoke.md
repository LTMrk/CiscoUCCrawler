---
doc_id: webex-cloud-calling-post-telephony-config-people-me-settings-voicemail-actions-noanswergreetingupload-invoke
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/people/me/settings/voicemail/actions/noAnswerGreetingUpload/invoke
operation_id: uploadVoicemailNoAnswerGreeting
tags: Call Settings For Me Phase 4
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.383275+00:00
---
...
- `file` (string/binary) (**requerido**): Greeting audio file in WAV format. Maximum file size is 5000 kilobytes.

## Ejemplo de invocación
```bash
curl -X POST '/telephony/config/people/me/settings/voicemail/actions/noAnswerGreetingUpload/invoke' \
