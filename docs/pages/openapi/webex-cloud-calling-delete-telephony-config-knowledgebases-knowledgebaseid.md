---
doc_id: webex-cloud-calling-delete-telephony-config-knowledgebases-knowledgebaseid
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.124321+00:00
---

# DELETE /telephony/config/knowledgeBases/{knowledgeBaseId}
...
```bash
curl -X DELETE '/telephony/config/knowledgeBases/<knowledgeBaseId>' \
