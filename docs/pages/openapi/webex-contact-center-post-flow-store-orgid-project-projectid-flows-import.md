...
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:32.969031+00:00
---
...
## Parámetros
- `Content-Length` [header] (integer) **(requerido)**: Content length value in number of bytes.
...
- `associatedRcs` [query] (array): IDs of Resource Collections to associate with the imported flow.

## Cuerpo de la petición (multipart/form-data)
- `file` (string) **(requerido)**: Upload a file containing a `FlowVersionRes` object.
