...
operation_id: getAllV2ConfigWithMetaDataAgentPersonalGreeting
tags: Agent Personal Greeting Files
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.726994+00:00
---
...
```bash
curl -X GET '/organization/<orgid>/v3/agent-personal-greeting' \
