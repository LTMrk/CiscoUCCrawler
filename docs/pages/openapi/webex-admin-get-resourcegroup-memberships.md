---
doc_id: webex-admin-get-resourcegroup-memberships
source: webex-openapi-specs/public-spec/webex-admin.json
api: Webex Admin
api_version: 1.0.0
method: GET
path: /resourceGroup/memberships
operation_id: List Resource Group Memberships
tags: Resource Group Memberships
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:42.578223+00:00
---
...
- `personId` [query] (string): List resource group memberships for a person, by ID.
- `personOrgId` [query] (string): List resource group memberships for an organization, by ID.
...
```bash
curl -X GET '/resourceGroup/memberships' \
