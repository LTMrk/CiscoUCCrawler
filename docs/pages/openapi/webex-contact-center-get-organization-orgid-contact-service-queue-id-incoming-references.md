---
doc_id: webex-contact-center-get-organization-orgid-contact-service-queue-id-incoming-references
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/contact-service-queue/{id}/incoming-references
operation_id: getIncomingReferencesContactServiceQueue
tags: Contact Service Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.653604+00:00
---
...
**operationId:** `getIncomingReferencesContactServiceQueue`
...
```bash
curl -X GET '/organization/<orgid>/contact-service-queue/<id>/incoming-references' \
