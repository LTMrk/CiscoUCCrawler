---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-autoattendants-alternate-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/autoAttendants/alternate/availableNumbers
operation_id: getAutoAttendantAlternateAvailablePhoneNumbers
tags: Features:  Auto Attendant
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.254666+00:00
---

# GET /telephony/config/locations/{locationId}/autoAttendants/alternate/availableNumbers

**API:** Webex Cloud Calling
**Área:** Features:  Auto Attendant
**operationId:** `getAutoAttendantAlternateAvailablePhoneNumbers`

## Resumen
Get Auto Attendant Alternate Available Phone Numbers

## Descripción
List the service and standard PSTN numbers that are available to be assigned as the auto attendant's alternate number.
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/autoAttendants/alternate/availableNumbers' \
