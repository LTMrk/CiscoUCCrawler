---
doc_id: webex-contact-center-put-organization-orgid-work-type-id
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.791776+00:00
---
...
## Descripción
Update an existing Work Type by ID in a given organization.
...
```bash
curl -X PUT '/organization/<orgid>/work-type/<id>' \
