---
doc_id: webex-contact-center-post-v1-tasks-taskid-hold
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: POST
path: /v1/tasks/{taskId}/hold
operation_id: agentHoldRoute
tags: Tasks
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.801083+00:00
---

# POST /v1/tasks/{taskId}/hold
...
```bash
curl -X POST '/v1/tasks/<taskId>/hold' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"mediaResourceId": "<mediaResourceId>"}'
```
