---
doc_id: webex-cloud-calling-delete-telephony-config-premisepstn-trunks-trunkid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/premisePstn/trunks/{trunkId}
operation_id: Delete a Trunk
tags: Call Routing
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:07.948516+00:00
---

# DELETE /telephony/config/premisePstn/trunks/{trunkId}

**API:** Webex Cloud Calling
**Área:** Call Routing
**operationId:** `Delete a Trunk`
...
```bash
curl -X DELETE '/telephony/config/premisePstn/trunks/<trunkId>' \
