---
doc_id: webex-cloud-calling-put-telephony-config-people-me-endpoints-endpointid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/people/me/endpoints/{endpointId}
operation_id: modifyMyEndpointDetails
tags: Call Settings For Me
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.576919+00:00
---

# PUT /telephony/config/people/me/endpoints/{endpointId}

**API:** Webex Cloud Calling
**Área:** Call Settings For Me
**operationId:** `modifyMyEndpointDetails`
...
- `mobilitySettings` (object) (**requerido**): Mobility settings of the endpoint.
...
```bash
curl -X PUT '/telephony/config/people/me/endpoints/<endpointId>' \
