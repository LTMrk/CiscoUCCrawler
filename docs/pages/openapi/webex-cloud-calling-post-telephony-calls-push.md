---
doc_id: webex-cloud-calling-post-telephony-calls-push
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.559711+00:00
---
...
- `callId` (string): The call identifier of the call to push.
...
```bash
curl -X POST '/telephony/calls/push' \
