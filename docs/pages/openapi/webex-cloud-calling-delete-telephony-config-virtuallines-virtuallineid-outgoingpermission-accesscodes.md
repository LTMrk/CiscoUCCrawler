---
doc_id: webex-cloud-calling-delete-telephony-config-virtuallines-virtuallineid-outgoingpermission-accesscodes
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/virtualLines/{virtualLineId}/outgoingPermission/accessCodes
operation_id: Delete Access Codes for a Virtual Line
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.393700+00:00
---

# DELETE /telephony/config/virtualLines/{virtualLineId}/outgoingPermission/accessCodes

**API:** Webex Cloud Calling
**Área:** Virtual Line Call Settings
**operationId:** `Delete Access Codes for a Virtual Line`
...
```bash
curl -X DELETE '/telephony/config/virtualLines/<virtualLineId>/outgoingPermission/accessCodes' \
