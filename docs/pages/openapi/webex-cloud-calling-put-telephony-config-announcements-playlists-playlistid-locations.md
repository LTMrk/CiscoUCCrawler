---
doc_id: webex-cloud-calling-put-telephony-config-announcements-playlists-playlistid-locations
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/announcements/playlists/{playlistId}/locations
operation_id: updatePlaylistLocations
tags: Features: Announcement Playlist
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.247132+00:00
---
...
- `orgId` [query] (string): Modify an assign location for announcement playlist for organization.

## Cuerpo de la petición (application/json)
- `locationIds` (array) (**requerido**): Array of location IDs with which the playlist is associated.
...
```bash
curl -X PUT '/telephony/config/announcements/playlists/<playlistId>/locations' \
