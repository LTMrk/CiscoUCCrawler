---
doc_id: webex-cloud-calling-get-telephony-config-people-me-settings-anonymouscallreject
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/me/settings/anonymousCallReject
operation_id: getMyAnonymousCallRejectSettings
tags: Call Settings For Me With UserHub Phase3
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.164756+00:00
---
...
```bash
curl -X GET '/telephony/config/people/me/settings/anonymousCallReject' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: Anonymous Call Rejection Settings retrieved for the authenticated user.
