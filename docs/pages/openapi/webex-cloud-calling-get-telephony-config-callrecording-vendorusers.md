---
doc_id: webex-cloud-calling-get-telephony-config-callrecording-vendorusers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/callRecording/vendorUsers
operation_id: getCallRecordingVendorUsers
tags: Features: Call Recording
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.273651+00:00
---
...
**operationId:** `getCallRecordingVendorUsers`
...
## Parámetros
- `orgId` [query] (string): Retrieve call recording vendor users for this organization.
...
```bash
curl -X GET '/telephony/config/callRecording/vendorUsers' \
