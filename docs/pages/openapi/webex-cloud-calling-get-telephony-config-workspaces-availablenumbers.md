---
doc_id: webex-cloud-calling-get-telephony-config-workspaces-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/workspaces/availableNumbers
operation_id: Get Workspace Available Phone Numbers
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.379056+00:00
---
...
**operationId:** `Get Workspace Available Phone Numbers`
...
```bash
curl -X GET '/telephony/config/workspaces/availableNumbers' \
