---
doc_id: webex-cloud-calling-get-telephony-config-people-personid-selectivereject
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/{personId}/selectiveReject
operation_id: getUserSelectiveCallRejectionCriteriaListing
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.162987+00:00
---

# GET /telephony/config/people/{personId}/selectiveReject

**API:** Webex Cloud Calling
**Área:** User Call Settings (2/2)
**operationId:** `getUserSelectiveCallRejectionCriteriaListing`
...
```bash
curl -X GET '/telephony/config/people/<personId>/selectiveReject' \
