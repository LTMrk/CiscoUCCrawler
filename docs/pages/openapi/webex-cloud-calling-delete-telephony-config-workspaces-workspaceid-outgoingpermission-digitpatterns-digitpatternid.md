---
doc_id: webex-cloud-calling-delete-telephony-config-workspaces-workspaceid-outgoingpermission-digitpatterns-digitpatternid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/workspaces/{workspaceId}/outgoingPermission/digitPatterns/{digitPatternId}
operation_id: Delete a Digit Pattern for the Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.593583+00:00
---
...
**operationId:** `Delete a Digit Pattern for the Workspace`
...
```bash
curl -X DELETE '/telephony/config/workspaces/<workspaceId>/outgoingPermission/digitPatterns/<digitPatternId>' \
