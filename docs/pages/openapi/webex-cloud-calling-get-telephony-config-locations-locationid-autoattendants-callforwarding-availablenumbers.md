---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-autoattendants-callforwarding-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/autoAttendants/callForwarding/availableNumbers
operation_id: getAutoAttendantCallForwardAvailablePhoneNumbers
tags: Features:  Auto Attendant
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.254936+00:00
---
...
## Descripción
List the service and standard PSTN numbers that are available to be assigned as the auto attendant's call forward number.
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/autoAttendants/callForwarding/availableNumbers' \
...
```json
{
  "phoneNumbers": [
    ...
    },
    {
      ...
      "owner": {
        "id": "Y2lzY29zcGFyazovL3VybjpURUFNOnVzLWVhc3QtMV9pbnQxMy9QTEFDRS8zZjc0NzJiMS1iNDNmLTQ3N2QtODNlZi1hNmQzZGYyZGJiMjY=",
        "type": "PLACE",
