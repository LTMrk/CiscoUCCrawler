---
doc_id: webex-cloud-calling-post-telephony-config-servicesettings-callerreputationprovider-actions-unlock-invoke
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/serviceSettings/callerReputationProvider/actions/unlock/invoke
operation_id: unlockCallerReputationProvider
tags: Caller Reputation Provider
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.369761+00:00
---
...
```bash
curl -X POST '/telephony/config/serviceSettings/callerReputationProvider/actions/unlock/invoke' \
...
**200**: Successful unlock of caller reputation provider.
