---
doc_id: webex-contact-center-get-organization-orgid-v2-contact-service-queue
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/v2/contact-service-queue
operation_id: getAllFilteredConfigWithPagedMetaDataContactServiceQueue
tags: Contact Service Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.737299+00:00
---

# GET /organization/{orgid}/v2/contact-service-queue

**API:** Webex Contact Center
**Área:** Contact Service Queue
**operationId:** `getAllFilteredConfigWithPagedMetaDataContactServiceQueue`
...
```bash
curl -X GET '/organization/<orgid>/v2/contact-service-queue' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `meta` (object): Meta Data Paged CSQ schema.
  ...
  - `actualSummariesInclusionCount` (integer/int64): Indicates the actual number of queues included for AI assistant-generated summaries in a given organization, including queues that are access-restricted for the user requesting the data.
- `data` (array): List of contact service queues returned in this page.
  ...
  "data": [
    {
      ...
      "personalizedAIRouting": {
        "aiRoutingMode": "EVALUATION",
        "aiRoutingKPIId": "63beec53-8a61-489f-afc6-bb03c8c73834"
      },
