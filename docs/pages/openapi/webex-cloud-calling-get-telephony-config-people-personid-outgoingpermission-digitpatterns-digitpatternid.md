---
doc_id: webex-cloud-calling-get-telephony-config-people-personid-outgoingpermission-digitpatterns-digitpatternid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/{personId}/outgoingPermission/digitPatterns/{digitPatternId}
operation_id: retrieveDigitPatternDetailsPerson
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.336231+00:00
---

# GET /telephony/config/people/{personId}/outgoingPermission/digitPatterns/{digitPatternId}

**API:** Webex Cloud Calling
**Área:** User Call Settings (2/2)
**operationId:** `retrieveDigitPatternDetailsPerson`
...
```bash
curl -X GET '/telephony/config/people/<personId>/outgoingPermission/digitPatterns/<digitPatternId>' \
