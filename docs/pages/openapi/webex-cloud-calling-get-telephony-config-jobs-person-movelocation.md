---
doc_id: webex-cloud-calling-get-telephony-config-jobs-person-movelocation
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/jobs/person/moveLocation
operation_id: listMoveUsersJobs
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.151784+00:00
---
...
## Parámetros
- `orgId` [query] (string): Retrieve list of Move Users jobs for this organization.
...
```bash
curl -X GET '/telephony/config/jobs/person/moveLocation' \
