...
operation_id: getAllConfigOutdialANI
tags: Outdial ANI
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.673530+00:00
---
...
```bash
curl -X GET '/organization/<orgid>/outdial-ani' \
...
- (array de:)
  ...
  - `name` (string): Enter a name for the outdial ANI. Long. max: 80.
