...
operation_id: Get Webex Go Available Phone Numbers
tags: Location Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.334822+00:00
---
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/webexGo/availableNumbers' \
