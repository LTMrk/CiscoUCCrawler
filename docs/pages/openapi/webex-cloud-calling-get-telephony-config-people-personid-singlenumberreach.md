---
doc_id: webex-cloud-calling-get-telephony-config-people-personid-singlenumberreach
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/{personId}/singleNumberReach
operation_id: Get Single Number Reach Settings For A Person
tags: Features: Single Number Reach
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.501584+00:00
---

# GET /telephony/config/people/{personId}/singleNumberReach
...
```bash
curl -X GET '/telephony/config/people/<personId>/singleNumberReach' \
