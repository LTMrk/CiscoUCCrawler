---
doc_id: webex-cloud-calling-post-telephony-config-locations-locationid-huntgroups-huntgroupid-callforwarding-selectiverules
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/locations/{locationId}/huntGroups/{huntGroupId}/callForwarding/selectiveRules
operation_id: createHuntGroupSelectiveCallForwardingRule
tags: Features:  Hunt Group
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.494502+00:00
---

# POST /telephony/config/locations/{locationId}/huntGroups/{huntGroupId}/callForwarding/selectiveRules

**API:** Webex Cloud Calling
**Área:** Features:  Hunt Group
**operationId:** `createHuntGroupSelectiveCallForwardingRule`
...
- `huntGroupId` [path] (string) (**requerido**): Create the rule for this hunt group.
- `orgId` [query] (string): Create the hunt group rule for this organization.
...
```bash
curl -X POST '/telephony/config/locations/<locationId>/huntGroups/<huntGroupId>/callForwarding/selectiveRules' \
