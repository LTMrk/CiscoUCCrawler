...
operation_id: deleteCriteriaFromUserSelectiveCallAcceptService
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.344206+00:00
---
...
```bash
curl -X DELETE '/telephony/config/people/<personId>/selectiveAccept/criteria/<id>' \
