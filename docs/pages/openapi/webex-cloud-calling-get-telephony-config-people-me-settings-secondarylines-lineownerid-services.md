---
doc_id: webex-cloud-calling-get-telephony-config-people-me-settings-secondarylines-lineownerid-services
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/me/settings/secondaryLines/{lineownerId}/services
operation_id: getMySecondaryLinesCallingServicesList
tags: Call Settings For Me
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.180806+00:00
---

# GET /telephony/config/people/me/settings/secondaryLines/{lineownerId}/services

**API:** Webex Cloud Calling
**Área:** Call Settings For Me
**operationId:** `getMySecondaryLinesCallingServicesList`
...
```bash
curl -X GET '/telephony/config/people/me/settings/secondaryLines/<lineownerId>/services' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `services` (array) (**requerido**): The list of allowed services.
