---
doc_id: webex-cloud-calling-delete-locations-locationid
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.738612+00:00
---
...
- `orgId` [query] (string): Specify the organization for the location to be deleted.

## Ejemplo de invocación
```bash
curl -X DELETE '/locations/<locationId>' \
