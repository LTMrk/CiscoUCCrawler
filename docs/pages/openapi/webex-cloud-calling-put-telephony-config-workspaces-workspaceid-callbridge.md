---
doc_id: webex-cloud-calling-put-telephony-config-workspaces-workspaceid-callbridge
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/workspaces/{workspaceId}/callBridge
operation_id: Modify Call Bridge Warning Tone Settings for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.597126+00:00
---

# PUT /telephony/config/workspaces/{workspaceId}/callBridge
...
```bash
curl -X PUT '/telephony/config/workspaces/<workspaceId>/callBridge' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"warningToneEnabled": true}'
```
