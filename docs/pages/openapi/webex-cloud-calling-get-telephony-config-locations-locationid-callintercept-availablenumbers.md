---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-callintercept-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/callIntercept/availableNumbers
operation_id: Get Location Call Intercept Available Phone Numbers
tags: Location Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.725990+00:00
---

# GET /telephony/config/locations/{locationId}/callIntercept/availableNumbers

**API:** Webex Cloud Calling
**Área:** Location Call Settings
**operationId:** `Get Location Call Intercept Available Phone Numbers`
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/callIntercept/availableNumbers' \
...
- `phoneNumbers` (array) (**requerido**): Array of phone numbers.
  ...
  - `extension` (string): Extension for phone number.
  ...
  - `owner` (object):
    - `id` (string) (**requerido**): ID of the owner to which the number is assigned.
    ...
    - `firstName` (string): First name of the number's owner and will only be returned when the owner `type` is `PEOPLE` or `VIRTUAL_LINE`.
    - `lastName` (string): Last name of the number's owner and will only be returned when the owner `type` is `PEOPLE` or `VIRTUAL_LINE`.
