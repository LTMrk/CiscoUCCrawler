---
doc_id: webex-cloud-calling-put-people-personid-features-intercept
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /people/{personId}/features/intercept
operation_id: Configure Call Intercept Settings for a Person
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.537548+00:00
---
...
**operationId:** `Configure Call Intercept Settings for a Person`
...
```bash
curl -X PUT '/people/<personId>/features/intercept' \
