...
operation_id: Get Network Test results for node
tags: Video Mesh
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.507753+00:00
---
...
```bash
curl -X GET '/videoMesh/testResults/networkTest/nodes?nodeId=<nodeId>&triggerType=<triggerType>&from=<from>&to=<to>' \
