---
doc_id: webex-cloud-calling-get-telephony-config-virtuallines-virtuallineid-emergencycallbacknumber-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/virtualLines/{virtualLineId}/emergencyCallbackNumber/availableNumbers
operation_id: Get Virtual Line ECBN Available Phone Numbers
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.792939+00:00
---
...
**operationId:** `Get Virtual Line ECBN Available Phone Numbers`
...
```bash
curl -X GET '/telephony/config/virtualLines/<virtualLineId>/emergencyCallbackNumber/availableNumbers' \
...
- `phoneNumbers` (array) (**requerido**): Array of phone numbers.
  ...
  - `owner` (object):
    ...
    - `type` (string) (**requerido**): Type of the number's owner.  * `PLACE` - Number's owner is a workspace.  * `PEOPLE` - Number's owner is a person.  * `VIRTUAL_LINE` - Number's owner is a Virtual Line.  * `HUNT_GROUP` - Number's owner is a Hunt Group. Valores: PLACE, PEOPLE, VIRTUAL_LINE, HUNT_GROUP.
