...
operation_id: getMySecondaryLinesCallCenterSettings
tags: Call Settings For Me
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.186204+00:00
---
...
```bash
curl -X GET '/telephony/config/people/me/settings/secondaryLines/<lineownerId>/queues' \
