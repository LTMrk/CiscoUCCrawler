...
operation_id: Get Reachability Test results for cluster V2
tags: Video Mesh
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.504626+00:00
---
...
```bash
curl -X GET '/videoMesh/testResults/reachabilityTest/clusters?clusterId=<clusterId>&triggerType=<triggerType>&from=<from>&to=<to>' \
