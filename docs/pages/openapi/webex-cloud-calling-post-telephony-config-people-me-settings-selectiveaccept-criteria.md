---
doc_id: webex-cloud-calling-post-telephony-config-people-me-settings-selectiveaccept-criteria
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/people/me/settings/selectiveAccept/criteria
operation_id: createMySelectiveAcceptCriteria
tags: Call Settings For Me With UserHub Phase2
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.195378+00:00
---
...
**operationId:** `createMySelectiveAcceptCriteria`
...
```bash
curl -X POST '/telephony/config/people/me/settings/selectiveAccept/criteria' \
...
**200**: Selective Call Accept Criteria created successfully. Returns the criteria ID.
