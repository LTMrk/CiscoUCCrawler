---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/availableNumbers
operation_id: Get Available Phone Numbers for a Location with Given Criteria
tags: Location Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.115640+00:00
---

# GET /telephony/config/locations/{locationId}/availableNumbers

**API:** Webex Cloud Calling
**Área:** Location Call Settings
**operationId:** `Get Available Phone Numbers for a Location with Given Criteria`
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/availableNumbers' \
