---
doc_id: webex-contact-center-get-organization-orgid-v2-dial-number
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/v2/dial-number
operation_id: getAllConfigWithMetaData_15
tags: Dial Number
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.666030+00:00
---

# GET /organization/{orgid}/v2/dial-number

**API:** Webex Contact Center
**Área:** Dial Number
**operationId:** `getAllConfigWithMetaData_15`
...
- `attributes` [query] (string/string): Specify the attributes to be returned. By default, all attributes are returned along with the specified columns. All attributes are supported. except (links)
...
- `includeEntryPointName` [query] (boolean): If includeEntryPointName is set to true and entryPointName is in the attributes, the API will return entryPointName in the Get All response, and filtering, searching, and sorting on entryPointName will also be enabled. Por defecto: False.

## Ejemplo de invocación
```bash
curl -X GET '/organization/<orgid>/v2/dial-number' \
