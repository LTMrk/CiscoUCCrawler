---
doc_id: webex-contact-center-post-organization-orgid-agent-profile
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: POST
path: /organization/{orgid}/agent-profile
operation_id: createConfigDesktopProfile
tags: Desktop Profile
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.793913+00:00
---
...
**operationId:** `createConfigDesktopProfile`
...
- `agentProfileDTO` [query] (object) (**requerido**): Agent profile configuration data

## Ejemplo de invocación
```bash
curl -X POST '/organization/<orgid>/agent-profile?agentProfileDTO=<agentProfileDTO>' \
