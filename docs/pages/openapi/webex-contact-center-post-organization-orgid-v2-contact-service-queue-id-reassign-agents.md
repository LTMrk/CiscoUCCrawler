...
operation_id: reassignAgentsContactServiceQueue
tags: Contact Service Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-20T13:57:48.683895+00:00
---
...
```bash
curl -X POST '/organization/<orgid>/v2/contact-service-queue/<id>/reassign-agents' \
