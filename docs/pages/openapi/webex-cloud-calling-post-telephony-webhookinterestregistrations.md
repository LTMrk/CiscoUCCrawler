---
doc_id: webex-cloud-calling-post-telephony-webhookinterestregistrations
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/webhookInterestRegistrations
operation_id: createWebhookInterestRegistration
tags: Webhook Interest Registrations
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.585567+00:00
---
...
**operationId:** `createWebhookInterestRegistration`
...
- `interests` (array) (**requerido**): The collection of webhook interests for this registration. At least one interest is required. Each interest is either resource-based or actor-based (exactly one of `resource` or `actor` is set).
...
- `duration` (integer): Optional time, in days, after which the registration expires. When omitted, the registration defaults to expire after 60 days.
...
```bash
curl -X POST '/telephony/webhookInterestRegistrations' \
