---
doc_id: webex-cloud-calling-get-telephony-config-virtuallines-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/virtualLines/availableNumbers
operation_id: Get Virtual Line Available Phone Numbers
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.399634+00:00
---
...
**operationId:** `Get Virtual Line Available Phone Numbers`
...
```bash
curl -X GET '/telephony/config/virtualLines/availableNumbers' \
