...
operation_id: Retrieve Sequential Ring Criteria for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.599122+00:00
---
...
```bash
curl -X GET '/telephony/config/workspaces/<workspaceId>/sequentialRing/criteria/<id>' \
