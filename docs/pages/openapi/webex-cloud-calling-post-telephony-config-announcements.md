---
doc_id: webex-cloud-calling-post-telephony-config-announcements
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/announcements
operation_id: Upload a binary announcement greeting at organization level
tags: Features: Announcement Repository
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.015199+00:00
---
...
```bash
curl -X POST '/telephony/config/announcements' \
