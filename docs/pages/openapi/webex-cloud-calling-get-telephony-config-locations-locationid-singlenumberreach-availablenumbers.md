---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-singlenumberreach-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/singleNumberReach/availableNumbers
operation_id: Get Single Number Reach Primary Available Phone Numbers
tags: Features: Single Number Reach
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.716910+00:00
---

# GET /telephony/config/locations/{locationId}/singleNumberReach/availableNumbers
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/singleNumberReach/availableNumbers' \
