---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-callrouting-translationpatterns-translationid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/callRouting/translationPatterns/{translationId}
operation_id: Retrieve a specific Translation Pattern for a Location
tags: Call Routing
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.348921+00:00
---

# GET /telephony/config/locations/{locationId}/callRouting/translationPatterns/{translationId}

**API:** Webex Cloud Calling
**Área:** Call Routing
**operationId:** `Retrieve a specific Translation Pattern for a Location`
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/callRouting/translationPatterns/<translationId>' \
