---
doc_id: webex-cloud-calling-get-telephony-config-jobs-devices-applylinekeytemplate-jobid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/jobs/devices/applyLineKeyTemplate/{jobId}
operation_id: getTheJobStatusOfAnApplyLineKeyTemplateJob
tags: Device Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.402420+00:00
---
...
- `orgId` [query] (string): Check a line key template job status in this organization.

## Ejemplo de invocación
```bash
curl -X GET '/telephony/config/jobs/devices/applyLineKeyTemplate/<jobId>' \
