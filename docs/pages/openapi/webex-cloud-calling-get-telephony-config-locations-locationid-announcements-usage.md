...
operation_id: Fetch repository usage for announcements in a location
tags: Features: Announcement Repository
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.249287+00:00
---
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/announcements/usage' \
