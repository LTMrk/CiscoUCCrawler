---
doc_id: webex-contact-center-get-organization-orgid-dial-plan-id-incoming-references
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/dial-plan/{id}/incoming-references
operation_id: getIncomingReferencesDialPlan
tags: Dial Plan
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.668115+00:00
---
...
**API:** Webex Contact Center
**Área:** Dial Plan
**operationId:** `getIncomingReferencesDialPlan`
...
```bash
curl -X GET '/organization/<orgid>/dial-plan/<id>/incoming-references' \
