---
doc_id: webex-cloud-calling-post-telephony-calls-resume
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:07.939322+00:00
---
...
- `callId` (string) (**requerido**): The call identifier of the call to resume.
...
```bash
curl -X POST '/telephony/calls/resume' \
