---
doc_id: webex-cloud-calling-post-telephony-conference-undeafen
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/conference/undeafen
operation_id: Undeafen Participant
tags: Conference Controls
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.177996+00:00
---
...
**operationId:** `Undeafen Participant`
...
- `callId` (string) (**requerido**): The call identifier of the participant to undeafen.
...
```bash
curl -X POST '/telephony/conference/undeafen' \
