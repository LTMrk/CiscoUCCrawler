...
operation_id: Modify an Operating Mode Holiday
tags: Features: Operating Modes
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.323187+00:00
---
...
```bash
curl -X PUT '/telephony/config/operatingModes/<modeId>/holidays/<holidayId>' \
