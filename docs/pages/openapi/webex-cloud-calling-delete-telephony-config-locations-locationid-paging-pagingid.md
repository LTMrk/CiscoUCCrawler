---
doc_id: webex-cloud-calling-delete-telephony-config-locations-locationid-paging-pagingid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/locations/{locationId}/paging/{pagingId}
operation_id: Delete a Paging Group
tags: Features:  Paging Group
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.055715+00:00
---
...
## Parámetros
- `locationId` [path] (string) (**requerido**): Location from which to delete a paging group.
- `pagingId` [path] (string) (**requerido**): Delete the paging group with the matching ID.
- `orgId` [query] (string): Delete the paging group from this organization.

## Ejemplo de invocación
```bash
curl -X DELETE '/telephony/config/locations/<locationId>/paging/<pagingId>' \
