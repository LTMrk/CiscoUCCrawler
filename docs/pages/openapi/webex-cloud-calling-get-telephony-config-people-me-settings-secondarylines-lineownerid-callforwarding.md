---
doc_id: webex-cloud-calling-get-telephony-config-people-me-settings-secondarylines-lineownerid-callforwarding
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/me/settings/secondaryLines/{lineownerId}/callForwarding
operation_id: getMySecondaryLinesCallForwardingSettings
tags: Call Settings For Me
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.581058+00:00
---

# GET /telephony/config/people/me/settings/secondaryLines/{lineownerId}/callForwarding

**API:** Webex Cloud Calling
**Área:** Call Settings For Me
**operationId:** `getMySecondaryLinesCallForwardingSettings`
...
```bash
curl -X GET '/telephony/config/people/me/settings/secondaryLines/<lineownerId>/callForwarding' \
