---
doc_id: webex-cloud-calling-post-telephony-calls-startrecording
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.333836+00:00
---
...
- `callId` (string): The call identifier of the call to start recording.
...
```bash
curl -X POST '/telephony/calls/startRecording' \
