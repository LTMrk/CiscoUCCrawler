---
doc_id: webex-cloud-calling-put-telephony-config-people-personid-selectivereject-criteria-id
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/people/{personId}/selectiveReject/criteria/{id}
operation_id: modifyCriteriaForUserSelectiveCallRejectionService
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.380713+00:00
---

# PUT /telephony/config/people/{personId}/selectiveReject/criteria/{id}
...
```bash
curl -X PUT '/telephony/config/people/<personId>/selectiveReject/criteria/<id>' \
