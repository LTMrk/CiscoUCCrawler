...
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:32.952055+00:00
---
...
- `supervisorView` [query] (boolean): If set to true, the API will only return data that the user has access to, according to the User Profile.
