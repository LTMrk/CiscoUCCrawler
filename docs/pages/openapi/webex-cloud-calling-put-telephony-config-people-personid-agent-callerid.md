---
doc_id: webex-cloud-calling-put-telephony-config-people-personid-agent-callerid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/people/{personId}/agent/callerId
operation_id: modifyAgentCallerIdInformation
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.339712+00:00
---

# PUT /telephony/config/people/{personId}/agent/callerId

**API:** Webex Cloud Calling
**Área:** User Call Settings (2/2)
**operationId:** `modifyAgentCallerIdInformation`
...
```bash
curl -X PUT '/telephony/config/people/<personId>/agent/callerId' \
