...
operation_id: getMySecondaryLinesCallRecordingSettings
tags: Call Settings For Me
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:07.957717+00:00
---
...
```bash
curl -X GET '/telephony/config/people/me/settings/secondaryLines/<lineownerId>/callRecording' \
...
```json
{
  ...
  "recordingMode": "Always with Pause/Resume",
