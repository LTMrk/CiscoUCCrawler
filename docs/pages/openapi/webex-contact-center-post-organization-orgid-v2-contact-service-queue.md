---
doc_id: webex-contact-center-post-organization-orgid-v2-contact-service-queue
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: POST
path: /organization/{orgid}/v2/contact-service-queue
operation_id: createConfigContactServiceQueue_1
tags: Contact Service Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.654951+00:00
---
...
**operationId:** `createConfigContactServiceQueue_1`
...
{
  "name": "SupportQueue",
  "description": "Queue for support calls",
  "queueType": "INBOUND",
...
```bash
curl -X POST '/organization/<orgid>/v2/contact-service-queue' \
