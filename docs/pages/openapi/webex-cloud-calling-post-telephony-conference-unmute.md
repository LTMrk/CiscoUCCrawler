---
doc_id: webex-cloud-calling-post-telephony-conference-unmute
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.255636+00:00
---
...
- `callId` (string): The call identifier of the participant to unmute. The conference host is unmuted when this attribute is not provided.
...
```bash
curl -X POST '/telephony/conference/unmute' \
