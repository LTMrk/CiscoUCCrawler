---
doc_id: webex-device-get-telephony-config-devices-deviceid-settings
source: webex-openapi-specs/public-spec/webex-device.json
api: Webex Device
api_version: 1.0.0
method: GET
path: /telephony/config/devices/{deviceId}/settings
operation_id: getDeviceSettings
tags: Device Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.190962+00:00
---
...
```bash
curl -X GET '/telephony/config/devices/<deviceId>/settings' \
