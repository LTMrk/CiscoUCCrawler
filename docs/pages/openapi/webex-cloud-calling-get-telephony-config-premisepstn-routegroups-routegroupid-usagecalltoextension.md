---
doc_id: webex-cloud-calling-get-telephony-config-premisepstn-routegroups-routegroupid-usagecalltoextension
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/premisePstn/routeGroups/{routeGroupId}/usageCallToExtension
operation_id: Read the Call to Extension Locations of a Routing Group
tags: Call Routing
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.170089+00:00
---

# GET /telephony/config/premisePstn/routeGroups/{routeGroupId}/usageCallToExtension

**API:** Webex Cloud Calling
**Área:** Call Routing
**operationId:** `Read the Call to Extension Locations of a Routing Group`
...
```bash
curl -X GET '/telephony/config/premisePstn/routeGroups/<routeGroupId>/usageCallToExtension' \
