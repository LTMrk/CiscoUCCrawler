...
operation_id: modifyPreferredAnswerEndpoint
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.337192+00:00
---
...
```bash
curl -X PUT '/telephony/config/people/<personId>/preferredAnswerEndpoint' \
