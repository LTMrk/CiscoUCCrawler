---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-voicemail
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/voicemail
operation_id: Get Location Voicemail
tags: Location Call Settings:  Voicemail
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.521813+00:00
---

# GET /telephony/config/locations/{locationId}/voicemail
...
## Parámetros
- `locationId` [path] (string) (**requerido**): Retrieve voicemail settings for this location.
- `orgId` [query] (string): Retrieve voicemail settings for this organization.

## Ejemplo de invocación
```bash
curl -X GET '/telephony/config/locations/<locationId>/voicemail' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `voicemailTranscriptionEnabled` (boolean) (**requerido**): Set to `true` to enable voicemail transcription.
