---
doc_id: webex-cloud-calling-delete-telephony-config-people-me-settings-selectiveforward-criteria-id
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/people/me/settings/selectiveForward/criteria/{id}
operation_id: deleteMySelectiveCallForwardingCriteria
tags: Call Settings For Me With UserHub Phase2
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.374877+00:00
---

# DELETE /telephony/config/people/me/settings/selectiveForward/criteria/{id}

**API:** Webex Cloud Calling
**Área:** Call Settings For Me With UserHub Phase2
**operationId:** `deleteMySelectiveCallForwardingCriteria`
...
```bash
curl -X DELETE '/telephony/config/people/me/settings/selectiveForward/criteria/<id>' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**204**: Selective Call Forwarding criteria deleted successfully. No content is returned.
