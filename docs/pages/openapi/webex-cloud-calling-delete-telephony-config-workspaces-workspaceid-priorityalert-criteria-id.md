---
doc_id: webex-cloud-calling-delete-telephony-config-workspaces-workspaceid-priorityalert-criteria-id
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/workspaces/{workspaceId}/priorityAlert/criteria/{id}
operation_id: Delete Priority Alert Criteria for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.418021+00:00
---
...
**operationId:** `Delete Priority Alert Criteria for a Workspace`
...
```bash
curl -X DELETE '/telephony/config/workspaces/<workspaceId>/priorityAlert/criteria/<id>' \
