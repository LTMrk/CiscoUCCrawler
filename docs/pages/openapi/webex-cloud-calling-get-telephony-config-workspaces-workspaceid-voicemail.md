---
doc_id: webex-cloud-calling-get-telephony-config-workspaces-workspaceid-voicemail
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/workspaces/{workspaceId}/voicemail
operation_id: Read Voicemail Settings for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.382931+00:00
---

# GET /telephony/config/workspaces/{workspaceId}/voicemail

**API:** Webex Cloud Calling
**Área:** Workspace Call Settings (2/2)
**operationId:** `Read Voicemail Settings for a Workspace`
...
```bash
curl -X GET '/telephony/config/workspaces/<workspaceId>/voicemail' \
