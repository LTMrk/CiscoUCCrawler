---
doc_id: webex-contact-center-get-organization-orgid-agent-personal-greeting-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/agent-personal-greeting/{id}
operation_id: getConfigAgentPersonalGreeting
tags: Agent Personal Greeting Files
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.667410+00:00
---
...
**operationId:** `getConfigAgentPersonalGreeting`
...
```bash
curl -X GET '/organization/<orgid>/agent-personal-greeting/<id>' \
