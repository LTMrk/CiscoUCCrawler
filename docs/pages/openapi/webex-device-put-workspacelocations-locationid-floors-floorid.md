---
doc_id: webex-device-put-workspacelocations-locationid-floors-floorid
source: webex-openapi-specs/public-spec/webex-device.json
api: Webex Device
api_version: 1.0.0
method: PUT
path: /workspaceLocations/{locationId}/floors/{floorId}
operation_id: Update a Workspace Location Floor
tags: Workspace Locations
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.210784+00:00
---

# PUT /workspaceLocations/{locationId}/floors/{floorId}

> **ENDPOINT DEPRECADO.** No usar en integraciones nuevas.

**API:** Webex Device
**Área:** Workspace Locations
**operationId:** `Update a Workspace Location Floor`
...
```bash
curl -X PUT '/workspaceLocations/<locationId>/floors/<floorId>' \
