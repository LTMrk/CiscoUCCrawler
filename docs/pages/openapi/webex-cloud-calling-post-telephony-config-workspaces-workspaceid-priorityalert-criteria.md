---
doc_id: webex-cloud-calling-post-telephony-config-workspaces-workspaceid-priorityalert-criteria
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/workspaces/{workspaceId}/priorityAlert/criteria
operation_id: Create Priority Alert Criteria for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.391437+00:00
---

# POST /telephony/config/workspaces/{workspaceId}/priorityAlert/criteria

**API:** Webex Cloud Calling
**Área:** Workspace Call Settings (2/2)
**operationId:** `Create Priority Alert Criteria for a Workspace`
...
- `scheduleName` (string) (**requerido**): Name of the location's schedule which determines when the priority alert is in effect.
...
- `notificationEnabled` (boolean) (**requerido**): When set to `true` priority alerting criteria is enabled for calls that meet the current criteria. Criteria with `notificationEnabled` set to `false` take priority.
...
```bash
curl -X POST '/telephony/config/workspaces/<workspaceId>/priorityAlert/criteria' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"scheduleName": "<scheduleName>", "scheduleType": "<scheduleType>", "scheduleLevel": "<scheduleLevel>", "callsFrom": "<callsFrom>", "notificationEnabled": true}'
```
