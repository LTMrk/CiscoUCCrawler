---
doc_id: webex-contact-center-get-organization-orgid-user-profile-id-incoming-references
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/user-profile/{id}/incoming-references
operation_id: getIncomingReferencesUserProfile
tags: User Profiles
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.688772+00:00
---

# GET /organization/{orgid}/user-profile/{id}/incoming-references
...
## Descripción
Retrieve a list of all entities that have reference to an existing user profile by ID in a given organization.
...
```bash
curl -X GET '/organization/<orgid>/user-profile/<id>/incoming-references' \
