---
doc_id: webex-cloud-calling-get-telephony-config-premisepstn-routelists-routelistid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/premisePstn/routeLists/{routeListId}
operation_id: Get a Route List
tags: Call Routing
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:07.951097+00:00
---

# GET /telephony/config/premisePstn/routeLists/{routeListId}
...
```bash
curl -X GET '/telephony/config/premisePstn/routeLists/<routeListId>' \
