---
doc_id: webex-cloud-calling-put-telephony-config-people-personid-simultaneousring-criteria-id
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/people/{personId}/simultaneousRing/criteria/{id}
operation_id: updatePersonSimultaneousRingCriteria
tags: User Call Settings (3/3)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.779562+00:00
---

# PUT /telephony/config/people/{personId}/simultaneousRing/criteria/{id}
...
```bash
curl -X PUT '/telephony/config/people/<personId>/simultaneousRing/criteria/<id>' \
