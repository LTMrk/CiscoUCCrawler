---
doc_id: webex-contact-center-post-v1-tasks-taskid-consult-conference
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: POST
path: /v1/tasks/{taskId}/consult/conference
operation_id: consultConferenceRoute
tags: Tasks
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.710000+00:00
---
...
## Descripción
Access this endpoint when the user has to initiate a conference with the consulting user. Requires one of the following scopes 'cjp:user' or 'cloud-contact-center:pod_conv' for authorization. For a list of possible response messages, see the [Call Control API Guide](/docs/contact-control-apis).
...
- `agentId` (string/UUID): The unique Id of the user logged in as an agent.
...
```bash
curl -X POST '/v1/tasks/<taskId>/consult/conference' \
