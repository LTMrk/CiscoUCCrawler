---
doc_id: webex-contact-center-put-organization-orgid-v2-agent-personal-greeting-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: PUT
path: /organization/{orgid}/v2/agent-personal-greeting/{id}
operation_id: updateV2ConfigAgentPersonalGreeting
tags: Agent Personal Greeting Files
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.775060+00:00
---
...
**operationId:** `updateV2ConfigAgentPersonalGreeting`

## Resumen
Update specific Greeting File by ID

## Descripción
Update an existing Greeting File by ID in a given organization.
...
- `agentPersonalGreetingInfo` (object) (**requerido**): Agent Personal Greeting Agent Personal Greetings With Greeting Purpose schema.
...
```bash
curl -X PUT '/organization/<orgid>/v2/agent-personal-greeting/<id>' \
