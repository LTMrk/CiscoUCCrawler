...
operation_id: getAllCSQGroupedAssistantSkillContactServiceQueue
tags: Contact Service Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.656036+00:00
---
...
```bash
curl -X POST '/organization/<orgid>/v2/contact-service-queue/fetch-by-grouped-assistant-skill' \
...
- `data` (array): List of Data.
  ...
  - `associatedQueueCount` (integer/int64): Number of queues mapped to this Assistant Skill ID
  - `lastAssistantSkillUpdatedTime` (integer/int64): Last updated time Assistant Skill mapping i.e. timestamp corresponding to most recently added queue mapping
