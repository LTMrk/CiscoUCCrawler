---
doc_id: webex-cloud-calling-put-telephony-config-workspaces-workspaceid-selectiveforward-criteria-id
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/workspaces/{workspaceId}/selectiveForward/criteria/{id}
operation_id: Modify Selective Forward Criteria for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.814272+00:00
---

# PUT /telephony/config/workspaces/{workspaceId}/selectiveForward/criteria/{id}
...
```bash
curl -X PUT '/telephony/config/workspaces/<workspaceId>/selectiveForward/criteria/<id>' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"callsFrom": "<callsFrom>"}'
```
