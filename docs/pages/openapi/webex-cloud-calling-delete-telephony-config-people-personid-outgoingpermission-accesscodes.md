---
doc_id: webex-cloud-calling-delete-telephony-config-people-personid-outgoingpermission-accesscodes
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/people/{personId}/outgoingPermission/accessCodes
operation_id: deleteAccessCodesForPerson
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.762154+00:00
---

# DELETE /telephony/config/people/{personId}/outgoingPermission/accessCodes

**API:** Webex Cloud Calling
**Área:** User Call Settings (2/2)
**operationId:** `deleteAccessCodesForPerson`
...
```bash
curl -X DELETE '/telephony/config/people/<personId>/outgoingPermission/accessCodes' \
