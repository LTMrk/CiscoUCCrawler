---
doc_id: webex-cloud-calling-post-telephony-config-jobs-devices-rebuildphones
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/jobs/devices/rebuildPhones
operation_id: rebuildPhonesConfiguration
tags: Device Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.001020+00:00
---
...
## Parámetros
- `orgId` [query] (string): Rebuild phones for this organization.
...
```bash
curl -X POST '/telephony/config/jobs/devices/rebuildPhones' \
