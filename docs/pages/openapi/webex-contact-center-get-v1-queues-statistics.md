...
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:32.959950+00:00
---
...
- **200**: OK
  ...
  - `data` (array) **(requerido)**: List of Queue statistics records retrieved according to query parameters.
    ...
    - `serviceLevelThresholdPercentage` (number): The Service Level threshold % is an aggregate percentage based on how many contacts out of the total handled have met the service level value and gives an indication of the timely pick-up of contacts by agents.
