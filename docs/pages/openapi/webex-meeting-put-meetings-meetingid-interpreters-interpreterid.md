...
operation_id: updateInterpreterById
tags: Meetings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.488477+00:00
---
...
```bash
curl -X PUT '/meetings/<meetingId>/interpreters/<interpreterId>' \
...
```json
{
  "message": "'marcus.tuchel@example.com' is found in more than one interpreter.",
