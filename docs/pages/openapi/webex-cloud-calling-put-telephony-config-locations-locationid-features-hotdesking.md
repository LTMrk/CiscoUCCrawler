---
doc_id: webex-cloud-calling-put-telephony-config-locations-locationid-features-hotdesking
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/locations/{locationId}/features/hotDesking
operation_id: Update Voice Portal Hot desking sign in details for a location
tags: Features: Hot Desking Sign-in via Voice Portal
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.708810+00:00
---
...
**operationId:** `Update Voice Portal Hot desking sign in details for a location`
...
```bash
curl -X PUT '/telephony/config/locations/<locationId>/features/hotDesking' \
