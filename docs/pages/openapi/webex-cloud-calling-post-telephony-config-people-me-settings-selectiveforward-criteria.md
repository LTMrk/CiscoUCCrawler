...
operation_id: createMySelectiveCallForwardCriteria
tags: Call Settings For Me With UserHub Phase2
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.374275+00:00
---
...
```bash
curl -X POST '/telephony/config/people/me/settings/selectiveForward/criteria' \
