---
doc_id: webex-contact-center-put-organization-orgid-agent-profile-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: PUT
path: /organization/{orgid}/agent-profile/{id}
operation_id: updateConfigDesktopProfile
tags: Desktop Profile
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T18:15:55.085980+00:00
---
...
**operationId:** `updateConfigDesktopProfile`
...
- `agentProfileDTO` [query] (object) (**requerido**): Agent profile configuration data for update

## Ejemplo de invocación
```bash
curl -X PUT '/organization/<orgid>/agent-profile/<id>?agentProfileDTO=<agentProfileDTO>' \
