---
doc_id: webex-cloud-calling-put-telephony-config-virtuallines-virtuallineid-donotdisturb
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/virtualLines/{virtualLineId}/doNotDisturb
operation_id: Put VirtualLine DoNotDisturb
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.400394+00:00
---

# PUT /telephony/config/virtualLines/{virtualLineId}/doNotDisturb
...
```bash
curl -X PUT '/telephony/config/virtualLines/<virtualLineId>/doNotDisturb' \
