---
doc_id: webex-cloud-calling-put-telephony-config-workspaces-workspaceid-privacy
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/workspaces/{workspaceId}/privacy
operation_id: Modify Privacy Settings for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.411318+00:00
---

# PUT /telephony/config/workspaces/{workspaceId}/privacy
...
```bash
curl -X PUT '/telephony/config/workspaces/<workspaceId>/privacy' \
