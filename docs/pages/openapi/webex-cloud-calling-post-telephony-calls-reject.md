---
doc_id: webex-cloud-calling-post-telephony-calls-reject
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.331807+00:00
---
...
- `callId` (string) (**requerido**): The call identifier of the call to be rejected.
- `action` (object): The rejection action to apply to the call. The busy action is applied if no specific action is provided.
...
```bash
curl -X POST '/telephony/calls/reject' \
