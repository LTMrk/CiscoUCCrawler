---
doc_id: webex-cloud-calling-get-telephony-config-workspaces-workspaceid-monitoring-availablemembers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/workspaces/{workspaceId}/monitoring/availableMembers
operation_id: getAvailableMembersForWorkspaceMonitoring
tags: Workspace Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.588469+00:00
---
...
**operationId:** `getAvailableMembersForWorkspaceMonitoring`

## Resumen
Get Available Members for Workspace Monitoring

## Descripción
Get available members for workspace monitoring. This API allows administrators to retrieve a list of members that can be added to the monitoring list for a specific workspace.
...
```bash
curl -X GET '/telephony/config/workspaces/<workspaceId>/monitoring/availableMembers' \
