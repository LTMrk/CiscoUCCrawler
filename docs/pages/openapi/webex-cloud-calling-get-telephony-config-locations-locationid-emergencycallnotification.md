---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-emergencycallnotification
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/emergencyCallNotification
operation_id: Get a Location Emergency Call Notification
tags: Emergency Services Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.243452+00:00
---

# GET /telephony/config/locations/{locationId}/emergencyCallNotification

**API:** Webex Cloud Calling
**Área:** Emergency Services Settings
**operationId:** `Get a Location Emergency Call Notification`
...
## Parámetros
- `locationId` [path] (string) (**requerido**): Retrieve Emergency Call Notification attributes for this location.
- `orgId` [query] (string): Retrieve Emergency Call Notification attributes for the location in this organization.

## Ejemplo de invocación
```bash
curl -X GET '/telephony/config/locations/<locationId>/emergencyCallNotification' \
...
```json
{
  ...
  "emailAddress": "callback@gmail.com",
  "organization": {
    "emergencyCallNotificationEnabled": true,
