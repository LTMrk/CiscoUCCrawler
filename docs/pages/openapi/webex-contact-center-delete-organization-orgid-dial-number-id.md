---
doc_id: webex-contact-center-delete-organization-orgid-dial-number-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: DELETE
path: /organization/{orgid}/dial-number/{id}
operation_id: deleteConfig_14
tags: Dial Number
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T18:15:55.089729+00:00
---
...
```bash
curl -X DELETE '/organization/<orgid>/dial-number/<id>' \
