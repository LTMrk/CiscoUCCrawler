---
doc_id: webex-contact-center-post-organization-orgid-asset
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: POST
path: /organization/{orgid}/asset
operation_id: createConfigAsset
tags: Asset
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-15T15:08:16.239043+00:00
---

# POST /organization/{orgid}/asset

**API:** Webex Contact Center
**Área:** Asset
**operationId:** `createConfigAsset`

## Resumen
Create a new Asset

## Descripción
Create a new Asset in a given organization. Supports work item assets with the specified channel and data schema.
...
```bash
curl -X POST '/organization/<orgid>/asset' \
