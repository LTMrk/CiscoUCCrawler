---
doc_id: webex-contact-center-get-organization-orgid-user-id-incoming-references
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/user/{id}/incoming-references
operation_id: getIncomingReferencesUser
tags: Users
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.839077+00:00
---
...
**API:** Webex Contact Center
**Área:** Users
**operationId:** `getIncomingReferencesUser`
...
```bash
curl -X GET '/organization/<orgid>/user/<id>/incoming-references' \
