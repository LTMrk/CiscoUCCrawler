...
operation_id: Read Do Not Disturb Settings for a Person
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.325009+00:00
---
...
```bash
curl -X GET '/people/<personId>/features/doNotDisturb' \
