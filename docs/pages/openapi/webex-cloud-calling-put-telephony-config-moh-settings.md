---
doc_id: webex-cloud-calling-put-telephony-config-moh-settings
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/moh/settings
operation_id: Update the organization Music on Hold configuration
tags: Calling Service Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:07.984558+00:00
---
...
## Parámetros
- `orgId` [query] (string): Patch Music on Hold for this organization.
...
```bash
curl -X PUT '/telephony/config/moh/settings' \
