---
doc_id: webex-cloud-calling-get-telephony-config-jobs-numbers-managenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/jobs/numbers/manageNumbers
operation_id: List Manage Numbers Jobs
tags: Numbers
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.131939+00:00
---
...
**API:** Webex Cloud Calling
**Área:** Numbers
**operationId:** `List Manage Numbers Jobs`
...
## Parámetros
- `orgId` [query] (string): Retrieve list of Manage Number jobs for this organization.
- `start` [query] (integer): Start at the zero-based offset in the list of jobs. Default is 0.
- `max` [query] (integer): Limit the number of jobs returned to this maximum count. Default is 2000.

## Ejemplo de invocación
```bash
curl -X GET '/telephony/config/jobs/numbers/manageNumbers' \
...
```json
{
  "items": [
    {
      "id": "Y2lzY29zcGFyazovL3VzL0pPQl9JRC84YTI0ZjM5NC1lMTdjLTRiMTYtOTU3Ni0zNzA3YjY5YmU3Mzc",
      "jobType": "managenumbers",
      "trackingId": "ROUTER_6332CCCB-E492-01BB-0165-48A3DC0A0165",
      ...
      "jobExecutionStatus": [
        {
          "id": 252158,
          "startTime": "2022-09-27T10:13:43.130Z",
          "endTime": "2022-09-27T10:13:47.191Z",
          "lastUpdated": "2022-09-27T10:13:47.595Z",
          "statusMessage": "COMPLETED",
          "exitCode": "COMPLETED",
          "createdTime": "2022-09-27T10:13:43.106Z",
          "stepExecutionStatuses": [
            {
              "id": 1224428,
              "startTime": "2022-09-27T10:13:43.404Z",
              "endTime": "2022-09-27T10:13:44.664Z",
              "lastUpdated": "2022-09-27T10:13:44.664Z",
              "statusMessage": "COMPLETED",
              "exitCode": "COMPLETED",
            ...
            {
              "id": 1224429,
              "startTime": "2022-09-27T10:13:44.684Z",
              "endTime": "2022-09-27T10:1
  ... (truncado)
```
