---
doc_id: webex-cloud-calling-get-people-personid-features-incomingpermission
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /people/{personId}/features/incomingPermission
operation_id: Read Incoming Permission Settings for a Person
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.145829+00:00
---

# GET /people/{personId}/features/incomingPermission

**API:** Webex Cloud Calling
**Área:** User Call Settings (1/2)
**operationId:** `Read Incoming Permission Settings for a Person`
...
```bash
curl -X GET '/people/<personId>/features/incomingPermission' \
