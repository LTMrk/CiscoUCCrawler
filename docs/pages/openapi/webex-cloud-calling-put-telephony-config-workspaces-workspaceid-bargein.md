---
doc_id: webex-cloud-calling-put-telephony-config-workspaces-workspaceid-bargein
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/workspaces/{workspaceId}/bargeIn
operation_id: Modify Barge In Call Settings for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.380717+00:00
---

# PUT /telephony/config/workspaces/{workspaceId}/bargeIn

**API:** Webex Cloud Calling
**Área:** Workspace Call Settings (2/2)
**operationId:** `Modify Barge In Call Settings for a Workspace`
...
- `enabled` (boolean) (**requerido**): `true` if the Barge In feature is enabled.
...
```bash
curl -X PUT '/telephony/config/workspaces/<workspaceId>/bargeIn' \
