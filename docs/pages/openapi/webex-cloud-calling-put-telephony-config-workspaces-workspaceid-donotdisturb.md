---
doc_id: webex-cloud-calling-put-telephony-config-workspaces-workspaceid-donotdisturb
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/workspaces/{workspaceId}/doNotDisturb
operation_id: Modify DoNotDisturb Settings for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.381149+00:00
---
...
**operationId:** `Modify DoNotDisturb Settings for a Workspace`
...
```bash
curl -X PUT '/telephony/config/workspaces/<workspaceId>/doNotDisturb' \
