---
doc_id: webex-meeting-get-meetings-sessiontypes-sessiontypeid
source: webex-openapi-specs/public-spec/webex-meeting.json
api: Webex Meetings
api_version: 1.0.0
method: GET
path: /meetings/sessionTypes/{sessionTypeId}
operation_id: getMeetingSessionTypeById
tags: Meetings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.484074+00:00
---

# GET /meetings/sessionTypes/{sessionTypeId}
...
## Parámetros
- `sessionTypeId` [path] (number) (**requerido**): A unique identifier for the sessionType.
- `hostEmail` [query] (string): Email address for the user. This parameter is only used if the user or application calling the API has the admin-level scopes. If set, the admin may specify the email of a user in a site they manage and the API will get a meeting session type with the specified session type ID enabled for the user.
...
```bash
curl -X GET '/meetings/sessionTypes/<sessionTypeId>' \
