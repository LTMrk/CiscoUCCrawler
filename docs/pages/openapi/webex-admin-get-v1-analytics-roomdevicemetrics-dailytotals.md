...
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:32.150671+00:00
---
...
## Parámetros
- `from` [query] (string): Starting UTC Date from which historical data should be returned.
- `to` [query] (string): Ending UTC Date for which data should be returned.
