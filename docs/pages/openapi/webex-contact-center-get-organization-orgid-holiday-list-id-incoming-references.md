---
doc_id: webex-contact-center-get-organization-orgid-holiday-list-id-incoming-references
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/holiday-list/{id}/incoming-references
operation_id: getIncomingReferencesHolidayList
tags: Holiday List
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.714710+00:00
---
...
**API:** Webex Contact Center
**Área:** Holiday List
**operationId:** `getIncomingReferencesHolidayList`
...
```bash
curl -X GET '/organization/<orgid>/holiday-list/<id>/incoming-references' \
