...
operation_id: getCSQByUserIDForAgentBasedQueueContactServiceQueue
tags: Contact Service Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-20T13:57:48.682144+00:00
---
...
```bash
curl -X GET '/organization/<orgid>/v2/contact-service-queue/by-user-id/<userid>/agent-based-queues' \
