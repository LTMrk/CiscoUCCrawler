---
doc_id: webex-cloud-calling-post-telephony-config-virtuallines-virtuallineid-outgoingpermission-accesscodes
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/virtualLines/{virtualLineId}/outgoingPermission/accessCodes
operation_id: Create Access Codes for a Virtual Line
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.359746+00:00
---

# POST /telephony/config/virtualLines/{virtualLineId}/outgoingPermission/accessCodes

**API:** Webex Cloud Calling
**Área:** Virtual Line Call Settings
**operationId:** `Create Access Codes for a Virtual Line`
...
- `code` (string) (**requerido**): An Access code.
- `description` (string) (**requerido**): The description of the access code.
...
```bash
curl -X POST '/telephony/config/virtualLines/<virtualLineId>/outgoingPermission/accessCodes' \
