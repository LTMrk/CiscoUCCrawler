---
doc_id: webex-cloud-calling-post-people
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.743697+00:00
---
...
- `minResponse` [query] (boolean): Set to `true` to improve performance by omitting person details and returning only the ID in the response when successful. If unsuccessful the response will have optional error details. Por defecto: False.
