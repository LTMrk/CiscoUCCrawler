---
doc_id: webex-cloud-calling-delete-telephony-config-workspaces-workspaceid-sequentialring-criteria-id
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/workspaces/{workspaceId}/sequentialRing/criteria/{id}
operation_id: Delete Sequential Ring Criteria for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.200449+00:00
---

# DELETE /telephony/config/workspaces/{workspaceId}/sequentialRing/criteria/{id}

**API:** Webex Cloud Calling
**Área:** Workspace Call Settings (2/2)
**operationId:** `Delete Sequential Ring Criteria for a Workspace`
...
```bash
curl -X DELETE '/telephony/config/workspaces/<workspaceId>/sequentialRing/criteria/<id>' \
