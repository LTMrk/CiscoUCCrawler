---
doc_id: webex-cloud-calling-get-people-personid-features-executiveassistant
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /people/{personId}/features/executiveAssistant
operation_id: Retrieve Executive Assistant Settings for a Person
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.539998+00:00
---

# GET /people/{personId}/features/executiveAssistant

**API:** Webex Cloud Calling
**Área:** User Call Settings (1/2)
**operationId:** `Retrieve Executive Assistant Settings for a Person`
...
```bash
curl -X GET '/people/<personId>/features/executiveAssistant' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `type` (string): The Executive Assistant type.  * `UNASSIGNED` - The feature is not enabled.  * `EXECUTIVE` - The feature is enabled and the person is an Executive.  * `EXECUTIVE_ASSISTANT` - The feature is enabled and the person is an Executive Assistant. Valores: UNASSIGNED, EXECUTIVE, EXECUTIVE_ASSISTANT.
