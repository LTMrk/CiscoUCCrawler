...
operation_id: Retrieve Selective Reject Settings for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.809999+00:00
---
...
```bash
curl -X GET '/telephony/config/workspaces/<workspaceId>/selectiveReject' \
