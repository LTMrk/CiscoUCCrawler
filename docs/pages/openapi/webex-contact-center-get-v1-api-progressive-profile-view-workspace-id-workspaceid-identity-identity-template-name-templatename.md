---
doc_id: webex-contact-center-get-v1-api-progressive-profile-view-workspace-id-workspaceid-identity-identity-template-name-templatename
...
operation_id: getProgressiveProfileViewByIdentityAndTemplateName
tags: Journey - Profile Creation & Insights API
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.816172+00:00
---

# GET /v1/api/progressive-profile-view/workspace-id/{workspaceId}/identity/{identity}/template-name/{templateName}
...
```bash
curl -X GET '/v1/api/progressive-profile-view/workspace-id/<workspaceId>/identity/<identity>/template-name/<templateName>' \
