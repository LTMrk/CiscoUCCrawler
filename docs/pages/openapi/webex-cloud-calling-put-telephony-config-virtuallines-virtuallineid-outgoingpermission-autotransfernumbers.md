...
operation_id: Modify Transfer Numbers for a Virtual Line
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.178576+00:00
---
...
```bash
curl -X PUT '/telephony/config/virtualLines/<virtualLineId>/outgoingPermission/autoTransferNumbers' \
