...
operation_id: Get Virtual Line Call Forward Available Phone Numbers
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.184931+00:00
---
...
```bash
curl -X GET '/telephony/config/virtualLines/<virtualLineId>/callForwarding/availableNumbers' \
