---
doc_id: webex-cloud-calling-put-telephony-config-people-me-schedules-scheduletype-scheduleid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/people/me/schedules/{scheduleType}/{scheduleId}
operation_id: updateMySchedule
tags: Call Settings For Me With UserHub Phase2
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.369667+00:00
---

# PUT /telephony/config/people/me/schedules/{scheduleType}/{scheduleId}
...
- `scheduleId` [path] (string) (**requerido**): Update the schedule with the matching ID.
...
```bash
curl -X PUT '/telephony/config/people/me/schedules/<scheduleType>/<scheduleId>' \
...
**204**: Schedule Configurations updated successfully for the authenticated user.
