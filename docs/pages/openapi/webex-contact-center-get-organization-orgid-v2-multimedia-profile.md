---
doc_id: webex-contact-center-get-organization-orgid-v2-multimedia-profile
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/v2/multimedia-profile
operation_id: getAllConfigWithMetaData_13
tags: Multimedia Profile
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.673261+00:00
---
...
**operationId:** `getAllConfigWithMetaData_13`
...
```bash
curl -X GET '/organization/<orgid>/v2/multimedia-profile' \
