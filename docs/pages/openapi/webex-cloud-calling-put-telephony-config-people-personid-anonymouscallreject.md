---
doc_id: webex-cloud-calling-put-telephony-config-people-personid-anonymouscallreject
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/people/{personId}/anonymousCallReject
operation_id: updatePersonAnonymousCallRejectSettings
tags: User Call Settings (3/3)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.778380+00:00
---

# PUT /telephony/config/people/{personId}/anonymousCallReject
...
- `enabled` (boolean) (**requerido**): Enable or disable Anonymous Call Rejection. When set to true, incoming calls from callers who have blocked their caller ID will be automatically rejected.
...
```bash
curl -X PUT '/telephony/config/people/<personId>/anonymousCallReject' \
