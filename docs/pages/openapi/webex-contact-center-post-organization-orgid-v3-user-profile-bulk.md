---
doc_id: webex-contact-center-post-organization-orgid-v3-user-profile-bulk
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: POST
path: /organization/{orgid}/v3/user-profile/bulk
operation_id: saveAllConfigUserProfileGranularAccess
tags: User Profiles
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.690021+00:00
---

# POST /organization/{orgid}/v3/user-profile/bulk
...
## Descripción
Create, Update or delete user profiles in bulk in a given organization.
...
- `items` (array): List of items in the bulk request.
  ...
  - `item` (object): Data Transfer Object for creating or updating a user profile with granular access controls.
...
```bash
curl -X POST '/organization/<orgid>/v3/user-profile/bulk' \
