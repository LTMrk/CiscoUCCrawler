...
operation_id: Validate an external phone number
tags: Features: Virtual Extensions
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.059108+00:00
---
...
```bash
curl -X POST '/telephony/config/virtualExtensions/actions/validateNumbers/invoke' \
