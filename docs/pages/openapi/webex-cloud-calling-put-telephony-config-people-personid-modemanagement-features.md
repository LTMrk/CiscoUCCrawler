---
doc_id: webex-cloud-calling-put-telephony-config-people-personid-modemanagement-features
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/people/{personId}/modeManagement/features
operation_id: assignListOfFeaturesToAUserModeManagement
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.769860+00:00
---

# PUT /telephony/config/people/{personId}/modeManagement/features
...
- `featureIds` (array) (**requerido**): Array of feature IDs.
...
```bash
curl -X PUT '/telephony/config/people/<personId>/modeManagement/features' \
