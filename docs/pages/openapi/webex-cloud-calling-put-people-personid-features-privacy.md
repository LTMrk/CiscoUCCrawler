---
doc_id: webex-cloud-calling-put-people-personid-features-privacy
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /people/{personId}/features/privacy
operation_id: Configure Privacy Settings for a Person
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.542814+00:00
---

# PUT /people/{personId}/features/privacy

**API:** Webex Cloud Calling
**Área:** User Call Settings (1/2)
**operationId:** `Configure Privacy Settings for a Person`
...
- `aaNamingDialingEnabled` (boolean): When `true` auto attendant dailing by first or last name is enabled.
...
```bash
curl -X PUT '/people/<personId>/features/privacy' \
