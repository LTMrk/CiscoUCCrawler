---
doc_id: webex-cloud-calling-post-telephony-config-locations-locationid-autoattendants-autoattendantid-callforwarding-actions-switchmode-invoke
...
operation_id: switchAutoAttendantCallForwardingMode
tags: Features:  Auto Attendant
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.291546+00:00
---

# POST /telephony/config/locations/{locationId}/autoAttendants/{autoAttendantId}/callForwarding/actions/switchMode/invoke
...
- `autoAttendantId` [path] (string) (**requerido**): Switch operating mode to normal operations for this `auto attendant`.
- `orgId` [query] (string): Switch operating mode as per normal operations for the `auto attendant` from this organization.
...
```bash
curl -X POST '/telephony/config/locations/<locationId>/autoAttendants/<autoAttendantId>/callForwarding/actions/switchMode/invoke' \
