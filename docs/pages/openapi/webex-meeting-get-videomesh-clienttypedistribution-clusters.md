---
doc_id: webex-meeting-get-videomesh-clienttypedistribution-clusters
source: webex-openapi-specs/public-spec/webex-meeting.json
api: Webex Meetings
api_version: 1.0.0
method: GET
path: /videoMesh/clientTypeDistribution/clusters
operation_id: Get Cluster Client Type Distribution details
tags: Video Mesh
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.508316+00:00
---

# GET /videoMesh/clientTypeDistribution/clusters
...
```bash
curl -X GET '/videoMesh/clientTypeDistribution/clusters?clusterId=<clusterId>&from=<from>&to=<to>&deviceType=<deviceType>' \
  ...
  - `items` (array): Client Type Distribution details for the organization.
    - (cualquiera de:)
      ...
      - `clusters` (array):
        ...
        - `clientTypeDistributionDetails` (array): Client Type Distribution Details.
      - `timestamp` (string): Timestamp.
      - `clusters` (array):
        - `clusterId` (string): ID of the Video Mesh cluster.
        - `clusterName` (string): Name of the Video Mesh cluster.
