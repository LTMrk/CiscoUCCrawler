---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-queues-queueid-dnis-settings
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/queues/{queueId}/dnis/settings
operation_id: getDnisSettingsForACallQueue
tags: Features:  Call Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.699489+00:00
---

# GET /telephony/config/locations/{locationId}/queues/{queueId}/dnis/settings

**API:** Webex Cloud Calling
**Área:** Features:  Call Queue
**operationId:** `getDnisSettingsForACallQueue`
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/queues/<queueId>/dnis/settings' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `distinctiveRingingEnabled` (boolean) (**requerido**): Whether distinctive ringing is enabled for the queue.
- `displayDnisNameAndNumberEnabled` (boolean) (**requerido**): Whether the DNIS name and number is displayed to agents.
