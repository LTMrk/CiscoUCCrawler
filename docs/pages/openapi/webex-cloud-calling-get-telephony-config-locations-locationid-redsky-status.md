...
operation_id: Get a Location's RedSky Compliance Status
tags: Emergency Services Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.415054+00:00
---
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/redSky/status' \
