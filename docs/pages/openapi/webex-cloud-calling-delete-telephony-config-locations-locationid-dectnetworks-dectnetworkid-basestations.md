---
doc_id: webex-cloud-calling-delete-telephony-config-locations-locationid-dectnetworks-dectnetworkid-basestations
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/locations/{locationId}/dectNetworks/{dectNetworkId}/baseStations
operation_id: Delete Bulk DECT Network Base Stations
tags: DECT Devices Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.117064+00:00
---

# DELETE /telephony/config/locations/{locationId}/dectNetworks/{dectNetworkId}/baseStations
...
- `dectNetworkId` [path] (string) (**requerido**): Delete all the base stations in the specified DECT network ID.
- `orgId` [query] (string): Organization containing the DECT network.

## Ejemplo de invocación
```bash
curl -X DELETE '/telephony/config/locations/<locationId>/dectNetworks/<dectNetworkId>/baseStations' \
