---
doc_id: webex-cloud-calling-post-locations-locationid-floors
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /locations/{locationId}/floors
operation_id: createLocationFloor
tags: Locations
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.525955+00:00
---
...
**API:** Webex Cloud Calling
**Área:** Locations
**operationId:** `createLocationFloor`
...
```bash
curl -X POST '/locations/<locationId>/floors' \
