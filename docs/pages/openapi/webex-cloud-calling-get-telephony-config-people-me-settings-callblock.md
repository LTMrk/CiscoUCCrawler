---
doc_id: webex-cloud-calling-get-telephony-config-people-me-settings-callblock
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/me/settings/callBlock
operation_id: getMyCallBlockSettings
tags: Call Settings For Me
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.152184+00:00
---
...
```bash
curl -X GET '/telephony/config/people/me/settings/callBlock' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `numbers` (array) (**requerido**): Numbers for the call block list.
  - `id` (string) (**requerido**): Unique identifier of the phone number.
  - `phoneNumber` (string) (**requerido**): Phone number which is blocked by user.
