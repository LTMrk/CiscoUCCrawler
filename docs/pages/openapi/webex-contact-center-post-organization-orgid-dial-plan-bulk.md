---
doc_id: webex-contact-center-post-organization-orgid-dial-plan-bulk
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: POST
path: /organization/{orgid}/dial-plan/bulk
operation_id: saveAllConfigDialPlan
tags: Dial Plan
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.751832+00:00
---
...
**API:** Webex Contact Center
**Área:** Dial Plan
**operationId:** `saveAllConfigDialPlan`

## Resumen
Bulk save Dial Plans

## Descripción
Create, Update or delete Dial Plans in bulk in a given organization.
...
```bash
curl -X POST '/organization/<orgid>/dial-plan/bulk' \
