---
doc_id: webex-contact-center-get-organization-orgid-asset-id-incoming-references
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/asset/{id}/incoming-references
operation_id: getIncomingReferencesAsset
tags: Asset
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-15T15:08:16.241057+00:00
---
...
**API:** Webex Contact Center
**Área:** Asset
**operationId:** `getIncomingReferencesAsset`

## Resumen
List references for a specific Asset

## Descripción
Retrieve a list of all entities that have reference to an existing Asset by ID in a given organization. For example, Entry Points.
...
```bash
curl -X GET '/organization/<orgid>/asset/<id>/incoming-references' \
