---
doc_id: webex-cloud-calling-get-telephony-config-people-me-settings-selectivereject-criteria-id
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/me/settings/selectiveReject/criteria/{id}
operation_id: getMySelectiveRejectCriteriaSettings
tags: Call Settings For Me With UserHub Phase3
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.165130+00:00
---
...
```bash
curl -X GET '/telephony/config/people/me/settings/selectiveReject/criteria/<id>' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: Selective Call Reject Criteria Settings retrieved for the authenticated user.
