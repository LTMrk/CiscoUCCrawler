---
doc_id: webex-cloud-calling-put-telephony-config-locations-locationid-voicemail
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/locations/{locationId}/voicemail
operation_id: Update Location Voicemail
tags: Location Call Settings:  Voicemail
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.735277+00:00
---
...
## Parámetros
- `locationId` [path] (string) (**requerido**): Update voicemail settings for this location.
...
```bash
curl -X PUT '/telephony/config/locations/<locationId>/voicemail' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"voicemailTranscriptionEnabled": true}'
```
