---
doc_id: webex-cloud-calling-get-telephony-config-virtuallines-virtuallineid-callrecording
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/virtualLines/{virtualLineId}/callRecording
operation_id: Read Call Recording Settings for a Virtual Line
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.570069+00:00
---

# GET /telephony/config/virtualLines/{virtualLineId}/callRecording
...
This API requires a full, user, read-only, or location administrator auth token with the `spark-admin:telephony_config_read` scope.
...
```bash
curl -X GET '/telephony/config/virtualLines/<virtualLineId>/callRecording' \
