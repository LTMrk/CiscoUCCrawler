...
operation_id: Retrieve Call Bridge Warning Tone Settings for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.596922+00:00
---
...
```bash
curl -X GET '/telephony/config/workspaces/<workspaceId>/callBridge' \
