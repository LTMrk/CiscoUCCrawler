---
doc_id: webex-cloud-calling-get-telephony-config-people-personid-anonymouscallreject
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/{personId}/anonymousCallReject
operation_id: getPersonAnonymousCallRejectSettings
tags: User Call Settings (3/3)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.566107+00:00
---

# GET /telephony/config/people/{personId}/anonymousCallReject
...
```bash
curl -X GET '/telephony/config/people/<personId>/anonymousCallReject' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `enabled` (boolean) (**requerido**): Indicates whether Anonymous Call Rejection is enabled. When true, incoming calls from callers who have blocked their caller ID will be automatically rejected.
