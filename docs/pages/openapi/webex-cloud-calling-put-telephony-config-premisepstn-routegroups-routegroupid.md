...
operation_id: Modify a Route Group for a Organization
tags: Call Routing
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.137318+00:00
---
...
```bash
curl -X PUT '/telephony/config/premisePstn/routeGroups/<routeGroupId>' \
