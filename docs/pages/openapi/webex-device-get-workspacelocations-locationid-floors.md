---
doc_id: webex-device-get-workspacelocations-locationid-floors
source: webex-openapi-specs/public-spec/webex-device.json
api: Webex Device
api_version: 1.0.0
method: GET
path: /workspaceLocations/{locationId}/floors
operation_id: List Workspace Location Floors
tags: Workspace Locations
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.210282+00:00
---

# GET /workspaceLocations/{locationId}/floors
...
```bash
curl -X GET '/workspaceLocations/<locationId>/floors' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `items` (array): An array of floor objects.
