...
operation_id: getConfig_4
tags: Skill Profile
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-20T13:57:48.710896+00:00
---
...
- `includeSkillDetails` [query] (boolean): If set to true returns skill details Por defecto: False.

## Ejemplo de invocación
```bash
curl -X GET '/organization/<orgid>/skill-profile/<id>' \
