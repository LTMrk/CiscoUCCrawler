---
doc_id: webex-contact-center-put-organization-orgid-site-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: PUT
path: /organization/{orgid}/site/{id}
operation_id: updateConfig_8
tags: Site
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.715373+00:00
---

# PUT /organization/{orgid}/site/{id}
...
## Descripción
Update an existing Site by ID in a given organization.
...
```bash
curl -X PUT '/organization/<orgid>/site/<id>' \
