---
doc_id: webex-cloud-calling-put-telephony-config-people-me-settings-selectiveforward
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/people/me/settings/selectiveForward
operation_id: updateMySelectiveForwardSettings
tags: Call Settings For Me With UserHub Phase2
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.197417+00:00
---
...
**operationId:** `updateMySelectiveForwardSettings`
...
{
  "enabled": false,
  "defaultForwardToPhoneNumber": "+16175550100",
...
```bash
curl -X PUT '/telephony/config/people/me/settings/selectiveForward' \
...
**204**: Selective Call Forward Settings updated successfully for the authenticated user.
