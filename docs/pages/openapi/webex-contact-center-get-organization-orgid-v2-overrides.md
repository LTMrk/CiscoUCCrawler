...
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:32.927295+00:00
---
...
- `sort` [query] (string): Sorting criteria in the format: property(, asc | desc). Default sort order is ascending. Supported sortable fields (name, timezone, createdTime, lastUpdatedTime).    The examples below show some sort queries - name,asc - createdTime,desc
- `includeLatestOverride` [query] (boolean): Enable the flag to get the latest Override
