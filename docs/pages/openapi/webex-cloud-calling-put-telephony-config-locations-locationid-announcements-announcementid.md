---
doc_id: webex-cloud-calling-put-telephony-config-locations-locationid-announcements-announcementid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/locations/{locationId}/announcements/{announcementId}
operation_id: Modify a binary announcement greeting at location level
tags: Features: Announcement Repository
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.017406+00:00
---

# PUT /telephony/config/locations/{locationId}/announcements/{announcementId}

**API:** Webex Cloud Calling
**Área:** Features: Announcement Repository
**operationId:** `Modify a binary announcement greeting at location level`
...
- `orgId` [query] (string): Modify an announcement for location in this organization.
...
```bash
curl -X PUT '/telephony/config/locations/<locationId>/announcements/<announcementId>' \
