...
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:32.595976+00:00
---
...
- `fileUri` (string) **(requerido)**: URI of the announcement file.
- `fileName` (string) **(requerido)**: File name of the announcement.
