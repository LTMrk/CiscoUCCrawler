---
doc_id: webex-device-get-workspacelocations-locationid
source: webex-openapi-specs/public-spec/webex-device.json
api: Webex Device
api_version: 1.0.0
method: GET
path: /workspaceLocations/{locationId}
operation_id: Get a Workspace Location Details
tags: Workspace Locations
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.209691+00:00
---

# GET /workspaceLocations/{locationId}
...
```bash
curl -X GET '/workspaceLocations/<locationId>' \
