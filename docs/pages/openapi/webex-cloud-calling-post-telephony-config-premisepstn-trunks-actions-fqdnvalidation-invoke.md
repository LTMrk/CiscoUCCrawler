...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.135328+00:00
---
...
**API:** Webex Cloud Calling
**Área:** Call Routing
**operationId:** `Validate Local Gateway FQDN and Domain for a Trunk`
...
## Parámetros
- `orgId` [query] (string): Organization to which trunk types belongs.
