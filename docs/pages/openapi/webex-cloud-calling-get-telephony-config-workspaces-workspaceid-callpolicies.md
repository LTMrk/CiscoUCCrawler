...
operation_id: Read Call Policy Settings for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.412753+00:00
---
...
```bash
curl -X GET '/telephony/config/workspaces/<workspaceId>/callPolicies' \
