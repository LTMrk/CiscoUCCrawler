---
doc_id: webex-cloud-calling-get-telephony-config-virtuallines-virtuallineid-callwaiting
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/virtualLines/{virtualLineId}/callWaiting
operation_id: Read Call Waiting Settings for a Virtual Line
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.357587+00:00
---

# GET /telephony/config/virtualLines/{virtualLineId}/callWaiting

**API:** Webex Cloud Calling
**Área:** Virtual Line Call Settings
**operationId:** `Read Call Waiting Settings for a Virtual Line`
...
Retrieving the call waiting settings for a virtual line requires a full, user, read-only administrator, or location administrator auth token with a scope of `spark-admin:telephony_config_read`.
...
```bash
curl -X GET '/telephony/config/virtualLines/<virtualLineId>/callWaiting' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `enabled` (boolean) (**requerido**): `true` if the Call Waiting feature is enabled.
