---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-voiceportal-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/voicePortal/availableNumbers
operation_id: Get VoicePortal Available Phone Numbers
tags: Location Call Settings:  Voicemail
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.737673+00:00
---
...
**operationId:** `Get VoicePortal Available Phone Numbers`

## Resumen
Get VoicePortal Available Phone Numbers

## Descripción
List the service and standard PSTN numbers that are available to be assigned as the location voice portal's phone number.
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/voicePortal/availableNumbers' \
