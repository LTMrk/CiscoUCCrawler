---
doc_id: webex-cloud-calling-get-people-personid-features-schedules-scheduletype-scheduleid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /people/{personId}/features/schedules/{scheduleType}/{scheduleId}
operation_id: Get a Schedule Details
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.757225+00:00
---

# GET /people/{personId}/features/schedules/{scheduleType}/{scheduleId}

**API:** Webex Cloud Calling
**Área:** User Call Settings (1/2)
**operationId:** `Get a Schedule Details`
...
```bash
curl -X GET '/people/<personId>/features/schedules/<scheduleType>/<scheduleId>' \
