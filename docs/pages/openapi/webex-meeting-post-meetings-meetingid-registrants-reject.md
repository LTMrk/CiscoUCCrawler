---
doc_id: webex-meeting-post-meetings-meetingid-registrants-reject
source: webex-openapi-specs/public-spec/webex-meeting.json
api: Webex Meetings
api_version: 1.0.0
method: POST
path: /meetings/{meetingId}/registrants/reject
operation_id: batchRejectMeetingRegistrants
tags: Meetings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.486909+00:00
---

# POST /meetings/{meetingId}/registrants/reject
...
## Descripción
Batch reject a set of registrants for a meeting by the meeting host or cohost.
...
```bash
curl -X POST '/meetings/<meetingId>/registrants/reject' \
