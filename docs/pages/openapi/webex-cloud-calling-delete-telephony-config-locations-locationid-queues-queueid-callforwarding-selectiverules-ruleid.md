...
operation_id: deleteCallQueueSelectiveCallForwardingRule
tags: Features:  Call Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.300304+00:00
---
...
```bash
curl -X DELETE '/telephony/config/locations/<locationId>/queues/<queueId>/callForwarding/selectiveRules/<ruleId>' \
