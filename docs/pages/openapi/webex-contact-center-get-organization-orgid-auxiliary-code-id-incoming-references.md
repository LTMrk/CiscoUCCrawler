---
doc_id: webex-contact-center-get-organization-orgid-auxiliary-code-id-incoming-references
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/auxiliary-code/{id}/incoming-references
operation_id: getIncomingReferences_18
tags: Auxiliary Code
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.730554+00:00
---
...
**API:** Webex Contact Center
**Área:** Auxiliary Code
**operationId:** `getIncomingReferences_18`
...
```bash
curl -X GET '/organization/<orgid>/auxiliary-code/<id>/incoming-references' \
