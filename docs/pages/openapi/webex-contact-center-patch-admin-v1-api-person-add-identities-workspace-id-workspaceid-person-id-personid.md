...
operation_id: addIdentitiesToPerson
tags: Journey - Customer Identification API
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.812670+00:00
---
...
```bash
curl -X PATCH '/admin/v1/api/person/add-identities/workspace-id/<workspaceId>/person-id/<personId>' \
