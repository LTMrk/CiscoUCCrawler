---
doc_id: webex-contact-center-delete-organization-orgid-work-type-id
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T18:15:55.132706+00:00
---

# DELETE /organization/{orgid}/work-type/{id}
...
## Descripción
Delete an existing Work Type by ID in a given organization.
...
```bash
curl -X DELETE '/organization/<orgid>/work-type/<id>' \
