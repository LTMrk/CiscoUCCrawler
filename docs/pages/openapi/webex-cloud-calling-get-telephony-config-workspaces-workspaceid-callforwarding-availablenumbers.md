---
doc_id: webex-cloud-calling-get-telephony-config-workspaces-workspaceid-callforwarding-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/workspaces/{workspaceId}/callForwarding/availableNumbers
operation_id: Get Workspace Call Forward Available Phone Numbers
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.196917+00:00
---

# GET /telephony/config/workspaces/{workspaceId}/callForwarding/availableNumbers

**API:** Webex Cloud Calling
**Área:** Workspace Call Settings (2/2)
**operationId:** `Get Workspace Call Forward Available Phone Numbers`
...
```bash
curl -X GET '/telephony/config/workspaces/<workspaceId>/callForwarding/availableNumbers' \
...
- `phoneNumbers` (array) (**requerido**): Array of phone numbers.
  ...
  - `extension` (string): Extension for the number.
