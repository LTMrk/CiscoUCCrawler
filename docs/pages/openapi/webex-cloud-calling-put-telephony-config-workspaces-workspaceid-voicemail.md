---
doc_id: webex-cloud-calling-put-telephony-config-workspaces-workspaceid-voicemail
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/workspaces/{workspaceId}/voicemail
operation_id: Configure Voicemail Settings for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.806565+00:00
---

# PUT /telephony/config/workspaces/{workspaceId}/voicemail

**API:** Webex Cloud Calling
**Área:** Workspace Call Settings (2/2)
**operationId:** `Configure Voicemail Settings for a Workspace`
...
```bash
curl -X PUT '/telephony/config/workspaces/<workspaceId>/voicemail' \
