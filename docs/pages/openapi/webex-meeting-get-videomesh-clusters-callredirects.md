---
doc_id: webex-meeting-get-videomesh-clusters-callredirects
source: webex-openapi-specs/public-spec/webex-meeting.json
api: Webex Meetings
api_version: 1.0.0
method: GET
path: /videoMesh/clusters/callRedirects
operation_id: Get Cluster Redirect details
tags: Video Mesh
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.502986+00:00
---

# GET /videoMesh/clusters/callRedirects
...
```bash
curl -X GET '/videoMesh/clusters/callRedirects?from=<from>&to=<to>&clusterId=<clusterId>' \
  ...
  - `items` (array): Redirect details for the organization.
    - (cualquiera de:)
      ...
      - `clusters` (array):
        ...
        - `redirectDetails` (array): Call Redirect Details.
      - `timestamp` (string): Timestamp.
      - `clusters` (array):
        - `clusterId` (string): ID of the Video Mesh cluster.
        - `clusterName` (string): Name of the Video Mesh cluster.
