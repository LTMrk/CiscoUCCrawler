---
doc_id: webex-cloud-calling-delete-telephony-config-virtualextensions-extensionid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/virtualExtensions/{extensionId}
operation_id: Delete a Virtual Extension
tags: Features: Virtual Extensions
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.290559+00:00
---

# DELETE /telephony/config/virtualExtensions/{extensionId}

**API:** Webex Cloud Calling
**Área:** Features: Virtual Extensions
**operationId:** `Delete a Virtual Extension`
...
```bash
curl -X DELETE '/telephony/config/virtualExtensions/<extensionId>' \
