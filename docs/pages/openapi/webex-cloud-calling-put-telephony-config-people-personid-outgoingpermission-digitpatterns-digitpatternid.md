---
doc_id: webex-cloud-calling-put-telephony-config-people-personid-outgoingpermission-digitpatterns-digitpatternid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/people/{personId}/outgoingPermission/digitPatterns/{digitPatternId}
operation_id: modifyDigitPatternForPerson
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.336414+00:00
---

# PUT /telephony/config/people/{personId}/outgoingPermission/digitPatterns/{digitPatternId}
...
```bash
curl -X PUT '/telephony/config/people/<personId>/outgoingPermission/digitPatterns/<digitPatternId>' \
