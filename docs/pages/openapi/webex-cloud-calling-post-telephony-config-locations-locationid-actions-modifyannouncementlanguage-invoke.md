---
doc_id: webex-cloud-calling-post-telephony-config-locations-locationid-actions-modifyannouncementlanguage-invoke
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/locations/{locationId}/actions/modifyAnnouncementLanguage/invoke
operation_id: Change Announcement Language
tags: Location Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.508121+00:00
---
...
**operationId:** `Change Announcement Language`
...
## Parámetros
- `locationId` [path] (string) (**requerido**): Change announcement language for this location.
- `orgId` [query] (string): Change announcement language for this organization.
...
- `announcementLanguageCode` (string) (**requerido**): Language code.
...
```bash
curl -X POST '/telephony/config/locations/<locationId>/actions/modifyAnnouncementLanguage/invoke' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"announcementLanguageCode": "<announcementLanguageCode>"}'
```
