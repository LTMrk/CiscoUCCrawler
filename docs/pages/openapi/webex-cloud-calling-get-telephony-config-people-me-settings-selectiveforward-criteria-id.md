---
doc_id: webex-cloud-calling-get-telephony-config-people-me-settings-selectiveforward-criteria-id
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/me/settings/selectiveForward/criteria/{id}
operation_id: getMySelectiveCallForwardCriteria
tags: Call Settings For Me With UserHub Phase2
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:07.973368+00:00
---

# GET /telephony/config/people/me/settings/selectiveForward/criteria/{id}
...
```bash
curl -X GET '/telephony/config/people/me/settings/selectiveForward/criteria/<id>' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: Selective Call Forwarding Criteria Settings retrieved.
