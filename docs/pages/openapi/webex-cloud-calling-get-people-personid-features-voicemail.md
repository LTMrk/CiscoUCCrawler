---
doc_id: webex-cloud-calling-get-people-personid-features-voicemail
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /people/{personId}/features/voicemail
operation_id: Read Voicemail Settings for a Person
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.368577+00:00
---
...
**operationId:** `Read Voicemail Settings for a Person`
...
```bash
curl -X GET '/people/<personId>/features/voicemail' \
