---
doc_id: webex-contact-center-get-organization-orgid-user-by-ci-user-id-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/user/by-ci-user-id/{id}
operation_id: getUserByCiUserIdUser
tags: Users
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.731128+00:00
---

# GET /organization/{orgid}/user/by-ci-user-id/{id}
...
## Descripción
Retrieve an existing User using the CI ID  in a given organization. Deprecated. Use GET /v2/user/by-ci-user-id/{id} instead.
...
```bash
curl -X GET '/organization/<orgid>/user/by-ci-user-id/<id>' \
