...
operation_id: Configure Voicemail Settings for a Virtual Line
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.181885+00:00
---
...
```bash
curl -X PUT '/telephony/config/virtualLines/<virtualLineId>/voicemail' \
