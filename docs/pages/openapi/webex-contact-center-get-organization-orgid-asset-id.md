---
doc_id: webex-contact-center-get-organization-orgid-asset-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/asset/{id}
operation_id: getConfigAsset
tags: Asset
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-17T19:59:29.839634+00:00
---

# GET /organization/{orgid}/asset/{id}
...
## Descripción
Retrieve an existing Asset by ID in a given organization. Set includeChannelName to true to include the channel name in the response.
...
```bash
curl -X GET '/organization/<orgid>/asset/<id>' \
