---
doc_id: webex-cloud-calling-get-devices-deviceid
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.006911+00:00
---
...
## Descripción
Shows details for a device, by ID. This requires an auth token with the `spark:devices_read` scope to see your own device, or `spark-admin:devices_read` to see any other device in your organization.
