...
operation_id: Update Voicemail Settings
tags: Calling Service Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.174987+00:00
---
...
```bash
curl -X PUT '/telephony/config/voicemail/settings' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"messageExpiryEnabled": true, "numberOfDaysForMessageExpiry": 0}'
```
