---
doc_id: webex-contact-center-get-organization-orgid-v2-agent-profile
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
method: GET
path: /organization/{orgid}/v2/agent-profile
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:32.939674+00:00
---
...
**operationId:** `getAllConfigWithMetaDataDesktopProfile`
...
- `provisioningView` [query] (boolean): If set to true, the API will only return data that the user has access to, according to the User Profile.
