---
doc_id: webex-cloud-calling-get-people-personid-features-bargein
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /people/{personId}/features/bargeIn
operation_id: Read Barge In Settings for a Person
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.360056+00:00
---
...
**operationId:** `Read Barge In Settings for a Person`
...
```bash
curl -X GET '/people/<personId>/features/bargeIn' \
