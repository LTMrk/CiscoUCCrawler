---
doc_id: webex-wholesale-get-wholesale-customers-customerid
source: webex-openapi-specs/public-spec/webex-wholesale.json
api: Webex Wholesale
method: GET
path: /wholesale/customers/{customerId}
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:33.731709+00:00
---

# GET /wholesale/customers/{customerId}
...
## Descripción
Retrieves details of a provisioned Wholesale customer on Cisco Webex.
...
- `includePackageLicenseInfo` [query] (boolean): If specified as true, a list of licenseIds will be returned for all provisioned packages
