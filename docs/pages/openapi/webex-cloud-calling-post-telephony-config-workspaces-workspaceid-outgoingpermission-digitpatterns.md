---
doc_id: webex-cloud-calling-post-telephony-config-workspaces-workspaceid-outgoingpermission-digitpatterns
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/workspaces/{workspaceId}/outgoingPermission/digitPatterns
operation_id: Create Digit Pattern for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.801324+00:00
---

# POST /telephony/config/workspaces/{workspaceId}/outgoingPermission/digitPatterns

**API:** Webex Cloud Calling
**Área:** Workspace Call Settings (2/2)
**operationId:** `Create Digit Pattern for a Workspace`
...
```bash
curl -X POST '/telephony/config/workspaces/<workspaceId>/outgoingPermission/digitPatterns' \
