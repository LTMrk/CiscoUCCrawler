---
doc_id: webex-contact-center-get-organization-orgid-overrides-id-incoming-references
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/overrides/{id}/incoming-references
operation_id: getIncomingReferences_5
tags: Overrides
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.767468+00:00
---
...
**API:** Webex Contact Center
**Área:** Overrides
**operationId:** `getIncomingReferences_5`
...
```bash
curl -X GET '/organization/<orgid>/overrides/<id>/incoming-references' \
