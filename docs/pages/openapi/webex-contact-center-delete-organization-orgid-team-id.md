---
doc_id: webex-contact-center-delete-organization-orgid-team-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: DELETE
path: /organization/{orgid}/team/{id}
operation_id: deleteConfigTeam
tags: Team
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.826951+00:00
---
...
```bash
curl -X DELETE '/organization/<orgid>/team/<id>' \
