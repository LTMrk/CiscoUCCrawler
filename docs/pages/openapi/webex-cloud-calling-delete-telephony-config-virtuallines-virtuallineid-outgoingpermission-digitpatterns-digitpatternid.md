...
operation_id: Delete a Digit Pattern for a Virtual Profile
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.180069+00:00
---
...
```bash
curl -X DELETE '/telephony/config/virtualLines/<virtualLineId>/outgoingPermission/digitPatterns/<digitPatternId>' \
