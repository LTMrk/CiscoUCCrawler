---
doc_id: webex-contact-center-get-organization-orgid-outdial-ani-id-incoming-references
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/outdial-ani/{id}/incoming-references
operation_id: getIncomingReferencesOutdialANI
tags: Outdial ANI
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.811906+00:00
---
...
**API:** Webex Contact Center
**Área:** Outdial ANI
**operationId:** `getIncomingReferencesOutdialANI`
...
```bash
curl -X GET '/organization/<orgid>/outdial-ani/<id>/incoming-references' \
