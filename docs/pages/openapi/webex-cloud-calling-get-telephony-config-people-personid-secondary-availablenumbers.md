---
doc_id: webex-cloud-calling-get-telephony-config-people-personid-secondary-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/{personId}/secondary/availableNumbers
operation_id: getPersonSecondaryAvailablePhoneNumbers
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.340269+00:00
---

# GET /telephony/config/people/{personId}/secondary/availableNumbers

**API:** Webex Cloud Calling
**Área:** User Call Settings (2/2)
**operationId:** `getPersonSecondaryAvailablePhoneNumbers`
...
```bash
curl -X GET '/telephony/config/people/<personId>/secondary/availableNumbers' \
