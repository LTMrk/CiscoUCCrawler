---
doc_id: webex-cloud-calling-get-telephony-config-people-personid-faxmessage-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/{personId}/faxMessage/availableNumbers
operation_id: getPersonFaxMessageAvailablePhoneNumbers
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.340474+00:00
---

# GET /telephony/config/people/{personId}/faxMessage/availableNumbers

**API:** Webex Cloud Calling
**Área:** User Call Settings (2/2)
**operationId:** `getPersonFaxMessageAvailablePhoneNumbers`
...
```bash
curl -X GET '/telephony/config/people/<personId>/faxMessage/availableNumbers' \
