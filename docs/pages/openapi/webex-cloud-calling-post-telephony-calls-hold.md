---
doc_id: webex-cloud-calling-post-telephony-calls-hold
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:07.939176+00:00
---
...
- `callId` (string) (**requerido**): The call identifier of the call to hold.
...
```bash
curl -X POST '/telephony/calls/hold' \
