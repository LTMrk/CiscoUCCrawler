---
doc_id: webex-meeting-patch-group-meetings-meetingid
source: webex-openapi-specs/public-spec/webex-meeting.json
api: Webex Meetings
api_version: 1.0.0
method: PATCH
path: /group/meetings/{meetingId}
operation_id: patchGroupMeeting
tags: Meetings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.478120+00:00
---

# PATCH /group/meetings/{meetingId}

**API:** Webex Meetings
**Área:** Meetings
**operationId:** `patchGroupMeeting`

## Resumen
Patch a Group Meeting

## Descripción
Patches details for a group meeting with a specified meeting ID by a service app which has group meeting access. This operation applies to meeting series and scheduled meetings. It doesn't apply to ended or in-progress meeting instances. Ad-hoc meetings created by [Create a Meeting](/docs/api/v1/meetings/create-a-meeting) with `adhoc` of `true` and a `roomId` cannot be updated.
...
```bash
curl -X PATCH '/group/meetings/<meetingId>' \
