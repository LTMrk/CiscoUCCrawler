---
doc_id: webex-cloud-calling-get-telephony-config-people-personid-emergencycallbacknumber-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/{personId}/emergencyCallbackNumber/availableNumbers
operation_id: getPersonEcbnAvailablePhoneNumbers
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.555601+00:00
---
...
**operationId:** `getPersonEcbnAvailablePhoneNumbers`
...
```bash
curl -X GET '/telephony/config/people/<personId>/emergencyCallbackNumber/availableNumbers' \
