---
doc_id: webex-contact-center-get-organization-orgid-outdial-ani-outdialaniid-entry-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/outdial-ani/{outDialAniId}/entry/{id}
operation_id: getConfigOutDialANIEntry
tags: Outdial ANI
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.676295+00:00
---
...
**API:** Webex Contact Center
**Área:** Outdial ANI
**operationId:** `getConfigOutDialANIEntry`
...
```bash
curl -X GET '/organization/<orgid>/outdial-ani/<outDialAniId>/entry/<id>' \
