...
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:32.962790+00:00
---
...
## Parámetros
- `taskId` [path] (string) **(requerido)**: The unique ID representing the task that needs to be resumed and was on hold already.
