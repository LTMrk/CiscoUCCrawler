---
doc_id: webex-cloud-calling-post-telephony-config-announcements-playlists
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/announcements/playlists
operation_id: createAnnouncementPlaylist
tags: Features: Announcement Playlist
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.013577+00:00
---
...
## Parámetros
- `orgId` [query] (string): Create an announcement playlist in this organization.

## Cuerpo de la petición (application/json)
- `name` (string) (**requerido**): Unique name for the announcement playlist.
- `announcementIds` (array) (**requerido**): Array of `announcementIds` associated with the playlist.
...
```bash
curl -X POST '/telephony/config/announcements/playlists' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"name": "<name>", "announcementIds": []}'
```

## Respuestas correctas
**201**: Created
- `id` (string) (**requerido**): Unique identifier of the announcement playlist.
