---
doc_id: webex-cloud-calling-delete-locations-locationid-floors-floorid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /locations/{locationId}/floors/{floorId}
operation_id: deleteLocationFloor
tags: Locations
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.130378+00:00
---
...
**API:** Webex Cloud Calling
**Área:** Locations
**operationId:** `deleteLocationFloor`
...
```bash
curl -X DELETE '/locations/<locationId>/floors/<floorId>' \
