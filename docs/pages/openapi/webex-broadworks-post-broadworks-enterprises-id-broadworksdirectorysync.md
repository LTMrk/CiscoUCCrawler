---
doc_id: webex-broadworks-post-broadworks-enterprises-id-broadworksdirectorysync
...
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:32.284749+00:00
---

# POST /broadworks/enterprises/{id}/broadworksDirectorySync
...
- `syncStatus` (string) **(requerido)**: At this time, the only value allowed for this attribute is `SYNC_NOW` which will trigger the directory sync for the BroadWorks enterprise.
