---
doc_id: webex-contact-center-put-organization-orgid-agent-burnout-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: PUT
path: /organization/{orgid}/agent-burnout/{id}
operation_id: updateConfigAgentBurnout
tags: Agent Wellbeing
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.625897+00:00
---

# PUT /organization/{orgid}/agent-burnout/{id}
...
## Descripción
Update an existing Agent Burnout resource by ID in a given organization. Deprecated. Use PUT /ai-feature/agent-burnout/{id} instead.
...
```bash
curl -X PUT '/organization/<orgid>/agent-burnout/<id>' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"agentInclusionType": "<agentInclusionType>", "enabled": true}'
```
