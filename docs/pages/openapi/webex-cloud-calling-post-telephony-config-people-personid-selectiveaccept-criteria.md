---
doc_id: webex-cloud-calling-post-telephony-config-people-personid-selectiveaccept-criteria
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/people/{personId}/selectiveAccept/criteria
operation_id: createCriteriaToUserSelectiveCallAcceptService
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.379328+00:00
---

# POST /telephony/config/people/{personId}/selectiveAccept/criteria
...
```bash
curl -X POST '/telephony/config/people/<personId>/selectiveAccept/criteria' \
