---
doc_id: webex-cloud-calling-put-telephony-config-premisepstn-routelists-routelistid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/premisePstn/routeLists/{routeListId}
operation_id: Modify a Route List
tags: Call Routing
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.139230+00:00
---

# PUT /telephony/config/premisePstn/routeLists/{routeListId}

**API:** Webex Cloud Calling
**Área:** Call Routing
**operationId:** `Modify a Route List`
...
```bash
curl -X PUT '/telephony/config/premisePstn/routeLists/<routeListId>' \
