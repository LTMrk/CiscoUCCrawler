...
operation_id: Modify a specific Translation Pattern for an Organization
tags: Call Routing
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.173043+00:00
---
...
```bash
curl -X PUT '/telephony/config/callRouting/translationPatterns/<translationId>' \
