...
operation_id: Retrieve Priority Alert Settings for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.605591+00:00
---
...
```bash
curl -X GET '/telephony/config/workspaces/<workspaceId>/priorityAlert' \
