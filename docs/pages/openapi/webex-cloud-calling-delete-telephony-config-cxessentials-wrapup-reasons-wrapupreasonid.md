---
doc_id: webex-cloud-calling-delete-telephony-config-cxessentials-wrapup-reasons-wrapupreasonid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/cxEssentials/wrapup/reasons/{wrapupReasonId}
operation_id: Delete Wrap Up Reason
tags: Features: Customer Assist
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.488661+00:00
---

# DELETE /telephony/config/cxEssentials/wrapup/reasons/{wrapupReasonId}
...
```bash
curl -X DELETE '/telephony/config/cxEssentials/wrapup/reasons/<wrapupReasonId>' \
