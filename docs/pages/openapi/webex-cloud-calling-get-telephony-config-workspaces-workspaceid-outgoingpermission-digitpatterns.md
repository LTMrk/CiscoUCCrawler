---
doc_id: webex-cloud-calling-get-telephony-config-workspaces-workspaceid-outgoingpermission-digitpatterns
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/workspaces/{workspaceId}/outgoingPermission/digitPatterns
operation_id: Retrieve all Digit Patterns for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.376741+00:00
---

# GET /telephony/config/workspaces/{workspaceId}/outgoingPermission/digitPatterns
...
```bash
curl -X GET '/telephony/config/workspaces/<workspaceId>/outgoingPermission/digitPatterns' \
