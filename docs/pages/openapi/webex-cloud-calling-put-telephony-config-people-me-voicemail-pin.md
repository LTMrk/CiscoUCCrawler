---
doc_id: webex-cloud-calling-put-telephony-config-people-me-voicemail-pin
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/people/me/voicemail/pin
operation_id: updateVoicemailPin
tags: Call Settings For Me Phase 5
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.603888+00:00
---
...
- `passcode` (string) (**requerido**): Person voicemail PIN. The PIN must comply with the passcode rules defined for the organization.

## Ejemplo de invocación
```bash
curl -X PUT '/telephony/config/people/me/voicemail/pin' \
...
**204**: No Content: Voicemail PIN successfully updated.
