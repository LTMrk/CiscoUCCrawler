...
operation_id: Create or Replace existing subscription tags with the provided ones
tags: Partner Tags
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:42.591042+00:00
---
...
```bash
curl -X POST '/partner/tags/organizations/<orgId>/subscriptions/<subscriptionId>/assignTags' \
