---
doc_id: webex-cloud-calling-post-telephony-config-workspaces-workspaceid-voicemail-actions-uploadbusygreeting-invoke
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/workspaces/{workspaceId}/voicemail/actions/uploadBusyGreeting/invoke
operation_id: Configure Busy Voicemail Greeting for a Place
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.384596+00:00
---

# POST /telephony/config/workspaces/{workspaceId}/voicemail/actions/uploadBusyGreeting/invoke

**API:** Webex Cloud Calling
**Área:** Workspace Call Settings (2/2)
**operationId:** `Configure Busy Voicemail Greeting for a Place`

## Resumen
Configure Busy Voicemail Greeting for a Place

## Descripción
Configure a workspace's Busy Voicemail Greeting by uploading a Waveform Audio File Format, `.wav`, encoded audio file.
...
```bash
curl -X POST '/telephony/config/workspaces/<workspaceId>/voicemail/actions/uploadBusyGreeting/invoke' \
