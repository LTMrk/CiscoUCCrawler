---
doc_id: webex-cloud-calling-post-people-personid-features-schedules
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /people/{personId}/features/schedules
operation_id: Create Schedule for a Person
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.366943+00:00
---

# POST /people/{personId}/features/schedules

**API:** Webex Cloud Calling
**Área:** User Call Settings (1/2)
**operationId:** `Create Schedule for a Person`
...
```bash
curl -X POST '/people/<personId>/features/schedules' \
