---
doc_id: webex-cloud-calling-put-people-personid-features-hoteling
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /people/{personId}/features/hoteling
operation_id: Configure Hoteling Settings for a Person
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.753246+00:00
---
...
**operationId:** `Configure Hoteling Settings for a Person`
...
```bash
curl -X PUT '/people/<personId>/features/hoteling' \
