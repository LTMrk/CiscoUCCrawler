---
doc_id: webex-contact-center-get-orgid-project-projectid-v2-flows-flowid-export
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /{orgId}/project/{projectId}/v2/flows/{flowId}:export
operation_id: exportFlowV2
tags: Flows
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.808427+00:00
---
...
## Descripción
Export a flow as a flow document for backup, migration, or version control.
...
- `version` [query] (string): Version to export. Use 'latest' for the most recent published version, 'draft' for the working copy, or a specific version ObjectId. Por defecto: latest.
- `flowType` [query] (string): Either of 'FLOW' or 'SUBFLOW'. Por defecto: FLOW.

## Ejemplo de invocación
```bash
curl -X GET '/<orgId>/project/<projectId>/v2/flows/<flowId>:export' \
