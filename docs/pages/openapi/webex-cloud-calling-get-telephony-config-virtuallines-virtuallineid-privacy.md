---
doc_id: webex-cloud-calling-get-telephony-config-virtuallines-virtuallineid-privacy
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/virtualLines/{virtualLineId}/privacy
operation_id: Get a Virtual Line's Privacy Settings
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.398853+00:00
---

# GET /telephony/config/virtualLines/{virtualLineId}/privacy

**API:** Webex Cloud Calling
**Área:** Virtual Line Call Settings
**operationId:** `Get a Virtual Line's Privacy Settings`
...
Retrieving the privacy settings for a virtual line requires a full, user, read-only administrator, or location administrator auth token with a scope of `spark-admin:telephony_config_read`.
...
```bash
curl -X GET '/telephony/config/virtualLines/<virtualLineId>/privacy' \
