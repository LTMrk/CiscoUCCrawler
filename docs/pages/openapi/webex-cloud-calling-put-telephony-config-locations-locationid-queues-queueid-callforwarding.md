---
doc_id: webex-cloud-calling-put-telephony-config-locations-locationid-queues-queueid-callforwarding
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/locations/{locationId}/queues/{queueId}/callForwarding
operation_id: updateCallQueueCallForwardingSettings
tags: Features:  Call Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.262758+00:00
---
...
**operationId:** `updateCallQueueCallForwardingSettings`
...
- `queueId` [path] (string) (**requerido**): Update call forwarding settings for this call queue.
- `orgId` [query] (string): Update call queue forwarding settings from this organization.
...
```bash
curl -X PUT '/telephony/config/locations/<locationId>/queues/<queueId>/callForwarding' \
