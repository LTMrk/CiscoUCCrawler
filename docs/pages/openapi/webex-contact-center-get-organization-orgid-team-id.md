---
doc_id: webex-contact-center-get-organization-orgid-team-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/team/{id}
operation_id: getConfigTeam
tags: Team
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.687390+00:00
---
...
```bash
curl -X GET '/organization/<orgid>/team/<id>' \
