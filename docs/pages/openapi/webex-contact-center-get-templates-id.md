---
doc_id: webex-contact-center-get-templates-id
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.862435+00:00
---
...
## Descripción
Retrieve a specific flow template by its ID. Use this to inspect a template's flow structure before creating a flow from it.

Scope: `cjp:config_read`

## Parámetros
- `id` [path] (string) (**requerido**): Template ID.
...
**200**: Template metadata and flow structure.
