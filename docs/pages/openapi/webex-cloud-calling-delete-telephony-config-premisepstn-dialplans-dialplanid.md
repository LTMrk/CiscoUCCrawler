---
doc_id: webex-cloud-calling-delete-telephony-config-premisepstn-dialplans-dialplanid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/premisePstn/dialPlans/{dialPlanId}
operation_id: Delete a Dial Plan
tags: Call Routing
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:07.947454+00:00
---
...
**API:** Webex Cloud Calling
**Área:** Call Routing
**operationId:** `Delete a Dial Plan`
...
```bash
curl -X DELETE '/telephony/config/premisePstn/dialPlans/<dialPlanId>' \
