---
doc_id: webex-cloud-calling-get-telephony-config-people-personid-emergencycallbacknumber-dependencies
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/{personId}/emergencyCallbackNumber/dependencies
operation_id: Retrieve A Person's Emergency Callback Number Dependencies
tags: Emergency Services Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.011727+00:00
---
...
**operationId:** `Retrieve A Person's Emergency Callback Number Dependencies`
...
```bash
curl -X GET '/telephony/config/people/<personId>/emergencyCallbackNumber/dependencies' \
...
- `isSelfEcbnDefault` (boolean) (**requerido**): The default emergency callback number for the person when `isSelfEcbnDefault` is true.
- `dependentMemberCount` (number) (**requerido**): Number of members using this person as their emergency callback number.
