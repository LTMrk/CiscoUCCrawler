---
doc_id: webex-cloud-calling-put-telephony-config-announcements-announcementid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/announcements/{announcementId}
operation_id: Modify a binary announcement greeting at organization level
tags: Features: Announcement Repository
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.677880+00:00
---
...
- `orgId` [query] (string): Modify an announcement in this organization.
...
```bash
curl -X PUT '/telephony/config/announcements/<announcementId>' \
