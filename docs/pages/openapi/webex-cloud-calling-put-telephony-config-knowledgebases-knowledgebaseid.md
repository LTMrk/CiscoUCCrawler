---
doc_id: webex-cloud-calling-put-telephony-config-knowledgebases-knowledgebaseid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/knowledgeBases/{knowledgeBaseId}
operation_id: updateKnowledgeBase
tags: AI Receptionist for Webex Calling, AI Receptionist
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:07.937107+00:00
---
...
- `name` (string): The display name assigned to the Knowledge Base. Used to identify the KB across the platform. Long. max: 64.
...
```json
{
  "name": "Shree HealthCare Clinic KB Updated",
...
```bash
curl -X PUT '/telephony/config/knowledgeBases/<knowledgeBaseId>' \
