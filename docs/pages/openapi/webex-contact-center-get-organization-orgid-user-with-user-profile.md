---
doc_id: webex-contact-center-get-organization-orgid-user-with-user-profile
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/user/with-user-profile
operation_id: getAllUsersWithUserProfileUser
tags: Users
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.835545+00:00
---
...
**API:** Webex Contact Center
**Área:** Users
**operationId:** `getAllUsersWithUserProfileUser`

## Resumen
List Users along with profile

## Descripción
Retrieve a list of Users along with their User Profiles in a given organization.
...
```bash
curl -X GET '/organization/<orgid>/user/with-user-profile' \
