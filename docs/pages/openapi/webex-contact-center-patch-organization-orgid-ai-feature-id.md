---
doc_id: webex-contact-center-patch-organization-orgid-ai-feature-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: PATCH
path: /organization/{orgid}/ai-feature/{id}
operation_id: patchConfigAiFeature
tags: AI Feature
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.628050+00:00
---
...
## Descripción
Partially update AI Feature resource by ID in a given organization.
...
### Real time transcripts configuration update — petición
```json
{
...
### Generated Summaries configuration update — petición
```json
{
  "id": "26e2df70-0f77-41b8-8e8f-1d76e92c9638",
  "generatedSummaries": {
...
### Agent Wellbeing configuration update — petición
```json
{
  "id": "26e2df70-0f77-41b8-8e8f-1d76e92c9638",
  "agentWellbeing": {
...
```bash
curl -X PATCH '/organization/<orgid>/ai-feature/<id>' \
