---
doc_id: webex-contact-center-post-organization-orgid-business-hours-bulk
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: POST
path: /organization/{orgid}/business-hours/bulk
operation_id: saveAllConfigBusinessHours
tags: Business Hour
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.710435+00:00
---

# POST /organization/{orgid}/business-hours/bulk

**API:** Webex Contact Center
**Área:** Business Hour
**operationId:** `saveAllConfigBusinessHours`

## Resumen
Bulk save Business Hours resources

## Descripción
Create, Update or delete Business Hours resources in bulk in a given organization.
...
- `items` (array): List of items in the bulk request.
  ...
  - `item` (object): Business Hours schema.
...
```bash
curl -X POST '/organization/<orgid>/business-hours/bulk' \
