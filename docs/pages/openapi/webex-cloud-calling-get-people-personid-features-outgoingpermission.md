...
operation_id: Retrieve Outgoing Calling Permissions Settings for a Person
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.146259+00:00
---
...
```bash
curl -X GET '/people/<personId>/features/outgoingPermission' \
