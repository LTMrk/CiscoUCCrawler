...
operation_id: getCallQueueNightService
tags: Features:  Call Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.693682+00:00
---
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/queues/<queueId>/nightService' \
