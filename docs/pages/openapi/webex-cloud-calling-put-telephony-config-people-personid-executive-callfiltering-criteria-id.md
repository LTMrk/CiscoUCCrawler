...
operation_id: updatePersonExecutiveCallFilteringCriteria
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.383781+00:00
---
...
```bash
curl -X PUT '/telephony/config/people/<personId>/executive/callFiltering/criteria/<id>' \
