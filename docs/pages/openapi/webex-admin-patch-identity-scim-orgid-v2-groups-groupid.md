...
operation_id: Update a group with PATCH
tags: SCIM 2 Groups
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:42.581751+00:00
---
...
```bash
curl -X PATCH '/identity/scim/<orgId>/v2/Groups/<groupId>' \
...
```json
{
  ...
  "members": [
    {
      "value": "9836fa05-21f4-4fbc-8863-8eaf3dfbabe7",
      "type": "user",
      "example": "https://example.com/v2/Users/9836fa05-21f4-4fbc-8863-8eaf3dfbabe7",
      "display": "A user"
    },
    {
