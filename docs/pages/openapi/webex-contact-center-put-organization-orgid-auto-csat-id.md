...
operation_id: updateConfigAutoCSAT
tags: Auto CSAT
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.757972+00:00
---
...
```bash
curl -X PUT '/organization/<orgid>/auto-csat/<id>' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"agentInclusionType": "<agentInclusionType>", "enabled": true, "selectedGlobalVariableId": "<selectedGlobalVariableId>", "surveyDataSource": "<surveyDataSource>"}'
```
