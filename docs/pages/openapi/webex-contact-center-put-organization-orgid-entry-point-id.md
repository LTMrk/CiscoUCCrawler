...
operation_id: updateConfig_15
tags: Entry Point
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-20T13:57:48.695744+00:00
---
...
```bash
curl -X PUT '/organization/<orgid>/entry-point/<id>' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"active": true, "assetId": "<assetId>", "channelType": "<channelType>", "controlFlowScriptUrl": "<controlFlowScriptUrl>", "entryPointType": "<entryPointType>", "imiOrgType": "<imiOrgType>"}'
```
