---
doc_id: webex-contact-center-get-v1-api-progressive-profile-view-workspace-id-workspaceid-person-id-personid-template-name-templatename
...
operation_id: getProgressiveProfileViewByTemplateName
tags: Journey - Profile Creation & Insights API
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-20T13:57:48.745267+00:00
---

# GET /v1/api/progressive-profile-view/workspace-id/{workspaceId}/person-id/{personId}/template-name/{templateName}
...
```bash
curl -X GET '/v1/api/progressive-profile-view/workspace-id/<workspaceId>/person-id/<personId>/template-name/<templateName>' \
