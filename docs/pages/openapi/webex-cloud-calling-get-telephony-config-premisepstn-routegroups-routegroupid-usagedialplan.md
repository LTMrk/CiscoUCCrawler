---
doc_id: webex-cloud-calling-get-telephony-config-premisepstn-routegroups-routegroupid-usagedialplan
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/premisePstn/routeGroups/{routeGroupId}/usageDialPlan
operation_id: Read the Dial Plan Locations of a Routing Group
tags: Call Routing
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.345401+00:00
---

# GET /telephony/config/premisePstn/routeGroups/{routeGroupId}/usageDialPlan

**API:** Webex Cloud Calling
**Área:** Call Routing
**operationId:** `Read the Dial Plan Locations of a Routing Group`
...
```bash
curl -X GET '/telephony/config/premisePstn/routeGroups/<routeGroupId>/usageDialPlan' \
