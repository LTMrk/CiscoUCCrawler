...
operation_id: getAllConfigHolidayList
tags: Holiday List
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T18:15:55.056131+00:00
---
...
```bash
curl -X GET '/organization/<orgid>/holiday-list' \
...
- (array de:)
  ...
  - `name` (string): Enter a name for the holiday list. Long. max: 80.
