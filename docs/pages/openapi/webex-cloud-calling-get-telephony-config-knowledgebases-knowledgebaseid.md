---
doc_id: webex-cloud-calling-get-telephony-config-knowledgebases-knowledgebaseid
...
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:07.936942+00:00
---
...
```bash
curl -X GET '/telephony/config/knowledgeBases/<knowledgeBaseId>' \
