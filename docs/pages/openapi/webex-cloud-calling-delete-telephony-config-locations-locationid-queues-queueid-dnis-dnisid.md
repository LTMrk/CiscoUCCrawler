---
doc_id: webex-cloud-calling-delete-telephony-config-locations-locationid-queues-queueid-dnis-dnisid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/locations/{locationId}/queues/{queueId}/dnis/{dnisId}
operation_id: deleteADnisForACallQueue
tags: Features:  Call Queue
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.699325+00:00
---
...
**operationId:** `deleteADnisForACallQueue`
...
```bash
curl -X DELETE '/telephony/config/locations/<locationId>/queues/<queueId>/dnis/<dnisId>' \
