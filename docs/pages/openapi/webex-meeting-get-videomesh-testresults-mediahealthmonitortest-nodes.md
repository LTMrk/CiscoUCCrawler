---
doc_id: webex-meeting-get-videomesh-testresults-mediahealthmonitortest-nodes
source: webex-openapi-specs/public-spec/webex-meeting.json
api: Webex Meetings
api_version: 1.0.0
method: GET
path: /videoMesh/testResults/mediaHealthMonitorTest/nodes
operation_id: Get Media Health Monitoring Tool Test results for node V2
tags: Video Mesh
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.502182+00:00
---

# GET /videoMesh/testResults/mediaHealthMonitorTest/nodes
...
```bash
curl -X GET '/videoMesh/testResults/mediaHealthMonitorTest/nodes?nodeId=<nodeId>&triggerType=<triggerType>&from=<from>&to=<to>' \
...
- `items` (array): Media Health Monitoring Tool test results.
  - `clusters` (array): The list of Video Mesh clusters.
