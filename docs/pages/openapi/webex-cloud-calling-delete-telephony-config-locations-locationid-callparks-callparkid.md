---
doc_id: webex-cloud-calling-delete-telephony-config-locations-locationid-callparks-callparkid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/locations/{locationId}/callParks/{callParkId}
operation_id: Delete a Call Park
tags: Features:  Call Park
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.292530+00:00
---
...
**operationId:** `Delete a Call Park`
...
## Parámetros
- `locationId` [path] (string) (**requerido**): Location from which to delete a call park.
- `callParkId` [path] (string) (**requerido**): Delete the call park with the matching ID.
- `orgId` [query] (string): Delete the call park from this organization.

## Ejemplo de invocación
```bash
curl -X DELETE '/telephony/config/locations/<locationId>/callParks/<callParkId>' \
