---
doc_id: webex-cloud-calling-put-telephony-config-people-personid-selectivereject
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/people/{personId}/selectiveReject
operation_id: updateUserSelectiveCallRejectionCriteriaList
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.771480+00:00
---

# PUT /telephony/config/people/{personId}/selectiveReject

**API:** Webex Cloud Calling
**Área:** User Call Settings (2/2)
**operationId:** `updateUserSelectiveCallRejectionCriteriaList`
...
- `enabled` (boolean) (**requerido**): if `true`, selective reject is enabled.
...
```bash
curl -X PUT '/telephony/config/people/<personId>/selectiveReject' \
