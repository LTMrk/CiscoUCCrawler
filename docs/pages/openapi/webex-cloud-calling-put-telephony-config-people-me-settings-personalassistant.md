---
doc_id: webex-cloud-calling-put-telephony-config-people-me-settings-personalassistant
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/people/me/settings/personalAssistant
operation_id: updatePersonalAssistantSettings
tags: Call Settings For Me Phase 5
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-25T10:28:32.349819+00:00
---
...
## Descripción
Update personal assistant settings for a person. Allows configuring the personal assistant feature including enabling/disabling it, setting presence status, configuring call transfer options, and alerting preferences.
...
```bash
curl -X PUT '/telephony/config/people/me/settings/personalAssistant' \
...
**204**: No Content: Personal assistant settings successfully updated.
