...
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:32.577024+00:00
---
...
## Parámetros
- `max` [query] (integer): Limit the maximum number of hosts in the response. Default is 100.
- `start` [query] (integer): Start index for pagination. Default is 0.
