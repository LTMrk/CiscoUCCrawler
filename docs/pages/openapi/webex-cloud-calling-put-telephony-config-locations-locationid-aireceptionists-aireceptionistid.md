...
license: CC-BY-4.0
retrieved_at: 2026-08-16T11:30:32.548230+00:00
---
...
- `name` (string): Name of the AI Receptionist. This has to be unique across location.
...
- `alternateNumbers` (array): List of alternate phone numbers to assign to the AI Receptionist.
  - `phoneNumber` (string): Alternate phone number.
