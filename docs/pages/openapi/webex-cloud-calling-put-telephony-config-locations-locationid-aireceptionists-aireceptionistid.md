---
doc_id: webex-cloud-calling-put-telephony-config-locations-locationid-aireceptionists-aireceptionistid
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/locations/{locationId}/aiReceptionists/{aiReceptionistId}
operation_id: updateAiReceptionist
tags: AI Receptionist for Webex Calling, AI Receptionist
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.121988+00:00
---

# PUT /telephony/config/locations/{locationId}/aiReceptionists/{aiReceptionistId}

**API:** Webex Cloud Calling
**Área:** AI Receptionist for Webex Calling, AI Receptionist
**operationId:** `updateAiReceptionist`
...
- `name` (string): Name of the AI Receptionist. This has to be unique across location. Long. max: 128.
- `enabled` (boolean): Flag to indicate AI receptionist is enabled or not. When disabled, incoming calls to this AI receptionist will not be answered.
...
- `alternateNumbers` (array): List of alternate phone numbers to assign to the AI Receptionist.
...
```bash
curl -X PUT '/telephony/config/locations/<locationId>/aiReceptionists/<aiReceptionistId>' \
