---
doc_id: webex-cloud-calling-get-workspaces-workspaceid-features-callwaiting
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /workspaces/{workspaceId}/features/callWaiting
operation_id: Retrieve Call Waiting Settings for a Workspace
tags: Workspace Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.402205+00:00
---

# GET /workspaces/{workspaceId}/features/callWaiting

**API:** Webex Cloud Calling
**Área:** Workspace Call Settings (1/2)
**operationId:** `Retrieve Call Waiting Settings for a Workspace`
...
```bash
curl -X GET '/workspaces/<workspaceId>/features/callWaiting' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `enabled` (boolean) (**requerido**): Call Waiting state.
