---
doc_id: webex-messaging-get-room-tabs
source: webex-openapi-specs/public-spec/webex-messaging.json
api: Webex Messaging
api_version: 1.0.0
method: GET
path: /room/tabs
operation_id: List Room Tabs
tags: Room Tabs
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.811112+00:00
---
...
## Parámetros
- `roomId` [query] (string) (**requerido**): ID of the room for which to list room tabs.

## Ejemplo de invocación
```bash
curl -X GET '/room/tabs?roomId=<roomId>' \
