---
doc_id: webex-contact-center-post-organization-orgid-v3-user-profile
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: POST
path: /organization/{orgid}/v3/user-profile
operation_id: createConfigUserProfileGranularAccess
tags: User Profiles
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.689619+00:00
---

# POST /organization/{orgid}/v3/user-profile
...
## Descripción
Create a new user profile in a given organization.
...
```bash
curl -X POST '/organization/<orgid>/v3/user-profile' \
  -H 'Authorization: Bearer <TOKEN>' \
  -H 'Content-Type: application/json' \
  -d '{"active": true, "name": "<name>", "permissionAccessLevel": "<permissionAccessLevel>", "profileType": "<profileType>", "resourceAccessLevel": "<resourceAccessLevel>"}'
```
