---
doc_id: webex-cloud-calling-get-telephony-config-virtuallines-virtuallineid-outgoingpermission-digitpatterns
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/virtualLines/{virtualLineId}/outgoingPermission/digitPatterns
operation_id: Retrieve Digit Patterns for a Virtual Profile
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.178815+00:00
---

# GET /telephony/config/virtualLines/{virtualLineId}/outgoingPermission/digitPatterns

**API:** Webex Cloud Calling
**Área:** Virtual Line Call Settings
**operationId:** `Retrieve Digit Patterns for a Virtual Profile`
...
```bash
curl -X GET '/telephony/config/virtualLines/<virtualLineId>/outgoingPermission/digitPatterns' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `useCustomDigitPatterns` (boolean) (**requerido**): When `true`, use custom settings for the digit patterns category of outgoing call permissions.
- `digitPatterns` (array) (**requerido**): List of digit patterns.
