---
doc_id: webex-contact-center-get-organization-orgid-v3-user-profile
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/v3/user-profile
operation_id: getAllConfigWithPagedMetaDataUserProfileGranularAccess
tags: User Profiles
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.778029+00:00
---
...
**API:** Webex Contact Center
**Área:** User Profiles
**operationId:** `getAllConfigWithPagedMetaDataUserProfileGranularAccess`

## Resumen
List user profiles

## Descripción
Retrieve a list of user profiles in a given organization.
...
```bash
curl -X GET '/organization/<orgid>/v3/user-profile' \
