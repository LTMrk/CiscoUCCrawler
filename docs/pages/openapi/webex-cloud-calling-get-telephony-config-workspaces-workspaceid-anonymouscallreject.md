---
doc_id: webex-cloud-calling-get-telephony-config-workspaces-workspaceid-anonymouscallreject
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/workspaces/{workspaceId}/anonymousCallReject
operation_id: Retrieve Anonymous Call Settings for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.804032+00:00
---

# GET /telephony/config/workspaces/{workspaceId}/anonymousCallReject

**API:** Webex Cloud Calling
**Área:** Workspace Call Settings (2/2)
**operationId:** `Retrieve Anonymous Call Settings for a Workspace`
...
```bash
curl -X GET '/telephony/config/workspaces/<workspaceId>/anonymousCallReject' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `enabled` (boolean) (**requerido**): `true` if the Anonymous Call Rejection feature is enabled.
