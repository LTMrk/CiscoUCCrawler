---
doc_id: webex-contact-center-get-organization-orgid-v2-site
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/v2/site
operation_id: getAllConfigWithMetaData_9
tags: Site
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.818826+00:00
---
...
## Descripción
Retrieve a list of Site(s) in a given organization.
...
```bash
curl -X GET '/organization/<orgid>/v2/site' \
