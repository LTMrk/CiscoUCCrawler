---
doc_id: webex-contact-center-get-organization-orgid-v3-address-book-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/v3/address-book/{id}
operation_id: getConfig_2
tags: Address Book
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.721827+00:00
---
...
```bash
curl -X GET '/organization/<orgid>/v3/address-book/<id>' \
