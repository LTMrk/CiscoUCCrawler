---
doc_id: webex-cloud-calling-get-telephony-config-people-me-settings-secondarylines-lineownerid-callpark
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/people/me/settings/secondaryLines/{lineownerId}/callPark
operation_id: getMySecondaryLinesCallParkSettings
tags: Call Settings For Me
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:07.961894+00:00
---

# GET /telephony/config/people/me/settings/secondaryLines/{lineownerId}/callPark

**API:** Webex Cloud Calling
**Área:** Call Settings For Me
**operationId:** `getMySecondaryLinesCallParkSettings`
...
```bash
curl -X GET '/telephony/config/people/me/settings/secondaryLines/<lineownerId>/callPark' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `groupName` (string) (**requerido**): Unique name for the call park. The maximum length is 80..
- `memberList` (array) (**requerido**): List of members in the call park group.
  ...
  - `displayName` (string) (**requerido**): Display name of the member.

### Ejemplo — respuesta 200
```json
{
  "groupName": "technical support - cards - customer 1",
  "memberList": [
    {
