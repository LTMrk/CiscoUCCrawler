---
doc_id: webex-messaging-get-hds-clusters-clusterid
source: webex-openapi-specs/public-spec/webex-messaging.json
api: Webex Messaging
api_version: 1.0.0
method: GET
path: /hds/clusters/{clusterId}
operation_id: getHDSClusterDetails
tags: Hybrid Data Security
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:44.804631+00:00
---

# GET /hds/clusters/{clusterId}
...
```bash
curl -X GET '/hds/clusters/<clusterId>' \
