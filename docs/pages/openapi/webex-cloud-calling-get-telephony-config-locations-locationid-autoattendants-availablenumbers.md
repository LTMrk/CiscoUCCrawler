---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-autoattendants-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/autoAttendants/availableNumbers
operation_id: getAutoAttendantPrimaryAvailablePhoneNumbers
tags: Features:  Auto Attendant
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.683746+00:00
---
...
**operationId:** `getAutoAttendantPrimaryAvailablePhoneNumbers`

## Resumen
Get Auto Attendant Primary Available Phone Numbers

## Descripción
List the service and standard PSTN numbers that are available to be assigned as the auto attendant's primary phone number.
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/autoAttendants/availableNumbers' \
