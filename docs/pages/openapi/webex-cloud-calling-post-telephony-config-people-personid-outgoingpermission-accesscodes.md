---
doc_id: webex-cloud-calling-post-telephony-config-people-personid-outgoingpermission-accesscodes
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/people/{personId}/outgoingPermission/accessCodes
operation_id: createAccessCodesForPerson
tags: User Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.153585+00:00
---
...
**operationId:** `createAccessCodesForPerson`
...
```bash
curl -X POST '/telephony/config/people/<personId>/outgoingPermission/accessCodes' \
