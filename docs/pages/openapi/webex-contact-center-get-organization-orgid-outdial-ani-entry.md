---
doc_id: webex-contact-center-get-organization-orgid-outdial-ani-entry
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/outdial-ani/entry
operation_id: getAllConfigWithMetaDataOutDialANIEntry2
tags: Outdial ANI
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.707499+00:00
---

# GET /organization/{orgid}/outdial-ani/entry

**API:** Webex Contact Center
**Área:** Outdial ANI
**operationId:** `getAllConfigWithMetaDataOutDialANIEntry2`

## Resumen
List Outdial ANI Entries

## Descripción
Retrieve a list of Outdial ANI Entries in a given organization.
...
```bash
curl -X GET '/organization/<orgid>/outdial-ani/entry' \
