---
doc_id: webex-cloud-calling-post-telephony-config-virtuallines-virtuallineid-voicemail-actions-resetpin-invoke
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/config/virtualLines/{virtualLineId}/voicemail/actions/resetPin/invoke
operation_id: Reset Voicemail PIN for a Virtual Line
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.364216+00:00
---

# POST /telephony/config/virtualLines/{virtualLineId}/voicemail/actions/resetPin/invoke

**API:** Webex Cloud Calling
**Área:** Virtual Line Call Settings
**operationId:** `Reset Voicemail PIN for a Virtual Line`
...
Updating the voicemail pin for a virtual line requires a full, user, or location administrator auth token with a scope of `spark-admin:telephony_config_write`.
...
```bash
curl -X POST '/telephony/config/virtualLines/<virtualLineId>/voicemail/actions/resetPin/invoke' \
