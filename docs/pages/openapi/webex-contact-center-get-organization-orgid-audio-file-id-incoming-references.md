---
doc_id: webex-contact-center-get-organization-orgid-audio-file-id-incoming-references
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/audio-file/{id}/incoming-references
operation_id: getIncomingReferences_19
tags: Audio Files
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-21T15:48:41.728292+00:00
---
...
**API:** Webex Contact Center
**Área:** Audio Files
**operationId:** `getIncomingReferences_19`
...
```bash
curl -X GET '/organization/<orgid>/audio-file/<id>/incoming-references' \
