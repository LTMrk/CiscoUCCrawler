---
doc_id: webex-contact-center-get-organization-orgid-address-book-id
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/address-book/{id}
operation_id: getConfigWithEntries
tags: Address Book
deprecated: true
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.640692+00:00
---

# GET /organization/{orgid}/address-book/{id}

> **ENDPOINT DEPRECADO.** No usar en integraciones nuevas.

**API:** Webex Contact Center
**Área:** Address Book
**operationId:** `getConfigWithEntries`

## Resumen
Get specific Address Book by ID

## Descripción
Retrieve an existing Address Book by ID in a given organization. To get address book having large entries use latest apis.
...
```bash
curl -X GET '/organization/<orgid>/address-book/<id>' \
