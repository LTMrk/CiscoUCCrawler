---
doc_id: webex-contact-center-get-organization-orgid-v2-address-book-addressbookid-entry
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/v2/address-book/{addressBookId}/entry
operation_id: getAllConfigWithMetaData_29
tags: Address Book
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-20T13:57:48.668867+00:00
---
...
**API:** Webex Contact Center
**Área:** Address Book
**operationId:** `getAllConfigWithMetaData_29`
...
```bash
curl -X GET '/organization/<orgid>/v2/address-book/<addressBookId>/entry' \
