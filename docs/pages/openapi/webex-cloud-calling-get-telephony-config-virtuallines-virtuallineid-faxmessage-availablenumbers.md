---
doc_id: webex-cloud-calling-get-telephony-config-virtuallines-virtuallineid-faxmessage-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/virtualLines/{virtualLineId}/faxMessage/availableNumbers
operation_id: Get Virtual Line Fax Message Available Phone Numbers
tags: Virtual Line Call Settings
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-31T10:47:27.366962+00:00
---
...
**operationId:** `Get Virtual Line Fax Message Available Phone Numbers`
...
```bash
curl -X GET '/telephony/config/virtualLines/<virtualLineId>/faxMessage/availableNumbers' \
