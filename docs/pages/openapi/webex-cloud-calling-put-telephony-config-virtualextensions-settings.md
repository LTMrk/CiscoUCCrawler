---
doc_id: webex-cloud-calling-put-telephony-config-virtualextensions-settings
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: PUT
path: /telephony/config/virtualExtensions/settings
operation_id: Modify Virtual Extension Settings
tags: Features: Virtual Extensions
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.719102+00:00
---
...
**operationId:** `Modify Virtual Extension Settings`
...
```bash
curl -X PUT '/telephony/config/virtualExtensions/settings' \
