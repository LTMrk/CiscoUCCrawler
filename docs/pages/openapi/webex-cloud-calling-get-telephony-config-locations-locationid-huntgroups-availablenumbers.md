---
doc_id: webex-cloud-calling-get-telephony-config-locations-locationid-huntgroups-availablenumbers
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/locations/{locationId}/huntGroups/availableNumbers
operation_id: getHuntGroupPrimaryAvailablePhoneNumbers
tags: Features:  Hunt Group
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.051690+00:00
---

# GET /telephony/config/locations/{locationId}/huntGroups/availableNumbers

**API:** Webex Cloud Calling
**Área:** Features:  Hunt Group
**operationId:** `getHuntGroupPrimaryAvailablePhoneNumbers`

## Resumen
Get Hunt Group Primary Available Phone Numbers

## Descripción
List the service and standard PSTN numbers that are available to be assigned as the hunt group's primary phone number.
...
```bash
curl -X GET '/telephony/config/locations/<locationId>/huntGroups/availableNumbers' \
