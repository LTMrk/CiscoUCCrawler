---
doc_id: webex-cloud-calling-get-telephony-config-workspaces-workspaceid-musiconhold
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /telephony/config/workspaces/{workspaceId}/musicOnHold
operation_id: Retrieve Music On Hold Settings for a Workspace
tags: Workspace Call Settings (2/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.406186+00:00
---

# GET /telephony/config/workspaces/{workspaceId}/musicOnHold

**API:** Webex Cloud Calling
**Área:** Workspace Call Settings (2/2)
**operationId:** `Retrieve Music On Hold Settings for a Workspace`
...
```bash
curl -X GET '/telephony/config/workspaces/<workspaceId>/musicOnHold' \
