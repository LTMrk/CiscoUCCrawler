---
doc_id: webex-contact-center-get-organization-orgid-channel-id-incoming-references
source: webex-openapi-specs/public-spec/webex-contact-center.json
api: Webex Contact Center
api_version: 1.0.0
method: GET
path: /organization/{orgid}/channel/{id}/incoming-references
operation_id: getIncomingReferencesChannel
tags: Channel
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-17T19:59:29.845007+00:00
---

# GET /organization/{orgid}/channel/{id}/incoming-references

**API:** Webex Contact Center
**Área:** Channel
**operationId:** `getIncomingReferencesChannel`

## Resumen
List references for a specific Channel

## Descripción
Retrieve a list of all entities that have reference to an existing Channel by ID in a given organization. Includes Asset and Entry Point entities that reference the channel.
...
```bash
curl -X GET '/organization/<orgid>/channel/<id>/incoming-references' \
