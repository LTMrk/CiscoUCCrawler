---
doc_id: webex-cloud-calling-delete-telephony-config-people-me-settings-sequentialring-criteria-id
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: DELETE
path: /telephony/config/people/me/settings/sequentialRing/criteria/{id}
operation_id: deleteMySequentialRingCriteria
tags: Call Settings For Me With UserHub Phase3
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-18T23:45:43.200438+00:00
---

# DELETE /telephony/config/people/me/settings/sequentialRing/criteria/{id}

**API:** Webex Cloud Calling
**Área:** Call Settings For Me With UserHub Phase3
**operationId:** `deleteMySequentialRingCriteria`
...
```bash
curl -X DELETE '/telephony/config/people/me/settings/sequentialRing/criteria/<id>' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**204**: Sequential Ring Criteria deleted successfully. No content is returned.
