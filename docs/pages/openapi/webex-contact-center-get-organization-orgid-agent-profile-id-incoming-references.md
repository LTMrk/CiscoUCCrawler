...
operation_id: getIncomingReferencesDesktopProfile
tags: Desktop Profile
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T15:03:57.662742+00:00
---
...
```bash
curl -X GET '/organization/<orgid>/agent-profile/<id>/incoming-references' \
