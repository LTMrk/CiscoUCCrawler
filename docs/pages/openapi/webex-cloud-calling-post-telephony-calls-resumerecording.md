---
doc_id: webex-cloud-calling-post-telephony-calls-resumerecording
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: POST
path: /telephony/calls/resumeRecording
operation_id: resumerecording
tags: Call Controls, External Voicemail
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-09-01T07:56:51.559380+00:00
---
...
- `callId` (string): The call identifier of the call to resume recording.
...
```bash
curl -X POST '/telephony/calls/resumeRecording' \
