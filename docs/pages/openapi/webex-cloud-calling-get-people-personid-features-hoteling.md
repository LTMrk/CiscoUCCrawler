---
doc_id: webex-cloud-calling-get-people-personid-features-hoteling
source: webex-openapi-specs/public-spec/webex-cloud-calling.json
api: Webex Cloud Calling
api_version: 1.0.0
method: GET
path: /people/{personId}/features/hoteling
operation_id: Read Hoteling Settings for a Person
tags: User Call Settings (1/2)
deprecated: false
scopes: 
license: CC-BY-4.0
retrieved_at: 2026-08-19T19:15:08.144519+00:00
---

# GET /people/{personId}/features/hoteling

**API:** Webex Cloud Calling
**Área:** User Call Settings (1/2)
**operationId:** `Read Hoteling Settings for a Person`
...
```bash
curl -X GET '/people/<personId>/features/hoteling' \
  -H 'Authorization: Bearer <TOKEN>'
```

## Respuestas correctas
**200**: OK
- `enabled` (boolean) (**requerido**): When `true`, allow this person to connect to a Hoteling host device.
