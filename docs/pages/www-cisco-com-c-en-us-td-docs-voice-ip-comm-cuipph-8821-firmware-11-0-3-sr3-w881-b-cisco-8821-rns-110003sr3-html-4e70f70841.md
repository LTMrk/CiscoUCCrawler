...
These release notes support the Cisco Wireless IP Phone 8821 Firmware Release 11.0(3)SR3.
...
### Install Firmware Release 11.0(3)SR3 on Cisco Unified Communications Manager
...
Firmware file: cmterm-8821-sip.11-0-3SR3-2.k3.cop.sgn

If you added
				  the firmware file to the cart, click the Download Cart link when you are ready to download
				  the file.

### Install Firmware Release 11.0(3)SR3 on Cisco Unified Communications Manager Express
...
The file to download is cmterm-8821.11-0-3SR3-2.zip
...
| Cisco Wireless LAN Controller | 8.0.121.0 | 8.0.140.0, 8.2.151.0, 8.3.112.0 |
...
| Step 5 | In the Latest
			 Releases folder, choose 11.0(3)SR3 . |
| Step 6 | Select the
			 firmware file, click the Download or Add to
				cart button, and follow the prompts. Firmware file: cmterm-8821-sip.11-0-3SR3-2.k3.cop.sgn Note If you added
				  the firmware file to the cart, click the Download Cart link when you are ready to download
...
| Step 4 | Choose 11.0(3)SR3 in the Latest Releases folder. |
| Step 5 | Click Download or Add to cart and follow the prompts. The file to download is cmterm-8821.11-0-3SR3-2.zip |
