---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-12-5-1-installatio-006f288149
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_12_5_1/installation/guide/ucce_b_cti-os-system-manager-guide12-5/ucce_b_cti-os-system-manager-guide12-5_chapter_01001.html
retrieved_at: 2026-08-16T20:07:29.050564+00:00
---
...
The Unified
                                          					 ICM NodeManager (fault tolerance manager). Each Unified ICM service is started
                                          					 by NodeManager, and NodeManager restarts any abnormally terminated processes.
...
The server processes are managed by a fault tolerance/recovery platform called NodeManager. NodeManager creates and monitors
                           each process running as part of the CTI OS service, and automatically restarts abnormally terminated processes.
...
| NM | The Unified
                                          					 ICM NodeManager (fault tolerance manager). Each Unified ICM service is started
                                          					 by NodeManager, and NodeManager restarts any abnormally terminated processes. | No |
| NMM | The Unified
                                          					 ICM NodeManagerManager (system fault tolerance). Each Unified ICM Node (e.g.
                                          					 CTI OS) starts up a NMM process to handle system-level faults. In the event of
