---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cer-15su4-english-release-notes-guide-cer0-b-cisco-emergency-responder-relea-225f40c0dd
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cer/15su4/english/release_notes/guide/cer0_b_cisco-emergency-responder-release-notes-15SU4.html
retrieved_at: 2026-08-21T06:38:41.185177+00:00
---

Cisco Emergency Responder Version 15SU4 Release Notes
...
Cisco Emergency Responder Release 15SU4 supports the following new feature:

## Fresh Install with Data Import

Virtual to Virtual (V2V) migration make it easy to upgrade and migrate Emergency Responder. In the same process, you can upgrade
                  the Emergency Responder version, move to a new virtual machine configuration, upgrade the VMware vSphere ESXi version, and
                  migrate to new hardware if desired.
...
For more information on Install with Data Import, see the Cisco Emergency Responder Administration Guide .

## New Hypervisor Support

Emergency Responder Release 15SU4 introduces support for additional virtualization options. In addition to VMware vSphere
                  ESXi, Release 15SU4 supports Cisco NFVIS-for-UC and Cisco Compute Hyperconverged with Nutanix (CCHN) for on-premises calling
                  deployments. These additions allow on-premises customers to choose between traditional VMware support, a Cisco-native virtualization
                  layer for appliances, or a robust hyperconverged infrastructure (HCI) solution.
...
Supported Applications : Cisco Emergency Responder. Other workloads (including the remainder of the Collaboration portfolio, other Cisco products,
                              third-party applications, or homegrown applications) are not supported.
...
The information in the following sections discuss Hardware and Software requirements for Cisco Emergency Responder 15SU4.
...
Microsoft Edge, Chrome, and Firefox on Windows 11 (64 bit)
...
Cisco Unified Wireless IP Phone 7925G, 7925G-EX, 7926G , 8821 , and Cisco Webex App
...
Cisco Emergency Responder supports Install with Data Import only from Release 15SU4 onwards.
...
Cisco Emergency Responder 14 or Cisco Emergency Responder 14SU1 or Cisco Emergency Responder 14SU2 or Cisco Emergency Responder
                              14SU3a or Cisco Emergency Responder 14SU4 or Cisco Emergency Responder 14SU5
...
14, 14SU1, 14SU2, 14SU3a, 14SU4 , and 14SU5
...
CER OS admin servlet is showing a database communication error message for login with wrong credentials
...
| Web browser | Microsoft Edge, Chrome, and Firefox on Windows 11 (64 bit) Chrome, Firefox, and Safari with MacOS (15.5) | We recommend that you use the latest version for all the web browsers supported. |
...
| Note | If the user dismisses the display before confirming or updating the location, the location can be recovered by selecting Running
                                                Applications from the Services menu or by resetting the phone. |
| Phones supported for Access Point based tracking with Unified Communications Manager 11.5 and later Cisco Unified Wireless IP Phone 7925G, 7925G-EX, 7926G , 8821 , and Cisco Webex App | Wireless Access Points need to be defined in Unified Communications Manager 11.5 and later, these phones provide their upstream
                                       infrastructure information (like BSSID) through Station Info messages to Unified Communications Manager. Cisco Emergency Responder
                                       through AXL Change Notification can track these phones through the associated Access Point. |
...
| Note | Cisco Emergency Responder supports Install with Data Import only from Release 15SU4 onwards. |
|---|---|
...
| Identifier | Headline |
|---|---|
| CSCws98140 | CER OS admin servlet is showing a database communication error message for login with wrong credentials |
