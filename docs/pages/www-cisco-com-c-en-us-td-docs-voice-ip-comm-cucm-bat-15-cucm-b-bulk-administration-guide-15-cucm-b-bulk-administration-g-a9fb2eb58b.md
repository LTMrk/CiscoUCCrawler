---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-bat-15-cucm-b-bulk-administration-guide-15-cucm-b-bulk-administration-g-a9fb2eb58b
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/bat/15/cucm_b_bulk-administration-guide-15/cucm_b_bulk-administration-guide-1251su2_chapter_01001011.html
retrieved_at: 2026-08-21T09:21:22.916156+00:00
---
...
Configure TAPS—Allows you to enable TAPS usage for all phones that use auto-registration or to limit TAPS to only phones that
                                    are added through BAT with pseudo MAC addresses.
...
After BAT has added the new phone configurations with pseudo MAC addresses in Cisco Unified Communications Manager Administration, you can plug the phones into the network. You or the phone user can dial a TAPS directory number that causes
...
You have 100 new-hire employees starting on Monday. You must add these users and their new phones to Cisco Unified Communications Manager Administration. You can use BAT to create a phone template for these 100 phones and a CSV data file for phones and users.
                                    By using the pseudo MAC address option in the CSV data file, you do not need to add the individual MAC addresses for the new phones. With auto-registration
...
For phones that are added by using BAT and have a pseudo MAC address.

For existing phones in Cisco Unified Communications Manager Administration

The default setting limits use of TAPS to phones that have a pseudo MAC address with a device name that starts with the prefix "BAT."
...
Allow Auto-Registered phones to reset with a profile with a pseudo MAC address .
...
| Step 4 | Choose one of these two options from the Parameter Value drop-down
                                       			 list box, and click Save . Allow Auto-Registered phones to reset with a profile with a pseudo MAC address . TAPS updates auto-registered phones with a profile that have the pseudo MAC address only. Allow Auto-Registered phones to reset with any
