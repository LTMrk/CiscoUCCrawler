---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-pcce-pcce-12-6-1-maintenance-guide-pcce-b-report-875f2adef4
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/pcce/pcce_12_6_1/maintenance/guide/pcce_b_Reporting-User-Guide-12_6_1/pcce_b_cisco-packaged-contact-center-enterprise_chapter_010110.html
retrieved_at: 2026-08-21T16:57:05.604754+00:00
---
...
Chapter: Real Time Outbound Option Report Templates

## Chapter: Real Time Outbound Option Report Templates

# Real Time Outbound Option Report Templates
...
The
                                          						number of calls where the customer hung up immediately after picking up the
                                          						phone.
...
Campaign
                                          						Start Zone 2 time measured in HH:MM:SS format. Campaign Start Zone 2 time is
                                          						the start time that a customer can be phoned at Zone 2. Campaign time is
                                          						normalized to the customer's time zone. For example, if the campaign runs from
                                          						3 to 6 p.m. Eastern Standard time and it is past 6 p.m. on the East coast, you can
                                          						still dial someone in Chicago because it is not yet 6 p.m. there.
...
The
                                          						number of contacts today where the customer hung up immediately after picking
                                          						up the phone.
...
Campaign Start Zone 2 time measured in HH:MM format. Campaign Start Zone 2 time is the start time that a customer can be phoned
                                          at Zone2. Campaign time is normalized to the customer's time zone. For example, if the campaign runs from 3 to 6 p.m. Eastern
...
| Zone 1
                                          						...
                                          						from: Campaign.HomeDuration |
| Start
                                          						Zone 2 Time | Campaign
                                          						Start Zone 2 time measured in HH:MM:SS format. Campaign Start Zone 2 time is
                                          						the start time that a customer can be phoned at Zone 2. Campaign time is
                                          						normalized to the customer's time zone. For example, if the campaign runs from
                                          						3 to 6 p.m. Eastern Standard time and it is past 6 p.m. on the East coast, you can
                                          						still dial someone in Chicago because it is not yet 6 p.m. there. Derived from: Campaign.WorkStartHours :
                                          						Campaign.WorkStartMinutes |
| End
...
| Customer Abandon | The number of contacts today where the customer hung up immediately after picking up the phone. Derived from: Dialer_Real_Time.CustomerAbandonDetectHalf |
...
| Customer Abandon | The
                                          						number of contacts today where the customer hung up immediately after picking
                                          						up the phone. Derived from: Dialer_Real_Time.CustomerAbandonDetectHalf |
| Talk
                                          						Time | The
                                          						total time in HH:MM (hours, minutes, seconds) that agents spent talking on the
...
| Start Zone 2 Time | Campaign Start Zone 2 time measured in HH:MM format. Campaign Start Zone 2 time is the start time that a customer can be phoned
                                          at Zone2. Campaign time is normalized to the customer's time zone. For example, if the campaign runs from 3 to 6 p.m. Eastern
                                          Standard time and it is past 6 p.m. on the East coast, you can still dial someone in Chicago because it is not yet 6 p.m.
                                          there. Derived from: Campaign.WorkStartHours ':' Campaign.WorkStartMinutes |
