---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-admin-cucm-b-feature-configuration-guide-for-15-cucm-m-configure-multil-8fdcef209c
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/admin/cucm_b_feature-configuration-guide-for-15/cucm_m_configure-multilevel-precedence-and-preemption.html
retrieved_at: 2026-08-16T16:07:06.407836+00:00
---
...
Before Release 15SU3, MLPP notifications did not appear on call-originating SIP endpoints until the call was connected when
                                                   using a route or translation pattern. Starting with Release 15SU3, Unified CM supports MLPP notifications on specific SIP
                                                   phone models. This feature enables these models to play precedence ringback notifications before the call connects. The supported
                                                   models are the Cisco Desk Phone 9841, Cisco Desk Phone 9851, Cisco Desk Phone 9861, Cisco Desk Phone 9871, and Cisco Video
                                                   Phone 8875 (including Non-Radio models).
...
| MLPP Notification | Only MLPP Indication Enabled devices generate MLPP-related notifications, such as tones and ringers. If a precedence call
                                       ...
                                       from a device that is not MLPP Indication Enabled, no precedence ringback tone is applied. If a device that is not MLPP Indication
                                       Enabled is involved in a call that is preempted (that is, the other side of the call initiated preemption), no preemption
                                       tone gets applied to the device. Note Before Release 15SU3, MLPP notifications did not appear on call-originating SIP endpoints until the call was connected when
                                                   using a route or translation pattern. Starting with Release 15SU3, Unified CM supports MLPP notifications on specific SIP
                                                   phone models. This feature enables these models to play precedence ringback notifications before the call connects. The supported
                                                   models are the Cisco Desk Phone 9841, Cisco Desk Phone 9851, Cisco Desk Phone 9861, Cisco Desk Phone 9871, and Cisco Video
                                                   Phone 8875 (including Non-Radio models). | Note | Before Release 15SU3, MLPP notifications did not appear on call-originating SIP endpoints until the call was connected when
                                                   using a route or translation pattern. Starting with Release 15SU3, Unified CM supports MLPP notifications on specific SIP
                                                   phone models. This feature enables these models to play precedence ringback notifications before the call connects. The supported
                                                   models are the Cisco Desk Phone 9841, Cisco Desk Phone 9851, Cisco Desk Phone 9861, Cisco Desk Phone 9871, and Cisco Video
                                                   Phone 8875 (including Non-Radio models). |
| Note | Before Release 15SU3, MLPP notifications did not appear on call-originating SIP endpoints until the call was connected when
                                                   using a route or translation pattern. Starting with Release 15SU3, Unified CM supports MLPP notifications on specific SIP
                                                   phone models. This feature enables these models to play precedence ringback notifications before the call connects. The supported
                                                   models are the Cisco Desk Phone 9841, Cisco Desk Phone 9851, Cisco Desk Phone 9861, Cisco Desk Phone 9871, and Cisco Video
                                                   Phone 8875 (including Non-Radio models). |
