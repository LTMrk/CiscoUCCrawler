---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-7832-firmware-12-7-1-releasenotes-cs78-b-rns-7832-1271-html-951c4c7348
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/7832/firmware/12-7-1/releasenotes/cs78_b_rns-7832-1271.html
retrieved_at: 2026-08-21T13:22:34.919560+00:00
---

Cisco IP Conference Phone 7832 Release Notes for Firmware Release 12.7(1)
...
These release notes support the Cisco IP Conference Phone 7832 running SIP Firmware Release 12.7(1).
...
#### Hunt Group Support for Conference Phones

You can configure conference phones into hunt groups in any supported Cisco Unified Communications Manager release.

Conference phone users can sign into and out of the hunt group. Users can also view the Call Queue.

##### Hunt Groups and Incoming Call Alerts Feature in Firmware Release 12.7(1)
...
The firmware filename is cmterm-7832-sip.12-7-1-0001-393.k3.cop.sgn
...
cmterm-7832.12-7-1-0001-393.zip
...
There are no severity 1, 2, and 3 defects that are open for the Cisco IP Conference Phone 7832 for Firmware Release 12.7(1).
...
CSCvr96736 Cisco IP Phone Remote Code Execution and Denial of Service Vulnerability
...
| Step 1 | Perform one of the following actions: To find all caveats for this release, use this URL: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=12.7(1.*),12.7(1)&sb=anfr&svr=3nH&bt=custV To find all open caveats for this release, use this URL: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=12.7(1)&sb=afr&sts=open&svr=3nH&bt=custV To find all resolved caveats for this release, use this URL: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=12.7(1.*),12.7(1)&sb=fr&sts=fd&svr=3nH&bt=custV |
|---|---|
