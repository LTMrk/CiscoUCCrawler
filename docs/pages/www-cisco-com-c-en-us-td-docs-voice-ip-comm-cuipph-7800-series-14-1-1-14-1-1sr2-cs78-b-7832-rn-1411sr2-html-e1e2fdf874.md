---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-7800-series-14-1-1-14-1-1sr2-cs78-b-7832-rn-1411sr2-html-e1e2fdf874
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/7800-series/14-1-1/14-1-1sr2/cs78_b_7832-rn-1411sr2.html
retrieved_at: 2026-08-21T13:22:09.814739+00:00
---

Cisco IP Conference Phone 7832 Release Notes for Firmware Release 14.1(1)SR2
...
These release notes support the Cisco IP Conference Phone 7832 running SIP Firmware Release 14.1(1) SR2.
...
The firmware filename is cmterm-7832-sip.14-1-1-0211-134.k4.cop.sha512.
...
Select the firmware file, click the Downlod or Add to Cart button, and follow the prompts. The firmware file name is cmterm-7832.14-1-1-0211-134.zip.
...
To find all caveats for this release, use this URL: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=14.1(1.*),14.1(1)&sb=anfr&svr=3nH&bt=custV

To find all open caveats for this release, use this URL:

https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&rls=14.1(1)&sb=afr&sts=open&svr=3nH&bt=custV&prdNam=Cisco%20IP%20Phone%207800%20Series

To find all resolved caveats for this release, use this URL:

https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&rls=14.1(1),14.1(1.*)&sb=fr&svr=3nH&bt=custV&prdNam=Cisco%20IP%20Phone%207800%20Series
...
CSCwc42556 IP Phone Ringtone setting is disappeared or changed to other ringtone after firmware upgrade

CSCvx84768 Show Apps softkey by default
...
|---|---|
| Step 2 | Choose IP Conference Phone 7832 . |
| Step 3 | Choose Session Initiation Protocol (SIP) Software . |
| Step 4 | In the Latest Releases folder, choose 14.1(1)SR2 . |
| Step 5 | Select the firmware file, click the Download or Add to Cart and follow the prompts. The firmware filename is cmterm-7832-sip.14-1-1-0211-134.k4.cop.sha512. Note If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . | Note | If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . |
...
| Step 3 | Choose Session Initiation Protocol (SIP) Software . |
| Step 4 | In the Latest Releases folder, choose 14.1(1)SR2 . |
| Step 5 | Select the firmware file, click the Downlod or Add to Cart button, and follow the prompts. The firmware file name is cmterm-7832.14-1-1-0211-134.zip. |
...
| Step 1 | Perform one of the following actions: To find all caveats for this release, use this URL: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=14.1(1.*),14.1(1)&sb=anfr&svr=3nH&bt=custV To find all open caveats for this release, use this URL: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&rls=14.1(1)&sb=afr&sts=open&svr=3nH&bt=custV&prdNam=Cisco%20IP%20Phone%207800%20Series To find all resolved caveats for this release, use this URL: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&rls=14.1(1),14.1(1.*)&sb=fr&svr=3nH&bt=custV&prdNam=Cisco%20IP%20Phone%207800%20Series |
|---|---|
