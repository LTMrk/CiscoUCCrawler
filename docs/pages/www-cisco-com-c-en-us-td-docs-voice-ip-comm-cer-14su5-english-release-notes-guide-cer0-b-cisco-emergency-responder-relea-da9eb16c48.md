...
This document applies to Cisco Emergency Responder Release 14SU5. Defects are addressed as part of this release.

## Requirements

### Supported Hardware and Software

The information in the following sections discuss Hardware and Software requirements for Cisco Emergency Responder 14SU5.
...
Cisco Emergency Responder 11.5(1) and later is supported on Cisco Unified Computing System (UCS) and other virtual platforms
...
Direct upgrades to Cisco Emergency Responder 14 and SUs are supported only for the following releases:
...
Cisco Emergency Responder 12.5(1) or Cisco Emergency Responder 12.5(1a) or Cisco Emergency Responder 12.5(1) SU1 or Cisco
                              ...
                              Emergency Responder 12.5(1) SU5 or Cisco Emergency Responder 12.5(1) SU6 or Cisco Emergency Responder 12.5(1) SU7 or Cisco Emergency Responder 12.5(1) SU8b or Cisco Emergency Responder 12.5(1) SU9.

#### COP Files Required for Upgrades to Release 14 and SUs
...
12.5(1), 12.5(1a), 12.5(1) SU1, 12.5(1) SU2, 12.5(1) SU3, 12.5(1) SU4, 12.5(1) SU5, 12.5(1) SU6 , 12.5(1)SU7 , 12.5(1)SU8b , and 12.5(1)SU9
...
Secure AXL not working with CUCM version <15su2 , if CER Su2 configured with weak cipher

CSCwn78985

CSCwk99247

CER not purging cercallhistory table after it reaches above 10000

CSCwp32950

Wireless phones are not being tracked through AXL when same DN present in diff partitions

CSCwn81862

CER not sending notification emails if one email address is rejected by the email server

CSCwm85123

CER UI login failure for node installation with hostname >32

CSCwk75221

CER doesn't show any license unauthorized and PT service restart warning in welcome page

CSCwn93353

CER Access Point search view stuck in (locations tables being modified, Please wait) admin exception

CSCwo25073

(CER) Smart License Registration failing with SSM On-Prem

CSCwn44942

Duplicate ERL causing ERL details page to load up blank
...
|---|---|---|
| Cisco Unified Communications Manager | Cisco Unified Communications Manager 14 Cisco Unified Communications Manager 12.5(x) | The software that runs the telephony network. |
| Web browser | Firefox with Windows 11 (64 bit) Chrome with Windows 11 (64 bit) Microsoft Edge browser with Windows 11 (64 bit) Chrome, Firefox, and Safari with MacOS (15.5) | We recommend that you use the latest version for all the web browsers supported. |
...
| Identifier | Headline |
|---|---|
| CSCwm63368 | Secure AXL not working with CUCM version <15su2 , if CER Su2 configured with weak cipher |
| CSCwn78985 | The CER discoveries do not start once there has been a fallback in the cluster |
| CSCwk99247 | CER not purging cercallhistory table after it reaches above 10000 |
| CSCwp32950 | Wireless phones are not being tracked through AXL when same DN present in diff partitions |
| CSCwn81862 | CER not sending notification emails if one email address is rejected by the email server |
| CSCwm85123 | CER UI login failure for node installation with hostname >32 |
