---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-mpp-6800-firmware-11-1-1sr1-p680-b-release-notes-for-6800mpp-110101sr-3d466ce875
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/MPP/6800/firmware/11-1-1sr1/p680_b_release_notes_for_6800mpp_110101sr1.html
retrieved_at: 2026-08-21T23:14:41.835816+00:00
---

Cisco IP Phone 6800 Series Multiplatform Phones Release Notes for Firmware Release 11.1(1)SR1
...
Use these release notes with the following Cisco IP Phone 6800 Series Multiplatform Phones running SIP Firmware Release 11.1(1)SR1.
...
https://10.74.10.225/firmware/sip68xx.11-1-1MSR1-1.loads
...
The following list contains the severity 1, 2, and 3 defects that are open for the Cisco IP Phone 6800 Series Multiplatform Phones that use Firmware Release 11.1(1)SR1.
...
The following list contains the severity 1, 2, and 3 defects that are resolved for the Cisco IP Phone 6800 Series Multiplatform Phones that use Firmware Release 11.1(1)SR1.
...
| Step 5 | Under Latest , choose the 11.1.1 MSR1-1 folder. |
| Step 6 | (Optional) Place your mouse pointer on the filename to display the file details and checksum values. |
| Step 7 | Download the cp-68xx.11-1-1MSR1-1_REL.zip file. |
