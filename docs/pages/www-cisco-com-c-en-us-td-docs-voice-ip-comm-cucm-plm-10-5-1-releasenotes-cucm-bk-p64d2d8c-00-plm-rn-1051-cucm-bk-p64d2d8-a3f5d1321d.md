...
For information about which COP file you need to apply prior to performing an upgrade, see topics relating to license management in the Compatibility Information for Cisco Unified Communications Manager .
...
You can verify that you
		  have the correct COP file installed with the following commands:
...
In Release 10.0(1) and later, Cisco only supports virtualized
		  deployments of Cisco Prime License Manager, formally known as Enterprise
		  License Manager, on Cisco Unified Computing System servers, or on a
		  Cisco-approved third-party server configuration.

## Set Manual
	 MAC

Configure virtualized machines with Manual / Static MAC with the
		  following steps.
...
| Note | For information about which COP file you need to apply prior to performing an upgrade, see topics relating to license management in the Compatibility Information for Cisco Unified Communications Manager . |
|---|---|
