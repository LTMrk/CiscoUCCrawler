...
Cisco Emergency Responder Release 12.5(1)SU1 supports the following new features:

## Enhanced Location Tracking for Jabber Clients

Enhanced Location tracking allows Cisco Emergency Responder to track the Wireless Jabber Clients registered to Unified Communications
                  Manager and identify them behind Corporate defined Access Points and provide corresponding ERL Treatment.

Wireless Jabber Clients (12.6) registered to Unified Communications Manager release 12.5(1)SU1 can be tracked behind Access
                              Points in Emergency Responder from release 12.5(1) SU1 and onwards.

## FIPS Mode Support and Enhancement

FIPS Mode and Enhanced Security Mode do not support MD5 or DES encryption methods. From 12.5(1)SU1 release onwards, when in
                  FIPS Mode or Enhanced Security Mode, SNMPv3 encryption settings allow encryption methods using SHA1 or AES-128 only.
...
The information in the following sections discuss Hardware and Software requirements for Cisco Emergency Responder 12.5(1)SU1.
...
Assigning to Smart Account through API is failing for CER Upgraded from 11.5 to 12.5
...
Unable to add more than 6 IP addresses under CER SNMP V3 user
...
| Note | Wireless Jabber Clients (12.6) registered to Unified Communications Manager release 12.5(1)SU1 can be tracked behind Access
                              Points in Emergency Responder from release 12.5(1) SU1 and onwards. |
|---|---|
...
| CSCvp18565 | Assigning to Smart Account through API is failing for CER Upgraded from 11.5 to 12.5 |
