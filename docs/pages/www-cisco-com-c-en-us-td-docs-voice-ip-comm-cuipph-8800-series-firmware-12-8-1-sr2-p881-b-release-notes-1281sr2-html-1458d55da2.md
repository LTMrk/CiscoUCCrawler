---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-8800-series-firmware-12-8-1-sr2-p881-b-release-notes-1281sr2-html-1458d55da2
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/8800-series/firmware/12-8-1-SR2/p881_b_release-notes-1281sr2.html
retrieved_at: 2026-08-21T13:32:54.132715+00:00
---

Cisco IP Phone 8811, 8841, 8851, 8851NR, and 8861 Release Notes for Firmware Release 12.8(1)SR2
...
These release notes support the Cisco IP Phone 8811, 8841, 8851, 8851NR, and 8861 running SIP
                  				Firmware Release 12.8(1)SR2.
...
In the Latest Releases folder, choose 12.8(1)SR2 .
...
For Cisco IP Phone 8811, 8841, 8851, 8851NR, and
                                          								8861—cmterm-88xx-sip.12-8-1-0201-486.k3.cop.sgn
...
For Cisco IP Phone 8811, 8841, 8851, 8851NR, and
                              						8861—cmterm-88xx.12-8-1-0201-486.zip
...
The following list contains severity 1, 2, and 3 defects that are open for the Cisco IP Phone
                        				8811, 8841, 8851, 8851NR, and 8861 for Firmware Release 12.8(1)SR2.
...
CSCvp34626 - No wifi icon displayed at the upper right corner of LCD after
...
The following list contains the severity 1, 2, and 3 defects that are resolved for the Cisco
                        				IP Phone 8811, 8841, 8851, 8851NR, and 8861 that uses Firmware Release
                        				12.8(1)SR2.
...
CSCvw41907 - SIP phones call stats had Vopktlost & LostPkt with negative
                              						values -1, -6
...
|---|---|
| 8811, 8841, 8851, 8851NR, and 8861 | Cisco Unified Communications Manager 10.5(2) and later Cisco Unified Communications Manager DST Olsen version D or later SRST 8.0 (IOS load 15.1(1)T) and above Cisco Expressway 8.7 |
...
| Step 5 | In the Latest Releases folder, choose 12.8(1)SR2 . |
| Step 6 | Select the firmware file, click the Download or Add to cart button, and follow the prompts: For Cisco IP Phone 8811, 8841, 8851, 8851NR, and
                                          								8861—cmterm-88xx-sip.12-8-1-0201-486.k3.cop.sgn Note If you added the firmware file to the cart, click the Download
