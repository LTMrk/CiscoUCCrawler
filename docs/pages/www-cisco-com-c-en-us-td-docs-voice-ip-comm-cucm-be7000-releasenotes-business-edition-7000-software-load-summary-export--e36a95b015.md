---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-be7000-releasenotes-business-edition-7000-software-load-summary-export--e36a95b015
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/BE7000/releasenotes/business-edition-7000-software-load-summary-export-unrestricted-version-12x14x-xu-14/cucm_m_business-edition-7000-software-load_xu.html
retrieved_at: 2026-08-21T21:40:30.034058+00:00
---

Business Edition 7000 Software Load Summary Export Unrestricted Version 12X14X-XU-14
...
If the factory-loaded software is erased (example due to hardware replacement/migration, disks reformat, RAID rebuild, virtualization
                                    software reinstall, or upgrade, so on), see the Business Edition 7000 12.5 or 14 Installation Guide for appliance rebuild instructions.
...
Partial (skip) installed OVA: Open Virtual Archive file containing an application that is installed up to the “skip” configuration point, where the application
                                    ...
                                    install with a platformConfig.xml configuration file. Refer to the Business Edition 7000 12.5 or 14 Installation Guide for further information.
...
The hypervisor datastore on the appliance includes installation files for Collaboration System Release 14 Unified Communications (UC) applications. These applications include Cisco Unified Communications Manager, Cisco Unity Connection,
...
The following table details the files included in the datastore and indicates which to use for a version 14 or 12.7 Unified Communications solution.
...
VMware-ESXi-7.0.1-16850804-Custom-Cisco-4.1.2-b.iso
...
Cisco Unified Communications Manager 12.5(1) SU2 and 14

Partial (skip) installed application OVA (7500 user VM configuration)

UCSInstall_UCOS_UNRST_12.5.1.10000-22_110_vmv13_v1.0.ova

UCSInstall_UCOS_UNRST_14.0.1.10000-20_110_vmv13_v1.0.ova
...
Bootable_UCSInstall_CUP_14.0.1.10000-20.sha512.iso

Cisco License Central

Preloaded non-bootable application upgrade-only image for Service Update (SU)

UCSInstall_UCOS_UNRST_12.5.1.12900-115.sgn.iso
...
Cisco Unified Communications Manager - IM &Presence Service 12.5(1) SU2 and 14

Partial (skip) installed application OVA (5000 user VM configuration)

UCSInstall_CUP_UNRST_12.5.1.10000-22_80d_vmv13_v1.0.OVA

UCSInstall_CUP_UNRST_14.0.1.10000-16_80d_vmv13_v1.0.ova
...
UCSInstall_CUP_UNRST_12.5.1.12900-25.sgn.iso
...
Cisco Unity Connection 12.5(1) SU2 and 14

Partial (skip) installed application OVA (5000 user VM configuration)

UCSInstall_CUC_UNRST_12.5.1.10000-23_200_v1.0.ova

UCSInstall_CUC_UNRST_14.0.1.10000-19_200_v1.0.ova
...
UCSInstall_CUC_UNRST_12.5.1.12900-56.sgn.iso
...
Cisco Emergency Responder 12.5(1) SU2 and 14
...
Cisco Expressway X12.6.2 12.7 and 14
...
Cisco Prime Collaboration Deployment 14

Deployed OVA containing preinstalled application (Default VM configuration)

pcd_vApp_UCOS_14.0.1.10000-8_vmv13_v1.2.ova
...
| Application or File | Filename for appliances with Cisco Product ID's: BE7M-M5-XU BE7H-M5-XU | Access |
|---|---|---|
| Virtualization Software |
| VMware vSphere ESXi 7.0 U1 |
| CISCO Custom Image for ESXi 7.0 U1 Install CD | VMware-ESXi-7.0.1-16850804-Custom-Cisco-4.1.2-b.iso | VMware |
| Cisco Business Edition Embedded Virtualization License |
...
| Calling, Messaging & Edge Applications |
| Cisco Unified Communications Manager 12.5(1) SU2 and 14 |
| Partial (skip) installed application OVA (7500 user VM configuration) | UCSInstall_UCOS_UNRST_12.5.1.10000-22_110_vmv13_v1.0.ova UCSInstall_UCOS_UNRST_14.0.1.10000-20_110_vmv13_v1.0.ova | Factory preload only |
| Preloaded bootable application installer image for base release | Bootable_UCSInstall_UCOS_12.5.1.10000-22.sgn.iso Bootable_UCSInstall_CUP_14.0.1.10000-20.sha512.iso | Cisco License Central |
| Preloaded non-bootable application upgrade-only image for Service Update (SU) | UCSInstall_UCOS_UNRST_12.5.1.12900-115.sgn.iso | Software Download |
| Locale files | CUCM_12.5.1.10000-22_Locale.iso | Software Download |
| Preloaded recovery software image | 12.5.1.10000-22-recovery.iso 14.0.1.10000-20-recovery.iso | Software Download |
| Preloaded base OVA for Virtual Machine configurations | cucm_12.5_vmv13_v1.0.ova cucm_14.0_vmv13_v1.1.ova | Software Download |
| Cisco Unified Communications Manager - IM &Presence Service 12.5(1) SU2 and 14 |
| Partial (skip) installed application OVA (5000 user VM configuration) | UCSInstall_CUP_UNRST_12.5.1.10000-22_80d_vmv13_v1.0.OVA UCSInstall_CUP_UNRST_14.0.1.10000-16_80d_vmv13_v1.0.ova | Factory preloaded only |
| Preloaded bootable application installer image for base release | Bootable_UCSInstall_CUP_12.5.1.10000-22.sgn.iso Bootable_UCSInstall_CUP_14.0.1.10000-16.sha512.iso | Cisco License Central |
| Preloaded non-bootable application upgrade-only image for Service Update (SU) | UCSInstall_CUP_UNRST_12.5.1.12900-25.sgn.iso | Software Download |
| Locale files | IMP_Locale_12.5.iso | Software Download |
| Preloaded recovery software image | 12.5.1.10000-22-recovery.iso 14.0.1.10000-16-recovery.iso | Software Download |
| Preloaded base OVA for Virtual Machine configurations | cucm_im_p_12.5_vmv13_v1.0.ova cucm_im_p_14.0_vmv13_v1.0.ova | Software Download |
| Cisco Unity Connection 12.5(1) SU2 and 14 |
| Partial (skip) installed application OVA (5000 user VM configuration) | UCSInstall_CUC_UNRST_12.5.1.10000-23_200_v1.0.ova UCSInstall_CUC_UNRST_14.0.1.10000-19_200_v1.0.ova | Factory preload only |
| Preloaded bootable application installer image for base release | Bootable_UCSInstall_CUC_12.5.1.10000-23.sgn.iso Bootable_UCSInstall_CUC_14.0.1.10000-19.sha512.iso | Cisco License Central |
| Preloaded non-bootable application upgrade-only image for Service Update (SU) | UCSInstall_CUC_UNRST_12.5.1.12900-56.sgn.iso | Software Download |
| Locale files | cuc_locale_12.5.iso cuc_locale1_12.5.iso | Software Download |
| Preloaded recovery software image | 12.5.1.10000-23-recovery.iso 14.0.1.10000-19-recovery.iso | Software Download |
| Preloaded base OVA for Virtual Machine configurations | CUC_12.5_v1.0.ova CUC_14.0_v1.1.ova | Software Download |
| Cisco Emergency Responder 12.5(1) SU2 and 14 |
| Preloaded bootable application installer image for base release | Bootable_UCSInstall_CER_12.5.1.10000-7.sgn.iso Bootable_UCSInstall_CER_14.0.1.10000-7.sha512.iso | Cisco License Central |
...
| Preloaded recovery software image | 12.5.1.10000-7-recovery.iso 14.0.1.10000-7-recovery.iso | Cisco License Central |
| Preloaded base OVA for Virtual Machine configurations | cer_12.5_vmv13_v1.0.ova cer_14.0_vmv13_v1.0.ova | Software Download |
| Cisco Expressway X12.6.2 12.7 and 14 |
| Deployed OVA containing preinstalled application (Medium VM configuration) | s42700x12_7_1_v6.5.ova s42700x14_0_0_v6.5.ova | Software Download |
| Cisco Paging Server 12.5.1 |
...
| Cisco Prime Collaboration Deployment 14 |
| Deployed OVA containing preinstalled application (Default VM configuration) | pcd_vApp_UCOS_14.0.1.10000-8_vmv13_v1.2.ova | Cisco License Central |