---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-plm-11-5-1-su6-userguide-cplm-b-userguide-11-5-1-su6-cplm-b-userguide-1-0dd322eeaa
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/plm/11_5_1_SU6/userguide/cplm_b_userguide_11_5_1_SU6/cplm_b_userguide_11_5_1_SU6_chapter_0111.html
retrieved_at: 2026-09-08T04:54:09.054450+00:00
---
...
This command sets the log level for core services.

license management set log level
                                    				  core_services { debug | info | warn | error }

## Syntax Description

Provides detailed information about the flow of the process.
                                          					 We recommend that you use set this parameter on an as needed basis only.

Provides general information that may be useful. This
                                          					 parameter is set by default.

Provides messages about potential problems.

Provides runtime errors or unexpected conditions that could be
                                          					 critical.
...
```
admin:license management set log level core_services warn
...
This command sets the log level for product instances.

license management set log level
                                    				  product_instances { error | warn | info | debug }
...
```
admin:license management set log level product_instances warn
Log level changed to warn
```
...
```
admin:license management show log level core_services
Log level for core_services is: warn
```
...
```
admin:license management show log level product_instances
Log level for product_instances: warn
```
...
| debug | Provides detailed information about the flow of the process.
                                          					 We recommend that you use set this parameter on an as needed basis only. |
| info | Provides general information that may be useful. This
                                          					 parameter is set by default. |
| warn | Provides messages about potential problems. |
| error | Provides runtime errors or unexpected conditions that could be
                                          					 critical. |
