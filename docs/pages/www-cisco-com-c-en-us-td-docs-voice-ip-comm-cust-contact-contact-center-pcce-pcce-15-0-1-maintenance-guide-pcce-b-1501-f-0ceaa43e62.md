---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-pcce-pcce-15-0-1-maintenance-guide-pcce-b-1501-f-0ceaa43e62
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/pcce/pcce_15_0_1/maintenance/guide/pcce_b_1501_features-guide/rcct_m_1501_preface.html
retrieved_at: 2026-08-21T12:09:58.961878+00:00
---
...
This guide explains features that you can use with Cisco Packaged Contact Center Enterprise . For each feature, there is a description, procedures for initial setup, and details on the functionality the feature provides.

## Audience

This guide is for Contact Center administrators who configure and run the contact center, manage agents, and address operational
                              issues.
...
Unified CCE preceded or followed by an em dash (—) indicates that the content is specific to Unified CCE.
...
Packaged CCE preceded or followed by an em dash (—) indicates that the content is specific to Packaged CCE.

| Change | See | Date |
|---|---|---|
| Initial Release of Document for Release 15.0(1) |  |
| Support for Facebook, Whatsapp, and Apple Messages for Business Digital Channels | Digital Channels Integration Using Webex Connect | April 2025 |
| Support for anti-malware scanning in Digital Channels | Anti-Malware Scan for Attachments |
| Add MR PIM for Outbound 4000 and 12000 Agent Deployment | Add MR PIM for Outbound 4000 and 12000 Agent Deployment |
...
| window font | Window font, such as Courier, is used for the following: Text as it appears in code or that the window displays. Example: <html><title>Cisco Systems, Inc. </title></html> |
...
| —Unified CCE or Unified CCE— or Unified CCE only— | Unified CCE preceded or followed by an em dash (—) indicates that the content is specific to Unified CCE. |
| —Packaged CCE or Packaged CCE— or Packaged CCE only— | Packaged CCE preceded or followed by an em dash (—) indicates that the content is specific to Packaged CCE. |