---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-7800-series-14-4-1-sr2-p2ad-b-7800-rn-1441sr2-html-f66e066caf
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/7800-series/14-4-1-SR2/p2ad_b_7800-rn-1441sr2.html
retrieved_at: 2026-08-17T01:07:10.317207+00:00
---

Cisco IP Phone 7800 Release Notes for Firmware Release 14.4(1)SR2
...
These release notes support the Cisco IP Phones 7811, 7821, 7841, and 7861 running SIP Firmware Release 14.4(1)SR2.
...
The firmware filename is cmterm-78xx.14-4-1-0201-225.k4.cop.sha512.
...
If a Cisco Unified Communications Manager is not available to load the installer program, the following zip file is available
                        to load the firmware cmterm-78xx.14-4-1-0201-225.zip.
...
The firmware filename is cmterm-78xx.14-4-1-0201-225.zip.
...
Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284883944&rls=14.4(1)SR2&sb=anfr&svr=3nH&bt=custV

Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284883944&rls=14.4(1)SR2&sb=afr&sts=open&svr=3nH&bt=custV

Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=14.4(1)SR2&sb=fr&svr=3nH&bt=custV
...
The following list contains a snapshot of the severity 1, 2, and 3 caveats that are open for the Cisco IP Phone 7800 Series
                     for Firmware Release 14.4(1)SR2.
...
| Step 5 | Select the firmware file, click the Download or Add to Cart button, and follow the prompts. The firmware filename is cmterm-78xx.14-4-1-0201-225.k4.cop.sha512. Note If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . | Note | If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . |
...
| Step 3 | Choose Session Initiation Protocol (SIP) Software . |
| Step 4 | In the Latest Release folder, choose 14.4(1)SR2 . |
| Step 5 | Select the firmware file, click the Download or Add to Cart button, and follow the prompts. The firmware filename is cmterm-78xx.14-4-1-0201-225.zip. Note If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . | Note | If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . |
| Note | If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . |
...
| Step 1 | Perform one of the following actions: Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284883944&rls=14.4(1)SR2&sb=anfr&svr=3nH&bt=custV Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284883944&rls=14.4(1)SR2&sb=afr&sts=open&svr=3nH&bt=custV Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=14.4(1)SR2&sb=fr&svr=3nH&bt=custV |
|---|---|
