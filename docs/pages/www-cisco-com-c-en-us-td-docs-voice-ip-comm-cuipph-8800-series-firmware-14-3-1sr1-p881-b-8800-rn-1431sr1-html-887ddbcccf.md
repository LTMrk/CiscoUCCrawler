---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-8800-series-firmware-14-3-1sr1-p881-b-8800-rn-1431sr1-html-887ddbcccf
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/8800-series/firmware/14-3-1SR1/p881_b_8800-rn-1431sr1.html
retrieved_at: 2026-08-17T01:12:24.813423+00:00
---

Cisco IP Phone 8800 Release Notes for Firmware Release 14.3(1)SR1
...
The firmware filename is cmterm-8845_65-sip.14-3-1-0101-131.k4.cop.sha512 or cmterm-88xx-sip.14-3-1-0101-131.k4.cop.sha512,
...
If a Cisco Unified Communications Manager is not available to load the installer program, the following .zip files are available
                        to load the firmware: cmterm-8845_65.14-3-1-0101-131.zip or cmterm-88xx.14-3-1-0101-131.zip.
...
In the Latest Releases folder, choose 14.3(1)SR1 .

Step 5

Select the firmware file, click the Download or Add to Cart button, and follow the prompts.

The firmware file name is cmterm-8845_65.14-3-1-0101-131.zip or cmterm-88xx.14-3-1-0101-131.zip, depending on the model you
                                    choose.
...
Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284729655&rls=14.3(1)SR1&sb=anfr&svr=3nH&bt=custV

Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284729655&rls=14.3(1)SR1&sb=afr&sts=open&svr=3nH&bt=custV

Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284729655&rls=14.3(1)SR1&sb=fr&sts=fd&svr=3nH&bt=custV
...
CSCwm75954: Cisco 88xx phones will not authenticate using the wireless LAN profile if password has an & in it

CSCwm86106: Kernel vulnerability CVE-2017-1000253: load_elf_binary does not allocate sufficient space

CSCwm90110: CVE-2014-3153 kernel: futex: pi futexes requeue issue

CSCwm80996: to Evaluation of 88x1 desktop phone for local privilege escalation vulnerability in the debug shell

CSCwm80982: to Evaluation of 8845/65/65NR for local privilege escalation vulnerability in the debug shell
...
| Step 5 | Select the firmware file, click the Download or Add to cart button, and follow the prompts: The firmware filename is cmterm-8845_65-sip.14-3-1-0101-131.k4.cop.sha512 or cmterm-88xx-sip.14-3-1-0101-131.k4.cop.sha512,
...
| Step 2 | Choose your phone model. |
| Step 3 | Choose Session Initiation Protocol (SIP) Software . |
| Step 4 | In the Latest Releases folder, choose 14.3(1)SR1 . |
| Step 5 | Select the firmware file, click the Download or Add to Cart button, and follow the prompts. The firmware file name is cmterm-8845_65.14-3-1-0101-131.zip or cmterm-88xx.14-3-1-0101-131.zip, depending on the model you
                                    choose. |
...
| Step 1 | Perform one of the following actions: Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284729655&rls=14.3(1)SR1&sb=anfr&svr=3nH&bt=custV Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284729655&rls=14.3(1)SR1&sb=afr&sts=open&svr=3nH&bt=custV Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284729655&rls=14.3(1)SR1&sb=fr&sts=fd&svr=3nH&bt=custV |
|---|---|
