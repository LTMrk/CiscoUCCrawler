---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-connection-14-os-administration-guide-b-14cucosagx-b-14cucosagx-chapter-0101-d1faddf136
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/os_administration/guide/b_14cucosagx/b_14cucosagx_chapter_0101.html
retrieved_at: 2026-08-17T02:24:06.678046+00:00
---
...
- If you update Tomcat certificate or tomcat-ECDSA certificate, you must restart the Cisco tomcat service, Connection IMAP Server,
                                                      Cisco Dirsync service, Connection Jetty service, SMTP service and Connection Conversation Manager service.
...
- If tomcat-ECDSA is the certificate purpose, select SHA384 or SHA512.
...
If you choose Different for the peer type, enter the new certificate common name.
...
| Step 7 | Upload the application certificate to the server. | See the “Upload
                                                      						  Application Certificate” . |
| Step 8 | Restart the services that are affected by the new certificate. | For all certificate types, restart the corresponding service: If you update Tomcat certificate or tomcat-ECDSA certificate, you must restart the Cisco tomcat service, Connection IMAP Server,
                                                      Cisco Dirsync service, Connection Jetty service, SMTP service and Connection Conversation Manager service. See
                                                   						the Cisco Unified Communications Manager Serviceability Administration Guide
                                                   						for information about restarting services. |
|  |  |  |
...
| Step 8 | From the Hash Algorithm drop-down list box, select as per the
                                                			 certificate purpose. If tomcat or ipsec is the
                                                      				  certificate purpose, select SHA1 or SHA256. If tomcat-ECDSA is the certificate purpose, select SHA384 or SHA512. |
...
| Certificate Common Name | If you choose Different for the peer type, enter the new certificate common name. |
