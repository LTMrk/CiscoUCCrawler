---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-service-12-5-1-rtmt-cucm-b-cisco-unified-rtmt-administration-1251-cucm--fa4eebec0c
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/service/12_5_1/rtmt/cucm_b_cisco-unified-rtmt-administration-1251/cucm_mp_meb9f00e_00_manage-profiles-and-categories.html
retrieved_at: 2026-08-21T01:39:04.790320+00:00
---
...
Display Performance Monitoring under the system tab or Devices/CTIs in the Search window under the Communications Manager
                                                         tab.
...
| Step 1 | Go to the applicable window for your configuration: Unified Communications Manager Display Performance Monitoring under the system tab or Devices/CTIs in the Search window under the Communications Manager
                                                         tab. Cisco Business Edition 5000 Display Performance Monitoring under the system tab or Devices/CTIs in the Search window under the Communications Manager
                                                         tab. Cisco Unity Connection Choose System > Performance > Open Performance Monitoring . | Unified Communications Manager | Display Performance Monitoring under the system tab or Devices/CTIs in the Search window under the Communications Manager
                                                         tab. | Cisco Business Edition 5000 | Display Performance Monitoring under the system tab or Devices/CTIs in the Search window under the Communications Manager
                                                         tab. | Cisco Unity Connection | Choose System > Performance > Open Performance Monitoring . |
|---|---|---|---|---|---|---|---|
| Unified Communications Manager | Display Performance Monitoring under the system tab or Devices/CTIs in the Search window under the Communications Manager
                                                         tab. |
| Cisco Business Edition 5000 | Display Performance Monitoring under the system tab or Devices/CTIs in the Search window under the Communications Manager
                                                         tab. |
