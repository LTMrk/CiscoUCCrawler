---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-connection-15-troubleshooting-guide-b-15cuctsg-b-15cuctsg-chapter-01001-html-6b0692bdae
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/15/troubleshooting/guide/b_15cuctsg/b_15cuctsg_chapter_01001.html
retrieved_at: 2026-08-17T02:38:49.032061+00:00
---
...
In Cisco Unity Connection Serviceability, use the Voice Network Map tool to verify the health of the digital network. See
                                    the “ Using the Voice Network Map Tool ” chapter of the Administration Guide for Cisco Unity Connection Serviceability Release 15 , at https://www-author3.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/15/requirements/b_15cucsysreqs.html .
...
Generate the SpeechView Activity Summary Report to verify that the transcriptions are arriving at the Unity Connection server.
                                    For more information, see the “ Generating and Viewing Reports ” section in the “Using Reports” chapter of the Administration Guide for Cisco Unity Connection Serviceability Release 15 , available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/15/serv_administration/guide/b_15cucservag.html .
...
Verify that the SMTP smart host setting is configured in Cisco Unity Connection Administration. For details, see the “ Task List for Configuring SpeechView ” section in the “SpeechView” chapter of the System Administration Guide for Cisco Unity Connection Release 15 , available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/15/administration/guide/b_15cucsag.html .
...
If SpeechView services are enabled on Unity Connection 11.x or later and you are upgrading Cisco Unity Connection to 15, you
                              may face the SpeechView transcription issues. After upgrade, you must register Unity Connection with nuance server.

Do the following to resolve the transcription issue for Unity Connection 15:
...
| Note | For Release 15 SU2 and later, refer Troubleshooting Transcription (SpeechView Cisco Webex in-house transcription service) for information related to Troubleshooting SpeechView feature. |
|---|---|
...
| Step 6 | If the incoming reply message is not received by the CLI test,
                                       			 do the following sub-steps to troubleshoot the problem: Verify that the email address entered in the Incoming SMTP
                                             				  ...
                                             				  diag_SMTP_*.uc. If you see “untrusted client Unity Connection refused” messages
                                             				  in the log files, you need to configure Unity Connection to trust incoming
                                             				  traffic from your email system. For details on configuring Unity Connection to trust incoming traffic from your email system, see the “ Task List for Configuring SpeechView ” section in the “SpeechView” chapter of the System Administration Guide for Cisco Unity Connection Release 15 , available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/15/administration/guide/b_15cucsag.html . . View the log files for your email infrastructure for additional
                                             				  clues. |
