---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cer-14su2-english-administration-guide-cer0-b-cisco-emergency-responder-admi-c2042de359
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cer/14su2/english/administration/guide/cer0_b_cisco-emergency-responder-administration-guide-14su2/cer0_m_enhanced-e911-teleworkers-and-off-premises.html
retrieved_at: 2026-08-20T23:52:30.966425+00:00
---
...
Validate connectivity to National E911 Service Provider .

Step 2

Set Up an National E911 Service Provider Route Pattern

Sets the route patterns for routing the call to National E911 Service Provider .
...
Adds the Default ALI Values for National E911 Service Provider URLs.
...
From Cisco ER Administration, choose System > National E911 Service Provider VUI Settings .
...
Click Test Connectivity to verify whether Emergency Responder can successfully connect to National E911 Service Provider VUI or not.
...
Enter the National E911 Service Provider Route/Translation Pattern.
...
From Cisco ER Administration, choose ERL > National E911 Service Provider ERL > Default ALI Values .
...
|  | Command or Action | Purpose |
|---|---|---|
| Step 1 | Set Up and Test National E911 Service Provider Connectivity | Validate connectivity to National E911 Service Provider . |
| Step 2 | Set Up an National E911 Service Provider Route Pattern | Sets the route patterns for routing the call to National E911 Service Provider . |
...
| Step 5 | Configure Default ALI Values for National E911 Service Provider ERLs | Adds the Default ALI Values for National E911 Service Provider URLs. |
...
| Step 6 | Click Test Connectivity to verify whether Emergency Responder can successfully connect to National E911 Service Provider VUI or not. On the 'Test National E911 Service Provider Connectivity' pop-up window, the Test Results section should show status “200 OK” after pressing the Connect button. This response indicates that both the certificate and account information are valid. |
