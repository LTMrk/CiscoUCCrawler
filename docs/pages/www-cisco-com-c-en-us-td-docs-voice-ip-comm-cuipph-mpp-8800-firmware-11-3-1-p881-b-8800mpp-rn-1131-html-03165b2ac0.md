---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-mpp-8800-firmware-11-3-1-p881-b-8800mpp-rn-1131-html-03165b2ac0
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/MPP/8800/firmware/11-3-1/p881_b_8800mpp_rn-1131.html
retrieved_at: 2026-08-21T13:44:52.396877+00:00
---

Cisco IP Phone 8800 Series Multiplatform Phones Release Notes for Firmware Release 11.3(1)
...
Use these release notes with the following Cisco IP Phone 8800 Series Multiplatform Phones running SIP Firmware Release 11.3(1).
...
You can enable the phone to send end-of-call statistics in Session Initiation Protocol (SIP) messages. The phone sends call
                        ...
                        and re-INVITE messages: RTP-RxStat and RTP-TxStat for audio sessions ; RTP-VideoRxStat and RTP-VideoTxStat for video sessions .
...
Only the following phones support Wi-Fi:
...
### Wi-Fi Status Messages

You can view messages about the Wi-Fi connection status of your Cisco IP Phone 8861 and 8865 Multiplatform Phones. The messages
                        can help you diagnose Wi-Fi connection problems. The messages contain:

connection time and MAC address of the access point

disconnection time and diagnostic code

connection failure time

time that weak signal of the access point continues over 12 seconds

To view the Wi-Fi messages, press Applications and select Status > Wi-Fi messages . If a message displays incompletely, press Details to view the complete message.

The feature is supported on these phones:
...
cmterm-88xx.11-3-1MPP-697_REL.zip
...
https://10.73.10.223/firmware/sip88xx.11-3-1MPP-697.loads
...
https://10.74.10.225/admin/upgrade?https://10.73.10.223/firmware/sip88xx.11-3-1MPP-697.loads
...
The following list contains the severity 1, 2, and 3 defects that are open for the Cisco IP Phone 8800 Series Multiplatform Phones that use Firmware Release 11.3(1).
...
CSCvq96400 Failed to resume Video call during call recording

CSCvr38502 Profile account setup toast does not work with provisioning on LCD

CSCvr64226 The call logs of all the lines will be deleted when select a line and press Delete All

CSCvr64429 Slight Echo is heard when calling using handset

CSCvr85659 "Wi-Fi Scan" softkey was missing if the user deletes a profile to disconnect Wi-Fi and back to home screen from
                              scan
...
The following list contains the severity 1, 2, and 3 defects that are resolved for the Cisco IP Phone 8800 Series Multiplatform Phones that use Firmware Release 11.3(1).
...
CSCvo17547 CP-8865-3PCC-K9=, service provider carrier attribute parsing error
...
CSCvq92857 With wireless connection, LCD display IP address which got from Ethernet network.
...
CSCvn81320 CP-88xx-3PCC phones restarts when connected PC power up/power down

CSCvr37046 CP-8851-3PCC : 8851 HW31 API misbehavior

CSCvr39880 8851 KEM Not Powering Up After Upgrade

CSCvq80431 Cisco 8851 - 8861 (3PCC) IP Phone Key Negotiation of Bluetooth Vulnerability

CSCvr67580 Multiple Vulnerabilities in linux_kernel

CSCvq80432 Cisco 8845 - 8865 (3PCC) IP Phone Key Negotiation of Bluetooth Vulnerability

CSCvr24925 Bluetooth Discoverable State Unauthorized Pairing Vulnerability

CSCvr48050 Lib: cURL and libcurl tftp_receive_packet() Function Heap Buffer Overflow …

CSCvr35152 8851: phone restarts once PC connected reboots.

CSCvr06360 CP-8865-3PCC, IPv6 address issue when using 5GHz Wi-Fi
...
|---|---|
| Cisco IP Phone 8800 Series Multiplatform Phones | BroadSoft BroadWorks 22.0 MetaSphere CFS version 9.5 Asterisk 11.0 |
...
| Step 6 | Download the corresponding file. cmterm-88xx.11-3-1MPP-697_REL.zip |
