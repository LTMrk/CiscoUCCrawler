...
Often, the
                                    				caller can get all the information he or she needs through simple interaction
                                    				with the VRU. In some cases, however, the VRU needs to transfer the caller to
                                    				an agent or another call resource.
