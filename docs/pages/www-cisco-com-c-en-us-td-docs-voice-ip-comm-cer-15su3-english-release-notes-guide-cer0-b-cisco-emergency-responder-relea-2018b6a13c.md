...
Cisco Emergency Responder Release 15SU3 supports the following new features:

## IPSec DH Group Changes

From this release onwards, DH groups 17 and 18 are no longer available on the IPSec Policy Configuration page. If your source
...
For more information, see the ‘IPSec Policy List' section in the “Cisco Unified Operating System Administration Web Interface"
                  chapter of the Cisco Emergency Responder Administration Guide, Release 15 and SUs .

## Updates to Cipher Management Page

For SSH interface, you can configure the SSH host key algorithm using the Cipher Management page. For more information, see
                  the 'SSH Interfaces', ‘Recommended Ciphers’, and 'Cipher Limitations' sections in the “Cisco Unified Operating System Administration
                  Web Interface” chapter of the Cisco Emergency Responder Administration Guide, Release 15 and SUs .

## Switch Support

Support switch port based tracking for new Voice LAN Switches: Meraki Managed Catalyst Switch C9300. For more information,
                  see the Supported Voice Ready Lan Switches section.

## Requirements

### Supported Hardware and Software

The information in the following sections discuss Hardware and Software requirements for Cisco Emergency Responder 15SU3.
...
1.3.6.1.4.1.29671.2.395

MS130-8P

1.3.6.1.4.1.29671.2.396

MS130-8X

1.3.6.1.4.1.29671.2.397

MS130-12X

1.3.6.1.4.1.29671.2.398

MS130-24

1.3.6.1.4.1.29671.2.399

MS130-24P

1.3.6.1.4.1.29671.2.400

MS130-24X

1.3.6.1.4.1.29671.2.401

MS130-48

1.3.6.1.4.1.29671.2.402

MS130-48P

1.3.6.1.4.1.29671.2.403

MS130-48X

1.3.6.1.4.1.29671.2.404
...
1.3.6.1.4.1.29671.2.382

MerakiC9300-24U-M

1.3.6.1.4.1.29671.2.384

MerakiC9300-48P-M

1.3.6.1.4.1.29671.2.386
...
1.3.6.1.4.1.29671.2.389

MerakiC9300-48UXM-M

1.3.6.1.4.1.29671.2.390

MerakiC9300-24S-M

1.3.6.1.4.1.29671.2.391

MerakiC9300-48S-M

1.3.6.1.4.1.29671.2.392
...
Discovery thread gets stuck in recursive DB refresh due to IPV6 subnet based tracking feature

CSCwn78985

The CER discoveries do not start once there has been a fallback in the cluster
...
DRF service is unavailable after reimaging the subscriber alone
...
|---|---|---|
| Cisco Unified Communications Manager | Cisco Unified Communications Manager 15 Cisco Unified Communications Manager 14 and SUs Cisco Unified Communications Manager 12.5(x) | The software that runs the telephony network. |
...
| Meraki MS130 | MS130-8 | 1.3.6.1.4.1.29671.2.395 |
| MS130-8P | 1.3.6.1.4.1.29671.2.396 |
| MS130-8X | 1.3.6.1.4.1.29671.2.397 |
| MS130-12X | 1.3.6.1.4.1.29671.2.398 |
| MS130-24 | 1.3.6.1.4.1.29671.2.399 |
| MS130-24P | 1.3.6.1.4.1.29671.2.400 |
| MS130-24X | 1.3.6.1.4.1.29671.2.401 |
| MS130-48 | 1.3.6.1.4.1.29671.2.402 |
| MS130-48P | 1.3.6.1.4.1.29671.2.403 |
| MS130-48X | 1.3.6.1.4.1.29671.2.404 |
...
| MerakiC9300-24P-M | 1.3.6.1.4.1.29671.2.382 |
| MerakiC9300-24U-M | 1.3.6.1.4.1.29671.2.384 |
| MerakiC9300-48P-M | 1.3.6.1.4.1.29671.2.386 |
| MerakiC9300-48U-M | 1.3.6.1.4.1.29671.2.388 |
| MerakiC9300-48UN-M | 1.3.6.1.4.1.29671.2.389 |
| MerakiC9300-48UXM-M | 1.3.6.1.4.1.29671.2.390 |
| MerakiC9300-24S-M | 1.3.6.1.4.1.29671.2.391 |
| MerakiC9300-48S-M | 1.3.6.1.4.1.29671.2.392 |
...
| Identifier | Headline |
|---|---|
| CSCwm95686 | Discovery thread gets stuck in recursive DB refresh due to IPV6 subnet based tracking feature |
