...
For example, to select the SBC Southwestern Bell AFT, click on: CER-aft-SBC_Southwestern_Bell.1-1-1.exe
...
For example, for SBC Southwestern Bell, go to:

Start > Programs > Cisco Emergency Responder > AFT > SBC_SouthwesternBell (NENA 2.0)
