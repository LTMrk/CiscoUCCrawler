---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cer-aft-1-1-english-sbc-southwest-bell-user-guide-user-swb-aftuse-html-5660f158c4
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cer/aft/1_1/english/sbc_southwest_bell/user/guide/user_swb/AFTuse.html
retrieved_at: 2026-08-21T15:50:00.522908+00:00
---
...
• The Function/Transaction Code field. Refer to "Using the ALI Formatting Tool for SBC Southwestern Bell" for more information.

• Service provider-specific fields. Refer to "Using the ALI Formatting Tool for SBC Southwestern Bell."
...
If the NENA files are on the Master Cisco Emergency Responder (Cisco ER) server and AFT is installed on the Standby Cisco ER server, you can use the Open Window Dialog box to browse to a shared Master Cisco ER folder.
...
• You understand which specific information you modify for your service provider. For details, see "Using the ALI Formatting Tool for SBC Southwestern Bell."
...
The AFT application displays all the ELINs from the NENA file in a tree box in the left side of the page by the Area Code, City Code and 4-digit directory number.
...
For details about the service provider-specific information required, see "Using the ALI Formatting Tool for SBC Southwestern Bell"
...
|---|---|---|
| Give a NENA file as input to AFT | Use one of these methods: • Click the File Open icon . • Select Menu > File > Open (Ctrl+O) . | If the NENA files are on the Master Cisco Emergency Responder (Cisco ER) server and AFT is installed on the Standby Cisco ER server, you can use the Open Window Dialog box to browse to a shared Master Cisco ER folder. |
