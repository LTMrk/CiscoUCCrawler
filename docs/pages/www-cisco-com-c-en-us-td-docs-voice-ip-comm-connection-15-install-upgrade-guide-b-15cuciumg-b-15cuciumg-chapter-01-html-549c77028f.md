---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-connection-15-install-upgrade-guide-b-15cuciumg-b-15cuciumg-chapter-01-html-549c77028f
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/15/install_upgrade/guide/b_15cuciumg/b_15cuciumg_chapter_01.html
retrieved_at: 2026-08-17T02:12:53.141290+00:00
---
...
Create a user with mailbox with an alias “system-backup-and-restore-admin” and assign him a corporate email id to receive
                                    ...
                                    of System Administration Guide for Cisco Unity Connection Release 15 at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/15/administration/guide/b_15cucsag.html .
...
| Step 7 | (Cluster only)
                                          			 ...
                                          			 check the status of the Unity Connection cluster: show cuc cluster status Verify that
                                             				the status of publisher server is Primary and subscriber server is Secondary.
                                             				Test and validate it before moving it back into production. Note (Applicable to 15 SU2 or later) If you are using SpeechView with Cisco Webex in-house transcription service, onboard the Subscriber Server of the Unity Connection
                                                         Cluster on Cisco Webex Cloud-Connected UC. For more details on Onboarding Unity Connection server on Cisco Webex Cloud-Connected
                                                         UC, refer https://help.webex.com/en-us/article/nzt6c0b/Set-up-Webex-Cloud-Connected-UC-for-on-premises-devices . | Note | (Applicable to 15 SU2 or later) If you are using SpeechView with Cisco Webex in-house transcription service, onboard the Subscriber Server of the Unity Connection
                                                         Cluster on Cisco Webex Cloud-Connected UC. For more details on Onboarding Unity Connection server on Cisco Webex Cloud-Connected
                                                         UC, refer https://help.webex.com/en-us/article/nzt6c0b/Set-up-Webex-Cloud-Connected-UC-for-on-premises-devices . |
| Note | (Applicable to 15 SU2 or later) If you are using SpeechView with Cisco Webex in-house transcription service, onboard the Subscriber Server of the Unity Connection
                                                         Cluster on Cisco Webex Cloud-Connected UC. For more details on Onboarding Unity Connection server on Cisco Webex Cloud-Connected
                                                         UC, refer https://help.webex.com/en-us/article/nzt6c0b/Set-up-Webex-Cloud-Connected-UC-for-on-premises-devices . |
