---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-bat-15-cucm-b-bulk-administration-guide-15-cucm-b-bulk-administration-g-be77b03d1a
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/bat/15/cucm_b_bulk-administration-guide-15/cucm_b_bulk-administration-guide-1251su2_chapter_01001110.html
retrieved_at: 2026-08-21T09:21:35.575115+00:00
---
...
### MAC Address Values Are Not Allowed in the File If Pseudo MAC Address Values Are Desired

Problem MAC address values are not allowed in the file if pseudo MAC address values are desired.

Possible Cause The CSV file contains MAC addresses. You cannot provide pseudo MAC addresses when MAC addresses are present in any row in the CSV file.

Solution If you want to use pseudo MAC addresses, create a new CSV file that contains only those records for which you have not specified MAC addresses. Alternatively,
                                 you can specify MAC addresses in the CSV file and not check the Create Pseudo MAC Address check box.
...
Solution Enter some pseudo value for the last column while creating the CSV file.

Solution Save the CSV file and close it.

Solution Open the saved CSV file using Text Editor/Notepad.

Solution Replace the pseudo values with a blank value and save it.
