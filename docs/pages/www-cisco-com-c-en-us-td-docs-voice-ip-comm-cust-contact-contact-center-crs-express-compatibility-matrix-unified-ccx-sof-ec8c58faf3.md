...
Automatic Speech Recognition and Text To Speech . 6
...
Gateways for Outbound Agent and IVR (FN2,4)
...
Cisco Smart Software Manager On-Prem (Cisco SSM On-Prem) (FN 8)
...
■ (FN 3) CUBE is supported with the SIP Outbound Dialer and CPA; supported versions of CUBE are ISR Pi28 15.5(3), Pi29 15.6(3), and Pi32 15.7(3) and later. For the latest list of supported IOS version, see https://www.cisco.com/c/en/us/support/ios-nx-os-software/ios-xe-17/products-release-notes-list.html .
...
■ (FN 7) For more information about CSSM version 9, see the Cisco Smart Software Manager On-Prem Release .

■ (FN 8) Transport Gateway is not supported in Unified CCX.

■ (FN 9) For FIPS to be enabled on 15.0, the Unified CM version should be 14.0 SU3 or later. This is because of the change in the security providers in the product.
...
Note: Cisco does not test consecutive Nuance Service Packs and relies on Nuance to follow standard release practices and avoid making significant changes or updates in Service Pack releases. As Service Packs typically contain defect fixes, enhancements, and improvements, Nuance highly recommends keeping up to date with Service Packs and staying within a supported release according to their "On Premise Service Pack Deprecation and Support Policy." Nuance Support should be contacted in case of any issues with a Service Pack application, and a rollback plan be in place for any updates, as per the industry’s best practices.
...
Nuance Speech Suite 11.0.12 (FN2)

Speech Server 7.9.0

Recognizer 11.8.0

Vocalizer Server 21.12.7 (FN 1)
...
■ The latest version of the ASR-TTS packages recommended by Nuance can be used. See http://network.nuance.com/portal/server.pt . Using the latest Nuance packages will not impact on the integration functionality between Unified CCX and Nuance until there is any major change by Nuance in the underlying design. However, customers must maintain the compatibility among different ASR-TTS packages as suggested by Nuance.

■ (FN 1) This is a new versioning scheme. Nuance Enterprise Version 20.x is the continuation of Nuance Enterprise version 7.x.

■ (FN2) Cisco Virtualized Voice Browser (VVB) supports the Nuance components compatible with MRCP Protocol v1 and v2. For further details on compatibility, see the Nuance Compatibility Matrix.
...
(FN 2) Unified CCX (12.5 SU3 ES03 and higher) is qualified for encrypted external database connections to Oracle 19c, Oracle 21c, MS SQL Server 2016, MS SQL Server 2019, and MS SQL Server 2022.

### Enterprise Database for Unified Intelligence Center

■ MS SQL Server 2019 and above

■ Informix Database Server 14.10.UC9W1X3
...
CCM_FREEZE_15_0_1_12900_234

Informix IDS14.10.FC10XT

1.2

Tomcat 9.0.88

CiscoSSL 1.1.1w.7.2.555
...
Dependent on the software provided by the TTS vendor
...
All printed copies and duplicate soft copies are considered un-Controlled copies and the original on-line version should be referred to for the latest version.
...
|---|---|---|
| ■ 15.0 | ■ 12.5(1) ■ 12.5(1) SU1 ■ 12.5(1) SU2 ■ 12.5(1) SU3 | CTI Server - Versions 13 to 18 For Unified CCX configuration APIs and Finesse APIs, see the Cisco Unified Contact Center Express Developer Guide, located at: https://developer.cisco.com/site/contact-center-express/ . |

| Cisco Unified Communications Manager (Unified CM) and Business Edition 6000 and 7000 (FN 1) | Gateways for Outbound Agent and IVR (FN2,4) | Customer Collaboration Platform (CCP) (FN6) | Cisco Prime Collaboration Deployment (PCD) | Cisco Instant Messaging and Presence (IM&P) (FN5) | Cisco Smart Software Manager On-Prem (Cisco SSM On-Prem) (FN 8) |
|---|---|---|---|---|---|
| 12.x | 14 (FN 9) | 15 |
| 12.5(1) | 14.0 | 15. 0 | Router Series ■ 43XX ■ 44XX ■ Catalyst 8200, 8300, and 8500 Cisco IOS (FN 3) ■ 17.6 ■ 17.9 ■ 17.10 ■ 17.11 ■ 17.12 ■ 17.13 ■ 17.14 ■ 17.15 | 15.0 | 15.0 SU3 | ■ 12.5(1) ■ 14.X | 9-202412 (FN 7) |

|  | Unified CCX | Cisco Unified Communications Manager | Cisco Jabber | IP Phones | Webex |
|---|---|---|---|---|---|
| Webex WFO | ■ 15.0 | ■ 12.5(1) ■ 14.0 ■ 15.0 | Yes | Yes | Yes |

| MRCP | VoiceXML Protocol Version | Speech Servers |
|---|---|---|
| Nuance |
| 1.0 2.0 | 2.0 | Nuance Software | Cisco Virtualized Voice Browser (VVB) supports the following Nuance components |
| Nuance Speech Suite 11.0.12 (FN2) | Speech Server 7.9.0 Recognizer 11.8.0 Vocalizer Server 21.12.7 (FN 1) Management Station 6.7.0 Krypton-4.17.0 (Dragon Voice engine) License Manager 11.19.1 |
...
| Databases | Drivers |
|---|---|
| Oracle 19c (FN 1) | ojdbc8.jar |
| Oracle 21c | ojdbc8.jar |
| IBM DB2 8.2, 10.5 | db2jcc.jar, db2jcc4.jar |
| MS SQL Server 2016 | jTDS 1.2.x and later |
| MS SQL Server 2019 | jTDS 1.2.x and later |
| MS SQL Server 2022 | jTDS 1.3.x |

|  | Firefox 134.0 Extended Support Release (ESR) and higher ESR | Google Chrome 126 and higher | Microsoft Edge (Edge Chromium) 131 and higher |
|---|---|---|---|
...
| UCOS Platform Version | Internal Unified CCX Database (IDS) | Transport Layer Security (TLS) | Tomcat | Open SSL | Alma Linux | Java versions |
|---|---|---|---|---|---|---|
| Servers |
| CCM_FREEZE_15_0_1_12900_234 | Informix IDS14.10.FC10XT | 1.2 | Tomcat 9.0.88 | CiscoSSL 1.1.1w.7.2.555 | 8.9 | OpenJDK 1.8.0_362 ■ Custom Classes/SDK ■ Real-Time Reporting |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| Arabic | No | No | No | No | No | Yes | No | Dependent on the software provided by the TTS vendor | Dependent on software provided by the MRCP vendor | No | No |
