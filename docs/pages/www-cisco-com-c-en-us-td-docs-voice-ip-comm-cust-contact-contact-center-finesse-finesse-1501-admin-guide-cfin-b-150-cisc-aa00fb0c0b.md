---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-finesse-finesse-1501-admin-guide-cfin-b-150-cisc-aa00fb0c0b
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/finesse/finesse_1501/admin/guide/cfin_b_150_cisco-finesse-administration-guide/cfin_m_150_manage-security.html
retrieved_at: 2026-08-21T12:04:56.774492+00:00
---
...
By default, SystemInfo requests within the LAN network do not require authentication. Use the following commands to enable
                           or disable authentication for SystemInfo API calls:

To enable authentication for SystemInfo API calls within LAN network: utils finesse set_property webservices secureSystemInfo true

To disable authentication for SystemInfo API calls within LAN network: utils finesse set_property webservices secureSystemInfo false

SystemInfo requests made via reverse proxy always require authentication. Changing the above property does not affect this
                                       behavior.
