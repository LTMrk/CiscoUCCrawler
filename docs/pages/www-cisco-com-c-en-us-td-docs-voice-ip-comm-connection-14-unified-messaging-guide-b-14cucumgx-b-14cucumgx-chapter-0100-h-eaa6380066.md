...
If you moved the Exchange mailbox to an Exchange server for which there is currently no unified messaging service in Unity
                                       Connection, create the service. For more information, see the Creating Unified Messaging Service to Access Mail Server, page 2-27 section.

Step 4

Create a new unified messaging account for the user and select a unified messaging service that accesses the new Exchange
                                       server to which the mailbox was moved. For more information, see the Unified Messaging Account for Users, page 2-30 section.
...
| Step 2 | Do either of the following steps: If Unity Connection can detect mailbox
                                                					 ...
                                                					 mailbox moves, continue with Step 3 . |
| Step 3 | If you moved the Exchange mailbox to an Exchange server for which there is currently no unified messaging service in Unity
                                       Connection, create the service. For more information, see the Creating Unified Messaging Service to Access Mail Server, page 2-27 section. |
| Step 4 | Create a new unified messaging account for the user and select a unified messaging service that accesses the new Exchange
                                       server to which the mailbox was moved. For more information, see the Unified Messaging Account for Users, page 2-30 section. |
