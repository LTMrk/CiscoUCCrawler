...
array formulas, ECC variable 1

ASR, type-ahead support 1

Automatic Speech Recognition for micro-applications 1
...
data format, Get Speech micro-application 1
...
DTMF input collection, Get Speech micro-application 1

dynamic audio file capability 1

dynamic prompt, using 1
...
Get Speech micro-application configuration 1
...
file contents, external VoiceXML 1
...
grammar specification, Get Speech micro-application 1
...
using Automatic Speech Recognition and Text-to-Speech 1

using external VoiceXML 1
...
tasks, setting up Unified ICME for scripting 1
...
Automatic Speech Recognition and Text-to-Speech for micro-applications 1
