---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-pcce-pcce-12-6-1-configuration-guide-pcce-b-admi-ed71219507
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/pcce/pcce_12_6_1/configuration/guide/pcce_b_admin_configuration_guide_12_6_1/pcce_b_admin_configuration_guide_12_5_2_chapter_01000.html
retrieved_at: 2026-08-21T16:52:20.705334+00:00
---
...
| Step 1 | Select the Business entity that owns the script that the node should run. By default, Unified ICM consists of one business
                                          ...
                                          the Security Guide for Cisco Unified ICM/Contact Center Enterprise at https://www.cisco.com/c/en/us/support/customer-collaboration/unified-contact-center-enterprise/products-installation-and-configuration-guides-list.html . |
|---|---|
| Step 2 | Select the Business entity that owns the script that the node should run. By default, Packaged CCE consists of one business
                                          entity. |
| Step 3 | Select a script from the Scripts list.  From within an administrative script, you can only go to another administrative script.
                                          Within a routing script, you can
                                          only go to another routing script. |
| Step 4 | Optionally, add comments and connection labels. |
