...
This maintenance upgrade fixes Expressway re-registration failures associated with the bug CSCwt41409 .
...
This version of Management Connector is compatible with X14.3 and all other currently
        supported versions of Expressway.

You must use Management Connector 8.11-1.0.459 (or later) with Expressway X14.3. Previous
        connector versions are not compatible with X14.3.
