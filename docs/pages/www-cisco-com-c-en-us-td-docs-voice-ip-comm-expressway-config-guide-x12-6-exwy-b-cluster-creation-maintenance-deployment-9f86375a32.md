---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-expressway-config-guide-x12-6-exwy-b-cluster-creation-maintenance-deployment-9f86375a32
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/expressway/config_guide/X12-6/exwy_b_cluster-creation-maintenance-deployment-guide/exwy_b_cluster-creation-maintenance-deployment-guide_chapter_01001.html
retrieved_at: 2026-08-16T15:32:45.002690+00:00
---
...
"Cluster replication error: cannot find primary or this subordinate's peer configuration file, manual synchronization of configuration
                                          is required"
...
Only use this command if the configuration on the primary Expressway is known to be in a good state. We recommend that you
...
Log in as root and run clusterdb_destroy_and_purge_data.sh

Restore that Expressway’s database by restoring a backup taken on that Expressway previously.

Add the Expressway back to the cluster using Add a Peer to a Cluster .

clusterdb_destroy_and_purge_data.sh is as dangerous as it sounds — only use this command in conjunction with instructions from your support representative.
...
| Caution | Only use this command if the configuration on the primary Expressway is known to be in a good state. We recommend that you
                                                   take a backup before running this command. |
|---|---|
