---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-mpp-6800-english-ag-p680-b-6800-mpp-ag-new-p680-b-6800-mpp-adminguide-47dabb4f00
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/MPP/6800/english/AG/p680_b_6800-mpp-ag_new/p680_b_6800-mpp-adminguide_chapter_01001.html
retrieved_at: 2026-08-21T23:15:54.258098+00:00
---
...
The Cisco IP Phone 6821 Multiplatform Phones does not have programmable feature buttons. Supported features display on softkeys.
...
Cisco IP Phone 6871 Multiplatform Phones have additional buttons and softkeys:
...
Only the Cisco IP Phone 6851 Multiplatform Phones and Cisco IP Phone 6861 Multiplatform Phones support the Electronic Hookswitch feature.
...
| Note | The Cisco IP Phone 6821 Multiplatform Phones does not have programmable feature buttons. Supported features display on softkeys. |
|---|---|

| Feature Name | Dedicated Feature Button | Programmable Feature Button | Softkey |
|---|---|---|---|
| Answer | Not supported | Supported | Supported |
| Call Forward All | Not supported | Supported | Supported |
| Call Forward Busy | Not supported | Supported | Supported |
| Call Forward No Answer | Not supported | Supported | Supported |
| Call Park | Not supported | Supported | Supported |
| Call Park Line Status | Not supported | Supported | Not supported |
| Call Pickup (Pick Up) | Not supported | Supported | Supported |
| Call Pickup Line Status | Not supported | Supported | Not supported |
| Category | Not supported | Supported | Supported |
| Conference | Supported | Not supported | Supported (only displayed during connected call conference scenario) |
...
| Speed Dial | Not supported | Supported | Supported |
| Speed Dial Line Status | Not supported | Supported | Not supported |
| Transfer | Supported | Not supported | Supported (only displayed during connected call transfer scenario) |
...
| PN | Product Name; for example, IP Phone 6841. |
| PSN | Product Series Number; for example, 6841. |
...
| Step 2 | In the XSI Line Service section, set the CFWD Enable parameter to Yes . You can configure this parameter in the phone configuration XML file (cfg.xml) by entering a string in this format: <CFWD_Enable_1_ ua="na">Yes</CFWD_Enable_1_> Options: Yes and No Default: Yes Note If XSI sync for call forward is enabled and the XSI host server or XSI account is not configured correctly, the phone user
                                                         can't forward calls on the phone. If XSI sync for call forward is enabled but the XSI host server or XSI account isn’t configured correctly, the Forward softkey isn’t available (doesn't appear). The user can't forward calls on the phone until the XSI account is configured correctly. | Note | If XSI sync for call forward is enabled and the XSI host server or XSI account is not configured correctly, the phone user
                                                         can't forward calls on the phone. If XSI sync for call forward is enabled but the XSI host server or XSI account isn’t configured correctly, the Forward softkey isn’t available (doesn't appear). The user can't forward calls on the phone until the XSI account is configured correctly. |
...
| Assistant Call Filter | This field is only available on the Cisco IP Phone 6871 Multiplatform Phones . Controls whether to show the Call filter menu on the phone screen for the assistant role. Set this field to Yes to show the menu. Otherwise, set it to No . Perform one of the following: In the phone configuration file (cfg.xml) with XML, enter a string in this format: <Assistant_Call_Filter ua="na">Yes</Assistant_Call_Filter> In the phone web interface, select Yes or No to show or hide the menu. Valid values: Yes and No Default: Yes |
...
| shortcut Cisco IP Phone 6861 only | wificonf | Settings > Network configuration > Wi-Fi configuration |
| shortcut Cisco IP Phone 6861 only | wifiprofile | Settings > Network configuration > Wi-Fi configuration > Wi-Fi profile |
| shortcut Cisco IP Phone 6861 only | wpspbc | Allows the phone to connect to a wireless router with WPS button. |
| shortcut Cisco IP Phone 6861 only | wpspin | Allows the phone to connect to a wireless router with a WPS PIN code. |
| shortcut Cisco IP Phone 6861 only | wifistatus | Settings > Network configuration > Wi-Fi configuration > Wi-Fi status |
