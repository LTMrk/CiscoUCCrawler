---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cusrst-release-notes-srst-releasenotes-12-5-html-ae2a15723b
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cusrst/release/notes/SRST_ReleaseNotes_12_5.html
retrieved_at: 2026-08-21T21:28:56.594570+00:00
---

Release Notes for Cisco Unified Survivable Remote Site Telephony, 12.5

# Release Notes for Cisco Unified Survivable Remote Site Telephony, 12.5

## Table of Contents

Release Notes for Cisco Unified Survivable Remote Site Telephony, Release 12.5
...
New Features in Unified SRST, Release 12.5

Support for Unified SRST on Cisco 4461 Integrated Services Router

Caveats

Open Caveats—Unified SRST, Release 12.5
...
This Release Notes document describes the features of Cisco Unified Survivable Remote Site Telephony, Release 12.5 (Cisco IOS XE Gibraltar 16.10.1a).
...
- Cisco 4461 Integrated Services Router (Supported from Cisco IOS XE Gibraltar 16.10.1a Release)
...
Cisco IOS XE Software, Version Cisco IOS XE 16.10.1a

Cisco IOS Software, ISR Software (X86_64_LINUX_IOSD-UNIVERSALK9-M),

Copyright (c) 1986-2018 by Cisco Systems, Inc.

Compiled Fri 18-Jul-18 01:12.
...
For information on the support introduced for Unified SRST on Cisco 4000 Series Integrated Services Routers, see Unified SRST/E-SRST 12.5 Supported Firmware, Platforms, Memory, and Voice Products.
...
There are no open or unresolved caveats for Unified SRST, 12.5 Release.
