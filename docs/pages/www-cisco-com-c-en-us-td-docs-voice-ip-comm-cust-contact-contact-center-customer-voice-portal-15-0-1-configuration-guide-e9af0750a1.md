---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-customer-voice-portal-15-0-1-configuration-guide-e9af0750a1
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/customer_voice_portal/15-0-1/configuration/guide/ccvp_b_150-configuration-guide-for-cisco-unified-customer-voice-portal/call_server_configuration.html
retrieved_at: 2026-08-21T02:58:19.279181+00:00
---
...
The filename of the ringtone to be played for the respective dialed number. You must save the ringtone media file to the Cisco VVB .
...
Unified CVP makes a call to the ringtone service on the Cisco VVB . This call is followed by sending the call to the Unified Communications Manager trunk for the agent. During this period,
...
The IVR service creates VXML documents that are used to implement miroapplications based on Run Script instructions received
                                 by the ICM. The VXML pages are sent to the Cisco VVB to be run. The IVR Service can also generate external VXML through the microapplications to engage the Unified CVP VXML Server
...
| DN on
                                             					 ...
                                             					 valid label | No |
| DN on the CVP for Forking | Configure the dialed number on the CVP for forking. | 9393939393 | Any valid label | No |
| DN on the Gateway for Forking | Configure the dialed number on the media gateway for forking. | 9494949494 | Any valid label | No |
...
| Custom
                                             					 ...
                                             					 characters. See Valid Format for Dialed Numbers . | No |
| Ringtone
                                             					 media file name | The filename of the ringtone to be played for the respective dialed number. You must save the ringtone media file to the Cisco VVB . | None | 0 to 256
