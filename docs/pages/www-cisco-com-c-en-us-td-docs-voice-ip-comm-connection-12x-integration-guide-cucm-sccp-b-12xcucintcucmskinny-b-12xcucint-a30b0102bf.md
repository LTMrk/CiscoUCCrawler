---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-connection-12x-integration-guide-cucm-sccp-b-12xcucintcucmskinny-b-12xcucint-a30b0102bf
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/integration/guide/cucm_sccp/b_12xcucintcucmskinny/b_12xcucintcucmskinny_chapter_010.html
retrieved_at: 2026-08-16T18:40:29.348091+00:00
---
...
- For details on installation
                                             						tasks, see the “Installing Cisco Unity Connection” chapter of the Install, Upgrade, and
                                                						  Maintenance Guide for Cisco Unity Connection , Release 12.x, available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/install_upgrade/guide/b_12xcuciumg.html
...
See the
                                          					 “Ethernet IPv6 Configuration Settings” section in the “Security” chapter of the
                                          					 Cisco Unified Communications Operating System Administration Guide for Cisco
                                          					 Unity Connection Release 12.x at http://www.cisco.com/c/en/us/support/unified-communications/unity-connection/products-maintenance-guides-list.html .
...
If this is the first integration, the first phone system is
                                                   				  ...
                                                   				  after creating this phone system integration are assigned to this phone system
                                                   				  ...
                                                   				  templates, or on selecting a user template when adding a new user, see the
                                                   				  “User Templates” section in “User Attributes” chapter of the System
...
| Step 21 | Under AXL Server Settings, enter the following settings and
                                          			 select Save . Table 15. Settings for the AXL Server Settings Field Setting Username Enter the username that
                                                         						  ...
                                                         						  more information on certificates, see “ Security ” chapter of
                                                         						  Cisco Unified Communications Operating System Administration Guide for Cisco
                                                         						  Unity Connection Release 12.x at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/os_administration/b_12xcucosagx.html . | Field | Setting | Username | Enter the username that
                                                         						  Unity Connection uses to sign in to the AXL server. Note This user must match the
                                                                     							 user name of a Cisco Unified CM application user who is assigned to the
