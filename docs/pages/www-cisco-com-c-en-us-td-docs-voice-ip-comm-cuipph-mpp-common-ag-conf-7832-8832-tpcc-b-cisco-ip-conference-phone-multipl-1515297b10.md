...
| Step 1 | Choose the power source for the phone: Power over Ethernet (PoE) Cisco Unified IP Phone Power Injector |
|---|---|
...
| Step 1 | Choose the power source for the phone: Power over Ethernet (PoE) deployment with a Cisco IP Conference Phone 8832 PoE Injector Non-PoE Ethernet deployment with a Cisco IP Conference Phone 8832 Non-PoE Ethernet Injector |
|---|---|
