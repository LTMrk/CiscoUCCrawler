...
After you have the system sizing considerations, you can begin to order the appropriate server configuration. First, however,
                        determine how many Unified ICM nodes you need.

The number of servers required in a Unified ICM system depends on the configuration of the central controller, PGs, NICs,
                        and other nodes. For example, a duplexed central controller configuration requires more servers because the CallRouter and
                        Logger are duplicated.
...
For information on server configurations and examples of supported server platforms, see at https://www.cisco.com/c/en/us/support/customer-collaboration/unified-contact-center-enterprise/products-device-support-tables-list.html .
...
Only installed at the central site if that site also serves as a call center or you are using the remote ACD option. A second
                                             central site is not required in duplexed-collocated Central Controller configurations.
...
For complete and current information about RAM and other platform requirements, see the Hardware & System Software Specification (Bill of Materials) for Cisco Unified ICM/ContactCenter Enterprise & Hosted .
...
| Note | Only installed at the central site if that site also serves as a call center or you are using the remote ACD option. A second
                                             central site is not required in duplexed-collocated Central Controller configurations. |
|---|---|
