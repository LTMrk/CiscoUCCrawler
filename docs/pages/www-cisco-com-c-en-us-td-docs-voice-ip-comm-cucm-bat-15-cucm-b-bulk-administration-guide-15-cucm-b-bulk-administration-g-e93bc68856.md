---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-bat-15-cucm-b-bulk-administration-guide-15-cucm-b-bulk-administration-g-e93bc68856
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/bat/15/cucm_b_bulk-administration-guide-15/cucm_b_bulk-administration-guide-1251su2_chapter_011.html
retrieved_at: 2026-08-21T09:16:18.303291+00:00
---
...
From Release 15 onwards, we no longer support the H.323 Gatekeeper Control options. Hence, we recommend that you use SIP trunk
                                                         with Location Bandwidth Manager (LBM).
...
You can use the pseudo MAC address option when adding CTI ports. This option gives a unique device name to each CTI port in the form of pseudo MAC addresses that you can manually update later using the or the Unified CM Auto-Register phone Tool. Do not use the pseudo MAC address option for H.323 clients, VGC phones, or VGC virtual phones.
...
Enter the MAC address for phones, VGC virtual phones, and VGC phones. Enter a unique identifier (Device Name) for the CTI
                                             port or H.323 client. You can check the Create Pseudo MAC Address check box to automatically generate unique device identifiers.
...
| Gatekeeper
                                                						Information |
| Gatekeeper Name | Choose the gatekeeper for the gatekeeper-controlled H.323 device from the drop-down list. Note From Release 15 onwards, we no longer support the H.323 Gatekeeper Control options. Hence, we recommend that you use SIP trunk
                                                         with Location Bandwidth Manager (LBM). Note If you
                                                         						do not choose the device, the system disables the E.164, Technology Prefix, and
                                                         						Zone fields. Note You
                                                         						cannot change the device to a gatekeeper-controlled phone if more than one
                                                         						directory number is configured for the device. | Note | From Release 15 onwards, we no longer support the H.323 Gatekeeper Control options. Hence, we recommend that you use SIP trunk
                                                         with Location Bandwidth Manager (LBM). | Note | If you
                                                         						do not choose the device, the system disables the E.164, Technology Prefix, and
                                                         						Zone fields. | Note | You
                                                         						cannot change the device to a gatekeeper-controlled phone if more than one
                                                         						directory number is configured for the device. |
| Note | From Release 15 onwards, we no longer support the H.323 Gatekeeper Control options. Hence, we recommend that you use SIP trunk
                                                         with Location Bandwidth Manager (LBM). |
| Note | If you
                                                         						do not choose the device, the system disables the E.164, Technology Prefix, and
                                                         						Zone fields. |
