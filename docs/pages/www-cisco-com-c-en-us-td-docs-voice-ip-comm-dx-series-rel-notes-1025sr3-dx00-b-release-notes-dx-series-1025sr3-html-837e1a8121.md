---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-dx-series-rel-notes-1025sr3-dx00-b-release-notes-dx-series-1025sr3-html-837e1a8121
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/dx/series/rel-notes/1025sr3/dx00_b_release-notes-dx-series-1025sr3.html
retrieved_at: 2026-08-22T00:57:10.113908+00:00
---

Release Notes for Cisco DX Series Firmware Release 10.2(5)SR3
...
- For Cisco DX70: cmterm-dx70.10-2-5-207.k3.cop.sgn

- For Cisco DX80: cmterm-dx80.10-2-5-207.k3.cop.sgn

- For Cisco DX650: cmterm-dx650.10-2-5-207.k3.cop.sgn

- For all Cisco DX Series devices: cmterm-dxseries.10-2-5-207.k3.cop.sgn
...
- For Cisco DX70: cmterm-dx70.10-2-5-207.zip

- For Cisco DX80: cmterm-dx80.10-2-5-207.zip

- For Cisco DX650: cmterm-dx650.10-2-5-207.zip
...
| Step 4 | In the Latest Releases folder, choose 10.2(5.207) . |
| Step 5 | Select one of the following firmware files, click the Download or Add to cart button, and follow the prompts: For Cisco DX70: cmterm-dx70.10-2-5-207.k3.cop.sgn For Cisco DX80: cmterm-dx80.10-2-5-207.k3.cop.sgn For Cisco DX650: cmterm-dx650.10-2-5-207.k3.cop.sgn For all Cisco DX Series devices: cmterm-dxseries.10-2-5-207.k3.cop.sgn Note If you added the firmware file to the cart, click the Download Cart link when you are ready to download the file. | Note | If you added the firmware file to the cart, click the Download Cart link when you are ready to download the file. |
...
| Step 3 | Choose your device type. |
| Step 4 | In the Latest Releases folder, choose 10.2(5.207) . |
| Step 5 | Download the relevant zip files. For Cisco DX70: cmterm-dx70.10-2-5-207.zip For Cisco DX80: cmterm-dx80.10-2-5-207.zip For Cisco DX650: cmterm-dx650.10-2-5-207.zip |
