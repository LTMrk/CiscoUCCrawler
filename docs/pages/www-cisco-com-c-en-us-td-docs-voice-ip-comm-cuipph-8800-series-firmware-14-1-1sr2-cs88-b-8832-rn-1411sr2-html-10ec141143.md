---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-8800-series-firmware-14-1-1sr2-cs88-b-8832-rn-1411sr2-html-10ec141143
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/8800-series/firmware/14-1-1sr2/cs88_b_8832-rn-1411sr2.html
retrieved_at: 2026-08-21T13:28:09.640642+00:00
---

Cisco IP Conference Phone 8832 Release Notes for Firmware Release 14.1(1)SR2
...
These release notes support the Cisco IP Conference Phone 8832 running SIP Firmware Release 14.1(1)SR2.
...
## New Cisco IP Conference Phone Hardware version for 8832

The Cisco IP Conference Phone 8832 hardware has been updated. The new hardware version is V08.

Phones manufactured with the new hardware updates must run Firmware Release 14.1(1)SR2 or later. The phone firmware does not
                     allow the phone to be downgraded to releases earlier than Firmware Release 14.1(1)SR2.
...
The firmware filename is cmterm-8832-sip.14-1-1-0211-134.k4.cop.sha512.
...
The firmware filename is cmterm-8832.14-1-1-0211-134.zip.
...
CSCwc69646 Wi-Fi password is printed in phone log when bootup

CSCwd04973 The phone can't connect to AP with EAP-TLS + MIC as User Cert
...
| Step 5 | Select the firmware file, click the Download or Add to cart button, and follow the prompts. The firmware filename is cmterm-8832-sip.14-1-1-0211-134.k4.cop.sha512. Note If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . | Note | If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . |
...
| Step 3 | Choose Session Initiation Protocol (SIP) Software . |
| Step 4 | In the Latest Releases folder, choose 14.1(1)SR2 . |
| Step 5 | Select the firmware file, click the Download Downlod or Add to Cart button, and follow the prompts. The firmware filename is cmterm-8832.14-1-1-0211-134.zip. |
