---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cer-12-5-1-english-off-premises-user-guide-cer0-b-cisco-emergency-responder--43d8066b21
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cer/12_5_1/english/off-premises_user/guide/cer0_b_cisco-emergency-responder-off-premises-guide-1251/cer0_b_cisco-emergency-responder-off-premises-guide-1251_chapter_01.html
retrieved_at: 2026-08-21T15:28:52.814351+00:00
---
...
For list of
                              		  supported phones, refer the Cisco Emergency Responder
                                 			 Release Notes .
...
User Options
                                          				...
                                          				address or name as the Cisco Unified Communications Manager server).
...
| Step 1 | Obtain the User
                                       			 ...
                                       			 your system administrator. Example: User Options
                                          				URL: <http://server_name/ccmuser/logon.asp>, where server_name is the
                                          				host on which the web server is installed (the host is usually the same IP
                                          				address or name as the Cisco Unified Communications Manager server). User ID:
