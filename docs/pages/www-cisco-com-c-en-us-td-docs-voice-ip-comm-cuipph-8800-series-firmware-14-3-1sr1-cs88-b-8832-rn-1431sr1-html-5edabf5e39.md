...
These release notes support the Cisco IP Conference Phone 8832 running SIP Firmware Release 14.3(1)SR1.
...
The firmware filename is cmterm-8832-sip.14-3-1-0101-131.k4.cop.sha512.
...
The firmware filename is cmterm-8832.14-3-1-0101-131.zip.
...
Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch?kw=*&pf=prdNm&rls=14.3(1)SR1&sb=anfr&svr=3nH&bt=custV&prdNam=Cisco%20IP%20Conference%20Phone%208832

Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch?kw=*&pf=prdNm&rls=14.3(1)SR1&sb=anfr&svr=3nH&bt=custV&prdNam=Cisco%20IP%20Conference%20Phone%208832&sts=open

Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch?kw=*&pf=prdNm&rls=14.3(1)SR1&sb=anfr&svr=3nH&bt=custV&prdNam=Cisco%20IP%20Conference%20Phone%208832&sts=fd
...
CSCwm85644: Vulnerabilities in linux-kernel 5.4.124 CVE-2022-0185

CSCwm85702: Vulnerabilities in linux-kernel 5.4.124 CVE-2023-0266

CSCwm85742: Vulnerabilities in linux-kernel 5.4.124 CVE-2022-2586

CSCwm87805: CVE-2024-1086: A use-after-free vulnerability in the Linux kernel's netfilter

CSCwm80999: Evaluation of 8832 for local privilege escalation vulnerability in the debug shell
...
| Step 4 | Select the firmware file, click the Download or Add to cart button, and follow the prompts. The firmware filename is cmterm-8832-sip.14-3-1-0101-131.k4.cop.sha512. Note If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . | Note | If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . |
...
| Step 2 | Choose Session Initiation Protocol (SIP) Software . |
| Step 3 | In the Latest Releases folder, choose 14.3(1)SR1 . |
| Step 4 | Select the firmware file, click the Download or Add to Cart button, and follow the prompts. The firmware filename is cmterm-8832.14-3-1-0101-131.zip. |
...
| Step 1 | Perform one of the following actions: Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch?kw=*&pf=prdNm&rls=14.3(1)SR1&sb=anfr&svr=3nH&bt=custV&prdNam=Cisco%20IP%20Conference%20Phone%208832 Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch?kw=*&pf=prdNm&rls=14.3(1)SR1&sb=anfr&svr=3nH&bt=custV&prdNam=Cisco%20IP%20Conference%20Phone%208832&sts=open Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch?kw=*&pf=prdNm&rls=14.3(1)SR1&sb=anfr&svr=3nH&bt=custV&prdNam=Cisco%20IP%20Conference%20Phone%208832&sts=fd |
|---|---|
