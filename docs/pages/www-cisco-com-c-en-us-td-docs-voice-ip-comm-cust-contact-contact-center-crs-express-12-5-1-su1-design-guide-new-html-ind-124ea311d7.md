---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-crs-express-12-5-1-su1-design-guide-new-html-ind-124ea311d7
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/crs/express_12_5_1_su1/design/guide_new/html/index/Solution-Security-UCCX-12-5-1-SU1.html
retrieved_at: 2026-08-16T21:06:38.630467+00:00
---
...
Chapter: Solution Security UCCX 12.5(1) SU1
...
The media leg between Unified CCX and gateway uses SRTP. However, media leg between Unified CCX and Nuance Speech server uses RTP.
...
FIPS mode does not support SNMP v3 with MD5 or DES. When FIPS 140-2 mode is enabled, if you have SNMP v3 configured, you must configure SHA as the Authentication Protocol and AES128 as the Privacy Protocol.
...
| Note | You must relaunch Cisco Unified CCX Editor and Cisco Unified Real-Time Monitoring Tool after the upgrade of Unified CCX. Ensure that the Unified CCX server and the client application is restarted for the changes to take effect. |
|---|---|

| Note | The media leg between Unified CCX and gateway uses SRTP. However, media leg between Unified CCX and Nuance Speech server uses RTP. SRTP is not applicable for Home Agents with Extend and Connect. |
|---|---|
