---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-12-6-1-program-gui-742051fd71
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_12_6_1/program/guide/ucce_b_ctios-developer-guide_12_6_1/ucce_b_ctios-developer-guide_12_5_chapter_0100.html
retrieved_at: 2026-08-16T20:24:13.029263+00:00
---
...
The agent continues to be in the same state as the agent was in before talking the call.
...
| Agent retrieves the call on hold | The agents is in the Talking state. The following buttons are enabled: Hold, Release, Supervisor
                                          					 Assist, Emergency Assist, Conference, transfer, Statistics, Chat ctl and
                                          					 Badline control. |
| Agent releases the call | The agent continues to be in the same state as the agent was in before talking the call. Note The agent is in the Wrap-up state, provided Wrap-up is
...
| Note | The Ready, NR and Wrap-up buttons are enabled based on the
                                                      						agent desktop setting. |
| Complete conference is done for the conference initiator | The agent continues to be in the same state as the agent was in, before talking the call. Note The agent is in the Wrap-up state, provided Wrap-up is
                                                      						configured. If Wrap-up was not configured, then the Ready and Not Ready buttons are enabled. | Note | The agent is in the Wrap-up state, provided Wrap-up is
                                                      						configured. |
| Note | The agent is in the Wrap-up state, provided Wrap-up is
                                                      						configured. |
...
| Note | The Ready, Not Ready, and wrap-up buttons are enabled based
                                                      						on the agent desktop settings configured in the Configuration Manager. |
| Complete conference is done for the Transfer Initiator | The agent continues to be in the same state as the agent was in, before talking the call. Note The agent is in the Wrap-up state, provided Wrap-up is
                                                      						configured. If Wrap-up was not configured, then the Ready and Not Ready buttons are enabled. | Note | The agent is in the Wrap-up state, provided Wrap-up is
                                                      						configured. |
| Note | The agent is in the Wrap-up state, provided Wrap-up is
                                                      						configured. |
| Agent does a Single Step Transfer | The agent continues to be in the same state as the agent was in, before talking the call. Note The agent is in the Wrap-up state, provided Wrap-up is
