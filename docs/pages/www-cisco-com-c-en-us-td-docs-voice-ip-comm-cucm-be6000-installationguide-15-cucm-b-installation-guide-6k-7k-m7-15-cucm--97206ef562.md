---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-be6000-installationguide-15-cucm-b-installation-guide-6k-7k-m7-15-cucm--97206ef562
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/BE6000/InstallationGuide/15/cucm_b_installation-guide-6k_7k_m7_15/cucm_m_installation-of-cisco-business-edition-m7.html
retrieved_at: 2026-08-21T22:40:22.454869+00:00
---
...
Before you unpack the server, verify that all of the following items are present. If any of the items is missing or appears
...
Any other required cables (not included with the appliance, such as KVM adapter, Ethernet cable, Console cable).
...
Ethernet network port(s) configured for the appliance's local area network access.

For More Instructions:

To understand the BE6000 appliance's front and rear panels, see the Detailed Views chapter of the Spec Sheet for Cisco UCS C220 M7 SFF Rack Server (M7S chassis) .

To understand the BE7000 appliance's front and rear panels, see the Detailed Views chapter of the Spec Sheet for Cisco UCS C240 M7 SFF Rack Server (M7SX chassis) .

To rack-mount a BE6000 appliance, see the rack-mount instructions in the Cisco UCS C220 M7 Server Installation and Service Guide .

To rack-mount a BE7K appliance, see the rack-mount instructions in the Cisco UCS C240 M7 Server Installation and Service Guide .
...
Infrastructure & Coresidency requirements —This web page contains information on the conditions that you must meet to run Cisco applications and any third-party applications
...
Business Edition 6000/7000 Software Load Summary/Release Notes —Describes what is and is not pre-loaded on your appliance.
...
Decide how you interconnect the appliance to your network. Specifics on network interconnection options are beyond the scope
                                 of this guide, but below are some important callouts.

Available physical ethernet ports depend on the appliance model:

All M7 appliance models include an Open Compute Project 3.0 NIC (“OCP NIC” motherboard LAN ports as described in the Cisco UCS C220/C240 M7 Rack Server (Small Form Factor Disk Drive Model) Spec Sheet .

All appliance models ship with quad-port 10-Gigabit Ethernet SFP+ network interface cards. It is not supported on any appliance
...
Collaboration application files are not factory-preloaded; they are sold separately and must be manually installed/licensed.
...
Installation guide for each application.
...
Configure CIMC for your Business Edition 6000/7000 appliance.
...
Some Business Edition applications require the host to have a valid time reference.
...
A license for VMware vSphere ESXi software is required but is not included with, sold with, or factory loaded on these appliances.
                                                ...
                                                Broadcom.com ESXi 7.0 technical documentation. After expiry of evaluation mode, virtual machines will not be able to power
...
Each application that you want to run, requires its virtual machine base OVA file from software.cisco.com.
...
For more details, see the applications Installation Guide and the Preload File Summaries in Release Notes at: http://www.cisco.com/c/en/us/support/unified-communications/business-edition-6000/products-release-notes-list.html .
...
Browse and select the source OVA template file on your PC.
...
Go to the online answer file generator at: www.cisco.com/web/cuc_afg/ .
...
|---|---|---|
| Step 1 | Configure Cisco Integrated Management Controller | Configure CIMC for your Business Edition 6000/7000 appliance. |
| Step 2 | Install and Customize Virtualization Software | Install and configure the VMware vSphere ESXi software on the appliance. |
...
| Note | Some Business Edition applications require the host to have a valid time reference. |
|---|---|
...
| Step 3 | Associate Application ISO Files to Virtual Machines | For UC application installations that require an ISO file, mount the ISO file on the application VM. |
...
| Caution | If you rebuild your appliance to use  an older version of ESXi, then to ensure proper operation of your appliance and ensure
                                          you are using the Cisco UCS-specific image from Broadcom.com and that you have made arrangements for ESXi licensing of the
                                          older version. |
|---|---|
...
| Step 5 | Browse and select the source OVA template file on your PC. |
