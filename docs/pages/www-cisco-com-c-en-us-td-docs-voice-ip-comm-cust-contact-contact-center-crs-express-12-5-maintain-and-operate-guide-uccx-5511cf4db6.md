...
If the passwords on all the nodes in the cluster don’t match, the system prompts you to enter the password every time you
                                                try to access a node.
...
| Caution | The security password on all nodes in a cluster must match. Change the security password on all machines, or the cluster nodes
                                                cannot communicate. If the passwords on all the nodes in the cluster don’t match, the system prompts you to enter the password every time you
                                                try to access a node. |
|---|---|
