---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-bat-12-5-1-su2-cucm-b-bulk-administration-guide-1251su2-cucm-b-bulk-adm-144de31c30
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/bat/12_5_1_SU2/cucm_b_bulk-administration-guide-1251su2/cucm_b_bulk-administration-guide-1251su2_chapter_010100.html
retrieved_at: 2026-08-21T08:47:00.560980+00:00
---
...
The user ID, PKID, password, pin, and digest credentials columns in
...
In the first Find User where drop-down list box, choose a
                                       			 field to query from the following options:
...
|---|---|
| Step 2 | In the first Find User where drop-down list box, choose a
                                       			 field to query from the following options: User ID First Name Middle Name Last Name Manager Department |
