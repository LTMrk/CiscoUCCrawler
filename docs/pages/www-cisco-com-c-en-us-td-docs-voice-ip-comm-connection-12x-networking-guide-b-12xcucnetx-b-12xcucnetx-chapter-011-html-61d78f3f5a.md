---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-connection-12x-networking-guide-b-12xcucnetx-b-12xcucnetx-chapter-011-html-61d78f3f5a
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/networking/guide/b_12xcucnetx/b_12xcucnetx_chapter_011.html
retrieved_at: 2026-08-17T02:37:20.276083+00:00
---
...
The remote voice messaging system that Unity Connection is
                                    			 networked with is listed in the “Requirements for VPIM Networking” section of
                                    			 the applicable system requirements document: System Requirements for Cisco Unity Connection Release 12.x ,
...
Review your partition and search space configuration to
                                    			 determine the partition and search scope you use for each VPIM location. For
                                    			 more information, see the “Dial Plan” section of
                                    			 the “Call Management” chapter of the System Administration Guide for
                                    			 Cisco Unity Connection Release 12.x ,
                                    			 available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/administration/guide/b_12xcucsag.html .
...
For more
                                 			 information on Bulk Administration Tool, appendix of System
...
| Step 6 | If applicable, add optional column headers to the first row, and
                                             			 ...
                                             			 you do so, confirm the following: Column headers and data are separated by commas. Note that every
                                                      					 ...
                                                      					 contained within quotation marks. Tip Include a column with the ListInDirectory header and a value of
                                                         				1 for each contact if you would like users to be able to address messages to
                                                         				VPIM contacts the same way that they address messages to regular Unity
                                                         				Connection users—by extension or by spelling the name of the recipient. For a
                                                         				list of optional column headers, see the “Required and Optional CSV
                                                            				  Fields in BAT” section of the “Bulk Administration Tool” appendix of the System Administration Guide for Cisco Unity Connection, Release
                                                            				  12.x , available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/administration/guide/b_12xcucsag.html . | Tip | Include a column with the ListInDirectory header and a value of
                                                         				1 for each contact if you would like users to be able to address messages to
                                                         				VPIM contacts the same way that they address messages to regular Unity
                                                         				Connection users—by extension or by spelling the name of the recipient. For a
                                                         				list of optional column headers, see the “Required and Optional CSV
...
| Tip | Include a column with the ListInDirectory header and a value of
                                                         				1 for each contact if you would like users to be able to address messages to
                                                         				VPIM contacts the same way that they address messages to regular Unity
                                                         				Connection users—by extension or by spelling the name of the recipient. For a
                                                         				list of optional column headers, see the “Required and Optional CSV
