...
The Unified ICM Enterprise Edition
                        		...
                        		network to perform pre-routing. Each interexchange carrier offers intelligent network services that
                        		allow customer-premises equipment to participate in network-level call routing.
                        		The Unified ICM software uses a Cisco
                        		Network Interface Controller (NIC) to connect  to one or more networks.
...
Choose the types of network link fault tolerance to apply. Apply fault tolerance in the network interface and the links to
                              			 the carrier  intelligent network.

Order intelligent network service. After you review the requirements
...
Cisco provides a NIC to
                              		  interface with the specific carrier network. For example, if you have TIM
                              		  service, your Unified ICM system is equipped with a Cisco-supplied TIM NIC. If
                              		  you use both AT&T and TIM as carriers, your Unified ICM system is equipped
                              		  with AT&T and TIM NICs. The following figure shows the interaction between
...
The following table summarizes the basic supported carrier connections and their corresponding Unified ICM software routing
                                 client (NIC) and network transport protocol.
...
Gatekeeper GKTMP interface (TCP/IP)

ICRP

Intelligent CallRouter Protocol (UDP)

INCRP

NAM/ICM Gateway Call Routing Protocol interface (UDP)
...
#### SPRINT network interface

3 (5 if simplexed) x Eiconcard:

PCI 2.2

- Motorola Freescale 852 T @ 98 MHz

- 16 MB SDRAM

- Bus Type: PCI 2.2 64bit / 66 MHz (3.3 V)
...
- PLX 8111 Express Interface

- Bus Type: Single lane PCIe 1.0a 2.5Gbit/Sec

- Two VHSI connectors

- 5 (10 if simplexed) x VHSI V.35 DCE cable (Eicon #300-076)

- Eiconcard Connections for Windows V6R9
...
|---|---|
| AT&T | AT&T Network (AT&T Sigtran) |
| CRSP | Call Routing Service Protocol (UDP) |
| GKTMP | Gatekeeper GKTMP interface (TCP/IP) Note Deprecated in release 10. | Note | Deprecated in release 10. |
| Note | Deprecated in release 10. |
| ICRP | Intelligent CallRouter Protocol (UDP) |
| INCRP | NAM/ICM Gateway Call Routing Protocol interface (UDP) Note Deprecated in release 10. | Note | Deprecated in release 10. |
| Note | Deprecated in release 10. |
| MCI | MCI Network (TCP/IP) |
| Nortel | INAP (Sigtran) |
| NTL | NTL Network (TCP/IP) |
| SS7IN | ITU (Sigtran) |
| Unisource INAP | INAP (Sigtran) |
| TIM | INAP (Sigtran) |
| CWC | INAP (Sigtran) |
...
| Network Interface | Hardware (For Signaling Access Networks) |
|---|---|
| SPRINT network interface | 3 (5 if simplexed) x Eiconcard: |
| PCI 2.2 | S94 V2 Motorola Freescale 852 T @ 98 MHz 16 MB SDRAM Bus Type: PCI 2.2 64bit / 66 MHz (3.3 V) |
| PCIe (PCI Express) | S94 PCI Express Motorola Freescale 852 T @ 98 MHz 16 MB SDRAM PLX 8111 Express Interface Bus Type: Single lane PCIe 1.0a 2.5Gbit/Sec Two VHSI connectors |
| 5 (10 if simplexed) x VHSI V.35 DCE cable (Eicon #300-076) Eiconcard Connections for Windows V6R9 |
