...
retrieved_at: 2026-08-16T15:55:42.972892+00:00
---
...
Call-id of the respective call leg of  to the cover buffer
...
Displays tracing status, which includes that time and date VoIP trace was enabled.
...
Displays the number of failed call legs dumped into logging buffer. Dumped calls refers to call legs associated with IEC errors
...
Displays total call legs available in the history. This can be same or different compared to Total call legs captured, it depends on the memory limit.
...
Filters and displays VOIP Trace based on SIP Call-ID
