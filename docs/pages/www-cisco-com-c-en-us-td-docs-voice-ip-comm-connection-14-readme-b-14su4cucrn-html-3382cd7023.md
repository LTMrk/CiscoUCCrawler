---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-connection-14-readme-b-14su4cucrn-html-3382cd7023
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/readme/b_14su4cucrn.html
retrieved_at: 2026-08-16T18:49:23.411466+00:00
---

Readme for Cisco Unity Connection Release 14 Service Update 4
...
This readme file contains installation and support information for Cisco Unity Connection Release 14 Service Update 4.
...
System Requirements for Cisco Unity Connection Release 14SU4 is available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/requirements/b_14cucsysreqs.html .
...
Cisco Unity Connection 14SU4 is a cumulative update that incorporates all of the fixes and changes to Cisco Unity Connection
                  version 14 — including the operating system and components shared by Cisco Unity Connection and Cisco Unified CM. It also
...
Full version numbers include the build number (for example, 14.0.1.14900-36), the software versions listed on the download
...
This section contains all new and changed support or functionality for release 14SU4 and later.

The new locales for Unity Connection 14 SU4 have been released and available on Download Software site at https://software.cisco.com/download/home/282421576/type .
...
Cisco Unity Connection supports the Speechview functionality with a third party transcription service, which converts the
                  voice message to text and the transcribed text is sent to the user along with the voice message. With Release 14SU4 and later,
                  Unity Connection uses the Cisco Webex in-house transcription service for transcription of voice messages.

Thirdparty transcription service will be EOL by Decemeber 30,2024. Hence customers are advised to upgrade to 14SU4 or later
...
For more information, see chapter "SpeechView Cisco Webex in-house Transcription Service" of the System Administration Guide
                  guide available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/administration/guide/b_14cucsag.html

## Important Notes

Warning for Upgrades to 15

The Upgrades from version 14 SU4 to any Cisco Unity Connection release 15 versions lower than 15SU2 are not allowed and will
                  not be displayed as valid upgrade options. Customers upgrading from this SU should choose 15SU2 or higher as their target
                  upgrade.

Warning for Upgrades from 10.5(2)

Direct upgrade from versions 10.5(2) to 14SU4 is not supported. To upgrade from version 10.5(2) to 14SU4, you must follow
                  an intermediate upgrade path such as going from 10.5(2) to 12.x or later and then from 12.x or later to 14SU4.

Warning for Upgrades with FIPS Enabled

If you are upgrading with FIPS enabled, see the CiscoSSL7 COP File Readme for information on the COP file ciscocm.ciscossl7_upgrade_CSCwa48315_CSCwa77974_v1.0.k4.cop.sha512 . This document details the pre-requisites required for direct upgrade or direct migration to the 14SU4 destination versions
...
For descriptions and URLs of Cisco Unity Connection documentation on Cisco.com, see the Documentation Guide for Cisco Unity Connection Release 14SU4 . The document is shipped with Unity Connection and is available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/requirements/b_14cucsysreqs.html .
...
For instructions on downloading the service update, see the " Downloading Cisco Unity Connection Release 14 SU4 Software " section.
...
If you are performing an upgrade from a FIPS enabled Cisco Unity Connection release to Cisco Unity Connection 14 SU4, make
                              sure to follow the steps for regenerating certificates before using any pre-existing telephony integrations. To learn how
                              to regenerate certificates, see the Regenerating Certificates for FIPS section of the "FIPS Compliance in Cisco Unity Connection" chapter of the Security Guide for Cisco Unity Connection Release 14SU4 at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/security/guide/b_14cucsecx.html

### Downloading Cisco Unity Connection Release 14 Service Update 4 Software
...
With restricted and unrestricted versions of Cisco Unity Connection software now available, download software carefully. Upgrading
                                 ...
                                 of the Release Notes for Cisco Unity Connection Release 14SU4 at http://www.cisco.com/c/en/us/support/unified-communications/unity-connection/products-release-notes-list.html .
...
On the Select a Release page, select 14 SU4 , and the download buttons appear on the right side of the page.
...
The VOS version for above mentioned ISO is 14.0.1.14901-1.
...
You can find the latest caveat information for Unity Connection version 14SU4 by using Bug Toolkit, an Online tool available
...
- Open Caveats—Unity Connection Release 14SU4

- Resolved Caveats—Unity Connection Release 14 SU4

Related Caveats—Cisco Unified Communications Manager 14SU4 Components that are Used by Unity Connection 14SU4
...
Evaluation of Cisco Unity Connection for Open SSH regression vulnerability

"Connection Google Workspace Sync Service" (CuGSuiteSy+) is using high CPU than expected

setup

3

CUC Dataexport fails on Blue Screen stuck indefinitely when exporting data from 11.5 to 15

Note : The COP file is available for this defect fix in 14SU4 at Software Download - Cisco Systems .

ReadMe: ciscocm.V14_CVE-2024-6387_v1.1.cop-Readme.pdf
...
Legacy secure call not working in "Authenticated" mode

database

3

Tomcat REST actions do not get updated to tbl_messageactivity in UnityRptDB

database

3

Sysadmin database failing to move to sadmin dbspace
...
Google Workspace Sync not functioning correctly in case invalid/stale history id in CUC DB

setup

3

Certificate Unknown Error is from Unity side, after upgrading from 14 FCS to 14SU3
...
- ReadMe for Cisco Unified Communications Manager Release 14SU4 on the download page for 14SU4 (start at https://software.cisco.com/download/home/280082558 ).
...
| Note | The new locales for Unity Connection 14 SU4 have been released and available on Download Software site at https://software.cisco.com/download/home/282421576/type . |
|---|---|

| Note | Thirdparty transcription service will be EOL by Decemeber 30,2024. Hence customers are advised to upgrade to 14SU4 or later
                              releases. For more information see Field Notice: FN74144 - Cisco Unity Connection SpeechView Transcription Service Will Stop Working after December 30, 2024
                                 - Software Upgrade Recommended - Cisco |
|---|---|

| Note | If you are performing an upgrade from a FIPS enabled Cisco Unity Connection release to Cisco Unity Connection 14 SU4, make
                              sure to follow the steps for regenerating certificates before using any pre-existing telephony integrations. To learn how
                              to regenerate certificates, see the Regenerating Certificates for FIPS section of the "FIPS Compliance in Cisco Unity Connection" chapter of the Security Guide for Cisco Unity Connection Release 14SU4 at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/security/guide/b_14cucsecx.html |
|---|---|
...
| Step 4 | On the Select a Release page, select 14 SU4 , and the download buttons appear on the right side of the page. |
| Step 5 | Confirm that
                                    			 the computer you are using has sufficient hard-disk space for the downloaded
                                    			 files. (The download descriptions include file sizes.) |
| Step 6 | Select the
                                    			 applicable download, then follow the on-screen prompts to complete the
                                    			 download, making note of the MD5 value. Restricted version UCSInstall_CUC_14.0.1.14900-36.sgn.iso Unrestricted version UCSInstall_CUC_UNRST_14.0.1.14900-36.sgn.iso Note The VOS version for above mentioned ISO is 14.0.1.14901-1. | Restricted version | UCSInstall_CUC_14.0.1.14900-36.sgn.iso | Unrestricted version | UCSInstall_CUC_UNRST_14.0.1.14900-36.sgn.iso | Note | The VOS version for above mentioned ISO is 14.0.1.14901-1. |
| Restricted version | UCSInstall_CUC_14.0.1.14900-36.sgn.iso |
| Unrestricted version | UCSInstall_CUC_UNRST_14.0.1.14900-36.sgn.iso |
| Note | The VOS version for above mentioned ISO is 14.0.1.14901-1. |
...
|---|---|---|---|
| CSCwk63494 1 | core | 3 | Evaluation of Cisco Unity Connection for Open SSH regression vulnerability |
...
| Caveat Number | Component | Severity | Description |
|---|---|---|---|
| CSCwh14380 | inbox | 2 | Cisco Unity Connection Unauthenticated Arbitrary File Upload Vulnerability. |
...
| CSCwf98820 | database | 3 | Sysadmin database failing to move to sadmin dbspace |
| CSCwi58750 | inbox | 3 | Unity Connection Encounters Null Pointer Exception on Web Inbox Redirection |
| CSCwf70241 | messaging | 3 | Google Workspace Sync not functioning correctly in case invalid/stale history id in CUC DB |
| CSCwf83827 | setup | 3 | Certificate Unknown Error is from Unity side, after upgrading from 14 FCS to 14SU3 |
