---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-12-5-1-installatio-f47795b5e9
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_12_5_1/installation/guide/ucce_b_12_5_Install_upgrade_guide_ucce/ucce_b_cisco-unified-contact-center-enterprise12_5_chapter_011.html
retrieved_at: 2026-08-16T19:52:47.987905+00:00
---
...
Select the host in the vSphere client and click Deploy OVF Template .
...
For each datastore, the following tables describe the RAID group, the ESXi Host, and the virtual machines for the Cisco UCS
                                                C240 M4SX , Cisco UCS C240 M5SX, and Cisco UCS C240 M6SX servers.
...
Go to Settings > Update & Security and run Microsoft Windows Update. Microsoft Windows Server is installed.
...
The Windows 11 installation is applicable to CCE release 12.5(2).
...
Open Control
                                                   				  Panel > Clock, Region and Language .
...
Cisco supports the Microsoft validation to dynamically manage the SQL
                                                            							...
                                                            							limit of the SQL memory using the maximum memory
                                                               								...
                                                               								Properties menu. as shown below:
...
To allow
                                          				required access to installation program files or folders, perform file-blocking
                                          				exclusions in the antivirus product file-and-folder protection rules. For
                                          				example, to create the exclusions in McAfee VirusScan:
...
In the
                                                					 Anti-virus Standard Protection category, make sure that the rule Prevent IRC communication is unchecked in the Block column.

Be aware that in the firewall component of Symantec Endpoint Protection 14.2, the Network Threat Protection feature must be
...
| Step 15 | Navigate to Control Panel > System and Security > System . Follow the instructions: Click Change Settings . In Computer name tab, click Change . Change the name of the computer from the name randomly generated during Microsoft Windows Server installation. The name does
...
| Note | If the ESXi version is 7.0 U2 and above you must upgrade the VM Hardware version. The Windows 11 installation is applicable to CCE release 12.5(2). |
|---|---|
...
| Step 14 | Enable Named Pipes and set the sort order as follows: Open the SQL Server Configuration Manager. In the left pane, navigate to SQL Native Client 11.0
                                                   							...
                                                   							select Enable . Note By default, Microsoft SQL Server dynamically resizes its memory. The SQL
                                                            							...
                                                            							limit of the SQL memory using the maximum memory
                                                               								usage settings in the SQL Server
                                                               								Properties menu. as shown below: Component SQL Server Minimum Memory SQL Server
