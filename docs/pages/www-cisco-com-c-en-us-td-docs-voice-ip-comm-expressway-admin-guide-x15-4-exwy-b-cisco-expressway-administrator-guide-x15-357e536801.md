---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-expressway-admin-guide-x15-4-exwy-b-cisco-expressway-administrator-guide-x15-357e536801
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/expressway/admin_guide/X15-4/exwy_b_cisco-expressway-administrator-guide-x154/exwy_m_zones-and-neighbors.html
retrieved_at: 2026-08-16T22:26:51.779490+00:00
---
...
Unified Communications traversal : A traversal client or traversal server zone used for Unified Communications features such as mobile and remote access.
...
Once B2BUA is engaged, Expressway does not act like a proxy (that is, 4xx messages are not proxied).
...
This option is primarily intended for use with Call Service Connect. See Hybrid Services Knowledge Base .
...
| Important | Once B2BUA is engaged, Expressway does not act like a proxy (that is, 4xx messages are not proxied). |
|---|---|
...
| ICE support | Controls whether ICE messages are supported by the devices in this zone. | See Configuring ICE Messaging Support for more information. |
| Preloaded SIP routes support | Switch Preloaded SIP routes support On to enable this zone to process SIP INVITE requests that contain the Route header. Switch Preloaded SIP routes support Off if you want the zone to reject SIP INVITE requests containing this header. |  |
| Modify DNS request | Routes outbound SIP calls from this zone to a manually specified SIP domain instead of the domain in the dialed destination. | This option is primarily intended for use with Call Service Connect. See Hybrid Services Knowledge Base . |
