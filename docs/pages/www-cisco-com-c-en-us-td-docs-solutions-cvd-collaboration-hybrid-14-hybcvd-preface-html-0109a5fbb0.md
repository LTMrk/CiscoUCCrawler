...
Readers of this guide should have a general knowledge of Cisco voice, video, and collaboration products and a basic understanding of how to deploy those products. We recommend that readers review the Preferred Architecture for Webex Hybrid Services, Design Overview before reading this CVD document.
...
- Building upon the product and design recommendations of the Preferred Architecture for Webex Hybrid Services, Design Overview
...
- Webex Hybrid Call Service — Provides integration of Cisco Unified Communications Manager call services with Webex. This chapter describes, at a high level, how to deploy Webex Hybrid Call Service within the Webex Hybrid Services solution.
...
The architecture was updated to support Webex Edge for Devices with Webex Device Connector. Webex Teams is now Webex App with new iconography. Lastly the chapters Video Mesh and Bandwidth Management were removed and replaced with standalone Alternative Design Guides linked from the Preferred Architectures Design Guides landing page, see Alternative Design Guides at

https://www.cisco.com/go/pa.

November 21, 2019

The architecture was updated to remove call service connector and replace it with Webex Device Connector enabling integration between on-premises call processing services and room systems registered as Webex Devices.
...
|---|---|
| October 22, 2021 | The architecture was updated to support Webex Edge for Devices with Webex Device Connector. Webex Teams is now Webex App with new iconography. Lastly the chapters Video Mesh and Bandwidth Management were removed and replaced with standalone Alternative Design Guides linked from the Preferred Architectures Design Guides landing page, see Alternative Design Guides at https://www.cisco.com/go/pa. |
| November 21, 2019 | The architecture was updated to remove call service connector and replace it with Webex Device Connector enabling integration between on-premises call processing services and room systems registered as Webex Devices. |
