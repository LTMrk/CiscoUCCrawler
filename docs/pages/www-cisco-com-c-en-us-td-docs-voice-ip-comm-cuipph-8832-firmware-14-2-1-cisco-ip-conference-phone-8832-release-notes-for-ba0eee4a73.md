...
Cisco IP Conference Phone 8832 Release Notes for Firmware Release 14.2(1) 3
...
These release notes support the Cisco IP Phone 8832 and 8832NR running SIP Firmware Release 14.2(1).
...
With the latest Cisco Unified Communications Manager Device Package installed, the Conference Phone 8832 can support 4096-bit RSA key.
...
The following list contains severity 1, 2, and 3 defects that are open for the Cisco IP Phone 8832 for Firmware Release 14.2(1).
...
The following list contains severity 1, 2, and 3 defects that are resolved for the Cisco IP Phone 8832 running Firmware Release 14.2(1).
...
We report open and resolved customer-found bugs of severity 1 to 3. You can find details about the listed bugs and search for other bugs by using the Cisco Bug Search Tool. For more info on using the Bug Search Tool, see Bug Search Tool Help .
