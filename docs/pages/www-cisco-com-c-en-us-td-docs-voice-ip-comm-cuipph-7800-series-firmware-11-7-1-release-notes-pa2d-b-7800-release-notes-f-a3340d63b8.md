---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-7800-series-firmware-11-7-1-release-notes-pa2d-b-7800-release-notes-f-a3340d63b8
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/7800-series/firmware/11-7-1/release_notes/pa2d_b_7800-release-notes-for-1171.html
retrieved_at: 2026-08-21T13:24:28.561984+00:00
---

Cisco IP Phone 7800 Series Release Notes for Firmware Release 11.7(1)
...
These release notes support the Cisco IP Phones 7811, 7821, 7841, and 7861 running SIP Firmware Release 11.7(1).
...
Cisco Unified Survivable Remote Site Telephony(SRST) supports IPv6. This feature requires Cisco Unified Communications Manager
                           12.0 and later.
...
Before using the Cisco Unified IP Phone Firmware Release 11.7(1) with Cisco Unified Communications Manager, you must install
...
Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=11.7(1)&sb=anfr&svr=3nH&bt=custV

Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=11.7(1)&sb=afr&svr=3nH&bt=custV

Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=11.7(1)&sb=fr&svr=3nH&bt=custV
...
| Step 1 | Perform one of the following actions: Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=11.7(1)&sb=anfr&svr=3nH&bt=custV Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=11.7(1)&sb=afr&svr=3nH&bt=custV Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=11.7(1)&sb=fr&svr=3nH&bt=custV |
|---|---|
