---
doc_id: developer-cisco-com-codeexchange-github-repo-jillesca-netconf-hello-world-ios-xr-0e2f7d16d3
source_url: https://developer.cisco.com/codeexchange/github/repo/jillesca/netconf-hello-world-ios-xr
retrieved_at: 2026-08-21T06:01:13.298677+00:00
---
...
Restrives hostname using openconfig-system.yang using the ncclient library.
...
For demo purposes, the script connects to the XR always-On sandbox , so you can test it right away.
...
Output printed. Change logger level if the output is too much.

```
❯ python hello_world.py
INFO:ncclient.transport.ssh:Connected (version 2.0, client Cisco-2.0)
INFO:ncclient.transport.ssh:Authentication (password) successful ! INFO:ncclient.transport.ssh:[host sandbox-iosxr-1.cisco.com session 0x10da0a7a0] Sending:
...
INFO:ncclient.transport.ssh:[host sandbox-iosxr-1.cisco.com session-id 4088117853] initialized: session-id=4088117853 | server_capabilities= < dict_keyiterator object at 0x10eb65f 80> INFO:ncclient.operations.rpc:[host sandbox-iosxr-1.cisco.com session-id 4088117853] Requesting ' GetConfig ' INFO:ncclient.transport.ssh:[host sandbox-iosxr-1.cisco.com session-id 4088117853] Sending:
...
INFO:ncclient.operations.rpc:[host sandbox-iosxr-1.cisco.com session-id 4088117853] Requesting ' CloseSession ' INFO:ncclient.transport.ssh:[host sandbox-iosxr-1.cisco.com session-id 4088117853] Sending:
...
INFO:root: !!! Successfully retrieved hostname from R1 !!! !!! Successfully retrieved hostname from R1 !!!
```
