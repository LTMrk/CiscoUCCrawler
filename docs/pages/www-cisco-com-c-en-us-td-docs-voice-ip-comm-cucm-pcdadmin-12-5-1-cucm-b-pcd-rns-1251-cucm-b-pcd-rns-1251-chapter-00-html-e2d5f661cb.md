...
These release notes
                           		describe new features, requirements, restrictions, and caveats for Cisco Prime
                           		Collaboration Deployment. These release notes are updated for every maintenance
                           		release.
...
- Migrate an existing
                              		  cluster of Unified Communications servers to a new 11.x cluster (this may be
...
Cisco Prime
                                       		  Collaboration Deployment does not support internationalization or languages
                                       		  other than English.
