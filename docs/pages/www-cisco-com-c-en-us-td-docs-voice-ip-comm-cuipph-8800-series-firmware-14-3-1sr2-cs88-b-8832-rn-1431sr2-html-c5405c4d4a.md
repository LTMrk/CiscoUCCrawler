---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-8800-series-firmware-14-3-1sr2-cs88-b-8832-rn-1431sr2-html-c5405c4d4a
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/8800-series/firmware/14-3-1SR2/cs88_b_8832-rn-1431sr2.html
retrieved_at: 2026-08-17T01:12:16.362070+00:00
---

Cisco IP Conference Phone 8832 Release Notes for Firmware Release 14.3(1)SR2
...
These release notes support the Cisco IP Conference Phone 8832 running SIP Firmware Release 14.3(1)SR2.
...
In the Latest Releases folder, choose 14.3(1)SR2 .

Step 4

Select the firmware file, click the Download or Add to cart button, and follow the prompts.

The firmware filename is cmterm-8832-sip.14-3-1-0201-246.k4.cop.sha512.
...
The firmware filename is cmterm-8832.14-3-1-0201-246.zip.
...
CSCwm91827: Vulnerabilities in linux-kernel 5.4.124 CVE-2022-3176

CSCwm91836: CVE-2023-2248 Vulnerability in Linux Kernel 5.4.124
...
| Step 3 | In the Latest Releases folder, choose 14.3(1)SR2 . |
| Step 4 | Select the firmware file, click the Download or Add to cart button, and follow the prompts. The firmware filename is cmterm-8832-sip.14-3-1-0201-246.k4.cop.sha512. Note If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . | Note | If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . |
...
| Step 2 | Choose Session Initiation Protocol (SIP) Software . |
| Step 3 | In the Latest Releases folder, choose 14.3(1)SR2 . |
| Step 4 | Select the firmware file, click the Download or Add to Cart button, and follow the prompts. The firmware filename is cmterm-8832.14-3-1-0201-246.zip. |
