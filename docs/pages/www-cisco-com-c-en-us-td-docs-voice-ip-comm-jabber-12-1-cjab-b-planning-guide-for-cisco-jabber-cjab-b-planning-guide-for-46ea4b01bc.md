---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-jabber-12-1-cjab-b-planning-guide-for-cisco-jabber-cjab-b-planning-guide-for-46ea4b01bc
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/jabber/12_1/cjab_b_planning-guide-for-cisco-jabber/cjab_b_planning-guide-for-cisco-jabber_chapter_0110.html
retrieved_at: 2026-08-21T19:01:57.233373+00:00
---
...
Cisco Jabber supports UDS using the following Cisco Unified
...
Cisco Jabber for all clients retrieves the fully qualified DNS domain from the USERDNSDOMAIN environment variable on the client workstation.
...
If the USERDNSDOMAIN environment variable resolves to a child domain, you can use one of the following options to enable Cisco Jabber for all clients to connect to a service in the parent domain:
...
Configure your DNS server to direct the client to a server that can access all users in the organization when Cisco Jabber
                                       for all clients requests a Global Catalog or LDAP directory server.

Configure Cisco Jabber for all clients to use the FQDN of the domain controller.

```
<PrimaryServerName> parent-domain-fqdn </PrimaryServerName>
```

#### Contact Source Server Discovery

Cisco Jabber can automatically discover and connect to the contact source server if:
...
In Jabber 12.7 and earlier with this Unified CM release or later, we can’t use these credentials from the Service Profile
                                 ...
                                 releases with the upgraded Unified CM, provide the LDAP credentials through the jabber-config.xml file, as detailed here.
...
| Contact Source Server | SRV Record |
|---|---|
| Global Catalog | _gc._tcp. domain.com |
| Domain Controller LDAP-based directory servers | _ldap._tcp. domain.com |
