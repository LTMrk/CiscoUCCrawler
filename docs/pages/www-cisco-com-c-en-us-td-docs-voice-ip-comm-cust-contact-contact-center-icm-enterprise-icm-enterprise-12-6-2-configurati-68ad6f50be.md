---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-12-6-2-configurati-68ad6f50be
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_12_6_2/configuration/guide/ucce_b_security-guide-for-cisco-unified-icm_contact_center_-enterprise_release_1262/ucce_m_general-antivirus-guidelines_12_6_1.html
retrieved_at: 2026-08-22T00:21:03.530733+00:00
---
...
Often, the default AV configuration settings increase CPU load and memory and disk usage, adversely affecting software performance.
                                       ...
                                       for using AV software with Unified ICM/Unified CCE.
...
## Unified ICM/Unified
                        	 CCE Maintenance Parameters

A few parameters control the application activity at
                              		  specific times. Before you schedule AV
                              		  software activity on Unified
                                 			 ICM / Unified CCE Servers, ensure that Antivirus software configuration settings do not
                              		  schedule "Daily Scans," "Automatic DAT
                                 			 Updates," and "Automatic Product
                                 			 Upgrades" during critical times.
