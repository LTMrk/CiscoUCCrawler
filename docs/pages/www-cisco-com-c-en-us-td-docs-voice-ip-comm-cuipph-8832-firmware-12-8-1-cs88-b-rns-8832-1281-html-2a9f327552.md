...
These release notes support the Cisco IP Conference Phone 8832 running SIP Firmware Release 12.8(1).
...
The firmware filename is cmterm-8832-sip.12-8-1-0001-455.k3.cop.sgn
...
cmterm-8832.12-8-1-0001-455.zip
...
CSCvt22554 8832 phone reboot intermittently due to MALI GPU timeout.
...
| Step 4 | In the Latest Releases folder, choose 12.8(1) . |
