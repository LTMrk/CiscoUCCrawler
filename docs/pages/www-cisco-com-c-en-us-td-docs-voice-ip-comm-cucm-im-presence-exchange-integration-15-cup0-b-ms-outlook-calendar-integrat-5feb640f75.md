---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-im-presence-exchange-integration-15-cup0-b-ms-outlook-calendar-integrat-5feb640f75
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/im_presence/exchange_integration/15/cup0_b_ms-outlook-calendar-integration-15/cup0_b_ms-outlook-calender-integration-1251_chapter_011.html
retrieved_at: 2026-08-16T16:15:21.359394+00:00
---
...
## Microsoft Exchange 2016 and 2019 Configuration over Exchange Web Services

Follow these tasks when configuring access to mailboxes on Exchange 2016 and 2019 servers.

### Before You
                              		  Begin

Before you use Exchange Web Services (EWS) to integrate Exchange 2016 and 2019 servers with IM and Presence Service , ensure that you configure the throttle policy parameter values on the Exchange Server. These are the values that are required
                              for the EWS calendaring integration to work with IM and Presence Service .

These are the commands and settings for Exchange Server 2016 and 2019.
...
These are the commands and settings for Exchange Server 2010. If you are using Exchange Server 2013, follow the steps in Set Exchange Impersonation Permissions for Specific Users or Groups for Exchange 2016 or 2019 .
...
These are the commands for Exchange Server 2010. If you are using Exchange Server 2013, follow the steps in Verify Permissions on the Microsoft Exchange 2016 or 2019 Accounts .
...
| Step 5 | Verify that
                                          			 the ThrottlingPolicy parameters match what is defined in 
                                          			 the below table by running this command in the
                                          			 EMS. Get-ThrottlingPolicy -Identity Policy_Name \| findstr ^EWS |
