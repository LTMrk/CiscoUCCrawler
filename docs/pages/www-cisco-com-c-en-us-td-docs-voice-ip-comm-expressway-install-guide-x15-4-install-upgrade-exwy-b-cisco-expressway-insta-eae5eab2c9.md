---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-expressway-install-guide-x15-4-install-upgrade-exwy-b-cisco-expressway-insta-eae5eab2c9
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/expressway/install_guide/X15-4/install-upgrade/exwy_b_cisco-expressway-install-and-upgrade-guide-x154/exwy_m_additional-information.html
retrieved_at: 2026-08-16T22:07:33.189749+00:00
---
...
Take a backup of the smaller (or the larger for downgrade) VM configuration. Use the Expressway’s backup function, not the
                                       hypervisor backup or VMware snapshot function.
...
## Migrating the VM between ESXi Hosts (use VMware VMotion)
...
We do not support VMware High Availability. We recommend clustering for resilience. If you need to move virtual Expressway,
                              you can use VMotion.
...
| Step 1 | Take a backup of the smaller (or the larger for downgrade) VM configuration. Use the Expressway’s backup function, not the
                                       hypervisor backup or VMware snapshot function. |
|---|---|
