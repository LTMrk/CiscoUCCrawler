---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-intelligence-suite-intelligence-suite-1205-maint-09b9ee8e1e
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/intelligence_suite/intelligence_suite_1205/maintain_and_operate/guide/cuic_b_admin-console-user-guide-1205/cuic_b_admin-console-user-guide-1205_chapter_011.html
retrieved_at: 2026-08-21T04:37:13.110490+00:00
---
...
## Change IP Address, Hostname, and Domain Name

Change the domain name from the Command Line Interface in the CUIC Live Data (LD)/Identity Service (IdS) server. Refer to
                              the Administration Guide for Cisco Unified Communications Manager for more details.

After changing the domain name, you should reset all the LD commands. Perform the following steps to change the domain name
                              in the CUIC LD/IdS server for UCCE 2000 Model:

Step 1

Remove the CUIC LD/IdS from the UCCE Inventory page and add the CUIC LD/IdS in the UCCE Inventory page again.

Step 2

Reset the LD AW access from the CUIC LD/IdS server.

Step 3

Set the LD CUIC-data source from the CUIC LD/IdS server.
...
| Step 1 | Remove the CUIC LD/IdS from the UCCE Inventory page and add the CUIC LD/IdS in the UCCE Inventory page again. |
|---|---|
| Step 2 | Reset the LD AW access from the CUIC LD/IdS server. |
| Step 3 | Set the LD CUIC-data source from the CUIC LD/IdS server. |