---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-cli-ref-15-cucm-b-cli-reference-guide-release-15-cucm-m-show-commands-h-c907d1b639
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/cli_ref/15/cucm_b_cli_reference_guide_release_15/cucm_m_show-commands.html
retrieved_at: 2026-08-16T23:53:16.402243+00:00
---
...
This command displays Certificate Sign Request contents.
...
```
No Certificate Sign Request available for display
```
...
## show http min-version

This command shows the minimum configured version for all the inbound and outbound HTTP requests.
