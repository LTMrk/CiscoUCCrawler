---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cer-aft-1-1-english-sbc-pacbell-user-guide-user-sbc-aftinstall-html-fd0d4e5c62
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cer/aft/1_1/english/sbc_pacbell/user/guide/user_sbc/AFTinstall.html
retrieved_at: 2026-08-21T15:51:24.022536+00:00
---
...
• Cisco Emergency Responder (Cisco ER) 1.1 or later

• Microsoft Windows 2000

The ALI Formatting Tool (AFT) supports all hardware platforms supported by Cisco ER. Refer to the Cisco Emergency Responder Administration Guide for Cisco ER-supported Cisco Media Convergence Server (MCS) hardware platforms.
...
For example, to select the SBC Pacific Bell AFT, click on: CER-aft-SBC_PacBell.1-1-1.exe
...
For example, for SBC Pacific Bell, go to:

Start > Programs > Cisco Emergency Responder > AFT > SBC PacBell (NENA 2.0)
