---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-jabber-12-8-cjab-b-planning-guide-cisco-jabber-128-cjab-m-planning-requireme-de439caaa4
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/jabber/12_8/cjab_b_planning-guide-cisco-jabber-128/cjab_m_planning-requirements-128.html
retrieved_at: 2026-08-21T19:06:14.730970+00:00
---
...
The following Apple devices are supported for Cisco Jabber for iPhone and iPad on iOS iOS 13.x and iPadOS. The devices that are not upgraded to these versions are not supported.
...
Cisco Jabber supports only audio mode with an MC40 device. Jabber doesn’t support launching Webex Meetings from an MC40 device.
...
Contact your administrator to set your Jabber phone service to be secure. Jabber plays ringback tone and busy tone at 24 kHz.
...
In the Samsung devices with Android OS 5.x or later, enable the auto-run option for Jabber.
...
Sony devices with Android OS 6.0 can’t play voicemail in Jabber.
...
TC70 devices might sometimes have issues connecting to a Wi-Fi network configured over DHCP.

In TC70, the default value of Keep wifi on during sleep is Off , set it to Always On for use with Jabber.
...
If the device's Android OS is 5.0.2 or later and kernel version is 3.10.49 or later, then the device can support nonsecure
                                             mode.
...
|---|---|---|---|
| BlackBerry | Priv | 5.1 | If you remove Jabber from the recently viewed apps list and you keep the device idle for some time, then Jabber becomes inactive. |
...
| V10 | 5.0 |  |
| V30 | 8.0 |  |
| Motorola | MC40 | 5.0 | Cisco Jabber supports only audio mode with an MC40 device. Jabber doesn’t support launching Webex Meetings from an MC40 device. |
|  | Moto G4 | 5.0 |  |
|  | Moto G5 | 7.0 |  |
|  | Moto G6 | 8.0 |  |
|  | Moto X (1st Gen.) | 5.0 |  |
...
| Z3+/Z4 | 5.0.2 | Video call is unstable on Sony Z3+/Z4. Try disabling your self-video for a video call. Otherwise, make a voice call only. |
| Z4 TAB | 5.0 |  |
| Z5 Premium and Z5 | 5.0.2 |  |
| ZR/A | 5.0 | Sony devices with Android OS 6.0 can’t play voicemail in Jabber. |
| Xiaomi | 4C | 5.1 | Only the 32-bit version runs on these devices. |
| MAX | 5.1 |  |
| Mi 4 | 5.0 |  |
| Mi 5 | 6.0 |  |
| Mi 5s | 7.0 |  |
...
| Mi 9 | 9.0 |  |
| Pocophone | 8.0 |  |
| Mi Note | 5.0 | Only the 32-bit version runs on these devices. |
| Mi Note 2 | 7.0 |  |
| Mi Pad 2 | 5.1 |  |
| Mi MIX 2 | 8.0 |  |
| Mi A1 | 8.0 |  |
...
| Zebra | TC70 | 5.0 | TC70 devices might sometimes have issues connecting to a Wi-Fi network configured over DHCP. In TC70, the default value of Keep wifi on during sleep is Off , set it to Always On for use with Jabber. |
| TC75X | 6.0 |  |
| TC51 | 6.0 |  |
...
| Sony Xperia M2 | Android OS 5.0 or later and kernel version earlier than 3.10.49. If the device's Android OS is 5.0.2 or later and kernel version is 3.10.49 or later, then the device can support nonsecure
                                             mode. |
| Sony Xperia Z1 |
| Sony Xperia ZR/A |
| Sony Xperia Z2 |
