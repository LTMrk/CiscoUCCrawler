---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-jvdi-12-1-windows-deploy-jvdi-b-deployment-installation-jvdi-windows-12-1-jv-6de90237f2
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/jvdi/12_1/windows/deploy/jvdi_b_deployment-installation-jvdi-windows-12-1/jvdi_b_deployment-installation-jvdi-windows-12-1_chapter_010.html
retrieved_at: 2026-08-22T00:38:36.311463+00:00
---
...
If you are installing a 32–bit version of Cisco Jabber Softphone for VDI, see VMware Installation—Required Setting .
...
The JVDI Client is a 32–bit application. When you install VMware Horizon View Client, choose Customize Installation and configure the following settings:
...
Use Microsoft Orca to set the language code if you plan to use Group Policy to deploy Cisco JVDI Client . Microsoft Orca is available as part of the Microsoft Windows SDK for Windows 7 and .NET Framework 4 that you can download
...
Browse to the location of Cisco JVDI Client .

Select Cisco JVDI Client , and then click Open .
...
Select a location to which to save the modified Cisco JVDI Client file.
...
| Step 3 | Set up Citrix or VMware access to the HVDs. Important Configure VMware to use PCoIP. If you are installing a 32–bit version of Cisco Jabber Softphone for VDI, see VMware Installation—Required Setting . | Important | Configure VMware to use PCoIP. |
...
| Important | The JVDI Client is a 32–bit application. When you install VMware Horizon View Client, choose Customize Installation and configure the following settings: Uncheck the Virtualization Pack for Skype for Business check box. Check the Install 32-bit Core remote Experience on this 64-bit machine check box. |
|---|---|
