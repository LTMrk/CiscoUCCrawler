---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-12-6-1-reference-g-8c0b813669
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_12_6_1/reference/guide/ucce_b_cti-servermessage-reference-guide-for-1261/ucce_b_cti-servermessagereferenceguideprotocolversion24-for-1261_preface_00.html
retrieved_at: 2026-08-16T19:46:32.707103+00:00
---
...
This manual describes the Customer Telephony Integration (CTI)
                              Server message interface between Unified Contact Center Enterprise (Unified
                              CCE) and application programs.

## Audience

This manual is for system integrators and programmers who want to integrate CTI client applications with Unified CCE.
...
| Added new messages for graceful shutdown | STANDBY_ACTIVE_EVENT_MSG ACTIVE_MAINTENANCE_REQ_MSG ACTIVE_MAINTENANCE_RESP_MSG ACTIVE_MAINTENANCE_EVENT_MSG STOPPING_REQUESTS_TO_THIS_SIDE_IND |
| New and updated messages for Agent Assist | CONFIG_AGENT_SERVICE_EVENT SET_AGENT_SERVICE_DATA_REQ AGENT_PRE_CALL_EVENT SNAPSHOT_CALL_CONF |
