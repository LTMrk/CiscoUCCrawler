---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-im-presence-configadminguide-14-su2-cup0-b-config-and-admin-guide-14su2-320fd2d120
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/im_presence/configAdminGuide/14_su2/cup0_b_config-and-admin-guide-14su2/cup0_b_config-and-admin-guide-1401_chapter_0100001.html
retrieved_at: 2026-08-16T16:19:02.562490+00:00
---
...
Chapter: Cisco Unified
	 Communications Manager TCP and UDP Port Usage
...
This chapter
                        		provides a list of the TCP and UDP ports that Cisco Unified
                           		  Communications Manager uses for intracluster connections and for
                        		communication with external applications or devices. You will also find
                        		important information for the configuration of firewalls, Access Control Lists
                        		(ACLs), and quality of service (QoS) on a network when an IP Communications
...
Port used by the server that handles DNA initialization. JNIWrapper functions respond to requests that the DNA Java service
                                             sends.
...
Cisco recommends that Cisco Unified Communications Manager not act as a DNS server and that all IP telephony applications
                                                         and endpoints use static IP addresses instead of hostnames.
...
| Unified Communications Manager | Certificate Manager | 7070 / TCP | Certificate Manager service |
...
| Unified Communications Manager [Dialed Number Analyzer (DNA) initializing server] | JNIWrapper server | 30000 / TCP | Dialed Number Analyzer (DNA) Port used by the server that handles DNA initialization. JNIWrapper functions respond to requests that the DNA Java service
                                             sends. |
...
| Endpoint | Unified Communications ManagerDNS Server) | Ephemeral / UDP | Cisco Unified Communications Manager acting as a DNS server or DNS client Note Cisco recommends that Cisco Unified Communications Manager not act as a DNS server and that all IP telephony applications
                                                         and endpoints use static IP addresses instead of hostnames. | Note | Cisco recommends that Cisco Unified Communications Manager not act as a DNS server and that all IP telephony applications
                                                         and endpoints use static IP addresses instead of hostnames. |
| Note | Cisco recommends that Cisco Unified Communications Manager not act as a DNS server and that all IP telephony applications
                                                         and endpoints use static IP addresses instead of hostnames. |
...
|  |  | 9560 | Used by Local Push Notification Service (LPNS). |
...
| Browser or CLI | Unified Communications Manager | 2355, 2356 / TCP | Log audit events from the CLI and Web applications |
...
| iPhone/iPad (Webex App) |  | 9560/Secure WebSocket | Webex App uses this port number for the LPNS feature. |
