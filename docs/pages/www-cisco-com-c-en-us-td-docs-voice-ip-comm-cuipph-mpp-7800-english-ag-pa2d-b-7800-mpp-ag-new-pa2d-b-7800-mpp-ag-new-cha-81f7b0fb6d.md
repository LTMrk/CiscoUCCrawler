...
The Cisco IP Phone 7811 Multiplatform Phones doesn't have programmable feature buttons.
...
Specifies how the BLF entries are displayed on the line keys . The options are: Name , Ext (extention number), and Both .
...
| Note | The Cisco IP Phone 7811 Multiplatform Phones doesn't have programmable feature buttons. |
|---|---|
...
| Note | If the Direct PLK Configuration feature is disabled, you must disable the extension to configure speed dial on the line key.
                                                      If the feature is enabled, you can skip this step. For details, see Enable Direct PLK Configuration . |
| Step 4 | In the Extended Function parameter, enter a string in this format: You can also configure this parameter in the phone configuration file (cfg.xml). The parameter is line-specific. Enter a string
...
| BLF Ringing LED—The monitored line is ringing. | Fast blinking red ON OFF Slow Blink | Blinking amber |
