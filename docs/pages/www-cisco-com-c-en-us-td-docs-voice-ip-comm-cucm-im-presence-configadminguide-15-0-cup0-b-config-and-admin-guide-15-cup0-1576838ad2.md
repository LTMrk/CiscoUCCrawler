---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-im-presence-configadminguide-15-0-cup0-b-config-and-admin-guide-15-cup0-1576838ad2
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/im_presence/configAdminGuide/15_0/cup0_b_config-and-admin-guide-15/cup0_b_config-and-admin-guide-1401_chapter_01011.html
retrieved_at: 2026-08-16T15:57:59.475097+00:00
---
...
Configure TLS Signature Algorithm for SIP Proxy and XMPP Enterprise Parameter

Configure the TLS Signature Algorithm for SIP Proxy and XMPP enterprise parameter.
...
Use this procedure to specify the priority order of the signature algorithm for the outbound TLS connection of SIP Proxy and
                                 XMPP. The TLS Signature Algorithm for SIP Proxy and XMPP parameter is introduced in Release 15SU2.

This enterprise parameter is specific to IM and Presence Service only.
...
From Cisco Unified CM IM and Presence Administration, choose System > Enterprise Parameters .

Step 2

In the Enterprise Parameters Configuration window, choose a value from the drop-down list for the TLS Signature Algorithm for SIP Proxy and XMPP enterprise parameter.

RSA Preferred —When you select this parameter, the signature algorithm will be in the order: RSA-PSS+SHA256:RSA-PSS+SHA384:RSA+SHA384:RSA+SHA512:ECDSA+SHA256:ECDSA+SHA384:ECDSA+SHA512:ECDSA+SHA224
                                                .

ECDSA Preferred —When you select this parameter, the signature algorithm will be in the order: ECDSA+SHA256:ECDSA+SHA384:ECDSA+SHA512:ECDSA+SHA224:RSA-PSS+SHA256:RSA-PSS+SHA384:RSA+SHA384:RSA+SHA512.
...
| Step 5 | Configure TLS Signature Algorithm for SIP Proxy and XMPP Enterprise Parameter | Configure the TLS Signature Algorithm for SIP Proxy and XMPP enterprise parameter. |
| Step 6 | FIPS Mode | If you want your deployment to be FIPS-compliant, you can enable FIPS mode. For added security, you can also enable Enhanced
                                          Security mode and Common Compliance mode. |
...
| Note | This enterprise parameter is specific to IM and Presence Service only. |
|---|---|

| Important | This section is applicable from Release 15SU2 onwards. |
|---|---|

| Step 1 | From Cisco Unified CM IM and Presence Administration, choose System > Enterprise Parameters . |
|---|---|
| Step 2 | In the Enterprise Parameters Configuration window, choose a value from the drop-down list for the TLS Signature Algorithm for SIP Proxy and XMPP enterprise parameter. RSA Preferred —When you select this parameter, the signature algorithm will be in the order: RSA-PSS+SHA256:RSA-PSS+SHA384:RSA+SHA384:RSA+SHA512:ECDSA+SHA256:ECDSA+SHA384:ECDSA+SHA512:ECDSA+SHA224
                                                . ECDSA Preferred —When you select this parameter, the signature algorithm will be in the order: ECDSA+SHA256:ECDSA+SHA384:ECDSA+SHA512:ECDSA+SHA224:RSA-PSS+SHA256:RSA-PSS+SHA384:RSA+SHA384:RSA+SHA512. |
| Step 3 | Click Save . Important For the parameter changes to take effect, restart Cisco Config Agent, Cisco XCP Config Manager, Cisco XCP Router and its dependent
                                                      services like Cisco XCP Connection Manager, Cisco XCP SIP Federation Connection Manager, Cisco XCP Web Connection Manager,
                                                      Cisco XCP File Transfer Manager, Cisco XCP Directory Service, Cisco XCP Message Archiver, Cisco XCP XMPP Federation Connection
                                                      Manager and Cisco XCP Text Conference Manager on Cisco Unified Communications Manager IM and Presence Service. | Important | For the parameter changes to take effect, restart Cisco Config Agent, Cisco XCP Config Manager, Cisco XCP Router and its dependent
                                                      services like Cisco XCP Connection Manager, Cisco XCP SIP Federation Connection Manager, Cisco XCP Web Connection Manager,
                                                      Cisco XCP File Transfer Manager, Cisco XCP Directory Service, Cisco XCP Message Archiver, Cisco XCP XMPP Federation Connection
                                                      Manager and Cisco XCP Text Conference Manager on Cisco Unified Communications Manager IM and Presence Service. |
| Important | For the parameter changes to take effect, restart Cisco Config Agent, Cisco XCP Config Manager, Cisco XCP Router and its dependent
                                                      services like Cisco XCP Connection Manager, Cisco XCP SIP Federation Connection Manager, Cisco XCP Web Connection Manager,
                                                      Cisco XCP File Transfer Manager, Cisco XCP Directory Service, Cisco XCP Message Archiver, Cisco XCP XMPP Federation Connection
                                                      Manager and Cisco XCP Text Conference Manager on Cisco Unified Communications Manager IM and Presence Service. |
