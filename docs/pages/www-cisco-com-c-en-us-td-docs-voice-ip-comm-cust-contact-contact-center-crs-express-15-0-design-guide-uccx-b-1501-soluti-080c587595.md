---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-crs-express-15-0-design-guide-uccx-b-1501-soluti-080c587595
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/crs/express_15_0/design/guide/uccx_b_1501_solution-design-guide/uccx_m_1501_unified-ccx-solution-design-considerations.html
retrieved_at: 2026-08-16T21:04:39.271306+00:00
---
...
IVR ports — Full-featured IVR ports available with the Cisco Unified IP IVR and Unified CCX Flex Premium product.
...
If you want additional supporting features, such as automatic speech recognition (ASR), text-to-speech (TTS), email notification,
                                    web server or client functionality, and database operations, you only need to purchase the Flex Premium package. Additional seats may also be purchased for IVR port licenses if the number of port licenses that come with
                                    the seat licenses is not sufficient.
...
| Service | Unified CCX Flex Premium | Unified CCX Flex Standard |
|---|---|---|
| Cisco Finesse REST APIs | Available | Available |

| Service | Unified CCX Flex Premium | Unified CCX Flex Standard | Unified IP IVR |
|---|---|---|---|
