---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-8821-firmware-11-0-3-w881-b-cisco-8821-rns-110003-html-c0fc8903f8
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/8821/firmware/11-0-3/w881_b_cisco-8821-rns-110003.html
retrieved_at: 2026-08-21T13:35:47.532071+00:00
---
...
Users adjust the filter in the Settings app, with the Phone settings > Sounds > Background noise filter menu. User scan set the filter to Off (default), High, Medium, and Low.
...
Cisco IP Wireless Phone 8821 and 8821-EX Administration Guide for Cisco Unified Communications Manager

#### Power Saving Enhancements

The talk time that you can get from the phone battery is improved.
...
United Arab Emirates (AE)—Adds channels 36-48, 52-64, 100-116,
132-140
...
Argentina (AR)—Adds channels 1-11 and 36-48, 52-64, 100-116,
132-140, 149-165

Malaysia (MY)—Adds channels 1-13 and 149-165

Oman (OM)—Adds channels 1-13 and 36-48, 52-64, 100-116,
132-140
...
With Firmware Release 11.0(3), a supported USB
to Ethernet dongle attached to the desktop charger can be connected
to a switch port with a Voice VLAN configuration.

Prior to Firmware Release 11.0(3), the switch
port configuration could not contain a Voice VLAN because only the
native VLAN was supported.

The USB to Ethernet dongle is for provisioning
purposes only and is not intended to convert the wireless phone to a fully-functional
wired phone.
...
Firmware file: cmterm-8821-sip.11-0-3-6.k3.cop.sgn
...
The file to download is cmterm-8821-sip.11-0-3-6.zip
...
| Cisco Unified Survivable Remote Site Telephony | 10.5 | 11.0, 11.5,  and later |
| Cisco Wireless LAN Controller | 8.0.121.0 | 8.0.140.0, 8.2.130.0, and later |
| Cisco IOS Access Points (Autonomous) | 12.4(21a)JY | 12.4(25d)JA2, 15.2(4)JB6,
15.3(3)JD |
| Cisco Meraki |  |  |
...
| Step 5 | In the Latest
			 Releases folder, choose 11.0(3) . |
| Step 6 | Select the
			 firmware file, click the Download or Add to
				cart button, and follow the prompts. Firmware file: cmterm-8821-sip.11-0-3-6.k3.cop.sgn Note If you added
				  the firmware file to the cart, click the Download Cart link when you are ready to download
...
| Step 4 | Choose 11.0(3) in the Latest Releases folder. |
| Step 5 | Click Download or Add to cart and follow the prompts. The file to download is cmterm-8821-sip.11-0-3-6.zip |
