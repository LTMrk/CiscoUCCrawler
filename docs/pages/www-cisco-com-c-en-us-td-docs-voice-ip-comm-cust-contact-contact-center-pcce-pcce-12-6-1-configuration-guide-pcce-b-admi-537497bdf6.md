---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-pcce-pcce-12-6-1-configuration-guide-pcce-b-admi-537497bdf6
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/pcce/pcce_12_6_1/configuration/guide/pcce_b_admin_configuration_guide_12_6_1/pcce_b_admin_configuration_guide_12_5_2_preface_00.html
retrieved_at: 2026-08-21T16:51:24.283401+00:00
---
...
Updated topics for Agent Answers
...
| Change | See | Date |
|---|---|---|
| Initial Release of Document for Release 12.6(1) | Mar, 2021 |
| OpenJDK Migration | Import CA Certificate into AW Machines |
|  |
| Change Java Truststore Password |
| Edge Chromium (Microsoft Edge) updates | Set Up CA Certificate for Chrome and Edge Chromium (Microsoft Edge) Browsers Accept Security Certificates |
| New chapters/topics have been added for Contact Center AI | Enable or Disable Contact Center AI Services for Multiple Agents |
| Bulk Contact Center AI Services Content File Contact Center AI Configuration |
| Updated topics for Agent Answers | Add and Maintain Agents |
| Manage Bulk Jobs Add and Maintain Call Types |
