---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-12-6-2-installatio-7b7912f019
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_12_6_2/installation/guide/ucce_b_install_upgrade_guide_1262/ucce_b_12_6_1-install_upgrade_guide_chapter_0111.html
retrieved_at: 2026-08-16T19:59:52.520291+00:00
---
...
If you are using a custom SQL Server port for CCE databases and/or external database for database lookup, and need to perform
                                       Common Ground upgrade, you must revert to default port (1433). For more information, see the following guides:
...
Common Ground Upgrade is not supported if the platform upgrade from Windows Server 2016 and SQL Server 2017 to Windows Server
                                       2019 and SQL Server 2019 is planned as part of upgrade process. Technology Refresh Upgrade is the supported upgrade option
...
EDMT also requires Microsoft® ODBC Driver 17 for SQL Server® and Visual C++ Redistributable for Visual Studio 2022. The latest version of these packages can be downloaded
...
In the Compatible with field, select a 6.7 or later ESXi version.
...
To apply the Unified ICM 12.6(2) Maintenance Release, click Browse and navigate to the Maintenance Release software. Click Next . You can also proceed with the installation of  Unified ICM 12.5(1) without selecting the Unified ICM 12.6(2) installer in this step. After installing Unified ICM 12.5(1), double-click the Unified ICM 12.6(2) installer, and proceed from step 20.
...
You can upgrade from Unified ICM 12.5(1) to Unified ICM 12.6(2) by double-clicking the Unified ICM 12.6(2) installer, and proceeding from Step 20.
...
To apply the Unified ICM 12.6(2) Maintenance Release, click Browse and navigate to the Maintenance Release software. Click Next . You can also proceed with the installation of Unified ICM 12.5(1) without selecting the Unified ICM 12.6(2) installer in this step. After installing Unified ICM 12.5(1), double-click the Unified ICM 12.6(2) installer, and proceed from step 7.
...
You can upgrade from Unified ICM 12.5(1) to Unified ICM 12.6(2) by double-clicking the Unified ICM 12.6(2) installer, and proceeding from Step 7.
...
To apply the Unified ICM 12.6(2) Maintenance Release, click Browse and navigate to the Maintenance Release software. Click Next . You can also proceed with the installation of Unified ICM 12.5(1) without selecting the Unified ICM 12.6(2) installer in this step. After installing Unified ICM 12.5(1), double-click the Unified ICM 12.6(2) installer, and proceed from step 11.
...
You can upgrade from Unified ICM version 12.5(1) to Unified ICM 12.6(2) by double-clicking the Unified ICM 12.6(2) installer, and proceeding from Step 11.
...
To apply the Unified ICM 12.6(2) Maintenance Release, click Browse and navigate to the Maintenance Release software. Click Next . You can also proceed with the installation of Administration Client 12.5(1) without selecting the Unified ICM 12.6(2) installer in this step. After installing Unified ICM 12.5(1), double-click the Unified ICM 12.6(2) installer, and proceed from step 6.
...
Log in to your system using domain credentials with administrative privileges. The Unified CCE Release 12.6(2) installation wizard to launches. Click Next to proceed.
...
To apply the Unified ICM 12.6(2) Maintenance Release, click Browse and navigate to the Maintenance Release software. Click Next . You can also proceed with the installation of Unified ICM 12.5(1) without selecting the Unified ICM 12.6(2) installer in this step. After installing Unified ICM 12.5(1), double-click the Unified ICM 12.6(2) installer, and proceed with the installation.
...
| Identity Service (IdS)/Single Sign-On(SSO) | SSO is an optional feature and exchanges authentication and authorization details between an identity provider (IdP) and an
                                          identity service (IdS). Note Cisco IdS 12.6(2) upgrade requires all SSO clients to log out from SSO, before any of the upgraded nodes is brought online.
                                                      To avoid this requirement, it's recommended that you install 12.6(2) ES02 on the upgraded node and wait for the access token
                                                      to expire before commencing the secondary node upgrade. Without installing 12.6(2) ES02, graceful shutdown feature will not
                                                      be available for Cisco IdS 12.6(2) upgrade. You can view the duration of access token expiry in the IdS administration portal
                                                      ...
                                                      upgraded to 12.6(2). For more information, see Upgrade Flowcharts https://www.cisco.com/c/en/us/support/customer-collaboration/unified-intelligence-center/products-installation-guides-list.html | Note | Cisco IdS 12.6(2) upgrade requires all SSO clients to log out from SSO, before any of the upgraded nodes is brought online.
                                                      To avoid this requirement, it's recommended that you install 12.6(2) ES02 on the upgraded node and wait for the access token
                                                      to expire before commencing the secondary node upgrade. Without installing 12.6(2) ES02, graceful shutdown feature will not
                                                      be available for Cisco IdS 12.6(2) upgrade. You can view the duration of access token expiry in the IdS administration portal
                                                      under Settings > Security > Tokens > Access Token Expiry . Deployments using VPN-less access to Finesse desktop should also upgrade the reverse proxy to 12.6(2) before Cisco IdS is
                                                      upgraded to 12.6(2). |
| Note | Cisco IdS 12.6(2) upgrade requires all SSO clients to log out from SSO, before any of the upgraded nodes is brought online.
                                                      To avoid this requirement, it's recommended that you install 12.6(2) ES02 on the upgraded node and wait for the access token
                                                      to expire before commencing the secondary node upgrade. Without installing 12.6(2) ES02, graceful shutdown feature will not
                                                      be available for Cisco IdS 12.6(2) upgrade. You can view the duration of access token expiry in the IdS administration portal
                                                      under Settings > Security > Tokens > Access Token Expiry . Deployments using VPN-less access to Finesse desktop should also upgrade the reverse proxy to 12.6(2) before Cisco IdS is
...
| Note To perform upgrade from CCE 12.5(x) to CCE 12.6(2) or from CCE 12.6(1) to CCE 12.6(2), refer Upgrade CCE Minor/Maintenance Release Software . | Note | To perform upgrade from CCE 12.5(x) to CCE 12.6(2) or from CCE 12.6(1) to CCE 12.6(2), refer Upgrade CCE Minor/Maintenance Release Software . |
| Note | To perform upgrade from CCE 12.5(x) to CCE 12.6(2) or from CCE 12.6(1) to CCE 12.6(2), refer Upgrade CCE Minor/Maintenance Release Software . |
...
| Step 14 | To apply the Unified ICM 12.6(2) Maintenance Release, click Browse and navigate to the Maintenance Release software. Click Next . You can also proceed with the installation of  Unified ICM 12.5(1) without selecting the Unified ICM 12.6(2) installer in this step. After installing Unified ICM 12.5(1), double-click the Unified ICM 12.6(2) installer, and proceed from step 20. |
...
| Step 19 | Log in to your system using domain credentials with administrative
                                          					privileges. |
| Step 20 | Wait for the Unified CCE 12.6(2) installation wizard to launch. Click Next to proceed. |
...
| Step 23 | Select the radio button to restart the system and click Finish . Note You can upgrade from Unified ICM 12.5(1) to Unified ICM 12.6(2) by double-clicking the Unified ICM 12.6(2) installer, and proceeding from Step 20. | Note | You can upgrade from Unified ICM 12.5(1) to Unified ICM 12.6(2) by double-clicking the Unified ICM 12.6(2) installer, and proceeding from Step 20. |
| Note | You can upgrade from Unified ICM 12.5(1) to Unified ICM 12.6(2) by double-clicking the Unified ICM 12.6(2) installer, and proceeding from Step 20. |
...
|---|---|
| Step 2 | To apply the Unified ICM 12.6(2) Maintenance Release, click Browse and navigate to the Maintenance Release software. Click Next . You can also proceed with the installation of Unified ICM 12.5(1) without selecting the Unified ICM 12.6(2) installer in this step. After installing Unified ICM 12.5(1), double-click the Unified ICM 12.6(2) installer, and proceed from step 7. |
...
| Step 6 | Log in to your system using domain credentials with administrative
                                          privileges. |
| Step 7 | Wait for the Unified CCE 12.6(2) installation wizard to launch. Click Next to proceed. |
...
| Step 10 | Select the radio button to restart the system and click Finish . Note You can upgrade from Unified ICM 12.5(1) to Unified ICM 12.6(2) by double-clicking the Unified ICM 12.6(2) installer, and proceeding from Step 7. | Note | You can upgrade from Unified ICM 12.5(1) to Unified ICM 12.6(2) by double-clicking the Unified ICM 12.6(2) installer, and proceeding from Step 7. |
| Note | You can upgrade from Unified ICM 12.5(1) to Unified ICM 12.6(2) by double-clicking the Unified ICM 12.6(2) installer, and proceeding from Step 7. |
...
| Step 5 | To apply the Unified ICM 12.6(2) Maintenance Release, click Browse and navigate to the Maintenance Release software. Click Next . You can also proceed with the installation of Unified ICM 12.5(1) without selecting the Unified ICM 12.6(2) installer in this step. After installing Unified ICM 12.5(1), double-click the Unified ICM 12.6(2) installer, and proceed from step 11. |
...
| Step 10 | Log in to your system using domain credentials with administrative
                                          					privileges. |
| Step 11 | Wait for the Unified CCE 12.6(2) installation wizard to launch. Click Next to proceed. |
...
| Step 14 | Select the radio button to restart the system and click Finish . Note You can upgrade from Unified ICM version 12.5(1) to Unified ICM 12.6(2) by double-clicking the Unified ICM 12.6(2) installer, and proceeding from Step 11. | Note | You can upgrade from Unified ICM version 12.5(1) to Unified ICM 12.6(2) by double-clicking the Unified ICM 12.6(2) installer, and proceeding from Step 11. |
| Note | You can upgrade from Unified ICM version 12.5(1) to Unified ICM 12.6(2) by double-clicking the Unified ICM 12.6(2) installer, and proceeding from Step 11. |
...
|---|---|
| Step 2 | To apply the Unified ICM 12.6(2) Maintenance Release, click Browse and navigate to the Maintenance Release software. Click Next . You can also proceed with the installation of Administration Client 12.5(1) without selecting the Unified ICM 12.6(2) installer in this step. After installing Unified ICM 12.5(1), double-click the Unified ICM 12.6(2) installer, and proceed from step 6. |
| Step 3 | Click OK on any informational messages that display. |
| Step 4 | Click Install . |
...
| Step 6 | Log in to your system using domain credentials with administrative privileges. The Unified CCE Release 12.6(2) installation wizard to launches. Click Next to proceed. |
...
| Step 1 | Launch the ICM-CCE-Installer and click Next . |
|---|---|
| Step 2 | To apply the Unified ICM 12.6(2) Maintenance Release, click Browse and navigate to the Maintenance Release software. Click Next . You can also proceed with the installation of Unified ICM 12.5(1) without selecting the Unified ICM 12.6(2) installer in this step. After installing Unified ICM 12.5(1), double-click the Unified ICM 12.6(2) installer, and proceed with the installation. |
| Step 3 | Click OK on any informational messages that display. |
| Step 4 | Click Install . |
| Step 5 | Reboot the
                                          			 server when the upgrade completes. |
