...
| Resource | 2000 Agent Reference Design Model | 4000 Agent Reference Design Model | 12000 Agent Reference Design Model | 24000 Agent Reference Design Model | Contact Director Reference Design Model |
|---|---|---|---|---|---|
| Maximum Agent PGs with Live Data, Precision Queueing, or Single Sign-On enabled 32 | 4 33 | 4 12 (when using the 12000 agents Live Data OVA) | 12 24 (when using the 24000 agents Live Data OVA) | 24 | 50 |
...
| Cisco Enterprise Chat and Email (ECE) | 0 or 1 | 4 43 | 0 or 1 | 0 or more | 0 or 1 | 0 or more |
| Third-party Multichannel | 0 or 1 | 4 44 | 0 or 1 | 0 or more | 0 or 1 | 0 or more |
