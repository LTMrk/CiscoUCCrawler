---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-intelligence-suite-intelligence-suite-150-user-g-d4bcb2066f
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/intelligence_suite/intelligence_suite_150/user/guide/cuic_b_report-customization-guide-1501/cuic_m_configure-1501.html
retrieved_at: 2026-08-21T04:43:19.576358+00:00
---
...
When a user who owns the entities (Dashboards, Reports, Report Definitions, Schedules, Value List, or Collections) is deleted,
                                          the entities associated with the user are automatically reassigned to the administrator.

To know the list of entities that the user owns, run the Resource Ownership and Access report that is generated using the Admin Security template downloaded from the Cisco Software Download Center .

You cannot delete a user account which has been synched into Unified Intelligence Center from Packaged CCE.
...
| Caution | When the signed in user is in the Run As mode of another user, modifying the user account information of either of the users
                                                      stops the Run As mode. |
| Delete | Deletes a user. Only users with a Security Administrator role can delete a user. When a user who owns the entities (Dashboards, Reports, Report Definitions, Schedules, Value List, or Collections) is deleted,
                                          the entities associated with the user are automatically reassigned to the administrator. To know the list of entities that the user owns, run the Resource Ownership and Access report that is generated using the Admin Security template downloaded from the Cisco Software Download Center . Note You cannot delete a user account which has been synched into Unified Intelligence Center from Packaged CCE. | Note | You cannot delete a user account which has been synched into Unified Intelligence Center from Packaged CCE. |
| Note | You cannot delete a user account which has been synched into Unified Intelligence Center from Packaged CCE. |
