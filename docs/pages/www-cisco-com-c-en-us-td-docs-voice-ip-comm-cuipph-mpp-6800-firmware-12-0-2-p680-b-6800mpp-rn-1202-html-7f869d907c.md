---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-mpp-6800-firmware-12-0-2-p680-b-6800mpp-rn-1202-html-7f869d907c
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/MPP/6800/firmware/12-0-2/p680_b_6800mpp-rn-1202.html
retrieved_at: 2026-08-17T01:06:15.211181+00:00
---

Cisco IP Phone 6800 Series Multiplatform Phones Release Notes for Firmware Release 12.0(2)
...
Use these release notes with the following Cisco IP Phone 6800 Series Multiplatform Phones running SIP Firmware Release 12.0(2).
...
https://10.73.10.223/firmware/sip6821.12.0.2MPP0001.116.loads

Other phones in 6800 series:

https://10.73.10.223/firmware/sip68xx.12.0.2MPP0001.116.loads
...
https://10.74.10.225/admin/upgrade?https://10.73.10.223/firmware/sip6821.12.0.2MPP0001.116.loads

Other phones in 6800 series:

https://10.74.10.225/admin/upgrade?https://10.73.10.223/firmware/sip68xx.12.0.2MPP0001.116.loads
...
6821: cmterm-6821.12.0.2MPP0001.116_REL.zip

Other phones in 6800 series: cmterm-68xx.12.0.2MPP0001.116_REL.zip
...
The following list contains the severity 1, 2, and 3 defects that are open for the Cisco IP Phone 6800 Series Multiplatform Phones that use Firmware Release 12.0(2).
...
CSCwe96772 MPP68xx : Call Appearance Per line behaivor inconsistent between 11.2.3 and 11.3.3

CSCwb46008 Many PRTs with logs missing for around 5 seconds

## Resolved Caveats

The following list contains the severity 1, 2, and 3 defects that are resolved for the Cisco IP Phone 6800 Series Multiplatform Phones that use Firmware Release 12.0(2).
...
| Step 6 | Download the corresponding file. 6821: cmterm-6821.12.0.2MPP0001.116_REL.zip Other phones in 6800 series: cmterm-68xx.12.0.2MPP0001.116_REL.zip |
