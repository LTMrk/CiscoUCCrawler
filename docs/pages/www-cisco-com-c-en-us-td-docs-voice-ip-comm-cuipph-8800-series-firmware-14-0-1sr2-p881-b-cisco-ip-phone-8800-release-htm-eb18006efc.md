...
Cisco Unified Communications Manager 10.0 and later
...
The firmware filename is cmterm-88xx-sip.14-0-1-0201-171.k3.cop.sha512
...
cmterm-88xx.14-0-1-0201-171.zip
...
Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284729655&rls=14.0(1),14.0(1.*)&sb=fr&sts=fd&svr=3nH&bt=custV
...
Because caveat status continually changes, the list reflects a snapshot of the caveats that
...
The following list contains the snapshot of severity 1, 2, and 3 caveats that are resolved for the Cisco IP Phone 8800 Series
                        that uses Firmware Release 14.0(1)SR2.
...
Because bug status continually changes, the list reflects a snapshot of the caveats that were
                        				resolved at the time this report was compiled. For an updated view of resolved
                        				caveats or to view specific caveats, access the Bug Search Tool as described in View Caveats .

CSCvx84332 Evaluation of 88x1/78x1/8832/7832 phone for OpenSSL March 2021 vulnerabilities
...
CSCvy11709 88xx HW rev 42 will not register fully over half-pair ethernet cable with a gigabit capable switch

CSCvy11282 88xx Download daemon may hang after configuration file download

CSCvy35155 88x1 Media Server (ms) component crash during call

CSCvx16077 Evaluation of IP Phone 8800 Series for Bluetooth_Pairing_Protocol_2021 vulnerabilities

CSCvy67833 Evaluation of 88x1 for boot script replacement vulnerability

CSCvx84332 Evaluation of 88x1/78x1/8832/7832 phone for OpenSSL March 2021 vulnerabilities

CSCvx85820 Evaluation of 88x1/78x1/7832/8832 for debugsh read file escape

CSCvx99688 8865 phone tagging Telepresence Call frames with DSCP CS4 as WMM UP 4 instead of WMM UP 5
...
CSCvx16071 Evaluation of 88x5 for Bluetooth_Pairing_Protocol_2021 vulnerabilities

CSCvy67824 Evaluation of 88x5 for boot script replacement vulnerability
...
|---|---|
| 8811, 8841, 8845, 8851, 8851NR, 8861, 8865, and 8865NR | Cisco Unified Communications Manager 10.0 and later Cisco Unified Communications Manager DST Olsen version D or later SRST 8.0 (IOS load 15.1(1)T) and above Cisco Expressway 8.7 |
