...
Cisco Emergency Responder Release 14SU3a supports the following new features:
...
Support switch port based tracking for new Voice LAN Switches: Cisco Catalyst C9200CX Series. For more information, see the Supported Voice Ready Lan Switches section.

## Configuration API in Emergency Responder—IP Subnet API

Emergency Responder introduced configuration APIs (WRITE access with necessary authentication) for IP subnets that allows
                  setting up Emergency Responder remotely. You can add new IP subnets, modify an existing IP subnet, or delete an IP subnet
                  using this API.
...
The information in the following sections discuss Hardware and Software requirements for Cisco Emergency Responder 14SU3a.
...
12.5(1), 12.5(1a), 12.5(1) SU1, 12.5(1) SU2, 12.5(1) SU3, 12.5(1) SU4, 12.5(1) SU5, 12.5(1) SU6 , 12.5(1)SU7
...
CER CTI Route Points unregistered after upgrade to v14 SU2

CSCwd71121

DRF mail alert notification not getting delivered

CSCwd95902

SSO page is not loading properly
...
CER OS Admin page redirecting to Internal IP address in UCMC/DI (NAT) environment

CSCwd56980

CER 14SU2 not handling 503 error from Intrado

CSCwc76921

Intermediate and/or root CA certs may get deleted after upgrade to 14 SU2

CSCwd18058

Customer is not able to hear onsite audio prompt if CTI port have multiple lines

CSCwc41268

utils diagnose test output stuck at "test - tomcat "

CSCwc85872

Smart license registration fails for proxy transport setting
...
| Identifier | Headline |
|---|---|
| CSCwd16211 | CER CTI Route Points unregistered after upgrade to v14 SU2 |
| CSCwd71121 | DRF mail alert notification not getting delivered |
| CSCwd95902 | SSO page is not loading properly |
| CSCwe61617 | ALI Formatting tool GUI formatting issue |
| CSCwc69440 | CER OS Admin page redirecting to Internal IP address in UCMC/DI (NAT) environment |
| CSCwd56980 | CER 14SU2 not handling 503 error from Intrado |
| CSCwc76921 | Intermediate and/or root CA certs may get deleted after upgrade to 14 SU2 |
