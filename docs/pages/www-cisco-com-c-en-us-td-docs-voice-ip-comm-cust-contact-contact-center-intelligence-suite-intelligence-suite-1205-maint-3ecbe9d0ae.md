...
After upgrading to Cisco Unified Intelligence Center 12.5 , perform the User Integration operation (Cluster Configuration > UCCE User Integration) manually to import the Supervisors
...
| Note | After upgrading to Cisco Unified Intelligence Center 12.5 , perform the User Integration operation (Cluster Configuration > UCCE User Integration) manually to import the Supervisors
