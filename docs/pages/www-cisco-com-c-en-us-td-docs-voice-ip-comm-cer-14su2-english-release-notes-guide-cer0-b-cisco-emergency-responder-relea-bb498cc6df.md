...
Cisco Emergency Responder Release 14SU2 supports the following new features:

## Integration of National E911 Service Provider through HTTP Authentication based Proxy

All communication to National E911 Service providers like RedSky is supported through a HTTP Authentication based Proxy.
...
## National E911 Service Provider

Although Emergency Responder uses the name National E911 Service Provider for all configuration tasks, both the RedSky and
                  ...
                  Responder. Any specific reference to National E911 Service Provider should be understood to mean either National E911 Service
                  Provider, depending on your chosen provider.

PKCS12 format is no longer supported from this release onwards. See the Cisco Emergency Responder Administration Guide for Release 14SU2 for more information.

## Support for Remote Users Updating their Emergency Location Over The Top (OTT)

Remote or Off-premises users which are using Cisco Jabber or Webex App client for calling can update their emergency location
                  Over The Top (OTT) to a National E911 Service Provider like RedSky using RedSky MyE911 application. Emergency Responder provides
                  support through routing configuration changes for emergency calls from such users to the National E911 Service Provider directly.
...
Touchless installation makes the installation process seamless and promotes simplified installation of Emergency Responder.
                  ...
                  during their installation. This feature has the following benefits:
...
After publisher installation is complete, and if the subscriber installation does not happen automatically, you must restart
                           the publisher node using the CLI command utils system restart .

## Switch Support

Support switch port based tracking for new Voice LAN Switches: Cisco Catalyst C9300CX Series and Cisco Meraki® Switches MS125
                  and MS390. For more information, see the Supported Voice Ready Lan Switches section.

## Requirements

### Supported Hardware and Software

The information in the following sections discuss Hardware and Software requirements for Cisco Emergency Responder 14SU2.
...
Cisco Unified IP Phone  8961, 8945, 8941, 8865, 8861, 8851, 8845, 8841, 7975, 7971, 7970, 7965, 7962, 7961, 7945, 7942, 7941,
                                             7911, 7910, and 7906
...
Cisco Emergency Responder 10.x and later is supported on Cis co Unified Computing System (UCS) and other virtual platforms
...
Direct upgrade from Cisco Emergency Responder 10.5(2) to Cisco Emergency Responder 14SU2 is not supported.
...
Cisco Emergency Responder 11.0(1), or Cisco Emergency Responder 11.5(1) or Cisco Emergency Responder 11.5(2) or Cisco Emergency
                              ...
                              11.5(4) SU4 or Cisco Emergency Responder 11.5(4) SU9 or Cisco Emergency Responder 11.5(4) SU10 or Cisco Emergency Responder 11.5(4) SU11

Direct upgrade from Cisco Emergency Responder 11.0(1) to Cisco Emergency Responder 14SU2 is not supported.
...
Cisco Emergency Responder 12.5(1) or Cisco Emergency Responder 12.5(1a) or Cisco Emergency Responder 12.5(1) SU1 or Cisco
                              ...
                              Emergency Responder 12.5(1) SU5 or Cisco Emergency Responder 12.5(1) SU6
...
11.5(1), 11.5(2), 11.5(2a), 11.5(3), 11.5(4), 11.5(4) SU1, 11.5(4) SU2, 11.5(4) SU3, 11.5(4) SU4, 11.5(4) SU9, 11.5(4) SU10 , 11.5(4)SU11
...
12.5(1), 12.5(1a), 12.5(1) SU1, 12.5(1) SU2, 12.5(1) SU3, 12.5(1) SU4, 12.5(1) SU5, 12.5(1) SU6
...
Cisco Emergency Responder Assessment of CVE-2021-4034 Pwnkit

CSCvy50277

SNMP Host Agent hrSWName missing process list if the node has zombie process

CSCwa23663

CLI command show tech dbintegrity not providing integrity data in output file

CSCwa19468

Core Dump caused during 911 call

CSCwa17653

SLM Proxy Password decryption failing due to DB column size being too small

CSCwb21404

Backup CTI Manager 1&2 character limitation for table backupprovider

CSCvy52346

CER failover fails by one round of iteration while fetching subscriber node

CSCvx00538

QuoVadis root CA decommission on Cisco Emergency Responder

### This Document Applies to These Products

- Emergency Responder 14

| Note | PKCS12 format is no longer supported from this release onwards. See the Cisco Emergency Responder Administration Guide for Release 14SU2 for more information. |
|---|---|
...
|---|---|---|
| Cisco Unified Communications Manager | Cisco Unified Communications Manager 14 Cisco Unified Communications Manager 12.5(x) Cisco Unified Communications Manager 12.0(x) Cisco Unified Communications Manager 11.5(x) | The software that runs the telephony network. |
| Web browser | Firefox with Windows 10 (64 bit) Chrome with Windows 10 (64 bit) Safari with MacOS (10.x) Microsoft Edge browser with Windows 10 (32 bit/64 bit) | We recommend that you use the latest version for all the web browsers supported. |
...
| Note | Any IP endpoint can be tracked at call time using the IP subnet provided that the Use IP Address From Call Signaling Telephony
                                                setting is enabled. |
| Phones supported for off-premises location confirmation and update with the Remote Worker Emergency Calling feature in Unified
                                          Communications Manager 9.0 and later Cisco IP Communicator Cisco Virtual Desktop (VXCC) Cisco IP Phone 7800 Series Cisco Unified IP Phone  8961, 8945, 8941, 8865, 8861, 8851, 8845, 8841, 7975, 7971, 7970, 7965, 7962, 7961, 7945, 7942, 7941,
                                             7911, 7910, and 7906 | When configured for off-premises use in Unified Communications Manager 9.0 and later, these phones provide displays for off-premises
...
| Note | Direct upgrade from Cisco Emergency Responder 10.5(2) to Cisco Emergency Responder 14SU2 is not supported. |
|---|---|

| Note | Direct upgrade from Cisco Emergency Responder 11.0(1) to Cisco Emergency Responder 14SU2 is not supported. |
|---|---|
...
| 10.0(1), 10.0(2), 10.5(1), and 10.5(1a) | 14 | Apply the required Upgrade Readiness COP File (pre-upgrade): ciscocm.cer_preUpgradeCheck-X.k4.cop.sha512 . Refresh upgrade. Required COP files: ciscocm.version3-keys.cop.sgn ciscocm.enable-sha512sum-2021-signing-key-v1.0.cop.sgn Note You must use the following COP file to upgrade from release 10.5(1) and 10.5(1a) to release 14 directly when you select the
                                             Switch Version as No : ciscocm.cer_10x_RU_12.5su3.cop.sgn . Note Direct upgrade from Cisco Emergency Responder 10.5(2) to Cisco Emergency Responder 14SU2 is not supported. Apply the required Upgrade Readiness COP Files (post-upgrade): ciscocm.cer_postUpgradeCheck-X.k4.cop.sha512 . | Note | You must use the following COP file to upgrade from release 10.5(1) and 10.5(1a) to release 14 directly when you select the
                                             Switch Version as No : ciscocm.cer_10x_RU_12.5su3.cop.sgn . | Note | Direct upgrade from Cisco Emergency Responder 10.5(2) to Cisco Emergency Responder 14SU2 is not supported. |
| Note | You must use the following COP file to upgrade from release 10.5(1) and 10.5(1a) to release 14 directly when you select the
                                             Switch Version as No : ciscocm.cer_10x_RU_12.5su3.cop.sgn . |
| Note | Direct upgrade from Cisco Emergency Responder 10.5(2) to Cisco Emergency Responder 14SU2 is not supported. |
| 11.0(1) | 14 | Apply the required Upgrade Readiness COP File (pre-upgrade): ciscocm.cer_preUpgradeCheck-X.k4.cop.sha512 . Refresh upgrade. Required COP file: ciscocm.enable-sha512sum-2021-signing-key-v1.0.cop.sgn Note Direct upgrade from Cisco Emergency Responder 11.0(1) to Cisco Emergency Responder 14SU2 is not supported. Apply the required Upgrade Readiness COP Files (post-upgrade): ciscocm.cer_postUpgradeCheck-X.k4.cop.sha512 . | Note | Direct upgrade from Cisco Emergency Responder 11.0(1) to Cisco Emergency Responder 14SU2 is not supported. |
| Note | Direct upgrade from Cisco Emergency Responder 11.0(1) to Cisco Emergency Responder 14SU2 is not supported. |
| 11.5(1), 11.5(2), 11.5(2a), 11.5(3), 11.5(4), 11.5(4) SU1, 11.5(4) SU2, 11.5(4) SU3, 11.5(4) SU4, 11.5(4) SU9, 11.5(4) SU10 , 11.5(4)SU11 | 14 | Apply the required Upgrade Readiness COP File (pre-upgrade): ciscocm.cer_preUpgradeCheck-X.k4.cop.sha512 . Refresh upgrade. Required COP file: ciscocm.enable-sha512sum-2021-signing-key-v1.0.cop.sgn Note If you want to upgrade Emergency Responder from Release 11.5.x (except for Release 11.5(1)SU11) to 14SU2, use the following
...
| Identifier | Headline |
|---|---|
| CSCwa77227 | Cisco Emergency Responder Assessment of CVE-2021-4034 Pwnkit |
| CSCvy50277 | SNMP Host Agent hrSWName missing process list if the node has zombie process |
| CSCwa23663 | CLI command show tech dbintegrity not providing integrity data in output file |
| CSCwa19468 | Core Dump caused during 911 call |
| CSCwa17653 | SLM Proxy Password decryption failing due to DB column size being too small |
