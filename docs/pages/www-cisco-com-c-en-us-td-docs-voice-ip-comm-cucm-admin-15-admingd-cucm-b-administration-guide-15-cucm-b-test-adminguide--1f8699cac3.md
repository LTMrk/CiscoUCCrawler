---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-admin-15-admingd-cucm-b-administration-guide-15-cucm-b-test-adminguide--1f8699cac3
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/admin/15/adminGd/cucm_b_administration-guide-15/cucm_b_test-adminguide_chapter_011010.html
retrieved_at: 2026-08-17T00:38:39.311584+00:00
---
...
| Trace | Administrators and Cisco engineers use trace files to obtain specific information about Unified Communications Manager service problems. Cisco Unified Serviceability sends configured trace information to the trace log file. Two types of trace log files exist: SDI and SDL. Every service includes a default trace log file. The system traces system diagnostic interface (SDI) information from the
                                       ...
                                       The system traces the signal distribution layer (SDL) of the call and logs state transitions into a log file. Note The .gzo file is no longer a compressed file but a text file. Hence, .gzo file need not be uncompressed and should be read
                                                as plain text. Note In most cases, you will only gather SDL traces when Cisco Technical Assistance Center (TAC) requests you to do so. | Note | The .gzo file is no longer a compressed file but a text file. Hence, .gzo file need not be uncompressed and should be read
                                                as plain text. | Note | In most cases, you will only gather SDL traces when Cisco Technical Assistance Center (TAC) requests you to do so. |
| Note | The .gzo file is no longer a compressed file but a text file. Hence, .gzo file need not be uncompressed and should be read
                                                as plain text. |
