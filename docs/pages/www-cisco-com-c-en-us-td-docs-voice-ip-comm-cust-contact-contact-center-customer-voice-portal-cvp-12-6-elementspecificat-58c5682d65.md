...
| The DialogflowCX element can be used to engage the Google Dialogflow CX services. The DialogflowCX element is located under the Virtual Assistant Voice group in the Call Studio Elements . This element is an extension of the Form element and it engages the special resource on VVB called Speech Server to communicate with the Dialogflow Server. Note The DialogflowCX element works with both Cisco DTMF and Nuance adaptors. The DialogflowCX element supports both Speech and DTMF inputs. | Note | The DialogflowCX element works with both Cisco DTMF and Nuance adaptors. The DialogflowCX element supports both Speech and DTMF inputs. |
|---|---|---|
