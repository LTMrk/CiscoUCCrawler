---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-rel-notes-12-5-1-su7-cucm-b-release-notes-for-cucm-imp-1251su7-html-41191ed284
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/rel_notes/12_5_1/SU7/cucm_b_release-notes-for-cucm-imp-1251su7.html
retrieved_at: 2026-08-16T23:52:02.437453+00:00
---

Release Notes for Cisco Unified Communications Manager and the IM and Presence Service, Release 12.5(1)SU7
...
The following software versions apply to Release 12.5(1)SU7:
...
Microsoft Teams users must use Webex Calling integration for Microsoft Teams.

This feature has dependent services which would be available later. For more information, see Webex Calling integration with Microsoft Teams .
...
### JTAPI Compatibility with Emergency Responder Release 14SU2

Cisco Emergency Responder (Emergency Responder) Release 14SU2 is now backward compatible with Unified Communications Manager Releases 14SU1, 12.5.x, and 11.5.x.
...
ReadMe for Cisco Unified Communications Manager Release 12.5(1)SU7

ReadMe for Cisco Unified IM and Presence, Release 12.5(1)SU7
...
| Note | This feature has dependent services which would be available later. For more information, see Webex Calling integration with Microsoft Teams . |
|---|---|
