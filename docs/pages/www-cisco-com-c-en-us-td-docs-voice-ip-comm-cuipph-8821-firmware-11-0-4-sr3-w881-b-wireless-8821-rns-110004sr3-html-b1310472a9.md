...
These release notes support the Cisco Wireless IP Phone 8821 Firmware Release 11.0(4)SR3.
...
8.0.152.0, 8.2.170.0, 8.3.143.0, 8.5.140.0, 8.8.111.0
...
### Install Firmware Release 11.0(4)SR3 on Cisco Unified Communications Manager
...
In the Latest Releases folder, choose 11.0(4)SR3 .

Select the firmware file, click the Download or Add to cart button, and follow the prompts.

Firmware file: cmterm-8821-sip.11-0-4SR3-3.k3.cop.sgn
...
### Install Firmware Release 11.0(4)SR3 on Cisco Communications Manager Express
...
Choose 11.0(4)SR3 in the Latest Releases folder.

Click Download or Add to cart and follow the prompts.

The file to download is cmterm-8821.11-0-4SR3-3.zip
...
https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286308995&rls=11.0%284%29SR3&sb=anfr&bt=custV

Use this URL for all open caveats:

https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286308995&rls=11.0%284%29SR3&sb=afr&bt=custV

Use this URL for all resolved caveats:

https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286308995&rls=11.0%284%29SR3&sb=fr&bt=custV
...
CSCvn18664 Unlock SoftKey Disappear On Phone Screen

CSCvn24025 Idle URL triggered when menu is open

CSCvn59042 8821 call disconnects when when we receive XML query to change the display in off hook mode

CSCvn60087 8821 URL format on CiscoIPPhoneMenu object request

CSCvn64558 8821 Menu item Name with carriage return does not display correctly
...
CSCvo32469 Could not disable WLAN profile 2

CSCvo32881 Both speaker icon displayed when setting auto answer with speaker on shared line

CSCvo34735 No toast prompted for invalid RTP port range
...
CSCvo44358 No voicemail LED indicator for non-primary line
...
| Cisco Wireless LAN Controller | 8.0.121.0 | 8.0.152.0, 8.2.170.0, 8.3.143.0, 8.5.140.0, 8.8.111.0 |
...
| Step 4 | Choose 11.0(4)SR3 in the Latest Releases folder. |
| Step 5 | Click Download or Add to cart and follow the prompts. The file to download is cmterm-8821.11-0-4SR3-3.zip |
...
| Step 1 | Perform one of the following actions: Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286308995&rls=11.0%284%29SR3&sb=anfr&bt=custV Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286308995&rls=11.0%284%29SR3&sb=afr&bt=custV Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286308995&rls=11.0%284%29SR3&sb=fr&bt=custV |
|---|---|
