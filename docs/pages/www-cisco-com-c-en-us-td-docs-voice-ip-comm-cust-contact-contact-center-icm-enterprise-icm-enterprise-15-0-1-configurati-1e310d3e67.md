---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-15-0-1-configurati-1e310d3e67
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_15_0_1/configuration/guide/ucce_b_1501_configuration-guide-for-cisco-unified-icm-enterprise-release/ucce_m_1501_routing-clients.html
retrieved_at: 2026-08-20T18:54:17.259392+00:00
---
...
An enterprise name for the call type. Initially, you can leave this field blank. For information on this field, refer to the Scripting and Media Routing Guide for Cisco Unified Contact Center Enterprise .
...
| Timeout limit
                                             				...
                                             				before it stops sending requests to the system software. |
| Default call
                                                				  type | An enterprise name for the call type. Initially, you can leave this field blank. For information on this field, refer to the Scripting and Media Routing Guide for Cisco Unified Contact Center Enterprise . |
| Configuration
                                                				  parameters | A string
                                             				containing any initialization parameters that must be passed to the routing
                                             				client. For a public network, this might include the subsystem number. A null
