---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-expressway-release-note-x14-0-9-exwy-b-cisco-expressway-and-telepresence-rel-a4fd4a71a5
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/expressway/release_note/X14-0-9/exwy_b_cisco-expressway-and-telepresence-release-note-x1409.html
retrieved_at: 2026-08-16T15:40:48.213408+00:00
---

Cisco Expressway and Cisco TelePresence Video Communication Server Release Note (X14.0.9)
...
## Features and Changes in X14.0.9
...
A new CLI command is added that specifies the maximum delay of a SIP BIB invite message (ensure SIP message proceeds in order)
                        that the server can handle (in milliseconds).
