---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-connection-rest-api-cuti-api-b-cuti-api-b-cuti-api-chapter-0111-html-561fbdaac8
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/REST-API/CUTI_API/b_CUTI_API/b_CUTI_API_chapter_0111.html
retrieved_at: 2026-08-21T08:07:22.469509+00:00
---
...
Chapter: Cisco Unity Connection Provisioning Interface (CUTI) API -- Voice Name Upload for Interview Handlers

## Chapter: Cisco Unity Connection Provisioning Interface (CUTI) API -- Voice Name Upload for Interview Handlers

# Cisco Unity Connection Provisioning Interface (CUTI) API -- Voice Name Upload for Interview Handlers

Links to Other API pages: Cisco_Unity_Connection_APIs

## Voice Name Upload for Interview Handlers

This API is used to upload voice name to the Interview Handlers. There are three ways of uploading the voice name:
...
### Add/Update the Voice Name for Interview Handler by Uploading a File from the Desktop
...
```
PUT https://<connection-server>/vmrest/handlers/interviewhandlers/<interviewhandlerobjectid>
Request Body:
<InterviewHandler>
...
```
POST https://<connection-sever>/vmrest/handlers/interviewhandlers/<interviewhandlerobjectid>
Accept: application/json
Content-Type; application/json
Connection: keep-alive
Request Body:
...
https://<connectionserver>/vmrest/handlers/interviewhandlers/<interviewhandlerobjectid>/voicename
...
PUT https://< connectionserver>/
  vmrest/handlers/interviewhandlers/<interviewhandlerobjectid>/voicename
Request Body:
<CallControl>
     <op>RECORD</op>
...
https://<connection-server>/vmrest/handlers/interviewhandlers/<interviewhandlerobjectid>/voicename
...
where the PUT request is created to upload the file3 .wav file. Make sure the content type for the request should be passed
                                 as "audio/wav". Use the following URL from the browser to listen to the voice name associated with the interview handler:
...
Connection: keep-alive |
| Response Code: 204 |
| Step 3 | Add the file to the voice name. The request is as follows: PUT https://<connection-server>/vmrest/handlers/interviewhandlers/<interviewhandlerobjectid>
Request Body:
<InterviewHandler>
     <VoiceName>0ad46c53-44eb-4da6-988c-4f07fabc6bdd.wav</VoiceName>
</InterviewHandler> Response Code: 201 JSON Example POST https://<connection-sever>/vmrest/handlers/interviewhandlers/<interviewhandlerobjectid>
Accept: application/json
Content-Type; application/json
Connection: keep-alive
Request Body:
{
     "VoiceName":"0ad46c53-44eb-4da6-988c-4f07fabc6bdd.wav"
} Response Code: 201 Use the below URL in the browser to listen to the voice name. https://<connectionserver>/vmrest/handlers/interviewhandlers/<interviewhandlerobjectid>/voicename | PUT https://<connection-server>/vmrest/handlers/interviewhandlers/<interviewhandlerobjectid>
Request Body:
<InterviewHandler>
     <VoiceName>0ad46c53-44eb-4da6-988c-4f07fabc6bdd.wav</VoiceName>
</InterviewHandler> | Response Code: 201 | POST https://<connection-sever>/vmrest/handlers/interviewhandlers/<interviewhandlerobjectid>
Accept: application/json
Content-Type; application/json
Connection: keep-alive
Request Body:
...
Request Body:
{
     ...
     "startPosition":"0"
                                             ...
                                             listen to the voice name. https://<connection-server>/vmrest/handlers/interviewhandlers/<interviewhandlerobjectid>/voicename | PUT https://< connectionserver>/
  vmrest/handlers/interviewhandlers/<interviewhandlerobjectid>/voicename
Request Body:
<CallControl>
     <op>RECORD</op>
