...
These release notes support the Cisco IP Conference Phone 7832 running SIP Firmware Release 12.5(1)SR3.
...
The Cisco IP Conference Phone 7832 User Guide is accessible for people with limited sight or who are blind. The HTML version of the document is now compatible with the
...
The firmware filename is cmterm-7832-sip.12-5-1SR3-74.k3.cop.sgn
...
https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286312831&rls=12.5(1)SR3&sb=anfr&svr=3nH&bt=custV

To find all open caveats for this release, use this URL:

https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286312831&rls=12.5(1)SR3&sb=afr&svr=3nH&bt=custV

To find all resolved caveats for this release, use this URL:

https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286312831&rls=12.5(1)SR3&sb=fr&svr=3nH&bt=custV
...
There are no open defects for the Cisco IP Conference Phone 7832 for Firmware Release 12.5(1)SR3.
...
CSCvp46565: Linux Kernel Stale TLB Entry Unauthorized Access Vulnerability
...
| Step 1 | Perform one of the following actions: To find all caveats for this release, use this URL: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286312831&rls=12.5(1)SR3&sb=anfr&svr=3nH&bt=custV To find all open caveats for this release, use this URL: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286312831&rls=12.5(1)SR3&sb=afr&svr=3nH&bt=custV To find all resolved caveats for this release, use this URL: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286312831&rls=12.5(1)SR3&sb=fr&svr=3nH&bt=custV |
|---|---|
