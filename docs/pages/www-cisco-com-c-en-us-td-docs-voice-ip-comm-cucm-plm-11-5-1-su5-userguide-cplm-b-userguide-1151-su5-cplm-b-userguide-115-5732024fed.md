...
An ISO file is available  via electronic software download after you purchase Cisco Unified Communications Manager or Cisco
                                             Unity Connection.
...
The following
                                 		  table provides a list of ports used by Cisco Prime License Manager. If you wish to use automatic license fulfillment,
                                 Cisco Prime License Manager should be allowed direct outbound access to the Internet.
...
Cisco Prime License Manager supports the following products:

Product

Enterprise License Manager Release 9.1

Cisco Prime License Manager Release 10.x
...
Yes, with license definition updates. For more details, see the License Definitions
...
| Product | Enterprise License Manager Release 9.1 | Cisco Prime License Manager Release 10.x |
|---|---|---|
| Cisco Unified Communications Manager Release 9.1 | Yes | Yes |
| Cisco Unity Connection Release 9.1 | Yes | Yes |
| Cisco Unified Communications Manager Release 10.x | Yes, with license definition updates. For more details, see the License Definitions | Yes |
| Cisco Unity Connection Release 10.x | Yes, with license definition updates. For more details, see the License Definitions | Yes |
