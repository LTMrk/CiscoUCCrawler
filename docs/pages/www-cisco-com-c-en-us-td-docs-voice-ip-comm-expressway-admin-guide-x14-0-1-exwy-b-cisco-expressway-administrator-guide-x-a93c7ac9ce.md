---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-expressway-admin-guide-x14-0-1-exwy-b-cisco-expressway-administrator-guide-x-a93c7ac9ce
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/expressway/admin_guide/X14-0-1/exwy_b_cisco-expressway-administrator-guide-x14-0-1/exwy_m_expressway-interfaces.html
retrieved_at: 2026-08-16T22:41:24.659427+00:00
---
...
This section summarizes the Expressway web user interface, and the CLI and API. For information about the optional Dedicated
                        Management Interface (DMI) to use LAN3 for management traffic, see Configuring the Dedicated Management Interface (DMI) .
...
The Expressway web interface is designed for and tested with Internet Explorer 8 and 9 (not in compatibility mode), Internet
                           Explorer 10 and 11, Firefox, and Chrome. We do not officially support using other browsers for accessing the UI.
...
The API is self documented using RAML. We provide a REST API Summary Guide on the Expressway configuration guides page, which summarizes how to access the base URL and the RAML definitions, and gives
