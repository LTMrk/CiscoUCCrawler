---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-security-14su2-cucm-b-security-guide-14su2-cucm-m-fips-mode-setup-su2-r-5d8c2eab1c
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/security/14SU2/cucm_b_security-guide-14su2/cucm_m_fips-mode-setup_su2_reorg.html
retrieved_at: 2026-08-17T00:28:38.016234+00:00
---
...
These versions are applicable for Release 14 and 14SU1 only.

CiscoSSL 1.0.2y.6.2.403 with FIPS Module CiscoSSL FOM 6_2_0
...
These versions are applicable for Release 14SU2 and SU3 only.
...
These versions are applicable for Release 14SU4 only.

CiscoSSL 1.1.1v.7.2.539 with FIPS Module CiscoSSL FOM 7.2a
...
These versions are applicable for Release 14SU5 only.
...
These versions are applicable for Release 14SU6 only.
...
This result is applicable for release 14SU1 and below only .
...
This result is applicable for release 14SU2 and 14SU3 only .
...
- S T A R T ---------------------
Executing FIPS selftests
runlevel is multi-user.target
Start time: Fri Jul 28 11:28:28 IST 2023
NSS self tests passed.
Kernel Crypto tests passed.
Operating System OpenSSL self tests passed.
...
| Important | These versions are applicable for Release 14 and 14SU1 only. |
|---|---|

| Important | These versions are applicable for Release 14SU2 and SU3 only. |
|---|---|

| Important | These versions are applicable for Release 14SU4 only. |
|---|---|

| Important | These versions are applicable for Release 14SU5 only. |
|---|---|

| Important | These versions are applicable for Release 14SU6 only. |
|---|---|
...
| Step 1 | Start a CLI Session. For more information, see the Starting a CLI Session section in the Command Line Interface Reference Guide for Cisco Unified Communications Solutions . |
|---|---|
| Step 2 | In the CLI, enter utils fips status The following message appears to confirm that FIPS 140-2 mode is enabled. Note This result is applicable for release 14SU1 and below only . admin:utils fips status
The system is operating in FIPS mode. Self test status: 
...
Openswan self tests passed.
OpenSSL self tests passed.
CryptoJ self tests passed... Note This result is applicable for release 14SU2 and 14SU3 only . admin:utils fips status
The system is operating in FIPS mode. Self test status: 
...
OpenSSL self tests passed.
CryptoJ self tests passed.
BCFIPS self tests passed. | Note | This result is applicable for release 14SU1 and below only . | Note | This result is applicable for release 14SU2 and 14SU3 only . |
| Note | This result is applicable for release 14SU1 and below only . |
| Note | This result is applicable for release 14SU2 and 14SU3 only . |
