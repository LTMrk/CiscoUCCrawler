---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-finesse-finesse-1261-installation-guide-cfin-b-1-d4d48f1baa
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/finesse/finesse_1261/installation/guide/cfin_b_1261-cisco-finesse-installation-and-upgrade/cfin_m_1261-upgrade.html
retrieved_at: 2026-08-21T15:53:58.816547+00:00
---
...
Release 12.0(x) or 12.5(x)

If you upgrade from Cisco Finesse 12.5(1) SU to Cisco Finesse 12.6(1), you must immediately upgrade to Cisco Finesse 12.6(1)
                                                      ES05 or above.

Upgrade to Release 12.6(1)

To upgrade from releases prior to Cisco Finesse 12.0(1) to Cisco Finesse 12.6(1), you must first upgrade to 12.0(1) and then
                                                upgrade to 12.6(1).

Before upgrading to Cisco Finesse 12.6(1), you must download and install ucos.keymanagement.cop.sgn file from https://software.cisco.com/download/home/268439622/type/286325642/release/12.6(1) .
...
For large deployments, allocate extra vRAM and other resources to avoid impacting the performance of the upgraded version.
                                    For more information on the virtualization details, see the Virtualization for Cisco Finesse wiki.
...
For upgraded layouts, the "hidden=false" attribute is introduced for non-voice state control gadgets. For example, the existing
                                    non-voice control gadget URLs are migrated to the new URL. <gadget hidden="true">https://localhost/uccx-nvcontrol/gadgets/NonVoiceControl.xml</gadget>

For upgraded layouts, TeamMessage, Desktop Chat, and sample configurations for customizing desktop properties don’t appear
                                    by default. The administrator must copy the XML from the View Default Layout and add to the respective custom layouts. For more information, see the Cisco Finesse Administration Guide .

After you upgrade to Cisco Finesse 12.0(1), the name, format, and folder references of the Cisco-provided gadgets are changed
                                    automatically. Automatically modified gadget details are as follows:
...
|---|---|
| Release 12.0(x) or 12.5(x) Note If you upgrade from Cisco Finesse 12.5(1) SU to Cisco Finesse 12.6(1), you must immediately upgrade to Cisco Finesse 12.6(1)
                                                      ES05 or above. | Note | If you upgrade from Cisco Finesse 12.5(1) SU to Cisco Finesse 12.6(1), you must immediately upgrade to Cisco Finesse 12.6(1)
                                                      ES05 or above. | Upgrade to Release 12.6(1) |
| Note | If you upgrade from Cisco Finesse 12.5(1) SU to Cisco Finesse 12.6(1), you must immediately upgrade to Cisco Finesse 12.6(1)
                                                      ES05 or above. |
...
| Note | To upgrade from releases prior to Cisco Finesse 12.0(1) to Cisco Finesse 12.6(1), you must first upgrade to 12.0(1) and then
                                                upgrade to 12.6(1). Before upgrading to Cisco Finesse 12.6(1), you must download and install ucos.keymanagement.cop.sgn file from https://software.cisco.com/download/home/268439622/type/286325642/release/12.6(1) . |
|---|---|
