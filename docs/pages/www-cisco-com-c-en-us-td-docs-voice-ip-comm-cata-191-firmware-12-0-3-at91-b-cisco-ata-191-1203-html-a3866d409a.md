---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cata-191-firmware-12-0-3-at91-b-cisco-ata-191-1203-html-a3866d409a
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cata/191/firmware/12-0-3/at91_b_cisco-ata-191-1203.html
retrieved_at: 2026-08-21T12:49:56.296642+00:00
---

Cisco ATA 191 Analog Telephone Adapter Release Notes for Firmware Release 12.0(3)
...
These release notes support the Cisco 191 Analog Telephone Adapter (ATA) running Firmware Release 12.0(3).
...
You can disable weak TLS ciphers on ATAs to help enhance the security, protect the communications between the TLS client/server,
                        and reduce the security risks.

To use this feature, configure the parameter Disable TLS Ciphers on Cisco Unified Communication Manager.
...
The ATA registered to Cisco Unified CM now supports the TLS up to the 1.3 version. TLS 1.3 can enhance the security and improve
                        the performance for ATA.

In addition, TLS 1.3 provides a simplified cipher suite:
...
To support the TLS 1.3 on the ATA, the required version of Unified CM is 15 SU2 or later.
...
From this release, you can set the minimum version of TLS required for the TLS communications. The feature is available  when
                        the ATA acts as a TLS client or TLS server. With this feature, you can disable certain low versions of TLS (such as, TLS 1.0,
                        TLS 1.1, etc.) to secure the communications between the TLS client and server.

By default, the TLS minimum version for client and server is both TLS 1.2. You can change the setting with Cisco Unified Communications
                        Manager.
...
In the Latest Releases folder, choose 12.0.3 .

Step 4

Select cmterm-ATA191.12-0-3-0001-139.k4.cop.sha512 firmware, click the Download or Add to cart button, and follow the prompts.
...
Select cmterm-ATA191.12-0-3-0001-139.zip firmware, click the Download or Add to cart button, and follow the prompts.
...
Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286282490&rls=12.0(3)&sb=fr&bt=custV

Use this URL for open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286282490&rls=12.0(3)&sb=fr&sts=open&bt=custV

Use this URL for resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286282490&rls=12.0(3)&sb=fr&sts=fd&bt=
...
The following list shows the severity 1, 2, and 3 defects that are resolved for the Cisco ATA 191 Analog Telephone Adapter
                        Release Firmware Release 12.0(3).
...
CSCwk58669: ATA 191 doesn't stop local ring back after receiving an UPDATE without ui-state=ringout.

CSCwm33267: ATA191 Delayed Voice Channel Setup for Secure SRTP Calls
...
| Note | To support the TLS 1.3 on the ATA, the required version of Unified CM is 15 SU2 or later. |
|---|---|
...
| Step 3 | In the Latest Releases folder, choose 12.0.3 . |
| Step 4 | Select cmterm-ATA191.12-0-3-0001-139.k4.cop.sha512 firmware, click the Download or Add to cart button, and follow the prompts. |
...
| Step 2 | Choose ATA 190 Series Analog Telephone Adapters > ATA 191 Analog Telephone Adapter . |
| Step 3 | In the Latest Releases folder, choose 12.0.3 . |
| Step 4 | Select cmterm-ATA191.12-0-3-0001-139.zip firmware, click the Download or Add to cart button, and follow the prompts. |
| Step 5 | Click the + next to the firmware file name in the Download Cart section to access additional information about this file. The hyperlink
                                    for the readme file is in the Additional Information section, which contains installation instructions for the corresponding
                                    firmware. |
| Step 6 | Follow the instructions in the readme file to install the firmware. |

| Step 1 | Perform one of the following actions: Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286282490&rls=12.0(3)&sb=fr&bt=custV Use this URL for open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286282490&rls=12.0(3)&sb=fr&sts=open&bt=custV Use this URL for resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286282490&rls=12.0(3)&sb=fr&sts=fd&bt= |
|---|---|
