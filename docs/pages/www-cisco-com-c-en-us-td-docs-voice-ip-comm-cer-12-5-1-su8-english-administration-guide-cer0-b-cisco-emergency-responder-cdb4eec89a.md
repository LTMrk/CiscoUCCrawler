---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cer-12-5-1-su8-english-administration-guide-cer0-b-cisco-emergency-responder-cdb4eec89a
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cer/12_5_1_su8/english/administration/guide/cer0_b_cisco-emergency-responder-administration-guide-1251su8/cer0_m_cer-administration-web-interface.html
retrieved_at: 2026-08-21T15:30:30.821098+00:00
---
...
| Note | If you choose to use a direct connection, then you must configure Domain Name System (DNS) on Emergency Responder that can resolve https://tools.cisco.com for Call Home . |
| Note | If you choose not to configure the domain and Domain Name System (DNS) on Emergency Responder , then you can select the Cisco Smart Software Manager satelliteor proxy server under Transport settings. In such cases, DNS
                                                      that can resolve https://www.cisco.com has to be configured on the Cisco Smart Software Manager satelliteor HTTP/HTTPS Proxy server. |
