...
For example, to select the Bell Canada AFT, click on: CER-aft-Bell_Canada.1-1-1.exe
...
Step 12 To test that the application successfully loaded, install the new shortcut path and launch the AFT application.

a. Go to:

Start > Programs > Cisco Emergency Responder> AFT > Bell Canada
