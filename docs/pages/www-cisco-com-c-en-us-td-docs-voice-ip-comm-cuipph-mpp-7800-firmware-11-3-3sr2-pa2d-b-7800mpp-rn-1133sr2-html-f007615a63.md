---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-mpp-7800-firmware-11-3-3sr2-pa2d-b-7800mpp-rn-1133sr2-html-f007615a63
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/MPP/7800/firmware/11-3-3sr2/pa2d_b_7800mpp-rn-1133sr2.html
retrieved_at: 2026-08-21T23:19:25.636371+00:00
---

Cisco IP Phone 7800 Series Multiplatform Phones Release Notes for Firmware Release 11.3(3)SR2
...
Use these release notes with the Cisco IP Phone 7800 Series Multiplatform Phones running SIP Firmware Release 11.3(3)SR2.
...
On the next page that is displayed, select 11.3.3 MSR2 in the All Releases > MPPv11 folder.

(Optional) Place your mouse pointer on the file name to see the file details and checksum values.

Download the corresponding file.

cmterm-78xx.11-3-3MPP0203-382_REL.zip
...
http://10.73.10.223/firmware/sip78xx.11-3-3MPP0203-382.loads

https://server.domain.com/firmware/sip78xx.11-3-3MPP0203-382.loads
...
https://10.74.10.225/admin/upgrade?http://10.73.10.223/firmware/sip78xx.11-3-3MPP0203-382.loads

https://10.74.10.225/admin/upgrade?https://server.domain.com/firmware/sip78xx.11-3-3MPP0203-382.loads
...
The following list contains the severity 1, 2, and 3 defects that are open for the Cisco IP Phone 7800 Series Multiplatform Phones that use Firmware Release 11.3(3)SR2.
...
The following list contains the severity 1, 2, and 3 defects that are resolved for the Cisco IP Phone 7800 Series Multiplatform Phones that use Firmware Release 11.3(3)SR2.
...
CSCwa20369 New LCD phone's grey softkey'color is not smooth
...
| Step 4 | On the next page that is displayed, select 11.3.3 MSR2 in the All Releases > MPPv11 folder. |
| Step 5 | (Optional) Place your mouse pointer on the file name to see the file details and checksum values. |
| Step 6 | Download the corresponding file. cmterm-78xx.11-3-3MPP0203-382_REL.zip |
