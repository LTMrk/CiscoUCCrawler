---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-mpp-common-ag-conf-7832-8832-tpcc-b-cisco-ip-conference-phone-multipl-903fde1903
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/MPP/common/ag_conf_7832_8832/tpcc_b_cisco-ip-conference-phone-multiplatform/cs88_m_corporate-personal-dir-setup-mpp1133.html
retrieved_at: 2026-08-21T13:48:51.685242+00:00
---
...
This defines the search for surnames [sn], known as last name in some locations. For example, sn:(sn=*$VALUE*). This search
                                                allows the provided text to appear anywhere in a name: beginning, middle, or end.

Default: Blank

First Name Filter

This defines the search for the common name [cn]. For example, cn:(cn=*$VALUE*). This search allows the provided text to appear
                                                anywhere in a name: beginning, middle, or end.
...
| Last Name Filter | This defines the search for surnames [sn], known as last name in some locations. For example, sn:(sn=*$VALUE*). This search
                                                allows the provided text to appear anywhere in a name: beginning, middle, or end. Default: Blank |
| First Name Filter | This defines the search for the common name [cn]. For example, cn:(cn=*$VALUE*). This search allows the provided text to appear
                                                anywhere in a name: beginning, middle, or end. Default: Blank |
