---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-crs-express-12-5-1-su1-install-guide-uccx-b-1251-b4fa6f97bf
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/crs/express_12_5_1_su1/install/guide/uccx_b_1251su1install-and-upgrade-guide/uccx_b_1252install-and-upgrade-guide_chapter_0100.html
retrieved_at: 2026-08-16T21:13:33.377887+00:00
---
...
You can upgrade to Unified CCX version 12.5.1 SU1 from only Unified CCX versions 11.6.x, 12.0, and 12.5.1. If you are using
                              any prior release of Unified CCX, you have to upgrade to 11.6.x or 12.0 and then upgrade to 12.5.1 SU1.
...
Install the following COP files.

Unified CCX - ucos.keymanagement.cop.sgn

Customer Collaboration Platform - ciscoccp.keymanagement.cop.sgn, if upgrading from Customer Collaboration Platform (CCP)
                                             Release 12.5(1)

SocialMiner - ciscosm.keymanagement.cop.sgn, if upgrading from SocialMiner Release 11.6(2) or 12.0(1)
...
During Refresh Upgrade to Release 12.5.1 SU1, the system-history.log file may contain the following information, which can be ignored:

Switch Version 12.5.1.11001-XY to 12.0.1.10000-24 Aborted
...
| Step 8 | Install the following COP files. Unified CCX - ucos.keymanagement.cop.sgn Customer Collaboration Platform - ciscoccp.keymanagement.cop.sgn, if upgrading from Customer Collaboration Platform (CCP)
                                             Release 12.5(1) SocialMiner - ciscosm.keymanagement.cop.sgn, if upgrading from SocialMiner Release 11.6(2) or 12.0(1) For information about installing the COP files, see COP File . Note If you do not install these COP files, the upgrade fails. | Note | If you do not install these COP files, the upgrade fails. |
...
| Note | During Refresh Upgrade to Release 12.5.1 SU1, the system-history.log file may contain the following information, which can be ignored: Switch Version 12.5.1.11001-XY to 12.0.1.10000-24 Aborted |
|---|---|
...
|---|---|
| 11.6.x/12.0/12.5(1)/12.5(1) SU1/12.5(1) SU2 to 12.5(1) SU3 | Single Node Setup: |
