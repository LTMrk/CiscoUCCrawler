...
These release notes support the Cisco Wireless IP Phone 8821 Firmware Release 11.0(2). This release is the initial introduction of the Cisco Wireless IP Phone 8821.
...
The Cisco Wireless IP Phone 8821 is a 802.11a/b/g/n/ac wireless device that utilizes SIP to provide voice communications across the IP network.

The phone provides voice communication over the same wireless LAN that your computer uses, allowing you to place and receive phone calls, put calls on hold, transfer calls, make conference calls, and so on. The phone has Ingress Protection 67 (IP67) level protection, which indicates dust-tight equipment that is protected against splashing water.
...
Firmware file: cmterm-8821-sip.11-0-2-2.k3.cop.sgn
...
### Install the Firmware Release on Cisco Unified Communications Manager Express
...
The file to download is cmterm-8821-sip.11-0-2-2.zip
...
| Step 5 | In the Latest
			 Releases folder, choose 11.0(2) . |
| Step 6 | Select the
			 firmware file, click the Download or Add to
				cart button, and follow the prompts. Firmware file: cmterm-8821-sip.11-0-2-2.k3.cop.sgn Note If you added
				  the firmware file to the cart, click the Download Cart link when you are ready to download
...
| Step 4 | Choose 11.0(2) in the Latest Releases folder. |
| Step 5 | Click Download or Add to cart and follow the prompts. The file to download is cmterm-8821-sip.11-0-2-2.zip |
