...
The following table list the supported upgrade path to Cisco Finesse Release 12.5(1).
...
Upgrade to Release 12.5(1) or 12.5(1) SU

To perform an upgrade of Cisco Finesse to 12.5(1) or 12.5(1) SU, you must first perform an upgrade to 12.0(1) from the previous
                                                      versions and then upgrade to 12.5(1) or 12.5(1) SU.

Release 12.5(1)

Upgrade to Release 12.5(1) SU

Cisco Finesse ISOs are bootable. For example, if you must rebuild your secondary server, you can upgrade your primary server
                                          to the latest release and then perform a fresh installation with the Finesse ISO on your secondary server.
...
|---|---|
| Release 12.0(x) | Upgrade to Release 12.5(1) or 12.5(1) SU Note To perform an upgrade of Cisco Finesse to 12.5(1) or 12.5(1) SU, you must first perform an upgrade to 12.0(1) from the previous
                                                      versions and then upgrade to 12.5(1) or 12.5(1) SU. | Note | To perform an upgrade of Cisco Finesse to 12.5(1) or 12.5(1) SU, you must first perform an upgrade to 12.0(1) from the previous
                                                      versions and then upgrade to 12.5(1) or 12.5(1) SU. |
| Note | To perform an upgrade of Cisco Finesse to 12.5(1) or 12.5(1) SU, you must first perform an upgrade to 12.0(1) from the previous
                                                      versions and then upgrade to 12.5(1) or 12.5(1) SU. |
| Release 12.5(1) | Upgrade to Release 12.5(1) SU |

| Note | To perform an upgrade of Cisco Finesse to 12.5(1) or 12.5(1) SU, you must first perform an upgrade to 12.0(1) from the previous
                                                      versions and then upgrade to 12.5(1) or 12.5(1) SU. |
|---|---|

| Note | Cisco Finesse ISOs are bootable. For example, if you must rebuild your secondary server, you can upgrade your primary server
                                          to the latest release and then perform a fresh installation with the Finesse ISO on your secondary server. |
|---|---|
