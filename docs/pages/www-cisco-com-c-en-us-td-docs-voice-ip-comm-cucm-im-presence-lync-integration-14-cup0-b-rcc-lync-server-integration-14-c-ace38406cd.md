---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-im-presence-lync-integration-14-cup0-b-rcc-lync-server-integration-14-c-ace38406cd
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/im_presence/lync_integration/14/cup0_b_rcc-lync-server-integration-14/cup0_b_rcc-lync-server-integration-1251_chapter_011.html
retrieved_at: 2026-08-16T16:34:28.230013+00:00
---
...
For IM and Presence to process any incoming SIP request with SIP URI containing a domain name different from the one configured
                                             for IMP Service domain, set the SRV Cluster Name parameter to the same enterprise top-level domain.
...
| Step 4 | Verify that the
                                       			 following parameters are configured correctly: The proxy
                                             				  ...
                                             				  "example.com"). This value can be entered in the CUCM Domain service parameter field. This
                                                					 parameter specifies which URIs are treated as local and handled by this IM and Presence
                                                   						Service installation. Other SIP requests may be proxied. For IM and Presence to process any incoming SIP request with SIP URI containing a domain name different from the one configured
                                             for IMP Service domain, set the SRV Cluster Name parameter to the same enterprise top-level domain. Enable the Add
