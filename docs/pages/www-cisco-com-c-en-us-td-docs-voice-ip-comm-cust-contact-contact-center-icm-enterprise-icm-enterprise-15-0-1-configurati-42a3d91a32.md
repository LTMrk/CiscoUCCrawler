---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-15-0-1-configurati-42a3d91a32
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_15_0_1/configuration/guide/ucce_b_serviceability-guide-for-cisco-unified-icm-contact-center-enterprise-release-15-0/cloud_connect_serviceability.html
retrieved_at: 2026-08-16T14:37:26.959399+00:00
---
...
You can collect and download the service logs from the Real Time Monitoring Tool (RTMT) interface. For instructions, see the Download Trace and Log Files section in the Serviceability Guide for Cisco Unified Contact Center Enterprise at https://www.cisco.com/c/en/us/support/customer-collaboration/unified-contact-center-enterprise/products-installation-and-configuration-guides-list.html
...
MRD configuration counters

The following are the API details to access the MRD configuration counters:

URL: https://host_fqdn:8445/drapi/v1/metrics/mrdCounters
...
```
{
    "digitalRoutingMediaChannelSettings": {
        "name": "digitalRoutingMediaChannelSettings",
        "attributes": [
            {
                "mediaClassId": 4,
                "maxTaskDuration": 0,
...
To access the MRD configuration counters:

Navigate to com.cisco.ccbu.dr.mbeans > MRDConfigMXBean > MRDConfigMXBean > Attributes .

Click Attributes to view the MRD configuration counter attributes.
...
## Servicability for Cache Service

This section provides serviceability information for the cache service module.

The cache service module is a recent addition to the Cloud Connect system, designed to offer distributed caching to enhance
                           performance and decrease latency for data accessed frequently.

This module will become available after installing Cloud Connect 15.0(1)ES202511 on top of the Cloud Connect 15.0(1) FCS build.

### Prerequisites

Ensure that you have installed the following:

Cloud Connect 15.0(1) FCS build

Latest ES COP applied - cloudconnect 15.0(1)-ES202511

Appropriate system permissions for configuration and log directories

Java Runtime Environment (included with Cloud Connect)
...
```
utils cloudconnect cache-service start
```
...
```
utils cloudconnect cache-service stop
```

### Restart the Service

To restart the service, run the following command to stop the cache service and start the cache service:
