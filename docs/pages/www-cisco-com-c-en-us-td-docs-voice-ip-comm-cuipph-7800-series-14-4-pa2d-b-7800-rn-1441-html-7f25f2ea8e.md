---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-7800-series-14-4-pa2d-b-7800-rn-1441-html-7f25f2ea8e
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/7800-series/14-4/pa2d_b_7800-rn-1441.html
retrieved_at: 2026-08-17T01:07:43.822605+00:00
---

Cisco IP Phone 7800 Release Notes for Firmware Release 14.4(1)
...
These release notes support the Cisco IP Phones 7811, 7821, 7841, and 7861 running SIP Firmware Release 14.4(1).
...
The firmware filename is cmterm-78xx.14-4-1-0001-36.k4.cop.sha512.
...
The firmware file name is cmterm-78xx.14-4-1-0001-36_REL.zip, depending on the model you choose.
...
CSCwp21258 7861 PC port has been disabled from the CUCM, but user can re-enable that port from the phone settings menu by
...
| Step 5 | Select the firmware file, click the Download or Add to cart button, and follow the prompts: The firmware filename is cmterm-78xx.14-4-1-0001-36.k4.cop.sha512. Note If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . | Note | If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . |
...
| Step 5 | Select the firmware file, click the Download or Add to Cart button, and follow the prompts. The firmware file name is cmterm-78xx.14-4-1-0001-36_REL.zip, depending on the model you choose. |
