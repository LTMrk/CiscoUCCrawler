---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-connection-12x-install-upgrade-guide-b-12xcuciumg-b-12xcuciumg-chapter-01-ht-3164a57df9
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/install_upgrade/guide/b_12xcuciumg/b_12xcuciumg_chapter_01.html
retrieved_at: 2026-08-17T02:27:42.178286+00:00
---
...
Create a user
                                    			 with mailbox with an alias “system-backup-and-restore-admin” and assign him a
                                    			 corporate email id to receive the restore point creation alerts or failure
                                    			 notifications. For more information on how to create a user, see Users chapter
                                    			 of System Administration Guide for Cisco Unity Connection Release
                                       				12.x at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/os_administration/b_12xcucosagx.html
...
After
                                             			 successfully restoring the Unity Connection server components using any of the
                                             			 above mentioned tool, you must register the Unity Connection with Cisco Smart
                                             			 Software Manager (CSSM) or Cisco Smart Software Manager satellite. If the
                                             			 product was already registered before taking the backup, you must reregister
                                             			 the product for updating the license information.

For more
                                             			 information on how to register the product with CSSM or satellite, see " Managing
                                                				Licenses " chapter.
...
| Note | After
                                             			 ...
                                             			 Software Manager (CSSM) or Cisco Smart Software Manager satellite. If the
                                             			 product was already registered before taking the backup, you must reregister
                                             			 the product for updating the license information. For more
                                             			 information on how to register the product with CSSM or satellite, see " Managing
                                                				Licenses " chapter. |
|---|---|