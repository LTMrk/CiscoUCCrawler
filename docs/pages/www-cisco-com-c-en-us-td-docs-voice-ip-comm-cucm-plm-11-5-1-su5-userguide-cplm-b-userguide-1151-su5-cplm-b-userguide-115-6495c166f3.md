---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-plm-11-5-1-su5-userguide-cplm-b-userguide-1151-su5-cplm-b-userguide-115-6495c166f3
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/plm/11_5_1_SU5/userguide/CPLM_b_userguide_1151_SU5/CPLM_b_userguide_1151_SU5_chapter_011.html
retrieved_at: 2026-09-08T04:54:29.909411+00:00
---
...
Click Install/Upgrade from Network (this option
...
Click Start
                                          			 ...
                                          			 upgrade. Click Continue to begin the upgrade.
...
Define the media source of the virtual machine. For example, is it an ISO file in the datastore or a physical optical drive
                                 on the client or host. Check the Connected checkbox for the VM CD/DVD drive.
...
Click Install/Upgrade from DVD/CD drive on Cisco Prime License Manager
                                             				server .
...
To upgrade the software from an FTP server, use the following procedure. Keep in mind that this procedure uses example software
                                 versions. For the latest software version, see the appropriate Release Notes for Cisco Prime License Manager .
...
Enter
                                          			 Directory, Server, User Name, and Password information when prompted.
...
Select option 1 to download upgrade file.
...
A system reboot is required when the upgrade process completes or is canceled. This will ensure services affected by the upgrade
...
When
                                          			 asked to automatically switch versions if the upgrade is successful, enter yes.
...
Enter yes to start installation.
...
| Step 6 | Click Start
                                          			 ...
                                          			 upgrade. Click Continue to begin the upgrade. Note You can leave
                                                         				  ...
                                                         				  progress of the upgrade, or close the browser. The upgrade proceeds even if you close the browser. The upgrade may take
...
| Step 6 | Click Continue to begin the upgrade. Note You can either leave the
                                                         				  screen up while the upgrade is in progress or close your browser. Closing your browser does not impact the upgrade process.
                                                         The upgrade may take 45 minutes to an hour to
...
| Step 5 | Select option 1 to download upgrade file. Accessing the file. Please wait... Validating the file... Downloaded 935 MB. Checksumming the file... A system reboot is required when the upgrade process completes or is canceled. This will ensure services affected by the upgrade
                                                process are functioning properly. Downloaded: CiscoPrimeLM_64bitLnx_10.0.0.98030-1.sgn.iso File version: 10.0.0.98030-1 File checksum: c4:13:ad:95:7b:c8:c1:01:1b:91:bb:da:8d:84:09:ea |
| Step 6 | When
...
| Step 3 | Select option
                                          			 3. |
| Step 4 | Select option 1 to download upgrade file. Accessing the file. Please wait... Validating the file... Downloaded 935 MB. Checksumming the file... A system reboot is required when the upgrade process completes or is canceled. This will ensure services affected by the upgrade
                                                process are functioning properly. Downloaded: CiscoPrimeLM_64bitLnx_10.0.0.98030-1.sgn.iso File version: 10.0.0.98030-1 File checksum: c4:13:ad:95:7b:c8:c1:01:1b:91:bb:da:8d:84:09:ea |
| Step 5 | When
