...
The following software versions apply to Release 12.5(1)SU4:
...
Before you upgrade to Release 12.5(1) or above, we recommend that you work with your channel partner or account team to use
                              the Cisco Collaboration Sizing Tool to compare your current deployment to an upgraded 12.5(1)SU4 deployment. If required,
