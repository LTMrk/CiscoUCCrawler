---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-admin-14su2-admingd-cucm-b-administration-guide-14su2-cucm-b-test-admin-52c516db0d
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/admin/14SU2/adminGd/cucm_b_administration-guide-14su2/cucm_b_test-adminguide_chapter_0110.html
retrieved_at: 2026-08-17T00:40:33.472306+00:00
---
...
Endpoints firmware downloads fail part the way through, the entire download restarts or the download appears to be very slow.

Important

Possible reasons:

This is likely due to network issues or congestion, and may be more prevalent in bulk upgrade scenarios.

If you are running 14SU1, you can potentially benefit from HTTP range requests (RFC7233) support on TFTP and Proxy TFTP (if
                                             the download file is at least 100MB).

Endpoints that support HTTP range requests can benefit from improved reliability and download speed, especially in bulk phone
                                             upgrade scenarios or in poor network conditions.

HTTP range requests should allow the download to pause and resume; meaning, interrupted downloads can continue from the last
                                             known successful byte-range without having to restart the entire download again.

Cisco Webex Wireless Phone 840 and 860 support RFC7233. Devices that don’t support RFC7233 are not affected by this feature.
...
| Endpoints firmware downloads fail part the way through, the entire download restarts or the download appears to be very slow. Important Applicable from Release 14SU1 onwards. | Important | Applicable from Release 14SU1 onwards. | Possible reasons: This is likely due to network issues or congestion, and may be more prevalent in bulk upgrade scenarios. If you are running 14SU1, you can potentially benefit from HTTP range requests (RFC7233) support on TFTP and Proxy TFTP (if
                                             the download file is at least 100MB). Endpoints that support HTTP range requests can benefit from improved reliability and download speed, especially in bulk phone
                                             upgrade scenarios or in poor network conditions. HTTP range requests should allow the download to pause and resume; meaning, interrupted downloads can continue from the last
                                             known successful byte-range without having to restart the entire download again. Cisco Webex Wireless Phone 840 and 860 support RFC7233. Devices that don’t support RFC7233 are not affected by this feature. |
