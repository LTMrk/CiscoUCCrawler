...
Cisco Emergency Responder Release 12.5(1)SU7 supports the following new feature:
...
The information in the following sections discuss Hardware and Software requirements for Cisco Emergency Responder 12.5(1)SU7.
...
CER—No ethernet link detected after VM upgrade/move or ESXi upgrade

CSCwb21404

Backup CTI Manager 1&2 character limitation for table backup provider
