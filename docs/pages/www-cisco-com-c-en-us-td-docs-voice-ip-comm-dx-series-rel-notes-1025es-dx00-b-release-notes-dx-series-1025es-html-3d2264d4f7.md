---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-dx-series-rel-notes-1025es-dx00-b-release-notes-dx-series-1025es-html-3d2264d4f7
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/dx/series/rel-notes/1025es/dx00_b_release-notes-dx-series-1025es.html
retrieved_at: 2026-08-22T00:56:57.430930+00:00
---

Release Notes for Cisco DX Series Firmware Release 10.2(5)ES
...
- For Cisco DX70: cmterm-dx70.10-2-5-215.k3.cop.sgn

- For Cisco DX80: cmterm-dx80.10-2-5-215.k3.cop.sgn

- For Cisco DX650: cmterm-dx650.10-2-5-215.k3.cop.sgn

- For all Cisco DX Series devices: cmterm-dxseries.10-2-5-215.k3.cop.sgn
...
- For Cisco DX70: cmterm-dx70.10-2-5-215.zip

- For Cisco DX80: cmterm-dx80.10-2-5-215.zip

- For Cisco DX650: cmterm-dx650.10-2-5-215.zip
...
There is a known issue with Cisco DX650 speakerphone calls. If one side’s audio level is higher than the other side’s, then the other side’s audio will be attenuated. This means that it is possible the speakers might not be able to hear each other, or that the volume of the far end will be reduced significantly. Adjusting the volume to 70% or less may help to improve this situation, but at higher volume levels this is expected behavior. If adjusting the volume does not improve the situation, we recommend using the handset or a headset for your calls instead.

Cisco DX650 endpoints cannot take the NTP servers specified in CUCM device pool configuration. Instead they reach 2.android.pool.ntp.org. The only possible workaround found so far is overwrite the DNS configuration on the DNS server to resolve 2.android.pool.ntp.org to the local NTP server. If there's no control over the subnets, all Android devices in the company network will access the local NTP server.
...
| CSCvc44073 | Display on DX80 flickers |
|---|---|
...
| Step 4 | In the Latest Releases folder, choose 10.2(5.215) . |
| Step 5 | Select one of the following firmware files, click the Download or Add to cart button, and follow the prompts: For Cisco DX70: cmterm-dx70.10-2-5-215.k3.cop.sgn For Cisco DX80: cmterm-dx80.10-2-5-215.k3.cop.sgn For Cisco DX650: cmterm-dx650.10-2-5-215.k3.cop.sgn For all Cisco DX Series devices: cmterm-dxseries.10-2-5-215.k3.cop.sgn Note If you added the firmware file to the cart, click the Download Cart link when you are ready to download the file. | Note | If you added the firmware file to the cart, click the Download Cart link when you are ready to download the file. |
...
| Step 3 | Choose your device type. |
| Step 4 | In the Latest Releases folder, choose 10.2(5.215) . |
| Step 5 | Download the relevant zip files. For Cisco DX70: cmterm-dx70.10-2-5-215.zip For Cisco DX80: cmterm-dx80.10-2-5-215.zip For Cisco DX650: cmterm-dx650.10-2-5-215.zip |
