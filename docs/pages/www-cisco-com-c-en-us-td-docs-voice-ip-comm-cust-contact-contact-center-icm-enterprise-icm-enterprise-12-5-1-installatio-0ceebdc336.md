---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-12-5-1-installatio-0ceebdc336
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_12_5_1/installation/guide/ucce_b_12_5_Install_upgrade_guide_ucce/ucce_b_cisco-unified-contact-center-enterprise12_5_chapter_01000.html
retrieved_at: 2026-08-16T19:53:16.603186+00:00
---
...
The certificate CommonName (CN) must match the Fully Qualified Domain Name (FQDN) provided for the CCE components in the CCE
                                                Inventory.
...
|---|---|---|
| AW Machines | Unified CCE Components (Router, Logger 4 , Rogger 5 , PGs, and HDS) | Import CCE Component Certificates Import Diagnostic Framework Portico Certificate into AW Machines |
...
| Important | The certificate CommonName (CN) must match the Fully Qualified Domain Name (FQDN) provided for the CCE components in the CCE
                                                Inventory. |
|---|---|
