---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-finesse-finesse-1262-user-guide-cfin-b-1262-cisc-2952ad5120
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/finesse/finesse_1262/user/guide/cfin_b_1262_cisco-desktop-user-guide/cfin_m_1261-preface-desktop-guide.html
retrieved_at: 2026-08-16T20:42:56.244021+00:00
---
...
Introduced Manage Digital Channels gadget.

Common Tasks>Sign In to Cisco Finesse Desktop>Manage Digital Channels gadget

Updated the Multi-Tab Gadgets topic.

Cisco Finesse Desktop Interface>Finesse Desktop Behavior>Multi-Tab Gadgets

Added the Reset Layout for Current Page topic.

Common Tasks>Drag-and-Drop and Resize Gadget or Component>Reset Layout for Current Page

Updated the Drag-and-Drop and Resize Gadget or Component topic.

Common Tasks>Drag-and-Drop and Resize Gadget or Component

## About This Guide

Cisco Finesse has undergone a user experience refresh in release 12.0(1). This guide documents the new look and feel of the
                           Agent and Supervisor desktop layouts along with release specific features.

This guide describes how to use the Finesse agent and supervisor desktop.

## Audience

This guide is intended for Unified Contact Center Enterprise ( Unified CCE ) and Packaged Contact Center Enterprise (Packaged CCE) for Contact Center agents and supervisors who use Finesse desktop.
...
| Introduced Manage Digital Channels gadget. | Common Tasks>Sign In to Cisco Finesse Desktop>Manage Digital Channels gadget |
| Updated the Multi-Tab Gadgets topic. | Cisco Finesse Desktop Interface>Finesse Desktop Behavior>Multi-Tab Gadgets |
| Added the Reset Layout for Current Page topic. | Common Tasks>Drag-and-Drop and Resize Gadget or Component>Reset Layout for Current Page |
| Updated the Drag-and-Drop and Resize Gadget or Component topic. | Common Tasks>Drag-and-Drop and Resize Gadget or Component |
