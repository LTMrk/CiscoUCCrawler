---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-bat-12-5-1-cucm-b-bulk-administration-guide-1251-cucm-b-bulk-administra-f2cfd28432
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/bat/12_5_1/cucm_b_bulk-administration-guide-1251/cucm_b_bulk-administration-guide-1251_chapter_011101.html
retrieved_at: 2026-08-21T17:57:19.669277+00:00
---
...
For more information that is related to CiscoUnifiedCommunications Manager Assistant, see the Cisco Unified Communications Manager Features and Services Guide and the Cisco Unified Communications Manager Assistant User Guide .
...
Refer to the Cisco Unified Communications Manager Features and Services Guide for information about running the CiscoUnifiedCM Assistant Configuration Wizard.
...
| Step 1 | Set up and
                                          			 ...
                                          			 space for the CiscoUnifiedCM Assistant service. To run the CiscoUnifiedCM
                                          			 Assistant Configuration Wizard, ensure BAT and the wizard are on the same
                                          			 server. Refer to the Cisco Unified Communications Manager Features and Services Guide for information about running the CiscoUnifiedCM Assistant Configuration Wizard. Note You can use
                                                         				  the CiscoUnifiedCM Assistant Configuration Wizard only one time to set up the
                                                         				  UnifiedCM Assistant configuration requirements for your system. After running
                                                         				  the configuration wizard, you can only view, but not change, your configuration
