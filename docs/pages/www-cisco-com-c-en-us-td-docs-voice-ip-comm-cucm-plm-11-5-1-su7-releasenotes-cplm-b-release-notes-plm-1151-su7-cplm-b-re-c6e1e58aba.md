...
The following table lists severity 1, 2, and 3 defects that are resolved for Cisco Prime License Manager 11.5(1)SU7. For more
                              information about an individual caveat, click the Identifier.

Headline

CSCvq97227

Cisco Prime License Manager Unauthorized Password Reset Vulnerability
