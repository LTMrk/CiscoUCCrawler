---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-jvdi-12-1-hp-ubuntu-rns-jvdi-b-release-notes-jvdi-hp-ubuntu-12-1-html-2bf23152c9
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/jvdi/12_1/hp_ubuntu/rns/jvdi_b_release-notes-jvdi-hp-ubuntu-12-1.html
retrieved_at: 2026-09-01T18:02:23.752226+00:00
---

Release Notes for Cisco Jabber Softphone for VDI—HP Thin Pro and Ubuntu Release 12.1
...
These release notes describe new features, requirements, restrictions, and caveats for Cisco Jabber Softphone for VDI for HP Thin Pro and Ubuntu Release 12.1. These release notes are updated for every maintenance release but not for patches
                  or hot fixes.
...
### Prerequisites File for HP Thin Pro

In preparation to install Cisco Jabber Softphone for VDI on HP Thin Pro hardware, visit the HP website to obtain the installation files. Download the prerequisites file that corresponds
                        to your Cisco Jabber Softphone for VDI release and to the HP platform image:

cisco-jvdi12.x.x-pre-reqs-thinpro6.2.0-hp1d.xar
...
Connection broker for the hosted virtual desktop 1
...
There are no closed bugs in Cisco Jabber Softphone for VDI—HP Thin Pro and Ubuntu Release 12.1.
...
|---|---|
| HP Thin Pro thin clients—Hardware | The following client hardware is supported with HP Thin Pro 6.2: HP t520 HP t530 HP t620 HP t630 HP t730 HP mt20 HP mt21 |
...
| Citrix Receiver or VMware Horizon Client 2 (Installed on the thin client) | For HP Thin Pro 6.2.0 The HP Thin Pro image includes Citrix and VMware: ICA Client: 13.5.0 or later (32 bit version required) VMware 4.4.0 or later (32 bit version required) For Ubuntu ICA Client V–13.3.0.344519 or later 13.3 versions VMware Horizon View Client V–4.0.1-3698616 |
| Cisco Unified Communications client on the hosted virtual desktop: Cisco Jabber for Windows or Cisco UC Integration™ for Microsoft Lync | Cisco Jabber for Windows 12.0 running on the hosted virtual desktop (HVD). Cisco Jabber Softphone for VDI is compatible with all future 12.0(X) Cisco Jabber for Windows versions. For complete information about virtual environment compatibility, see the Jabber installation documentation for your release. |
