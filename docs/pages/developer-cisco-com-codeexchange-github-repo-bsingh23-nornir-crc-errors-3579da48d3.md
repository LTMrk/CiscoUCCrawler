---
doc_id: developer-cisco-com-codeexchange-github-repo-bsingh23-nornir-crc-errors-3579da48d3
source_url: https://developer.cisco.com/codeexchange/github/repo/bsingh23/nornir_crc_errors
retrieved_at: 2026-08-21T08:17:26.462331+00:00
---
...
```
host_name : hostname : ip_address platform : ios username : username password : password groups : (Optional) - <group_name>
```
...
Modify the config_test.yaml file in the nornir directory with your specific settings.
...
The script will create a CSV file in the same directory as the script with the following name format: crcerror_<current_datetime>.csv .
