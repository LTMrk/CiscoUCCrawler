---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-expressway-config-guide-x14-2-mra-exwy-b-mra-deployment-guide-x142-exwy-m-ba-546442cc1e
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/expressway/config_guide/X14-2/mra/exwy_b_mra-deployment-guide-x142/exwy_m_basic-configuration.html
retrieved_at: 2026-08-16T15:20:26.522744+00:00
---
...
| Note | Load balancing is managed by Unified CM when it passes routing information back to the registering endpoints. The load is distributed across the nodes based on resource usage. Endpoints receives the least loaded node to reach CUCM.
                                                   There is no load balancing of calls, only the initial registrations are load balanced. As the registrations are load balanced,
                                                   probability of calls overloading on a single node is reduced. |
|---|---|
