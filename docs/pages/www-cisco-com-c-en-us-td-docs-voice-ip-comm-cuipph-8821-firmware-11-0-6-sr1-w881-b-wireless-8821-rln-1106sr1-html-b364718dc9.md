---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-8821-firmware-11-0-6-sr1-w881-b-wireless-8821-rln-1106sr1-html-b364718dc9
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/8821/firmware/11-0-6-SR1/w881-b-wireless-8821-rln-1106sr1.html
retrieved_at: 2026-08-21T13:34:43.996205+00:00
---

Cisco Wireless IP Phone 8821 and 8821-EX Release Notes for Firmware Release 11.0(6)SR1
...
These release notes support the 11.0(6)SR1 firmware release for the Cisco Wireless IP Phone 8821 and 8821-EX .
...
For more details about compatible wireless access points, see the Cisco Wireless IP Phone 8821 and 8821-EX Wireless LAN Deployment Guide at: https://www.cisco.com/c/en/us/support/collaboration-endpoints/unified-ip-phone-8800-series/products-implementation-design-guides-list.html .
...
### Install Firmware Release 11.0(6)SR1 on Cisco Unified
                     				Communications Manager
...
If you try to install the sha512 COP file on a Cisco Unified
                                       				Communications Manager that doesn't support the sha512 checksum, then the COP file won't appear in the list of available files.

To enable sha512 checksum support, install ciscocm.enable-sha512sum-2021-signing-key-v1.0.cop.sgn. For more information, see: https://www.cisco.com/web/software/282204704/18582/ciscocm.enable-sha512sum-2021-signing-key-v1.0.cop.sgn-COP-Readme.pdf .

Go to the following Software Download URL for the IP Phone 8800 Series :
...
From the Latest Releases folder, click 11.0(6)SR1 .

Click either Download or Add to Cart next to the firmware file, and follow the prompts.

Firmware file: cmterm-8821-sip.11-0-6SR1-4.k3.cop.sha512
...
For information about Cisco Unified
                           				Communications Manager Express support, see http://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucme/feature/phone_feature/phone_feature_support_guide.html .

For more information about this procedure, see the "Install and Upgrade Cisco Unified CME Software" chapter in the Cisco Unified Communications Manager Express System Administrator Guide at: http://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucme/admin/configuration/manual/cmeadm.html .
...
Zip file: cmterm-8821.11-0-6SR1-4.zip
...
Perform one of the following actions to view bugs for the 11.0(6)SR1 release of the Cisco Wireless IP Phone 8821 and 8821-EX :

Use this URL to view all bugs:

https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286308995&rls=11.0%286%29SR1&sb=anfr&bt=custV

Use this URL to view all open bugs:

https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286308995&rls=11.0%286%29SR1&sb=afr&bt=custV

Use this URL to view all resolved bugs:

https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286308995&rls=11.0%286%29SR1&sb=fr&bt=custV
...
The following list contains a snapshot of the severity 1, 2, and 3 bugs that were open at the time of the Cisco Wireless IP Phone 8821 and 8821-EX Firmware Release 11.0(6)SR1.
...
The following list contains a snapshot of the severity 1, 2, and 3 bugs that were resolved at the time of the Cisco Wireless IP Phone 8821 and 8821-EX Firmware Release 11.0(6)SR1.
...
CSCvu55114 Sometimes WLAN diag return NULL for WLAN profile

CSCvv33964 8821 Detail Softkey is not displaying the conference list

CSCvv43485 TCP Sequence Number Approximation Based Denial of Service (CVE-2004-0230)

CSCvv55620 With SRST enabled, can't reset or power off 8821 when coming back in range from OOR

CSCvv75671 Unexpected behavior is seen when click to enter into visual voicemail app

CSCvw00918 Wireless IP Phone 8821 Multiple Vulnerabilities in dnsmasq

CSCvw41879 Increase the timeout value for an association response from an access point

CSCvw91845 Phone can't stop vibrating after answering hold reverted call from share line
...
| Step 3 | Click Session Initiation Protocol (SIP) Software . |
| Step 4 | From the Latest Releases folder, click 11.0(6)SR1 . |
| Step 5 | Click Download or Add to Cart next to the following zip file and follow the prompts. Zip file: cmterm-8821.11-0-6SR1-4.zip |
| Step 6 | Extract the files from the zip file, manually copy them to the Cisco Unified
                                    				Communications Manager Express TFTP server (router flash), and enable them for TFTP. |

| Step 1 | Perform one of the following actions to view bugs for the 11.0(6)SR1 release of the Cisco Wireless IP Phone 8821 and 8821-EX : Use this URL to view all bugs: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286308995&rls=11.0%286%29SR1&sb=anfr&bt=custV Use this URL to view all open bugs: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286308995&rls=11.0%286%29SR1&sb=afr&bt=custV Use this URL to view all resolved bugs: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=286308995&rls=11.0%286%29SR1&sb=fr&bt=custV |
|---|---|
