---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-15-0-1-user-ucce-b-82b21998ec
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_15_0_1/user/ucce_b_150_outbound-option-guide-for-unified/dialer_detail_table.html
retrieved_at: 2026-08-16T20:35:48.713368+00:00
---
...
Depend on the PersonalCallbackReattemptNoRingBack registry settings in the Campaign Manager.

If it is set to 1, the call counted as attempt is No.

If it is set to 0, the call counted as attempt is Yes.

No

If the call counted as attempt is No, the retry action becomes Retry Next Business Day.

If the call counted as attempt is Yes, the retry action becomes No Answer.
...
| 4 | No ringback from network when dial attempted | NoRingBack | Depend on the PersonalCallbackReattemptNoRingBack registry settings in the Campaign Manager. If it is set to 1, the call counted as attempt is No. If it is set to 0, the call counted as attempt is Yes. | No | If the call counted as attempt is No, the retry action becomes Retry Next Business Day. If the call counted as attempt is Yes, the retry action becomes No Answer. |
