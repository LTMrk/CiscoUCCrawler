---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-vg248-1-1-english-configuration-guide-sw-confg-vg248swp-html-6b0e2d4cb3
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/vg248/1_1/english/configuration/guide/sw_confg/vg248swp.html
retrieved_at: 2026-08-22T01:19:37.318802+00:00
---
...
• Configuring the VG248 Analog Ports
...
the MAC address registered for port 12 in Cisco CallManager is 0039A4421812

After adding each port, make configuration changes as described in the "Configuring the VG248 Analog Ports" section .
...
• Configure each port as described in the "Configuring the VG248 Analog Ports" section .
...
After these phones are added to Cisco CallManager, treat them as you would any other phone in your IP telephony network. You need to add directory numbers, calling search space, and so on. Refer to the documentation and online help included with Cisco CallManager for details.

If you are using any ports on the VG248 for SMDI connections, refer to the "Configuring VG248 SMDI Ports in Cisco CallManager" section on page 5-13 for details.