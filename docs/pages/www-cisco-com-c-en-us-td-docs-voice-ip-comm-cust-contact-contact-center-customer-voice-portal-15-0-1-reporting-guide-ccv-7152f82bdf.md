---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-customer-voice-portal-15-0-1-reporting-guide-ccv-7152f82bdf
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/customer_voice_portal/15-0-1/reporting/guide/ccvp_b_150_reporting-guide-for-cisco-unified-customer-voice-portal/cvp_m_150_database-management.html
retrieved_at: 2026-08-21T03:04:23.691269+00:00
---
...
The CVP Reporting users cvp_dbadmin and cvp_dbuser must remain members of both local administrators group and Informix administrators group. These group memberships are required
                                          for database management, administration, and application access. Modifying or removing these users from the required groups
                                          will result in a complete loss of CVP Reporting functionality, backup and recovery failures, and potential service outages.
                                          This configuration is mandatory and must not be changed.
...
Increased
                              		  database space availability, as documented in the Solution Design Guide for Cisco Unified Contact Center Enterprise ,
                              		  increase the data retention times.
...
Storing a backup on the local machine does not protect against failure of that machine or loss of a site.

Important

You must manually or automatically create a job to copy the cvp_backup_data.old.gz file to a separate machine, at a separate location. Again, the user is responsible for managing backup data.
...
| Important | The CVP Reporting users cvp_dbadmin and cvp_dbuser must remain members of both local administrators group and Informix administrators group. These group memberships are required
                                          for database management, administration, and application access. Modifying or removing these users from the required groups
                                          will result in a complete loss of CVP Reporting functionality, backup and recovery failures, and potential service outages.
                                          This configuration is mandatory and must not be changed. |
|---|---|
...
| Important | You must manually or automatically create a job to copy the cvp_backup_data.old.gz file to a separate machine, at a separate location. Again, the user is responsible for managing backup data. |
|---|---|
