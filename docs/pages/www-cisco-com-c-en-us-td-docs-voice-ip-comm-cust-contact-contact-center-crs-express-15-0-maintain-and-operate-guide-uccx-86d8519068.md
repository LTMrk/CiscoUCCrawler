---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-crs-express-15-0-maintain-and-operate-guide-uccx-86d8519068
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/crs/express_15_0/maintain_and_operate/guide/uccx_b_1501_admin-and-operations-guide/uccx_m_1501_tools-menu.html
retrieved_at: 2026-08-16T21:28:34.207772+00:00
---
...
Go to OpenWebStart to download the installer for your operating system.

We recommend you download OpenWebStart v1.5.2.

Follow the instructions on the setup wizard and click Finish to complete the installation.

OpenWebStart is installed in your system.

#### What to do next

OpenWebStart allows you to add the installed Java Virtual Machines (JVMs) on your local file system. To add the locally available
                                 JVM, do the following:

Go to OpenWebStart > itw-settings (Windows) or OpenWebstart > OpenWebStart Settings (MacOS).

The Updater - OpenWebStart dialog box appears.

Click JVM Manager in the left pane. A list of locally available JVMs appears. Do one of the following:

If the installed JVM version is available in the list of JVMs, select it.

If the installed JVM version is not available in the list of JVMs, do the following:

Click Add local... .

The Select JVM dialog box appears.

Navigate to your Java folder and select the required JRE/JDK version. Click Open .

The selected JRE/JDK version appears in the JVM Manager area.

Click OK to associate the Java version with OpenWebStart.
...
The ODBC connections to Unified CCX supports encryption.
...
| Data Writing Interval | Sets the refresh interval for the wallboard data. Valid options: 5, 10, 15, 20, and 25. |
...
| Step 1 | Install the wallboard software and IBM Informix ODBC Driver (IDS
                                          			 Version 3.0.0.13219 and above) on the wallboard client desktop. Note You can download the Informix ODBC driver from the following URL: https://www-01.ibm.com/marketing/iwm/iwm/web/pickUrxNew.do?source=ifxdl . Download the IBM Informix Client Software Development Kit (CSDK) Version 3.00 or higher for the operating system you are
                                                               installing with the wallboard client. More information about the CSDK can be found at the following URL: http://www.ibm.com/software/data/informix/tools/csdk/ . The ODBC connections to Unified CCX supports encryption. | Note | You can download the Informix ODBC driver from the following URL: https://www-01.ibm.com/marketing/iwm/iwm/web/pickUrxNew.do?source=ifxdl . Download the IBM Informix Client Software Development Kit (CSDK) Version 3.00 or higher for the operating system you are
                                                               installing with the wallboard client. More information about the CSDK can be found at the following URL: http://www.ibm.com/software/data/informix/tools/csdk/ . The ODBC connections to Unified CCX supports encryption. |
|---|---|---|---|
