---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-15-0-1-program-gui-48516949a9
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_15_0_1/Program/guide/ucce_b_cisco-unified-contact-center-enterprise-developer-reference-release-15-0/ucce_m_working-with-unified-cce-apis_1501.html
retrieved_at: 2026-08-16T20:14:28.657587+00:00
---
...
In all Unified CCE API URLs or examples, replace <server> with the Fully Qualified Domain Name (FQDN) of your Admin Workstation.
...
When updating an attribute, supervisors can only modify the collection of agentAttributes by adding, removing, or changing
                                          the value of agents who are on their teams.
...
When updating a skill group, supervisors can only modify the collections of agents by adding or removing agents who are on
                                          their teams.
...
The type of Contact Center AI features and supported values are Transcript, .
...
| See | Updated | Date |
|---|---|---|
| Agent API | Add ciPerson detaila | October 2025 |
| Agent API | Added a note related to API access for supervisors and administrators. | Feburary 2025 |
| Agent Team API |

| Note | In all Unified CCE API URLs or examples, replace <server> with the Fully Qualified Domain Name (FQDN) of your Admin Workstation. |
|---|---|
