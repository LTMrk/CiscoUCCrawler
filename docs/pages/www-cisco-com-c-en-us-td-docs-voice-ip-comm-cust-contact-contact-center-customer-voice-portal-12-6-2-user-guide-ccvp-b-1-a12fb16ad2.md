...
Select the Select root directory radio button, and browse to the location where you want to import the Call Studio application.

Step 3

In the Projects section, select the following radio buttons:
...
| Step 1 | Select File > Import > General > Existing Projects into Workspace and click Next . |
|---|---|
| Step 2 | Select the Select root directory radio button, and browse to the location where you want to import the Call Studio application. |
| Step 3 | In the Projects section, select the following radio buttons: Search for nested projects Copy projects into workspace |
| Step 4 | Click Finish . |
| Step 5 | Click Yes To All when prompted. |
