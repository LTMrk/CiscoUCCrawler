---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-expressway-install-guide-x14-3-virtual-machine-exwy-b-cisco-expressway-on-vi-cbe3891145
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/expressway/install_guide/X14-3/virtual-machine/exwy_b_cisco-expressway-on-virtual-machine-installation-guide-x143/exwy_m_system-requirements.html
retrieved_at: 2026-08-16T22:12:11.968762+00:00
---
...
From X14.2 release and later versions, EXSi 6.5 Update 2a, ESXi 7.0 Update 3, ESXi 7.0 Update 3c, and ESXi 7.0 Update 3d are
                                    supported.
...
This issue applies to  running as virtualized systems with certain ESXi versions using VMWare vCenter 7.0.x. It was found
                                    during testing using VMWare vCenter 7.0.1 with ESXi 6.7.0 to deploy . The Ready to complete final page of the Deploy OVF Template wizard displays template values instead of the actual values entered on the earlier wizard pages. The issue is cosmetic,
