---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-connection-vmo-b-1253cucvmorn-html-fb1ce73316
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/vmo/b_1253cucvmorn.html
retrieved_at: 2026-08-16T18:49:57.139064+00:00
---

Release Notes for Cisco Unity Connection ViewMail for Microsoft Outlook Release 12.5(3)
...
# Release Notes for Cisco Unity Connection ViewMail for Microsoft Outlook (VMO) Release 12.5(3)

These release notes contain requirements, download, installation, configuration instructions, new and changed requirements,
               support, limitations and restrictions, and caveat information for VMO Release 12.5(3).

VMO 12.5(3) is available only from the Cisco Download Software website.
...
1 Single Inbox is not designed to sync the status of the messages for sent item folder.
...
- The “Matrices for Unity Connection 12.x and Cisco Business Edition 6000/7000” section of Compatibility Matrix for Cisco Unity Connection at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/compatibility/matrix/b_cucclientmtx.html .
...
- For a list of all languages available for VMO, see the “Available Languages for Cisco Unity Connection Components” section
                           of System Requirements for Cisco Unity Connection Release 12.x at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/requirements/b_12xcucsysreqs.html .

VMO 12.5(3) is compatible with Cisco Unity Connection 12.x, 11.x and 10.x.
...
## New and Changed Requirements and Support—Release 12.5(3)

There is no new and changed requirements and support in the 12.5(3) release time frame.

### Additional Languages for VMO

No new locales are available for VMO 12.5(3).

## New and Changed Functionality—Release 12.5(3)

This section contains information about new functionality in the View Mail for Outlook 12.5(3) release.

### Improving VMO Installation with Windows 10

In earlier releases, VMO requires Microsoft .NET Framework 3.5 and Microsoft DirectX on user workstation for successful installation.
                     However, VMO 12.5(3) removes these external dependencies for its installation on Windows 10 (32/64 bit).

VMO 12.5(3) provides below improvements for successful installation on Windows 10:

VMO 12.5(3) provides the support of Microsoft Direct X in its package.

VMO 12.5(3) uses inbuilt version of Microsoft .NET Framework available in the latest version of Windows 10 (32/64 bit).

For more information on .NET Framework on Windows 10, refer https://docs.microsoft.com/en-us/dotnet/framework/migration-guide/versions-and-dependencies

## Installation and
               	 Upgrade Information

### Task List for Installing VMO 12.5(3) for the First Time
...
- Download VMO from the Cisco Download Software website. See the “ Downloading VMO 12.5(3) ” section.

- Optional : Customize VMO setup. See the “ Customizing VMO Setup ” section.

- Optional : Provide users with VMO files for installation.

- Install VMO. Provide users with instructions, if applicable. See the “ Installing or Upgrading to VMO 12.5(3) ” section.
...
- Using the ViewMail Options or Settings dialog : Enter the required information. Provide users with instructions, if applicable. See the “ Installing VMO 12.5(3) Using Command Line Switches ” section.

### Task List for Upgrading to VMO 12.5(3)

If you are upgrading from a VMO version earlier than 12.5(3), see the “ Task List for Installing VMO 12.5(3) for the First Time ” section. The older version is uninstalled automatically, and installing 12.5(3) is considered a new installation.
...
- Upgrade VMO. Provide users with instructions, if applicable. See the “ Installing or Upgrading to VMO 12.5(3)
...
- The single-inbox feature is enabled.(See the Unified Messaging Guide for Cisco Unity Connection Release 12.x at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/unified_messaging/b_12xcucumgx.html .)
...
### Downloading VMO 12.5(3)

To Download VMO 12.5(3)
...
In the tree control on the download page, expand Products > Unified Communications > Unified Communications Applications> Messaging> Unity Connection , and select Unity Connection ViewMail for Microsoft Outlook Version 12.5(3) .

In the Latest Releases folder, select VMO 12.5(3) .
...
### Installing or Upgrading to VMO 12.5(3)
...
To Install or Upgrade to VMO 12.5(3)
...
Use this file for new installations and for upgrades from versions earlier than 12.5(3) It installs prerequisite software,
...
Use this file for quick minor upgrades for ViewMail 32-bit with versions 12.5(3) and later.

Use this file for quick minor upgrades for ViewMail 64-bit with versions 12.5(3) and later.

For successful installation and upgrade of VMO 12.5(3), you must download and run the setup.exe.
...
### Installing VMO 12.5(3) Using Command Line Switches

To install VMO 12.5(3) through command line switches :
...
Select the voicemail server type to associate with the email account.
...
In VMO 12.5(3) and later, if the user connects or disconnects the audio devices, it is recommended to restart Outlook, so
                              that VMO displays the status of currently attached recording and playback devices only.
...
### VMO 12.5(3) Limitations Regarding Icon Update when a Voice Message is read or unread

When a voice mail is marked read or unread using VMO 12.5(3), the state of voice mail Icon is not updated regardless of the
...
You can find the latest caveat information for VMO version 12.5(3) by using Bug Toolkit, an online tool available for customers
...
### Open Caveats—Release 12.5(3)

There is no open caveat in VMO version 12.5(3) release.

### Resolved Caveats—Release 12.5(3)

This section lists the resolved caveats for VMO 12.5(3) release. Click a link in the Caveat Number column to view the latest
...
ViewMail Stability Issues With 12.5.2 impacting the outlook performance and crash (64 bit).
...
VMO 32/64 bit installation fail on the windows only when .Net framework version > 3.5 is installed
...
| Note | VMO 12.5(3) is compatible with Cisco Unity Connection 12.x, 11.x and 10.x. |
|---|---|
...
| Note | If you are upgrading from a VMO version earlier than 12.5(3), see the “ Task List for Installing VMO 12.5(3) for the First Time ” section. The older version is uninstalled automatically, and installing 12.5(3) is considered a new installation. |
|---|---|
...
| Step 2 | In the tree control on the download page, expand Products > Unified Communications > Unified Communications Applications> Messaging> Unity Connection , and select Unity Connection ViewMail for Microsoft Outlook Version 12.5(3) . |
| Step 3 | In the Latest Releases folder, select VMO 12.5(3) . |
| Step 4 | On the right
                                 			 side of the page, select Download Now, and follow the on-screen prompts to
                                 			 complete the download. |
...
|---|---|
| Step 2 | In the
                                 			 ViewMail folder, double-click the applicable file: Setup.exe Use this file for new installations and for upgrades from versions earlier than 12.5(3) It installs prerequisite software,
                                                as needed; places the AdminConfig.xml file in the correct location; and uninstalls older versions during upgrades. This folder consists of two sub folders: Win32 : If you need to install 32-bit VMO. x64 : If you need to install 64-bit VMO. Note For silent installation of VMO, in AdminConfig.xml file, the user id should be the login name of the system whereas the username
                                                            and password should be the user name and password of Cisco Unity Connection. ViewMail.msi Use this file for quick minor upgrades for ViewMail 32-bit with versions 12.5(3) and later. ViewMail_64.msi Use this file for quick minor upgrades for ViewMail 64-bit with versions 12.5(3) and later. Note For successful installation and upgrade of VMO 12.5(3), you must download and run the setup.exe. | Setup.exe | Use this file for new installations and for upgrades from versions earlier than 12.5(3) It installs prerequisite software,
                                                as needed; places the AdminConfig.xml file in the correct location; and uninstalls older versions during upgrades. This folder consists of two sub folders: Win32 : If you need to install 32-bit VMO. x64 : If you need to install 64-bit VMO. Note For silent installation of VMO, in AdminConfig.xml file, the user id should be the login name of the system whereas the username
                                                            ...
                                                            and password should be the user name and password of Cisco Unity Connection. | ViewMail.msi | Use this file for quick minor upgrades for ViewMail 32-bit with versions 12.5(3) and later. | ViewMail_64.msi | Use this file for quick minor upgrades for ViewMail 64-bit with versions 12.5(3) and later. | Note | For successful installation and upgrade of VMO 12.5(3), you must download and run the setup.exe. |
| Setup.exe | Use this file for new installations and for upgrades from versions earlier than 12.5(3) It installs prerequisite software,
                                                as needed; places the AdminConfig.xml file in the correct location; and uninstalls older versions during upgrades. This folder consists of two sub folders: Win32 : If you need to install 32-bit VMO. x64 : If you need to install 64-bit VMO. Note For silent installation of VMO, in AdminConfig.xml file, the user id should be the login name of the system whereas the username
                                                            and password should be the user name and password of Cisco Unity Connection. | Note | For silent installation of VMO, in AdminConfig.xml file, the user id should be the login name of the system whereas the username
                                                            and password should be the user name and password of Cisco Unity Connection. |
| Note | For silent installation of VMO, in AdminConfig.xml file, the user id should be the login name of the system whereas the username
                                                            and password should be the user name and password of Cisco Unity Connection. |
| ViewMail.msi | Use this file for quick minor upgrades for ViewMail 32-bit with versions 12.5(3) and later. |
| ViewMail_64.msi | Use this file for quick minor upgrades for ViewMail 64-bit with versions 12.5(3) and later. |
| Note | For successful installation and upgrade of VMO 12.5(3), you must download and run the setup.exe. |
| Step 3 | Follow the
                                 			 on-screen prompts to complete the installation. |
| Step 4 | Restart
...
| Step 2 | Select Add , then
                                 			 select the account to associate with a voicemail server. |
| Step 3 | Enter the
                                 			 applicable information in each field: Voicemail Server Type Select the voicemail server type to associate with the email account. Username Enter the Cisco Unity Connection username (alias) of the user. Password Enter the user’s Cisco PCA password (also known as the web
                                                							 ...
                                                							 setting is required only if you want Unity Connection users to be able to
                                                							 record or play messages by using the phone. Recording Device Select the preferred device. Playback Device Select the preferred device. | Voicemail Server Type | Select the voicemail server type to associate with the email account. | Username | Enter the Cisco Unity Connection username (alias) of the user. | Password | Enter the user’s Cisco PCA password (also known as the web
                                                							 application password). | Voicemail Server Name | Enter the name of the voicemail server. | Voicemail Server Status | Display only. (Possible values are “Connected,” “Not Connected,” “Invalid
                                                							 Credentials,” and “Unknown.”) | Phone Number | Enter the extension or a phone number for the user. This
                                                							 setting is required only if you want Unity Connection users to be able to
...
| Voicemail Server Type | Select the voicemail server type to associate with the email account. |
...
| Note | In VMO 12.5(3) and later, if the user connects or disconnects the audio devices, it is recommended to restart Outlook, so
                              that VMO displays the status of currently attached recording and playback devices only. |
|---|---|
...
|---|---|---|---|
| CSCvs61764 | VMO | 3 | ViewMail Stability Issues With 12.5.2 impacting the outlook performance and crash (64 bit). |
| CSCvs48528 | VMO | 3 | VMO 32/64 bit installation fail on the windows only when .Net framework version > 3.5 is installed |