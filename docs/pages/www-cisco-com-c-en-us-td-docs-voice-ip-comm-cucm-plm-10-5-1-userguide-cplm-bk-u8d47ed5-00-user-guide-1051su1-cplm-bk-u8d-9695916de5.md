---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-plm-10-5-1-userguide-cplm-bk-u8d47ed5-00-user-guide-1051su1-cplm-bk-u8d-9695916de5
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/plm/10_5_1/userguide/CPLM_BK_U8D47ED5_00_user-guide-1051su1/CPLM_BK_U8D47ED5_00_user-guide-1051su1_chapter_0110.html
retrieved_at: 2026-09-08T05:02:25.463217+00:00
---
...
The Cisco Prime License
		  Manager OVA image is available for download at the Software Download Center, http:/​/​software.cisco.com , under Downloads Home
...
From the
					 list, choose the appropriate organization, unit, location, and state for your
					 installation.
...
Cisco
					 ...
					 that you choose No for the DHCP option and then enter a hostname, IP address, IP mask, and
					 gateway.
...
A system reboot is required, impacting all services relating to the
			 server. We recommend that you remove Cisco Prime License Manager during
			 off-peak hours.
...
You cannot restore Cisco Prime License Manager after it has been
			 removed.
...
| Step 1 | Access the
			 Software Download Center at http:/​/​software.cisco.com and download the Cisco Prime License
			 Manager OVA image for your desired release: Downloads
				  Home > Products > Cloud and Systems
				  Management > Collaboration and Unified Communications
				  Management > Cisco Prime License Manager . |
|---|---|
| Step 2 | From the
			 vCenter Client, open the console of your newly downloaded virtual machine
			 template. |
| Step 3 | From the
...
| Step 4 | Follow the Deploy
			 ...
			 the selected location within the vCenter Client. |
...
| Note | A system reboot is required, impacting all services relating to the
			 server. We recommend that you remove Cisco Prime License Manager during
			 off-peak hours. |
|---|---|

| Caution | You cannot restore Cisco Prime License Manager after it has been
			 removed. |
|---|---|
