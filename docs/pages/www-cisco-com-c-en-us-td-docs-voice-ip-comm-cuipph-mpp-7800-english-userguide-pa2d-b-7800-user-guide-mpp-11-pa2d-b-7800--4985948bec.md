---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-mpp-7800-english-userguide-pa2d-b-7800-user-guide-mpp-11-pa2d-b-7800--4985948bec
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/MPP/7800/english/userguide/pa2d_b_7800-user-guide-mpp-11/pa2d_b_7800-user-guide-mpp-11_chapter_01001.html
retrieved_at: 2026-08-21T02:23:19.921978+00:00
---
...
If your administrator configured the Missed softkey, and there is a missed call on the line, you can use the Missed softkey on the phone's home screen to access the Missed calls list.
...
In the Add BroadSoft personal contact screen, when contact details fields are empty or you enter invalid values to the fields, you don't see the Save softkey.
...
|---|---|
| Step 2 | Press Recents . If your administrator configured the Missed softkey, and there is a missed call on the line, you can use the Missed softkey on the phone's home screen to access the Missed calls list. |
...
| Step 8 | Press Save to add the contact. In the Add BroadSoft personal contact screen, when contact details fields are empty or you enter invalid values to the fields, you don't see the Save softkey. |
