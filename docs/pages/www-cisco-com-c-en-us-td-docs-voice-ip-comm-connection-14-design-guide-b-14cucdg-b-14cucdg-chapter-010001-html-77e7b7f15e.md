---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-connection-14-design-guide-b-14cucdg-b-14cucdg-chapter-010001-html-77e7b7f15e
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/design/guide/b_14cucdg/b_14cucdg_chapter_010001.html
retrieved_at: 2026-08-17T02:13:49.531320+00:00
---
...
For a list of servers that meet Unity Connection specifications, see the Cisco Unity Connection 14 Supported Platforms List
                        at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/supported_platforms/b_14cucspl.html .
...
For details on changing the audio codec that is advertised by Unity Connection, or the system-level recording audio codec,
                              see the “ Changing the Audio or Video Format of Recordings ” section of the “User Settings” chapter of the System Administration Guide for Cisco Unity Connection Release 14 , at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/administration/guide/b_14cucsag.html .
...
For additional information on the number of voice messaging ports, see the " Planning the Usage of Voice Messaging Ports " chapter in Cisco SIP Proxy Server Integration Guide for Cisco Unity Connection Release 14 at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/integration/sip-csps/b_cuc14intcsps.html .
...
For Unity Connection systems that are configured to store voicemails only (no emails or faxes are stored on the server), base
                           ...
                           supported on that server. See the Cisco Unity Connection 14 Supported Platforms List for the exact amount of voice-message storage supported for each server.
...
For the maximum number of users supported for each supported server, planning, and selection of servers, take into account
                           the possibility of adding users in the future. For more information, see the Cisco Unity Connection 14 Supported Platforms List at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/supported_platforms/b_14cucspl.html .

For information on moving users from one Cisco Unity Connection server to another, see the “ Moving or Migrating Users Between Locations in Cisco Unity Connection ” section of the “Users” chapter of the System Administration Guide for Cisco Unity Connection, Release 14, available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/administration/guide/b_14cucsag.html .
...
Unity Connection cluster —If a Unity Connection cluster server pair is configured (active/active high availability) instead of a standalone Unity Connection
                                 ...
                                 the Cisco Unity Connection 14 Supported Platforms List at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/supported_platforms/b_14cucspl.html .
...
Desktop Clients —When desktop clients (for example, the Web Inbox and IMAP) are deployed, the maximum number of TUI and/or VUI sessions that
                                 Unity Connection supports is reduced for Platform Overlay 1 servers. For more information, see the Cisco Unity Connection 14 Supported Platforms List at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/supported_platforms/b_14cucspl.html .
...
Most third-party IMAP email clients, such as Microsoft Outlook and Lotus Notes, support IMAP Idle. Cisco Unified Personal
                           ...
                           Connection servers), see the Cisco Unity Connection 14 Supported Platforms List at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/supported_platforms/b_14cucspl.html .
...
The maximum number of visual voicemail clients is equivalent to the maximum number of users supported by a Unity Connection
                           ...
                           or ports supported for each platform overlay, see the Cisco Unity Connection 14 Supported Platforms List at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/supported_platforms/b_14cucspl.html .
...
For supported versions of Cisco Unified Communications Manager and Cisco IP Phones with the Visual Voicemail feature, see
                           System Requirements for Cisco Unity Connection Release 14 at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/requirements/b_14cucsysreqs.html .

For system requirements, see the System Requirements for Cisco Unity Connection Release 14 at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/requirements/b_14cucsysreqs.html .
...
Cisco Unified Mobility Advantage (CUMA) Release 7.0 connects to the Unity Connection server using IMAP, so it is considered
                           ...
                           Cisco Unified Mobile Communicator clients supported for each platform overlay, see the Cisco Unity Connection 14 Supported Platforms List at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/supported_platforms/b_14cucspl.html .
...
The maximum number of Messaging Assistant clients is equivalent to the maximum number of users supported by a Unity Connection
                           ...
                           users supported for each platform overlay, see the Cisco Unity Connection 14 Supported Platforms List at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/supported_platforms/b_14cucspl.html .
...
For information on using the Messaging Assistant, see the User Guide for the Cisco Unity Connection Personal Call Transfer
                           Rules Web Tool (Release 14) at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/user/guide/pctr/b_14cucugpctr.html .

## Web Inbox
                        	 Clients

For the maximum number of Web Inbox clients supported for each platform overlay, see the Cisco Unity Connection 14 Supported Platforms List at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/supported_platforms/b_14cucspl.html .

For information on using the Web Inbox, see the Quick Start Guide for the Cisco Unity Connection Web Inbox (Release 14) at http://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/quick_start/guide/b_14cucqsginbox.html .
...
The Cisco Unified Personal Communicator (CUPC) client does not support IMAP Idle, so the number of CUPC clients supported
                           ...
                           users. For the maximum number of CUPC clients supported for each platform overlay, see the Cisco Unity Connection 14 Supported Platforms List at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/supported_platforms/b_14cucspl.html .
...
The voice messaging plug-in for the IBM Lotus Sametime client does not support IMAP Idle, so the number of IBM Lotus Sametime
                           ...
                           maximum number of users. For the maximum number of IBM Lotus Sametime clients supported for each platform overlay, see the Cisco Unity Connection 14 Supported Platforms List at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/supported_platforms/b_14cucspl.html .
...
| Note | Use of the G.722 or iLBC codec as line codecs or advertised codecs reduces the number of voice ports that can be provisioned
                                       ...
                                       using G.722 or iLBC codecs, see the Cisco Unity Connection 14 Supported Platforms List at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/14/supported_platforms/b_14cucspl.html |
|---|---|
