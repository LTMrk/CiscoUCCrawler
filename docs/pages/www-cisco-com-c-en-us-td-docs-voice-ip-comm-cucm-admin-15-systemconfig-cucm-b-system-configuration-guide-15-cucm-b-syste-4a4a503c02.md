---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-admin-15-systemconfig-cucm-b-system-configuration-guide-15-cucm-b-syste-4a4a503c02
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/admin/15/systemConfig/cucm_b_system-configuration-guide-15/cucm_b_system-configuration-guide-14_chapter_01000.html
retrieved_at: 2026-08-16T16:08:37.417832+00:00
---
...
From Release 15 onwards, H.323 Gatekeeper Control options will no longer be available in Unified Communications Manager. Hence,
                                       we recommend that you use SIP trunk with Location Bandwidth Manager (LBM).
...
| Note | From Release 15 onwards, H.323 Gatekeeper Control options will no longer be available in Unified Communications Manager. Hence,
                                       we recommend that you use SIP trunk with Location Bandwidth Manager (LBM). |
|---|---|
