---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-mpp-7832-firmware-11-3-1sr2-cs78-b-7832mpp-rn-1131sr2-html-7592837d40
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/MPP/7832/firmware/11-3-1sr2/cs78_b_7832mpp-rn-1131sr2.html
retrieved_at: 2026-08-21T23:17:58.816256+00:00
---

Cisco IP Conference Phone 7832 Multiplatform Phones Release Notes for Firmware Release 11.3(1)SR2
...
Use these release notes with the Cisco IP Conference Phone 7832 Multiplatform Phones running SIP Firmware Release 11.3(1)SR2.
...
Under Latest Release , select the 11.3.1 MSR2-6 folder.

(Optional) Place your mouse pointer on the file name to display the file details and checksum values.

Download the cmterm-7832.11-3-1MSR2-6_REL.zip file.
...
http://10.73.10.223/firmware/sip7832.11-3-1MSR2-6.loads

https://server.domain.com/firmware/sip7832.11-3-1MSR2-6.loads
...
```
https://10.74.10.225/admin/upgrade?http://10.73.10.223/firmware/sip7832.11-3-1MSR2-6.loads
```

```
https://10.74.10.225/admin/upgrade?https://server.domain.com/firmware/sip7832.11-3-1MSR2-6.loads
```
...
The following list contains the severity 1, 2, and 3 defects that are resolved for the Cisco IP Conference Phone 7832 Multiplatform Phones that use Firmware Release 11.3(1)SR2.
...
| Step 5 | Under Latest Release , select the 11.3.1 MSR2-6 folder. |
| Step 6 | (Optional) Place your mouse pointer on the file name to display the file details and checksum values. |
| Step 7 | Download the cmterm-7832.11-3-1MSR2-6_REL.zip file. |
