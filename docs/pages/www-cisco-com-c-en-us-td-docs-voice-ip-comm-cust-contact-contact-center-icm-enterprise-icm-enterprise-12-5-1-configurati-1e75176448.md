---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-12-5-1-configurati-1e75176448
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_12_5_1/configuration/guide/ucce_b_125-security-guide/ucce_b_125-security-guide_chapter_01100.html
retrieved_at: 2026-08-16T14:49:08.487508+00:00
---
...
If you use the
                                             						utility to upgrade Tomcat multiple times, you can revert to only one version
                                             						back of Tomcat.
...
| Note | If you use the
                                             						utility to upgrade Tomcat multiple times, you can revert to only one version
                                             						back of Tomcat. For example, if you upgrade
                                             						Tomcat from 9.0.21 to 9.0.22, and then to 9.0.24, the utility reverts Tomcat
                                             						to 9.0.22. |
|---|---|
