---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-hcs-cc-12-5-1-solution-design-guide-hcscc-b-sold-a298556d8f
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/hcs-cc/12_5_1/Solution_Design_Guide/hcscc_b_soldg-for-hcs-cc-12_5/hcscc_b_soldg-for-hcs-cc-12_5_chapter_010.html
retrieved_at: 2026-08-21T23:54:16.383705+00:00
---
...
Contact center solutions that include something not covered by the Contact Center Enterprise
                                 						Reference Designs are called Non-Reference Designs . Cisco HCS for Contact
                                 						Center supports the Avaya PG as a Non-Reference Design.
...
## Specifications for a Reference Design
                        		Solution
...
In general, you cannot use the ICM-to-ICM Gateway in Reference Designs. Only the Contact Director Reference Design allows
                                       you to use that gateway. The Cisco HCS for Contact
                                                						Center Small Contact Center model does not support the Application Gateway.
...
Contact Center Enterprise solutions use vCPU oversubscription. This policy applies for both Reference Design and Non-Reference Design solutions.
...
For information on the data source allocation of the components in the Reference Design layouts, see the Installing and Upgrading Guide for Cisco Hosted Collaboration Solution for Contact Center at https://www.cisco.com/c/en/us/support/unified-communications/hosted-collaboration-solution-contact-center/products-installation-guides-list.html
...
In this Reference Design, Cisco Unified Intelligence Center, Live Data, and the Identity Service for Single Sign-On are coresident
...
Adding more disks is not permitted in the Packaged CCE 2000 agent deployment. Any changes to the number of disks will result
                                             in a VM validation error.
...
#### 500 Agent Reference Design

The Cisco HCS for Contact
                                       						Center 500 Agent Reference Design is a variation of 2000 Agent Reference Design. This reference design supports two instances of
                                 500 agents.

For the Unified CM VMs in a 500 Agent Reference Design, Cisco HCS for Contact
                                             						Center starts with the 2500 Users CUCM OVA and manually increases the vCPUs to 2.

If you plan to upgrade to 12.x on Cisco UCS C240 M4SX servers, deploy Unified CM and ECE HA VMs on external servers.

##### Support on the Cisco UCS C240 M5SX and Cisco UCS C240 M6SX Large TRC Server s

This figure shows the base layout of the components in 500 Agent Reference Design on Cisco UCS C240 M5SX and Cisco UCS C240 M6SX Large TRC server s .
...
Small Contact Center solution of Cisco HCS for Contact
                                       						Center is a variation of the 4000 Agent Reference Design. Small Contact Center supports dedicated sub-customer peripherals for up
                                 to 100 or 500 agents. It also offers a shared peripheral model for customers with 40 or less agents.

##### Small Contact Center Reference Design on the Cisco UCS C240 M5SX and Cisco UCS C240 M6SX TRC Server s

Important

This VM layout shows the shared peripheral option on the Cisco UCS C240 M5SX and Cisco UCS C240 M6SX TRC server s .
...
###### Small Contact Center 100 Agent Reference Design on the Cisco UCS C240 M5SX and Cisco UCS C240 M6SX TRC Server s

Small Contact Center 100 Agent Reference Design supports 6 sub-customer instances for each server pair.

This figure shows the base layout of the components in Small Contact Center 100 Agent Reference Design.
...
###### Small Contact Center 500 Agent Reference Design on the Cisco UCS C240 M5SX and Cisco UCS C240 M6SX TRC Server s

Small Contact Center 500 Agent Reference Design supports three sub-customer instances.

This figure shows the base layout of the components in Small Contact Center 500 Agent Reference Design.
...
##### Small Contact Center on the Cisco HX220c-M5SX TRC Server

This VM layout shows the shared peripheral option on the Cisco HX220c-M5SX TRC server.
...
###### Small Contact Center 100 Agents on the Cisco HX220c-M5SX TRC Server

Small Contact Center 100 Agent Reference Design supports 6 sub-customer instances for each server pair.

This figure shows the base layout of the components in Small Contact Center 100 Agent Reference Design on the Cisco HX220c-M5SX
                                       TRC server.
...
###### Small Contact Center 500 Agents on the Cisco HX220c-M5SX TRC Server

The Cisco HCS for Contact
                                             						Center 500 Agent Reference Design is a variation of 4000 Agent Reference Design. This reference design supports two instances of
                                       500 agents.

This figure shows the base layout of the components in 500 Agent Reference Design on the Cisco HX220c-M5SX TRC server.
...
A Unified CCE or HCS for CC solution with PGs of version 11.6 and Packaged CCE do not support the 24000 Agent Deployment.

#### Support on the Cisco UCS C240 M5SX and Cisco UCS C240 M6SX Large TRC Server s

The following figure shows the base layout of the components in a 24000 Agent Reference Design on Cisco UCS C240 M5SX and Cisco UCS C240 M6SX Large TRC server s .
...
This figure shows the base layout of the components in a 24000 Agent Reference Design on Cisco HX220c-M5SX TRC server.
...
36000 concurrent Agents and corresponding configuration limits while employing the 24k Agent deployment model is not supported
                                                through CCMP.
...
Make the following changes to the Live Data and Cisco IdS OVA files to enable support for 36000 agents:

Live Data OVA file: Increase the VM memory reservation from 46 to 68 GB . Increase the number of vCPUs from 12 to 18 and the vCPU MHZ reservation from 24000 to 36000.

Cisco IdS OVA file: Increase the number of vCPUs from 8 to 10.
...
Use the Config Limit CLI tool to modify the value of calls per second (CPS) for your deployment. You can then use the Configuration
                                    Manager tool to modify the values for the other parameters listed in the following table. For more details, see the Change Limits for Calls Per Second to Support 36000 Agents topic in the Cisco Hosted Collaboration Solution for Contact Center Configuration Guide at https://www.cisco.com/c/en/us/support/unified-communications/hosted-collaboration-solution-contact-center/products-installation-and-configuration-guides-list.html .
...
Only Unified CCE supports the Contact Director reference design. The Contact Director distributes incoming calls to other
                              ...
                              instances. The 3 instances can support a total of 24000 active agents.
...
Cisco HCS for Contact
                                 						Center supports the Avaya PG as a Non-Reference Design solution.
...
Coresident Agent PG, VRU PG, and MR PG
...
| Note | The first four chapters of this book are for anyone who wants to get familiar with the three contact center enterprise solutions: Packaged Contact Center Enterprise Cisco Hosted Collaboration Solution for Contact Center Unified Contact Center Enterprise For information about design considerations and guidelines specific to HCS for CC , see the remaining chapters. |
|---|---|
...
| Contact
                                       Director | No | No | Yes |
| Non-Reference Designs | Avaya PG and ICM-to-ICM Gateway | Avaya PG only | Yes |
...
| Note | Adding more disks is not permitted in the Packaged CCE 2000 agent deployment. Any changes to the number of disks will result
                                             in a VM validation error. |
|---|---|
...
|---|---|---|---|---|
| Data Center Site A | 36 | 46300 | 106 | 2216 |
| Data Center Site B | 34 | 40500 | 100 | 2544 |
...
| Server | vCPU | MHz | vRAM | vDisk |
|---|---|---|---|---|
| Data Center Site 1A | 48 | 53100 | 134 | 1786 |
| Data Center Site 1B | 46 | 47300 | 128 | 2114 |
...
|---|---|---|---|---|---|
| Rogger | 4 | 5000 | 6 | 80 | 150 |
| Unified CM | 2 | 800 | 6 | 80 |  |
| Unified CVP OAMP | 2 | 400 | 4 | 80 |  |
| Unified CVP Server | 4 | 3000 | 12 | 250 |  |
| CUIC-LD-IdS | 4 | 5500 | 12 | 200 |  |
| AW-HDS-DDS | 4 | 3200 | 8 | 80 | 500 |
| PG | 2 | 2000 | 6 | 80 |  |
| Finesse | 4 | 4000 | 8 | 146 |  |

| Server | vCPU | MHz | vRAM | vDisk |
|---|---|---|---|---|
| Data Center Side A | 56 | 49400 | 136 | 3302 |
| Data Center Side B | 48 | 47000 | 116 | 2982 |
...
| Server | vCPU | MHz | vRAM | vDisk |
|---|---|---|---|---|
| Data Center Site A - Server 1A | 34 | 44800 | 90 | 1596 |
| Data Center Site B - Server 1B | 28 | 37200 | 78 | 1406 |
| Data Center Site A - Server 2A | 36 | 45000 | 120 | 2512 |
| Data Center Site B - Server 2B | 36 | 45000 | 120 | 2512 |
...
| Server | vCPU | MHz | vRAM | vDisk |
|---|---|---|---|---|
| Data Center Site A - Server 1A | 50 | 54400 | 140 | 1632 |
...
| Data Center Site A - Server 3A | 24 | 44200 | 70 | 1708 |
| Data Center Site A - Server 3B | 20 | 37000 | 62 | 1598 |

| Important | If you plan to upgrade to 12.x on Cisco UCS C240 M4SX servers, deploy the Unified CM and ECE HA VMs on external servers. |
|---|---|

| VM | vCPU | MHz | vRAM | vDisk 1 | vDisk 2 |
|---|---|---|---|---|---|
| Rogger | 4 | 5000 | 6 | 150 | 80 |
| Live Data | 4 | 5500 | 24 | 146 |  |
| IdS | 4 | 1500 | 10 | 146 |  |
| Unified CVP Reporting Server | 4 | 1800 | 6 | 80 | 438 |
| Unified CVP OAMP | 2 | 400 | 4 | 80 |  |
| VRU PG | 2 | 4000 | 6 | 80 |  |
...
| PG | 2 | 4000 | 6 | 80 |  |
| Unified CM | 2 | 800 | 6 | 80 |  |
| Finesse | 2 | 4000 | 8 | 146 |  |
| VVB | 4 | 6000 | 8 | 146 |  |

| Server | vCPU | MHz | vRAM | vDisk |
|---|---|---|---|---|
| Data Center Side A - Server 1A | 30 | 32200 | 74 | 1558 |
| Data Center Side B - Server 1B | 28 | 31800 | 70 | 1478 |
| Data Center Side A - Server 2A | 30 | 37000 | 102 | 2286 |
| Data Center Side B - Server 2B | 30 | 37000 | 102 | 2286 |
| Data Center Side A - Server 3A | 12 | 17600 | 40 | 612 |
| Data Center Side B - Server 3B | 12 | 17600 | 40 | 612 |
...
| Data Center Side A - Server 2A | 30 | 37000 | 102 | 2286 |
| Data Center Side B - Server 2B | 30 | 37000 | 102 | 2286 |
| Data Center Side A - Server 3A | 30 | 34200 | 108 | 1836 |
| Data Center Side B - Server 3B | 30 | 34200 | 108 | 1836 |
...
| Server | vCPU | MHz | vRAM | vDisk |
|---|---|---|---|---|
| Data Center Side A - Server 1A | 34 | 38200 | 82 | 1704 |
| Data Center Side B - Server 1B | 32 | 37800 | 78 | 1624 |
| Data Center Side A - Server 2A | 34 | 43000 | 110 | 2432 |
| Data Center Side B - Server 2B | 34 | 43000 | 110 | 2432 |
| Data Center Side A - Server 3A | 30 | 22800 | 78 | 1158 |
| Data Center Side B - Server 3B | 24 | 20400 | 60 | 918 |
...
| Server | vCPU | MHz | vRAM | vDisk |
|---|---|---|---|---|
| Data Center Side A - Server 1A | 46 | 43000 | 122 | 1558 |
| Data Center Side B - Server 1B | 44 | 42600 | 118 | 1478 |
| Data Center Side A - Server 2A | 46 | 47800 | 150 | 2286 |
| Data Center Side B - Server 2B | 46 | 47800 | 150 | 2286 |
| Data Center Side A - Server 3A | 28 | 28400 | 88 | 612 |
| Data Center Side B - Server 3B | 28 | 28400 | 88 | 612 |

| VM | vCPU | MHz | vRAM | vDisk 1 | vDisk 2 |
|---|---|---|---|---|---|
| HX Data Contoller | 16 | 10800 | 48 |  |  |
| Rogger | 4 | 5000 | 6 | 80 | 150 |
| Live Data | 4 | 5500 | 24 | 146 |  |
| IdS | 4 | 1500 | 10 | 146 |  |
| Unified CVP Reporting Server | 4 | 1800 | 6 | 80 | 438 |
...
| Data Center Side A - Server 2A | 46 | 47800 | 150 | 2286 |
| Data Center Side B - Server 2B | 46 | 47800 | 150 | 2286 |
| Data Center Side A - Server 3A | 46 | 45000 | 156 | 1836 |
| Data Center Side B - Server 3B | 46 | 45000 | 156 | 1836 |
...
| Data Center Side A - Server 2A | 46 | 47800 | 150 | 2286 |
| Data Center Side B - Server 2B | 46 | 47800 | 150 | 2286 |
| Data Center Side A - Server 3A | 46 | 33600 | 126 | 1158 |
| Data Center Side B - Server 3B | 40 | 31200 | 108 | 918 |
...
| Server | vCPU | MHz | vRAM | vDisk |
|---|---|---|---|---|
| Data Center Site A - Server 1A | 34 | 47700 | 82 | 2050 |
| Data Center Site B - Server 1B | 32 | 47300 | 78 | 1970 |
...
| Server | vCPU | MHz | vRAM | vDisk |
|---|---|---|---|---|
| Data Center Site A - Server 1A | 50 | 54200 | 132 | 1806 |
...
| Data Center Site B - Server 7A | 36 | 55800 | 98 | 730 |
| Data Center Site B - Server 7B | 36 | 55800 | 98 | 730 |
| Server 8 | 24 | 54000 | 60 | 876 |

| Note | A Unified CCE or HCS for CC solution with PGs of version 11.6 and Packaged CCE do not support the 24000 Agent Deployment. |
|---|---|
...
| Server | vCPU | MHz | vRAM | vDisk |
|---|---|---|---|---|
| Data Center Site A - Server 1A | 42 | 56700 | 98 | 2130 |
| Data Center Site B - Server 1B | 40 | 56300 | 94 | 2050 |
| Data Center Site A - Server 2A | 40 | 60100 | 106 | 1628 |
| Data Center Site B - Server 2B | 36 | 52900 | 98 | 1518 |
| Data Center Site A - Server 3A | 36 | 52900 | 98 | 1518 |
| Data Center Site B - Server 3B | 36 | 51400 | 98 | 1518 |
| Data Center Site A - Server 4A | 24 | 52500 | 48 | 1740 |
| Data Center Site B - Server 4B | 24 | 52500 | 48 | 1740 |
| Data Center Site A - Server 5A | 40 | 60100 | 106 | 1628 |
| Data Center Site B - Server 5B | 36 | 52900 | 98 | 1518 |
| Data Center Site A - Server 6A | 32 | 47400 | 82 | 1318 |
| Data Center Site B - Server 6B | 32 | 47400 | 82 | 1318 |
| Data Center Site A - Server 7A | 36 | 54600 | 90 | 1428 |
| Data Center Site B - Server 7B | 32 | 47400 | 82 | 1318 |
| Data Center Site A - Server 8A | 32 | 47400 | 82 | 1318 |
| Data Center Site B - Server 8B | 32 | 45900 | 82 | 1318 |
...
| Server | vCPU | MHz | vRAM | vDisk |
|---|---|---|---|---|
| Data Center Site A - Server 1A | 54 | 56900 | 146 | 1770 |
| Data Center Site B - Server 1B | 48 | 49300 | 134 | 1580 |
| Data Center Site A - Server 2A | 48 | 54700 | 136 | 1372 |
| Data Center Site B - Server 2B | 48 | 54700 | 136 | 1372 |
| Data Center Site A - Server 3A | 48 | 54700 | 136 | 1372 |
| Data Center Site B - Server 3B | 48 | 54700 | 136 | 1372 |
...
| Data Center Site A - Server 5A | 48 | 54700 | 136 | 1372 |
| Data Center Site B - Server 5B | 48 | 54700 | 136 | 1372 |
| Data Center Site A - Server 6A | 44 | 49200 | 120 | 1172 |
| Data Center Site B - Server 6B | 44 | 49200 | 120 | 1172 |
| Data Center Site A - Server 7A | 44 | 49200 | 120 | 1172 |
| Data Center Site B - Server 7B | 44 | 49200 | 120 | 1172 |
| Data Center Site A - Server 8A | 44 | 49200 | 120 | 1172 |
| Data Center Site B - Server 8B | 44 | 49200 | 120 | 1172 |
| Data Center Site A - Server 9A | 36 | 51800 | 90 | 1226 |
| Data Center Site B - Server 9B | 36 | 51800 | 90 | 1226 |
| Data Center Site A - Server 10A | 36 | 55800 | 98 | 730 |
| Data Center Site B - Server 10B | 36 | 55800 | 98 | 730 |
| Server 11 | 24 | 54000 | 60 | 876 |

| Note | 36000 concurrent Agents and corresponding configuration limits while employing the 24k Agent deployment model is not supported
                                                through CCMP. |
|---|---|
...
| Generic PG | Coresident Agent PG, VRU PG, and MR PG |
