---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-pcce-pcce-12-6-1-configuration-guide-pcce-b-admi-f0eab6abd9
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/pcce/pcce_12_6_1/configuration/guide/pcce_b_admin_configuration_guide_12_6_1/pcce_b_admin_configuration_guide_12_5_2_chapter_01011.html
retrieved_at: 2026-08-21T16:52:33.135353+00:00
---
...
Media Routing Domains (MRDs) organize how requests for each communication medium, such as voice and email, are routed to agents.
                              For example, the Enterprise Chat and
                                    						Email uses a Unified CCE Packaged CCE MRD to route a task to an agent who is associated with a skill group or precision queue and a particular channel.
...
Optionally, select Select the Enterprise Skill Group that includes the appropriate skill groups to cover all media routing domain cases for the selected Agent.

Step 6

Optionally, select Select the Enterprise Route that has an appropriate collection of routes, or the Route , matching the agent and media routing domain.
...
This section applies to tasks submitted by third-party multichannel applications that use the Task
                                                					Routing APIs.
...
For example Enterprise Chat and
                                    						Email scripts, see the Scripting and Media Routing Guide for Cisco Unified ICM/Contact Center Enterprise at https://www.cisco.com/c/en/us/support/customer-collaboration/unified-contact-center-enterprise/products-user-guide-list.html .
...
| Step 4 | Optionally, in the Consider if column, enter the formula that evaluates to true for the target when the ICM system runs the Queue to Agent node, or that
                                       target will not be selected. For help in creating a formula, put the cursor in this field and then click the Formula Editor button. |
| Step 5 | Optionally, select Select the Enterprise Skill Group that includes the appropriate skill groups to cover all media routing domain cases for the selected Agent. |
| Step 6 | Optionally, select Select the Enterprise Route that has an appropriate collection of routes, or the Route , matching the agent and media routing domain. |
...
| Note | This section applies to tasks submitted by third-party multichannel applications that use the Task
                                                					Routing APIs. |
|---|---|
