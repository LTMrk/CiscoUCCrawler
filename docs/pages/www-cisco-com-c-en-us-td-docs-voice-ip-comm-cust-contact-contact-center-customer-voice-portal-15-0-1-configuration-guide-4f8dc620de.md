---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-customer-voice-portal-15-0-1-configuration-guide-4f8dc620de
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/customer_voice_portal/15-0-1/configuration/guide/ccvp_b_150-configuration-guide-for-cisco-unified-customer-voice-portal/operations_console.html
retrieved_at: 2026-08-21T02:58:14.674855+00:00
---
...
| Unified
                                          ...
                                          to a VXML Server (standalone). Note A VXML Server (standalone) handles calls that arrive through Cisco VVB . (No statistics are provided when the VXML Server is configured this way.) Also, you cannot configure a database to and capture
                                                   data from VXML Server (standalone) applications. | Note | A VXML Server (standalone) handles calls that arrive through Cisco VVB . (No statistics are provided when the VXML Server is configured this way.) Also, you cannot configure a database to and capture
                                                   data from VXML Server (standalone) applications. |
| Note | A VXML Server (standalone) handles calls that arrive through Cisco VVB . (No statistics are provided when the VXML Server is configured this way.) Also, you cannot configure a database to and capture
                                                   data from VXML Server (standalone) applications. |
