---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-admin-14su2-admingd-cucm-b-administration-guide-14su2-cucm-m-restore-th-574d8c4227
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/admin/14SU2/adminGd/cucm_b_administration-guide-14su2/cucm_m_restore-the-system.html
retrieved_at: 2026-08-17T00:16:39.638057+00:00
---
...
Follow the below steps, after performing the restore operation on the Specific License Reservation or the Permanent License Reservation enabled Unified Communications Manager.
...
REGISTERED - SPECIFIC LICENSE RESERVATION or REGISTERED - UNIVERSAL LICENSE RESERVATION
...
Restore a Unified Communications Manager using Call Home Transport Mode.

NA

Switch the transport mode from Call Home to Smart Transport.
...
| REGISTERED - SPECIFIC LICENSE RESERVATION or REGISTERED - UNIVERSAL LICENSE RESERVATION Note Smart Agent may reflect the status as Universal License Reservation but is for Permanent Licenses Reservation feature. | Note | Smart Agent may reflect the status as Universal License Reservation but is for Permanent Licenses Reservation feature. | Yes | Execute the below CLI license smart reservation return from the product. A reservation return code will be printed on the console. Enter the reservation return code on CSSM to remove the product. |
| Note | Smart Agent may reflect the status as Universal License Reservation but is for Permanent Licenses Reservation feature. |
...
| Restore operation on the Unified Communications Manager registered for CSSM Satellite and Authorized for Export Restricted
                                             ...
                                             and request for the export restricted license from the product. |
| No | No action required. |
| Restore a Unified Communications Manager using Call Home Transport Mode. | NA | Switch the transport mode from Call Home to Smart Transport. |
