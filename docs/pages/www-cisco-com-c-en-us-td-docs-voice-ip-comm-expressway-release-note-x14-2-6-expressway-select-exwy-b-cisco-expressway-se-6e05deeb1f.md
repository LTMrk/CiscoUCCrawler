---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-expressway-release-note-x14-2-6-expressway-select-exwy-b-cisco-expressway-se-6e05deeb1f
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/expressway/release_note/X14-2-6/Expressway-Select/exwy_b_cisco-expressway-select-release-note-x1426.html
retrieved_at: 2026-08-16T15:38:26.154365+00:00
---

Cisco Expressway Select Release Note (X14.2.6)
...
## Feature Summary for Expressway Select X14.2.6
...
## Features and Changes in Expressway Select X14.2.6
...
X14.2.6 and Expressway Select X14.2.6 is not supported on the Cisco TelePresence Video Communication Server (VCS) series.
...
|---|---|---|---|
| CAP of 2500 secured/crypto sessions | No | X14.2.6 and Expressway Select X14.2.6 is not supported on the Cisco TelePresence Video Communication Server (VCS) series.
