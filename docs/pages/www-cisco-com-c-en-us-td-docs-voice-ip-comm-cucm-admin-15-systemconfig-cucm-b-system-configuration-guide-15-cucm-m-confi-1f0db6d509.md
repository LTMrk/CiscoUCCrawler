---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-admin-15-systemconfig-cucm-b-system-configuration-guide-15-cucm-m-confi-1f0db6d509
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/admin/15/systemConfig/cucm_b_system-configuration-guide-15/cucm_m_configure-enterprise-parameters-and-services.html
retrieved_at: 2026-08-16T16:08:12.603323+00:00
---
...
This feature is applicable for Release 12.5(1)SU7 and 14SU3 onwards.
...
This parameter allows the administrator to enable or disable auto renewal of refresh token. By default this parameter is enabled.
                                                If it's disabled then Unified Communications Manager retains the old behavior by not auto-extending the refresh token.

Important

This feature is applicable for Release 15 onwards.
...
| OAuth with Refresh Login Flow | This parameter controls the login flow used by clients such as Cisco Jabber when connecting to Unified Communications Managers. Enabled—If you enable this option, clients can use an oAuth-based Fast Login flow to provide a quicker and streamlined login
                                                      ...
                                                      components. Note For Mobile and Remote Access deployment with Cisco Jabber, we recommend enabling this parameter only with a compatible version
                                                                  of Expressway that supports oAuth with Refresh login flow. Incompatible version may impact the Cisco Jabber functionality.
                                                                  Please refer the specific product documents for supported version and configuration requirements. Important This feature is applicable for Release 12.5(1)SU7 and 14SU3 onwards. Along with the publisher, the subscriber node also has the access to update the refresh token on the requester node database
                                                                  and the same will be replicated across the cluster. This is a required field. Default: Disabled. | Note | For Mobile and Remote Access deployment with Cisco Jabber, we recommend enabling this parameter only with a compatible version
                                                                  of Expressway that supports oAuth with Refresh login flow. Incompatible version may impact the Cisco Jabber functionality.
                                                                  Please refer the specific product documents for supported version and configuration requirements. | Important | This feature is applicable for Release 12.5(1)SU7 and 14SU3 onwards. Along with the publisher, the subscriber node also has the access to update the refresh token on the requester node database
                                                                  and the same will be replicated across the cluster. |
| Note | For Mobile and Remote Access deployment with Cisco Jabber, we recommend enabling this parameter only with a compatible version
                                                                  of Expressway that supports oAuth with Refresh login flow. Incompatible version may impact the Cisco Jabber functionality.
                                                                  Please refer the specific product documents for supported version and configuration requirements. |
| Important | This feature is applicable for Release 12.5(1)SU7 and 14SU3 onwards. Along with the publisher, the subscriber node also has the access to update the refresh token on the requester node database
                                                                  and the same will be replicated across the cluster. |
| Auto Renew Refresh Token | This parameter allows the administrator to enable or disable auto renewal of refresh token. By default this parameter is enabled.
                                                If it's disabled then Unified Communications Manager retains the old behavior by not auto-extending the refresh token. Important This feature is applicable for Release 15 onwards. This is a required field. Default: Enabled. | Important | This feature is applicable for Release 15 onwards. This is a required field. Default: Enabled. |
| Important | This feature is applicable for Release 15 onwards. This is a required field. Default: Enabled. |
