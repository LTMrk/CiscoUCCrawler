...
Cisco Emergency Responder Release 12.5(1)SU2 supports the following new features:

## Customized Email Alerts

Cisco Emergency Responder Administrator can customize the 911 Call alert emails sent to configured Onsite Security Users.
                  Administrators can select required Information fields, add additional notes, or mask digits on Caller DN to support local
                  dialing patterns. It helps ease Operation of Onsite Security Users to better relate and respond to a 911 call.

## Switch Support

Support switch port based tracking for new Voice LAN Switches: Cisco Catalyst 1000 Series, Cisco Industrial Switches IE 3200,
                  and Cisco Meraki® Switches MS120, MS125, and MS355. For more information, see the Supported Voice Ready Lan Switches section.

## Requirements

### Supported Hardware and Software

The information in the following sections discuss Hardware and Software requirements for Cisco Emergency Responder 12.5(1)SU2.
...
CER ALI info in ERL shouldn't allow to configure spaces and more than 8 characters in zip code field

CSCvq23460

CER 12.5.1SU1 UI doesn't come up because of hostname mismatch

CSCvq37709

CER 12.5.1 SNMP Query Missing Portions of Host-Resources-MIB and SysAppl-MIB

CSCvq77533

CER 12.5.1 selinux dynamic-policies command need to be added back

CSCvo90743

CER 12.5—when restarting server, restart sequence not saved on system-history.log

CSCvo92909

CER 12.5 CLI file list not displaying directories or files

CSCvp45885

CER 12.5 unable to get files through SFTP from CLI

CSCvq27914

CER—Cisco ER User and Cisco ER Serviceability pages are inaccessible when SSO is enabled

CSCvq81487

Unable to restart the services in enforce mode

CSCvr39563

CER 12.5.1 upgrade administrative pages use Java Scripts that require internet access
...
| CSCvq23460 | CER 12.5.1SU1 UI doesn't come up because of hostname mismatch |
| CSCvq37709 | CER 12.5.1 SNMP Query Missing Portions of Host-Resources-MIB and SysAppl-MIB |
| CSCvq77533 | CER 12.5.1 selinux dynamic-policies command need to be added back |
| CSCvo90743 | CER 12.5—when restarting server, restart sequence not saved on system-history.log |
| CSCvo92909 | CER 12.5 CLI file list not displaying directories or files |
| CSCvp45885 | CER 12.5 unable to get files through SFTP from CLI |
