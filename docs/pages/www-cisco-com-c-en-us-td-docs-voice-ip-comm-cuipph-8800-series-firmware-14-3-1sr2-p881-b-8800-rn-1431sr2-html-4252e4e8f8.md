---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-8800-series-firmware-14-3-1sr2-p881-b-8800-rn-1431sr2-html-4252e4e8f8
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/8800-series/firmware/14-3-1SR2/p881_b_8800-rn-1431sr2.html
retrieved_at: 2026-08-17T01:12:12.067905+00:00
---

Cisco IP Phone 8800 Release Notes for Firmware Release 14.3(1)SR2
...
In the Latest Release folder, choose 14.3(1)SR2 .

Step 5

Select the firmware file, click the Download or Add to cart button, and follow the prompts:

The firmware filename is cmterm-8845_65-sip.14-3-1-0201-246.k4.cop.sha512 or cmterm-88xx-sip.14-3-1-0201-246.k4.cop.sha512,
...
If a Cisco Unified Communications Manager is not available to load the installer program, the following .zip files are available
                        to load the firmware: cmterm-8845_65.14-3-1-0201-246.zip or cmterm-88xx.14-3-1-0201-246.zip.
...
The firmware file name is cmterm-8845_65.14-3-1-0201-246.zip or cmterm-88xx.14-3-1-0201-246.zip, depending on the model you
                                    choose.
...
CSCwn05556: 8865 Stats printed on the SIP BYE Message are inaccurate
...
| Step 4 | In the Latest Release folder, choose 14.3(1)SR2 . |
| Step 5 | Select the firmware file, click the Download or Add to cart button, and follow the prompts: The firmware filename is cmterm-8845_65-sip.14-3-1-0201-246.k4.cop.sha512 or cmterm-88xx-sip.14-3-1-0201-246.k4.cop.sha512,
...
| Step 2 | Choose your phone model. |
| Step 3 | Choose Session Initiation Protocol (SIP) Software . |
| Step 4 | In the Latest Releases folder, choose 14.3(1)SR2 . |
| Step 5 | Select the firmware file, click the Download or Add to Cart button, and follow the prompts. The firmware file name is cmterm-8845_65.14-3-1-0201-246.zip or cmterm-88xx.14-3-1-0201-246.zip, depending on the model you
                                    choose. |
