---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-customer-voice-portal-15-0-1-elementspecificatio-5e64496aa5
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/customer_voice_portal/15-0-1/elementspecification/guide/ccvp_b_150-element-specifications-guide-for-cvp-vxml-and-call-studio/form.html
retrieved_at: 2026-08-21T17:11:25.913772+00:00
---
...
dtmf_overlay supports only VVB and must be selected before creating or deploying the Call Studio application.
...
| dtmf_overlay (DTMF Overlay) | Boolean | Yes | true | true | false | Setting this property to true will enable the generation of random DTMF digits tone at random duration while DTMF recognition is in progress. Note dtmf_overlay supports only VVB and must be selected before creating or deploying the Call Studio application. | Note | dtmf_overlay supports only VVB and must be selected before creating or deploying the Call Studio application. |
| Note | dtmf_overlay supports only VVB and must be selected before creating or deploying the Call Studio application. |
