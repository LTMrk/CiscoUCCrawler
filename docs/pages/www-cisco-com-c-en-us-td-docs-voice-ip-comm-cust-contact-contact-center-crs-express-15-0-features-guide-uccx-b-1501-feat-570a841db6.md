---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-crs-express-15-0-features-guide-uccx-b-1501-feat-570a841db6
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/crs/express_15_0/features/guide/uccx_b_1501_features-guide/uccx_m_1501_digital-channels.html
retrieved_at: 2026-08-16T21:16:34.248258+00:00
---
...
The digital channel features of Cisco Customer Collaboration Platform are available in the Unified CCX Flex Premium license version of Cisco Unified Contact Center Express. The feature availability in Unified CCX is based on the type
                                 of license for Cisco Unified Contact Center Express.
...
The following table describes the web chat features in addition to the chat features that are available in Flex Premium package.
...
Chat Widgets Bubble Chat is available .
...
| Step 3 | Specify the
                                          			 following fields: Field Name Description CSQ
                                                         ...
                                                         OAuth 2.0 protocol. As part of COP ciscouccx.1501.MSOauth.5.cop.sha512 and ciscoccp.1501.MSOauth.3.cop.sha512, OAuth 2.0 supports Microsoft Office 365. Office 365 authentication requires Tenant ID, Client ID, and Client Secret. Note This field is displayed only when you have configured Gmail mail server. Email
                                                                     ...
                                                                     Office 365. Note This field is mandatory when the email server type is Microsoft Office 365 or Microsoft Exchange. As part of COP ciscouccx.1251.su3.ES07.CSCwr61182.4.cop.sgn and ciscoccp.1251.su3.ES07.CSCwr61182.3.cop.sgn, this field is
                                                         ...
                                                         OAuth 2.0 protocol. As part of COP ciscouccx.1501.MSOauth.5.cop.sha512 and ciscoccp.1501.MSOauth.3.cop.sha512, OAuth 2.0 supports Microsoft Office 365. Office 365 authentication requires Tenant ID, Client ID, and Client Secret. Note This field is displayed only when you have configured Gmail mail server. | Note | This field is displayed only when you have configured Gmail mail server. | Email
                                                         						  ...
                                                         						  email address to which emails are sent or retrieved. | Email password | Password for the email account. Note As part of COP ciscouccx.1501.MSOauth.5.cop.sha512 and ciscoccp.1501.MSOauth.3.cop.sha512, this field is disabled for Microsoft
                                                                     Office 365. Note This field is mandatory when the email server type is Microsoft Office 365 or Microsoft Exchange. As part of COP ciscouccx.1251.su3.ES07.CSCwr61182.4.cop.sgn and ciscoccp.1251.su3.ES07.CSCwr61182.3.cop.sgn, this field is
                                                                     disabled for Microsoft Office 365. This field is optional when the email server type is Gmail. | Note | As part of COP ciscouccx.1501.MSOauth.5.cop.sha512 and ciscoccp.1501.MSOauth.3.cop.sha512, this field is disabled for Microsoft
                                                                     Office 365. | Note | This field is mandatory when the email server type is Microsoft Office 365 or Microsoft Exchange. As part of COP ciscouccx.1251.su3.ES07.CSCwr61182.4.cop.sgn and ciscoccp.1251.su3.ES07.CSCwr61182.3.cop.sgn, this field is
                                                                     disabled for Microsoft Office 365. This field is optional when the email server type is Gmail. | Private Key | The JSON file that contains the OAuth Private Key, which is generated while creating Service Account in Google Cloud server.
