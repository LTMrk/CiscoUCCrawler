---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-install-12-5-1su5-cucm-b-install-guide-cucm-imp-1251su5-cucm-b-install--b4ebd69c92
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/install/12_5_1SU5/cucm_b_install-guide-cucm-imp-1251su5/cucm_b_install-guide-cucm-imp-14_chapter_00.html
retrieved_at: 2026-08-17T00:07:44.934717+00:00
---
...
If you upgrade Unified Communications Manager which has IPsec configured using a certificate-based authentication with self-signed certificate, then the upgrade fails.
                                          To perform a successful upgrade, you have to reconfigure the IPsec policy with a CA-signed certificate.
...
Unified Communications Manager 12.5 requires minimum ESXi version of 6.5 U2 with minimum VM Hardware version of 13. For more information on latest Unified Communications Manager ESXi version support, see http://www.cisco.com/go/virtualized-collaboration .
...
Password must be at least six characters long and can contain alphanumeric characters, hyphens, and underscore.
...
| Note | If you upgrade Unified Communications Manager which has IPsec configured using a certificate-based authentication with self-signed certificate, then the upgrade fails.
                                          To perform a successful upgrade, you have to reconfigure the IPsec policy with a CA-signed certificate. |
|---|---|
...
| Note | Unified Communications Manager 12.5 requires minimum ESXi version of 6.5 U2 with minimum VM Hardware version of 13. For more information on latest Unified Communications Manager ESXi version support, see http://www.cisco.com/go/virtualized-collaboration . |
|---|---|
