---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-cli-ref-12-5-1su6-cucm-b-cli-reference-guide-release1251su6-cucm-b-cli--5bfe26fb30
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/cli_ref/12_5_1SU6/cucm_b_cli_reference-guide_release1251SU6/cucm_b_cli_reference_guide_release_1401_chapter_0110.html
retrieved_at: 2026-08-16T23:56:43.304465+00:00
---
...
This command enables or disables the SDI traces on Unity Connection.

set cuc sditrace {enable | disable}
...
Disables SDI traces and also deletes existing trace files.
...
After an upgrade or reinstallation, this CLI should be run again to enable the SDI traces.
...
If you use the set network domain domain-name command to change the domain name, you
                              		  ...
                              		  CLI. For more information about regenerating security certificates, see the Cisco Unified
...
| Parameters | Description |
|---|---|
| enable | Enables SDI traces. |
| disable | Disables SDI traces and also deletes existing trace files. |
