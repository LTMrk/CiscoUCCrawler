---
doc_id: www-cisco-com-c-en-us-td-docs-solutions-cvd-collaboration-hybrid-12x-hybcvd-intro-html-8ae826bb2d
source_url: https://www.cisco.com/c/en/us/td/docs/solutions/CVD/Collaboration/hybrid/12x/hybcvd/intro.html
retrieved_at: 2026-08-16T18:25:16.835044+00:00
---
...
Cisco IP Phones, Cisco Video Endpoints and Room Devices, and Cisco Webex Teams
...
Web portal that enables provisioning and management of enterprise Webex Teams users and services; registration of endpoints, clients, and Expressway-C Connector Host to Webex; and Expressway Connector upgrades
...
Provides on-premises media processing capabilities for Webex. This includes voice, video, and desktop sharing for on-premises and cloud registered devices.
...
Application with cloud-based integrated voice/video meeting, calling, messaging, and content sharing for mobile devices, personal computers, and web browsers.
...
| Product | Description |
|---|---|
| Mobile: Cisco Webex Teams for Android Cisco Webex Teams for iPhone and iPad Desktop: Cisco Webex Teams for Mac Cisco Webex Teams for Windows Web browser: Cisco Webex Teams web client | Application with cloud-based integrated voice/video meeting, calling, messaging, and content sharing for mobile devices, personal computers, and web browsers. |
