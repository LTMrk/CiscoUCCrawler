---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-expressway-admin-guide-x14-3-exwy-b-cisco-expressway-administrator-guide-x14-3f424456e8
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/expressway/admin_guide/X14-3/exwy_b_cisco-expressway-administrator-guide-x143/exwy_m_dial-plan-and-call-processing-x143.html
retrieved_at: 2026-08-16T22:36:43.791317+00:00
---
...
Expressway supports 933 and 988 calls without consuming Rich media session (RMS) licenses. This is similar to 911 calls.

933 number : 933 service is used to test E911 call flow. When an end user dials 933, it will play back the phone number and address stored
                                                in the E911 database.

988 number : 988 service is used to Route calls to Suicide Prevention Hotline without RMS licenses.
...
This field is only visible in the list of call policy rules (on the Call Policy rules page).
...
| Note | Expressway supports 933 and 988 calls without consuming Rich media session (RMS) licenses. This is similar to 911 calls. 933 number : 933 service is used to test E911 call flow. When an end user dials 933, it will play back the phone number and address stored
                                                in the E911 database. 988 number : 988 service is used to Route calls to Suicide Prevention Hotline without RMS licenses. |
|---|---|
