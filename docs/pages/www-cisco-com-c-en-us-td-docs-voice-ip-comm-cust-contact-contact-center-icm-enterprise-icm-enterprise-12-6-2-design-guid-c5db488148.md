---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-12-6-2-design-guid-c5db488148
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_12_6_2/design/guide/ucce_b_ucce_soldg-for-unified-cce-1262/rcct_b_ucce_soldg-for-unified-cce-1261_chapter_01001.html
retrieved_at: 2026-08-16T19:51:23.877371+00:00
---
...
12K numbers hold good for all other components as the call rates are the same.
...
| Cisco Identity Service (IdS) Server for 24000 agent deployment | 496 | 150 | 290 | NA | 24000 SSO agents; 105 CPS(Includes 10% Transfer and 5% Conference), ECC: 5 scalars @ 40 bytes each; 200 Reporting users at
                                             max query load. Note 12K numbers hold good for all other components as the call rates are the same. | Note | 12K numbers hold good for all other components as the call rates are the same. |
| Note | 12K numbers hold good for all other components as the call rates are the same. |
| Extra Large Live Data | 16552 | 9358 | 13578 |
| Router | 2985 | 1698 | 1690 | 5156 | 1414 | 1385 | 12,000 agents; 105 CPS(Includes 10% Transfer and 5% Conference), ECC: 5 scalars @ 40 bytes each; 200 Reporting users at max
                                             query load. |
| Logger | 5387 | 527 | 1518 | 3380 | 669 | 643 |
| AW-HDS | 2635 | 862 | 996 | NA |
| HDS-DDS | 7719 | 454 | 985 |
| Cisco Identity Server(Ids) | 260 | 56 | 224 |
| Large Live Data | 24723 | 18273 | 20950 |
...
| Small Live Data | 9393 | 4938 | 6614 |
...
| CUIC | 2315 | 1471 | 1734 | NA | 200 Reporting users running 2 Real Time reports with 100 rows retrieved for each report that is refreshed every 15 seconds,
                                             and 2 Historical Reports with 2000 rows retrieved for each report that is refreshed every 30 minutes, during call load for
                                             all deployments. |
...
| Medium PG | 2755 | 2541 | 2566 | 1378 | 1357 | 1370 | 2000 agents; 15 CPS; applicable for all deployments. |
| Large PG | 12605 | 10215 | 10305 | 1198 | 1174 | 1186 | 2,000 agents; 15 CPS; ECC; 5 scalars @ 40 bytes each; 100 Reporting users running 2 Real Time reports with 100 rows retrieved
                                          for each report that is refreshed every 15 seconds, and 2 Historical Reports with 2000 rows that are retrieved for each report,
                                          which is refreshed every 30 minutes during load and 20 CTI Clients. |
