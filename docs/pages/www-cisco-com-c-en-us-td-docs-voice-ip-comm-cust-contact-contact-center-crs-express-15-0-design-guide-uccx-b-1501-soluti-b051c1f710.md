---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-crs-express-15-0-design-guide-uccx-b-1501-soluti-b051c1f710
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/crs/express_15_0/design/guide/uccx_b_1501_solution-design-guide/uccx_m_1501_unified-ccx-reference-designs.html
retrieved_at: 2026-08-16T21:04:29.371307+00:00
---
...
Cisco Unified Intelligence Center, and Cisco Finesse are deployed on the same Virtual Machine (VM) with Unified CCX and support
                              all the Unified CCX reference designs.
...
Engine, Database, Monitoring, Reporting, Desktop, and Cisco Identity Service components.
...
Unified CCX deployment model integrated with Unified CME is not supported.
...
Advanced Quality Management and Workforce Management must be installed on separate VM from each other and from Unified CCX. No form of coresidency is
                                    supported in this release with any other software, such as installing on Unified CCX or installing both Advanced Quality Management and Workforce Management on the same VM.
...
This reference design can support silent monitoring and recording for agents at any WAN-connected site by using desktop monitoring.
                                 ...
                                 using desktop monitoring (regardless of location) or agents on the local VLAN using SPAN port monitoring. This reference design
                                 does not incorporate additional Remote Monitoring components, so silent monitoring and recording is not possible for agents
                                 who are using the Cisco IP Phone Agent at remote sites. Similarly, silent monitoring and recording are not possible for agents
                                 at remote sites who are using phones that do not support desktop monitoring.
...
|---|---|---|
| Single-Server Non-High Availability Deployment Model—Unified Communication Manager Integration | Engine, Database, Monitoring, Reporting, Desktop, and Cisco Identity Service components. | — |
| Two-Server High Availability Deployment Model—Unified Communication Manager Integration | Engine, Database, Monitoring, Reporting, Desktop, and Cisco Identity Service components. | Engine, Database, Monitoring, Reporting, Desktop, and Cisco Identity Service components. |

| Note | Unified CCX deployment model integrated with Unified CME is not supported. For hardware requirements, see Cisco Unified CCX Virtualization
                                             Information at https://www.cisco.com/c/dam/en/us/td/docs/voice_ip_comm/uc_system/virtualization/virtualization-cisco-unified-contact-center-express.html . |
|---|---|
