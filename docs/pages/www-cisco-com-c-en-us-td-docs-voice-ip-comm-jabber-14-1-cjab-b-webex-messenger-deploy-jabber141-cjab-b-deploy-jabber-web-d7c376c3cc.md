---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-jabber-14-1-cjab-b-webex-messenger-deploy-jabber141-cjab-b-deploy-jabber-web-d7c376c3cc
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/jabber/14_1/cjab_b_webex-messenger-deploy-jabber141/cjab_b_deploy-jabber-webex-messenger-129_chapter_01100.html
retrieved_at: 2026-08-21T19:13:42.375097+00:00
---
...
For cloud-based deployments, configure the client with the Webex Administration Tool. However, you can optionally set up client configuration parameters to configure the client with settings
                              that are not available in Webex Administration Tool.
...
Configure the client with the Webex Administration Tool. However, you can optionally set up a TFTP server to configure the client with settings that are not
