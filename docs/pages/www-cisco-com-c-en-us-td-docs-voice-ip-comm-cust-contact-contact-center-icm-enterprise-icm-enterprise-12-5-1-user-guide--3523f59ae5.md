---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-12-5-1-user-guide--3523f59ae5
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_12_5_1/user/guide/ucce_b_scripting-and-media-routing-guide_12_5/ucce_b_scripting-and-media-routing-guide_12_5_preface_00.html
retrieved_at: 2026-08-21T12:00:55.141509+00:00
---
...
Internet Script Editor tool supports HTTPs only.

The topic: Install Internet Script Editor.

Added CCE Scripts for Survey.
...
| Added the Release number-12.5(2) to the title. |  |
| Internet Script Editor tool supports HTTPs only. | The topic: Install Internet Script Editor. |
| Added CCE Scripts for Survey. |  | May 2020 |
...
| italic font | Italic
                                       					 font is used to indicate the following: To
                                             						  ...
                                             						  skills. A
                                             						  syntax value that the user must replace. Example: IF ( condition, true-value,
                                                							 false-value ) A book title. Example: See the Webex Contact Center Enterprise Features Guide . |
| window font | Window
