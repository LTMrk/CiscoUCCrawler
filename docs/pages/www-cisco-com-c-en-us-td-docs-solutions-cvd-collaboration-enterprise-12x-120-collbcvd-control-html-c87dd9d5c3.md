...
Added information on Apple Push Notification service (APNs)
...
|---|---|---|
| Added information on Apple Push Notification service (APNs) | Integration with Apple Push Notification Service (APNs) Onboarding for Push Notifications via Apple Push Notification Service (APNs) Other IM and Presence Settings | August 30, 2017 |
| OAuth with Refresh Login Flow | Other IM and Presence Settings Table 2-2 | August 30, 2017 |
