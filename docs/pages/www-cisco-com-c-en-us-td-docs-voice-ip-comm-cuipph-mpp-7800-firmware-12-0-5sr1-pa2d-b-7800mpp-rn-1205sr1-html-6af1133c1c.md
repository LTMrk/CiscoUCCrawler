---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-mpp-7800-firmware-12-0-5sr1-pa2d-b-7800mpp-rn-1205sr1-html-6af1133c1c
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/MPP/7800/firmware/12-0-5sr1/pa2d_b_7800mpp-rn-1205sr1.html
retrieved_at: 2026-08-17T01:10:27.923122+00:00
---

Cisco IP Phone 7800 Series Multiplatform Phones Release Notes for Firmware Release 12.0(5)SR1
...
Use these release notes with the Cisco IP Phone 7800 Series Multiplatform Phones running SIP Firmware Release 12.0(5)SR1.
...
- Under Latest Release , select 12.0.5SR1 .
...
http://10.73.10.223/firmware/sip78xx.12-0-5MPP0102-328.loads

https://server.domain.com/firmware/sip78xx.12-0-5MPP0102-328.loads
...
https://10.74.10.225/admin/upgrade?http://10.73.10.223/firmware/sip78xx.12-0-5MPP0102-328.loads

https://10.74.10.225/admin/upgrade?https://server.domain.com/firmware/sip78xx.12-0-5MPP0102-328.loads
...
cmterm-78xx.12-0-5MPP0102-328_REL.zip
...
The following list contains the severity 1, 2, and 3 defects that are open for the Cisco IP Phone 7800 Series Multiplatform Phones that use Firmware Release 12.0(5)SR1.
...
The following list contains the severity 1, 2, and 3 defects that are resolved for the Cisco IP Phone 7800 Series Multiplatform Phones that use Firmware Release 12.0(5)SR1.
...
| Step 4 | Under Latest Release , select 12.0.5SR1 . |
| Step 5 | (Optional) Place your mouse pointer on the file name to see the file details and checksum values. |
| Step 6 | Download the corresponding file. cmterm-78xx.12-0-5MPP0102-328_REL.zip |
