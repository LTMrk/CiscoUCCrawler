---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-bat-12-5-1-su2-cucm-b-bulk-administration-guide-1251su2-cucm-b-bulk-adm-1060bc6a1d
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/bat/12_5_1_SU2/cucm_b_bulk-administration-guide-1251su2/cucm_b_bulk-administration-guide-1251su2_chapter_010011.html
retrieved_at: 2026-08-21T08:46:56.276777+00:00
---
...
Do not use the insert or export transaction files that are created
                                             				...
                                             				with details of the user records that need to be deleted. Use only this file
                                             				for the delete transaction. In this custom delete file, you do not need a
                                             				header, and you can enter values for user ID.
...
- Create a text file that
                                    			 lists each user ID that you want to delete on a separate line.
