---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-upgrade-15-cucm-b-upgrade-and-migration-guide-15-cucm-b-upgrade-migrati-a10a93aa13
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/upgrade/15/cucm_b_upgrade-and-migration-guide_15/cucm_b_upgrade-migration-guide-1251su2_chapter_01000.html
retrieved_at: 2026-08-16T23:32:47.861512+00:00
---
...
| Step 2 | (Optional) For an upgrade
                                          			 from 9.x or earlier, if you need to increase the vDisk space to meet the space
                                          			 requirements of a refresh upgrade, install the following COP file: ciscocm.vmware-disk-size-reallocation-<latest_version>.cop.sgn Note Refresh Upgrades from Pre-12.5.x source to Release 15 is not supported. | Note | Refresh Upgrades from Pre-12.5.x source to Release 15 is not supported. |
