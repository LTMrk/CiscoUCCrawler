---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-jabber-14-1-cjab-b-feature-config-for-jabber141-cjab-m-feature-getting-start-35ace242dc
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/jabber/14_1/cjab_b_feature-config-for-jabber141/cjab_m_feature-getting-started-141.html
retrieved_at: 2026-08-21T05:26:15.653169+00:00
---
...
Chapter: Getting started with feature configuration
...
Cisco Collaboration Meeting Rooms (CMR) Cloud provides easy access for users to join or start Webex Meetings .
...
When Push Notifications are enabled and Cisco Jabber for Android is inactive, the Android title bar does not display a Jabber
                                                      icon.
...
Cisco Jabber for iPhone and iPad, and Android.
...
| Call Pickup | Call pickup allows users to pick up incoming calls from a group. | Cisco Jabber for Windows Cisco Jabber for Mac Cisco Jabber Softphone for VDI Cisco Jabber for Android Cisco Jabber for iPhone and iPad |
...
| Multiline | You can configure multiple phone lines for your users to perform daily Cisco Jabber tasks. You can add up to eight phone lines
                                          per user. | Cisco Jabber for Windows Cisco Jabber for Mac Cisco Jabber Softphone for VDI |
...
| Push Notification Services for Instant Messaging | The Push Notification service for IM forwards the new IM notification to Cisco Jabber, even if Cisco Jabber is inactive. Note When Push Notifications are enabled and Cisco Jabber for Android is inactive, the Android title bar does not display a Jabber
                                                      icon. | Note | When Push Notifications are enabled and Cisco Jabber for Android is inactive, the Android title bar does not display a Jabber
                                                      icon. | Cisco Jabber for iPhone and iPad, and Android in Jabber team messaging mode. |
| Note | When Push Notifications are enabled and Cisco Jabber for Android is inactive, the Android title bar does not display a Jabber
                                                      icon. |
| Push Notification Services for Video and Voice Calls | Receive notification about the incoming voice and video calls, even if Cisco Jabber is inactive. Note When Push Notifications are enabled and Cisco Jabber for Android is inactive, the Android title bar does not display a Jabber
                                                      icon. | Note | When Push Notifications are enabled and Cisco Jabber for Android is inactive, the Android title bar does not display a Jabber
                                                      icon. | Cisco Jabber for iPhone and iPad, and Android. |
| Note | When Push Notifications are enabled and Cisco Jabber for Android is inactive, the Android title bar does not display a Jabber
                                                      icon. |
