...
The CLI commands falling under "utils ucmgmt" are used to configure connectivity to the Cisco Unified Communications Management
                              Cloud Toolkit (UC Management Cloud Toolkit). Following are the commands:
