---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-expressway-install-guide-x15-0-virtual-machine-exwy-b-cisco-expressway-on-vi-be57e4ea9f
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/expressway/install_guide/X15-0/virtual-machine/exwy_b_cisco-expressway-on-virtual-machine-installation-guide-x150/exwy_m_system-requirements.html
retrieved_at: 2026-08-16T22:11:30.216106+00:00
---
...
The minimum versions specified here are subject to VMware support. The versions are correct when this documentation is published,
...
ESXi 6.7 Update 1 from X12.5.2, and Update 2 - for Large VMs only - from X12.5.4

ESXi 6.7 Update 3 from X12.6.1 for Large and Medium VMs

ESXi 6.7 Update 3 from X12.6.3 for Small VMs

ESXi 7.0. From X14.2 release, ESXi 7.0 Update 3, ESXi 7.0 Update 3c, and ESXi 7.0 Update 3d are also supported.

From the X14.2 and later releases, EXSi 6.5 Update 2a, ESXi 7.0 Update 3, ESXi 7.0 Update 3c, and ESXi 7.0 Update 3d are supported.

From the X14.2.6 and later releases, EXSi 6.5 Update 2a, ESXi 7.0 Update 3c, ESXi 7.0 Update 3d, and ESXi 8.0 are supported.
...
For upgrade instructions, see the VMware documentation.
...
This issue applies to running virtualized systems with certain ESXi versions using VMware vCenter 7.0.x. It was found during
                                    testing using VMware vCenter 7.0.1 with ESXi 6.7.0 to deploy. The Ready to Complete final page of the Deploy OVF Template
                                    wizard displays template values instead of the actual values entered on the earlier wizard pages. The issue is cosmetic, and
                                    when you click "FINISH," the OVA will deploy as expected using the entered values. Bug ID CSCvw64883 refers.
