---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-bat-12-5-1su4-cucm-b-bulk-administration-guide-1251su4-cucm-b-bulk-admi-131b3ba667
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/bat/12_5_1SU4/cucm_b_bulk-administration-guide-1251su4/cucm_b_bulk-administration-guide-1251su2_chapter_0110010.html
retrieved_at: 2026-08-21T17:52:55.766921+00:00
---
...
You can create a CSV data file to insert Cisco VG200 gateways
                           		and ports in the Cisco Unified Communications Manager database. Use either the BAT spreadsheet or a
...
You can create the CSV data file to insert Cisco Catalyst
                              		  ...
                              		  the Cisco Unified Communications Manager database. Use either the BAT spreadsheet or a
                              		  text editor to create the CSV data file.
...
You must upload the CSV data file to the first node of the Cisco Unified Communications Manager server, so BAT can access the data input file.
                              		  For more information, see Upload and Download Files .

## CSV Data Files Creation for Cisco VG224 Gateways and Ports

You can create a CSV data file to insert VG224 gateways and
                           		ports in the Cisco Unified Communications Manager database. Use either the BAT spreadsheet or a
                           		text editor to create the CSV data file.
...
You can create a CSV data file to insert VG310 gateways and ports in the Cisco Unified Communications Manager database. Use either the BAT spreadsheet or a text editor to create the CSV data file.
...
You can create a CSV data file to insert VG320 gateways and ports in the Cisco Unified Communications Manager database. Use either the BAT spreadsheet or a text editor to create the CSV data file.
...
If you want to insert a Cisco VG200 gateway, you must have a Cisco VG200 gateway template for the trunks or ports, and a CSV
...
If you want to insert a Cisco Catalyst 6000 Port, you must have a Cisco Catalyst 6000 Ports template and a CSV data file that
...
If you want to insert a Cisco VG224 gateway, you must have a Cisco VG224 gateway template for the trunks or ports, and a CSV
...
If you want to insert a Cisco VG202 or VG204 gateway, you must have a Cisco VG202 or VG204 gateway template for the trunks
