...
Chapter: In-House Preprovisioning and Provisioning
...
| Step 7 | Select one of the following options to receive the signed certificate: Enter Recipient’s Email Address —If you wish to receive the certificate via email, enter your email address in this field. Download —If you wish to download the signed certificate, select this option. |
| Step 8 | Click Submit . The signed server certificate is either emailed to the email address previously provided or downloaded. |
