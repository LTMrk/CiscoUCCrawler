---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-pcce-pcce-15-0-1-maintenance-guide-pcce-b-1501-f-58d3ee8157
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/pcce/pcce_15_0_1/maintenance/guide/pcce_b_1501_features-guide/pcce_m_150_agent-request.html
retrieved_at: 2026-08-21T12:10:11.955653+00:00
---
...
Enterprise Chat and Email also offers callback and delayed callback. You can use Agent Request, or Enterprise Chat and Email,
                                          or both.
...
Navigate to Unified CCE Administration > Overview > Infrastructure Settings > Peripheral Gateways and determine the Peripheral ID for a Multichannel peripheral that is unused.
...
Click the Main or RemoteSite tab to add the external machine.
...
For more details about the procedures for steps 2 to 5, see the Unified CCE Administration online help or Cisco Packaged Contact Center Enterprise Administration and Configuration Guide at https://www.cisco.com/en/US/products/ps12586/prod_maintenance_guides_list.html .
...
Call Type : Create a call type for Agent Request.
...
Expanded Call Variable : Use an existing Expanded Call Variable, or create an expanded call variable for Agent Request.
...
Packaged CCE— Unified CCE Administration Tools
...
| Note | Enterprise Chat and Email also offers callback and delayed callback. You can use Agent Request, or Enterprise Chat and Email,
                                          or both. |
|---|---|
...
| Step 1 | Navigate to Unified CCE Administration > Overview > Infrastructure Settings > Peripheral Gateways and determine the Peripheral ID for a Multichannel peripheral that is unused. Note In Packaged CCE 4000 and 12000 Agents deployment, fetch the Peripheral ID from the PG Explorer tool using Configuration Manager. | Note | In Packaged CCE 4000 and 12000 Agents deployment, fetch the Peripheral ID from the PG Explorer tool using Configuration Manager. |
|---|---|---|---|
...
| Step 12 | Add Customer Collaboration Platform as an external machine. Click the Main or RemoteSite tab to add the external machine. Click the New button that appears on top of the grid. The Add Machine dialog box appears. Select Customer Collaboration Platform from the drop-down list. Enter the required information. Click Save . The system automatically enables and completes the CCE Configuration for Multichannel Routing settings in Customer Collaboration Platform Administration, including the Application Connection Port you specified. |
...
| Step 4 | Expanded Call Variable : Use an existing Expanded Call Variable, or create an expanded call variable for Agent Request. Note Arrays are not supported with the Agent Request feature. CCE solutions support the Latin 1 character set only for Expanded Call Context variables and Call variables when used with
                                                         Unified CVP, Finesse, and Customer Collaboration Platform . | Note | Arrays are not supported with the Agent Request feature. CCE solutions support the Latin 1 character set only for Expanded Call Context variables and Call variables when used with
                                                         Unified CVP, Finesse, and Customer Collaboration Platform . |
...
| Step 9 | In the Dialed Number/Script Selector field, enter the dialed number string that you have configured. Packaged CCE— Unified CCE Administration Tools |
| Step 10 | Click Save . |
