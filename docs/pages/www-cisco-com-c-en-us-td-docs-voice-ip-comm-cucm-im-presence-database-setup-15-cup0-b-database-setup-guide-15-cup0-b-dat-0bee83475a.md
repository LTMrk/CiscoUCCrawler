---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-im-presence-database-setup-15-cup0-b-database-setup-guide-15-cup0-b-dat-0bee83475a
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/im_presence/database_setup/15/cup0_b_database-setup-guide-15/cup0_b_database-setup-guide-1401_chapter_00.html
retrieved_at: 2026-08-16T16:12:44.833677+00:00
---
...
All currently active PostgreSQL versions from 14.x through 18.x are supported. Now, validation was performed against versions
                                          14.x, 16.x, 17.x, and 18.x.

Oracle

All currently active Oracle database versions from 19c through 23c are supported. Now, validation is performed against version
                                          19c and 23c.

The support of Oracle database version 23c is available only from Release 15 SU2 onwards.
...
For SSL/TLS connections, IM and Presence Service Release 15 SU4 or later requires Microsoft SQL Server 2022 with Cumulative
                                                      Update 1 (CU1) or later.
...
For more information on how to configure the minimum TLS version and read about the limitations, see the "Set Minimum TLS
                                          Version" section in the Security Guide for Cisco Unified Communications Manager .
...
|---|---|
| PostgreSQL | All currently active PostgreSQL versions from 14.x through 18.x are supported. Now, validation was performed against versions
                                          14.x, 16.x, 17.x, and 18.x. |
| Oracle | All currently active Oracle database versions from 19c through 23c are supported. Now, validation is performed against version
                                          19c and 23c. Note The support of Oracle database version 23c is available only from Release 15 SU2 onwards. | Note | The support of Oracle database version 23c is available only from Release 15 SU2 onwards. |
| Note | The support of Oracle database version 23c is available only from Release 15 SU2 onwards. |
| Microsoft SQL Server | All currently active MS SQL versions from 2016 through 2022 are supported and validated. Important For SSL/TLS connections, IM and Presence Service Release 15 SU4 or later requires Microsoft SQL Server 2022 with Cumulative
                                                      Update 1 (CU1) or later. | Important | For SSL/TLS connections, IM and Presence Service Release 15 SU4 or later requires Microsoft SQL Server 2022 with Cumulative
                                                      Update 1 (CU1) or later. |
| Important | For SSL/TLS connections, IM and Presence Service Release 15 SU4 or later requires Microsoft SQL Server 2022 with Cumulative
                                                      Update 1 (CU1) or later. |
