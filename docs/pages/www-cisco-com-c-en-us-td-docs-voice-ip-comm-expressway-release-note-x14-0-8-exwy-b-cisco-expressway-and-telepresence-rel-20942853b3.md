---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-expressway-release-note-x14-0-8-exwy-b-cisco-expressway-and-telepresence-rel-20942853b3
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/expressway/release_note/X14-0-8/exwy_b_cisco-expressway-and-telepresence-release-note-x1408.html
retrieved_at: 2026-08-16T22:08:23.296886+00:00
---

Cisco Expressway and Cisco TelePresence Video Communication Server Release Note (X14.0.8)
...
This is a known issue in the current release. Deploying X14.0.8 OVA shows "Invalid Certificate" on vCenter 7.0 U2 version of VMware, though it shows "Trusted Certificate" in older versions. Refer to Knowledge Article for more information about the issue.
...
## Features and Changes in X14.0.8
...
Before upgrading from pre-X14.0.2 release to X14.0.8, make sure the following certificate requirement is met.
...
| Note | This is a known issue in the current release. Deploying X14.0.8 OVA shows "Invalid Certificate" on vCenter 7.0 U2 version of VMware, though it shows "Trusted Certificate" in older versions. Refer to Knowledge Article for more information about the issue. |
|---|---|
...
| Important | Before upgrading from pre-X14.0.2 release to X14.0.8, make sure the following certificate requirement is met. |
|---|---|