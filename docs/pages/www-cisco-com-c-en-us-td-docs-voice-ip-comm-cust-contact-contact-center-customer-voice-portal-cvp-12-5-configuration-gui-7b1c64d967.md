---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-customer-voice-portal-cvp-12-5-configuration-gui-7b1c64d967
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/customer_voice_portal/cvp_12_5/configuration/guide/ccvp_b_1251-reportingguide-cvp/ccvp_b_1251-reportingguide-cvp_chapter_0101.html
retrieved_at: 2026-08-21T03:06:46.551438+00:00
---
...
Reports
                                          			 ...
                                          			 performance must remain within the guidelines defined in the Solution Design Guide for Cisco Unified Contact Center
                                             				Enterprise .
...
See the
                              		  ...
                              		  Also see the Solution Design Guide for Cisco Unified Contact Center
                                 			 Enterprise .
...
VXML_TYPE_SUBDIALOG_START

SubdialogStart

VXML_TYPE_SUBDIALOG_RETURN
...
VXML_TYPE_ELEMENTFLAG

flag_element

VXML_TYPE_REQICMLABEL

ReqICMLabel

VXML_TYPE_RECORDINGLABEL

RecordingLabel

VXML_TYPE_ELMENT_DEF
...
|---|---|
| VXML_TYPE_START | start |
| VXML_TYPE_END | end |
| VXML_TYPE_SUBDIALOG_START | SubdialogStart |
| VXML_TYPE_SUBDIALOG_RETURN | SubdialogReturn |
| VXML_TYPE_VOICE | voice |
| VXML_TYPE_DECISION | decision |
| VXML_TYPE_ACTION | action |
| VXML_TYPE_VXMLINSERT | vxml |
| VXML_TYPE_CUSTOM | custom |
| VXML_TYPE_HOTLINK | hotlink |
| VXML_TYPE_HOTEVENT | hotevent |
| VXML_TYPE_ELEMENTFLAG | flag_element |
| VXML_TYPE_REQICMLABEL | ReqICMLabel |
| VXML_TYPE_RECORDINGLABEL | RecordingLabel |
| VXML_TYPE_ELMENT_DEF | element_def |
