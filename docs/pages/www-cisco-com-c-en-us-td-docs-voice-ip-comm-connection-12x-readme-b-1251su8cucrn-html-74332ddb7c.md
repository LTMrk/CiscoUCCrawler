...
retrieved_at: 2026-09-08T06:07:33.241338+00:00
---
...
This readme file contains installation and support information for Cisco Unity Connection Release 12(1) SU8.
...
Cisco Unity Connection 12.5(1) SU8 is a cumulative update that incorporates all of the fixes and changes to Cisco Unity Connection
...
Full version numbers include the build number (for example, 12.5.1.18900-16), the software versions listed on the download
...
This section contains all new and changed support or functionality for release 12.5(1) SU8 and later.

The new locales for Unity Connection 12.5(1) SU8 have been released and available on Download Software site at https://software.cisco.com/download/home/282421576/type .
...
Upgrades from this SU to any release lower than 14SU1 are not allowed and will not be displayed as valid upgrade options due
                  to database and device layer support added in the VOS. Customers migrating from this SU must choose 14SU1 or higher as their
                  target upgrade.
...
For instructions on downloading the service update, see the " Downloading Cisco Unity Connection Release 12.5(1) SU8 Software " section.
...
If you are performing an upgrade from a FIPS enabled Cisco Unity Connection release to Cisco Unity Connection 12.5(1) SU8,
...
### Downloading Cisco Unity Connection Release 12.5(1) SU8 Software
...
On the Select a Release page, select 12.5(1) SU8 , and the download buttons appear on the right side of the page.
...
The VOS version for above mentioned ISO is 12.5.1.18900-40.
...
See the “ Rollback of Unity
                     		  Connection ” section of the “Upgrading Cisco Unity Connection” chapter of
                  		the Install, Upgrade,
...
- Open Caveats—Unity Connection Release 12.5(1) SU8

- Resolved Caveats—Unity Connection Release 12.5(1) SU8

Related Caveats—Cisco Unified Communications Manager 12.5(1) Components that are Used by Unity Connection 12.5(1)

### Open Caveats—Unity Connection Release 12.5(1) SU8

There are no open caveats in this release time frame.
...
Error while trying to update Certificate Monitor Settings and Certificate Revocation Setting.
...
Miu Port Busy and ICMP flood for DST unreachable due to loop call initiated from unity to endpoints
...
RTP Media Inactivity for longer duration leading to Miu Port Busy and hung ports
...
- ReadMe for Cisco Unified Communications Manager Release 12.5 SU8 on the download page for 12.5 SU8 (start at https://software.cisco.com/download/home/280082558 ).
...
| Note | The new locales for Unity Connection 12.5(1) SU8 have been released and available on Download Software site at https://software.cisco.com/download/home/282421576/type . |
|---|---|

| Note | Following change is also introduced in 12.5(1) SU8. Log4j upgrade to 2.17.2 |
|---|---|

| Note | If you are performing an upgrade from a FIPS enabled Cisco Unity Connection release to Cisco Unity Connection 12.5(1) SU8,
                              make sure to follow the steps for regenerating certificates before using any pre-existing telephony integrations. To learn
                              how to regenerate certificates, see the Regenerating Certificates for FIPS section of the "FIPS Compliance in Cisco Unity Connection" chapter of the Security Guide for Cisco Unity Connection Release 12.x at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/security/guide/b_12xcucsecx.html . |
|---|---|
...
| Step 4 | On the Select a Release page, select 12.5(1) SU8 , and the download buttons appear on the right side of the page. |
| Step 5 | Confirm that
                                    			 the computer you are using has sufficient hard-disk space for the downloaded
                                    			 files. (The download descriptions include file sizes.) |
| Step 6 | Select the
                                    			 applicable download, then follow the on-screen prompts to complete the
                                    			 download, making note of the MD5 value. Restricted version UCSInstall_CUC_12.5.1.18900-16.sha512.iso Unrestricted version UCSInstall_CUC_UNRST_12.5.1.18900-16.sha512.iso Note The VOS version for above mentioned ISO is 12.5.1.18900-40. | Restricted version | UCSInstall_CUC_12.5.1.18900-16.sha512.iso | Unrestricted version | UCSInstall_CUC_UNRST_12.5.1.18900-16.sha512.iso | Note | The VOS version for above mentioned ISO is 12.5.1.18900-40. |
| Restricted version | UCSInstall_CUC_12.5.1.18900-16.sha512.iso |
| Unrestricted version | UCSInstall_CUC_UNRST_12.5.1.18900-16.sha512.iso |
| Note | The VOS version for above mentioned ISO is 12.5.1.18900-40. |
...
|---|---|---|---|
| CSCwf13979 | config | 3 | Error while trying to update Certificate Monitor Settings and Certificate Revocation Setting. |
| CSCvp40778 | conversations | 3 | Miu Port Busy and ICMP flood for DST unreachable due to loop call initiated from unity to endpoints |
| CSCwd91126 | messaging | 3 | RTP Media Inactivity for longer duration leading to Miu Port Busy and hung ports |
