---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-connection-12x-troubleshooting-guide-b-12xcuctsg-b-12xcuctsg-chapter-011010--a403c411cf
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/troubleshooting/guide/b_12xcuctsg/b_12xcuctsg_chapter_011010.html
retrieved_at: 2026-08-17T02:30:13.417873+00:00
---
...
In addition, do the following procedure to confirm that the
                           		value of the Region Unrestricted Feature licensing option is set to Yes. If the
                           		value is set to No, you cannot use personal call transfer rules, and you cannot
                           		use English-United States language. To resolve the problem, install a license
                           		in which the feature is enabled, and restart Cisco Unity Connection. (An
                           		additional fee might be required to enable the feature. Contact your Cisco
                           		account team to obtain the updated license file.) For details, see the “ Managing Licenses ”
...
See the “ Calendar and Contact
                                                   				  Integration ” section of the “Introduction to Unified Messaging” chapter
                                                				of the Unified Messaging Guide for Cisco Unity Connection, Release 12.x,
                                                				available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/unified_messaging/b_12xcucumgx.html for detailed information on setting up external service accounts.
...
See the “ Phone System ” section
                                                				of the “Telephony Integrations” chapter of the System Administration Guide for
                                                				Cisco Unity Connection Release 12.x for
                                                				detailed information about AXL server settings. The guide is available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/administration/guide/b_12xcucsag.html .
...
For details on using RTMT, see the Cisco Unified Real-Time
                                                      				  Monitoring Tool Administration Guide, Release 12.0(1), available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/service/12_0_1/rtmt/cucm_b_cisco-unified-rtmt-administration-1201.html
...
| Note | See the “ Calendar and Contact
                                                   				  Integration ” section of the “Introduction to Unified Messaging” chapter
                                                				of the Unified Messaging Guide for Cisco Unity Connection, Release 12.x,
                                                				available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/unified_messaging/b_12xcucumgx.html for detailed information on setting up external service accounts. |
|---|---|
...
| Note | See the “ Phone System ” section
                                                				of the “Telephony Integrations” chapter of the System Administration Guide for
                                                				Cisco Unity Connection Release 12.x for
                                                				detailed information about AXL server settings. The guide is available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/12x/administration/guide/b_12xcucsag.html . |
|---|---|

| Step 1 | Launch Real-Time Monitoring Tool (RTMT). Note For details on using RTMT, see the Cisco Unified Real-Time
                                                      				  Monitoring Tool Administration Guide, Release 12.0(1), available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/service/12_0_1/rtmt/cucm_b_cisco-unified-rtmt-administration-1201.html | Note | For details on using RTMT, see the Cisco Unified Real-Time
                                                      				  Monitoring Tool Administration Guide, Release 12.0(1), available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/service/12_0_1/rtmt/cucm_b_cisco-unified-rtmt-administration-1201.html |
|---|---|---|---|
| Note | For details on using RTMT, see the Cisco Unified Real-Time
                                                      				  Monitoring Tool Administration Guide, Release 12.0(1), available at https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/service/12_0_1/rtmt/cucm_b_cisco-unified-rtmt-administration-1201.html |
