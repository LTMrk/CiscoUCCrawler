...
The Mail Servers screen appears with a list of configured servers and buttons to Add , Edit , or Delete a server. The Test  Connection button allows you to test connectivity to a server. The bottom part of the screen shows the recipients listed for each server
                                             and buttons to Add , Edit , or Delete a recipient.
...
In the Sender UserID field, enter the sender user ID that you need to notify.

Name/IP Address , Port No. , and Sender UserID are mandatory fields.

Step 7

Click the OK button to add the server. You can use the Clear button to clear the field, or the Cancel button to end the operation without adding the Mail server.

Step 8

To add or edit a recipient, go back to the Mail Server screen and Click the Add button to add a recipient or the Edit button to edit an existing configuration. The Add Mail Server screen appears.

Step 9

In the Email address field, enter the name or the email address of the recipient you are adding.

Step 10

Click the OK button to add the recipient. You can use the Cancel button to end the operation without adding the recipient.
...
When you use the Unified RTMT to connect to a Unified Communications Manager or a Cisco Business Edition 5000 server, you can add nodes to include Cisco Unity Connection and IM and Presence servers in the Unified Analysis Manager.
...
New
                                                               						resources "SOAP
                                                                  						  Diagnostic Portal Database Service" and "SOAP
                                                                  						  Call Record APIs" added on an upgrade should not have the read and update
                                                               						permissions by default due to security reasons for existing users. Users need
                                                               						to create or copy the role to custom resources and update the required
                                                               						permissions for above mentioned resources as needed. See the Cisco Unified Communications Manager Administration
...
Unified Communications
                                             					 Manager/Cisco Business Edition
...
|---|---|
| Step 2 | The Mail Servers screen appears with a list of configured servers and buttons to Add , Edit , or Delete a server. The Test  Connection button allows you to test connectivity to a server. The bottom part of the screen shows the recipients listed for each server
                                             and buttons to Add , Edit , or Delete a recipient. |
...
| Step 6 | In the Sender UserID field, enter the sender user ID that you need to notify. Note Name/IP Address , Port No. , and Sender UserID are mandatory fields. | Note | Name/IP Address , Port No. , and Sender UserID are mandatory fields. |
| Note | Name/IP Address , Port No. , and Sender UserID are mandatory fields. |
| Step 7 | Click the OK button to add the server. You can use the Clear button to clear the field, or the Cancel button to end the operation without adding the Mail server. |
| Step 8 | To add or edit a recipient, go back to the Mail Server screen and Click the Add button to add a recipient or the Edit button to edit an existing configuration. The Add Mail Server screen appears. |
| Step 9 | In the Email address field, enter the name or the email address of the recipient you are adding. |
| Step 10 | Click the OK button to add the recipient. You can use the Cancel button to end the operation without adding the recipient. |
...
| Call Type | Unified Communications
                                             					 Manager/Cisco Business Edition | Unified CCE | Unified CVP | Unified CCX |
|---|---|---|---|---|
...
| Default | This level should include all traces generated in abnormal paths. This level is intended for coding error traces and error
                                             s traces that normally should not occur. | Minimum Traces expected |
