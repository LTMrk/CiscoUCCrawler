---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-8800-series-firmware-14-4-1sr2-p881-b-8800-rn-1441sr2-html-92c55d4da5
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/8800-series/firmware/14-4-1SR2/p881_b_8800-rn-1441sr2.html
retrieved_at: 2026-08-17T01:11:38.136180+00:00
---

Cisco IP Phone 8800 Release Notes for Firmware Release 14.4(1)SR2
...
These release notes support the Cisco IP Phone 8811, 8841, 8851, 8851NR, and 8861 running SIP Firmware Release 14.4(1)SR2.
...
In the Latest Release folder, choose 14.4(1)SR2 .

Step 5

Select the firmware file, click the Download or Add to cart button, and follow the prompts:

The firmware filename is cmterm-88xx-sip.14-4-1-0201-225.k4.cop.sha512 depending on the model you choose.
...
If a Cisco Unified Communications Manager is not available to load the installer program, the following .zip file is available
                        to load the firmware cmterm-88xx.14-4-1-0201-225.zip.
...
The firmware file name is cmterm-88xx.14-4-1-0201-225.zip.
...
Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284729655&rls=14.4(1)SR2&sb=anfr&svr=3nH&bt=custV

Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284729655&rls=14.4(1)SR2&sb=afr&sts=open&svr=3nH&bt=custV

Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284729655&rls=14.4(1)SR2&sb=fr&sts=fd&svr=3nH&bt=custV
...
| Step 4 | In the Latest Release folder, choose 14.4(1)SR2 . |
| Step 5 | Select the firmware file, click the Download or Add to cart button, and follow the prompts: The firmware filename is cmterm-88xx-sip.14-4-1-0201-225.k4.cop.sha512 depending on the model you choose. Note If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . | Note | If you added firmware to the cart, when you are ready to download the files, click the Cart and then click Download All . |
...
| Step 2 | Choose your phone model. |
| Step 3 | Choose Session Initiation Protocol (SIP) Software . |
| Step 4 | In the Latest Releases folder, choose 14.4(1)SR2 . |
| Step 5 | Select the firmware file, click the Download or Add to Cart button, and follow the prompts. The firmware file name is cmterm-88xx.14-4-1-0201-225.zip. |
...
| Step 1 | Perform one of the following actions: Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284729655&rls=14.4(1)SR2&sb=anfr&svr=3nH&bt=custV Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284729655&rls=14.4(1)SR2&sb=afr&sts=open&svr=3nH&bt=custV Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284729655&rls=14.4(1)SR2&sb=fr&sts=fd&svr=3nH&bt=custV |
|---|---|
