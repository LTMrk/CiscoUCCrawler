---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-im-presence-database-setup-14-cup0-b-database-setup-guide-1401-cup0-b-d-fd18aa32d3
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/im_presence/database_setup/14/cup0_b_database-setup-guide-1401/cup0_b_database-setup-guide-1401_chapter_01.html
retrieved_at: 2026-08-16T16:19:23.367027+00:00
---
...
| Step 4 | Configure user
                                       			 access to the database. Edit the install_dir /data/pg_hba.conf file to allow the postgres user and the new tcuser user to access the database. 
                                       		  For example: #
                                                      							 TYPE DATABASE USER CIDR-ADDRESS METHOD host tcmadb tcuser 10.89.99.0/24 password host dbinst mauser 10.89.99.0/24 password local 1 all all Trust or MD5 1 For Unix domain socket connections only. | #
                                                      							 TYPE | DATABASE | USER | CIDR-ADDRESS | METHOD | host | tcmadb | tcuser | 10.89.99.0/24 | password | host | dbinst | mauser | 10.89.99.0/24 | password | local 1 | all | all |  | Trust or MD5 |
| #
