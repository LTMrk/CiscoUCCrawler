---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-finesse-finesse-1261-user-guide-cfin-b-1261-cisc-5645c057f1
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/finesse/finesse_1261/user/guide/cfin_b_1261-cisco-desktop-user-guide/cfin_b_1261-cisco-desktop-user-guide_chapter_01.html
retrieved_at: 2026-08-21T03:12:28.967517+00:00
---
...
Unified CCE uses ASCII encoding (8-bits), while Finesse uses UTF-8 encoding (32-bits), so the First Name field in the Call Control area
...
When there's an incoming call and the Cisco Finesse desktop window or tab is inactive, Finesse displays a notification with
                              the call details. Click the notification to restore the Finesse desktop.
...
| Note | Unified CCE uses ASCII encoding (8-bits), while Finesse uses UTF-8 encoding (32-bits), so the First Name field in the Call Control area
                                          is truncated to only 16 characters. |
|---|---|
