...
These release notes support the Cisco IP Phones 7811, 7821, 7841, and 7861 running SIP Firmware Release 12.0(1).
...
The following features are now supported in IPv6:

Survivable Remote Site Telephony version 6 (SRSTv6)
...
IPv6 Deployment Guide for Cisco Collaboration Systems Release 12.0

#### Mobile and Remote Access Through Expressway and Domain Name Handling

Mobile and Remote Access Through Expressway  users can now login using a domain that is different than the Expressway domain.
                           This enhancement allows adminstrators to deploy multiple UC clusters in different domains.
...
### Upgrade from a pre-11.5(1) Firmware Release

Your Cisco IP Phone 7800 Series phone may have trouble booting up if you are upgrading from a pre-11.5(1) release to 12.0(1)
                        firmware. If your phone uses an earlier firmware release, then follow one of these procedures:

Upgrade from a pre-11.5(1) release to 11.5(1) firmware first and then upgrade from 11.5(1) to 12.0(1) firmware or later.

Upgrade from a pre-11.5(1) release to 12.0.1ES5 release or later.

### Install the Firmware Release on Cisco Unified Communications Manager

Before using the Cisco Unified IP Phone Firmware Release 12.0(1) with Cisco Unified Communications Manager, you must install
...
- cmterm-78xx.12-0-1-11.k3.cop.sgn
...
Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=12.0(1)&sb=anfr&svr=3nH&bt=custV

Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=12.0(1)&sb=afr&svr=3nH&bt=custV

Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=12.0(1)&sb=fr&svr=3nH&bt=custV
...
| Step 1 | Perform one of the following actions: Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=12.0(1)&sb=anfr&svr=3nH&bt=custV Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=12.0(1)&sb=afr&svr=3nH&bt=custV Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284883944&rls=12.0(1)&sb=fr&svr=3nH&bt=custV |
|---|---|
