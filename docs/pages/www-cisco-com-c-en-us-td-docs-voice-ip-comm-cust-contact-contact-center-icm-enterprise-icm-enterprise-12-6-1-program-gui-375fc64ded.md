---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-12-6-1-program-gui-375fc64ded
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_12_6_1/program/guide/ucce_b_ctios-developer-guide_12_6_1/ucce_b_ctios-developer-guide_12_5_chapter_0111.html
retrieved_at: 2026-08-16T20:24:30.914056+00:00
---
...
E_CTIOS_INVALID_ARGUMENT - a null Arguments parameter was supplied. Connect is closed. No events are fired.

E_CTIOS_MISSING_ARGUMENT - indicates that method call provided no value for both CTIOS_CTIOSA or CTIOS_CTIOSB. At least one
                                       of these values must be provided. Connect is closed. No events are fired.
...
E_CTIOS_SESSION_NOT_CONNECTED - unanticipated error. Connect is closed. No events are fired.
...
E_CTIOS_SET_AGENT_SESSION_DISCONNECT_REQUIRED – You attempted to run SetAgent for a session in monitor mode. The SetAgent
                                       request is not sent. To correct, run the Disconnect method to disconnect the session, then run the SetAgent method.
