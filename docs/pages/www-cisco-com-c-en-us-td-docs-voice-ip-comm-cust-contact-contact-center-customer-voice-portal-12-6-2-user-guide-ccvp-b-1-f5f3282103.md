...
Open Windows Registry Editor (regedit) in the VXML Server and navigate to HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Apache Software Foundation\Procrun 2.0\VXMLServer\Parameters\Java\Options .

Add the following entries:

Djavax.net.ssl.trustStore=<Path to RESTServer_ca_cert>
...
| Note | For a self-
                                                         				  ...
                                                         				  certificate. Then, import this self-signed certificate in the VXML Server trust
                                                         				  store. |
| Step 4 | Open Windows Registry Editor (regedit) in the VXML Server and navigate to HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Apache Software Foundation\Procrun 2.0\VXMLServer\Parameters\Java\Options . Add the following entries: Djavax.net.ssl.trustStore=<Path to RESTServer_ca_cert> Djavax.net.ssl.trustStorePassword=changeit Djavax.net.ssl.trustStoreType=JCEKS |
| Step 5 | Restart the
