...
Display the web page for the phone and select Info > System Status > Product Information .
...
| Perform one of the following actions: On the phone, press Applications > Phone Information , and look at the MAC Address field. Look at the MAC label on the back of the phone. Display the web page for the phone and select Info > System Status > Product Information . |
|---|
