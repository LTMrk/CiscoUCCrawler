...
If the TLS version in server is lower than 1.3, the connection can't be established.
...
If the TLS version in client is lower than 1.3, the connection can't be established.
...
| Step 1 | Select Voice > System |
|---|---|
| Step 2 | In the Security Settings section, select a TLS version from the TLS Client Min Version list. TLS 1.0 : The TLS client supports the versions of  TLS from 1.0 to 1.3. If the TLS version in server is lower than 1.0, the connection can't be established. TLS 1.1 : The TLS client supports the versions of  TLS from 1.1 to 1.3. If the TLS version in server is lower than 1.1, the connection can't be established. TLS 1.2 (default): The TLS client supports TLS 1.2 and 1.3. If the TLS version in server is lower than 1.2, the connection can't be established. TLS 1.3 : The TLS client supports TLS 1.3 only. If the TLS version in server is lower than 1.3, the connection can't be established. The following table shows the brief view TLS client minimum value result. TLS Client min version Server TLS version Results TLS 1.0 TLS 1.1 TLS 1.1 TLS 1.2 TLS 1.2 TLS 1.3 TLS 1.3 TLS 1.1 TLS 1.1 TLS 1.1 TLS 1.2 TLS 1.2 TLS 1.3 TLS 1.3 TLS 1.2 TLS 1.1 Protocol alert TLS 1.2 TLS 1.2 TLS 1.3 TLS 1.3 TLS 1.3 TLS 1.1 Protocol alert TLS 1.2 Protocol alert TLS 1.3 TLS 1.3 You can configure this parameter in the phone configuration XML file (cfg.xml) by entering a string in this format: <TLS_Client_Min_Version ua="na">TLS 1.2</TLS_Client_Min_Version> Default Value: TLS 1.2 Note This feature has been applied to most of the TLS clients initiated by phone, such as SIP over TLS, XMPP, E911 Geolocation,
                                                      and Wifi. | TLS Client min version | Server TLS version | Results | TLS 1.0 | TLS 1.1 | TLS 1.1 | TLS 1.2 | TLS 1.2 | TLS 1.3 | TLS 1.3 | TLS 1.1 | TLS 1.1 | TLS 1.1 | TLS 1.2 | TLS 1.2 | TLS 1.3 | TLS 1.3 | TLS 1.2 | TLS 1.1 | Protocol alert | TLS 1.2 | TLS 1.2 | TLS 1.3 | TLS 1.3 | TLS 1.3 | TLS 1.1 | Protocol alert | TLS 1.2 | Protocol alert | TLS 1.3 | TLS 1.3 | Note | This feature has been applied to most of the TLS clients initiated by phone, such as SIP over TLS, XMPP, E911 Geolocation,
                                                      and Wifi. |
| TLS Client min version | Server TLS version | Results |
| TLS 1.0 | TLS 1.1 | TLS 1.1 |
| TLS 1.2 | TLS 1.2 |
| TLS 1.3 | TLS 1.3 |
| TLS 1.1 | TLS 1.1 | TLS 1.1 |
| TLS 1.2 | TLS 1.2 |
| TLS 1.3 | TLS 1.3 |
| TLS 1.2 | TLS 1.1 | Protocol alert |
| TLS 1.2 | TLS 1.2 |
| TLS 1.3 | TLS 1.3 |
| TLS 1.3 | TLS 1.1 | Protocol alert |
...
| Note | This feature has been applied to most of the TLS clients initiated by phone, such as SIP over TLS, XMPP, E911 Geolocation,
                                                      and Wifi. |
| Step 3 | Select a TLS version from the TLS Server Min Version list. Users need to use an HTTPS client that support TLS to connect with the phone. TLS 1.1 : The TLS server supports the versions of TLS from 1.1 to 1.3. If the TLS version in client is lower than 1.1, the connection can't be established. TLS 1.2 (default): The TLS server supports TLS 1.2 and 1.3. If the TLS version in client is lower than 1.2, the connection can't be established. TLS 1.3 : The TLS server supports TLS 1.3 only. If the TLS version in client is lower than 1.3, the connection can't be established. The following table shows the brief view TLS server minimum value result. TLS Server min version Client TLS version Results TLS 1.1 TLS 1.0 Protocol alert TLS 1.1 TLS 1.1 TLS 1.2 TLS 1.2 TLS 1.3 TLS 1.3 TLS 1.2 TLS 1.0 Protocol alert TLS 1.1 Protocol alert TLS 1.2 TLS 1.2 TLS 1.3 TLS 1.3 TLS 1.3 TLS 1.0 Protocol alert TLS 1.1 Protocol alert TLS 1.2 Protocol alert TLS 1.3 TLS 1.3 You can configure this parameter in the phone configuration XML file (cfg.xml) by entering a string in this format: <TLS_Server_Min_Version ua="na">TLS 1.2</TLS_Server_Min_Version> Default Value: TLS 1.2 | TLS Server min version | Client TLS version | Results | TLS 1.1 | TLS 1.0 | Protocol alert | TLS 1.1 | TLS 1.1 | TLS 1.2 | TLS 1.2 | TLS 1.3 | TLS 1.3 | TLS 1.2 | TLS 1.0 | Protocol alert | TLS 1.1 | Protocol alert | TLS 1.2 | TLS 1.2 | TLS 1.3 | TLS 1.3 | TLS 1.3 | TLS 1.0 | Protocol alert | TLS 1.1 | Protocol alert | TLS 1.2 | Protocol alert | TLS 1.3 | TLS 1.3 |
