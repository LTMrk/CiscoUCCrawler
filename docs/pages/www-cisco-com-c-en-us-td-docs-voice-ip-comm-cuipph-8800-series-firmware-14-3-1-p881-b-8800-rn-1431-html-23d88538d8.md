---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-8800-series-firmware-14-3-1-p881-b-8800-rn-1431-html-23d88538d8
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/8800-series/firmware/14-3-1/p881_b_8800-rn-1431.html
retrieved_at: 2026-08-21T13:29:08.961271+00:00
---

Cisco IP Phone 8800 Release Notes for Firmware Release 14.3(1)
...
The Cisco IP Phone 8800 Series (8851/8851NR/8861/8865/8865NR) now supports the connection with Cisco wireless headsets through
                        the Cisco Headset USB-C Adapter. The supported headset models include the following:

Cisco Headset 720 Series

Cisco Headset 730

Bang & Olufsen Cisco 950 Series
...
### Conference with Active Call Enhancement

Since from the release, you can quickly add an active call on a line to join a conference. This feature reduces the procedures
                        to select an active call on a line to join a conference after you press the Conference softkey or Conference . For example:

If each line has only one call on the phone, you can directly press the line key to add the call on the line to join a conference.

If at least a line has multiple calls on the phone, you can quickly navigate to the active calls (filtered by line) after
                              you press the line key. In this case, you can quickly select a call from the list to join a conference.

This feature is only available when the phone is set to the Enhanced line mode.
...
### Customize Ringtone Enhancement

Starting from the release, you have an option to select your desired ringtone on the phone screen even though your administrator
                        has selected a ringtone. This means that your selection takes precedence over the default ringtone set by your administrator.
...
### MRA High Availability

The Firmware Release 14.3(1) supports Mobile and Remote Access Through Expressway (MRA) High Availability (HA) that provides
                        the features Adaptive routing and STUN keepalive. These MRA HA features are used to improve the MRA failover.

The MRA HA features require:

Cisco Unified Communication Manager Release: 14 or later

Cisco Expressway Release: X14.0 or later
...
In the Latest Release folder, choose 14.3(1) .

Step 5

Select the firmware file, click the Download or Add to cart button, and follow the prompts:

The firmware filename is cmterm-8845_65-sip.14-3-1-0001-60.k4.cop.sha512 or cmterm-88xx-sip.14-3-1-0001-60.k4.cop.sha512,
...
If a Cisco Unified Communications Manager is not available to load the installer program, the following .zip files are available
                        to load the firmware: cmterm-8845_65.14-3-1-0001-60.zip or cmterm-88xx.14-3-1-0001-60.zip.
...
In the Latest Releases folder, choose 14.3(1) .

Step 5

Select the firmware file, click the Download or Add to Cart button, and follow the prompts.

The firmware file name is cmterm-8845_65.14-3-1-0001-60.zip or cmterm-88xx.14-3-1-0001-60.zip, depending on the model you
                                    choose.
...
Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284729655&rls=14.3(1)&sb=anfr&svr=3nH&bt=custV

Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284729655&rls=14.3(1)&sb=afr&sts=open&svr=3nH&bt=custV

Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284729655&rls=14.3(1)&sb=fr&sts=fd&svr=3nH&bt=custV
...
CSCwh52647: 8845/8865/88xx Screen Image Overlap during Conference

CSCwh63485: EMCC not working on ip phone when using service URL through a load

CSCwi41362: Phone will show error message of "out of memory" after use FIPPA for some time

CSCwj44047: Vulnerabilities in wpa-supplicant 2.1 CVE-2023-52160

CSCwj66059: Vulnerabilities in linux-kernel 3.0.31 CVE-2014-3180

CSCwj67585: Vulnerabilities in linux-kernel 3.10.94 CVE-2014-3180

CSCwj95457: 88XX VPN disconnects a few seconds into call

CSCwj98832: Vulnerabilities in busybox 1.21.0 CVE-2022-48174

CSCwk87411: Upgrade Window Not Displayed for Headsets Upgraded via Dongle (Dongle Upgrade Not Supported)
...
| Step 4 | In the Latest Release folder, choose 14.3(1) . |
| Step 5 | Select the firmware file, click the Download or Add to cart button, and follow the prompts: The firmware filename is cmterm-8845_65-sip.14-3-1-0001-60.k4.cop.sha512 or cmterm-88xx-sip.14-3-1-0001-60.k4.cop.sha512,
...
| Step 2 | Choose your phone model. |
| Step 3 | Choose Session Initiation Protocol (SIP) Software . |
| Step 4 | In the Latest Releases folder, choose 14.3(1) . |
| Step 5 | Select the firmware file, click the Download or Add to Cart button, and follow the prompts. The firmware file name is cmterm-8845_65.14-3-1-0001-60.zip or cmterm-88xx.14-3-1-0001-60.zip, depending on the model you
                                    choose. |
...
| Step 1 | Perform one of the following actions: Use this URL for all caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284729655&rls=14.3(1)&sb=anfr&svr=3nH&bt=custV Use this URL for all open caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=&pf=prdNm&pfVal=284729655&rls=14.3(1)&sb=afr&sts=open&svr=3nH&bt=custV Use this URL for all resolved caveats: https://bst.cloudapps.cisco.com/bugsearch/search?kw=*&pf=prdNm&pfVal=284729655&rls=14.3(1)&sb=fr&sts=fd&svr=3nH&bt=custV |
|---|---|
