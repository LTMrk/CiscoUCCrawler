...
The ALI Formatting Tool User Guide is built into the end-user interface as the AFT online help system. AFT's online help system provides task-oriented help that is available from the AFT window.
