---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-15-0-1-reference-g-387ea86bd3
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_15_0_1/reference/guide/ucce_b_cti-servermessage-reference-guide-for-1501/ucce-m-changes-and-additions-1501.html
retrieved_at: 2026-08-16T19:45:37.251087+00:00
---
...
Following is a list of changes made in Protocol Version 25:

The previous Floating Field Tag values for Tag values 312 and 313 have now been updated to MEDIA_TYPE_TAG and MEDIA_PROVIDER_TAG,
                                 respectively for the message MEDIA_LOGIN_REQ.

The PostRoute description in CONFERENCE_CALL_REQ, CONSULTATION_CALL_REQ, MAKE_CALL_REQ, and TRANSFER_CALL_REQ now states,
                                 "This field is not used in Unified CCE," and the related footnote has been removed.

The CCT description in MAKE_CALL_REQ and MAKE_PREDICTIVE_CALL_REQ now specifies, "Call Control table, required when Call Placement
                                 Type is CPT_OUTBOUND."

CTIOSCILClientID has been removed from CLEAR_CONNECTION_REQ and SEND_DTMF_SIGNAL_REQ.

PT_ASPECT, PT_SYMPOSIUM, and PT_SIMPLIFIED_IPCC have been removed from PeripheralType values.

References to Avaya Aura and Aspect Call Center removed from CALL_DELIVERED_EVENT.
