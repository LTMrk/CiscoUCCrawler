---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cusm-express-12-5-1-su1-install-guide-ccp-b-1251su1install-and-upgrade-ccp-b-5bad075b19
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cusm/express_12_5_1_SU1/install/guide/ccp_b_1251su1install-and-upgrade/ccp_b_1261install-and-upgrade_chapter_011.html
retrieved_at: 2026-08-16T21:13:07.754814+00:00
---
...
You can upgrade from SocialMiner Release 11.6(2), 12.0(1), and CCP Release 12.5(1) to Release 12.5(1) SU1.
...
The following table lists the SocialMiner and Customer Collaboration Platform version and the corresponding COP file that you have to download and install before you begin the upgrade. The COP files
...
From SocialMiner 11.6(2) and 12.0(1)
...
11.6(2), 12.0(1), 12.5(1) to 12.5(1) SU1
...
| Version | COP File |
|---|---|
| From Customer Collaboration Platform Release 12.5(1) | ciscoccp.keymanagement.cop.sgn |
| From SocialMiner 11.6(2) and 12.0(1) | ciscosm.keymanagement.cop.sgn |
