---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-finesse-finesse-1262-installation-guide-cfin-b-1-15b0e276e8
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/finesse/finesse_1262/installation/guide/cfin_b_1262_cisco-finesse-installation-and-upgrade/cfin_m_1261-upgrade.html
retrieved_at: 2026-08-21T15:53:29.698851+00:00
---
...
The following table lists the supported upgrade paths to Cisco Finesse Release 12.6(2):

Current Version

Upgrade Path

Release 12.0(x), 12.5(x), or 12.6(1)

Upgrade to Release 12.6(2)

To upgrade from releases prior to Cisco Finesse 12.0(1) to Cisco Finesse 12.6(2), you must first upgrade to 12.0(1) and then
                                                upgrade to 12.6(2).

To upgrade from Cisco Finesse 12.5(1) to Cisco Finesse 12.6(2), you must download and install ucos.keymanagement.v01.cop.sgn file from Software Download .

To upgrade from Cisco Finesse 12.6(1) to Cisco Finesse 12.6(2), you must download and install ucos.keymanagement.v02.cop.sgn file from Software Download .
...
For upgraded layouts, TeamMessage, Desktop Chat, and sample configurations for customizing desktop properties don’t appear by default. The administrator must copy the XML
                                    from the View Default Layout and add to the respective custom layouts. For more information, see the Cisco Finesse Administration Guide

After you upgrade to Cisco Finesse 12.0(1) , the name, format, and folder references of the Cisco-provided gadgets are changed automatically. Automatically modified
                                    gadget details are as follows:
...
|---|---|
| Release 12.0(x), 12.5(x), or 12.6(1) | Upgrade to Release 12.6(2) |

| Note | To upgrade from releases prior to Cisco Finesse 12.0(1) to Cisco Finesse 12.6(2), you must first upgrade to 12.0(1) and then
                                                upgrade to 12.6(2). To upgrade from Cisco Finesse 12.5(1) to Cisco Finesse 12.6(2), you must download and install ucos.keymanagement.v01.cop.sgn file from Software Download . To upgrade from Cisco Finesse 12.6(1) to Cisco Finesse 12.6(2), you must download and install ucos.keymanagement.v02.cop.sgn file from Software Download . |
|---|---|
