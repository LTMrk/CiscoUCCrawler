---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-vg248-1-0-english-configuration-guide-soft-con-vg248swc-html-64eb7612fa
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/vg248/1_0/english/configuration/guide/soft_con/vg248swc.html
retrieved_at: 2026-08-22T01:20:02.228045+00:00
---
...
By default, this value is set to be the same as the device name registered in the Cisco CallManager database. This device name is a unique character string generated based on the MAC address for the VG248 (see the "Adding the VG248 to Cisco CallManager" section on page 4-2 for details). However, you can use this setting to modify the host name.
