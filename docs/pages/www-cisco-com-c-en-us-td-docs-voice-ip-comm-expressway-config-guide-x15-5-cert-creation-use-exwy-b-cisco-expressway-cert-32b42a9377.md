---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-expressway-config-guide-x15-5-cert-creation-use-exwy-b-cisco-expressway-cert-32b42a9377
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/expressway/config_guide/X15-5/cert-creation-use/exwy_b_cisco-expressway-certificate-creation-and-use-deployment-guide-x155/exwy_m_about-this-guide.html
retrieved_at: 2026-08-16T15:09:53.418803+00:00
---
...
Included chapter "Managing Expressway Certificates". Segregated content under respective topics.

Included a new topic "Managing the Expressway Client Certificate".

Renamed "Expressway Certificates" to "Expressway CSR Alternative Name Requirements for Unified Communications Features" to
                                          match the content.
...
|---|---|---|
| April 2026 | First published for X15.5. Included chapter "Managing Expressway Certificates". Segregated content under respective topics. Included a new topic "Managing the Expressway Client Certificate". Renamed "Expressway Certificates" to "Expressway CSR Alternative Name Requirements for Unified Communications Features" to
                                          match the content. | X15.5 release |
