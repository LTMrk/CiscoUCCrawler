---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-be7000-releasenotes-be7000-softwareloadsummary-11x12x-xu-12-be7k-b-be70-635e33215b
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/BE7000/releasenotes/BE7000_SoftwareLoadSummary-11X12X-XU-12/be7k_b_be7000-software-load-Unrestricted-12X13X-XU-12_chapter_00.html
retrieved_at: 2026-08-21T01:07:15.582447+00:00
---

Business Edition 7000 Software Load Summary Export Unrestricted Version 11X12X-XU-12
...
Business Edition 7000 appliances are shipped with preinstalled application virtual machines. These application virtual machines
...
Use the system wizard through the virtual machine console, or provide a platformConfig.xml configuration file to configure the “skip” installed applications. Refer to the Business Edition 7000 Installation Guide for further information. The following table summarizes the installed applications for this build. New and updated software
...
(UCCX_12_0_400Agent_VM11_OVA.ova)
...
(cpc-provisioning-12.6.0.2283-medium_v6.5_signed.ova)
...
## Preloaded Applications - Business Edition 7000
...
The hypervisor datastore on the appliance's module includes installation files for Collaboration Solution Release 11 and 12
                              ...
                              and Cisco Unified Communications Manager Instant Messaging and Presence Server. You many install any of the other preloaded
                              applications with either of these UC releases. Unified Communications Version 11 or 12 applications must be used together.
...
Bootable_UCSInstall_UCOS_UNRST_11.5.1.10000-6.sgn.iso
...
UCSInstall_UCOS_UNRST_11.5.1.13901-3.sgn.iso
...
UCSInstall_CUP_UNRST_11.5.1.13900-57.sgn.iso
...
Bootable_CiscoPrimeLM_64bitLnx_11.5.1.10000-5.sgn.iso
...
CiscoPrimeLM_64bitLnx_11.5.1.11900-5.sgn.iso
...
|---|---|---|---|
| Cisco Unified Communications Manager (UCSInstall_UCOS_UNRST_12.5.1.10000-22_110_vmv13_v1.0.ova) | 12.5 | 7500 users | Partial (skip) installed application |
| Cisco Unified Communications Manager IM & Presence (UCSInstall_CUP_UNRST_12.5.1.10000-22_80d_vmv13_v1.0.OVA) | 12.5 | 5000 users | Partial (skip) installed application |
| Cisco Unity Connection (UCSInstall_CUC_UNRST_12.5.1.10000-23_200_v1.0.ova) | 12.5 | 5000 users | Partial (skip) installed application |
| Cisco Paging Server (Bootable-CiscoPagingServer_12.5.1.ova) | 12.5 | Standard | Deployed Application OVA |
| Cisco Unified Contact Center Express (UCCX_12_0_400Agent_VM11_OVA.ova) | 12.0 | 400 Agents | Partial (skip) installed application |
| Cisco Prime Collaboration Provisioning (cpc-provisioning-12.6.0.2283-medium_v6.5_signed.ova) | 12.6 | Medium | Deployed Application OVA |
...
| Cisco Unified Communications Manager & Cisco Unity Connection 1 |
| - Common Version 11.5(1) SU3 UCM application image | Bootable_UCSInstall_UCOS_UNRST_11.5.1.10000-6.sgn.iso | ESD | Yes | — |
| - 12.5 application image | Bootable_UCSInstall_UCOS_UNRST_12.5.1.10000-22.sgn.iso | ESD | — | Yes |
...
| - Version 12.5 | UCSInstall_UCOS_UNRST_12.5.1.10000-22.sgn.iso | CSC | — | Yes |
| - Version 11.5(1) Service Update 3 | UCSInstall_UCOS_UNRST_11.5.1.13901-3.sgn.iso | CSC | Yes | — |
...
| - Version 11.5(1) SU3 application | UCSInstall_CUP_UNRST_11.5.1.13900-57.sgn.iso | ESD | Yes | — |
...
| - Version 12.5 image Bootable | Bootable_UCSInstall_CUP_UNRST_12.5.1.10000-22.sgn.iso | CSC | — | Yes |
| -Version 12.5 recovery image | 12.5.1.10000-22-recovery.iso | CSC | — | Yes |
...
| Cisco Unity Connection |
| - 12.5 application image | Bootable_UCSInstall_CUC_UNRST_12.5.1.10000-23.sgn.iso | CSC | — | Yes |
| -Version 12.5 recovery image | 12.5.1.10000-23-recovery.iso | CSC | — | Yes |
| -Version 12.5 | UCSInstall_CUC_UNRST_12.5.1.10000-23.sgn.iso | CSC | — | Yes |
...
| - Application image | Bootable_CiscoPrimeLM_64bitLnx_11.5.1.10000-5.sgn.iso | ESD | Yes | Yes |
| - Recovery image | 11.5.1.10000-5-recovery.iso | CSC | Yes | Yes |
| - Virtual machine template | plm_11.5_vmv8_v1.1.ova | CSC | Yes | Yes |
| - 11.5(1) SU1a Update | CiscoPrimeLM_64bitLnx_11.5.1.11900-5.sgn.iso | CSC | Yes | Yes |
