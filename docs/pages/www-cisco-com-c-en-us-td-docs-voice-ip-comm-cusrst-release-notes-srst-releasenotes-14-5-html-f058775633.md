...
Release Notes for Cisco Unified Survivable Remote Site Telephony, Release 14.5
...
New Features in Unified SRST, Release 14.5 (Cisco IOS XE 17.15.1a)

Caveats

Open Caveats—Unified SRST, Release 14.5
...
This Release Notes document describes the features of Cisco Unified Survivable Remote Site Telephony, Release 14.5. The Cisco Unified Survivable Remote Site Telephony, Release 14.5 is included in Cisco IOS XE 17.15.1a and later releases.
...
Cisco IOS XE Software, Version Cisco IOS XE 17.15.1a

Cisco IOS Software, ISR Software (X86_64_LINUX_IOSD-UNIVERSALK9-M),

Copyright (c) 1986-2022 by Cisco Systems, Inc.

Compiled Mon 16-Jan-24 01:12.
...
There are no feature updates for Unified SRST, 14.5 Release.
...
There are no open or unresolved caveats for Unified SRST, 14.5 Release.
