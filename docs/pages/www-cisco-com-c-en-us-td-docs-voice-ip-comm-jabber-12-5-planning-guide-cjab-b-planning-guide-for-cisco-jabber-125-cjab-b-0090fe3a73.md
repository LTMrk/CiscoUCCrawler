---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-jabber-12-5-planning-guide-cjab-b-planning-guide-for-cisco-jabber-125-cjab-b-0090fe3a73
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/jabber/12_5/Planning_Guide/cjab_b_planning-guide-for-cisco-jabber-125/cjab_b_planning-guide-for-cisco-jabber-125_chapter_010.html
retrieved_at: 2026-08-21T19:10:11.509197+00:00
---
...
5, 5c, 5s, 6, 6 Plus, , 6s, and 6s Plus, 7 and 7 Plus, 8 and 8 Plus , iPhone X, XR, XS, and XS Max, and Apple Watch
...
For two-way video: 480p x 800p or higher.

For IM only:  320p x 480p or higher.

Cisco Jabber for Android now supports Full UC mode in the following devices with respective version of Operating System provided
                                 in the table:
...
Contact your administrator to set your Jabber phone service to be secure. Jabber plays ringback tone and busy tone at 24kHz.
...
TC70 devices might sometimes have issues connecting to Wi-Fi network configured over DHCP.
...
Cisco Jabber for Android supports Samsung Knox on these devices:
...
Users can now install from Play store when the device is paried with a mobile device.
...
P9, P10, P10 Plus, P20, P20 Pro, Mate 8, Mate 9, Mate 10, Mate 10 Pro, Mate 20, Mate 20 Pro
...
S6, S6 edge, S6 edge+, S7, S7 edge, S8, S8+, S9, S9+, Note 5, Note 8, Note 9, Tab S3
...
| Webex Meetings Server | 2.8 MR1 and later 2.0 and later Cisco Jabber for Windows supports 1.5 and later |
...
| iPhone | 5, 5c, 5s, 6, 6 Plus, , 6s, and 6s Plus, 7 and 7 Plus, 8 and 8 Plus , iPhone X, XR, XS, and XS Max, and Apple Watch |
| iPod touch | 5 and |
...
|---|---|---|
| 5.0 or later | 1.5 GHz dual-core Recommended: 1.2-GHz quad-core or higher | For two-way video: 480p x 800p or higher. For IM only:  320p x 480p or higher. |

| Device | Device Model | Minimum Android Operating System version | Notes |
|---|---|---|---|
| BlackBerry | Priv | 5.1 | Blackberry Priv device limitation: If Jabber is removed from the recently viewed apps list, and the device is kept idle for
                                             some time, then Jabber becomes inactive. |
...
| 5X | 6.0 |  |
| 6 | 5.0.2 |  |
| 6P | 6.0 | If you have a Google Nexus 6P device with Android OS version 6.x or 7.0, then contact your administrator to set your Jabber
                                             phone service as a secure phone service. Otherwise, your device might not respond. However, if your Android OS version is
                                             7.1 or later, no action is required. |
| 7 | 5.0 |  |
| 9 | 5.0.2 |  |
...
| Pixel C | 6.0 |  |
| Pixel XL | 7.0 |  |
| Pixel 2 | 8.0 | During a Jabber call if the user switches audio from mobile device to a headset, then there might be some issues with the
                                             audio for few seconds. |
| Pixel 2 XL | 8.0 | During a Jabber call if the user switches audio from mobile device to a headset, then there might be some issues with the
                                             audio for few seconds. |
| Pixel 3 | 8.0 | During a Jabber call if the user switches audio from mobile device to a headset, then there might be some issues with the
                                             audio for few seconds. |
| Pixel 3 XL | 8.0 | During a Jabber call if the user switches audio from mobile device to a headset, then there might be some issues with the
                                             audio for few seconds. |
| Honeywell Dolphin | CT40 | 7.1.1 |  |
| CT50 | 5.0 |  |
| CT60 | 7.1.1 | Supported only with OS 7.1.1 |
| HTC | 10 | 6.0 |  |
| A9 | 6.0 |  |
| E9 PLUS | 5.0.2 |  |
| M7 | 5.0 |  |
...
| V10 | 5.0 |  |
| V30 | 8.0 |  |
| Motorola | MC40 | 5.0 | Cisco Jabber supports only audio mode with MC40 device. Cisco Jabber does not support launching Webex Meetings from MC40 device. |
| Moto G | 5.0 |  |
| Moto X | 5.0 |  |
| Moto Z Droid | 6.0 |  |
| Nokia | Nokia 6.1 | 8.0 |  |
...
| Z2 | 5.0 |  |
| Z2 tablet | 5.0 |  |
| Z3 | 5.0 | Sony Xperia Z3 (Model SO-01G) with Android OS 5.0.2 has poor audio on Jabber calls. |
...
| ZR/A | 5.0 | There is a limitation that Sony devices with Android OS 6.0 cannot play voicemail in Jabber. |
| Xiaomi | 4C | 5.1 |  |
| MAX | 5.1 |  |
| Mi 4 | 5.0 |  |
| Mi 5 | 6.0 |  |
...
| Redmi Note 5 | 8.0 |  |
| Zebra | TC51 | 6.0 |  |
| TC70 | 5.0 | TC70 devices might sometimes have issues connecting to Wi-Fi network configured over DHCP. In TC70, the default value of Keep wifi on during sleep is Off , you must set it to Always On to use Jabber. |
| TC75X | 6.0 |  |

| Knox Version | Samsung Galaxy Device Model |
|---|---|
| 2.6 | Note 10.1 (2014 Edition) Note 4 Note 5 Note Edge S5 S6 S6 Edge S6 Edge Plus S7 S7 Edge Tab S 8.4 and 10.5 |
| 2.7.1 | Galaxy Note5 |
| 3.1 | Galaxy A5 (2017) |
| 3.2 | Galaxy On5 (2016) |
| 3.3 | Galaxy S10 |
...
|---|---|
| HTC M7 | Android OS 5.0 or later |
| HTC M8 | Android OS 5.0 or later |
| HTC M9 | Android OS 5.0 or later |
| HTC One Max | Android OS 5.0 or later |
| Sony Xperia M2 | Android OS 5.0 or later and kernel version earlier than 3.10.49. If a Sony device's android OS is 5.0.2 or later and kernel version is 3.10.49 or later, then the device can support non-secure
                                                   mode. |
| Sony Xperia Z1 |
| Sony Xperia ZR/A |
| Sony Xperia Z2 |
...
| Sony Xperia Z3 |
| Sony Xperia Z3 Tablet Compact |
| Xiaomi Mi4 | (Android OS 5.0 or later) |
| Xiaomi Mi Note | (Android OS 5.0 or later) |
| Xiaomi Mi Pad | (Android OS 5.0 or later) |
| Sonim XP7 | (Android OS 5.0) |
| Honeywell Dolphin CT50 | Android OS 5.0 or later |
...
| Huawei | P9, P10, P10 Plus, P20, P20 Pro, Mate 8, Mate 9, Mate 10, Mate 10 Pro, Mate 20, Mate 20 Pro |
| OnePlus | 5, 5T, 6, 6T |
| Samsung | S6, S6 edge, S6 edge+, S7, S7 edge, S8, S8+, S9, S9+, Note 5, Note 8, Note 9, Tab S3 |
| Sony | Xperia XZ2, XZ3 |
| Xiaomi | Mi6, Mi8, Mi Mix2, Pocophone |
| LG | LG V30 |
