---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-expressway-release-note-x14-0-6-exwy-b-cisco-expressway-release-note-x1406-h-e05332bfc4
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/expressway/release_note/X14-0-6/exwy_b_cisco-expressway-release-note--x1406.html
retrieved_at: 2026-08-16T22:06:43.286925+00:00
---

Cisco Expressway and Cisco TelePresence Video Communication Server Release Note (X14.0.6)
...
Not supported (after X12.5.x) except limited support with X12.6.x versions for maintenance and bug fixing purposes only. Security/Vulnerability
                              support is extended to version X14.0.5.
...
This is a known issue in the current release. Deploying X14.0.3 OVA shows "Invalid Certificate" on vCenter 7.0 U2 version of VMware, though it shows "Trusted Certificate" in older versions. Refer to Knowledge Article for more information about the issue.
...
## Features and Changes in X14.0.6
...
Before upgrading from pre-X14.0.2 release to X14.0.6, make sure the following certificate requirement is met.
...
| CE1100 (Expressway pre-installed on UCS C220 M4L) | 52D##### | Not supported (after X12.5.x) except limited support with X12.6.x versions for maintenance and bug fixing purposes only. Security/Vulnerability
                              support is extended to version X14.0.5. |
...
| Note | This is a known issue in the current release. Deploying X14.0.3 OVA shows "Invalid Certificate" on vCenter 7.0 U2 version of VMware, though it shows "Trusted Certificate" in older versions. Refer to Knowledge Article for more information about the issue. |
|---|---|
...
| Important | Supply issues with components used in the Expressway CE1200 are delaying orders. In light of the supply issues, we are extending
                                 the end of Vulnerability/Security support for the CE1100 by 3 months, that is, from November 14, 2021 to February 14, 2022. Please ignore the warning " unsupported hardware " in the User Interface. |
|---|---|
...
| Important | Before upgrading from pre-X14.0.2 release to X14.0.6, make sure the following certificate requirement is met. |
|---|---|