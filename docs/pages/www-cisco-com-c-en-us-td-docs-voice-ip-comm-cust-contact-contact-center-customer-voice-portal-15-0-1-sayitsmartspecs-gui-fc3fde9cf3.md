...
This Say It Smart type handles the reading of any number. The number can be negative or positive, contain a decimal, and can
                           even contain an exponent. The whole part of the number is read ordinarily and the decimal part of the number is read digit-by-digit.
                           This plug-in can handle numbers up to 999 trillion.
...
The whole part of the number is read ordinarily and the decimal is read digit-by-digit.
...
The whole part of the number is read ordinarily, the decimal is read digit-by-digit, omitting trailing zeros.
...
|---|---|---|
| standard (Standard Number) | standard | The whole part of the number is read ordinarily and the decimal is read digit-by-digit. |
| no_trailing_0s (Read w/ no Trailing
                                          0s) | standard | The whole part of the number is read ordinarily, the decimal is read digit-by-digit, omitting trailing zeros. |
