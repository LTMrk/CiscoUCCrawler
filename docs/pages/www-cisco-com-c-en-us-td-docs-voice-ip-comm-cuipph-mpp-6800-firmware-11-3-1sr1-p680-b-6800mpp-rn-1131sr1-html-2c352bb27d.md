---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-mpp-6800-firmware-11-3-1sr1-p680-b-6800mpp-rn-1131sr1-html-2c352bb27d
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/MPP/6800/firmware/11-3-1sr1/p680_b_6800mpp-rn-1131sr1.html
retrieved_at: 2026-08-21T23:13:55.628362+00:00
---

Cisco IP Phone 6800 Series Multiplatform Phones Release Notes for Firmware Release 11.3(1)SR1
...
Use these release notes with the Cisco IP Phone 6800 Series Multiplatform Phones running SIP Firmware Release 11.3(1)SR1.
...
6821: cmterm-6821.11-3-1MSR1-3_REL.zip

Other phones in 6800 series: cmterm-68xx.11-3-1MSR1-3_REL.zip
...
http://10.73.10.223/firmware/sip6821.11-3-1MSR1-3.loads

https://server.domain.com/firmware/sip6821.11-3-1MSR1-3.loads

Other phones in 6800 series:

http://10.73.10.223/firmware/sip68xx.11-3-1MSR1-3.loads

https://server.domain.com/firmware/sip68xx.11-3-1MSR1-3.loads
...
```
https://10.74.10.225/admin/upgrade?http://10.73.10.223/firmware/sip6821.11-3-1MSR1-3.loads
```

```
https://10.74.10.225/admin/upgrade?https://server.domain.com/firmware/sip6821.11-3-1MSR1-3.loads
```

```
https://10.74.10.225/admin/upgrade?http://10.73.10.223/firmware/sip68xx.11-3-1MSR1-3.loads
```

```
https://10.74.10.225/admin/upgrade?https://server.domain.com/firmware/sip68xx.11-3-1MSR1-3.loads
```
...
The following list contains the severity 1, 2, and 3 defects that are open for the Cisco IP Phone 6800 Series Multiplatform Phones that use Firmware Release 11.3(1)SR1.
...
The following list contains the severity 1, 2, and 3 defects that are resolved for the Cisco IP Phone 6800 Series Multiplatform Phones that use Firmware Release 11.3(1)SR1.
...
| Step 6 | Download the corresponding file. 6821: cmterm-6821.11-3-1MSR1-3_REL.zip Other phones in 6800 series: cmterm-68xx.11-3-1MSR1-3_REL.zip |
