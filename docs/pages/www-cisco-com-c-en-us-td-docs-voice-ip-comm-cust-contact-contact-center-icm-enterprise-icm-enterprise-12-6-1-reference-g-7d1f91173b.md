---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-icm-enterprise-icm-enterprise-12-6-1-reference-g-7d1f91173b
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/icm_enterprise/icm_enterprise_12_6_1/reference/guide/ucce_b_cti-servermessage-reference-guide-for-1261/ucce_b_cti-servermessagereferenceguideprotocolversion24-for-1261_chapter_0100.html
retrieved_at: 2026-08-16T19:46:50.105555+00:00
---
...
Both the active and standby CTI Servers accept the client connection. The standby CTI server accepts only clients with CTI
                           Server protocol version 24 or later and connects with a new service mask (CTI_SERVICE_ACTIVE_STANDBY). If the CTI server protocol
                           version is lower than 24, the standby CTI server rejects the client connection by logging an error message 'E_CTI_INVALID_CLIENT_FOR_STANDB
                           in the server logs.
