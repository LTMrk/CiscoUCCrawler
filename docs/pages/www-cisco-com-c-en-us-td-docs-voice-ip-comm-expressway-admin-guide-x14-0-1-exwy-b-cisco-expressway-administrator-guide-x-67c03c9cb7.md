---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-expressway-admin-guide-x14-0-1-exwy-b-cisco-expressway-administrator-guide-x-67c03c9cb7
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/expressway/admin_guide/X14-0-1/exwy_b_cisco-expressway-administrator-guide-x14-0-1/exwy_m_zones-and-neighbors.html
retrieved_at: 2026-08-16T22:42:12.338242+00:00
---
...
| Look up peers by | Determines whether you look up peers by address, or by service (SRV) record lookup. Address (default) allows you to add up to six peers. When you click Save , the Expressway does the lookup for the addresses. Service record produces a field to enter the Service Domain. When you click Save , the Expressway queries its DNS server for service records based on the domain you entered and the protocols and transports
                                          ...
                                          register against is 15. If you use look up by DNS server be aware that your zones communicate over the SRV record-specified port and not the zone
                                          port. Keep the DNS-specified port open on your firewall. |
