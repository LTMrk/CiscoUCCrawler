---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-expressway-config-guide-x14-2-mra-exwy-b-mra-deployment-guide-x142-exwy-m-mr-ad677cc6d2
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/expressway/config_guide/X14-2/mra/exwy_b_mra-deployment-guide-x142/exwy_m_mra-troubleshooting.html
retrieved_at: 2026-08-16T15:20:55.129616+00:00
---
...
### Jabber Cannot Sign in When Connecting to Different Peers in a Cluster of Cisco Expressway-E s
...
Note that the solution must be configured to userid of the IDP that is provided in the SAML assertion should match the sAMAccountName
                                    of CUCM userid to validate against the tokens (access/refresh).
...
The Unified Communications traversal zone has a default hop count of 15. If you suspect this is a contributing factor, sign
                              in to all your MRA Expressways, raise the hop count to a significantly larger number, for example, 70 and test.
...
| Step 1 | If you wish to get information about the current calls, go to the Call status page ( Status > Calls > Calls ). The Call status page lists all the calls currently taking place to or from devices registered with the Cisco Expressway , or that are passing through the Cisco Expressway . |
|---|---|
