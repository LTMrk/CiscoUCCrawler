...
### Install Firmware Release 11.0(6)SR2 on Cisco Unified
                     				Communications Manager
...
From the Latest Releases folder, click 11.0(6)SR2 .
...
Click the following links to view bugs for the 11.0(6)SR2 release of the Cisco Wireless IP Phone 8821 and 8821-EX :
...
CSCvz43035 8821 Phones are not all intiating the re-association request frame to roam
...
| Step 3 | Click Session Initiation Protocol (SIP) Software . |
| Step 4 | From the Latest Releases folder, click 11.0(6)SR2 . |
| Step 5 | Click Download or Add to Cart next to the following zip file and follow the prompts. Zip file: cmterm-8821.11-0-6SR2-4.zip |
| Step 6 | Extract the files from the zip file, manually copy them to the Cisco Unified
                                    				Communications Manager Express TFTP server (router flash), and enable them for TFTP. |

| Step 1 | Click the following links to view bugs for the 11.0(6)SR2 release of the Cisco Wireless IP Phone 8821 and 8821-EX : View all bugs . View open bugs . View resolved bugs . |
|---|---|
