...
Cisco Emergency Responder Release 14SU4 supports the following new features:

## Switch Support

Support switch port based tracking for new Voice LAN Switches: Cisco Catalyst 2960L Series, Cisco 1100 Integrated Services
                  Routers, Cisco 890 Integrated Services Routers, and Meraki Managed Catalyst Switch C9300. For more information, see the Supported Voice Ready Lan Switches section.

## Requirements

### Supported Hardware and Software

The information in the following sections discuss Hardware and Software requirements for Cisco Emergency Responder 14SU4.
...
Cisco Unified IP Phone 9841, 9851, 9861, 9871, 9971, 9951, 8961, 8945, 8941, 8865, 8861, 8851, 8845, 8841, 7975, 7971, 7970, 7965, 7962, 7961, 7945, 7942, 7941, 7911, 7910, and 7906
...
Cisco Emergency Responder 12.5(1) or Cisco Emergency Responder 12.5(1a) or Cisco Emergency Responder 12.5(1) SU1 or Cisco
                              ...
                              Emergency Responder 12.5(1) SU5 or Cisco Emergency Responder 12.5(1) SU6 or Cisco Emergency Responder 12.5(1) SU8b
...
12.5(1), 12.5(1a), 12.5(1) SU1, 12.5(1) SU2, 12.5(1) SU3, 12.5(1) SU4, 12.5(1) SU5, 12.5(1) SU6 , 12.5(1)SU7 , and 12.5(1)SU8b
...
Multiple Unified Communications Products Unauthenticated API High CPU DoS Vulnerability

CSCwe24363

CER incremental discovery broken due to concurrent modification exception.

CSCwe61617

ALI Formatting tool GUI formatting issue

CSCwj54976

Discrepancy for update of usergroup's description via UI and API
...
CER ERL Management API conventional ERL Update failure. COS/TOS field requires text instead of number

CSCwh82026

CER fails to update location for phones tracked via AXL incremental discovery

CSCwh81316

Tomcat stuck in starting for CER upgraded pub having tomcat-ecdsa multisan certs

CSCwf99494

Validate_Network Module in Diagnose tool throws error after upgrade to 14 SU3

CSCwi70220

Repeated debug log lines printing in cer logs

CSCwe04145

HTTP Headers Missing SameSite=Strict in Emergency Responder
...
| Note | Any IP endpoint can be tracked at call time using the IP subnet provided that the Use IP Address From Call Signaling Telephony
                                                setting is enabled. |
| Phones supported for off-premises location confirmation and update with the Remote Worker Emergency Calling feature in Unified
                                          Communications Manager 9.0 and later Cisco IP Communicator Cisco Virtual Desktop (VXCC) Cisco IP Phone 7800 Series Cisco Unified IP Phone 9841, 9851, 9861, 9871, 9971, 9951, 8961, 8945, 8941, 8865, 8861, 8851, 8845, 8841, 7975, 7971, 7970, 7965, 7962, 7961, 7945, 7942, 7941, 7911, 7910, and 7906 | When configured for off-premises use in Unified Communications Manager 9.0 and later, these phones provide displays for off-premises
...
| Identifier | Headline |
|---|---|
| CSCwf62074 | Multiple Unified Communications Products Unauthenticated API High CPU DoS Vulnerability |
| CSCwe24363 | CER incremental discovery broken due to concurrent modification exception. |
| CSCwe61617 | ALI Formatting tool GUI formatting issue |
| CSCwj54976 | Discrepancy for update of usergroup's description via UI and API |
| CSCwi97789 | Restrict X.509 certificate validity periods - Revert of CSCvk20066 |
| CSCwi96690 | CER ERL Management API conventional ERL Update failure. COS/TOS field requires text instead of number |
| CSCwh82026 | CER fails to update location for phones tracked via AXL incremental discovery |
| CSCwh81316 | Tomcat stuck in starting for CER upgraded pub having tomcat-ecdsa multisan certs |
