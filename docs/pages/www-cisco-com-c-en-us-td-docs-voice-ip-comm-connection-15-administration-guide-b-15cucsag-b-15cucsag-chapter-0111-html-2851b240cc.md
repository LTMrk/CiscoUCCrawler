---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-connection-15-administration-guide-b-15cucsag-b-15cucsag-chapter-0111-html-2851b240cc
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/connection/15/administration/guide/b_15cucsag/b_15cucsag_chapter_0111.html
retrieved_at: 2026-08-17T02:13:37.328980+00:00
---
...
Interview handlers are not matched by extension for forwarded calls in the same manner as users or call handlers.You should
                                       create a routing rule to route calls to interview handlers.
...
| Note | With Cisco Unity Connection Release 14SU1 and later, the maximum recording time for one Interview Handler Question is 300
                                       ...
                                       maximum number of questions that can be recorded on Unity Connection is 20. Interview handlers are not matched by extension for forwarded calls in the same manner as users or call handlers.You should
                                       create a routing rule to route calls to interview handlers. |
|---|---|
