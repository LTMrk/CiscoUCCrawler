---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-8821-firmware-11-0-3-sr2-w881-b-cisco-8821-rns-110003sr2-html-2f1f3bbdae
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/8821/firmware/11-0-3-SR2/w881_b_cisco-8821-rns-110003sr2.html
retrieved_at: 2026-08-21T13:35:55.704019+00:00
---

Cisco Wireless IP Phone 8821 Release Notes for Firmware Release 11.0(3)SR2
...
These release notes support the Cisco Wireless IP Phone 8821 Firmware Release 11.0(3)SR2.
...
### Install Firmware Release 11.0(3)SR2 on Cisco Unified Communications Manager
...
Firmware file: cmterm-8821-sip.11-0-3SR2-1.k3.cop.sgn

If you added
				  the firmware file to the cart, click the Download Cart link when you are ready to download
				  the file.

### Install Firmware Release 11.0(3)SR2 on Cisco Unified Communications Manager Express
...
The file to download is cmterm-8821.11-0-3SR2-1.zip
...
| Step 5 | In the Latest
			 Releases folder, choose 11.0(3)SR2 . |
| Step 6 | Select the
			 firmware file, click the Download or Add to
				cart button, and follow the prompts. Firmware file: cmterm-8821-sip.11-0-3SR2-1.k3.cop.sgn Note If you added
				  the firmware file to the cart, click the Download Cart link when you are ready to download
...
| Step 4 | Choose 11.0(3)SR2 in the Latest Releases folder. |
| Step 5 | Click Download or Add to cart and follow the prompts. The file to download is cmterm-8821.11-0-3SR2-1.zip |
