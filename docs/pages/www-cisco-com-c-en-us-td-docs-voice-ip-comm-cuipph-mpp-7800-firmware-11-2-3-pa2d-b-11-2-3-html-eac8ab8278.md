---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cuipph-mpp-7800-firmware-11-2-3-pa2d-b-11-2-3-html-eac8ab8278
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cuipph/MPP/7800/firmware/11-2-3/pa2d_b_11_2_3.html
retrieved_at: 2026-08-21T23:20:04.068674+00:00
---

Cisco IP Phone 7800 Series Multiplatform Phones Release Notes for Firmware Release 11.2(3)
...
Use these release notes with the following Cisco IP Phone 7800 Series Multiplatform Phones running SIP Firmware Release 11.2(3).

Cisco IP Phone 7811, 7821, 7841, and  7861 Multiplatform Phones
...
You must set Use Line Keys For BLF List to Yes to enable the phone to monitor the BLF list.
...
Cisco IP Phone 7800 Multiplatform Phones Administration Guide

Cisco IP Phone 7800 Multiplatform Phones Provisioning Guide
...
Use the information in this section to upgrade the firmware on Cisco IP Phone 7811, 7821, 7841, and 7861 Multiplatform Phones.

The Cisco IP Conference Phone 7832 Multiplatform Phones have a different firmware image. For more information, see the Cisco IP Conference Phone 7832 Multiplatform Phones Release Notes for Firmware Release 11.2(3), at this location:
...
Download the cmterm-78xx.11-2-3MPP-398_REL.zip file.
...
https://10.74.10.225/admin/upgrade?https://10.73.10.223/firmware/sip78xx.11-2-3MPP-398.loads
...
The following list contains the severity 1, 2, and 3 defects that are open for the Cisco IP Phone 7800 Series Multiplatform Phones that use Firmware Release 11.2(3).
...
CSCvo01547 When the phone set ignores an incoming call , the Current Ringer Volume is not right

## Resolved Caveats

The following list contains the severity 1, 2, and 3 defects that are resolved for the Cisco IP Phone 7800 Series Multiplatform Phones that use Firmware Release 11.2(3).
...
CSCvm53194 Extension Mobility randomly logs out
...
| Note | You must set Use Line Keys For BLF List to Yes to enable the phone to monitor the BLF list. |
|---|---|
...
| Step 6 | Download the cmterm-78xx.11-2-3MPP-398_REL.zip file. |
