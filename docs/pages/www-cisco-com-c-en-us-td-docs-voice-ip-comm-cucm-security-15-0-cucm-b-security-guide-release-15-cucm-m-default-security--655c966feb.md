...
The following table is applicable from Release 15SU1 onwards.
...
ITL Hash of any of the tftp servers and phone are the same.

MisMatch

ITL Hash of the server is not as that of the phone or the ITL Hash of the phone or the server is unknown.
...
| Note | The following table is applicable from Release 15SU1 onwards. |
| Field | Description |
| Match | ITL Hash of any of the tftp servers and phone are the same. |
| MisMatch | ITL Hash of the server is not as that of the phone or the ITL Hash of the phone or the server is unknown. |
| Not Installed | The phone fails to register to a new CUCM server and bounces back to its prior server. |
| Step 3 | Click Find . |
