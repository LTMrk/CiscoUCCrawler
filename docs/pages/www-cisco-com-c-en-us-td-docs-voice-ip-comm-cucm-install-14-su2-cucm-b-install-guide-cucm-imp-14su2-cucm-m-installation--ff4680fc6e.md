...
## Installation Methods Task Flows
...
Use this method to install a Unified Communications Manager or IM and Presence Service cluster using skip-install OVAs.

Install with Data Import

Complete this tasks to install a Unified Communications Manager or IM and Presence Service cluster using Install with Data
                                          Import.
...
| Touchless Installation Task Flow | Use this task flow to install a Unified Communications Manager or IM and Presence Service cluster dynamically without the
                                          need for manual intervention. Applies to either Centralized or Standard (Decentralized) IM and Presence deployments. |
| Automated Installation using vApp properties and VMware OVF Tool | Use this method to install a Unified Communications Manager or IM and Presence Service cluster using skip-install OVAs. |
| Install with Data Import | Complete this tasks to install a Unified Communications Manager or IM and Presence Service cluster using Install with Data
                                          Import. |
...
| Note | For basic installation of IM and Presence Service in a de-centralized/distributed (Standard) deployment, follow the Installation Methods Task Flows to install both the telephony and IM and Presence Service clusters. |
|---|---|
