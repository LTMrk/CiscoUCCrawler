---
doc_id: developer-cisco-com-docs-cisco-emergency-responder-configuration-api-v15su2-8c14819913
source_url: https://developer.cisco.com/docs/cisco-emergency-responder-configuration-api-v15su2/
retrieved_at: 2026-08-24T22:11:47.554635+00:00
---

# Cisco Emergency Responder Configuration API v15su2
...
Version 2: callhistory and phone details API
...
Refers to the CallHistory and Phone Details configuration API which helps in retrieving callhistory, trackable phones, non-trackable phones, manual config phones and unlocated phones details. This IPSubnet API is supported for CER Versions >= 15SU2.
...
CER also supports a separate read-only API for retrieving additional CER configuration details.
