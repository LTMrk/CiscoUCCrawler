---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cust-contact-contact-center-finesse-finesse-1501-installation-guide-rcct-b-v-ede598ba66
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cust_contact/contact_center/finesse/finesse_1501/installation/guide/rcct_b_vpn-less-finesse/rcct_m_vpn-less_preface.html
retrieved_at: 2026-08-16T19:57:48.183523+00:00
---
...
Have added the following properties in "Cisco Finesse Properties" section.
...
Have added the following properties in "Cisco IdS Properties" section.
...
This guide describes how to install and upgrade Cisco Contact Center Enterprise Reverse Proxy and perform the required configurations
                           to enable VPN-less Finesse.

## Audience

This guide is intended for Contact Center administrators who configure and run the Reverse Proxy Installer to enable VPN-less
                           Finesse.
...
| Change | See | Date |
|---|---|---|
| Have added the following properties in "Cisco Finesse Properties" section. NGX_PRXY_ALT_FIN_HOSTNAME NGX_PRXY_ALT_FIN_PORT NGX_ALT_FIN_HOSTNAME | Cisco Finesse Properties | November, 2025 |
| Have added the following properties in "Cisco IdS Properties" section. NGX_PRXY_ALT_IDS_HOSTNAME NGX_PRXY_ALT_IDS_PORT NGX_ALT_IDS_HOSTNAME | Cisco IdS properties | November. 2025 |
| Multi-instance support | Run Multiple Containers on a Single Host | April 30, 2025 |
| OS upgrade | Upgrade Notes |
| Automatic upgrade |
