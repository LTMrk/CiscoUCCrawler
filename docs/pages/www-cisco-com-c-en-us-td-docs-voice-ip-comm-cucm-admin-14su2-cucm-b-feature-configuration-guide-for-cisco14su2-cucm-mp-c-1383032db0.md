---
doc_id: www-cisco-com-c-en-us-td-docs-voice-ip-comm-cucm-admin-14su2-cucm-b-feature-configuration-guide-for-cisco14su2-cucm-mp-c-1383032db0
source_url: https://www.cisco.com/c/en/us/td/docs/voice_ip_comm/cucm/admin/14SU2/cucm_b_feature-configuration-guide-for-cisco14su2/cucm_mp_c0dc4c29_00_configure-location-awareness12-0.html
retrieved_at: 2026-08-16T16:26:17.898304+00:00
---
...
Network infrastructure devices such as switches and wireless access points, including IP addresses, hostnames, and Basic Service
                                    Set Identifier (BSSID) information (where applicable) for each infrastructure device.
...
Unified Communications Manager supports Meraki Wireless Access Point for Location Awareness.
...
Support is limited to the model with this specific OUI. While a model may have multiple OUIs, from the Unified Communications
                              ...
                              model are not supported within Unified Communications Manager or Emergency Responder. Refer to the 'Supported Meraki Wireless
                              Access Point for Location Awareness' section in the CER Release Notes documentation for the supported Meraki Wireless Access Points.
...
The Infrastructure Device Utility tool retrieves access points from the Meraki dashboard. The tool formats this data for use
                                             on the Insert Infrastructure Device page. You can view this utility in the Upload/Download Files page.
...
This note applies to releases 12.5(1)SU6, 14SU1, and later releases through 15SU4.

You can define both an IPv4 and IPv6 address, or you can define an IPv4 or an IPv6 address.

For Meraki Access Points, the Unified Communications Manager updates the Basic Service Set Identifiers (BSSID) in the Database after normalizing it to its base BSSID. For more information
                                             about BSSID calculation for Meraki Access Points, see Calculating Cisco Meraki BSSID MAC Addresses .

For Non- Meraki Access Points, the Unified CM updates the BSSID in the database by masking the last byte with 0. This masking
                                             logic helps Unified CM to uniquely identify the Access Point as opposed to the BSSIDs for the individual channels on the Access
                                             Point.
...
Click Find and select the job that you created.
...
| Note | The Infrastructure Device Utility tool retrieves access points from the Meraki dashboard. The tool formats this data for use
                                             on the Insert Infrastructure Device page. You can view this utility in the Upload/Download Files page. |
|---|---|

| Note | This note applies to releases 12.5(1)SU6, 14SU1, and later releases through 15SU4. You can define both an IPv4 and IPv6 address, or you can define an IPv4 or an IPv6 address. For Meraki Access Points, the Unified Communications Manager updates the Basic Service Set Identifiers (BSSID) in the Database after normalizing it to its base BSSID. For more information
                                             about BSSID calculation for Meraki Access Points, see Calculating Cisco Meraki BSSID MAC Addresses . For Non- Meraki Access Points, the Unified CM updates the BSSID in the database by masking the last byte with 0. This masking
                                             logic helps Unified CM to uniquely identify the Access Point as opposed to the BSSIDs for the individual channels on the Access
                                             Point. |
|---|---|
...
| Step 6 | If you chose to run the job later, schedule when the job runs: Choose Bulk Administration > Job Scheduler . Click Find and select the job that you created. In the Job Scheduler window, schedule when you want to run the job. Click Save . At the scheduled time, the job runs. |
