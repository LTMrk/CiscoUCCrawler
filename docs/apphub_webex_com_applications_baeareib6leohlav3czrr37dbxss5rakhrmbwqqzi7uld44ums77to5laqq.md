ThousandEyes MCP Server - Webex App Hub
[Skip to content](https://apphub.webex.com/applications/baeareib6leohlav3czrr37dbxss5rakhrmbwqqzi7uld44ums77to5laqq#main-content) [Skip to footer](https://apphub.webex.com/applications/baeareib6leohlav3czrr37dbxss5rakhrmbwqqzi7uld44ums77to5laqq#main-footer)
...
Back
* * *
![ThousandEyes MCP Server logo](https://developer-applications.webexcontent.com/agenticServers/icons/4e1c4fa3511641849f222bf81407d5e5.png)
#### ThousandEyes MCP Server
Federated through Agntcy Developed by thousandeyes; Imported from External Registry
Bring real-time network intelligence to your AI assistant—troubleshoot outages, analyze performance, and run instant tests using natural language.
[ Learn more ](https://developer.webex.com/mcp/docs/federated-through-external-registry-mcp-servers#thousandeyes)
![ThousandEyes MCP Server logo](https://developer-applications.webexcontent.com/agenticServers/icons/4e1c4fa3511641849f222bf81407d5e5.png)
#### ThousandEyes MCP Server
Federated through Agntcy Developed by thousandeyes; Imported from External Registry
Agentic App by [thousandeyes](https://www.thousandeyes.com)
* * *
Bring real-time network intelligence to your AI assistant—troubleshoot outages, analyze performance, and run instant tests using natural language.
[ Learn more ](https://developer.webex.com/mcp/docs/federated-through-external-registry-mcp-servers#thousandeyes)
Agentic App by [thousandeyes](https://www.thousandeyes.com)
The ThousandEyes MCP Server integrates your AI assistant with the ThousandEyes platform, enabling conversational access to network and application monitoring data. NetOps and SRE teams can identify root causes by asking questions like "Show me outages in the last hour" or "Troubleshoot the latency spike in San Jose." The server provides visibility across Cloud, Enterprise, and Endpoint agents and allows for triggering "Instant Tests" to diagnose live issues, accelerating incident response by reducing context switching. To get started, generate a User API Token from your ThousandEyes profile, then add the remote server URL <https://api.thousandeyes.com/mcp> to your preferred AI client. Requirements include a Webex license and an active ThousandEyes account with API access enabled. The server is available to customers with an active subscription, with "Instant Tests" consuming test units per your plan. Visit thousandeyes.com/pricing for details.
##### Support
* * *
  * ![Developer Support](https://apphub.webex.com/images/developer-support.png)[Developer Support](https://docs.thousandeyes.com/product-documentation/integration-guides/thousandeyes-mcp-server)
  * ![Privacy Policy](https://apphub.webex.com/images/privacy.png)[Privacy Policy](https://www.thousandeyes.com/cisco-privacy/)
