[Jump to Content](https://help.webexconnect.io/docs/wxcc-faqs#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)FAQs - WXCC
Search
`CTRL-K`
All
Platform Documentation
...
# FAQs - WXCC
Common asked questions about various channels in Cisco Webex Contact Center integration
[Suggest Edits](https://help.webexconnect.io/edit/wxcc-faqs)
**Which channels are supported as part of Webex Connect and Cisco Webex Contact Center integration?**
Webex Connect and Cisco Webex Contact Center integration currently supports SMS, Live Chat, Email, and Facebook Messenger channels. We plan to add more channels soon and this section will be updated as we roll out support for additional channels.
**Which file formats are supported across various channels as part of Webex Connect and Cisco Webex Contact Center integration?**  
...
* * *
[Best Practices and Guidelines - WXCC](https://help.webexconnect.io/docs/wxcc-best-practices-guidelines)[Overview - CCE](https://help.webexconnect.io/docs/cce_overview)
