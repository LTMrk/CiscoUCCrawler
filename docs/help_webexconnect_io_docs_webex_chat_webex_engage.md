[Jump to Content](https://help.webexconnect.io/docs/webex-chat-webex-engage#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Webex Chat/ Webex Engage
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/webex-chat-webex-engage)
> ## 📘
> Deprecation Alert
...
[](https://help.webexconnect.io/docs/webex-chat-webex-engage#configure-imichat-details)
...
![Screenshot of Configuring New IMIchat Integratio](https://files.readme.io/9fbee8d-imichat.jpg)
Configuring New IMIchat Integration.  
...
[](https://help.webexconnect.io/docs/webex-chat-webex-engage#configure-rules-based-on-imichat-events)
...
| Trigger  | Action  |  
| --- | --- |  
| Incoming message from any of the channels selcted  | Invoke a flow  
Foward to CCSP ( Choose IMIchat integration)  
Forward to BOT and CCSP.  |  
Updated over 1 year ago
* * *
[Cancel Appointment Flow Template](https://help.webexconnect.io/docs/cancel-appointment-flow-template)[Enghouse Integration-Deprecated](https://help.webexconnect.io/docs/enghouse-integration-deprecated)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/webex-chat-webex-engage)
  *     * [Configure IMIchat Details](https://help.webexconnect.io/docs/webex-chat-webex-engage#configure-imichat-details)
    * [CONFIGURE RULES BASED ON IMIchat EVENTS](https://help.webexconnect.io/docs/webex-chat-webex-engage#configure-rules-based-on-imichat-events)
