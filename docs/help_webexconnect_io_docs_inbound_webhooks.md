[Jump to Content](https://help.webexconnect.io/docs/inbound-webhooks#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Inbound Webhooks
Search
`CTRL-K`
All
Platform Documentation
...
# Inbound Webhooks
Configure the inbound webhook URL in any of your applications to start sending events and triggers to Webex Connect
[Suggest Edits](https://help.webexconnect.io/edit/inbound-webhooks)
...
[](https://help.webexconnect.io/docs/inbound-webhooks#trigger-conditions-for-inbound-webhook)
...
![Screenshot for Inbound Webhook with a trigger condition to invoke the flow](https://files.readme.io/bdc8fba23a7b2007ec2008277bca8190472035f0af9c782440624de71d313b76-05_31_19.jpg)
Inbound Webhook with a trigger condition to invoke the flow
...
* * *
[Migrate an Existing WhatsApp Number to a Business Account](https://help.webexconnect.io/docs/migrate-an-existing-whatsapp-number-to-a-whatsapp-business-account)[Outbound Webhooks](https://help.webexconnect.io/docs/outbound-webhooks)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/inbound-webhooks)
  *     * [Trigger Conditions for Inbound Webhook](https://help.webexconnect.io/docs/inbound-webhooks#trigger-conditions-for-inbound-webhook)
