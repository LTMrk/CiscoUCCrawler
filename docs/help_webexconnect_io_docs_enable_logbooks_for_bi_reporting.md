[Jump to Content](https://help.webexconnect.io/docs/enable-logbooks-for-bi-reporting#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Enable Logbooks for BI Reporting
Search
`CTRL-K`
All
Platform Documentation
...
Access this add-on tool to enable logbooks for Business Intelligence (BI) reporting.
[Suggest Edits](https://help.webexconnect.io/edit/enable-logbooks-for-bi-reporting)
...
![Screenshot displaying the option to Enable FiIe Destination](https://files.readme.io/378364e-c3b9bff0-6b02-4fcc-9780-cf74aa243f74.png)
Screenshot displaying the option to Enable File Destination
...
![Interface showing the 'BI Reporting Enabled' label](https://files.readme.io/c33fca8-BI_reporting.png)
Screenshot displaying the label BI Reporting Enabled
...
## 
Logbook Usage
[](https://help.webexconnect.io/docs/enable-logbooks-for-bi-reporting#logbook-usage)
...
* * *
[Logbooks](https://help.webexconnect.io/docs/logbook)[Media Manager](https://help.webexconnect.io/docs/media-manager)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/enable-logbooks-for-bi-reporting)
  *     * [Logbook Usage](https://help.webexconnect.io/docs/enable-logbooks-for-bi-reporting#logbook-usage)
