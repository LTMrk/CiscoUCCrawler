[Jump to Content](https://help.webexconnect.io/docs/get-available-slots#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Get Available slots
Search
`CTRL-K`
All
Platform Documentation
...
# Get Available slots
The EPIC Get available slots flow automates retrieval of available appointment slots from EPIC EHR for use by the Webex AI Agent.
[Suggest Edits](https://help.webexconnect.io/edit/get-available-slots)
## 
Overview
[](https://help.webexconnect.io/docs/get-available-slots#overview)
...
## 
Pre-requisite
[](https://help.webexconnect.io/docs/get-available-slots#pre-requisite)
...
## 
User
[](https://help.webexconnect.io/docs/get-available-slots#user)
...
## 
Create flow
[](https://help.webexconnect.io/docs/get-available-slots#create-flow)
...
## 
Node Breakdown
[](https://help.webexconnect.io/docs/get-available-slots#node-breakdown)
### 
Configure AI Agent
[](https://help.webexconnect.io/docs/get-available-slots#configure-ai-agent)
...
### 
Authenticate
[](https://help.webexconnect.io/docs/get-available-slots#authenticate)
This node performs EPIC authentication using OAuth 2.0 before any scheduling API request is made.
#### 
Purpose
[](https://help.webexconnect.io/docs/get-available-slots#purpose)
...
### 
Outcome
[](https://help.webexconnect.io/docs/get-available-slots#outcome)
...
[](https://help.webexconnect.io/docs/get-available-slots#get-open-slots-prebuilt-node)
...
### 
Purpose
[](https://help.webexconnect.io/docs/get-available-slots#purpose-1)
...
### 
Behavior
[](https://help.webexconnect.io/docs/get-available-slots#behavior)
...
## 
Evaluate
[](https://help.webexconnect.io/docs/get-available-slots#evaluate)
This node implements the retry mechanism used when the Get Open Slots request fails.
### 
Purpose
[](https://help.webexconnect.io/docs/get-available-slots#purpose-2)
...
### 
Logic
[](https://help.webexconnect.io/docs/get-available-slots#logic)
...
### 
Outcome
[](https://help.webexconnect.io/docs/get-available-slots#outcome-1)
...
## 
Trim Result Set
[](https://help.webexconnect.io/docs/get-available-slots#trim-result-set)
...
### 
Purpose
[](https://help.webexconnect.io/docs/get-available-slots#purpose-3)
...
### 
Observed Logic
[](https://help.webexconnect.io/docs/get-available-slots#observed-logic)
  * Parse slotsData
...
## 
Output
[](https://help.webexconnect.io/docs/get-available-slots#output)
· The transformed array is stored in slotsArray
### 
Output Payload Description
[](https://help.webexconnect.io/docs/get-available-slots#output-payload-description)  
| Field  | Description  |  
| --- | --- |  
...
## 
Error Handling
[](https://help.webexconnect.io/docs/get-available-slots#error-handling)
### 
API Timeout / Transient Failure
[](https://help.webexconnect.io/docs/get-available-slots#api-timeout--transient-failure)
...
### 
Invalid Credentials
[](https://help.webexconnect.io/docs/get-available-slots#invalid-credentials)
If EPIC authentication fails, the flow cannot proceed to slot retrieval and exits through the error path.
### 
Invalid Data
[](https://help.webexconnect.io/docs/get-available-slots#invalid-data)
...
### 
No Slots Available
[](https://help.webexconnect.io/docs/get-available-slots#no-slots-available)
...
## 
Script Analysis
[](https://help.webexconnect.io/docs/get-available-slots#script-analysis)
### 
Trim Result Set Script
[](https://help.webexconnect.io/docs/get-available-slots#trim-result-set-script)
...
### 
Observed Processing
[](https://help.webexconnect.io/docs/get-available-slots#observed-processing)
...
### 
Result
[](https://help.webexconnect.io/docs/get-available-slots#result)
The final transformed response is stored in slotsArray
## 
Retry Logic Script
[](https://help.webexconnect.io/docs/get-available-slots#retry-logic-script)
The JavaScript in the Evaluate node implements the standard retry pattern used across EPIC fulfillment flows.
### 
Observed Processing
[](https://help.webexconnect.io/docs/get-available-slots#observed-processing-1)
...
### 
Result
[](https://help.webexconnect.io/docs/get-available-slots#result-1)
...
Updated 20 days ago
* * *
[Patient Match (EPIC EHR) Flow Template](https://help.webexconnect.io/docs/patient-match-epic-ehr-flow-template)[EPIC Reschedule Appointment Flow Template](https://help.webexconnect.io/docs/epic-reschedule-appointment-flow-template)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/get-available-slots)
  *     * [Overview](https://help.webexconnect.io/docs/get-available-slots#overview)
    * [Pre-requisite](https://help.webexconnect.io/docs/get-available-slots#pre-requisite)
    * [User](https://help.webexconnect.io/docs/get-available-slots#user)
    * [Create flow](https://help.webexconnect.io/docs/get-available-slots#create-flow)
    * [Node Breakdown](https://help.webexconnect.io/docs/get-available-slots#node-breakdown)
      * [Configure AI Agent](https://help.webexconnect.io/docs/get-available-slots#configure-ai-agent)
      * [Authenticate](https://help.webexconnect.io/docs/get-available-slots#authenticate)
      * [Outcome](https://help.webexconnect.io/docs/get-available-slots#outcome)
    * [Get Open Slots Prebuilt Node](https://help.webexconnect.io/docs/get-available-slots#get-open-slots-prebuilt-node)
      * [Purpose](https://help.webexconnect.io/docs/get-available-slots#purpose-1)
      * [Behavior](https://help.webexconnect.io/docs/get-available-slots#behavior)
    * [Evaluate](https://help.webexconnect.io/docs/get-available-slots#evaluate)
      * [Purpose](https://help.webexconnect.io/docs/get-available-slots#purpose-2)
      * [Logic](https://help.webexconnect.io/docs/get-available-slots#logic)
      * [Outcome](https://help.webexconnect.io/docs/get-available-slots#outcome-1)
    * [Trim Result Set](https://help.webexconnect.io/docs/get-available-slots#trim-result-set)
      * [Purpose](https://help.webexconnect.io/docs/get-available-slots#purpose-3)
      * [Observed Logic](https://help.webexconnect.io/docs/get-available-slots#observed-logic)
    * [Output](https://help.webexconnect.io/docs/get-available-slots#output)
      * [Output Payload Description](https://help.webexconnect.io/docs/get-available-slots#output-payload-description)
    * [Error Handling](https://help.webexconnect.io/docs/get-available-slots#error-handling)
      * [API Timeout / Transient Failure](https://help.webexconnect.io/docs/get-available-slots#api-timeout--transient-failure)
      * [Invalid Credentials](https://help.webexconnect.io/docs/get-available-slots#invalid-credentials)
      * [Invalid Data](https://help.webexconnect.io/docs/get-available-slots#invalid-data)
      * [No Slots Available](https://help.webexconnect.io/docs/get-available-slots#no-slots-available)
    * [Script Analysis](https://help.webexconnect.io/docs/get-available-slots#script-analysis)
      * [Trim Result Set Script](https://help.webexconnect.io/docs/get-available-slots#trim-result-set-script)
      * [Observed Processing](https://help.webexconnect.io/docs/get-available-slots#observed-processing)
      * [Result](https://help.webexconnect.io/docs/get-available-slots#result)
    * [Retry Logic Script](https://help.webexconnect.io/docs/get-available-slots#retry-logic-script)
      * [Observed Processing](https://help.webexconnect.io/docs/get-available-slots#observed-processing-1)
      * [Result](https://help.webexconnect.io/docs/get-available-slots#result-1)
