[Jump to Content](https://help.webexconnect.io/docs/configuring-branded-mail-in-apple-business-connect#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Configuring Branded Mail in Apple Business Connect
Search
`CTRL-K`
All
Platform Documentation
...
Learn about configuring and testing Branded Mail in Apple Business Connect
[Suggest Edits](https://help.webexconnect.io/edit/configuring-branded-mail-in-apple-business-connect)
## 
Overview
[](https://help.webexconnect.io/docs/configuring-branded-mail-in-apple-business-connect#overview)
...
## 
Prerequisites
[](https://help.webexconnect.io/docs/configuring-branded-mail-in-apple-business-connect#prerequisites)
...
## 
Domain Structure
[](https://help.webexconnect.io/docs/configuring-branded-mail-in-apple-business-connect#domain-structure)
Branded Mail can be set up at one of the following levels: 
  ...
  * Specific email address. e.g., mailid@domain.tld
...
[](https://help.webexconnect.io/docs/configuring-branded-mail-in-apple-business-connect#set-up-branded-mail-in-apple-business-connect)
...
[](https://help.webexconnect.io/docs/configuring-branded-mail-in-apple-business-connect#verify-domain-for-branded-mail-in-apple-business-connect)
...
* * *
[Best Practices to Improve Email Deliverability](https://help.webexconnect.io/docs/best-practices-to-improve-email-deliverability)[Setting up Brand Indicators for Message Identification (BIMI)](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/configuring-branded-mail-in-apple-business-connect)
  *     * [Overview](https://help.webexconnect.io/docs/configuring-branded-mail-in-apple-business-connect#overview)
    * [Prerequisites](https://help.webexconnect.io/docs/configuring-branded-mail-in-apple-business-connect#prerequisites)
    * [Domain Structure](https://help.webexconnect.io/docs/configuring-branded-mail-in-apple-business-connect#domain-structure)
    * [Set up Branded Mail in Apple Business Connect](https://help.webexconnect.io/docs/configuring-branded-mail-in-apple-business-connect#set-up-branded-mail-in-apple-business-connect)
    * [Verify Domain for Branded Mail in Apple Business Connect](https://help.webexconnect.io/docs/configuring-branded-mail-in-apple-business-connect#verify-domain-for-branded-mail-in-apple-business-connect)
