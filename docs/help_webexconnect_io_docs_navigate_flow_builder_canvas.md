[Jump to Content](https://help.webexconnect.io/docs/navigate-flow-builder-canvas#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Navigating Flow Builder Canvas
Search
`CTRL-K`
All
Platform Documentation
...
Editor to create interactive communication flows with minimal programming or scripting efforts
[Suggest Edits](https://help.webexconnect.io/edit/navigate-flow-builder-canvas)
## 
Interface Components
[](https://help.webexconnect.io/docs/navigate-flow-builder-canvas#interface-components)
The flow builder has the following user interface components:
![Screenshot of Flow Builder Interface.](https://files.readme.io/7e3dff1-flow_designer.png)
Flow Builder Interface
### 
1. Canvas
[](https://help.webexconnect.io/docs/navigate-flow-builder-canvas#1-canvas)
...
### 
2. Node Palette
[](https://help.webexconnect.io/docs/navigate-flow-builder-canvas#2-node-palette)
...
### 
3. Canvas Controls
[](https://help.webexconnect.io/docs/navigate-flow-builder-canvas#3-canvas-controls)
...
[](https://help.webexconnect.io/docs/navigate-flow-builder-canvas#4-flow-controls-and-settings)
...
### 
5. Flow Versioning
[](https://help.webexconnect.io/docs/navigate-flow-builder-canvas#5-flow-versioning)
This area displays the current [version](https://help.webexconnect.io/docs/versioning) of the flow. Click the drop-down list box to view the _Version History_ and to load any of the available versions in the flow canvas.
### 
6. Right-side Toolbar
[](https://help.webexconnect.io/docs/navigate-flow-builder-canvas#6-right-side-toolbar)
Optional tools that aid flow setup.
  ...
  * _[Share](https://help.webexconnect.io/docs/flows#section-sharing-a-flow)_ : Generates a read-only link to share the flow with other users including/excluding the **Analyze Mode**. The Analyze Mode option is visible only if the administrator has configured it. You must protect the shareable link with a password. 
  * _[Flow Debug](https://help.webexconnect.io/docs/debugging)_ : Launches the debug pane from the bottom of the flow and allows you to access detailed debug logs for each flow run.


Updated 4 months ago
* * *
[Flows](https://help.webexconnect.io/docs/flows-introduction)[Flow Settings](https://help.webexconnect.io/docs/flow-settings)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/navigate-flow-builder-canvas)
  *     * [Interface Components](https://help.webexconnect.io/docs/navigate-flow-builder-canvas#interface-components)
      * [1. Canvas](https://help.webexconnect.io/docs/navigate-flow-builder-canvas#1-canvas)
      * [2. Node Palette](https://help.webexconnect.io/docs/navigate-flow-builder-canvas#2-node-palette)
      * [3. Canvas Controls](https://help.webexconnect.io/docs/navigate-flow-builder-canvas#3-canvas-controls)
      * [4. Flow Controls and Settings](https://help.webexconnect.io/docs/navigate-flow-builder-canvas#4-flow-controls-and-settings)
      * [5. Flow Versioning](https://help.webexconnect.io/docs/navigate-flow-builder-canvas#5-flow-versioning)
      * [6. Right-side Toolbar](https://help.webexconnect.io/docs/navigate-flow-builder-canvas#6-right-side-toolbar)
