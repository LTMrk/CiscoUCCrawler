[Jump to Content](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Freshdesk
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/prebuilt-integration-freshdesk)
## 
Introduction
[](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#introduction)
...
## 
Version Supported
[](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#version-supported)
This integration is based on Freshdesk API v2.
## 
Pre-requisites
[](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#pre-requisites)
...
## 
Node Configuration
[](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#node-configuration)
...
Screenshot of View a Contact method configuration page.
  1. You can see the data that this node generates under the Output Variables section. These [variables](https://help.webexconnect.io/docs/variable-management) are available for use in subsequent nodes. E.g., company_id, name, email, etc. in the above screenshot.
...
[](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#methods-and-outcomes)
Here’s a brief description of various methods, and corresponding output variables and node outcomes associated with each of the methods.
### 
Method Name - Create a Ticket
[](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---create-a-ticket)
...
**CC_Emails**  
Specifies the cc email address  |  **cc_emails**
  * Contains the cc email address

reply_cc_emails **priority**
...
**id**  
Contains the unique identification number of the ticket type  
fr_escalated  
spam  
urgent  
...
fr_due_by  
description_text  
description  | onCreateTicketFailure  
onCreateTicketSuccess  |  
### 
Method Name - View a Ticket
[](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---view-a-ticket)
...
description_text  
description  
custom_fields_category  | onViewTicketFailure  
onViewTicketSuccess  |  
### 
Method Name - Update a Ticket
[](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---update-a-ticket)
...
updated_at  
due_by  
fr_due_by  | onUpdateTicketFailure  
onUpdateTicketSuccess  |  
### 
Method Name - Delete a Ticket
[](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---delete-a-ticket)
...
| Input Variables  | Output Variables  | Node Outcomes  |  
| --- | --- | --- |  
| Ticket ID  | None  | onDeleteTicketFailure  
onDeleteTicketSuccess  |  
### 
Method Name - Create a Contact
[](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---create-a-contact)
...
**address**  
Contains the address of the contact  | onCreateContactFailure  
onCreateContactSuccess  |  
### 
Method Name - View a Contact
[](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---view-a-contact)
...
updated_at  
custom_fields  
avatar  | onViewContactFailure  
onViewContactSuccess  |  
### 
Method Name - Update a Contact
[](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---update-a-contact)
...
other_companies  
created_at  
updated_at  | onUpdateContactFailure  
onUpdateContactSuccess  |  
### 
Method Name - Soft Delete a Contact
[](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---soft-delete-a-contact)
...
| Input Variables  | Output Variables  | Node Outcomes  |  
| --- | --- | --- |  
| Contact ID  | response  | onSoftDeleteContactFailure  
onSoftDeleteContactSuccess  |  
Updated 4 months ago
* * *
[Zendesk CRM](https://help.webexconnect.io/docs/zendesk-crm)[Zoho CRM](https://help.webexconnect.io/docs/prebuilt-integrations-zoho-crm)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk)
  *     * [Introduction](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#introduction)
    * [Version Supported](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#version-supported)
    * [Pre-requisites](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#pre-requisites)
    * [Node Configuration](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#node-configuration)
    * [Methods and Outcomes](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#methods-and-outcomes)
      * [Method Name - Create a Ticket](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---create-a-ticket)
      * [Method Name - View a Ticket](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---view-a-ticket)
      * [Method Name - Update a Ticket](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---update-a-ticket)
      * [Method Name - Delete a Ticket](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---delete-a-ticket)
      * [Method Name - Create a Contact](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---create-a-contact)
      * [Method Name - View a Contact](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---view-a-contact)
      * [Method Name - Update a Contact](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---update-a-contact)
      * [Method Name - Soft Delete a Contact](https://help.webexconnect.io/docs/prebuilt-integration-freshdesk#method-name---soft-delete-a-contact)
