[Jump to Content](https://help.webexconnect.io/docs/wxcc-engage-node-palette#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Webex CC Engage Integration Nodes, Data Streams, and Node Authorizations
Search
`CTRL-K`
All
Platform Documentation
...
Understand the various engage nodes, data streams and node authorizations in Cisco Webex Contact Center
[Suggest Edits](https://help.webexconnect.io/edit/wxcc-engage-node-palette)
...
## 
Node and Methods
[](https://help.webexconnect.io/docs/wxcc-engage-node-palette#node-and-methods)  
| Node Name  | Description  | Methods  | Recommended Node Version  |  
| --- | --- | --- | --- |  
| [Search Conversation](https://help.webexconnect.io/docs/search-conversation)  | Calls Webex Engage Conversation Search API to search for an existing conversation using the customer identifier  | Search Chat  | v1.0, v1.1, and v1.3  |  
| [Append Message](https://help.webexconnect.io/docs/append-conversation)  | Calls Webex Engage Append Conversation API to append a message to an existing conversation  | Append Message  | v1.0, v1.3, and v1.4  |  
| [Create Conversation](https://help.webexconnect.io/docs/create-conversation)  | Calls Webex Engage Create Conversation API to create a new conversation on Webex Engage with the channel and customer details  | Create Conversation  | v1.0, v1.2, and v1.3  |  
| [Update Conversation](https://help.webexconnect.io/docs/update-conversation)  | Calls Webex Engage Update Conversation API to update a new conversation on Webex Engage with the channel and customer details  | Update Conversation  | v1.0  |  
| [Add Participant](https://help.webexconnect.io/docs/add-participant)  | Calls Webex Engage API to add a participant to a conversation  | Add Participant  | v1.0  |  
| [Remove Participant](https://help.webexconnect.io/docs/remove-participant)  | Calls Webex Engage API to remove a participant from a conversation  | Remove Participant  | v1.0  |  
| [Close conversation](https://help.webexconnect.io/docs/close-conversation)  | Calls Webex Engage API to close the conversation  | Close conversation  | v1.0  |  
| [Re-open Conversation](https://help.webexconnect.io/docs/re-open-conversation)  | Calls Webex Engage Update Conversation API to Re-open and queue a conversation which is in closed state  | Re-open Conversation  | v1.0  |  
| [Business Hours](https://help.webexconnect.io/docs/business-hours)  | Calls Webex Engage's Business Hour API to validate point in time whether the business is in working hours, on a holiday or an override  | Business Hours  | v1.0  |  
## 
Node Authorization
[](https://help.webexconnect.io/docs/wxcc-engage-node-palette#node-authorization)
...
[](https://help.webexconnect.io/docs/wxcc-engage-node-palette#node-authorization-for--engage-nodes)
...
## 
Node Outcomes
[](https://help.webexconnect.io/docs/wxcc-engage-node-palette#node-outcomes)
...
[](https://help.webexconnect.io/docs/wxcc-engage-node-palette#webex-engage-streaming)
...
### 
Prerequisites
[](https://help.webexconnect.io/docs/wxcc-engage-node-palette#prerequisites)
...
[](https://help.webexconnect.io/docs/wxcc-engage-node-palette#viewing-and-editing-webex-engage-streaming-data-stream-on--tenant)
...
Screenshot of Integrations page.
  1. Under **Actions** , click **Manage**.  
In the **Manage Integration - Data Streams** page, under Data Streams, you should be able to view Webex Engage Streaming.
  2. The default configuration for Webex Engage Streaming allows to stream data for all channels incoming events.

![Screenshot of Default Webex Engage Streaming configuration.](https://files.readme.io/d13bbe8-Integrations1.png)
Default Webex Engage Streaming configuration
  1. Select one of the following for Assets: 
...
Screenshot of Apple Messages for Business - Manage App Page
  1. Select the required channels under Channels. By default all the channels are selected, however optionally channels can be disabled from platform UI. This will disable the streaming service for un-selected channels. We recommend to have at least the Apple Business Messaging option selected for Webex Engage streaming. 
  2. **Incoming events & Messages** is selected by default for **Events**. 
...
* * *
[Resolve Conversation](https://help.webexconnect.io/docs/wxcc-resolve-conversation)[Search Conversation - WXCC](https://help.webexconnect.io/docs/wxcc-engage-search-conversation)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/wxcc-engage-node-palette)
  *     * [Node and Methods](https://help.webexconnect.io/docs/wxcc-engage-node-palette#node-and-methods)
    * [Node Authorization](https://help.webexconnect.io/docs/wxcc-engage-node-palette#node-authorization)
    * [Node Authorization for Cisco Webex Contact Center Engage nodes](https://help.webexconnect.io/docs/wxcc-engage-node-palette#node-authorization-for--engage-nodes)
    * [Node Outcomes](https://help.webexconnect.io/docs/wxcc-engage-node-palette#node-outcomes)
    * [Webex Engage Streaming](https://help.webexconnect.io/docs/wxcc-engage-node-palette#webex-engage-streaming)
      * [Prerequisites](https://help.webexconnect.io/docs/wxcc-engage-node-palette#prerequisites)
      * [Viewing and Editing Webex Engage Streaming Data Stream on Webex Connect Tenant](https://help.webexconnect.io/docs/wxcc-engage-node-palette#viewing-and-editing-webex-engage-streaming-data-stream-on--tenant)
