[Jump to Content](https://help.webexconnect.io/docs/cce-get-task-details#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Get Task Details - CCE
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/cce-get-task-details)
...
## 
Authorization
[](https://help.webexconnect.io/docs/cce-get-task-details#authorization)
...
[](https://help.webexconnect.io/docs/cce-get-task-details#methods-and-outcomes)
...
_ Task ID - $(flid)  
Flow transaction id from the state node is converted into UUID in the evaluate node, and passed to create task node, for creating task with flid as task id. $(flid) is one of the custom variables that contains the processed task ID value which is evaluated in the Evaluate node.  |  _preferredOwner  
_ taskId  
 _customerId  
_ origin  
 _destination  
...
* * *
[Create Task - CCE](https://help.webexconnect.io/docs/cce-create-task)[End Task - CCE](https://help.webexconnect.io/docs/cce-end-task)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/cce-get-task-details)
  *     * [Authorization](https://help.webexconnect.io/docs/cce-get-task-details#authorization)
    * [Methods and Outcomes](https://help.webexconnect.io/docs/cce-get-task-details#methods-and-outcomes)
