[Jump to Content](https://help.webexconnect.io/docs/manage-consent-groups#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Manage Consent Groups
Search
`CTRL-K`
All
Platform Documentation
...
View, modify, and delete Groups, and manage customer data.
[Suggest Edits](https://help.webexconnect.io/edit/manage-consent-groups)
...
[](https://help.webexconnect.io/docs/manage-consent-groups#view-and-modify-a-group)
...
[](https://help.webexconnect.io/docs/manage-consent-groups#upload-consumer-records)
...
> **For email**
>   * 2023-05-01T00:00:00Z,abc@gmail.com,email,FALSE,2050-08-01T15:00:00Z,keyword,ConsentGroup,eventscheduler
> 
...
### 
Method 1
[](https://help.webexconnect.io/docs/manage-consent-groups#method-1)
...
> 
  ...
  1. In the **Reason** field, type the reason for uploading the file.
  2. Select the **Update existing policy for documents** checkbox to update any existing records that are already in the group. 
...
> If you do not select this option, any new information pertaining to existing consumer records will be ignored. For example, if an older file marked the consent for a certain consumer record as “true”, and that of the latest file marked the same consumer record as “false”, and the new file is uploaded, the whole record will be ignored. It is recommended to select this option if a newer version of the same file contains updated consumer information.
  1. Click **Upload**. The newly imported file appears in the Management Consent Group page for the specific group under the **Upload History** tab.

![Screenshot of upload history](https://files.readme.io/66b033710afb9c1e782d733af2396ef4d932f83e908db66c4eafa1958dc030a0-image-20240802-151730.png)
Manage Consent Group - Upload History Tab
> ## 📘
> Note
...
### 
Method 2
[](https://help.webexconnect.io/docs/manage-consent-groups#method-2)
...
![Screenshot of Upload Records tab on Manage Consent Group page](https://files.readme.io/9950bf3ceb96c499530ffccf37928be5f34743d90402ee407e786d532a14519e-c0771694-fd6a-47fa-8e3f-79f07756fb63_1.png)
Manage Consent Group - Upload Records Tab
...
## 
Upload Status
[](https://help.webexconnect.io/docs/manage-consent-groups#upload-status)
...
![Screenshot of sample of a Downloaded CSV file](https://files.readme.io/d293c621753adbc424a0ba15f07dea9939eb2c330cc2236af0c7cdd305665646-image-20250908-085329.png)
Sample of a Downloaded CSV file
> ## 🚧
...
[](https://help.webexconnect.io/docs/manage-consent-groups#reasons-for-upload-failure)
...
| Conflicting alternate address  | The uploaded record attempts to replace an existing alternate address or BSUID mapping, but `replaceAlternateAddress` is not set to `true`.  
Set `replaceAlternateAddress` to `true` to replace the existing BSUID mapping.  | Failure  |  
## 
Delete a Group
[](https://help.webexconnect.io/docs/manage-consent-groups#delete-a-group)
...
> ## 📘
> Note
> The 'Delete' option is available for users with full access to the platform. To enable the access permissions for Contact Policy, following are the [Steps](https://help.webexconnect.io/docs/manage-consent-groups#Enable%20Access%20Permission%20for%20Contact%20Policy).
  3. In the confirmation message, click **Delete**. The group is removed from the Consent Group List.

![Image showing a confirmation dialog asking the user to confirm the action by clicking the Delete button.](https://files.readme.io/2d6b07a-Delete_Consent_Group_Confirmation.jpg)
A confirmation message displayed with a prompt to click Delete
### 
Enable Access Permission for Contact Policy
[](https://help.webexconnect.io/docs/manage-consent-groups#enable-access-permission-for-contact-policy)
...
Contact Policy—Full Access


## 
Deleting a Consumer Consent
[](https://help.webexconnect.io/docs/manage-consent-groups#deleting-a-consumer-consent)
...
![A screen showing a list of consumer records.](https://files.readme.io/3aaa7c4d351b758815d0e57300c43511b4dd9f44b4ecb2087c2dc1994c604a9e-image-20250609-053832_1.png)
Image displaying a list of consumer records
  1. Click the **Delete** icon under **Actions**. A pop-up appears.

![Image showing a confirmation dialog asking the user to confirm the action by clicking the Delete button.](https://files.readme.io/7b039b6-Delete_User_Consent1.png)
A confirmation message displayed with a prompt to click Delete
  1. Click Delete. A message appears as ”Consent record is deleted successfully.”
...
* * *
[Consent Groups](https://help.webexconnect.io/docs/consent-groups)[Handling Carrier Deactivations](https://help.webexconnect.io/docs/handling-carrier-deactivations)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/manage-consent-groups)
  *     * [View and Modify a Group](https://help.webexconnect.io/docs/manage-consent-groups#view-and-modify-a-group)
    * [Upload Consumer Records](https://help.webexconnect.io/docs/manage-consent-groups#upload-consumer-records)
      * [Method 1](https://help.webexconnect.io/docs/manage-consent-groups#method-1)
      * [Method 2](https://help.webexconnect.io/docs/manage-consent-groups#method-2)
    * [Upload Status](https://help.webexconnect.io/docs/manage-consent-groups#upload-status)
    * [Reasons for upload failure](https://help.webexconnect.io/docs/manage-consent-groups#reasons-for-upload-failure)
    * [Delete a Group](https://help.webexconnect.io/docs/manage-consent-groups#delete-a-group)
      * [Enable Access Permission for Contact Policy](https://help.webexconnect.io/docs/manage-consent-groups#enable-access-permission-for-contact-policy)
    * [Deleting a Consumer Consent](https://help.webexconnect.io/docs/manage-consent-groups#deleting-a-consumer-consent)
