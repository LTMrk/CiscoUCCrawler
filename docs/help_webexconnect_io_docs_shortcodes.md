[Jump to Content](https://help.webexconnect.io/docs/shortcodes#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Short Code
Search
`CTRL-K`
All
Platform Documentation
...
# Short Code
Shortcode is a 5 to 7 character string (numeric or alphanumeric) that is used for sending or receiving high SMS volumes.
[Suggest Edits](https://help.webexconnect.io/edit/shortcodes)
Select **Assets** > **Numbers** menu on the Webex Connect platform and choose the **Short Code** option from the **Get Numbers** drop-down list box.
![Screenshot of Numbers Page.](https://files.readme.io/83a9815-2.jpg)
Numbers Page
Select the country for which you need the Short Code and provide the following details in the **Request Description** field:
  * Prefered series of shortcode (3xxxxx, 4xxxx, 5xxxx, 6xxxx)
  * SMS volume you estimate to send using the shortcode
  * Time period for which you need to hold the shortcode (6 months, 1 year, or permanent)
  * An email and a phone number for communication.


> ## 🚧
> Shortcode Allocation
> Webex Connect operations team will contact you within 24 hours after you place the request.
## 
DLT Registered Numbers
[](https://help.webexconnect.io/docs/shortcodes#dlt-registered-numbers)
...
* * *
[Phone Number](https://help.webexconnect.io/docs/phone-numbers)[Sender ID](https://help.webexconnect.io/docs/sender-id)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/shortcodes)
  *     * [DLT Registered Numbers](https://help.webexconnect.io/docs/shortcodes#dlt-registered-numbers)
