...
[+1-888-469-3239](tel:+1-888-469-3239)[Contact Sales →](https://www.webex.com/contact-sales.html)
  ...
  * ![Cisco AI Assistant for Webex](https://help.webex.com/images/cisco-ai-assistance.svg)
  * English
    * [ Dansk ](https://help.webex.com/da-dk/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Deutsch ](https://help.webex.com/de-de/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ English ](https://help.webex.com/en-us/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)![language tick](https://help.webex.com/images/checkbox-check.svg)
    * [ Español ](https://help.webex.com/es-co/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Français ](https://help.webex.com/fr-fr/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Italiano ](https://help.webex.com/it-it/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Nederlands ](https://help.webex.com/nl-nl/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Português ](https://help.webex.com/pt-br/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Pyccĸий ](https://help.webex.com/ru-ru/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Svenska ](https://help.webex.com/sv-se/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Tϋrkçe ](https://help.webex.com/tr-tr/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ 한국어 ](https://help.webex.com/ko-kr/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ 日本語 ](https://help.webex.com/ja-jp/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ 简体中文 ](https://help.webex.com/zh-cn/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ 繁體中文 ](https://help.webex.com/zh-tw/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Română ](https://help.webex.com/ro-ro/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Magyar ](https://help.webex.com/hu-hu/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Polski ](https://help.webex.com/pl-pl/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Čeština ](https://help.webex.com/cs-cz/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Български ](https://help.webex.com/bg-bg/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Norsk ](https://help.webex.com/no-no/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Hrvatski ](https://help.webex.com/hr-hr/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Srpski ](https://help.webex.com/sr-rs/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Українська ](https://help.webex.com/uk-ua/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ العربية ](https://help.webex.com/ar-ae/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ עברית ](https://help.webex.com/he-il/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Suomi ](https://help.webex.com/fi-fi/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Slovenščina ](https://help.webex.com/sl-si/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
    * [ Slovenský ](https://help.webex.com/sk-sk/article/WBX58194/I-Can-t-Enter-Names-into-the-Alternate-Host-Field-when-Scheduling-a-Meeting-using-Webex-Desktop-App)
  * Sign In
...
You must enter email addresses into the To: field in the Outlook appointment before you can select an Alternate host. 
## I can't enter names into the Alternate host field when scheduling a meeting using Webex Desktop App.
## I am unable to enter an alternate host when scheduling a meeting using in Outlook.
## The Alternate host button is grayed out when scheduling a meeting using Webex Desktop App.
  
**Solution:**
You must enter email addresses into the To: field in the Outlook appointment before you can select an Alternate host.
**To resolve the issue:**
  1. In the _Webex Settings_ window, click the **OK** button.
  2. In the Outlook appointment window, enter the alternate host's email address in the _To:_ field. 
  3. Click the **Change Settings** button.  
  
The 'Webex Settings' window appears.  

  4. Go to the **Resources** tab.
  5. In the _Alternate host:_ section, check the box beside the person you would like to make an alternate host.
