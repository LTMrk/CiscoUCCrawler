[Jump to Content](https://help.webexconnect.io/docs/entity-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Entity Node
Search
`CTRL-K`
All
Platform Documentation
...
# Entity Node
Understand what an Entity node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/entity-node)
> ## 📘
...
![Screenshot of Entity Node.](https://files.readme.io/195d409-entity.PNG)
Entity Node
## 
Node Configuration
[](https://help.webexconnect.io/docs/entity-node#node-configuration)
Use this tab to configure the Entity node. You can define the Entity in two steps: _Configuring Entity Settings_ and _Transition Actions_. 
![Screenshot of Entity Node Configuration](https://files.readme.io/1ffb40e-entity_configuration.PNG)
...
![Screenshot of Untrained Entity](https://files.readme.io/7fe0dba-untrained_entity.png)
Untrained Entity
...
## 
Input Variables
[](https://help.webexconnect.io/docs/entity-node#input-variables)
...
![Screenshot of Input and Custom Variables](https://files.readme.io/0fa6c2c-input_variable.png)
Input and Custom Variables
## 
Output Variables
[](https://help.webexconnect.io/docs/entity-node#output-variables)
Click this collapsible panel to view the output variables. 
You can see the data that this node generates as output variables. The data generated by the node is displayed as variables here. These [variables](https://help.webexconnect.io/docs/variable-management) are available for use in subsequent nodes. The standard output variables for this node are:
  * **Entity**
...
![Screenshot of Output Variables](https://files.readme.io/d6326a6-entity_outcomenode.PNG)
Output Variables
## 
Node Outcomes
[](https://help.webexconnect.io/docs/entity-node#node-outcomes)
...
| Timeout (orange)  |  _**onmaxcount** - the flow exits through this node when it reaches max count.  
_ **onpartialcomplete** - the flow exits through this node when it is partially complete.  |  
| Error (red)  | * **onError** - the flow exits through this node outcome when there is an error.  |  
## 
Transition Actions
[](https://help.webexconnect.io/docs/entity-node#transition-actions)
...
![Screenshot of Transition Actions](https://files.readme.io/48a8b2c-delay_transition_actions.png)
Transition Actions
## 
Testing the Data
[](https://help.webexconnect.io/docs/entity-node#testing-the-data)
...
![Screenshot of Test Entity](https://files.readme.io/cf18dd1-test_entity.PNG)
Test Entity
The system will run the input entity and return the result in the **Response** text box.
![Screenshot of Test Entity](https://files.readme.io/ee8bd61-Entity_Node.png)
Screenshot of Test Entity
> ## ❗️
> Note
> Copy and Paste functionality is not supported for this node
Updated over 1 year ago
* * *
[NLP Premium Node](https://help.webexconnect.io/docs/nlp-premium-node)[Intent Node](https://help.webexconnect.io/docs/intent-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/entity-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/entity-node#node-configuration)
    * [Input Variables](https://help.webexconnect.io/docs/entity-node#input-variables)
    * [Output Variables](https://help.webexconnect.io/docs/entity-node#output-variables)
    * [Node Outcomes](https://help.webexconnect.io/docs/entity-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/entity-node#transition-actions)
    * [Testing the Data](https://help.webexconnect.io/docs/entity-node#testing-the-data)
