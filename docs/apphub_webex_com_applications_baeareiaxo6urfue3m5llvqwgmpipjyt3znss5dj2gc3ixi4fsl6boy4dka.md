PayPal - Webex App Hub
[Skip to content](https://apphub.webex.com/applications/baeareiaxo6urfue3m5llvqwgmpipjyt3znss5dj2gc3ixi4fsl6boy4dka#main-content) [Skip to footer](https://apphub.webex.com/applications/baeareiaxo6urfue3m5llvqwgmpipjyt3znss5dj2gc3ixi4fsl6boy4dka#main-footer)
...
Back
* * *
![PayPal logo](https://developer-applications.webexcontent.com/agenticServers/icons/bba6c9c010e14a0ab12de32a1f83eabb.jpg)
#### PayPal
Federated through Agntcy Developed by Paypal; Imported from External Registry
Securely manage your PayPal transactions, check balances, and handle payments directly through your AI assistant for streamlined financial workflows.
[ Learn more ](https://developer.webex.com/mcp/docs/federated-through-external-registry-mcp-servers#paypal)
![PayPal logo](https://developer-applications.webexcontent.com/agenticServers/icons/bba6c9c010e14a0ab12de32a1f83eabb.jpg)
#### PayPal
Federated through Agntcy Developed by Paypal; Imported from External Registry
Agentic App by [Paypal](https://paypal.com)
* * *
Securely manage your PayPal transactions, check balances, and handle payments directly through your AI assistant for streamlined financial workflows.
[ Learn more ](https://developer.webex.com/mcp/docs/federated-through-external-registry-mcp-servers#paypal)
Agentic App by [Paypal](https://paypal.com)
The PayPal MCP Server enables your AI assistant to securely manage financial tasks and developer testing directly within your workflow. It allows you to check account balances, list transaction histories, and retrieve payment details using natural language, streamlining account reconciliation for business owners and developers. By leveraging the Model Context Protocol, it ensures financial data remains secure and structured. To get started, log in to the PayPal Developer Dashboard to create an application and obtain your Client ID and Secret, then connect the server to your AI client using the endpoint from the PayPal MCP Quickstart Guide. Requirements include a Webex license and a PayPal Developer or Business account. While developer tools and sandbox testing are free, standard transaction fees apply for live payments. For more information on fees, visit paypal.com/merchant-fees. v
##### Support
* * *
  * ![Developer Support](https://apphub.webex.com/images/developer-support.png)[Developer Support](https://www.paypal-support.com/)
  * ![Privacy Policy](https://apphub.webex.com/images/privacy.png)[Privacy Policy](https://www.paypal.com/us/legalhub/privacy-full)
...
[Contact Center](https://apphub.webex.com/contact-center)
[Accounting & Finance](https://apphub.webex.com/category/accounting-and-finance)
[Developer Tools](https://apphub.webex.com/category/developer-tools)
[Workflow & Automation](https://apphub.webex.com/category/workflow-and-automation)
The PayPal MCP Server enables your AI assistant to securely manage financial tasks and developer testing directly within your workflow. It allows you to check account balances, list transaction histories, and retrieve payment details using natural language, streamlining account reconciliation for business owners and developers. By leveraging the Model Context Protocol, it ensures financial data remains secure and structured. To get started, log in to the PayPal Developer Dashboard to create an application and obtain your Client ID and Secret, then connect the server to your AI client using the endpoint from the PayPal MCP Quickstart Guide. Requirements include a Webex license and a PayPal Developer or Business account. While developer tools and sandbox testing are free, standard transaction fees apply for live payments. For more information on fees, visit paypal.com/merchant-fees. v
* * *
