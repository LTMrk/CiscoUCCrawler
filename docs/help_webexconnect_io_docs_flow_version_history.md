[Jump to Content](https://help.webexconnect.io/docs/flow-version-history#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Flow Version History
Search
`CTRL-K`
All
Platform Documentation
...
Maintains a history of every change made to a flow
[Suggest Edits](https://help.webexconnect.io/edit/flow-version-history)
...
![Screenshot of Flow Version History.](https://files.readme.io/eaf1740-Flow_Version_History_Flow_Version_History.png)
Flow Version History
...
[](https://help.webexconnect.io/docs/flow-version-history#switching-between-versions)
...
# 
Rollback
[](https://help.webexconnect.io/docs/flow-version-history#rollback)
...
* * *
[Calling a Flow from another Flow](https://help.webexconnect.io/docs/calling-a-flow-from-another-flow)[Flow Analytics](https://help.webexconnect.io/docs/flow-analytics)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/flow-version-history)
  *     * [Switching between Versions](https://help.webexconnect.io/docs/flow-version-history#switching-between-versions)
    * [Rollback](https://help.webexconnect.io/docs/flow-version-history#rollback)
