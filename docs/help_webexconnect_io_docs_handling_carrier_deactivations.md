[Jump to Content](https://help.webexconnect.io/docs/handling-carrier-deactivations#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Handling Carrier Deactivations
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/handling-carrier-deactivations)
...
## 
DEACT State
[](https://help.webexconnect.io/docs/handling-carrier-deactivations#deact-state)
...
## 
TRANSFER State
[](https://help.webexconnect.io/docs/handling-carrier-deactivations#transfer-state)
...
## 
PORTING State
[](https://help.webexconnect.io/docs/handling-carrier-deactivations#porting-state)
...
[](https://help.webexconnect.io/docs/handling-carrier-deactivations#carrier-lookup-service)
...
* * *
[Manage Consent Groups](https://help.webexconnect.io/docs/manage-consent-groups)[Contact Policy Reports](https://help.webexconnect.io/docs/contact-policy-reports)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/handling-carrier-deactivations)
  *     * [DEACT State](https://help.webexconnect.io/docs/handling-carrier-deactivations#deact-state)
    * [TRANSFER State](https://help.webexconnect.io/docs/handling-carrier-deactivations#transfer-state)
    * [PORTING State](https://help.webexconnect.io/docs/handling-carrier-deactivations#porting-state)
    * [Carrier Lookup Service](https://help.webexconnect.io/docs/handling-carrier-deactivations#carrier-lookup-service)
