[Jump to Content](https://help.webexconnect.io/docs/cancel-appointment-flow-template#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Cancel Appointment Flow Template
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/cancel-appointment-flow-template)
## 
Overview
[](https://help.webexconnect.io/docs/cancel-appointment-flow-template#overview)
...
## 
Pre-requisites
[](https://help.webexconnect.io/docs/cancel-appointment-flow-template#pre-requisites)
...
## 
User Roles
[](https://help.webexconnect.io/docs/cancel-appointment-flow-template#user-roles)
...
## 
Node Breakdown
[](https://help.webexconnect.io/docs/cancel-appointment-flow-template#node-breakdown)  
...
| EPIC Cancel Appointment  | Executes the subscription-based API call to EPIC to cancel the specified appointment.  | Cancellation confirmation status.  
...
[](https://help.webexconnect.io/docs/cancel-appointment-flow-template#input--output-variables)
### 
Input Variables (Configure AI Agent Event)
[](https://help.webexconnect.io/docs/cancel-appointment-flow-template#input-variables-configure-ai-agent-event)
...
### 
Output Variables
[](https://help.webexconnect.io/docs/cancel-appointment-flow-template#output-variables)
...
# 
Error Handling
[](https://help.webexconnect.io/docs/cancel-appointment-flow-template#error-handling)
...
## 
Script Analysis
[](https://help.webexconnect.io/docs/cancel-appointment-flow-template#script-analysis)
### 
Evaluate Script
[](https://help.webexconnect.io/docs/cancel-appointment-flow-template#evaluate-script)
...
Updated 20 days ago
* * *
[Get Future Appointments Flow Template](https://help.webexconnect.io/docs/get-future-appointments-flow-template)[Webex Chat/ Webex Engage](https://help.webexconnect.io/docs/webex-chat-webex-engage)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/cancel-appointment-flow-template)
  *     *       * [Overview](https://help.webexconnect.io/docs/cancel-appointment-flow-template#overview)
      * [Pre-requisites](https://help.webexconnect.io/docs/cancel-appointment-flow-template#pre-requisites)
      * [User Roles](https://help.webexconnect.io/docs/cancel-appointment-flow-template#user-roles)
      * [Node Breakdown](https://help.webexconnect.io/docs/cancel-appointment-flow-template#node-breakdown)
      * [Input & Output Variables](https://help.webexconnect.io/docs/cancel-appointment-flow-template#input--output-variables)
    * [Error Handling](https://help.webexconnect.io/docs/cancel-appointment-flow-template#error-handling)
      * [Script Analysis](https://help.webexconnect.io/docs/cancel-appointment-flow-template#script-analysis)
