[Jump to Content](https://help.webexconnect.io/docs/export-logs-overview#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Export Logs
Search
`CTRL-K`
All
Platform Documentation
...
# Export Logs
Export transaction logs for Inbound and Outbound Messages sent or received using the platform
[Suggest Edits](https://help.webexconnect.io/edit/export-logs-overview)
...
* * *
[WhatsApp Template Rejection Reasons](https://help.webexconnect.io/docs/whatsapp-templates)[New Export Logs](https://help.webexconnect.io/docs/new-export-logs)
