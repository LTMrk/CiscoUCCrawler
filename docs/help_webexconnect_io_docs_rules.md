[Jump to Content](https://help.webexconnect.io/docs/rules#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Rules
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/rules)
...
## 
Triggers
[](https://help.webexconnect.io/docs/rules#triggers)
...
![1012](https://files.readme.io/8039f17-2.jpeg)
Rule Triggers
## 
Channels and Trigger Events
[](https://help.webexconnect.io/docs/rules#channels-and-trigger-events)
Each communication channel has a set of pre-defined events that can trigger a flow.  
| Channel  | Possible Events  |  
| --- | --- |  
| SMS  |  _`Mobile Originated - MO`  
_ `On Link Click`  |  
| MMS  | * `Mobile Originated - MO`  |  
| RCS  |  _`Incoming Attachment`  
_ `Incoming Message`  
_`Location Response`  
_ `Postback`  
-`Subscribe`  
-`Unsubscribe`  |  
| Voice  |  _`Inbound Call`  
_ `Missed Call`  |  
| Instagram  |  _`Incoming Message`  
_ `Postback`  
* `Message Deleted`  |  
| Email  |  _`Incoming Message`  
_ `Subscribe`  
* `Unsubscribe`  |  
| Mobile & Web App  
(i.e., Push, Live Chat and In-App Messaging)  |  _`Custom Event`  
_ `Incoming Message`  
_`Location Change`  
_`Typing Indicator`  |  
| Apple Messages for Business  |  _`Conversation Closed`  
_ `Incoming Message`  
_`Invitation Response`  
_ `Interactive Message`  
_ `Typing Indicator`  |  
| Messenger  |  _`Incoming Message`  
_ `On Link Click`  
* `Postback`  |  
...
[](https://help.webexconnect.io/docs/rules#apple-messages-for-business-invitation-response)
...
[](https://help.webexconnect.io/docs/rules#custom-trigger-events)  
...
## 
Actions
[](https://help.webexconnect.io/docs/rules#actions)
...
## 
Notify URL
[](https://help.webexconnect.io/docs/rules#notify-url)
...
[](https://help.webexconnect.io/docs/rules#adding-actions-to-rules)
To add an action in rule, follow the procedure below:
  1. Select the required channel from **Select Actions**.

![Screenshot of Adding Actions to Rules](https://files.readme.io/d739314-2.jpg)
Add New Rule
  1. Select the **Event** and required number from **MMS** drop-down.

![Screenshot of Select Event and Conditions while adding a new rule](https://files.readme.io/b15ac2b-3.jpg)
Select Event and Conditions
  1. Click **Next**. 
  2. Enter the required details in the **Enter Action Details** page.

![Screenshot of Enter Action Details to an event.](https://files.readme.io/b15ac2b-3.jpg)
Enter Action Details
  1. The **Confirm** page is displayed. Enter the required details.

![Screenshot of Add Details to schedule rule. ](https://files.readme.io/d87050e-MMS_-_Confirm.jpg)
Add Details
...
[](https://help.webexconnect.io/docs/rules#notify-url-authorisation)
To enable Notify URL Signature and Authorization, add an action in the rule and follow the procedure below:
  1. Select the required channel from **Select Actions**.
![Secreenshot of Select Action on Rules page.](https://files.readme.io/1c2fac2f401be709b6b02a80cb4f94445435fb5bf5ebb2f1be91cb50a60ad410-d739314-2.jpg)
Select Actions
...
Select Event And Add Conditions
  3. Click **Next**.
  4. Enter the required details in the **Enter Action Details** page.
![Screenshot for Enter Action Details - Notify URL](https://files.readme.io/db0d7decb7ac9fa0f426d783a8587b1bea0d68f04df98aa48a4f05c799260b09-image-20250904-101808.png)
Enter Action Details - Notify URL
  5. Select the **Enable Notify URL Authorization** checkbox and provide the associated details.
![Screenshot of Notify URL Authentication on Rule page.](https://files.readme.io/d81ef8d44fec4e84524bfe8b94b61ca358bbb69dc27c1460373dcc77eb10f173-image-20250904-102029.png)
Enter Notify URL Authentication
  6. The **Confirm** page is displayed. Enter the required details.
![Add a New Rule](https://files.readme.io/d53c1e9824fa5a21184fd61f9a549fad2a99da1925b766c5e929ddf0a81b51d8-image-20250904-102235.png)
Add New Rule
...
Updated 14 days ago
* * *
[Summarize Text Beta Node](https://help.webexconnect.io/docs/summarize-text-beta-node)[Reports](https://help.webexconnect.io/docs/service-reports)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/rules)
  *     * [Triggers](https://help.webexconnect.io/docs/rules#triggers)
    * [Channels and Trigger Events](https://help.webexconnect.io/docs/rules#channels-and-trigger-events)
    * [Apple Messages for Business Invitation Response](https://help.webexconnect.io/docs/rules#apple-messages-for-business-invitation-response)
    * [Integrations and Trigger Events](https://help.webexconnect.io/docs/rules#integrations-and-trigger-events)
    * [Custom Trigger Events](https://help.webexconnect.io/docs/rules#custom-trigger-events)
    * [Actions](https://help.webexconnect.io/docs/rules#actions)
    * [Notify URL](https://help.webexconnect.io/docs/rules#notify-url)
      * [Adding Actions to Rules](https://help.webexconnect.io/docs/rules#adding-actions-to-rules)
      * [Notify URL Authorisation](https://help.webexconnect.io/docs/rules#notify-url-authorisation)
