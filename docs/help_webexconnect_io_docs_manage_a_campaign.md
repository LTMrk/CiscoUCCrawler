[Jump to Content](https://help.webexconnect.io/docs/manage-a-campaign#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Managing a Campaign
Search
`CTRL-K`
All
Platform Documentation
...
# Managing a Campaign
Understand how to manage a Campaign in Webex Connect
[Suggest Edits](https://help.webexconnect.io/edit/manage-a-campaign)
> ## 📘
...
To manage a campaign on the Webex Connect platform:
  1. In the Brands & Campaigns (10DLC) page, expand the drop-down menu button for a brand record.

![Screenshot Displaying Manage Button Under Action](https://files.readme.io/987f8d0-4.jpg)
Screenshot Displaying Manage Button Under Action.
  1. In the **Action** column, click the drop-down button for a campaign record.
  2. Click **Manage**.
...
> The campaigns added by the Webex Connect Platform Admins are not allowed to be managed from the platform. Also, use case ‘information country’ and ‘vertical information’ will not be displayed on the listing page.
  1. In the New Campaign page, you can:
*Edit required fields or options for **Campaign and Content Attributes** section.
*Click **Edit** to modify the message or messages.

![Screenshot of Campaign and Content Attributes.](https://files.readme.io/7464dbc-BnC_Manage.jpg)
...
* * *
[Types of Campaigns and Terms](https://help.webexconnect.io/docs/types-of-campaigns-and-terms)[Campaign and Content Attributes](https://help.webexconnect.io/docs/campaign-and-content-attributes)
