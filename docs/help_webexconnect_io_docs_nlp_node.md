[Jump to Content](https://help.webexconnect.io/docs/nlp-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)NLP Node
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/nlp-node)
...
![Screenshot of NLP Node](https://files.readme.io/098c2cb-NLP_node_icon.png)
NLP Node
...
## 
Node Configuration
[](https://help.webexconnect.io/docs/nlp-node#node-configuration)
...
## 
Input Variables
[](https://help.webexconnect.io/docs/nlp-node#input-variables)
...
[](https://help.webexconnect.io/docs/nlp-node#methods-and-output-variables)
...
[](https://help.webexconnect.io/docs/nlp-node#global-input-variables)
...
[](https://help.webexconnect.io/docs/nlp-node#global-output-variables)
...
[](https://help.webexconnect.io/docs/nlp-node#global-node-outcomes)
...
## 
Node Outcomes
[](https://help.webexconnect.io/docs/nlp-node#node-outcomes)
...
**Note** : You can see this node edge only when you complete the node configuration.  | * **onSuccess** - the flow exits through this node when the input text is processed successfully  |  
| Timeout (yellow/amber)  | * **onTimeout** - the flow exits through this node outcome when the input is timed out  |  
| Error (red)  |  _**onFailure** - the flow exits through this node outcome when the input text is not processed successfully  
...
## 
Available methods
[](https://help.webexconnect.io/docs/nlp-node#available-methods)
The following methods are available in NLP node
### 
Spell Check
[](https://help.webexconnect.io/docs/nlp-node#spell-check)
...
### 
Language Detection
[](https://help.webexconnect.io/docs/nlp-node#language-detection)
...
| --- | --- | --- |  
| Language Detection  | Detects language for the input text  |  _DetectedLanguage – Contains the language detected for input text  
_ DetectionConfidence – contains the confidence score for the language detection operation  |  
### 
Lemmatization
[](https://help.webexconnect.io/docs/nlp-node#lemmatization)
...
[](https://help.webexconnect.io/docs/nlp-node#part-of-speech-tagging)
...
### 
Number Recognition
[](https://help.webexconnect.io/docs/nlp-node#number-recognition)
...
[](https://help.webexconnect.io/docs/nlp-node#parse-tree-generation)
...
### 
Question Detection
[](https://help.webexconnect.io/docs/nlp-node#question-detection)
...
| Method  | Description  | Output Variables  |  
| --- | --- | --- |  
| Question Detection  | Determines whether the input phrase is a question or not.  |  _QuestionType – Contains the type of question detected. For example, ‘yes/no’ for input ‘is it time to submit readings yet?’, ‘how’ for ‘how can I submit my readings?’  
...
[](https://help.webexconnect.io/docs/nlp-node#sentence-tokenization)
...
### 
Sentiment Analysis
[](https://help.webexconnect.io/docs/nlp-node#sentiment-analysis)
...
### 
Units Recognition
[](https://help.webexconnect.io/docs/nlp-node#units-recognition)
...
### 
Word Tokenization
[](https://help.webexconnect.io/docs/nlp-node#word-tokenization)
...
[](https://help.webexconnect.io/docs/nlp-node#time-and-date-recognition)
...
| Method  | Description  | Output Variables  |  
| --- | --- | --- |  
| Time and Date Recognition  | Detects if the provided input is either a date or time.  |  _SingleDate – contains date in input text if it contains only one date and time combination. Null if input contains no date or multiple dates  
_ SingleTime - contains time in input text if it contains only one date and time combination. Null if input contains no time or multiple times  
 _DateTimePayload – contains date and time detected provided in a dictionary format. This can be used in conjunction with a data parser node for inputs that contain multiples dates or times.  
_ Timezone – contains the time zone considered when returning the date and time  |  
### 
Profanity Filter
[](https://help.webexconnect.io/docs/nlp-node#profanity-filter)
...
* * *
[Task Bot Node](https://help.webexconnect.io/docs/task-bot-node)[Data Transform Node](https://help.webexconnect.io/docs/data-transform-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/nlp-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/nlp-node#node-configuration)
    * [Input Variables](https://help.webexconnect.io/docs/nlp-node#input-variables)
    * [Methods and Output variables](https://help.webexconnect.io/docs/nlp-node#methods-and-output-variables)
      * [Global input variables](https://help.webexconnect.io/docs/nlp-node#global-input-variables)
      * [Global output variables](https://help.webexconnect.io/docs/nlp-node#global-output-variables)
      * [Global Node Outcomes](https://help.webexconnect.io/docs/nlp-node#global-node-outcomes)
    * [Node Outcomes](https://help.webexconnect.io/docs/nlp-node#node-outcomes)
    * [Available methods](https://help.webexconnect.io/docs/nlp-node#available-methods)
      * [Spell Check](https://help.webexconnect.io/docs/nlp-node#spell-check)
      * [Language Detection](https://help.webexconnect.io/docs/nlp-node#language-detection)
      * [Lemmatization](https://help.webexconnect.io/docs/nlp-node#lemmatization)
      * [Part of Speech Tagging](https://help.webexconnect.io/docs/nlp-node#part-of-speech-tagging)
      * [Number Recognition](https://help.webexconnect.io/docs/nlp-node#number-recognition)
      * [Parse Tree Generation](https://help.webexconnect.io/docs/nlp-node#parse-tree-generation)
      * [Question Detection](https://help.webexconnect.io/docs/nlp-node#question-detection)
      * [Sentence Tokenization](https://help.webexconnect.io/docs/nlp-node#sentence-tokenization)
      * [Sentiment Analysis](https://help.webexconnect.io/docs/nlp-node#sentiment-analysis)
      * [Units Recognition](https://help.webexconnect.io/docs/nlp-node#units-recognition)
      * [Word Tokenization](https://help.webexconnect.io/docs/nlp-node#word-tokenization)
      * [Time and Date Recognition](https://help.webexconnect.io/docs/nlp-node#time-and-date-recognition)
      * [Profanity Filter](https://help.webexconnect.io/docs/nlp-node#profanity-filter)
