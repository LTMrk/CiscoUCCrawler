  * [Skip to main content](https://www.cisco.com/site/us/en/products/computing/servers-unified-computing-systems/ucs-c-series-rack-servers/index.html#fw-c-content)
  * [Skip to search](https://www.cisco.com/site/us/en/products/computing/servers-unified-computing-systems/ucs-c-series-rack-servers/index.html#fw-c-header__button--search)
  * [Skip to footer](https://www.cisco.com/site/us/en/products/computing/servers-unified-computing-systems/ucs-c-series-rack-servers/index.html#fw-c-footer)
...
Clear
[Downloads](https://www.cisco.com/site/us/en/products/computing/servers-unified-computing-systems/ucs-c-series-rack-servers/index.html#tabs-7edb32179e-item-d43da2dc1e-tab) [Product Support](https://www.cisco.com/site/us/en/products/computing/servers-unified-computing-systems/ucs-c-series-rack-servers/index.html#tabs-7edb32179e-item-d43da2dc1e-tab) [Technology Support](https://www.cisco.com/site/us/en/products/computing/servers-unified-computing-systems/ucs-c-series-rack-servers/index.html#tabs-7edb32179e-item-d43da2dc1e-tab) | End of Sale End of Support
...
Partners
EN US
[ Log in](https://www.cisco.com/content/cdc/login.html?referer=/site/us/en/products/computing/servers-unified-computing-systems/ucs-c-series-rack-servers/index.html)
[ Trials and demos](https://www.cisco.com/site/us/en/products/trials-demos.html?linkclickid=hdr-mainnav-trialsdemos)
MENU
CLOSE
[ How to buy](https://www.cisco.com/site/us/en/buy/index.html?linkclickid=hdr-utilnav-howtobuy)
...
Close
  ...
  2. [ Computing ](https://www.cisco.com/site/us/en/products/computing/index.html)
  3. [ Servers ](https://www.cisco.com/site/us/en/products/computing/servers-unified-computing-systems/index.html)


##  Navigating the AI Tidal Wave 
See how the Cisco AI-ready data center unifies infrastructure, security, and operations for the AI era.
[Watch on demand](https://www.cisco.com/site/us/en/about/why-cisco/ai-ready-data-centers/index.html#tidal-wave)
![Stacked Cisco UCS C–Series Rack Servers with laptop displaying  Cisco Intersight](https://www.cisco.com/content/dam/cisco-cdc/site/images/heroes/products/computing/ucs-c-series-product-stack-3200x1312.jpg)
# Cisco UCS C-Series Rack Servers
##  Unite and simplify with one powerful package 
...
[Register for demo](https://www.cisco.com/c/en/us/solutions/cloud-computing/promotions-free-trials/request-intersight-demo.html)
Overview [Resources](https://www.cisco.com/site/us/en/products/computing/servers-unified-computing-systems/ucs-c-series-rack-servers/resources.html)
[Register for demo](https://www.cisco.com/c/en/us/solutions/cloud-computing/promotions-free-trials/request-intersight-demo.html)
Hello, how can I help?
## Cisco UCS C-Series models
[ Compare models](https://apps.cisco.com/ccw/cpc/guest/catalog/content/ucsSeriesDetails/series_cseries)
Cisco UCS C220 M8 Rack Server
### Intel Xeon 6 processors
[ Read data sheet](https://www.cisco.com/c/en/us/products/collateral/servers-unified-computing/ucs-c-series-rack-servers/ucs-c220-m8-rack-server-ds.html)
1RU rack server with the latest Intel CPUs for your demanding applications.
  * 2 sockets, up to 64 cores per socket
  * Support for Cisco UCS VIC 15000 Series adapters as well as third-party options
  * Up to 10 SFF SAS/SATA/NVMe or 16 E3.S NVM drives
  * Up to 3 GPUs supported


Cisco UCS C240 M8 Rack Server
### Intel Xeon 6 processors
[ Read data sheet](https://www.cisco.com/c/en/us/products/collateral/servers-unified-computing/ucs-c-series-rack-servers/ucs-c240-m8-rack-server-ds.html)
2RU rack server, flexible storage options, and the latest Intel CPUs for your data-intensive applications.
  * 2 sockets, up to 86 cores per socket
  * Support for Cisco UCS VIC 15000 Series adapters as well as third-party options
  * SFF, LFF, and E3.S drive options
  * Up to 8 GPUs supported


Cisco UCS C225 M8 Rack Server
### 4th or 5th Gen AMD EPYC processors
[ Read data sheet](https://www.cisco.com/c/en/us/products/collateral/servers-unified-computing/ucs-c-series-rack-servers/ucs-c225-m8-rack-server-ds.html)
Reduce your TCO with this single-socket, high core count server.
  * 1 socket, up to 160 cores per server
  * Support for Cisco UCS VIC 15000 Series adapters as well as third-party options
...
### 4th or 5th Gen AMD EPYC processors
[ Read data sheet](https://www.cisco.com/c/en/us/products/collateral/servers-unified-computing/ucs-c-series-rack-servers/ucs-c245-m8-rack-server-ds.html)
Maximum CPU core density per socket for high performance in data-intensive applications.
  * 2 sockets, up to 160 cores per socket
  * Support for Cisco UCS VIC 15000 Series adapters as well as third-party options
  * Up to 28 SAS/SATA or NVMe disk drives
  * Up to 8 GPUs supported


Cisco UCS C845A M8 Rack Server
### 5th Gen AMD EPYC processors
[ Read data sheet](https://www.cisco.com/c/en/us/products/collateral/servers-unified-computing/ucs-c-series-rack-servers/ucs-c845a-m8-rack-server-ds.html)
Highly scalable, flexible, and customizable AI server for a wide range of workloads.
  * 2 sockets, up to 96 cores
  * NVIDIA MGX reference design
  * Up to 20 E1.S NVMe drives
  * 2-8 NVIDIA H100/H200 NVL or L40S GPUs


C880A M8 with NVIDIA HGX B300
### AI super computing platform
[ View Data Sheet](https://www.cisco.com/c/en/us/products/collateral/servers-unified-computing/ucs-c-series-rack-servers/ucs-c880a-m8-rack-server-ds.html)
Accelerate AI reasoning and training with the Blackwell Ultra-powered HGX B300 in the Cisco UCS C880A M8.
  * Built on dual-reticle Blackwell Ultra architecture 
  * Up to 11x inference and 4x training speed versus previous generation 
  * NVLink-5 / 1.8 TBps GPU interconnect for massive scale 
  * Up to 288 GB HBM3E per GPU for trillion-plus-parameter models 
  * Next-gen precisions (NVFP4, FP8/FP6) and transformer engine enhancements


Cisco UCS C885A M8 Rack Server
### 4th or 5th Gen AMD EPYC processors
[ Read data sheet](https://www.cisco.com/c/en/us/products/collateral/servers-unified-computing/ucs-c-series-rack-servers/ucs-c885a-m8-ds.html)
Train your GenAI models on-premises with this GPU-dense server.
  * 2 sockets, 64 cores per socket
  * NVIDIA HGX architecture
  * 16 1.92 TB NVMe drives
  * 8 NVIDIA H100/H200 or 8 AMD MI300X GPUs


Cisco UCS C220 M7 Rack Server
### 4th or 5th Gen Intel Xeon Scalable processors
[ Read data sheet](https://www.cisco.com/c/en/us/products/collateral/servers-unified-computing/ucs-c-series-rack-servers/ucs-c220-m7-rack-server-ds.html)
Performance and efficiency to help achieve your sustainability goals.
  * ​​2 sockets, up to 60 cores per socket
  * ​​Support for Cisco UCS VIC 15000 Series adapters as well as third-party options
  * Up to 10 SAS/SATA or NVMe disk drives
  * Up to 3 GPUs supported
...
### 4th or 5th Gen Intel Xeon Scalable processors
[ Read data sheet](https://www.cisco.com/c/en/us/products/collateral/servers-unified-computing/ucs-c-series-rack-servers/ucs-c240-m7-rack-server-ds.html)
Cuts server operating costs combined with simplified infrastructure management.
  * 2 sockets, up to 64 cores per socket
  * ​​Support for Cisco UCS VIC 15000 Series adapters as well as third-party options;
  * ​Up to 28 SAS/SATA or NVMe disk drives
  * Up to 5 GPUs supported


Cisco UCS C220 M6 Rack Server
### 3rd Gen Intel Xeon Scalable CPUs
[ Read data sheet](https://www.cisco.com/c/en/us/products/servers-unified-computing/ucs-c-series-rack-servers/ucs-c220-m6-rack-server-ds.html)
Industry-leading performance and efficiency for a wide range of workloads.
  * 2 sockets, up to 40 cores per socket
  * Up to 12 TB memory support with optional Intel Optane PMem
  * ​​Up to 10 SAS/SATA or NVMe drives
  * Up to 3 PCIe Gen 4.0 expansion slots


Cisco UCS C225 M6 SFF Rack Server
### 3rd or 2nd Gen AMD EPYC processors
[ Read data sheet](https://www.cisco.com/c/en/us/products/collateral/servers-unified-computing/ucs-c-series-rack-servers/ucs-c225-m6-sff-rack-server-ds.html)
Extended capabilities of the Cisco UCS portfolio in a single rack unit.
  * 2 sockets, up to 64 cores per socket
  * ​Single-socket optimized
  * ​​Up to 10 NVMe drives
  * Up to 4 PCIe Generation 4 slots


Cisco UCS C240 M6 Rack Server
### 3rd Gen Intel Xeon Scalable CPUs
[ Read data sheet](https://www.cisco.com/c/en/us/products/collateral/servers-unified-computing/ucs-c-series-rack-servers/ucs-c240-m6-rack-server-ds.html)
Increased agility, lower total cost of ownership, and industry-leading performance for all your workloads.
  * 2 sockets, up to 40 cores per socket
  * ​​Up to 12 TB memory support with optional Intel Optane PMem
  * ​​Up to 28 SAS/SATA or NVMe drives
  * Up to 8 PCIe Gen 4.0 expansion slots


Cisco UCS C245 M6 SFF Rack Server
### 3rd or 2nd Gen AMD EPYC processors
[ Read data sheet](https://www.cisco.com/c/en/us/products/collateral/servers-unified-computing/ucs-c-series-rack-servers/ucs-c245-m6-sff-rack-server-ds.html)
Computing, networking, management, virtualization, and storage access, all unified under one system.  

  * 2 sockets, up to 64 cores per socket
  * ​​Up to 8 TB of memory
  * Up to 28 small form-factor (SFF) drives​
  * Up to 8 PCIe Generation 4 slots


Previous
Next
[ Compare all models](https://www.cisco.com/c/en/us/solutions/data-center/data-center-computing/model-comparison.html)
![Worker managing IT infrastructure on his laptop in a hybrid environment](https://www.cisco.com/content/dam/cisco-cdc/site/images/photography/lifestyle-photography/ucs-c-series-demo-1292x727.jpg)
##  An easier way to manage your IT infrastructure 
Simplify and automate operations across your entire infrastructure from one place with Cisco Intersight. Then, no matter where you are, you can focus on where you're needed most.
[Request a demo](https://engage2demand.cisco.com/lp_Cisco_Intersight_Demo_17557)
## Cisco AI servers portfolio
![C880A M8 with NVIDIA HGX B300 product image](https://www.cisco.com/content/dam/cisco-cdc/site/images/heroes/products/computing/servers-unified-computing-systems/og-dense-gpu-servers-1200x630.jpg)
...
![Cisco RTX PRO Server image](https://www.cisco.com/content/dam/cisco-cdc/site/images/photography/products/computing/servers-unified-computing-systems/pcie-nv-link-cross-link.jpg)
...
Cisco+ Hybrid Cloud
###  Choose (and only pay for) the features you need 
Optimize workloads across your hybrid cloud with the flexibility you need to keep everything running smoothly on-premises.
[Get details](https://www.cisco.com/c/en/us/products/plus-as-a-service/hybrid-cloud.html)
Cisco Customer Experience (CX) services 
###  Get help from our experts 
Keeping track of new tech, evolving trends, and best practices is a full-time job. Let our CX team guide you through it all.
[Get details](https://www.cisco.com/c/en/us/solutions/data-center-virtualization/service-listing.html)
...
###  How do Cisco UCS C-Series Rack Servers integrate with Cisco UCS networks?
...
###  How do I deploy a Cisco C-Series Rack Server?
...
###  What are the benefits of a Cisco UCS-C Series Rack Server?
...
###  Where can I find support resources for Cisco UCS C-Series Rack Servers?
For more detailed support information, please visit [this Cisco UCS C Series Rack Server support page.](https://www.cisco.com/c/en/us/support/servers-unified-computing/ucs-c-series-rack-servers/series.html)
...
[Explore a UCS Solution Overview](https://www.cisco.com/c/en/us/products/collateral/servers-unified-computing/solution-overview-c22-744677.html)
##  Automation for a hybrid world 
Cisco Intersight lets you manage lifecycle operations from anywhere with the convenience and security of the cloud.
[Register for demo](https://www.cisco.com/site/us/en/products/computing/offers/demos/request-intersight-demo.html)
###  Quick Links
