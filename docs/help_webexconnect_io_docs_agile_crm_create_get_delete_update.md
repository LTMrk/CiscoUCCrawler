[Jump to Content](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Agile CRM
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/agile-crm-create-get-delete-update)
## 
Introduction
[](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#introduction)
...
## 
Version Supported
[](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#version-supported)
Please note that the latest version of the Agile CRM integration node that you should use is v1.7.
## 
Pre-requisites
[](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#pre-requisites)
...
## 
Node Configuration
[](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#node-configuration)
...
Screenshot of Agile CRM Configuration Page
  1. You can see the data that this node generates under the Output Variables section. These [variables](https://help.webexconnect.io/docs/variable-management) are available for use in subsequent nodes. (Ref: right panel in the below image).
...
[](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#methods-and-outcomes)
Here’s a brief description of various methods, and corresponding output variables and node outcomes associated with each of the methods.
### 
Method Name - Create a Ticket
[](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---create-a-ticket)
![Screenshot of Create a ticket method configuration page.](https://files.readme.io/76c3a90-image.png)
Screenshot of Create a ticket method configuration page.  
| Input Variables  | Output Variables  | Node Outcomes  | Version  |  
| --- | --- | --- | --- |  
|  **Requester Name**
  * Specifies the name of the requester

**Requester Email  
** * Specifies the email address of the requester **Subject**
...
**assigned_to_group** **requester_name**
...
last_customer_replied_time first_notes_text  
last_reply_text  
is_compressed **status**
...
html_text  
entity_type  
isPrivate **contact_id**
  * Contains the unique identification number of the contact

**contact_type** contact_properties_type  
contact_properties_name  
dueOn **createdOn**
  * Contains the date on which of ticket is created 

**lastUpdatedOn**  
Contains the date on which of ticket is last updated attachements_existsString  
is_favouriteString  
stringTicketID **closedOn**
  * Contains the date on which of ticket was closed

statusName  
priorityName  
soruceFrom **responsePayload**
...
[](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---get-all-ticket)
...
assignee_time **assignee_id**
  * Contains the unique identification number of the assignee

assignee_domain **assignee_email**
...
assignee_schedule_id **requester_name**
  * Contains the name of the requester
...
no_of_reopens  
html_text **contact_id**
  * Contains the unique identification number of the contact

contact_type **responsePayload**
  * Contains all the response JSON payload
...
[](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---delete-a-ticket)
...
[](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---creating-a-contact)
...
**Zip Code  
** * Specifies the zip code of the user **Country**
...
[](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---get-contact-by-id)
...
[](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---update-properties-of-a-contact-by-id)
...
[](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---delete-single-contact)
...
|  **Contact ID**
 ...
 | none  | onDeleteSingleContactSuccess  
onDeleteSingleContactFailure  |   |  
### 
Method Name - Get all Filter IDs
[](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---get-all-filter-ids)
...
* * *
[Introduction](https://help.webexconnect.io/docs/pre-built-integrations-introduction)[Salesforce CRM](https://help.webexconnect.io/docs/salesforce-crm-get-insert-update-delete-contacts)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update)
  *     * [Introduction](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#introduction)
    * [Version Supported](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#version-supported)
    * [Pre-requisites](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#pre-requisites)
    * [Node Configuration](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#node-configuration)
    * [Methods and Outcomes](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#methods-and-outcomes)
      * [Method Name - Create a Ticket](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---create-a-ticket)
      * [Method Name - Get all Ticket](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---get-all-ticket)
      * [Method Name - Delete a Ticket](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---delete-a-ticket)
      * [Method Name - Creating a Contact](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---creating-a-contact)
      * [Method Name - Get Contact by ID](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---get-contact-by-id)
      * [Method Name - Update Properties of a Contact by ID](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---update-properties-of-a-contact-by-id)
      * [Method Name - Delete Single Contact](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---delete-single-contact)
      * [Method Name - Get all Filter IDs](https://help.webexconnect.io/docs/agile-crm-create-get-delete-update#method-name---get-all-filter-ids)
