[Jump to Content](https://help.webexconnect.io/docs/instagram#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Instagram (Deprecated)
Search
`CTRL-K`
All
Platform Documentation
...
Engage with your customers on the most popular social media channel available today
[Suggest Edits](https://help.webexconnect.io/edit/instagram)
...
[](https://help.webexconnect.io/docs/instagram#prerequisites-for-configuring-the-instagram-app)
...
![Screenshot of Message Controls.](https://files.readme.io/012a350-Step_4.png)
Message Controls
  1. Create a Facebook Professional account or keep the login details ready for an existing Facebook Professional account.
  2. Create a Facebook Page for the newly created Facebook account or existing Facebook account.Facebook User should be able to perform Tasks with at least 'Moderate' level access on that Page.
  3. In your Instagram account, navigate to the newly created Facebook account or existing Facebook account by clicking **Settings** > **Instagram** > Webex Connect account. You will be routed to the **Instagram Login** page.
  4. Log in to your Instagram account and you will be navigated to the connected Facebook page.

![Screenshot of Connected Facebook page.](https://files.readme.io/07736f3-Step8_1.png)
Screenshot of Connected Facebook page.
![Screenshot of Connect to Instagram page.](https://files.readme.io/241a0ec-Creating_Insta5.png)
Screenshot of Connect to Instagram page.
  1. Look for text with Instagram account is connected (Or) if there is an alert message for review connection, then click on **Review Connect** and enter Instagram login details.

![Screenshot of Connected Instagram page.](https://files.readme.io/5f24abe-Creating_Insta4.png)
Screenshot of Connected Instagram page.
## 
Configuring your Instagram App on Webex Connect
[](https://help.webexconnect.io/docs/instagram#configuring-your-instagram-app-on-webex-connect)
...
Screenshot of Configuring New Instagram App.
  1. Click on Add Instagram account. You will be navigated to the Facebook Login page and it will display all the available Facebook pages. You must skip this step if you're already logged in.

![Screenshot of Facebook login popup.](https://files.readme.io/87178ef-Configuring_Insta2.png)
Facebook login popup.
  1. Select the Facebook page that was linked with the Instagram app in the procedure above.
  2. Provide the requested access permissions and click **Done**.
  3. At this stage, you'll be redirected to Webex Connect. If you selected multiple pages in the previous step, you will be asked to choose the page that you want to use for the asset you are configuring. Select the required page.

![Screenshot Displaying to Select the Required Page.](https://files.readme.io/ad2fbc4-Configuring_Insta3.png)
Screenshot Displaying to Select the Required Page.
...
Screenshot of Managing Instagram App.
  1. Click **Save**.
  2. Optionally, you can add Ice Breakers in the Ice Breakers section.


## 
Ice-Breakers
[](https://help.webexconnect.io/docs/instagram#ice-breakers)
...
Screenshot of Ice Breakers.
## 
Authorization Expiry
[](https://help.webexconnect.io/docs/instagram#authorization-expiry)
...
[](https://help.webexconnect.io/docs/instagram#editmanagedelete-the-instagram-app-asset)
  1. Go to **Assets** > **Apps**.
...
![Screenshot of Manage Instagram app asset](https://files.readme.io/739f518a09c382b29053949734217f6f2ecde263efa8a7f79d35e7cfe6fff72c-Instagram_-_Manage_app.png)
Manage Instagram App asset
You see the **Manage – Instagram** page, where you can manage the settings of the app.   

### 
Delete Instagram App Asset
[](https://help.webexconnect.io/docs/instagram#delete-instagram-app-asset)
  1. Go to Assets > Apps.
...
![Screenshot of Deleting Instagram app asset](https://files.readme.io/ccc9c1459c4e71a0b1708dba0edbbcea4b2b95fe5ca8b396d73def06943c1b78-Instagram_app_asset.png)
Deleting Instagram app asset
## 
Using the Channel
[](https://help.webexconnect.io/docs/instagram#using-the-channel)
### 
User Identity
[](https://help.webexconnect.io/docs/instagram#user-identity)
...
## 
API
[](https://help.webexconnect.io/docs/instagram#api)
...
## 
Webhooks
[](https://help.webexconnect.io/docs/instagram#webhooks)
...
## 
Message Types
[](https://help.webexconnect.io/docs/instagram#message-types)
...
## 
Rules
[](https://help.webexconnect.io/docs/instagram#rules)
...
|  _Incoming message  
_ Postback  
* Message Deleted  | * Notify URL  |  
## 
Flows
[](https://help.webexconnect.io/docs/instagram#flows)
...
## 
FAQs
[](https://help.webexconnect.io/docs/instagram#faqs)
...
* * *
[Setting up Brand Indicators for Message Identification (BIMI)](https://help.webexconnect.io/docs/setting-up-brand-indicators-for-message-identification-bimi)[Messenger](https://help.webexconnect.io/docs/facebook-messenger)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/instagram)
  *     * [Prerequisites for Configuring the Instagram App](https://help.webexconnect.io/docs/instagram#prerequisites-for-configuring-the-instagram-app)
    * [Configuring your Instagram App on Webex Connect](https://help.webexconnect.io/docs/instagram#configuring-your-instagram-app-on-webex-connect)
    * [Ice-Breakers](https://help.webexconnect.io/docs/instagram#ice-breakers)
    * [Authorization Expiry](https://help.webexconnect.io/docs/instagram#authorization-expiry)
    * [Edit/Manage/Delete the Instagram App Asset](https://help.webexconnect.io/docs/instagram#editmanagedelete-the-instagram-app-asset)
      * [Delete Instagram App Asset](https://help.webexconnect.io/docs/instagram#delete-instagram-app-asset)
    * [Using the Channel](https://help.webexconnect.io/docs/instagram#using-the-channel)
      * [User Identity](https://help.webexconnect.io/docs/instagram#user-identity)
    * [API](https://help.webexconnect.io/docs/instagram#api)
    * [Webhooks](https://help.webexconnect.io/docs/instagram#webhooks)
    * [Message Types](https://help.webexconnect.io/docs/instagram#message-types)
    * [Rules](https://help.webexconnect.io/docs/instagram#rules)
    * [Flows](https://help.webexconnect.io/docs/instagram#flows)
    * [FAQs](https://help.webexconnect.io/docs/instagram#faqs)
