[Jump to Content](https://help.webexconnect.io/docs/sender-id#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Sender ID
Search
`CTRL-K`
All
Platform Documentation
...
# Sender ID
A Sender ID is a name or number that an SMS appears to come from (_from address_) when you receive a message on your mobile phone.
[Suggest Edits](https://help.webexconnect.io/edit/sender-id)
A Sender ID is the _from address_ of an SMS or text message. A Sender ID can be a meaningful word, abbreviation, or an alphanumeric string that represents your brand. 
> ## 📘
> Alphanumeric Sender IDs
> Alphanumeric Sender IDs send only one-way messages and do not allow the customers to reply. We recommend keeping alphanumeric Sender IDs between 3 and 11 characters due to variable network specific limitations.
...
## 
Get a Sender ID
[](https://help.webexconnect.io/docs/sender-id#get-a-sender-id)
Select **Numbers** from the **Assets** menu and choose the **Sender ID** option from the **Get Numbers** drop-down list box.
![Screenshot of Getting a Sender ID.](https://files.readme.io/f8189be-22.jpg)
Screenshot of Getting a Sender ID.
...
[](https://help.webexconnect.io/docs/sender-id#dlt-registered-numbers)
...
* * *
[Short Code](https://help.webexconnect.io/docs/shortcodes)[Keyword](https://help.webexconnect.io/docs/keyword)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/sender-id)
  *     * [Get a Sender ID](https://help.webexconnect.io/docs/sender-id#get-a-sender-id)
    * [DLT Registered Numbers](https://help.webexconnect.io/docs/sender-id#dlt-registered-numbers)
