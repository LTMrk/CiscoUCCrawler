[Jump to Content](https://help.webexconnect.io/docs/data-parser-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Data Parser Node
Search
`CTRL-K`
All
Platform Documentation
...
# Data Parser Node
Understand what a Data Parser node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/data-parser-node)
...
![Screenshot of Data Parser Node.](https://files.readme.io/1260c44-Data_Parser.png)
## 
Interface Elements
[](https://help.webexconnect.io/docs/data-parser-node#interface-elements)
![Screenshot of Data Parser Node Configuration Page.](https://files.readme.io/83a9e9d-Data_Parser_Click_the_image_to_view_it_larger.png)
Data Parser Node Configuration Page.
Here is the description for interface elements:  
| S. No  | Element  | Description  |  
| --- | --- | --- |  
| 1  | Configuration tab  | Use this tab to convert JSON/XML data into a list of key-value pairs.  
...
| 3  | Test button  | Both the Configuration tab and the Transition Actions tab contain a Test button.  
Here is what you can do using the Test button:  
_Click the**Test** button on the **Configuration** tab to test the sample input.  
...
[](https://help.webexconnect.io/docs/data-parser-node#converting-json-or-xml-data)
...
[](https://help.webexconnect.io/docs/data-parser-node#configuring-the-input-data)
...
## 
**Parsing the Data**
[](https://help.webexconnect.io/docs/data-parser-node#parsing-the-data)
...
![Screenshot of Selecting Output Variables](https://files.readme.io/9420984-Data_Parser-Select_Output_Variables.jpg)
Selecting Output Variable
  1. Click the **IMPORT** button located below the **SELECT OUTPUT VARIABLES BOX**.  
The selected variable is populated in the Variable Path field in the Parsed data output area.
  2. In the **Parsed data output** area, specify a **name** for the **Output variable** in the **OUTPUT VARIABLE Name** field.

![Screenshot of Naming Output Varibales.](https://files.readme.io/b74935e-Data_Parser_Naming_output_variable.png)
...
## 
**Testing the Data**
[](https://help.webexconnect.io/docs/data-parser-node#testing-the-data)
...
![Screenshot of Test Window.](https://files.readme.io/16ddc29-Data_Parser-Test.jpg)
Test Window
## 
**Configuring the Transition Actions**
[](https://help.webexconnect.io/docs/data-parser-node#configuring-the-transition-actions)
...
The Transition Actions area appears.
  1. On the **Transition Actions** area:
...
![Screenshot of Delete Button](https://files.readme.io/e6afcd5-Delete_button.jpg)
Delete Button
...
* * *
[Delay Node](https://help.webexconnect.io/docs/delay-node)[Page Connector Node](https://help.webexconnect.io/docs/page-connector-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/data-parser-node)
  *     * [Interface Elements](https://help.webexconnect.io/docs/data-parser-node#interface-elements)
    * [Converting JSON or XML Data](https://help.webexconnect.io/docs/data-parser-node#converting-json-or-xml-data)
    * [**Configuring the Input Data**](https://help.webexconnect.io/docs/data-parser-node#configuring-the-input-data)
    * [**Parsing the Data**](https://help.webexconnect.io/docs/data-parser-node#parsing-the-data)
    * [**Testing the Data**](https://help.webexconnect.io/docs/data-parser-node#testing-the-data)
    * [**Configuring the Transition Actions**](https://help.webexconnect.io/docs/data-parser-node#configuring-the-transition-actions)
