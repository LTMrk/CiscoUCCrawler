[Jump to Content](https://help.webexconnect.io/docs/channel-specific-message-types#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Channel specific message types - WxEngage standalone
Search
`CTRL-K`
All
Platform Documentation
...
View the list of channels and their supported attachment types.
[Suggest Edits](https://help.webexconnect.io/edit/channel-specific-message-types)
...
* * *
[WhatsApp - WxEngage standalone](https://help.webexconnect.io/docs/whatsapp-1)[Message Schemas - WxEngage standalone](https://help.webexconnect.io/docs/message-schemas)
