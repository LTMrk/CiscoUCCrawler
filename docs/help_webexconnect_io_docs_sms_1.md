[Jump to Content](https://help.webexconnect.io/docs/sms-1#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Message Schema- SMS - WxEngage standalone
Search
`CTRL-K`
All
Platform Documentation
...
The document contains examples of inbound and outbound text messages, and a markdown cheat sheet for text formatting.
[Suggest Edits](https://help.webexconnect.io/edit/sms-1)
## 
➡️ Inbound Messages
[](https://help.webexconnect.io/docs/sms-1#%EF%B8%8F-inbound-messages)
JSON
...
## 
⬅️ Outbound Messages
[](https://help.webexconnect.io/docs/sms-1#%EF%B8%8F-outbound-messages)
JSON
...
## 
↩️ Announcement
[](https://help.webexconnect.io/docs/sms-1#%EF%B8%8F-announcement)
...
[](https://help.webexconnect.io/docs/sms-1#markdown-cheat-sheet)  
| Formatting  | Synax  |  
| --- | --- |  
...
* * *
[Message Schemas - WxEngage standalone](https://help.webexconnect.io/docs/message-schemas)[Message Schema - Facebook Messenger - WxEngage standalone](https://help.webexconnect.io/docs/facebook-messenger-3)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/sms-1)
  *     * [➡️ Inbound Messages](https://help.webexconnect.io/docs/sms-1#%EF%B8%8F-inbound-messages)
    * [⬅️ Outbound Messages](https://help.webexconnect.io/docs/sms-1#%EF%B8%8F-outbound-messages)
    * [↩️ Announcement](https://help.webexconnect.io/docs/sms-1#%EF%B8%8F-announcement)
    * [Markdown Cheat Sheet](https://help.webexconnect.io/docs/sms-1#markdown-cheat-sheet)
