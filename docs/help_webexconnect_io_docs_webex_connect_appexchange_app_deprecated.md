[Jump to Content](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Webex Connect AppExchange App - Deprecated
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/webex-connect-appexchange-app-deprecated)
> ## 📘
> Deprecation Alert
...
[](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#installing--for-salesforce-app)
...
[](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#trigger--flows-from-salesforce)
...
## 
Process Builder
[](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#process-builder)
...
![Screenshot of Choose +Add Action under IMMEDIATE ACTION or SCHEDULED ACTION](https://files.readme.io/160a48d-img7.png)
Choose +Add Action
  1. Choose the following configurations:  
i. Action type – Apex  
...
### 
Set Apex Variables
[](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#set-apex-variables)  
| Apex Variables  | Type  | Value  |  
| --- | --- | --- |  
|  Webex Connect_Webhook_URL  | String  | Enter Webex Connectcustom event URl  |  
| sObject_ID  | Field Reference  | Choose ID formula field  
  
Eg: For Account ID – : "Apex V.Id  |  
| sObject_Name  | String  | Enter sObject Name  
...
## 
Event Trigger
[](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#event-trigger)
...
![Screenshot of Event Trigger Page](https://files.readme.io/b0cb567-img8.png)
Event Trigger
...
## 
Schedule Trigger
[](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#schedule-trigger)
...
[](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#dashboard-within--for-salesforce-app)
This is a comprehensive page for all trigger related activities on Salesforce organization.
## 
Reports
[](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#reports)
...
* * *
[Enghouse Integration-Deprecated](https://help.webexconnect.io/docs/enghouse-integration-deprecated)[Nice inContact - Deprecated](https://help.webexconnect.io/docs/nice-incontact-deprecated)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated)
  *     * [Installing Webex Connect for Salesforce app](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#installing--for-salesforce-app)
    * [Trigger Webex Connect flows from Salesforce](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#trigger--flows-from-salesforce)
    * [Process Builder](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#process-builder)
      * [Set Apex Variables](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#set-apex-variables)
    * [Event Trigger](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#event-trigger)
    * [Schedule Trigger](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#schedule-trigger)
    * [Dashboard within Webex Connect for Salesforce App](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#dashboard-within--for-salesforce-app)
    * [Reports](https://help.webexconnect.io/docs/webex-connect-appexchange-app-deprecated#reports)
