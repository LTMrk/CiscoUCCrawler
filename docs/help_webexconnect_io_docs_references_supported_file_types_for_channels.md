[Jump to Content](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Supported File Types for Channels
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/references-supported-file-types-for-channels)
## 
Apple Messages for Business
[](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#apple-messages-for-business)  
...
## 
Email
[](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#email)  
| Media  | Supported Content Types - Outbound  | Supported Content Types - Inbound  |  
| --- | --- | --- |  
...
[](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#instagram-deprecated)  
| Media  | Supported Content Types - Outbound  | Supported Content Types - Inbound  |  
| --- | --- | --- |  
| Image  | .jpg, .png, .ico, .bmp, sticker (Like heart)  | .jpg, .png, .ico, .bmp, .gif  |  
## 
Facebook Messenger
[](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#facebook-messenger)  
| Media  | Supported Content Types - Outbound  | Supported Content Types - Inbound  |  
| --- | --- | --- |  
...
[](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#in-app-messaging--live-chat)  
...
| application  | pdf, doc, ppt, pptx, xlsx, xls,  
txt, csv  | pdf, doc, ppt, pptx, xlsx, xls,  
csv  |  
## 
MMS
[](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#mms)  
...
## 
SMS
[](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#sms)  
| Media  | Supported Content Type  |  
| --- | --- |  
| NA  | NA  |  
## 
Voice
[](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#voice)  
...
## 
WhatsApp
[](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#whatsapp)  
...
| --- | --- | --- | --- | --- |  
| audio  | AAC, AMR, MPEG, OGG  
  
Note: For OGG MIME Type, only media codec supported by WhatsApp is OPUS. Also, OPUS MIME Type is no longer supported by WhatsApp.  | audio/aac, audio/mp4, audio/mpeg, audio/amr, audio/ogg (only opus codecs, base audio/ogg is not supported)  | Audio is not supported via Templates.  | 16 MB  |  
...
Images must be 8-bit, RGB or RGBA  | JPEG, PNG  | 5 MB  |  
| video  | 3GPP, MP4  
  
Note:  
Only H.264 video codec and AAC audio codec is supported.  
WhatsApp support videos with a single audio stream or no audio stream.  | video/mp4, video/3gp  
  
Note:  
Only H.264 video codec and AAC audio codec is supported.  
We support videos with a single or no audio stream.  | 3GPP, MP4  
  
Note:  
Only H.264 video codec and AAC audio codec is supported.  
WhatsApp support videos with a single or no audio stream.  | 16 MB  |  
| Sticker  | WEBP  | image/webp  | NA  | Static stickers: 100KB  
...
[](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#custom-node-integration)  
| Feature  | File type  |  
| --- | --- |  
| Custom Node  | Only SVG image files supported  |  
## 
Event Scheduler
[](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#event-scheduler)  
| Media  | Supported Content Types  |  
| --- | --- |  
| Text  | .txt  |  
| Excel  | .xlsx  |  
...
[](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#channel-asset-set-up)  
...
Updated 14 days ago
* * *
[Supported Languages for Voice STT (Speech-to-Text)](https://help.webexconnect.io/docs/references-supported-languages-for-voice-stt-speech-to-text)[Security Best Practices](https://help.webexconnect.io/docs/references-security-best-practices)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/references-supported-file-types-for-channels)
  *     * [Apple Messages for Business](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#apple-messages-for-business)
    * [Email](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#email)
    * [Instagram (Deprecated)](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#instagram-deprecated)
    * [Facebook Messenger](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#facebook-messenger)
    * [In-App Messaging / Live Chat](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#in-app-messaging--live-chat)
    * [MMS](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#mms)
    * [Push Notifications](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#push-notifications)
    * [RCS](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#rcs)
    * [SMS](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#sms)
    * [Voice](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#voice)
    * [WhatsApp](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#whatsapp)
    * [Custom Node Integration](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#custom-node-integration)
    * [Event Scheduler](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#event-scheduler)
    * [Channel Asset Set-Up](https://help.webexconnect.io/docs/references-supported-file-types-for-channels#channel-asset-set-up)
