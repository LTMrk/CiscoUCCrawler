[Jump to Content](https://help.webexconnect.io/docs/qa-bot-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)QnA Bot Node
Search
`CTRL-K`
All
Platform Documentation
...
# QnA Bot Node
Understand what a QnA Bot node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/qa-bot-node)
...
![Screenshot of QnA bot Node](https://files.readme.io/cefe1b5-image.png)
QnA bot Node
> ## 📘
> Node version
...
[](https://help.webexconnect.io/docs/qa-bot-node#methods-and-outcomes)
...
[](https://help.webexconnect.io/docs/qa-bot-node#method-name---process-message)
...
| Language  | If the selected bot is multi-lingual, you can select the language of incoming message in the Language dropdown. The dropdown list is populated based on languages in bot settings.  
...
![Screenshot of Node configuration for Process Message method.](https://files.readme.io/460fd78-1.jpg)
...
[](https://help.webexconnect.io/docs/qa-bot-node#method-name---close-session)
...
![Screenshot of Node configuration for Close Session method.](https://files.readme.io/e597abb-2.png)
Node configuration for Close Session method
### 
Node outcomes
[](https://help.webexconnect.io/docs/qa-bot-node#node-outcomes)
...
### 
Node versions
[](https://help.webexconnect.io/docs/qa-bot-node#node-versions)
...
* * *
[Webex Campaign Profile Node](https://help.webexconnect.io/docs/campaign-profile-node)[Task Bot Node](https://help.webexconnect.io/docs/task-bot-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/qa-bot-node)
  *     * [Methods and Outcomes](https://help.webexconnect.io/docs/qa-bot-node#methods-and-outcomes)
      * [Method Name - Process Message](https://help.webexconnect.io/docs/qa-bot-node#method-name---process-message)
      * [Method name - Close Session](https://help.webexconnect.io/docs/qa-bot-node#method-name---close-session)
      * [Node outcomes](https://help.webexconnect.io/docs/qa-bot-node#node-outcomes)
      * [Node versions](https://help.webexconnect.io/docs/qa-bot-node#node-versions)
