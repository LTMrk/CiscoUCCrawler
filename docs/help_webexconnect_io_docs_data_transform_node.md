[Jump to Content](https://help.webexconnect.io/docs/data-transform-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Data Transform Node
Search
`CTRL-K`
All
Platform Documentation
...
# Data Transform Node
Understand what a Data Transform node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/data-transform-node)
...
![Screenshot of Data Transform Node](https://files.readme.io/5c3491c-Data_Transform_Data_Transform_node_image.png)
Data Transform Node
## 
Interface Elements
[](https://help.webexconnect.io/docs/data-transform-node#interface-elements)
...
| --- | --- | --- |  
| 1  | Configuration tab  | Use this tab to configure the data transformation settings.  
...
[](https://help.webexconnect.io/docs/data-transform-node#transforming-data-using-vtl)
You can transform data from JSON or XML to the desired format using VTL (Velocity Template Language). 
Here are the steps:
### 
**Configuring Settings**
[](https://help.webexconnect.io/docs/data-transform-node#configuring-settings)
...
### 
**Quick Sample**
[](https://help.webexconnect.io/docs/data-transform-node#quick-sample)
...
Screenshot of Data Transform Node Configuration Page.
Tranformation to XML using VTL
...
[](https://help.webexconnect.io/docs/data-transform-node#configuring-transitions)
...
* * *
[NLP Node](https://help.webexconnect.io/docs/nlp-node)[Call Transfer Node](https://help.webexconnect.io/docs/call-transfer-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/data-transform-node)
  *     * [Interface Elements](https://help.webexconnect.io/docs/data-transform-node#interface-elements)
    * [Transforming Data Using VTL](https://help.webexconnect.io/docs/data-transform-node#transforming-data-using-vtl)
      * [**Configuring Settings**](https://help.webexconnect.io/docs/data-transform-node#configuring-settings)
      * [**Quick Sample**](https://help.webexconnect.io/docs/data-transform-node#quick-sample)
      * [Configuring Transitions](https://help.webexconnect.io/docs/data-transform-node#configuring-transitions)
