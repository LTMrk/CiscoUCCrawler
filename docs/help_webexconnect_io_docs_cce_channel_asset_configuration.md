[Jump to Content](https://help.webexconnect.io/docs/cce-channel-asset-configuration#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Channel Asset Configuration - CCE
Search
`CTRL-K`
All
Platform Documentation
...
# Channel Asset Configuration - CCE
Learn about the procedures for asset configuration for various channels within the Webex Connect platform.
[Suggest Edits](https://help.webexconnect.io/edit/cce-channel-asset-configuration)
Webex Connect and Cisco Contact Center Enterprise (CCE) integration currently supports three channels - SMS, Email, and Live Chat. Here are the details of how you can configure the channel assets for each of these channels within Webex Connect.  
...
| Apple Messages for Business  | [Apple Messages for Business Asset Creation](https://help.webexconnect.io/docs/apple-messages-for-business-cce)  |  
| Facebook Messenger  | [Facebook Messenger Asset Creation](https://help.webexconnect.io/docs/facebook-messenger-cce)  |  
| WhatsApp  | [WhatsApp Asset Creation](https://help.webexconnect.io/docs/whatsapp-cce)  |  
> ## 📘
> Web CallBack
> Web CallBack is not a native channel of Webex Connect Please refer to the configuration related details on nodes in the [Flow Configurations](https://help.imiconnect.io/docs/flow-configurations) topic.
Updated 4 months ago
* * *
[Overview - CCE](https://help.webexconnect.io/docs/cce_overview)[SMS - CCE](https://help.webexconnect.io/docs/cce-sms)
