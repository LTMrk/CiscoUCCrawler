[Jump to Content](https://help.webexconnect.io/docs/page-connector-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Page Connector Node
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/page-connector-node)
...
[](https://help.webexconnect.io/docs/page-connector-node#creating-a-page-to-modularize-reusable-parts)
...
![Screenshot of Creating a Page for Modularizing a Reusable Node Sequence in a Flow.](https://files.readme.io/05eafe1-Page_Connector_Creating_a_Page_for_modularizing_a_Reusable_Node_Sequence_in_a_Flow.png)
...
[](https://help.webexconnect.io/docs/page-connector-node#using-page-connector-node)
Drag-drop a Page Connector node on the canvas and double-click the node to open for configuration.
![Screenshot of Page Connector Node Configuration Page.](https://files.readme.io/74e8c41-Page_Connector_-_Using_Page_Connector_Mode.png)
Page Connector Node Configuration Page.
...
![Screenshot of Using Page Connector Node in the main flow.](https://files.readme.io/5245e92-Page_Connector_Node.png)
...
![Screenshot of Connections with the Modularized Flow Segment.](https://files.readme.io/62e90a0-Configuring_Page_Connector_Node.png)
...
* * *
[Data Parser Node](https://help.webexconnect.io/docs/data-parser-node)[Call Workflow Node](https://help.webexconnect.io/docs/call-workflow-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/page-connector-node)
  *     * [Creating a Page to modularize reusable parts](https://help.webexconnect.io/docs/page-connector-node#creating-a-page-to-modularize-reusable-parts)
      * [Using Page Connector Node](https://help.webexconnect.io/docs/page-connector-node#using-page-connector-node)
