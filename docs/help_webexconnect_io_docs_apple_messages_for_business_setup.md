[Jump to Content](https://help.webexconnect.io/docs/apple-messages-for-business-setup#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Apple Messages for Business
Search
`CTRL-K`
All
Platform Documentation
...
Support your customers on Apple Messages for Business
[Suggest Edits](https://help.webexconnect.io/edit/apple-messages-for-business-setup)
## 
Creating an Apple Messages for Business application
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#creating-an-apple-messages-for-business-application)
...
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#registering-on-apple-messages-for-business-register)
...
## 
Using the channel
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#using-the-channel)
### 
User Identity
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#user-identity)
...
### 
Message Types
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#message-types)
...
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#apple-payment-configuration-optional)
...
#### 
**Prerequisites**
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#prerequisites)
...
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#register-your-merchant-id-on-apple-business-register)
...
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#generate-the-pem-file-required-by-the-payment-session)
...
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#configure-the-app-on-webex-connect-platform)
...
![Screenshot of Enable Payment](https://files.readme.io/92b7074-2024-06-06_16h06_55.png)
Enable Payment
...
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#business-logo-for-invitation-messages)
...
#### 
Prerequisites
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#prerequisites-1)
...
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#configure-the-business-logo)
...
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#apple-authentication-configuration-optional)
...
![Screenshot of Apple Business Register.](https://files.readme.io/b2dd215-apple_business_register.png)
Apple Business Register
#### 
**Prerequisites**
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#prerequisites-2)
...
![Screenshot displaying Enable Authentication.](https://files.readme.io/873a5dc-1.jpeg)
...
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#rich-link-previews-for-domains-optional)
...
![Screenshot displaying the Add Preview For Domain Button.](https://files.readme.io/10c0cac-AMB_Rich_Links.jpg)
Add Preview For Domain
  1. Enter a valid **Domain** name.

![Screenshot diaplying the enter the Domain Name](https://files.readme.io/1a79aa2-AMB_Rich_Links1.jpg)
Domain Name
  1. Click **Choose File** to upload the image for the domain.

![Screenshot displaying to Choose File to upload the image](https://files.readme.io/f5a28e6-AMB_Rich_Links3.png)
...
## 
API
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#api)
...
## 
Webhooks
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#webhooks)
...
## 
FAQs
[](https://help.webexconnect.io/docs/apple-messages-for-business-setup#faqs)
...
Updated 8 days ago
* * *
[Assigning a number to a Campaign ID](https://help.webexconnect.io/docs/assigning-a-number-to-a-campaign-id)[Email](https://help.webexconnect.io/docs/email)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/apple-messages-for-business-setup)
  *     * [Creating an Apple Messages for Business application](https://help.webexconnect.io/docs/apple-messages-for-business-setup#creating-an-apple-messages-for-business-application)
    * [Registering on Apple Messages for Business Register](https://help.webexconnect.io/docs/apple-messages-for-business-setup#registering-on-apple-messages-for-business-register)
    * [Using the channel](https://help.webexconnect.io/docs/apple-messages-for-business-setup#using-the-channel)
      * [User Identity](https://help.webexconnect.io/docs/apple-messages-for-business-setup#user-identity)
      * [Message Types](https://help.webexconnect.io/docs/apple-messages-for-business-setup#message-types)
      * [Apple Payment Configuration (Optional)](https://help.webexconnect.io/docs/apple-messages-for-business-setup#apple-payment-configuration-optional)
      * [Business Logo for Invitation Messages](https://help.webexconnect.io/docs/apple-messages-for-business-setup#business-logo-for-invitation-messages)
      * [Apple Authentication Configuration (Optional)](https://help.webexconnect.io/docs/apple-messages-for-business-setup#apple-authentication-configuration-optional)
      * [Rich Link Previews for Domains (Optional)](https://help.webexconnect.io/docs/apple-messages-for-business-setup#rich-link-previews-for-domains-optional)
    * [API](https://help.webexconnect.io/docs/apple-messages-for-business-setup#api)
    * [Webhooks](https://help.webexconnect.io/docs/apple-messages-for-business-setup#webhooks)
    * [FAQs](https://help.webexconnect.io/docs/apple-messages-for-business-setup#faqs)
