[Jump to Content](https://help.webexconnect.io/docs/cce-webex-engage-nodes-and-node-authorizations#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Webex Engage Nodes and Node Authorizations - CCE
Search
`CTRL-K`
All
Platform Documentation
...
Understand the various engage nodes and node authorizations in Cisco Contact Center Enterprise integration.
[Suggest Edits](https://help.webexconnect.io/edit/cce-webex-engage-nodes-and-node-authorizations)
...
## 
Node and Methods
[](https://help.webexconnect.io/docs/cce-webex-engage-nodes-and-node-authorizations#node-and-methods)  
| Node Name  | Description  | Methods  | Recommended Node Version  |  
| --- | --- | --- | --- |  
| [Search Conversation](https://help.webexconnect.io/docs/search-conversation)  | Calls Webex Engage Conversation Search API to search for an existing conversation using the customer identifier  | Search Conversation  | v1.1  |  
| [Append Message](https://help.webexconnect.io/docs/append-conversation)  | Calls Webex Engage Append Conversation API to append a message to an existing conversation  | Append Message  | v1.0 and v1.3  |  
| [Create Conversation](https://help.webexconnect.io/docs/create-conversation)  | Calls Webex Engage Create Conversation API to create a new conversation on imiengage with the channel and customer details  | Create Conversation  | v1.0 and v1.2  |  
| [Update Conversation](https://help.webexconnect.io/docs/update-conversation)  | Calls Webex Engage Update Conversation API to update a new conversation on imiengage with the channel and customer details  | Update Conversation  | v1.0  |  
...
## 
Node Authorization
[](https://help.webexconnect.io/docs/cce-webex-engage-nodes-and-node-authorizations#node-authorization)
...
[](https://help.webexconnect.io/docs/cce-webex-engage-nodes-and-node-authorizations#node-authorization-for-webex-engage-nodes)
...
![Page showing a list of prebuilt integrations available for selection and configuration.](https://files.readme.io/58dc375-WebexCCE_Engage_Authorized.PNG)
List of Prebuilt Integrations.
...
![Screenshot of Manage Integrations page with Node Authorizations section displaying mapped authorizations for the integration.](https://files.readme.io/54f3a49-Prebuild_Integration_Manage_Integration.PNG)
Viewing node authorizations for the integration.
> ## 📘
> Note
...
* * *
[End Task - CCE](https://help.webexconnect.io/docs/cce-end-task)[Search Conversation - CCE](https://help.webexconnect.io/docs/cce-search-conversation-engage-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/cce-webex-engage-nodes-and-node-authorizations)
  *     * [Node and Methods](https://help.webexconnect.io/docs/cce-webex-engage-nodes-and-node-authorizations#node-and-methods)
    * [Node Authorization](https://help.webexconnect.io/docs/cce-webex-engage-nodes-and-node-authorizations#node-authorization)
    * [Node Authorization for Webex Engage nodes](https://help.webexconnect.io/docs/cce-webex-engage-nodes-and-node-authorizations#node-authorization-for-webex-engage-nodes)
