[Jump to Content](https://help.webexconnect.io/docs/wxcc-flows-with-qnabot-nodes#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Configuring flows with Q&A and Task Bot Nodes - WXCC
Search
`CTRL-K`
All
Platform Documentation
...
Understand how to configure flows using Q&A and Task Bot Nodes
[Suggest Edits](https://help.webexconnect.io/edit/wxcc-flows-with-qnabot-nodes)
...
[](https://help.webexconnect.io/docs/wxcc-flows-with-qnabot-nodes#fbm-inbound-message-flow-with-bot-nodes)
### 
Use case description
[](https://help.webexconnect.io/docs/wxcc-flows-with-qnabot-nodes#use-case-description)
...
[](https://help.webexconnect.io/docs/wxcc-flows-with-qnabot-nodes#understanding-flow-logic)
...
![Screenshot of FBM Inbound Message Flow.](https://files.readme.io/5c591c0-Picture3.png)
...
![Screenshot of Part of the flow responsible for branching based on conversation state.](https://files.readme.io/bfe483d-Picture4.png)
Part of the flow responsible for branching based on conversation state
![Screenshot of extracting entity values using Data Parser node.](https://files.readme.io/bf6046a-Picture5.png)
Extracting entity values using Data Parser node
...
## 
Conversation closed
[](https://help.webexconnect.io/docs/wxcc-flows-with-qnabot-nodes#conversation-closed)
...
[](https://help.webexconnect.io/docs/wxcc-flows-with-qnabot-nodes#processing-bot-response)
...
![Screenshot of extracting quick reply button titles and payloads along with text response.](https://files.readme.io/52d1cdc-Picture6.png)
Extracting quick reply button titles and payloads along with text response
...
![Screenshot of using the values extracted from Data Parser in Messenger node](https://files.readme.io/e52401f-Messenger1.jpg)
...
[](https://help.webexconnect.io/docs/wxcc-flows-with-qnabot-nodes#livechat-inbound-message-flow-with-bot-nodes)
For the Livechat Inbound Message flow, sequence, and logic largely remain the same as Messenger 
![Screenshot of Livechat Inbound Message Flow with bot nodes.](https://files.readme.io/a4090db-Picture8.png)
Livechat Inbound Message Flow with bot nodes.
...
![Screenshot of using a pre-chat form through In-app Messaging node.](https://files.readme.io/2798237-Picture9.png)
Using a pre-chat form through In-app Messaging node
...
![Screenshot of Using Name and Email values collected in pre-chat form and sending them to the bot as Customer Parameters along with balance as Message Parameter](https://files.readme.io/887f1a8d5b81f96c3f8d2f23ffb4a2c12ecb538d2cf4cd17fed48f2524903389-image.png)
Using Name and Email values collected in pre-chat form and sending them to the bot as Customer Parameters along with balance as Message Parameter
  * Rest of the flow remains the same as Inbound Message flows for other channels.


Updated 4 months ago
* * *
[Proactive chat - Flows - WXCC](https://help.webexconnect.io/docs/wxcc-proactive-chat-flows)[Configuring flows with AI Agent Node - WXCC](https://help.webexconnect.io/docs/configuring-flows-with-ai-agent-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/wxcc-flows-with-qnabot-nodes)
  *     * [FBM Inbound Message Flow with bot nodes](https://help.webexconnect.io/docs/wxcc-flows-with-qnabot-nodes#fbm-inbound-message-flow-with-bot-nodes)
      * [Use case description](https://help.webexconnect.io/docs/wxcc-flows-with-qnabot-nodes#use-case-description)
      * [Understanding Flow Logic](https://help.webexconnect.io/docs/wxcc-flows-with-qnabot-nodes#understanding-flow-logic)
    * [Conversation closed](https://help.webexconnect.io/docs/wxcc-flows-with-qnabot-nodes#conversation-closed)
    * [Processing bot response](https://help.webexconnect.io/docs/wxcc-flows-with-qnabot-nodes#processing-bot-response)
    * [Livechat Inbound Message Flow with bot nodes](https://help.webexconnect.io/docs/wxcc-flows-with-qnabot-nodes#livechat-inbound-message-flow-with-bot-nodes)
