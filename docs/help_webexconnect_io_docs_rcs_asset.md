[Jump to Content](https://help.webexconnect.io/docs/rcs-asset#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)RCS
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/rcs-asset)
...
[](https://help.webexconnect.io/docs/rcs-asset#enabling-an-rcs-application)
...
[](https://help.webexconnect.io/docs/rcs-asset#configure-rcs-application-on-webex-connect)
  1. To configure the RCS app, sign in to the Webex Connect platform, go to **Assets** > **Apps**. 

![Screenshot of Selecting the Apps from Assets Menu.](https://files.readme.io/8423d11-RCS.png)
Selecting the Apps from Assets Menu.
...
## 
Using the channel
[](https://help.webexconnect.io/docs/rcs-asset#using-the-channel)
### 
User Identity
[](https://help.webexconnect.io/docs/rcs-asset#user-identity)
...
### 
API
[](https://help.webexconnect.io/docs/rcs-asset#api)
...
### 
Webhooks
[](https://help.webexconnect.io/docs/rcs-asset#webhooks)
...
Incoming MessageIncoming AttachmentLocationPostback
...
## 
Message Type
[](https://help.webexconnect.io/docs/rcs-asset#message-type)
...
## 
Flow
[](https://help.webexconnect.io/docs/rcs-asset#flow)
...
## 
FAQs
[](https://help.webexconnect.io/docs/rcs-asset#faqs)
...
[](https://help.webexconnect.io/docs/rcs-asset#regions-where-webex-connect-has-connectivity)
...
Updated 16 days ago
* * *
[Mobile & Web](https://help.webexconnect.io/docs/mobile-web)[RCS Onboarding Guidelines](https://help.webexconnect.io/docs/rcs-onboarding-guidelines)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/rcs-asset)
  *     * [Enabling an RCS Application](https://help.webexconnect.io/docs/rcs-asset#enabling-an-rcs-application)
    * [Configure RCS application on Webex Connect](https://help.webexconnect.io/docs/rcs-asset#configure-rcs-application-on-webex-connect)
    * [Using the channel](https://help.webexconnect.io/docs/rcs-asset#using-the-channel)
      * [User Identity](https://help.webexconnect.io/docs/rcs-asset#user-identity)
      * [API](https://help.webexconnect.io/docs/rcs-asset#api)
      * [Webhooks](https://help.webexconnect.io/docs/rcs-asset#webhooks)
    * [Message Type](https://help.webexconnect.io/docs/rcs-asset#message-type)
    * [Flow](https://help.webexconnect.io/docs/rcs-asset#flow)
    * [FAQs](https://help.webexconnect.io/docs/rcs-asset#faqs)
    * [Regions where Webex Connect has connectivity](https://help.webexconnect.io/docs/rcs-asset#regions-where-webex-connect-has-connectivity)
