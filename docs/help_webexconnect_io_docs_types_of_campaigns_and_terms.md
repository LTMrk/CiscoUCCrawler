[Jump to Content](https://help.webexconnect.io/docs/types-of-campaigns-and-terms#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Types of Campaigns and Terms
Search
`CTRL-K`
All
Platform Documentation
...
Understand the various types of Campaigns present and select the type based on the use case to be supported
[Suggest Edits](https://help.webexconnect.io/edit/types-of-campaigns-and-terms)
## 
Types of Campaigns
[](https://help.webexconnect.io/docs/types-of-campaigns-and-terms#types-of-campaigns)
...
! Post-registration approval by MNO in the United States is required for this use case.  |  
...
| Emergency  | Notification services designed to support public safety or health during natural disasters, armed conflicts, pandemics, and other national or regional emergencies.  
! Post-registration approval by MNO is required for this use case.  |  
...
(Election Campaigns)  | Part of organized effort to influence decision making of specific group. Available only to registered 501(c)(4/5/6) and organizations with a Campaign Verify token.  |  
| Social  | Communication between public figures or influencers and their communities. Examples include: YouTube Influencers' alerts or Celebrity alerts  
! Only MNO pre-approved brands are eligible for this use case.  |  
| Sole Proprietor  | Limited to entities without a EIN / Tax ID, requires separate contract.  |  
| Platform Free Trial  | Platform Free Trial offers with strict controls and MNO audit rights (MO opt in).  
! Only pre-approved brands are eligible for this use case.  |  
...
! Only pre-approved brands are eligible for this use case.  |  
| Agents and Franchises  | Brands that have multiple agents, franchises or offices in the same brand vertical, but require individual localized numbers per agent, location, or office.  
...
[](https://help.webexconnect.io/docs/types-of-campaigns-and-terms#carrier-terms-preview)
...
* * *
[Registering a Campaign](https://help.webexconnect.io/docs/register-a-campaign)[Managing a Campaign](https://help.webexconnect.io/docs/manage-a-campaign)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/types-of-campaigns-and-terms)
  *     * [Types of Campaigns](https://help.webexconnect.io/docs/types-of-campaigns-and-terms#types-of-campaigns)
    * [Carrier Terms Preview](https://help.webexconnect.io/docs/types-of-campaigns-and-terms#carrier-terms-preview)
