[Jump to Content](https://help.webexconnect.io/docs/task-bot-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Task Bot Node
Search
`CTRL-K`
All
Platform Documentation
...
# Task Bot Node
Understand what a Task Bot node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/task-bot-node)
...
![Screenshot of Task bot Node](https://files.readme.io/e9e6f4f-image.png)
Task bot Node
> ## 📘
> Node version
...
[](https://help.webexconnect.io/docs/task-bot-node#methods-and-outcomes)
...
[](https://help.webexconnect.io/docs/task-bot-node#method-name---process-message)
...
| --- | --- |  
| Bot  | The bot that will be used to process the user message and get a response.  
...
![Screenshot of Task bot node configuration.](https://files.readme.io/2d403a1-image.png)
Task bot node configuration
**Output variables**
...
[](https://help.webexconnect.io/docs/task-bot-node#method-name---close-session)
...
![Screenshot of Node configuration for the Close Session method.](https://files.readme.io/9fa2a28-image.png)
Node configuration for the Close Session method
### 
Node Outcomes
[](https://help.webexconnect.io/docs/task-bot-node#node-outcomes)
...
|   |   |  
| --- | --- |  
| Error (Red)  |  _**onError** - when the bot has not responded with a message  
_ **onInvalidCustomerID** - when customer identifier is missing  
* **onInvalidMessage** - when message value is missing  |  
| Success (green)  |  _**onSuccess** - when the bot responds with a message  
...
### 
Node versions
[](https://help.webexconnect.io/docs/task-bot-node#node-versions)
...
* * *
[QnA Bot Node](https://help.webexconnect.io/docs/qa-bot-node)[NLP Node](https://help.webexconnect.io/docs/nlp-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/task-bot-node)
  *     * [Methods and Outcomes](https://help.webexconnect.io/docs/task-bot-node#methods-and-outcomes)
      * [Method Name - Process Message](https://help.webexconnect.io/docs/task-bot-node#method-name---process-message)
      * [Method name - Close Session](https://help.webexconnect.io/docs/task-bot-node#method-name---close-session)
      * [Node Outcomes](https://help.webexconnect.io/docs/task-bot-node#node-outcomes)
      * [Node versions](https://help.webexconnect.io/docs/task-bot-node#node-versions)
