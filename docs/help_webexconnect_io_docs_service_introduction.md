[Jump to Content](https://help.webexconnect.io/docs/service-introduction#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)What's a Service
Search
`CTRL-K`
All
Platform Documentation
...
# What's a Service
Understand what services are and how you can set them up
[Suggest Edits](https://help.webexconnect.io/edit/service-introduction)
...
Within a service, you can:
  * [Create and manage flows](https://help.webexconnect.io/docs/flows)
  * [Create and manage rules](https://help.webexconnect.io/docs/rules)
  * [View, copy or regenerate Service Key and/or JWT tokens needed for invoking various APIs](https://help.webexconnect.io/docs/api-settings)
...
## 
NGMP Services
[](https://help.webexconnect.io/docs/service-introduction#ngmp-services)
...
* * *
[Authenticating Customers with Apple Auth](https://help.webexconnect.io/docs/authenticate-customers-with-apple-auth)[Creating a Service](https://help.webexconnect.io/docs/create-a-service)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/service-introduction)
  *     * [NGMP Services](https://help.webexconnect.io/docs/service-introduction#ngmp-services)
