[Jump to Content](https://help.webexconnect.io/docs/database-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Database Node [Deprecated]
Search
`CTRL-K`
All
Platform Documentation
...
Understand what a Database node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/database-node)
> ## 📘
> Deprecation Alert
...
## 
Interface Elements
[](https://help.webexconnect.io/docs/database-node#interface-elements)
![1264](https://files.readme.io/0f4a636-Database_Deprecated_Click_the_image_to_view_it_larger.png)
Click the image to view it larger
Here is the description for the interface elements:  
| S. No  | Element  | Description  |  
| --- | --- | --- |  
| 1  | Configuration tab  | Use this tab to configure the settings for selecting or updating a specific data in the database .  
...
[](https://help.webexconnect.io/docs/database-node#selecting-or-updating-a-specific-data-in-database)
You can select or update specific data in the database by configuring the settings in the Database node.
Here are the steps:
## 
Configuring Settings
[](https://help.webexconnect.io/docs/database-node#configuring-settings)
...
[](https://help.webexconnect.io/docs/database-node#configuring-transitions)
...
* * *
[Registry Node [Deprecated]](https://help.webexconnect.io/docs/registry-node)[Create Chat Node](https://help.webexconnect.io/docs/create-chat-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/database-node)
  *     * [Interface Elements](https://help.webexconnect.io/docs/database-node#interface-elements)
    * [Selecting or Updating a Specific Data in Database](https://help.webexconnect.io/docs/database-node#selecting-or-updating-a-specific-data-in-database)
    * [Configuring Settings](https://help.webexconnect.io/docs/database-node#configuring-settings)
    * [Configuring Transitions](https://help.webexconnect.io/docs/database-node#configuring-transitions)
