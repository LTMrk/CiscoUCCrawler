[Jump to Content](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Cisco ECE Integration - Deprecated
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/cisco-ece-integration-deprecated)
> ## ❗️
> Deprecation Alert
> Please note that the below integration has been deprecated.
**_Enterprise Chat and Email (ECE)_** is an offering from Cisco CCE suite that allows customer support agents to respond to customer queries/tickets in real-time on webchat and email.  
...
## 
Channel Support
[](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#channel-support)
...
## 
Capabilities
[](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#capabilities)
...
Channel-specific limitations related to the type and format of attachments apply. Attachments are sent in one of the following ways: 
  ...
  * Notify agents about the customer-related events such as: 
    * `Customer started/stopped typing`
    * `Customer uploaded attachment`
    * `Customer accepted attachment`
...
> The events may vary based on the communication channel.
  * Notify customers about agent-related events such as: 
    * `Agent started/stopped typing`
    * `Chat started`
    * `Chat assigned`
    * `Chat transferred`
    * `Chat closed`
    * `Agent uploaded attachment`
    * `Agent accepted attachment`
    * `Agent rejected attachment`.
...
[](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#integrate-cisco-ece-with-webex-connect)
...
![Screenshot of List of Integrations.](https://files.readme.io/5e17adc-CiscoECE.jpg)
List of Integrations
  1. Click **Add Integration** and select the **Cisco ECE** option.
  2. Enter a suitable **Name** for the integration.
  3. Select the required **Version** of the Cisco ECE connector.
  4. Enter **Authentication Details** for the integration. 
...
![Screenshot of Authentication Details.](https://files.readme.io/cd70545-ece_authentication_details.png)
Authentication Details
  1. Provide details for **Entry Point Configurations** (an entry point is an agent or a group of agents in Cisco Finesse): 
...
![Screenshot of Entry Point Configurations](https://files.readme.io/7a75b37-entry_point_configs.png)
Entry Point Configurations
The following icons provide details about the agent:  
| Icon  | Description  |  
| --- | --- |  
| Agent  |  Indicates whether an agent can accept new chats or is busy:
>   * Red – indicates that the agent is busy and cannot accept pick up any chat
>   * Green – indicates that the agent is ready to accept the chat
> 

 |  
| Depth  |  Indicates whether the maximum number of chats that an agent can handle concurrently has been reached:
>   * Red – indicates that the agent is out of capacity
>   * Green – indicates that the agent can pick up a chat
> 

 |  
| Wait  |  Indicates whether the waiting time for the customers before an agent picks up the chat is within an acceptable range or not: 
>   * Red – indicates that wait time is out of acceptable range
>   * Green – indicates that the wait time is within the acceptable range
> 

 |  
| Status  |  Indicates the availability status of the agent: 
>   * Red – offline
>   * Green - online
> 

 |  
  1. Configure the set of messages that appear to the customer when certain events are triggered. This is an optional step.

![Screenshot of Configure Messages Section.](https://files.readme.io/9e49169-messages_for_events.png)
Configure Messages
...
> 
  ...
  1. Click **Add Entry Point** and repeat the above steps to add other entry points to the integration. This is an optional step.  
You can add entry points in scenarios where multiple entry points are associated with a single Cisco ECE integration in Webex Connect.
  2. Use **Custom Attributes** to map channel attributes with integration attributes. For example, to map Facebook username to the Messenger username, enter `$(fb.username)` in the **Name** field and `$(messenger.username)` in the **Value** field. Click **Add Custom Attribute** to map the required attributes. This is an optional step.

![Screenshot of Custom Attributes.](https://files.readme.io/2f4c506-CustomAttributes.jpg)
Custom Attributes
  1. Click **Save** to test and save the integration.  
...
[](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#use-the-cisco-ece-integration)
Once you’ve integrated Cisco ECE with Webex Connect, you can test the end-to-end experience from receiving a customer message through any of the supported channels to facilitating a two-way chat communication between an agent and the customer by following the below steps:
  ...
  4. Map the Cisco ECE Integration as a CCSP endpoint within the service. Define logic to route the customer messages to CCSP in one of the following ways: 
     ...
     * [Create a flow](https://help.webexconnect.io/docs/flows#section-creating-a-flow) that uses the CCSP (Create Chat and Validate Chat) nodes. Publish the flow and then launch it.
...
[](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#use-cisco-ece-integration-for-customer-support-over-messenger)
In this sample tutorial, you can see how to integrate Messenger to Cisco ECE through Webex Connect chat engine to allow direct communication between an agent and a customer.
  1. Create a Cisco ECE integration with the name _MyCiscoECEIntegration_. For more information, see the [Integrate Cisco ECE with Webex Connect](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#section-integrate-cisco-ece-with-imiconnect) section.
...
![Screenshot of Add Messenger Page.](https://files.readme.io/398dc90-create_messenger_app.png)
Add Messenger Page
For more information, see [Creating a Messenger App](https://help.webexconnect.io/docs/facebook-messenger#section-creating-a-facebook-messenger-messenger-app).
  1. Create a service to route incoming customer inquiries from Facebook messenger account to Cisco ECE.  
...
![Screenshot of Selecting the Incoming Event.](https://files.readme.io/097fc52-rule_select_event.png)
Select Event
...
![Screenshot of Selecting Action Forward to CCSP](https://files.readme.io/2a7cd7f-rule_select_action.png)
Select Action - Forward to CCSP
e. Configure rule details like **Name** , **Start Date** , **End Date** , **Status** , and then **Save** the rule as _MyECEMessengerRule_.
![Screenshot of Rule Details Section.](https://files.readme.io/e75f90a-rule_details.png)
Rule Details
...
[](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#use-cisco-ece-integration-for-customer-support-over-sms)
...
## 
Use Cases
[](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#use-cases)
...
In this use case, you can see the customer journey from chat initiation to chat completion.
  ...
  2. The message reaches the Cisco ECE chat console through Webex Connect and a pre-configured welcome message appears in the Messenger window. For example, `Thank you for contacting us. We are here to help you resolve your issue. Please be patient until an agent attends you`.
  3. When an agent picks up the chat on Cisco ECE console, a pre-configured agent-assigned message appears. For example, `You are now chatting with CiscoAgent1`.
  4. If the agent transfers the chat to another agent or queue, a pre-configured message appears. For example, `You have been transferred to the Network Issues queue`.
  5. When the customer sends an attachment to the agent and if the agent accepts it, a pre-configured message like `The agent has accepted your attachment.` appears to the customer. When the agent clicks the attachment, it is downloaded. If the agent rejects the attachment, a message indicating that appears on the customer screen if configured.
  6. If the agent pushes a page to the customer using _Page Push_ in the chat console, again a pre-configured message appears on the customer screen.  



Finally, when the agent completes the chat, a message like `The agent has marked your chat closed.` appears if configured.
## 
Agent Unavailable
[](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#agent-unavailable)
In this use case, you can see what happens when there are no agents available to pick the customer’s chat.
  ...
  3. If there are no agents available/ready to pick up the chat, a pre-configured message like `Sorry! There are no agents available right now to be with you. Please come back later.` appears to the customer.  
...
* * *
[Nice inContact - Deprecated](https://help.webexconnect.io/docs/nice-incontact-deprecated)[Skype for Business Integration - Deprecated](https://help.webexconnect.io/docs/skype-for-business-integration-deprecated)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated)
  *     * [Channel Support](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#channel-support)
    * [Capabilities](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#capabilities)
    * [Integrate Cisco ECE with Webex Connect](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#integrate-cisco-ece-with-webex-connect)
    * [Use the Cisco ECE Integration](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#use-the-cisco-ece-integration)
    * [Use Cisco ECE Integration for Customer Support over Messenger](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#use-cisco-ece-integration-for-customer-support-over-messenger)
    * [Use Cisco ECE Integration for Customer Support over SMS](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#use-cisco-ece-integration-for-customer-support-over-sms)
    * [Use Cases](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#use-cases)
    * [Agent Unavailable](https://help.webexconnect.io/docs/cisco-ece-integration-deprecated#agent-unavailable)
