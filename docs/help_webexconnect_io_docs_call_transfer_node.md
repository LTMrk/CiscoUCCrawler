[Jump to Content](https://help.webexconnect.io/docs/call-transfer-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Call Transfer Node
Search
`CTRL-K`
All
Platform Documentation
...
# Call Transfer Node
Understand what a Call Transfer node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/call-transfer-node)
...
![Screenshot of Call Transfer Node](https://files.readme.io/7adacca-Call_Transfer.png)
Call Transfer Node
...
* * *
[Data Transform Node](https://help.webexconnect.io/docs/data-transform-node)[Summarize Text Beta Node](https://help.webexconnect.io/docs/summarize-text-beta-node)
