[Jump to Content](https://help.webexconnect.io/docs/references-character-sets-supported-for-messaging#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Character Sets Supported for Messaging
Search
`CTRL-K`
All
Platform Documentation
...
Character sets supported by the platform while sending and receiving messages
[Suggest Edits](https://help.webexconnect.io/edit/references-character-sets-supported-for-messaging)
...
* * *
[Glossary](https://help.webexconnect.io/docs/references-glossary)[Public IPs Across Regions](https://help.webexconnect.io/docs/references-public-ips-across-regions)
