  * [Skip to content](https://www.cisco.com/c/en/us/support/docs/field-notices/704/fn70489.html#eot-doc-wrapper)
  * [Skip to search](https://www.cisco.com/c/en/us/support/docs/field-notices/704/fn70489.html)
  * [Skip to footer](https://www.cisco.com/c/en/us/support/docs/field-notices/704/fn70489.html)
  ...
  * [...](https://www.cisco.com/c/en/us/support/docs/field-notices/704/fn70489.html)Show All Breadcrumbs
  * [Support](https://www.cisco.com/c/en/us/support/index.html)
...
Save
[Log in](https://www.cisco.com/c/login/index.html?referer=/c/en/us/support/docs/field-notices/704/fn70489.html) to Save Content 
Print
### Available Languages
...
| 1.1  | 18-Dec-19  | Minor text and formmatting correction  |  
...
| IOS  | IOS  | 15.8  | 15.8(3)M, 15.8(3)M0a, 15.8(3)M0b, 15.8(3)M1, 15.8(3)M1a, 15.8(3)M2, 15.8(3)M2a  | All releases prior to 15.8(03)M03  |  
...
**Note:** To be impacted by this issue, a device must have a self-signed certificate defined _AND_ the self-signed certificate must be applied to one or more features as outlined below. Presence of a self-signed certificate alone will not impact the operation of the device when the certificate expires and does not require immediate action.
### Background
...
**Wireless Features:**
  * LWAPP/CAPWAP connections between older Cisco IOS access points (manufactured in 2005 or earlier) and Wireless LAN Controllers; see Cisco Field Notice [FN63942](https://www.cisco.com/c/en/us/support/docs/field-notices/639/fn63942.html) for more details.
...
After you upgrade the software, you must _ALSO_ regenerate the self-signed certificate and export it to any devices that might require the new certificate in their trust-store.
...
`User@linux-box$ openssl req -newkey rsa:2048 -nodes -keyout tmp.key -x509 -days 4000 -out tmp.cer -subj  
  ...
  2. Import the certificate to a Cisco IOS or IOS XE Router:
`Router# conf t  
 	Enter configuration commands, one per line.  End with CNTL/Z.  
 	Router(config)# crypto pki trustpoint TEST  
...
```
     ...
     * **If the trustpoint enrollment is _not_ configured for "selfsigned":** The device is not impacted by this field notice. No action is required.
     * **If the trustpoint enrollment _is_ configured for "selfsigned" _and_ if the self-signed certificate appears in the configuration:** The device might be impacted by this field notice. Continue to Step 4.
  4. If you determined in Step 3 that the trustpoint enrollment is configured for "selfsigned" and that the self-signed certificate appears in the configuration, then check to see if the self-signed certificate is applied to a feature on the device.
...
**Note:** You may notice the self-signed certificate truststore name shown in the output of the **show ip ssh** CLI command. This is _NOT_ an indication that you are exposed to the issue described in this Field Notice. If you only log into a device with a username / password or by use of an RSA key pair, you are _NOT_ affected by this Field Notice.
...
For additional technical details, refer to [IOS Self-Signed Certificate Expiration on Jan. 1, 2020](https://www.cisco.com/c/en/us/support/docs/security-vpn/public-key-infrastructure-pki/215118-ios-self-signed-certificate-expiration-o.html "IOS Self-Signed Certificate Expiration on Jan. 1, 2020").
...
[![Back to Top](https://www.cisco.com/etc/designs/cdc/fw/i/responsive/Default-bTop-36.svg)Back to Top](https://www.cisco.com/c/en/us/support/docs/field-notices/704/fn70489.html "Back to Top")
...
### Contact Cisco
  * [Open a Support Case ![login required](https://www.cisco.com/etc/designs/cdc/fw/i/icon_lock_small.png)](https://mycase.cloudapps.cisco.com/start?prodDocUrl=https://www.cisco.com/c/en/us/support/docs/field-notices/704/fn70489.html)
  * (Requires a [Cisco Service Contract](https://www.cisco.com/c/en/us/services/order-services.html))


### This Document Applies to These Products
  * [2500 Series Connected Grid Switches](https://www.cisco.com/c/en/us/support/switches/2500-series-connected-grid-switches/series.html)
  * [Industrial Ethernet 2000 Series Switches](https://www.cisco.com/c/en/us/support/switches/industrial-ethernet-2000-series-switches/series.html)
  * [Industrial Ethernet 2000U Series Switches](https://www.cisco.com/c/en/us/support/switches/industrial-ethernet-2000u-series-switches/series.html)
  * [Industrial Ethernet 3000 Series Switches](https://www.cisco.com/c/en/us/support/switches/industrial-ethernet-3000-series-switches/series.html)
  * [Industrial Ethernet 4000 Series Switches](https://www.cisco.com/c/en/us/support/switches/industrial-ethernet-4000-series-switches/series.html)
  * [Industrial Ethernet 4010 Series Switches](https://www.cisco.com/c/en/us/support/switches/industrial-ethernet-4010-series-switches/series.html)
  * [Industrial Ethernet 5000 Series Switches](https://www.cisco.com/c/en/us/support/switches/industrial-ethernet-5000-series-switches/series.html)
  * [Industrial Wireless 3700 Series](https://www.cisco.com/c/en/us/support/wireless/industrial-wireless-3700-series/series.html)

+ Show All 8 Products
Unleash the Power of TAC's Virtual Assistance
Unleash the Power of TAC's Virtual Assistance
[Login to enable assistance](https://www.cisco.com/c/login/index.html?referer=/c/en/us/support/docs/field-notices/704/fn70489.html)
Unleash the Power of TAC's Virtual Assistance
Unleash the Power of TAC's Virtual Assistance
[Login to enable assistance](https://www.cisco.com/c/en/us/support/docs/field-notices/704/fn70489.html)
