[Jump to Content](https://help.webexconnect.io/docs/ivr-menu-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)IVR Menu Node
Search
`CTRL-K`
All
Platform Documentation
...
# IVR Menu Node
Understand what a IVR Menu node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/ivr-menu-node)
The _IVR Menu_ node is used to receive and capture the user input on an on-going call and accordingly branch the execution of the flow. The expected user input is a single digit for the _IVR Menu_ node. You can choose to play an audio prompt before asking the user to enter input.  
...
## 
Node Configuration
[](https://help.webexconnect.io/docs/ivr-menu-node#node-configuration)
...
[](https://help.webexconnect.io/docs/ivr-menu-node#configuring-keypress)
![Screenshot of Keypress IVR Menu Node Configuration](https://files.readme.io/7d4d957-IVR.jpg)
IVR Menu Node Configuration - Keypress
...
[](https://help.webexconnect.io/docs/ivr-menu-node#configuring-speech-recognition)
![Screenshot of Speech IVR Menu Node Configuration](https://files.readme.io/63a177d-IVR1.jpg)
IVR Menu Node Configuration - Speech
...
## 
Input Variables
[](https://help.webexconnect.io/docs/ivr-menu-node#input-variables)
...
## 
Output Variables
[](https://help.webexconnect.io/docs/ivr-menu-node#output-variables)
You can see the data that this node generates as output variables. These [variables](https://help.webexconnect.io/docs/variable-management) are available for use in subsequent nodes. The following are the standard output variables for the _IVR Menu_ node:
  * **ivr.input** - stores the user input captured through IVR.

![Screenshot of IVR Menu Output Variables](https://files.readme.io/5b08841-IVR2.jpg)
Output Variables
## 
Node Outcomes
[](https://help.webexconnect.io/docs/ivr-menu-node#node-outcomes)
...
| Error (red)  | > _**onError** - the flow exits through this node outcome when there is an error in playing the configured audio prompts  
> _ **onwrongInput** - the flow exits through this node outcome when the user input is wrong/invalid  |  
## 
Transition Actions
[](https://help.webexconnect.io/docs/ivr-menu-node#transition-actions)
...
* * *
[Call Patch Node](https://help.webexconnect.io/docs/call-patch-node)[Profile Node](https://help.webexconnect.io/docs/profile-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/ivr-menu-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/ivr-menu-node#node-configuration)
      * [Configuring Keypress](https://help.webexconnect.io/docs/ivr-menu-node#configuring-keypress)
      * [Configuring Speech Recognition](https://help.webexconnect.io/docs/ivr-menu-node#configuring-speech-recognition)
    * [Input Variables](https://help.webexconnect.io/docs/ivr-menu-node#input-variables)
    * [Output Variables](https://help.webexconnect.io/docs/ivr-menu-node#output-variables)
    * [Node Outcomes](https://help.webexconnect.io/docs/ivr-menu-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/ivr-menu-node#transition-actions)
