  * [Skip to content](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-cimc-arg-inject-upSHdMfU.html#eot-doc-wrapper)
  * [Skip to search](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-cimc-arg-inject-upSHdMfU.html)
  * [Skip to footer](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-cimc-arg-inject-upSHdMfU.html)
  ...
  * [](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-cimc-arg-inject-upSHdMfU.html)
  * [Support](https://www.cisco.com/c/en/us/support/index.html)
...
Save
[Log in](https://www.cisco.com/c/login/index.html?referer=/c/en/us/support/docs/csa/cisco-sa-cimc-arg-inject-upSHdMfU.html) to Save Content 
Print
### Available Languages
Updated:August 5, 2026
Document ID:1785948290883332
Bias-Free Language
### Bias-Free Language
...
Cisco Bug IDs:
[CSCwt16342](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwt16342)
[CSCwt45063](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwt45063)
[CSCwu57141](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwu57141)
[ More... ](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-cimc-arg-inject-upSHdMfU.html)
[](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-cimc-arg-inject-upSHdMfU.html) ,[CSCwt16342](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwt16342),[CSCwt45063](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwt45063),[CSCwu57141](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwu57141),[CSCwu57142](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwu57142)
CVE-2026-20200
CVE-2026-20288
[](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-cimc-arg-inject-upSHdMfU.html)
CWE-141
...
CWE-146
[](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-cimc-arg-inject-upSHdMfU.html)
[ Download CSAF ](https://sec.cloudapps.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-cimc-arg-inject-upSHdMfU/csaf/cisco-sa-cimc-arg-inject-upSHdMfU.json)
Email 
## 
Summary 
  * Multiple vulnerabilities in the web-based management interface of Cisco Integrated Management Controller (IMC) could allow an authenticated, remote attacker to execute arbitrary commands on the underlying operating system of an affected system and elevate privileges to _root_. 
For more information about these vulnerabilities, see the [Details](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-cimc-arg-inject-upSHdMfU.html#details) section of this advisory.
...
| --- | --- | --- |  
| 5000 Series Enterprise Network Compute Systems (ENCS)  | CVE-2026-20288  | [CSCwu57141](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwu57141)  |  
| Catalyst 8300 Series Edge uCPE  | CVE-2026-20288  | [CSCwu57142](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwu57142)  |  
| UCS C-Series M5 and M6 Rack Servers in standalone mode  | CVE-2026-20288  | [CSCwt45063](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwt45063)  |  
| UCS C-Series M7 and M8 Rack Servers in standalone mode  | CVE-2026-20200   
CVE-2026-20288  |  [CSCwt16342](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwt16342)  
[CSCwt45063](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwt45063)  |  
| UCS E-Series Servers M3  | CVE-2026-20288  | [CSCwu57141](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwu57141)  |  
| UCS E-Series Servers M6  | CVE-2026-20288  | [CSCwu57142](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwu57142)  |  
| UCS S-Series Storage Servers in standalone mode  | CVE-2026-20288  | [CSCwt45063](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwt45063)  |  
...
For information about which Cisco software releases are vulnerable, see the [Fixed Software](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-cimc-arg-inject-upSHdMfU.html#fs) section of this advisory.
##  Products Confirmed Not Vulnerable 
Only products listed in the [Vulnerable Products](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-cimc-arg-inject-upSHdMfU.html#vp) section of this advisory are known to be affected by these vulnerabilities.
...
A vulnerability in the web-based management interface of Cisco IMC could allow an authenticated, remote attacker with low privileges to execute arbitrary commands on the underlying operating system of an affected system and elevate privileges to _root_. 
This vulnerability is due to improper validation of user-supplied input. An attacker could exploit this vulnerability by entering crafted inputs to the web-based management interface of the affected software. A successful exploit could allow the attacker to execute arbitrary commands on the underlying operating system as the _root_ user. 
Cisco has released software updates that address this vulnerability. There are no workarounds that address this vulnerability.
Bug ID(s): [CSCwt16342](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwt16342)  
CVE ID: CVE-2026-20200  
Security Impact Rating (SIR): High  
CVSS Base Score:8.8  
CVSS Vector: CVSS:3.1/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H
**CVE-2026-20288: Cisco IMC Argument Injection Vulnerability**
A vulnerability in the web-based management interface of Cisco IMC could allow an authenticated, remote attacker with  _Admin_ privileges to execute arbitrary commands on the underlying operating system of an affected system and elevate privileges to _root_. 
This vulnerability is due to improper validation of user-supplied input. An attacker could exploit this vulnerability by entering crafted inputs to the web-based management interface of the affected software. A successful exploit could allow the attacker to execute arbitrary commands on the underlying operating system as the _root_ user. 
Cisco has assigned this vulnerability a SIR of High rather than Medium as the score indicates because additional security implications could occur when the attacker becomes  _root_.
Cisco has released software updates that address this vulnerability. There are no workarounds that address this vulnerability.
Bug ID(s): [CSCwt45063](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwt45063), [CSCwu57141](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwu57141), and [CSCwu57142](https://bst.cloudapps.cisco.com/bugsearch/bug/CSCwu57142)   
...
### Fixed Releases
In the following tables, the left column lists Cisco software releases. The right column indicates whether a release is affected the vulnerabilities that are described in this advisory and the first release that includes the fix these vulnerabilities. Customers are advised to upgrade to an appropriate [fixed software release](https://sec.cloudapps.cisco.com/security/center/resources/security_vulnerability_policy.html#fixes) as indicated in this section.
...
6.0(2.260143)1 (M6, M8)  | Apply the Hotfix [GA](https://www.cisco.com/c/en/us/td/docs/security/secure-firewall/release-notes/threat-defense/hotfix/threat-defense-release-notes-hotfix.html#Cisco_Reference.dita_e5a104de-579f-48b7-adb6-0a72dc5183b7).  |  
...
6.0(2.260143)1 (M6, M8)  | Apply the BIOS and HUU upgrade, as documented in Firmware Upgrade Guide for [Cisco Secure Network Server 3600 Series](https://www.cisco.com/c/en/us/td/docs/security/ise/sns3600hig/sns-36xx-firmware-4-x-xx_upgrade_guide.html#Cisco_Concept.dita_3e2c957e-62e6-4b2d-9f76-96ad121f29e1), [Cisco Secure Network Server 3700 Series](https://www.cisco.com/c/en/us/td/docs/security/ise/sns3700hig/sns-37xx-firmware-4-x-xx_upgrade_guide.html#r_overview), or [Cisco Secure Network Server 3800 Series](https://www.cisco.com/c/en/us/td/docs/security/ise/sns3800hig/sns-38xx-firmware-4-x-xx_upgrade_guide.html#r_overview).  |  
...
## 
Related to This Advisory 
[![Back to Top](https://www.cisco.com/etc/designs/cdc/fw/i/responsive/Default-bTop-36.svg)Back to Top](https://www.cisco.com/c/en/us/support/docs/csa/cisco-sa-cimc-arg-inject-upSHdMfU.html "Back to Top")
