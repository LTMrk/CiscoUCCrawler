[Jump to Content](https://help.webexconnect.io/docs/generate-otp-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Generate OTP Node
Search
`CTRL-K`
All
Platform Documentation
...
# Generate OTP Node
Understand what a Generate OTP node is and how to configure it
[Suggest Edits](https://help.webexconnect.io/edit/generate-otp-node)
...
## 
Node Configuration
[](https://help.webexconnect.io/docs/generate-otp-node#node-configuration)
...
![Screenshot of Generate OTP Configuration Page.](https://files.readme.io/ac3a083-Generate_OTP_Node_Generate_OTP_Configurations.png)
Generate OTP Configuration
  1. Define **OTP Validity (in minutes)**. The OTP expires after this duration. On resend OTP request, the validity is reset. The default validity period of the OTP is 30 minutes.
  2. Select the action for **On Resend OTP Request** , either _Generate new OTP_ or _Re-use current OTP_. The OTP validity is reset for either of the actions.
  3. Enter a **Transaction Reference** or select a variable that contains this value. This is a unique reference code tied to the generated OTP that is used to validate it.
  4. Enter any **Extra Parameters**. This is an optional step.  
...
## 
Input Variables
[](https://help.webexconnect.io/docs/generate-otp-node#input-variables)
...
You can see the list of variables that you explicitly create and configure for this node under the **Custom Variables** pane. You can also add a custom variable to the flow using the **Add New Custom Variable** button. For more information, see [Custom Variables](https://help.webexconnect.io/docs/variable-management).
![Screenshot of Input and Custom Variables](https://files.readme.io/c4634e1-generate_otp_input_variables.png)
Input and Custom Variables
## 
Output Variables
[](https://help.webexconnect.io/docs/generate-otp-node#output-variables)
You can see the data that this node generates as output variables. These [variables](https://help.webexconnect.io/docs/variable-management) are available for use in subsequent nodes. The following are the standard output variables for the generate OTP node:
  * **generateOTP.OTP** - captures the generated OTP. 

![Screenshot of Output Variables](https://files.readme.io/4f69b2e-generate_otp_output_variables.png)
Output Variables
## 
Node Outcomes
[](https://help.webexconnect.io/docs/generate-otp-node#node-outcomes)
...
**Note** : You can see this node edge only when you complete the node configuration.  | * **onSuccess** - the flow exits through this node when an OTP is generated successfully.  |  
...
See the [example](https://help.webexconnect.io/docs/generate-otp-node#section-example) for configuration details.
![Screenshot of Node Outcomes](https://files.readme.io/e28dab5-Generate_OTP_Node_Node_Outcomes.png)
Node Outcomes
## 
Transition Actions
[](https://help.webexconnect.io/docs/generate-otp-node#transition-actions)
...
### 
Example
[](https://help.webexconnect.io/docs/generate-otp-node#example)
...
![Screenshot of Sample Configuration of Generate OTP.](https://files.readme.io/114d6d5-Generate_OTP_Node_Sample_Configuration_of_Generate_OTP.png)
Sample Configuration of Generate OTP
Updated 4 months ago
* * *
[Call Workflow Node](https://help.webexconnect.io/docs/call-workflow-node)[Validate OTP Node](https://help.webexconnect.io/docs/validate-otp-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/generate-otp-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/generate-otp-node#node-configuration)
    * [Input Variables](https://help.webexconnect.io/docs/generate-otp-node#input-variables)
    * [Output Variables](https://help.webexconnect.io/docs/generate-otp-node#output-variables)
    * [Node Outcomes](https://help.webexconnect.io/docs/generate-otp-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/generate-otp-node#transition-actions)
      * [Example](https://help.webexconnect.io/docs/generate-otp-node#example)
