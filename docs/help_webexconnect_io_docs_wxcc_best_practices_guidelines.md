[Jump to Content](https://help.webexconnect.io/docs/wxcc-best-practices-guidelines#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Best Practices and Guidelines - WXCC
Search
`CTRL-K`
All
Platform Documentation
...
Know the best practices and guidelines for using various Pre-built Integrations
[Suggest Edits](https://help.webexconnect.io/edit/wxcc-best-practices-guidelines)
...
* * *
[Using bot rich responses with Livechat](https://help.webexconnect.io/docs/wxcc-using-bot-rich-responses-with-livechat)[FAQs - WXCC](https://help.webexconnect.io/docs/wxcc-faqs)
