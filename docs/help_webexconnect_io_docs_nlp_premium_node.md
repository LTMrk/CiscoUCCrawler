[Jump to Content](https://help.webexconnect.io/docs/nlp-premium-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)NLP Premium Node
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/nlp-premium-node)
> ## ❗️
> Note
...
![Screenshot of NLP Node](https://files.readme.io/0bf261d-nlp-premium.png)
NLP Premium Node
...
## 
Node Configuration
[](https://help.webexconnect.io/docs/nlp-premium-node#node-configuration)
...
Screenshot of Selecting Sentiment Analysis method.
  1. Enter the **MSISDN** if the selected method is _Profanity Filter_.
  2. Click **Save** to complete the configuration.


## 
Input Variables
[](https://help.webexconnect.io/docs/nlp-premium-node#input-variables)
...
## 
Output Variables
[](https://help.webexconnect.io/docs/nlp-premium-node#output-variables)
...
| --- | --- |  
| Sentiment Analysis  | > _**Library** - contains the library from which sentiment analysis is done  
...
![Screenshot of Output Variables.](https://files.readme.io/f1c6be1-nlp-premium-output-variables.png)
Output Variables
## 
Node Outcomes
[](https://help.webexconnect.io/docs/nlp-premium-node#node-outcomes)
...
## 
Transition Actions
[](https://help.webexconnect.io/docs/nlp-premium-node#transition-actions)
...
* * *
[NLP Pipeline Node](https://help.webexconnect.io/docs/nlp-pipeline-node)[Entity Node](https://help.webexconnect.io/docs/entity-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/nlp-premium-node)
  *     * [Node Configuration](https://help.webexconnect.io/docs/nlp-premium-node#node-configuration)
    * [Input Variables](https://help.webexconnect.io/docs/nlp-premium-node#input-variables)
    * [Output Variables](https://help.webexconnect.io/docs/nlp-premium-node#output-variables)
    * [Node Outcomes](https://help.webexconnect.io/docs/nlp-premium-node#node-outcomes)
    * [Transition Actions](https://help.webexconnect.io/docs/nlp-premium-node#transition-actions)
