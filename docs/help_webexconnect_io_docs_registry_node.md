[Jump to Content](https://help.webexconnect.io/docs/registry-node#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Registry Node [Deprecated]
Search
`CTRL-K`
All
Platform Documentation
...
[Suggest Edits](https://help.webexconnect.io/edit/registry-node)
> ## 📘
> Deprecation Alert
...
## 
Interface Elements
[](https://help.webexconnect.io/docs/registry-node#interface-elements)
...
| --- | --- | --- |  
| 1  | Configuration tab  | Use this tab to configure the registry operations including get, delete, and set.  
...
[](https://help.webexconnect.io/docs/registry-node#configuring-registry-operations)
You can get, delete, or set data in your instance by referencing the user key.
Here are the steps:
### 
Getting Data from a Store
[](https://help.webexconnect.io/docs/registry-node#getting-data-from-a-store)
...
### 
Deleting a Store
[](https://help.webexconnect.io/docs/registry-node#deleting-a-store)
  1. Double click the **Registry** node.  
The Registry screen appears. 
  2. On the **Registry** screen: 
...
[](https://help.webexconnect.io/docs/registry-node#setting-data-in-a-store)
  1. Double click the **Registry** node.  
The Registry screen appears. 
  2. On the **Registry** screen: 
...
[](https://help.webexconnect.io/docs/registry-node#configuring-transitions)
...
Delete Button
  1. Finally, click the **Save** button at the bottom.  
The transition actions are configured.


Updated 7 months ago
* * *
[Send Voice Node [Deprecated]](https://help.webexconnect.io/docs/send-voice-node)[Database Node [Deprecated]](https://help.webexconnect.io/docs/database-node)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/registry-node)
  *     * [Interface Elements](https://help.webexconnect.io/docs/registry-node#interface-elements)
    * [Configuring Registry Operations](https://help.webexconnect.io/docs/registry-node#configuring-registry-operations)
      * [Getting Data from a Store](https://help.webexconnect.io/docs/registry-node#getting-data-from-a-store)
      * [Deleting a Store](https://help.webexconnect.io/docs/registry-node#deleting-a-store)
      * [Setting Data in a Store](https://help.webexconnect.io/docs/registry-node#setting-data-in-a-store)
    * [Configuring Transitions](https://help.webexconnect.io/docs/registry-node#configuring-transitions)
