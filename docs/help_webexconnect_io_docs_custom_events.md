[Jump to Content](https://help.webexconnect.io/docs/custom-events#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Custom Events
Search
`CTRL-K`
All
Platform Documentation
...
# Custom Events
Call Custom Event API to trigger flows on Webex Connect.
[Suggest Edits](https://help.webexconnect.io/edit/custom-events)
...
[](https://help.webexconnect.io/docs/custom-events#configure-a-custom-event)
...
![Screenshot of Custom Event Configuration Page](https://files.readme.io/7c821be-1.png)
...
![Screenshot of Dynamically Generated Sample Payload.](https://files.readme.io/5dd8d41-Custom1.png)
Dynamically Generated Sample Payload
> ## 📘
> Note
...
* * *
[Authorization for Outbound Webhook and Contact Policy](https://help.webexconnect.io/docs/authorization-for-outbound-webhook-and-contact-policy)[Custom Node Integration](https://help.webexconnect.io/docs/custom-nodes-integration)
Did this page help you?
Yes
No
  * [Table of Contents](https://help.webexconnect.io/docs/custom-events)
  *     * [Configure a Custom Event](https://help.webexconnect.io/docs/custom-events#configure-a-custom-event)
