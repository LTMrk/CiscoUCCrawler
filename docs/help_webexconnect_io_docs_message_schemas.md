[Jump to Content](https://help.webexconnect.io/docs/message-schemas#content)
...
v6.20.0
[Home](https://help.webexconnect.io/)[Platform Documentation](https://help.webexconnect.io/docs)[Platform Changelog](https://help.webexconnect.io/changelog)Message Schemas - WxEngage standalone
Search
`CTRL-K`
All
Platform Documentation
...
# Message Schemas - WxEngage standalone
Explore message schemas for supported digital channels.
[Suggest Edits](https://help.webexconnect.io/edit/message-schemas)
...
* * *
[Channel specific message types - WxEngage standalone](https://help.webexconnect.io/docs/channel-specific-message-types)[Message Schema- SMS - WxEngage standalone](https://help.webexconnect.io/docs/sms-1)
